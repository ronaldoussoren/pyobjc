...
objc.registerNewKeywordsFromSelector("SNAudioFileAnalyzer", b"init")
objc.registerNewKeywordsFromSelector("SNAudioFileAnalyzer", b"initWithURL:error:")
objc.registerNewKeywordsFromSelector("SNAudioStreamAnalyzer", b"init")
objc.registerNewKeywordsFromSelector("SNAudioStreamAnalyzer", b"initWithFormat:")
objc.registerNewKeywordsFromSelector("SNClassification", b"init")
objc.registerNewKeywordsFromSelector("SNClassificationResult", b"init")
objc.registerNewKeywordsFromSelector("SNClassifySoundRequest", b"init")
...
objc.registerNewKeywordsFromSelector("SNTimeDurationConstraint", b"init")
objc.registerNewKeywordsFromSelector(
...
formal_protocols = {
    "SNRequest": "SNRequest",
    "SNResult": "SNResult",
    "SNResultsObserving": "SNResultsObserving",
}
