...
functions = {
    ...
    "IOSurfaceCreateMachPort": (b"I^{__IOSurface=}",),
...
aliases = {"kIOSurfaceSuccess": "KERN_SUCCESS"}
...
objc.registerNewKeywordsFromSelector("IOSurface", b"initWithProperties:")
expressions = {}
