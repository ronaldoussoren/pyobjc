...
if sys.maxsize > 2 ** 32:
    ...
    class TestGKSession (TestCase):
        ...
        def testMethods10_8(self):
            ...
            self.assertResultIsBOOL(GameCenter.GKSession.sendDataToAllPeers_withDataMode_error_)
            self.assertArgIsOut(GameCenter.GKSession.sendDataToAllPeers_withDataMode_error_, 2)
