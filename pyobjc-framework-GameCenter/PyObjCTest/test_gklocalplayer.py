...
if sys.maxsize > 2 ** 32:
    ...
    class TestGKLocalPlayer (TestCase):
        ...
        def testMethods10_9(self):
            ...
            self.assertResultIsBlock(GameCenter.GKLocalPlayer.setAuthenticateHandler_, 0, b'v@@')

        @min_os_level('10.10')
        def testMethods10_10(self):
            self.assertResultIsBlock(GameCenter.GKLocalPlayer.loadFriendPlayersWithCompletionHandler_, 0, b'v@@')
            self.assertResultIsBlock(GameCenter.GKLocalPlayer.setDefaultLeaderboardIdentifier_completionHandler_, 1, b'v@')
            self.assertResultIsBlock(GameCenter.GKLocalPlayer.loadDefaultLeaderboardIdentifierWithCompletionHandler_, 0, b'v@@')
            self.assertResultIsBlock(GameCenter.GKLocalPlayer.generateIdentityVerificationSignatureWithCompletionHandler_, 0, b'v@@@Q@')
