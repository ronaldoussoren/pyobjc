...
if sys.maxsize > 2 ** 32:
    ...
    class TestGKTurnBasedMatchHelper (GameCenter.NSObject):
        ...
        def handleTurnEventForMatch_didBecomeActive_(self, m, a): pass
    ...
    class TestGKTurnBasedMatch (TestCase):
        ...
        def testMethods10_8(self):
            ...
            self.assertArgIsBlock(GameCenter.GKTurnBasedMatch.removeWithCompletionHandler_, 0, b'v@')
            self.assertArgIsBlock(GameCenter.GKTurnBasedMatch.loadMatchDataWithCompletionHandler_, 0, b'v@@')
            self.assertArgIsBlock(GameCenter.GKTurnBasedMatch.participantQuitOutOfTurnWithOutcome_withCompletionHandler_, 1, b'v@')
            self.assertArgIsBlock(GameCenter.GKTurnBasedMatch.endMatchInTurnWithMatchData_completionHandler_, 1, b'v@')

            self.assertArgIsBlock(GameCenter.GKTurnBasedMatch.saveCurrentTurnWithMatchData_completionHandler_, 1, b'v@')
            self.assertArgIsBlock(GameCenter.GKTurnBasedMatch.endTurnWithNextParticipant_matchData_completionHandler_, 2, b'v@')
            self.assertArgIsBlock(GameCenter.GKTurnBasedMatch.participantQuitInTurnWithOutcome_nextParticipant_matchData_completionHandler_, 3, b'v@')

        @min_os_level('10.9')
        def testMethods10_9(self):
            self.assertArgIsBlock(GameCenter.GKTurnBasedMatch.rematchWithCompletionHandler_, 0, b'v@@')
            self.assertArgIsBlock(GameCenter.GKTurnBasedMatch.endTurnWithNextParticipants_turnTimeout_matchData_completionHandler_, 3, b'v@')
            self.assertArgIsBlock(GameCenter.GKTurnBasedMatch.participantQuitInTurnWithOutcome_nextParticipants_turnTimeout_matchData_completionHandler_, 4, b'v@')

        @min_os_level('10.10')
        def testMethods10_10(self):
            self.assertArgIsBlock(GameCenter.GKTurnBasedMatch.endMatchInTurnWithMatchData_scores_achievements_completionHandler_, 3, b'v@')
            self.assertArgIsBlock(GameCenter.GKTurnBasedMatch.saveMergedMatchData_withResolvedExchanges_completionHandler_, 2, b'v@')
            self.assertArgIsBlock(GameCenter.GKTurnBasedMatch.sendExchangeToParticipants_data_localizableMessageKey_arguments_timeout_completionHandler_, 5, b'v@@')
