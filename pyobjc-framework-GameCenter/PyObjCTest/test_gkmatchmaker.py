...
if sys.maxsize > 2 ** 32:
    ...
    class TestGKMatchmaker (TestCase):
        ...
        def testConstants10_8(self):
            ...
            self.assertEqual(GameCenter.GKInviteeResponseAccepted, GameCenter.GKInviteRecipientResponseAccepted)
            self.assertEqual(GameCenter.GKInviteeResponseDeclined, GameCenter.GKInviteRecipientResponseDeclined)
            self.assertEqual(GameCenter.GKInviteeResponseFailed, GameCenter.GKInviteRecipientResponseFailed)
            self.assertEqual(GameCenter.GKInviteeResponseIncompatible, GameCenter.GKInviteRecipientResponseIncompatible)
            self.assertEqual(GameCenter.GKInviteeResponseUnableToConnect, GameCenter.GKInviteRecipientResponseUnableToConnect)
            self.assertEqual(GameCenter.GKInviteeResponseNoAnswer, GameCenter.GKInviteRecipientResponseNoAnswer)
