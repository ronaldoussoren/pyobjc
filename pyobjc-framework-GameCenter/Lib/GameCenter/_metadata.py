...
misc = {}
constants = """$GKErrorDomain$GKExchangeTimeoutDefault@d$GKExchangeTimeoutNone@d$GKPlayerAuthenticationDidChangeNotificationName$GKPlayerDidChangeNotificationName$GKSessionErrorDomain$GKTurnTimeoutDefault@f$GKTurnTimeoutNone@d$GKVoiceChatServiceErrorDomain$"""
...
try:
    ...
    r(b"NSObject", b"match:player:didChangeState:", {"arguments": {4: {"type": "Q"}}})
    r(
        b"NSObject",
...
formal_protocols = {
    ...
    "GKGameCenterControllerDelegat": "GKGameCenterControllerDelegat",
    ...
    "GKViewControllerObject": "GKViewController",
