...
#
# Last update: Tue Jun 30 23:07:21 2026
#
# flake8: noqa
...
functions = {
    ...
    "ColorSyncProfileCreateCopyWithHeadroomAdaptiveGainCurveMetadata": (
        b"^{ColorSyncProfile=}^{ColorSyncProfile=}^{__CFData=}^{__CFDictionary=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "ColorSyncProfileCopyHeadroomAdaptiveGainCurveInfoDictionary": (
        b"^{__CFDictionary=}^{ColorSyncProfile=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "ColorSyncProfileCreateCopyWithHeadroomAdaptiveGainCurveInfoDictionary": (
        b"^{ColorSyncProfile=}^{ColorSyncProfile=}^{__CFDictionary=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "ColorSyncProfileCreateWithURLAndOptions": (
        b"^{ColorSyncProfile=}^{__CFURL=}^{__CFDictionary=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "ColorSyncProfileGetMD5": (b"{ColorSyncMD5=[16C]}^{ColorSyncProfile=}",),
