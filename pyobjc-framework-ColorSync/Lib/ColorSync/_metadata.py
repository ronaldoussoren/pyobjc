...
#
# Last update: Tue Feb 11 22:13:23 2020
...
misc.update(
    {
        "ColorSyncMD5": objc.createStructType(
            "ColorSyncMD5", b"{_ColorSyncMD5=[8C]}", ["digest"]
        )
    }
)
...
functions = {
    ...
    "ColorSyncCMMGetTypeID": (sel32or64(b"I", b"Q"),),
    "ColorSyncProfileCreateWithURL": (
        b"^{ColorSyncProfile=}^{__CFURL=}o^{__CFError=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "ColorSyncProfileVerify": (b"B^{ColorSyncProfile=}o^{__CFError=}o^{__CFError=}",),
    "ColorSyncTransformConvert": (
        b"B^{ColorSyncTransform=}LL^viiL^viiL^{__CFDictionary=}",
        "",
        {
            "arguments": {
    ...
    "ColorSyncProfileInstall": (
        b"B^{ColorSyncProfile=}^{__CFString=}^{__CFString=}o^^{__CFError=}",
    ),
    ...
    "ColorSyncProfileGetURL": (b"^{__CFData=}^{ColorSyncProfile=}o^{__CFError=}",),
    ...
    "ColorSyncProfileUninstall": (b"B^{ColorSyncProfile=}o^^{__CFError=}",),
    "ColorSyncProfileCopyData": (
        b"^{__CFData=}^{ColorSyncProfile=}o^{__CFError=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "ColorSyncProfileGetTypeID": (sel32or64(b"I", b"Q"),),
    "ColorSyncProfileCreateWithName": (
        b"^{ColorSyncProfile=}^{__CFString=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "ColorSyncTransformGetTypeID": (sel32or64(b"I", b"Q"),),
    ...
    "ColorSyncProfileEstimateGammaWithDisplayID": (b"fIo^{__CFError=}",),
    "ColorSyncProfileGetMD5": (b"{_ColorSyncMD5=[8C]}^{ColorSyncProfile=}",),
    ...
    "ColorSyncProfileEstimateGamma": (b"f^{ColorSyncProfile=}o^{__CFError=}",),
    "ColorSyncProfileCreate": (
        b"^{ColorSyncProfile=}^{__CFData=}o^{__CFError=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
