...
#
# Last update: Tue Jun 11 10:20:38 2024
#
# flake8: noqa
...
misc.update(
    {
        ...
        "PhoneticEncoderType": NewType("PhoneticEncoderType", int),
        "PhoneticEmbedderInitFlag": NewType("PhoneticEmbedderInitFlag", int),
