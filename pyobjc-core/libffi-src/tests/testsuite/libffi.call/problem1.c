...
my_ffi_struct
callee(struct my_ffi_struct a1, struct my_ffi_struct a2)
{
...
void
stub(ffi_cif* cif, void* resp, void** args, void* userdata)
{
...
main(void)
{
    ...
    CHECK(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 2, &my_ffi_struct_type, arg_types)
          == FFI_OK);
