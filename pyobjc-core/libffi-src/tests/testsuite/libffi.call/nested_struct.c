                       ...
                       struct cls_struct_combined b2)
{
    ...
    printf("%g %g %d %d %g %g %g %g %d %d %g %g: %g %g %d %d %g %g\n", b0.a, b0.b, b0.c,
           b1.ii, b1.dd, b1.ff, b2.d.a, b2.d.b, b2.d.c, b2.e.ii, b2.e.dd, b2.e.ff,
           result.d.a, result.d.b, result.d.c, result.e.ii, result.e.dd, result.e.ff);
...
main(void)
{
    ...
    CHECK(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 3, &cls_struct_type2, dbl_arg_types)
          == FFI_OK);
    ...
    res_dbl = ((cls_struct_combined(*)(cls_struct_16byte1, cls_struct_16byte2,
                                       cls_struct_combined))(pcl))(e_dbl, f_dbl, g_dbl);
