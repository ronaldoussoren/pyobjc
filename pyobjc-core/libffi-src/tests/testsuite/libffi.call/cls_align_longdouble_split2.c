...
cls_struct_align
cls_struct_align_fn(cls_struct_align a1, cls_struct_align a2)
{
    ...
    printf("%Lg %Lg %Lg %Lg %Lg %g %Lg %Lg %Lg %Lg %Lg %Lg %g %Lg: "
           "%Lg %Lg %Lg %Lg %Lg %g %Lg\n",
           a1.a, a1.b, a1.c, a1.d, a1.e, a1.f, a1.g, a2.a, a2.b, a2.c, a2.d, a2.e, a2.f,
           a2.g, r.a, r.b, r.c, r.d, r.e, r.f, r.g);
...
main(void)
{
    ...
    res_dbl =
        ((cls_struct_align(*)(cls_struct_align, cls_struct_align))(pcl))(g_dbl, f_dbl);
