...
cls_struct_12byte
cls_struct_12byte_fn(struct cls_struct_12byte b1, struct cls_struct_12byte b2)
{
...
static void
cls_struct_12byte_gn(ffi_cif* cif, void* resp, void** args, void* userdata)
{
...
main(void)
{
    ...
    res_dbl =
        ((cls_struct_12byte(*)(cls_struct_12byte, cls_struct_12byte))(pcl))(h_dbl, j_dbl);
    /* { dg-output "\n7 4 9 1 5 3: 8 9 12" } */
    printf("res: %d %d %d\n", res_dbl.a, res_dbl.b, res_dbl.c);
    /* { dg-output "\nres: 8 9 12" } */
