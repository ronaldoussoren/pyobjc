...
unsigned short
test_func_fn(unsigned char a1, unsigned short a2, unsigned char a3, unsigned short a4)
{
...
typedef unsigned short (*test_type)(unsigned char, unsigned short, unsigned char,
                                    unsigned short);
...
main(void)
{
    ...
    /* Initialize the cif */
    CHECK(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 4, &ffi_type_ushort, cl_arg_types)
          == FFI_OK);
