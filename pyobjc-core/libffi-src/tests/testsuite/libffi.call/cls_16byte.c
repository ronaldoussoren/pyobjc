...
cls_struct_16byte
cls_struct_16byte_fn(struct cls_struct_16byte b1, struct cls_struct_16byte b2)
{
    ...
    printf("%d %g %d %d %g %d: %d %g %d\n", b1.a, b1.b, b1.c, b2.a, b2.b, b2.c, result.a,
           result.b, result.c);
...
static void
cls_struct_16byte_gn(ffi_cif* cif, void* resp, void** args, void* userdata)
{
...
main(void)
{
    ...
    CHECK(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 2, &cls_struct_type, dbl_arg_types)
          == FFI_OK);
    ...
    res_dbl =
        ((cls_struct_16byte(*)(cls_struct_16byte, cls_struct_16byte))(pcl))(h_dbl, j_dbl);
    /* { dg-output "\n7 8 9 1 9 3: 8 17 12" } */
    printf("res: %d %g %d\n", res_dbl.a, res_dbl.b, res_dbl.c);
    /* { dg-output "\nres: 8 17 12" } */
