...
cls_struct_24byte
cls_struct_24byte_fn(struct cls_struct_24byte b0, struct cls_struct_24byte b1,
                     struct cls_struct_24byte b2, struct cls_struct_24byte b3)
{
    ...
    printf("%g %g %d %g %g %g %d %g %g %g %d %g %g %g %d %g: %g %g %d %g\n", b0.a, b0.b,
           b0.c, b0.d, b1.a, b1.b, b1.c, b1.d, b2.a, b2.b, b2.c, b2.d, b3.a, b3.b, b3.c,
           b2.d, result.a, result.b, result.c, result.d);
...
main(void)
{
    ...
    res_dbl =
        ((cls_struct_24byte(*)(cls_struct_24byte, cls_struct_24byte, cls_struct_24byte,
                               cls_struct_24byte))(pcl))(e_dbl, f_dbl, g_dbl, h_dbl);
