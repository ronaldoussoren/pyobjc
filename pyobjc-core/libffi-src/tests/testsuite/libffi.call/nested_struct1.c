...
cls_struct_combined
cls_struct_combined_fn(struct cls_struct_16byte1 b0, struct cls_struct_16byte2 b1,
                       struct cls_struct_combined b2, struct cls_struct_16byte1 b3)
{
    ...
    printf("%g %g %d %d %g %g %g %g %d %d %g %g %g %g %d: %g %g %d %d %g %g\n", b0.a,
           b0.b, b0.c, b1.ii, b1.dd, b1.ff, b2.d.a, b2.d.b, b2.d.c, b2.e.ii, b2.e.dd,
           b2.e.ff, b3.a, b3.b, b3.c, result.d.a, result.d.b, result.d.c, result.e.ii,
           result.e.dd, result.e.ff);
...
main(void)
{
    ...
    struct cls_struct_combined g_dbl = {{4.0, 5.0, 6}, {3, 1.0, 8.0}};
    ...
    CHECK(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 4, &cls_struct_type2, dbl_arg_types)
          == FFI_OK);
    ...
    res_dbl = ((cls_struct_combined(*)(cls_struct_16byte1, cls_struct_16byte2,
                                       cls_struct_combined, cls_struct_16byte1))(pcl))(
        e_dbl, f_dbl, g_dbl, h_dbl);
