...
struct_72byte
cls_struct_72byte_fn(struct_72byte b0, struct_72byte b1, struct_72byte b2,
                     struct_72byte b3)
{
    ...
    printf("%g %g %g %g %g %g %g %g %g\n", result.a, result.b, result.c, result.d,
           result.e, result.f, result.g, result.h, result.i);
...
main(void)
{
    ...
    res_dbl = ((struct_72byte(*)(struct_72byte, struct_72byte, struct_72byte,
                                 struct_72byte))(pcl))(e_dbl, f_dbl, g_dbl, h_dbl);
