...
cls_struct_9byte
cls_struct_9byte_fn(struct cls_struct_9byte b1, struct cls_struct_9byte b2)
{
    ...
    printf("%g %d %g %d: %g %d\n", b1.a, b1.b, b2.a, b2.b, result.a, result.b);

    return result;
}

static void
cls_struct_9byte_gn(ffi_cif* cif, void* resp, void** args, void* userdata)
{
...
main(void)
{
    ...
    res_dbl =
        ((cls_struct_9byte(*)(cls_struct_9byte, cls_struct_9byte))(pcl))(h_dbl, j_dbl);
    /* { dg-output "\n7 8 1 9: 8 17" } */
    printf("res: %g %d\n", res_dbl.a, res_dbl.b);
    /* { dg-output "\nres: 8 17" } */
