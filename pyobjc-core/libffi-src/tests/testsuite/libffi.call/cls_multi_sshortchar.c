...
signed short
test_func_fn(signed char a1, signed short a2, signed char a3, signed short a4)
{
    signed short result;
...
typedef signed short (*test_type)(signed char, signed short, signed char, signed short);
...
main(void)
{
    ...
    /* Initialize the cif */
    CHECK(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 4, &ffi_type_sshort, cl_arg_types)
          == FFI_OK);
