...
closure_test_fn0(ffi_cif* cif, void* resp, void** args, void* userdata)
{
    *(ffi_arg*)resp =
        ...
        + (int)*(unsigned long long*)args[10] + (int)*(unsigned long long*)args[11]
        + (int)*(unsigned long long*)args[12] + (int)*(unsigned long long*)args[13]
        + (int)*(unsigned long long*)args[14] + *(int*)args[15] + (int)(long)userdata;
...
typedef int (*closure_test_type0)(
...
main(void)
{
    ...
    res = (*((closure_test_type0)pcl))(1LL, 2LL, 3LL, 4LL, 127LL, 429LL, 7LL, 8LL, 9LL,
                                       10LL, 11LL, 12LL, 13LL, 19LL, 21LL, 1);
