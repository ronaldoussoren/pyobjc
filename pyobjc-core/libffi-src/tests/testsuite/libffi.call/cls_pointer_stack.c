...
long
dummy_func(long double a1, char b1, long double a2, char b2, long double a3, char b3,
...
void*
cls_pointer_fn2(void* a1, void* a2)
{
    ...
    dummyVar = dummy_func(trample1, trample2, trample3, trample4, trample5, trample6,
                          trample7, trample8);
...
void*
cls_pointer_fn1(void* a1, void* a2)
{
    long double trample1 = (long)a1 + (long)a2;
    char        trample2 = ((char*)&a1)[0] + ((char*)&a2)[0];
    long double trample3 = (long)trample1 + (long)a1;
...
main(void)
{
    ...
    CHECK(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 2, &ffi_type_pointer, arg_types) == FFI_OK);
