...
long double
cls_ldouble_fn(long double a1, long double a2, long double a3, long double a4,
...
cls_ldouble_gn(ffi_cif* cif, void* resp, void** args, void* userdata)
{
    ...
    *(long double*)resp = cls_ldouble_fn(a1, a2, a3, a4, a5, a6, a7, a8);
}
...
main(void)
{
    ...
    CHECK(ffi_prep_cif(&cif, FFI_DEFAULT_ABI, 8, &ffi_type_longdouble, arg_types)
          == FFI_OK);
    ...
    res = ((long double (*)(long double, long double, long double, long double,
                            long double, long double, long double, long double))(pcl))(
