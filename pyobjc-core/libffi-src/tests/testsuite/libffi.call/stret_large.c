...
struct_108byte
cls_struct_108byte_fn(struct_108byte b0, struct_108byte b1, struct_108byte b2,
                      struct_108byte b3)
{
...
main(void)
{
    ...
    struct_108byte e_dbl = {9.0, 2.0, 6.0, 5.0, 3.0, 4.0, 8.0,
                            1.0, 1.0, 2.0, 3.0, 7.0, 2.0, 7};
    struct_108byte f_dbl = {1.0, 2.0, 3.0, 7.0, 2.0, 5.0, 6.0,
                            7.0, 4.0, 5.0, 7.0, 9.0, 1.0, 4};
    struct_108byte g_dbl = {4.0, 5.0, 7.0, 9.0, 1.0, 1.0, 2.0,
                            9.0, 8.0, 6.0, 1.0, 4.0, 0.0, 3};
    struct_108byte h_dbl = {8.0, 6.0, 1.0, 4.0, 0.0, 3.0, 3.0,
                            1.0, 9.0, 2.0, 6.0, 5.0, 3.0, 2};
    ...
    res_dbl = ((struct_108byte(*)(struct_108byte, struct_108byte, struct_108byte,
                                  struct_108byte))(pcl))(e_dbl, f_dbl, g_dbl, h_dbl);
