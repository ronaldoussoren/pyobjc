...
class BasePackable(object):
    ...
    def to_str(self, s, **kw):
        raise NotImplementedError

    def to_fileobj(self, f, **kw):
        f.write(self.to_str(**kw))

    def to_mmap(self, mm, ptr, **kw):
        mm[ptr:ptr+self._size_] = self.to_str(**kw)
...
class Structure(BasePackable):
    ...
    def to_str(self, **kw):
        ...
        return struct.pack(endian + self._format_, *self._get_packables())
