...
extern Py_ssize_t PyObjCFFI_ParseArguments(PyObjCMethodSignature*, Py_ssize_t,
                                           PyObject* const*, size_t, Py_ssize_t,
                                           unsigned char*, Py_ssize_t, void**,
...
extern PyObject* PyObjCFFI_Caller_SimpleSEL(PyObject*, PyObject*, PyObject* const*,
                                            size_t);

extern Py_ssize_t PyObjCFFI_ParseArguments_Simple(PyObjCMethodSignature*, Py_ssize_t,
                                                  PyObject* const*, size_t, Py_ssize_t,
                                                  unsigned char*, Py_ssize_t, void**);
extern PyObject*  PyObjCFFI_BuildResult_Simple(PyObjCMethodSignature*, void*, PyObject*,
                                               int);
#endif
