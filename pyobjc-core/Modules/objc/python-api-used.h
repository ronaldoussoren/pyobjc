...
PyAPI_FUNC(PyObject* _Nullable) PyByteArray_FromStringAndSize(const char*, Py_ssize_t);
...
PyAPI_FUNC(PyObject* _Nullable) PyBytes_FromStringAndSize(const char*, Py_ssize_t);
PyAPI_FUNC(PyObject* _Nullable)
    PyCFunction_NewEx(PyMethodDef* ml, PyObject* _Nullable self, PyObject* module);
PyAPI_FUNC(PyObject* _Nullable)
...
PyAPI_FUNC(int) PyDict_Next(PyObject* p, Py_ssize_t* ppos, PyObject* _Nullable* _Nonnull,
                            PyObject* _Nullable* _Nonnull pvalue);
...
PyAPI_FUNC(PyObject* _Nullable) PyErr_Format(PyObject* exception, const char* format, ...)
    PyAPI_FUNC(PyObject* _Nullable)
...
PyAPI_FUNC(PyObject* _Nullable) PyFrozenSet_New(PyObject*);
...
PyAPI_FUNC(PyObject * _Nullable) PyImport_ImportModule(
...
PyAPI_FUNC(PyObject * _Nullable) PyLong_FromVoidPtr(void *);
...
PyAPI_FUNC(void * _Nullable) PyMem_Realloc(void *ptr, size_t new_size);
...
PyAPI_FUNC(PyObject * _Nullable) PyObject_Call(PyObject *callable, PyObject * _Nullable args, PyObject * _Nullable kwargs);
PyAPI_FUNC(PyObject * _Nullable) PyObject_CallFunction(PyObject *callable, const char *format, ...);
PyAPI_FUNC(PyObject * _Nullable) PyObject_CallFunctionObjArgs(PyObject *callable, ...) __attribute__ ((__sentinel__(NULL)));
PyAPI_FUNC(PyObject * _Nullable) PyObject_CallMethod(PyObject *obj, const char *name, const char *format, ...);
...
PyAPI_FUNC(PyObject * _Nullable) PyObject_VectorcallMethod(PyObject *name, PyObject * _Nonnull const *_Nonnull args, size_t nargsf, PyObject * _Nullable kwnames)
...
PyAPI_FUNC(PyObject * _Nullable) PySet_New(PyObject *);
...
PyAPI_FUNC(PyObject * _Nullable) PyType_GenericNew(PyTypeObject *,
PyAPI_FUNC(int) PyType_IsSubtype(PyTypeObject *, PyTypeObject *);
PyAPI_FUNC(void) PyType_Modified(PyTypeObject *);
PyAPI_FUNC(PyObject* _Nullable) PyType_FromSpec(PyType_Spec*);
PyAPI_FUNC(PyObject* _Nullable) PyType_FromSpecWithBases(PyType_Spec*, PyObject*);
PyAPI_FUNC(PyObject* _Nullable) PyType_FromModuleAndSpec(PyObject *, PyType_Spec *, PyObject *);
PyAPI_DATA(PyTypeObject) PyType_Type; /* built-in 'type' */
PyAPI_FUNC(void) PyUnicode_Append(PyObject* _Nullable * _Nonnull, PyObject*);
PyAPI_FUNC(PyObject* _Nullable) PyUnicode_AsEncodedString(PyObject *unicode, const char * _Nullable encoding, const char * _Nullable errors);
...
PyAPI_FUNC(wchar_t* _Nullable) PyUnicode_AsWideCharString(PyObject *unicode, Py_ssize_t *size);
PyAPI_FUNC(PyObject* _Nullable) PyUnicode_Decode(const char *s, Py_ssize_t size, const char * _Nullable encoding, const char * _Nullable errors);
PyAPI_FUNC(PyObject* _Nullable) PyUnicode_DecodeFSDefault(const char* s);
PyAPI_FUNC(PyObject* _Nullable) PyUnicode_DecodeUTF16(const char *s, Py_ssize_t size, const char * _Nullable errors, int * _Nullable byteorder);
PyAPI_FUNC(PyObject* _Nullable) PyUnicode_DecodeUTF8(const char *s, Py_ssize_t size, const char * _Nullable errors);
...
PyAPI_FUNC(PyObject* _Nullable) PyUnicode_FromStringAndSize(const char* u, Py_ssize_t size);
...
PyAPI_FUNC(PyObject * _Nullable) PyVectorcall_Call(PyObject *callable, PyObject *tuple, PyObject *dict);
