...
static id
create_void_noargs(PyObject*              callable,
...
static id
create_id_noargs(PyObject* callable, PyObjCMethodSignature* methinfo)
{
...
IMP _Nullable blockimpForSignature(SEL sel, const char* typestr, PyObject* callable,
                                   PyObjCMethodSignature* methinfo)
{
    ...
    for (struct block_generator* cur = registry; cur->typestr != NULL; cur++) {
        if (strcmp(typestr, cur->typestr) != 0)
            continue;
