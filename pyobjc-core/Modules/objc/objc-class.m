                                     ...
                                     PyObject* _Nullable args, PyObject* _Nullable kwds)
{
    ...
    if (objc_class != nil) {
        ...
        if (existing != res) { // LCOV_BR_EXCL_LINE
    ...
    for (i = 0; i < n; i++) {
        ...
        if (PyObject_IsSubclass(base, (PyObject*)&PyObjCMetaClass_Type)) {
            ...
            if (base_class == NULL) {
                ...
                if (PyObjCClass_CheckMethodList( // LCOV_BR_EXCL_LINE
                        base_class, 0)
                    < 0) {
                    // LCOV_EXCL_START
                    Py_CLEAR(mro);
...
static PyObject* _Nullable class_richcompare(PyObject* self, PyObject* other, int op)
{
    ...
    if (self_class == other_class) {
    ...
    } else if (!self_class) { // LCOV_BR_EXCL_LINE
        ...
        case Py_EQ:
            ...
            if (self_class == other_class) { // LCOV_BR_EXCL_LINE
        ...
        case Py_NE:
            ...
            if (self_class == other_class) { // LCOV_BR_EXCL_LINE
                ...
                Py_RETURN_TRUE; // LxCOV_EXCL_LINE
            }
        }
...
PyObject* _Nullable PyObjCClass_New(Class objc_class)
{
    ...
    if (class_getSuperclass(objc_class) == NULL) {
        ...
        if (super_class == NULL) { // LCOV_BR_EXCL_LINE
            // LCOV_EXCL_START
            Py_DECREF(hiddenSelectors);
            Py_DECREF(hiddenClassSelectors);
            Py_DECREF(metaclass);
     ...
     * objc_class_register.
     */
    if (PyType_Type.tp_setattro( // LCOV_BR_EXCL_LINE
                                             ...
                                             BOOL class_method)
{
    ...
    if (PyObjCClass_CheckMethodList(cls, 1) < 0) { // LCOV_BR_EXCL_LINE
        return NULL;                               // LCOV_EXCL_LINE
    }
...
PyObjCClass_AddMethods(PyObject* classObject, PyObject** methods, Py_ssize_t methodCount)
{
    ...
    for (methodIndex = 0; methodIndex < methodCount; methodIndex++) {
        ...
        if (objcMethod->type == NULL) {    // LCOV_BR_EXCL_LINE
