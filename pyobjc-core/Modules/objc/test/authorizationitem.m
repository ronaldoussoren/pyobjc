...
+(NSDictionary*)dictWithAuthorizationItem:(AuthorizationItem*)item
{
    if (item->value) {
        return @{
           ...
           @"name": item->name?[NSString stringWithUTF8String:item->name]:[NSNull null],
        };
    } else {
        return @{
            @"flags": @(item->flags),
...
PyObject* __attribute__((__visibility__("default"))) _Nullable PyInit_authorizationitem(void)
{
