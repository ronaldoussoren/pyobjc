...
extern int PyObjC_setup_simple_methods(void);
extern int PyObjC_setup_simd(void);

extern PyObject* _Nullable pythonify_nsdecimal(void* value);
...
extern PyObject* _Nullable pythonify_authorizationitem(void* value);
