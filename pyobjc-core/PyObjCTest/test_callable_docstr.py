...
class TestDescribeType (TestCase):
    ...
    def test_inout(self):
        self.assertEqual(mod.describe_type(objc._C_IN + objc._C_PTR + objc._C_INT), "in void*")
        self.assertEqual(mod.describe_type(objc._C_OUT + objc._C_PTR + objc._C_INT), "out void*")
        self.assertEqual(mod.describe_type(objc._C_INOUT + objc._C_PTR + objc._C_INT), "inout void*")

        # Nonsense, but should give a sane result anway:
        self.assertEqual(mod.describe_type(objc._C_OUT + objc._C_IN + objc._C_PTR + objc._C_INT), "out in void*")

    def test_pointers(self):
        self.assertEqual(mod.describe_type(objc._C_CHARPTR), "char*")
        self.assertEqual(mod.describe_type(objc._C_PTR + objc._C_CHAR), "char*")
    ...
    def test_struct(self):
        ...
        self.assertEqual(mod.describe_type(objc._C_STRUCT_B + b"name=\"field\"" + objc._C_ID + '"field2"' + objc._C_INT + objc._C_STRUCT_E), "struct name")
    ...
    def test_union(self):
        ...
        self.assertEqual(mod.describe_type(objc._C_UNION_B + b"name=\"field\"" + objc._C_ID + '"field2"' + objc._C_INT + objc._C_UNION_E), "union name")
