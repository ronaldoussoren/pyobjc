...
class TestVectorCall(TestCase):
    ...
    def test_clsv2dd_(self):
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsv2dd_(-557000000000.0, "hello")
    ...
    def test_clsv2fQ_(self):
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsv2fQ_(35184372088832, "hello")
    ...
    def test_clsv2fd_(self):
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsv2fd_(-557000000000.0, "hello")
    ...
    def test_clsv2fq_(self):
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsv2fq_(-17592186044416, "hello")
    ...
    def test_clsv3dd_(self):
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsv3dd_(-557000000000.0, "hello")
    ...
    def test_clsv3fv2i_v2i_(self):
        ...
        # Valid call
        rv = oc.clsv3fv2i_v2i_(objc.simd.vector_int2(0, 1), objc.simd.vector_int2(0, 1))
        self.assertEqual(rv, objc.simd.vector_float3(0.0, 1.5, 3.0))
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsv3fv2i_v2i_(objc.simd.vector_int2(0, 1))
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsv3fv2i_v2i_(None, objc.simd.vector_int2(0, 1))

        with self.assertRaises((TypeError, ValueError)):
            oc.clsv3fv2i_v2i_(objc.simd.vector_int2(0, 1), None)
    ...
    def test_clsv3fv3f_(self):
        ...
        # Valid call
        rv = oc.clsv3fv3f_(objc.simd.vector_float3(0.0, 1.5, 3.0))
        self.assertEqual(rv, objc.simd.vector_float3(0.0, 1.5, 3.0))
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsv3fv3f_(objc.simd.vector_float3(0.0, 1.5, 3.0), "hello")
    ...
    def test_clsv3fv3f_id_(self):
        ...
        # Valid call
        rv = oc.clsv3fv3f_id_(objc.simd.vector_float3(0.0, 1.5, 3.0), "hello")
        self.assertEqual(rv, objc.simd.vector_float3(0.0, 1.5, 3.0))
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsv3fv3f_id_(objc.simd.vector_float3(0.0, 1.5, 3.0))

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsv3fv3f_id_(objc.simd.vector_float3(0.0, 1.5, 3.0), "hello", "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsv3fv3f_id_(None, "hello")

        with self.assertRaises((TypeError, ValueError)):
            oc.clsv3fv3f_id_(objc.simd.vector_float3(0.0, 1.5, 3.0), NoObjCValueObject)
    ...
    def test_clsv3fv4i_(self):
        ...
        # Valid call
        rv = oc.clsv3fv4i_(objc.simd.vector_int4(0, 1, 2, 3))
        self.assertEqual(rv, objc.simd.vector_float3(0.0, 1.5, 3.0))
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsv3fv4i_(objc.simd.vector_int4(0, 1, 2, 3), "hello")
    ...
    def test_clsv3fQ_(self):
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsv3fQ_(35184372088832, "hello")
    ...
    def test_clsv3fd_(self):
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsv3fd_(-557000000000.0, "hello")
    ...
    def test_clsv4dd_(self):
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsv4dd_(-557000000000.0, "hello")
    ...
    def test_clsv4fd_(self):
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsv4fd_(-557000000000.0, "hello")
    ...
    def test_clsv4iv3f_(self):
        ...
        # Valid call
        rv = oc.clsv4iv3f_(objc.simd.vector_float3(0.0, 1.5, 3.0))
        self.assertEqual(rv, objc.simd.vector_int4(0, 1, 2, 3))
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsv4iv3f_(objc.simd.vector_float3(0.0, 1.5, 3.0), "hello")
    ...
    def test_clsidv2f_(self):
        ...
        # Valid call
        rv = oc.clsidv2f_(objc.simd.vector_float2(0.0, 1.5))
        self.assertEqual(rv, "hello")
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidv2f_(objc.simd.vector_float2(0.0, 1.5), "hello")
    ...
    def test_clsidv2f_v2f_(self):
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidv2f_v2f_(objc.simd.vector_float2(0.0, 1.5))
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidv2f_v2f_(None, objc.simd.vector_float2(0.0, 1.5))

        with self.assertRaises((TypeError, ValueError)):
            oc.clsidv2f_v2f_(objc.simd.vector_float2(0.0, 1.5), None)
    ...
    def test_clsidv2i_(self):
        ...
        # Valid call
        rv = oc.clsidv2i_(objc.simd.vector_int2(0, 1))
        self.assertEqual(rv, "hello")
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidv2i_(objc.simd.vector_int2(0, 1), "hello")
    ...
    def test_clsidv2i_i_i_Z_(self):
        ...
        # Valid call
        rv = oc.clsidv2i_i_i_Z_(objc.simd.vector_int2(0, 1), -42, -42, False)
        self.assertEqual(rv, "hello")
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidv2i_i_i_Z_(objc.simd.vector_int2(0, 1), -42, -42)

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidv2i_i_i_Z_(objc.simd.vector_int2(0, 1), -42, -42, False, "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidv2i_i_i_Z_(None, -42, -42, False)

        with self.assertRaises((TypeError, ValueError)):
            oc.clsidv2i_i_i_Z_(objc.simd.vector_int2(0, 1), None, -42, False)

        with self.assertRaises((TypeError, ValueError)):
            oc.clsidv2i_i_i_Z_(objc.simd.vector_int2(0, 1), -42, None, False)

        with self.assertRaises((TypeError, ValueError)):
            oc.clsidv2i_i_i_Z_(objc.simd.vector_int2(0, 1), -42, -42, NoBool())
    ...
    def test_clsidv2i_i_i_Z_Class_(self):
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidv2i_i_i_Z_Class_(objc.simd.vector_int2(0, 1), -42, -42, False)

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidv2i_i_i_Z_Class_(
                objc.simd.vector_int2(0, 1),
                -42,
                -42,
                False,
        ...
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidv2i_i_i_Z_Class_(objc.simd.vector_int2(0, 1), -42, -42, False, 42)
    ...
    def test_clsidv3f_(self):
        ...
        # Valid call
        rv = oc.clsidv3f_(objc.simd.vector_float3(0.0, 1.5, 3.0))
        self.assertEqual(rv, "hello")
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidv3f_(objc.simd.vector_float3(0.0, 1.5, 3.0), "hello")
    ...
    def test_clsidv3f_v2I_Z_Z_Z_q_id_(self):
        ...
        # Valid call
        rv = oc.clsidv3f_v2I_Z_Z_Z_q_id_(
            objc.simd.vector_float3(0.0, 1.5, 3.0),
            objc.simd.vector_uint2(0, 1),
            False,
            False,
    ...
    def test_clsidv3f_Z_q_id_(self):
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidv3f_Z_q_id_(None, False, -17592186044416, "hello")
    ...
    def test_clsidv4f_(self):
        ...
        # Valid call
        rv = oc.clsidv4f_(objc.simd.vector_float4(0.0, 1.5, 3.0, 4.5))
        self.assertEqual(rv, "hello")
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidv4f_(objc.simd.vector_float4(0.0, 1.5, 3.0, 4.5), "hello")
    ...
    def test_clsidid_v2f_(self):
        ...
        # Valid call
        rv = oc.clsidid_v2f_("hello", objc.simd.vector_float2(0.0, 1.5))
        self.assertEqual(rv, "hello")
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_v2f_("hello")

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_v2f_("hello", objc.simd.vector_float2(0.0, 1.5), "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_v2f_(NoObjCValueObject, objc.simd.vector_float2(0.0, 1.5))

        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_v2f_("hello", None)
    ...
    def test_clsidid_v3f_(self):
        ...
        # Valid call
        rv = oc.clsidid_v3f_("hello", objc.simd.vector_float3(0.0, 1.5, 3.0))
        self.assertEqual(rv, "hello")
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_v3f_("hello")

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_v3f_("hello", objc.simd.vector_float3(0.0, 1.5, 3.0), "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_v3f_(NoObjCValueObject, objc.simd.vector_float3(0.0, 1.5, 3.0))

        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_v3f_("hello", None)
    ...
    def test_clsidid_v4f_(self):
        ...
        # Valid call
        rv = oc.clsidid_v4f_("hello", objc.simd.vector_float4(0.0, 1.5, 3.0, 4.5))
        self.assertEqual(rv, "hello")
    ...
    def test_clsidid_id_v2i_(self):
        ...
        # Valid call
        rv = oc.clsidid_id_v2i_("hello", "hello", objc.simd.vector_int2(0, 1))
        self.assertEqual(rv, "hello")
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_id_v2i_("hello", "hello")

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_id_v2i_("hello", "hello", objc.simd.vector_int2(0, 1), "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_id_v2i_(NoObjCValueObject, "hello", objc.simd.vector_int2(0, 1))

        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_id_v2i_("hello", NoObjCValueObject, objc.simd.vector_int2(0, 1))

        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_id_v2i_("hello", "hello", None)
    ...
    def test_clsidid_id_v2i_f_(self):
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_id_v2i_f_("hello", "hello", objc.simd.vector_int2(0, 1))

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_id_v2i_f_(
                "hello", "hello", objc.simd.vector_int2(0, 1), 2500000000.0, "hello"
            )
        ...
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_id_v2i_f_("hello", "hello", None, 2500000000.0)

        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_id_v2i_f_("hello", "hello", objc.simd.vector_int2(0, 1), None)
    ...
    def test_clsidid_Q_v2f_(self):
        ...
        # Valid call
        rv = oc.clsidid_Q_v2f_(
            "hello", 35184372088832, objc.simd.vector_float2(0.0, 1.5)
        )
        self.assertEqual(rv, "hello")
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_Q_v2f_("hello", 35184372088832)
        ...
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_Q_v2f_("hello", None, objc.simd.vector_float2(0.0, 1.5))

        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_Q_v2f_("hello", 35184372088832, None)
    ...
    def test_clsidid_Q_v3f_(self):
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_Q_v3f_("hello", 35184372088832)
        ...
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_Q_v3f_("hello", None, objc.simd.vector_float3(0.0, 1.5, 3.0))

        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_Q_v3f_("hello", 35184372088832, None)
    ...
    def test_clsidid_Q_v4f_(self):
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_Q_v4f_("hello", 35184372088832)
        ...
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_Q_v4f_("hello", 35184372088832, None)
    ...
    def test_clsidid_Q_matrixfloat4x4_(self):
        # Check that the signature is as expected
        self.assertResultHasType(OC_VectorCall.clsidid_Q_matrixfloat4x4_, b"@")
        self.assertArgHasType(OC_VectorCall.clsidid_Q_matrixfloat4x4_, 0, b"@")
        self.assertArgHasType(OC_VectorCall.clsidid_Q_matrixfloat4x4_, 1, b"Q")
        self.assertArgHasType(
            OC_VectorCall.clsidid_Q_matrixfloat4x4_, 2, b"{_matrix_float4x4=[4<4f>]}"
        )
        ...
        # Valid call
        rv = oc.clsidid_Q_matrixfloat4x4_(
            "hello",
            35184372088832,
            simd.matrix_float4x4(
                (
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_Q_matrixfloat4x4_("hello", 35184372088832)

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_Q_matrixfloat4x4_(
                "hello",
                35184372088832,
                simd.matrix_float4x4(
                    (
        ...
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_Q_matrixfloat4x4_("hello", 35184372088832, None)
    ...
    def test_clsidid_Z_id_v2i_q_Q_q_Z_(self):
        ...
        # Valid call
        rv = oc.clsidid_Z_id_v2i_q_Q_q_Z_(
            "hello",
            False,
            "hello",
            objc.simd.vector_int2(0, 1),
    ...
    def test_clsidid_q_v2i_f_f_f_f_f_(self):
        ...
        # Valid call
        rv = oc.clsidid_q_v2i_f_f_f_f_f_(
            "hello",
            -17592186044416,
            objc.simd.vector_int2(0, 1),
            2500000000.0,
    ...
    def test_clsidid_MDLAxisAlignedBoundingBox_f_(self):
        ...
        # Valid call
        rv = oc.clsidid_MDLAxisAlignedBoundingBox_f_(
            "hello",
            (
                objc.simd.vector_float3(-8.0, -9.0, -10.0),
                objc.simd.vector_float3(-11.0, -12.0, -13.0),
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_MDLAxisAlignedBoundingBox_f_(
                "hello",
                (
                    objc.simd.vector_float3(-8.0, -9.0, -10.0),
                    objc.simd.vector_float3(-11.0, -12.0, -13.0),
        ...
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_MDLAxisAlignedBoundingBox_f_("hello", None, 2500000000.0)
    ...
    def test_clsidid_matrixfloat2x2_(self):
        # Check that the signature is as expected
        self.assertResultHasType(OC_VectorCall.clsidid_matrixfloat2x2_, b"@")
        self.assertArgHasType(OC_VectorCall.clsidid_matrixfloat2x2_, 0, b"@")
        self.assertArgHasType(
            OC_VectorCall.clsidid_matrixfloat2x2_, 1, b"{_matrix_float2x2=[2<2f>]}"
        )
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_matrixfloat2x2_("hello")

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_matrixfloat2x2_(
                "hello",
                simd.matrix_float2x2(
                    (
                        objc.simd.vector_float2(0.0, 1.5),
        ...
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_matrixfloat2x2_("hello", None)
    ...
    def test_clsidid_matrixfloat3x3_(self):
        # Check that the signature is as expected
        self.assertResultHasType(OC_VectorCall.clsidid_matrixfloat3x3_, b"@")
        self.assertArgHasType(OC_VectorCall.clsidid_matrixfloat3x3_, 0, b"@")
        self.assertArgHasType(
            OC_VectorCall.clsidid_matrixfloat3x3_, 1, b"{_matrix_float3x3=[3<3f>]}"
        )
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_matrixfloat3x3_("hello")

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_matrixfloat3x3_(
                "hello",
                simd.matrix_float3x3(
                    (
                        objc.simd.vector_float3(0.0, 1.5, 3.0),
        ...
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_matrixfloat3x3_("hello", None)
    ...
    def test_clsidid_matrixfloat4x4_(self):
        # Check that the signature is as expected
        self.assertResultHasType(OC_VectorCall.clsidid_matrixfloat4x4_, b"@")
        self.assertArgHasType(OC_VectorCall.clsidid_matrixfloat4x4_, 0, b"@")
        self.assertArgHasType(
            OC_VectorCall.clsidid_matrixfloat4x4_, 1, b"{_matrix_float4x4=[4<4f>]}"
        )
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_matrixfloat4x4_("hello")

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidid_matrixfloat4x4_(
                "hello",
                simd.matrix_float4x4(
                    (
                        objc.simd.vector_float4(0.0, 1.5, 3.0, 4.5),
        ...
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidid_matrixfloat4x4_("hello", None)
    ...
    def test_clsidCGColor_CGColor_id_v2i_(self):
        ...
        # Valid call
        rv = oc.clsidCGColor_CGColor_id_v2i_(
            "color!", "color!", "hello", objc.simd.vector_int2(0, 1)
        )
        self.assertEqual(rv, "hello")
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidCGColor_CGColor_id_v2i_("color!", "color!", "hello")

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidCGColor_CGColor_id_v2i_(
                "color!", "color!", "hello", objc.simd.vector_int2(0, 1), "hello"
            )
        ...
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidCGColor_CGColor_id_v2i_("color!", "color!", "hello", None)
    ...
    def test_clsidf_v2f_v2f_(self):
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidf_v2f_v2f_(2500000000.0, objc.simd.vector_float2(0.0, 1.5))
        ...
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidf_v2f_v2f_(2500000000.0, None, objc.simd.vector_float2(0.0, 1.5))

        with self.assertRaises((TypeError, ValueError)):
            oc.clsidf_v2f_v2f_(2500000000.0, objc.simd.vector_float2(0.0, 1.5), None)
    ...
    def test_clsidf_v2f_Q_Q_Q_q_Z_id_(self):
        ...
        # Valid call
        rv = oc.clsidf_v2f_Q_Q_Q_q_Z_id_(
            2500000000.0,
            objc.simd.vector_float2(0.0, 1.5),
            35184372088832,
            35184372088832,
    ...
    def test_clsidf_id_v2i_i_q_CGColor_CGColor_(self):
        ...
        # Valid call
        rv = oc.clsidf_id_v2i_i_q_CGColor_CGColor_(
            2500000000.0,
            "hello",
            objc.simd.vector_int2(0, 1),
            -42,
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidf_id_v2i_i_q_CGColor_CGColor_(
                2500000000.0,
                "hello",
                objc.simd.vector_int2(0, 1),
                -42,
    ...
    def test_clsidf_id_v2i_q_(self):
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidf_id_v2i_q_(2500000000.0, "hello", objc.simd.vector_int2(0, 1))
        ...
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidf_id_v2i_q_(2500000000.0, "hello", None, -17592186044416)
    ...
    def test_clsidf_f_id_v2i_(self):
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsidf_f_id_v2i_(2500000000.0, 2500000000.0, "hello")
        ...
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidf_f_id_v2i_(2500000000.0, 2500000000.0, "hello", None)
    ...
    def test_clsidGKBox_f_(self):
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidGKBox_f_(None, 2500000000.0)
    ...
    def test_clsidGKQuad_f_(self):
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidGKQuad_f_(None, 2500000000.0)
    ...
    def test_clsidMDLVoxelIndexExtent_(self):
        ...
        # Valid call
        rv = oc.clsidMDLVoxelIndexExtent_(
            (
                objc.simd.vector_int4(100, 101, 102, 103),
                objc.simd.vector_int4(-20, -21, -22, -23),
            )
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidMDLVoxelIndexExtent_(None)
    ...
    def test_clsidmatrixfloat4x4_(self):
        # Check that the signature is as expected
        self.assertResultHasType(OC_VectorCall.clsidmatrixfloat4x4_, b"@")
        self.assertArgHasType(
            OC_VectorCall.clsidmatrixfloat4x4_, 0, b"{_matrix_float4x4=[4<4f>]}"
        )
    ...
    def test_clsidmatrixfloat4x4_Z_(self):
        # Check that the signature is as expected
        self.assertResultHasType(OC_VectorCall.clsidmatrixfloat4x4_Z_, b"@")
        self.assertArgHasType(
            OC_VectorCall.clsidmatrixfloat4x4_Z_, 0, b"{_matrix_float4x4=[4<4f>]}"
        )
        self.assertArgHasType(OC_VectorCall.clsidmatrixfloat4x4_Z_, 1, b"Z")
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsidmatrixfloat4x4_Z_(None, False)
    ...
    def test_clsZv2i_id_id_id_id_(self):
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsZv2i_id_id_id_id_(None, "hello", "hello", "hello", "hello")
    ...
    def test_clsZv4i_Z_Z_Z_Z_(self):
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsZv4i_Z_Z_Z_Z_(objc.simd.vector_int4(0, 1, 2, 3), False, False, False)
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsZv4i_Z_Z_Z_Z_(None, False, False, False, False)
    ...
    def test_clsCGColorv3f_(self):
        ...
        # Valid call
        rv = oc.clsCGColorv3f_(objc.simd.vector_float3(0.0, 1.5, 3.0))
        self.assertEqual(rv, "color!")
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsCGColorv3f_(objc.simd.vector_float3(0.0, 1.5, 3.0), "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsCGColorv3f_(None)
    ...
    def test_clsCGColorv3f_CGColorSpace_(self):
        ...
        # Valid call
        rv = oc.clsCGColorv3f_CGColorSpace_(
            objc.simd.vector_float3(0.0, 1.5, 3.0), "colorspace!"
        )
        self.assertEqual(rv, "color!")
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsCGColorv3f_CGColorSpace_(objc.simd.vector_float3(0.0, 1.5, 3.0))

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsCGColorv3f_CGColorSpace_(
                objc.simd.vector_float3(0.0, 1.5, 3.0), "colorspace!", "hello"
            )

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsCGColorv3f_CGColorSpace_(None, "colorspace!")
    ...
    def test_clsfv2f_(self):
        ...
        # Valid call
        rv = oc.clsfv2f_(objc.simd.vector_float2(0.0, 1.5))
        self.assertEqual(rv, 2500000000.0)
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsfv2f_(objc.simd.vector_float2(0.0, 1.5), "hello")
    ...
    def test_clsfv2i_(self):
        ...
        # Valid call
        rv = oc.clsfv2i_(objc.simd.vector_int2(0, 1))
        self.assertEqual(rv, 2500000000.0)
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsfv2i_(objc.simd.vector_int2(0, 1), "hello")
    ...
    def test_clsvv2d_d_(self):
        ...
        # Valid call
        rv = oc.clsvv2d_d_(objc.simd.vector_double2(0.0, 1.5), -557000000000.0)
        self.assertIs(rv, None)
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvv2d_d_(objc.simd.vector_double2(0.0, 1.5))

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvv2d_d_(objc.simd.vector_double2(0.0, 1.5), -557000000000.0, "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvv2d_d_(None, -557000000000.0)

        with self.assertRaises((TypeError, ValueError)):
            oc.clsvv2d_d_(objc.simd.vector_double2(0.0, 1.5), None)
    ...
    def test_clsvv2f_(self):
        ...
        # Valid call
        rv = oc.clsvv2f_(objc.simd.vector_float2(0.0, 1.5))
        self.assertIs(rv, None)
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvv2f_(objc.simd.vector_float2(0.0, 1.5), "hello")
    ...
    def test_clsvv2f_d_(self):
        ...
        # Valid call
        rv = oc.clsvv2f_d_(objc.simd.vector_float2(0.0, 1.5), -557000000000.0)
        self.assertIs(rv, None)
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvv2f_d_(objc.simd.vector_float2(0.0, 1.5))

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvv2f_d_(objc.simd.vector_float2(0.0, 1.5), -557000000000.0, "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvv2f_d_(None, -557000000000.0)

        with self.assertRaises((TypeError, ValueError)):
            oc.clsvv2f_d_(objc.simd.vector_float2(0.0, 1.5), None)
    ...
    def test_clsvv3d_(self):
        ...
        # Valid call
        rv = oc.clsvv3d_(objc.simd.vector_double3(0.0, 1.5, 3.0))
        self.assertIs(rv, None)
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvv3d_(objc.simd.vector_double3(0.0, 1.5, 3.0), "hello")
    ...
    def test_clsvv3d_d_(self):
        ...
        # Valid call
        rv = oc.clsvv3d_d_(objc.simd.vector_double3(0.0, 1.5, 3.0), -557000000000.0)
        self.assertIs(rv, None)
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvv3d_d_(objc.simd.vector_double3(0.0, 1.5, 3.0))
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvv3d_d_(None, -557000000000.0)

        with self.assertRaises((TypeError, ValueError)):
            oc.clsvv3d_d_(objc.simd.vector_double3(0.0, 1.5, 3.0), None)
    ...
    def test_clsvv3f_(self):
        ...
        # Valid call
        rv = oc.clsvv3f_(objc.simd.vector_float3(0.0, 1.5, 3.0))
        self.assertIs(rv, None)
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvv3f_(objc.simd.vector_float3(0.0, 1.5, 3.0), "hello")
    ...
    def test_clsvv3f_v3f_(self):
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvv3f_v3f_(objc.simd.vector_float3(0.0, 1.5, 3.0))
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvv3f_v3f_(None, objc.simd.vector_float3(0.0, 1.5, 3.0))

        with self.assertRaises((TypeError, ValueError)):
            oc.clsvv3f_v3f_(objc.simd.vector_float3(0.0, 1.5, 3.0), None)
    ...
    def test_clsvv3f_d_(self):
        ...
        # Valid call
        rv = oc.clsvv3f_d_(objc.simd.vector_float3(0.0, 1.5, 3.0), -557000000000.0)
        self.assertIs(rv, None)
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvv3f_d_(objc.simd.vector_float3(0.0, 1.5, 3.0))
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvv3f_d_(None, -557000000000.0)

        with self.assertRaises((TypeError, ValueError)):
            oc.clsvv3f_d_(objc.simd.vector_float3(0.0, 1.5, 3.0), None)
    ...
    def test_clsvv4d_d_(self):
        ...
        # Valid call
        rv = oc.clsvv4d_d_(
            objc.simd.vector_double4(0.0, 1.5, 3.0, 4.5), -557000000000.0
        )
        self.assertIs(rv, None)
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvv4d_d_(objc.simd.vector_double4(0.0, 1.5, 3.0, 4.5))
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvv4d_d_(None, -557000000000.0)

        with self.assertRaises((TypeError, ValueError)):
            oc.clsvv4d_d_(objc.simd.vector_double4(0.0, 1.5, 3.0, 4.5), None)
    ...
    def test_clsvv4f_(self):
        ...
        # Valid call
        rv = oc.clsvv4f_(objc.simd.vector_float4(0.0, 1.5, 3.0, 4.5))
        self.assertIs(rv, None)
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvv4f_(objc.simd.vector_float4(0.0, 1.5, 3.0, 4.5), "hello")
    ...
    def test_clsvv4f_d_(self):
        ...
        # Valid call
        rv = oc.clsvv4f_d_(objc.simd.vector_float4(0.0, 1.5, 3.0, 4.5), -557000000000.0)
        self.assertIs(rv, None)
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvv4f_d_(objc.simd.vector_float4(0.0, 1.5, 3.0, 4.5))
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvv4f_d_(None, -557000000000.0)

        with self.assertRaises((TypeError, ValueError)):
            oc.clsvv4f_d_(objc.simd.vector_float4(0.0, 1.5, 3.0, 4.5), None)
    ...
    def test_clsvv4i_(self):
        ...
        # Valid call
        rv = oc.clsvv4i_(objc.simd.vector_int4(0, 1, 2, 3))
        self.assertIs(rv, None)
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvv4i_(objc.simd.vector_int4(0, 1, 2, 3), "hello")
    ...
    def test_clsvid_v2f_v2f_(self):
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvid_v2f_v2f_("hello", objc.simd.vector_float2(0.0, 1.5))
        ...
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvid_v2f_v2f_("hello", None, objc.simd.vector_float2(0.0, 1.5))

        with self.assertRaises((TypeError, ValueError)):
            oc.clsvid_v2f_v2f_("hello", objc.simd.vector_float2(0.0, 1.5), None)
    ...
    def test_clsvf_v2i_(self):
        ...
        # Valid call
        rv = oc.clsvf_v2i_(2500000000.0, objc.simd.vector_int2(0, 1))
        self.assertIs(rv, None)
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvf_v2i_(2500000000.0)

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvf_v2i_(2500000000.0, objc.simd.vector_int2(0, 1), "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvf_v2i_(None, objc.simd.vector_int2(0, 1))

        with self.assertRaises((TypeError, ValueError)):
            oc.clsvf_v2i_(2500000000.0, None)
    ...
    def test_clsvMDLAxisAlignedBoundingBox_(self):
        ...
        # Valid call
        rv = oc.clsvMDLAxisAlignedBoundingBox_(
            (
                objc.simd.vector_float3(-8.0, -9.0, -10.0),
                objc.simd.vector_float3(-11.0, -12.0, -13.0),
            )
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvMDLAxisAlignedBoundingBox_()
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvMDLAxisAlignedBoundingBox_(None)
    ...
    def test_clsvMDLAxisAlignedBoundingBox_Z_(self):
        ...
        # Valid call
        rv = oc.clsvMDLAxisAlignedBoundingBox_Z_(
            (
                objc.simd.vector_float3(-8.0, -9.0, -10.0),
                objc.simd.vector_float3(-11.0, -12.0, -13.0),
            ),
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsvMDLAxisAlignedBoundingBox_Z_(
                (
                    objc.simd.vector_float3(-8.0, -9.0, -10.0),
                    objc.simd.vector_float3(-11.0, -12.0, -13.0),
                )
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvMDLAxisAlignedBoundingBox_Z_(None, False)
    ...
    def test_clsvmatrixdouble4x4_(self):
        # Check that the signature is as expected
        self.assertResultHasType(OC_VectorCall.clsvmatrixdouble4x4_, b"v")
        self.assertArgHasType(
            OC_VectorCall.clsvmatrixdouble4x4_, 0, b"{_matrix_double4x4=[4<4d>]}"
        )
    ...
    def test_clsvmatrixdouble4x4_d_(self):
        # Check that the signature is as expected
        self.assertResultHasType(OC_VectorCall.clsvmatrixdouble4x4_d_, b"v")
        self.assertArgHasType(
            OC_VectorCall.clsvmatrixdouble4x4_d_, 0, b"{_matrix_double4x4=[4<4d>]}"
        )
        self.assertArgHasType(OC_VectorCall.clsvmatrixdouble4x4_d_, 1, b"d")
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvmatrixdouble4x4_d_(None, -557000000000.0)
    ...
    def test_clsvmatrixfloat2x2_(self):
        # Check that the signature is as expected
        self.assertResultHasType(OC_VectorCall.clsvmatrixfloat2x2_, b"v")
        self.assertArgHasType(
            OC_VectorCall.clsvmatrixfloat2x2_, 0, b"{_matrix_float2x2=[2<2f>]}"
        )
    ...
    def test_clsvmatrixfloat3x3_(self):
        # Check that the signature is as expected
        self.assertResultHasType(OC_VectorCall.clsvmatrixfloat3x3_, b"v")
        self.assertArgHasType(
            OC_VectorCall.clsvmatrixfloat3x3_, 0, b"{_matrix_float3x3=[3<3f>]}"
        )
    ...
    def test_clsvmatrixfloat4x4_(self):
        # Check that the signature is as expected
        self.assertResultHasType(OC_VectorCall.clsvmatrixfloat4x4_, b"v")
        self.assertArgHasType(
            OC_VectorCall.clsvmatrixfloat4x4_, 0, b"{_matrix_float4x4=[4<4f>]}"
        )
    ...
    def test_clsvmatrixfloat4x4_d_(self):
        # Check that the signature is as expected
        self.assertResultHasType(OC_VectorCall.clsvmatrixfloat4x4_d_, b"v")
        self.assertArgHasType(
            OC_VectorCall.clsvmatrixfloat4x4_d_, 0, b"{_matrix_float4x4=[4<4f>]}"
        )
        self.assertArgHasType(OC_VectorCall.clsvmatrixfloat4x4_d_, 1, b"d")
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvmatrixfloat4x4_d_(None, -557000000000.0)
    ...
    def test_clsvsimdfloat4x4_(self):
        ...
        self.assertArgHasType(
            OC_VectorCall.clsvsimdfloat4x4_, 0, b"{_simd_float4x4=[4<4f>]}"
        )
    ...
    def test_clsvsimdquatd_d_(self):
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvsimdquatd_d_(None, -557000000000.0)
    ...
    def test_clsvsimdquatf_v3f_(self):
        ...
        self.assertArgHasType(
            OC_VectorCall.clsvsimdquatf_v3f_, 0, b"{_simd_quatf=<4f>}"
        )
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvsimdquatf_v3f_(None, objc.simd.vector_float3(0.0, 1.5, 3.0))
    ...
    def test_clsvsimdquatf_d_(self):
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsvsimdquatf_d_(None, -557000000000.0)
    ...
    def test_clsGKTriangleQ_(self):
        ...
        # Valid call
        rv = oc.clsGKTriangleQ_(35184372088832)
        self.assertEqual(
            rv,
            (
                (
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsGKTriangleQ_(35184372088832, "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsGKTriangleQ_(None)
    ...
    def test_clsMDLAxisAlignedBoundingBox(self):
        ...
        # Valid call
        rv = oc.clsMDLAxisAlignedBoundingBox()
        self.assertEqual(
            rv,
            (
                objc.simd.vector_float3(-8.0, -9.0, -10.0),
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsMDLAxisAlignedBoundingBox("hello")
    ...
    def test_clsMDLAxisAlignedBoundingBoxv4i_(self):
        ...
        # Valid call
        rv = oc.clsMDLAxisAlignedBoundingBoxv4i_(objc.simd.vector_int4(0, 1, 2, 3))
        self.assertEqual(
            rv,
            (
                objc.simd.vector_float3(-8.0, -9.0, -10.0),
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsMDLAxisAlignedBoundingBoxv4i_()
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsMDLAxisAlignedBoundingBoxv4i_(None)
    ...
    def test_clsMDLAxisAlignedBoundingBoxd_(self):
        ...
        # Valid call
        rv = oc.clsMDLAxisAlignedBoundingBoxd_(-557000000000.0)
        self.assertEqual(
            rv,
            (
                objc.simd.vector_float3(-8.0, -9.0, -10.0),
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsMDLAxisAlignedBoundingBoxd_()

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsMDLAxisAlignedBoundingBoxd_(-557000000000.0, "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsMDLAxisAlignedBoundingBoxd_(None)
    ...
    def test_clsMDLVoxelIndexExtent(self):
        # Check that the signature is as expected
        self.assertResultHasType(
            OC_VectorCall.clsMDLVoxelIndexExtent, b"{_MDLVoxelIndexExtent=<4i><4i>}"
        )
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsMDLVoxelIndexExtent("hello")
    ...
    def test_clsMPSAxisAlignedBoundingBox(self):
        ...
        # Valid call
        rv = oc.clsMPSAxisAlignedBoundingBox()
        self.assertEqual(
            rv,
            (
                objc.simd.vector_float3(1.5, 2.5, 3.5),
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsMPSAxisAlignedBoundingBox("hello")
    ...
    def test_clsMPSImageHistogramInfo(self):
        ...
        # Valid call
        rv = oc.clsMPSImageHistogramInfo()
        self.assertEqual(
            rv,
            (
                4398046511104,
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsMPSImageHistogramInfo("hello")
    ...
    def test_clsmatrixdouble4x4(self):
        # Check that the signature is as expected
        self.assertResultHasType(
            OC_VectorCall.clsmatrixdouble4x4, b"{_matrix_double4x4=[4<4d>]}"
        )
    ...
    def test_clsmatrixdouble4x4d_(self):
        # Check that the signature is as expected
        self.assertResultHasType(
            OC_VectorCall.clsmatrixdouble4x4d_, b"{_matrix_double4x4=[4<4d>]}"
        )
        self.assertArgHasType(OC_VectorCall.clsmatrixdouble4x4d_, 0, b"d")
        ...
        # Valid call
        rv = oc.clsmatrixdouble4x4d_(-557000000000.0)
        self.assertEqual(
            rv,
            simd.matrix_double4x4(
                (
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsmatrixdouble4x4d_()

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsmatrixdouble4x4d_(-557000000000.0, "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsmatrixdouble4x4d_(None)
    ...
    def test_clsmatrixfloat2x2(self):
        # Check that the signature is as expected
        self.assertResultHasType(
            OC_VectorCall.clsmatrixfloat2x2, b"{_matrix_float2x2=[2<2f>]}"
        )
    ...
    def test_clsmatrixfloat3x3(self):
        # Check that the signature is as expected
        self.assertResultHasType(
            OC_VectorCall.clsmatrixfloat3x3, b"{_matrix_float3x3=[3<3f>]}"
        )
    ...
    def test_clsmatrixfloat4x4(self):
        # Check that the signature is as expected
        self.assertResultHasType(
            OC_VectorCall.clsmatrixfloat4x4, b"{_matrix_float4x4=[4<4f>]}"
        )
    ...
    def test_clsmatrixfloat4x4id_d_(self):
        # Check that the signature is as expected
        self.assertResultHasType(
            OC_VectorCall.clsmatrixfloat4x4id_d_, b"{_matrix_float4x4=[4<4f>]}"
        )
        self.assertArgHasType(OC_VectorCall.clsmatrixfloat4x4id_d_, 0, b"@")
        self.assertArgHasType(OC_VectorCall.clsmatrixfloat4x4id_d_, 1, b"d")
        ...
        # Valid call
        rv = oc.clsmatrixfloat4x4id_d_("hello", -557000000000.0)
        self.assertEqual(
            rv,
            simd.matrix_float4x4(
                (
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsmatrixfloat4x4id_d_("hello")

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsmatrixfloat4x4id_d_("hello", -557000000000.0, "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsmatrixfloat4x4id_d_(NoObjCValueObject, -557000000000.0)

        with self.assertRaises((TypeError, ValueError)):
            oc.clsmatrixfloat4x4id_d_("hello", None)
    ...
    def test_clsmatrixfloat4x4d_(self):
        # Check that the signature is as expected
        self.assertResultHasType(
            OC_VectorCall.clsmatrixfloat4x4d_, b"{_matrix_float4x4=[4<4f>]}"
        )
        self.assertArgHasType(OC_VectorCall.clsmatrixfloat4x4d_, 0, b"d")
        ...
        # Valid call
        rv = oc.clsmatrixfloat4x4d_(-557000000000.0)
        self.assertEqual(
            rv,
            simd.matrix_float4x4(
                (
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsmatrixfloat4x4d_()

        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clsmatrixfloat4x4d_(-557000000000.0, "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clsmatrixfloat4x4d_(None)
    ...
    def test_clssimdfloat4x4simdfloat4x4_id_(self):
        ...
        self.assertArgHasType(
            OC_VectorCall.clssimdfloat4x4simdfloat4x4_id_,
            0,
        ...
        # Valid call
        rv = oc.clssimdfloat4x4simdfloat4x4_id_(
            simd.simd_float4x4(
                (
                    objc.simd.vector_float4(0.0, 1.5, 3.0, 4.5),
                    objc.simd.vector_float4(0.0, 1.5, 3.0, 4.5),
        ...
        # Too few arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clssimdfloat4x4simdfloat4x4_id_(
                simd.simd_float4x4(
                    (
                        objc.simd.vector_float4(0.0, 1.5, 3.0, 4.5),
                        objc.simd.vector_float4(0.0, 1.5, 3.0, 4.5),
        ...
        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clssimdfloat4x4simdfloat4x4_id_(None, "hello")
    ...
    def test_clssimdquatdd_(self):
        ...
        # Valid call
        rv = oc.clssimdquatdd_(-557000000000.0)
        self.assertEqual(
            rv, simd.simd_quatd(objc.simd.vector_double4(0.0, 1.5, 3.0, 4.5))
        )
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clssimdquatdd_(-557000000000.0, "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clssimdquatdd_(None)
    ...
    def test_clssimdquatfd_(self):
        ...
        # Valid call
        rv = oc.clssimdquatfd_(-557000000000.0)
        self.assertEqual(
            rv, simd.simd_quatf(objc.simd.vector_float4(0.0, 1.5, 3.0, 4.5))
        )
        ...
        # Too many arguments call
        with self.assertRaisesRegex(TypeError, "expected.*arguments.*got"):
            oc.clssimdquatfd_(-557000000000.0, "hello")

        # Bad value for arguments
        with self.assertRaises((TypeError, ValueError)):
            oc.clssimdquatfd_(None)
