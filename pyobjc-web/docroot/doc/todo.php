<?
    ...
    include "header.inc";
?>
<div class="document" id="todo-list">
...
<li><a class="reference" href="#copy" id="id14" name="id14"><tt class="literal"><span class="pre">-copy</span></tt></a></li>
...
<h1><a class="toc-backref" href="#id3" name="important-items">Important items</a></h1>
<div class="section" id="better-documentation">
<h2><a class="toc-backref" href="#id4" name="better-documentation">Better documentation</a></h2>
<ul class="simple">
...
<h2><a class="toc-backref" href="#id5" name="test-suite">Test suite</a></h2>
...
of PyObjC.</li>
<li>tests for all functions in <tt class="literal"><span class="pre">Modules/*/*Mapping*.m</span></tt>
(including IMPs)</li>
...
<h1><a class="toc-backref" href="#id6" name="less-important-items">Less important items</a></h1>
<div class="section" id="refactor-some-parts-of-the-bridge">
<h2><a class="toc-backref" href="#id7" name="refactor-some-parts-of-the-bridge">Refactor some parts of the bridge</a></h2>
...
Objective-C.</li>
<li>Remove the need for <tt class="literal"><span class="pre">pyobjc_classMethods</span></tt>, you should be able to call
...
<li>We've several types that wrap pointer values, such as <tt class="literal"><span class="pre">SessionWrapper</span></tt> in
<tt class="literal"><span class="pre">Modules/AppKit</span></tt>. Should add a function for creating these types, 
possibly exposed to C code.</li>
</ul>
</div>
<div class="section" id="support-for-gnustep">
<h2><a class="toc-backref" href="#id8" name="support-for-gnustep">Support for GNUstep</a></h2>
...
<h2><a class="toc-backref" href="#id9" name="plugin-bundles">Plugin bundles</a></h2>
<p>Allow for more than one class to show up in the bundle via
<tt class="literal"><span class="pre">+[NSBundle</span> <span class="pre">bundleForClass:]</span></tt>.  The implementation of this would statically
...
<h2><a class="toc-backref" href="#id10" name="project-templates">Project templates</a></h2>
...
<h2><a class="toc-backref" href="#id11" name="complete-cocoa-wrapping">Complete Cocoa wrapping</a></h2>
...
<h2><a class="toc-backref" href="#id12" name="pickle-support">Pickle support</a></h2>
...
<h2><a class="toc-backref" href="#id13" name="nscoder-support">NSCoder support</a></h2>
<p>It might be useful to add default implementations of <tt class="literal"><span class="pre">encodeWithCoder:</span></tt> and
<tt class="literal"><span class="pre">initWithCoder:</span></tt> methods to Python subclasses of Objective-C classes that 
implement these.  Note that property list types should already be serializable
(<tt class="literal"><span class="pre">int</span></tt>, <tt class="literal"><span class="pre">long</span></tt>, <tt class="literal"><span class="pre">unicode</span></tt>, <tt class="literal"><span class="pre">list</span></tt>, <tt class="literal"><span class="pre">tuple</span></tt>, <tt class="literal"><span class="pre">dict</span></tt>).</p>
<p>See also <cite>Pickle support</cite>.</p>
</div>
<div class="section" id="copy">
<h2><a class="toc-backref" href="#id14" name="copy"><tt class="literal"><span class="pre">-copy</span></tt></a></h2>
<p>There are issues with implementing <tt class="literal"><span class="pre">-copy</span></tt> in python, these need to be fixed.</p>
<p>Specifically, overriding an existing <tt class="literal"><span class="pre">-copy</span></tt> implementation does not work 
unless <tt class="literal"><span class="pre">__slots__</span> <span class="pre">==</span> <span class="pre">()</span></tt></p>
</div>
<div class="section" id="known-issues">
<h2><a class="toc-backref" href="#id15" name="known-issues">Known issues</a></h2>
...
<h2><a class="toc-backref" href="#id16" name="code-cleanup">Code cleanup</a></h2>
<ul class="simple">
...
<li>SessionWrapper (in <tt class="literal"><span class="pre">Modules/AppKit</span></tt>) is one of several types that wrap 
a single pointer, create a function to build such types (similar to
<tt class="literal"><span class="pre">Modules/objc/struct-wrapper.m</span></tt>)</li>
<li>Use the <tt class="literal"><span class="pre">CArray</span></tt> API whenever appropriate.</li>
</ul>
</div>
<div class="section" id="cleanup-examples">
<h2><a class="toc-backref" href="#id17" name="cleanup-examples">Cleanup Examples</a></h2>
...
<h2><a class="toc-backref" href="#id18" name="performance-tuning-testing">Performance tuning/testing</a></h2>
...
<h2><a class="toc-backref" href="#id19" name="add-freelists">Add freelists</a></h2>
...
<h2><a class="toc-backref" href="#id20" name="formal-protocols-distributed-objects">Formal Protocols, Distributed Objects</a></h2>
<p><tt class="literal"><span class="pre">DO</span></tt> seems to use formal protocols, we don't fully support those. There is 
an equivalent to <tt class="literal"><span class="pre">&#64;protocol(Foo)</span></tt>, but it is not yet possible to define
new protocols in Python.</p>
</div>
<div class="section" id="links-to-apple-documentation">
<h2><a class="toc-backref" href="#id21" name="links-to-apple-documentation">Links to Apple documentation</a></h2>
...
<h2><a class="toc-backref" href="#id22" name="implement-more-of-nsmutabledictionary-in-oc-pythondictionary">Implement more of NSMutableDictionary in OC_PythonDictionary</a></h2>
...
<h2><a class="toc-backref" href="#id23" name="clean-up-oc-pythonobject">Clean up OC_PythonObject</a></h2>
<p>The code is a mess.</p>
</div>
<div class="section" id="rewrite-scripts-find-raw-pointers-py">
<h2><a class="toc-backref" href="#id24" name="rewrite-scripts-find-raw-pointers-py">Rewrite scripts/find-raw-pointers.py</a></h2>
...
<h2><a class="toc-backref" href="#id25" name="finish-struct-wrapper-m">Finish struct-wrapper.m</a></h2>
...
<h2><a class="toc-backref" href="#id26" name="finish-refactoring-of-the-code-generator-scripts">Finish refactoring of the code-generator scripts</a></h2>
<ol class="arabic simple">
<li>Change code-generator scripts to use loadBundleFunctions, etc.</li>
<li>Move the code-generator scripts to <tt class="literal"><span class="pre">PyObjCTools</span></tt>, to make it easier
for others to generate wrappers.</li>
<li>Install <tt class="literal"><span class="pre">pyobjc-api.h</span></tt>.</li>
</ol>
</div>
<div class="section" id="setup-py-cleanup">
<h2><a class="toc-backref" href="#id27" name="setup-py-cleanup">setup.py cleanup</a></h2>
<ul class="simple">
...
<h2><a class="toc-backref" href="#id28" name="unique-proxies-for-python-objects">Unique proxies for Python objects</a></h2>
<p>Some Cocoa/CoreFoundation API's basically require that <tt class="literal"><span class="pre">a[0]</span> <span class="pre">is</span> <span class="pre">a[0]</span></tt>. The
...
<h2><a class="toc-backref" href="#id29" name="nsdecimal-vs-decimal">NSDecimal vs decimal</a></h2>
<p>Check if it is possible to wrap <tt class="literal"><span class="pre">NSDecimal</span></tt> using <tt class="literal"><span class="pre">decimal</span></tt> (and v.v.).</p>
<p>Only implement this when it is possible to convert without loss of information.</p>
</div>
<div class="section" id="nsset-vs-set">
<h2><a class="toc-backref" href="#id30" name="nsset-vs-set">NSSet vs set</a></h2>
<p>Check if it is possible to wrap <tt class="literal"><span class="pre">NSSet</span></tt> using <tt class="literal"><span class="pre">set</span></tt> (and v.v.).</p>
<p>Only implement this when it is possible to convert without loss of information.</p>
</div>
<div class="section" id="python-2-4">
<h2><a class="toc-backref" href="#id31" name="python-2-4">Python 2.4</a></h2>
...
<h2><a class="toc-backref" href="#id32" name="nslog-stringwithformat">NSLog, stringWithFormat, ...</a></h2>
