...
<ol class="arabic">
<li><p class="first">Make a copy of <tt class="docutils literal"><span class="pre">/Developer/Examples/AppKit/SimpleComboBox</span></tt> to work on.
Let's call this <tt class="docutils literal"><span class="pre">SimpleComboBoxPlus</span></tt>:</p>
...
<tt class="docutils literal"><span class="pre">SimpleComboBoxPlus</span></tt> folder.</blockquote>
...
<dt>We now need to write the code implementing the <tt class="docutils literal"><span class="pre">ITunesCommunication</span></tt></dt>
...
simply copy <tt class="docutils literal"><span class="pre">src/ITunesCommunication_1.py</span></tt> to <tt class="docutils literal"><span class="pre">ITunesCommunication.py</span></tt>.</p>
</dd>
</dl>
</li>
...
<p>You may also copy this file from <tt class="docutils literal"><span class="pre">src/setup.py</span></tt>.</p>
</li>
...
<p>You may also copy a full main.m from <tt class="docutils literal"><span class="pre">src/main.m</span></tt>.  This code ensures
