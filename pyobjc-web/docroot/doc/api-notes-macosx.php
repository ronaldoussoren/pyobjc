...
<li><a class="reference" href="#class-nsbitmapimagerep" id="id9" name="id9">Class <tt class="docutils literal"><span class="pre">NSBitmapImageRep</span></tt></a></li>
<li><a class="reference" href="#class-nsfont" id="id10" name="id10">Class <tt class="docutils literal"><span class="pre">NSFont</span></tt></a></li>
<li><a class="reference" href="#class-nsgraphicscontext" id="id11" name="id11">Class <tt class="docutils literal"><span class="pre">NSGraphicsContext</span></tt></a></li>
<li><a class="reference" href="#class-nslayoutmanager" id="id12" name="id12">Class <tt class="docutils literal"><span class="pre">NSLayoutManager</span></tt></a></li>
<li><a class="reference" href="#class-nsmatrix" id="id13" name="id13">Class <tt class="docutils literal"><span class="pre">NSMatrix</span></tt></a></li>
<li><a class="reference" href="#class-nsmovie" id="id14" name="id14">Class <tt class="docutils literal"><span class="pre">NSMovie</span></tt></a></li>
<li><a class="reference" href="#class-nsopenglcontext" id="id15" name="id15">Class <tt class="docutils literal"><span class="pre">NSOpenGLContext</span></tt></a></li>
<li><a class="reference" href="#class-nsopenglpixelformat" id="id16" name="id16">Class <tt class="docutils literal"><span class="pre">NSOpenGLPixelFormat</span></tt></a></li>
<li><a class="reference" href="#class-nsquickdrawview" id="id17" name="id17">Class <tt class="docutils literal"><span class="pre">NSQuickDrawView</span></tt></a></li>
<li><a class="reference" href="#class-nssimplehorizontaltypesetter" id="id18" name="id18">Class <tt class="docutils literal"><span class="pre">NSSimpleHorizontalTypesetter</span></tt></a></li>
<li><a class="reference" href="#class-nsview" id="id19" name="id19">Class <tt class="docutils literal"><span class="pre">NSView</span></tt></a></li>
<li><a class="reference" href="#class-nswindow" id="id20" name="id20">Class <tt class="docutils literal"><span class="pre">NSWindow</span></tt></a></li>
</ul>
</li>
<li><a class="reference" href="#foundation-framework" id="id21" name="id21">Foundation framework</a><ul>
<li><a class="reference" href="#class-nsarray" id="id22" name="id22">Class <tt class="docutils literal"><span class="pre">NSArray</span></tt></a></li>
<li><a class="reference" href="#class-nsautoreleasepool" id="id23" name="id23">Class <tt class="docutils literal"><span class="pre">NSAutoreleasePool</span></tt></a></li>
<li><a class="reference" href="#class-nsbundle" id="id24" name="id24">Class <tt class="docutils literal"><span class="pre">NSBundle</span></tt></a></li>
<li><a class="reference" href="#class-nscoder" id="id25" name="id25">Class <tt class="docutils literal"><span class="pre">NSCoder</span></tt></a></li>
<li><a class="reference" href="#class-nsdata" id="id26" name="id26">Class <tt class="docutils literal"><span class="pre">NSData</span></tt></a></li>
<li><a class="reference" href="#class-nsdecimalnumber-and-the-nsdecimal-type" id="id27" name="id27">Class <tt class="docutils literal"><span class="pre">NSDecimalNumber</span></tt> and the <tt class="docutils literal"><span class="pre">NSDecimal</span></tt> type</a></li>
<li><a class="reference" href="#class-nsdictionary" id="id28" name="id28">Class <tt class="docutils literal"><span class="pre">NSDictionary</span></tt></a></li>
<li><a class="reference" href="#class-nsexception" id="id29" name="id29">Class <tt class="docutils literal"><span class="pre">NSException</span></tt></a></li>
<li><a class="reference" href="#class-nsfault" id="id30" name="id30">Class <tt class="docutils literal"><span class="pre">NSFault</span></tt></a></li>
<li><a class="reference" href="#class-nsindexset" id="id31" name="id31">Class <tt class="docutils literal"><span class="pre">NSIndexSet</span></tt></a></li>
<li><a class="reference" href="#class-nsinvocation" id="id32" name="id32">Class <tt class="docutils literal"><span class="pre">NSInvocation</span></tt></a></li>
<li><a class="reference" href="#class-nsmutablearray" id="id33" name="id33">Class <tt class="docutils literal"><span class="pre">NSMutableArray</span></tt></a></li>
<li><a class="reference" href="#class-nsmutablestring" id="id34" name="id34">Class <tt class="docutils literal"><span class="pre">NSMutableString</span></tt></a></li>
<li><a class="reference" href="#class-nsnetservice" id="id35" name="id35">Class <tt class="docutils literal"><span class="pre">NSNetService</span></tt></a></li>
<li><a class="reference" href="#class-nsobject" id="id36" name="id36">Class <tt class="docutils literal"><span class="pre">NSObject</span></tt></a></li>
<li><a class="reference" href="#class-nsscriptobjectspecifier" id="id37" name="id37">Class <tt class="docutils literal"><span class="pre">NSScriptObjectSpecifier</span></tt></a></li>
<li><a class="reference" href="#class-nsset" id="id38" name="id38">Class <tt class="docutils literal"><span class="pre">NSSet</span></tt></a></li>
<li><a class="reference" href="#class-nsstring" id="id39" name="id39">Class <tt class="docutils literal"><span class="pre">NSString</span></tt></a></li>
<li><a class="reference" href="#class-nsthread" id="id40" name="id40">class <tt class="docutils literal"><span class="pre">NSThread</span></tt></a></li>
</ul>
</li>
<li><a class="reference" href="#interfacebuilder-framework" id="id41" name="id41">InterfaceBuilder framework</a><ul>
<li><a class="reference" href="#class-ibobjcsourceparser" id="id42" name="id42">Class <tt class="docutils literal"><span class="pre">IBObjCSourceParser</span></tt></a></li>
<li><a class="reference" href="#id1" id="id43" name="id43">Class <tt class="docutils literal"><span class="pre">NSView</span></tt></a></li>
<li><a class="reference" href="#class-nsibobjectdata" id="id44" name="id44">Class <tt class="docutils literal"><span class="pre">NSIBObjectData</span></tt></a></li>
<li><a class="reference" href="#class-ibobjectcontainer" id="id45" name="id45">Class <tt class="docutils literal"><span class="pre">IBObjectContainer</span></tt></a></li>
<li><a class="reference" href="#class-ibxmldecoder" id="id46" name="id46">Class <tt class="docutils literal"><span class="pre">IBXMLDecoder</span></tt></a></li>
<li><a class="reference" href="#class-ibsplitscrollview" id="id47" name="id47">Class <tt class="docutils literal"><span class="pre">IBSplitScrollView</span></tt></a></li>
</ul>
</li>
...
<li><a class="reference" href="#class-screensaverdefaults" id="id50" name="id50">Class <tt class="docutils literal"><span class="pre">ScreenSaverDefaults</span></tt></a></li>
<li><a class="reference" href="#class-screensaverview" id="id51" name="id51">Class <tt class="docutils literal"><span class="pre">ScreenSaverView</span></tt></a></li>
</ul>
</li>
</ul>
</div>
...
<h4><a class="toc-backref" href="#id4" name="class-protocol">Class Protocol</a></h4>
<ul>
<li><p class="first"><tt class="docutils literal"><span class="pre">descriptionForClassMethod:</span></tt>, <tt class="docutils literal"><span class="pre">descriptionForInstanceMethod</span></tt></p>
...
<h3><a class="toc-backref" href="#id5" name="addressbook-framework">Addressbook framework</a></h3>
...
<h3><a class="toc-backref" href="#id6" name="appkit-framework">AppKit framework</a></h3>
...
<h4><a class="toc-backref" href="#id7" name="class-nsapplication">Class NSApplication</a></h4>
<p><tt class="docutils literal"><span class="pre">NSModalSession</span></tt> objects are wrapped as opaque values. You can check if
two wrapper objects refer to the same session object by comparing their
<tt class="docutils literal"><span class="pre">ptr</span></tt> attributes.</p>
</div>
<div class="section" id="class-nsbezierpath">
<h4><a class="toc-backref" href="#id8" name="class-nsbezierpath">Class NSBezierPath</a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id9" name="class-nsbitmapimagerep">Class <tt class="docutils literal"><span class="pre">NSBitmapImageRep</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id10" name="class-nsfont">Class <tt class="docutils literal"><span class="pre">NSFont</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id11" name="class-nsgraphicscontext">Class <tt class="docutils literal"><span class="pre">NSGraphicsContext</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id12" name="class-nslayoutmanager">Class <tt class="docutils literal"><span class="pre">NSLayoutManager</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id13" name="class-nsmatrix">Class <tt class="docutils literal"><span class="pre">NSMatrix</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id14" name="class-nsmovie">Class <tt class="docutils literal"><span class="pre">NSMovie</span></tt></a></h4>
...
<h4><a class="toc-backref" href="#id15" name="class-nsopenglcontext">Class <tt class="docutils literal"><span class="pre">NSOpenGLContext</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id16" name="class-nsopenglpixelformat">Class <tt class="docutils literal"><span class="pre">NSOpenGLPixelFormat</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id17" name="class-nsquickdrawview">Class <tt class="docutils literal"><span class="pre">NSQuickDrawView</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id18" name="class-nssimplehorizontaltypesetter">Class <tt class="docutils literal"><span class="pre">NSSimpleHorizontalTypesetter</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id19" name="class-nsview">Class <tt class="docutils literal"><span class="pre">NSView</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id20" name="class-nswindow">Class <tt class="docutils literal"><span class="pre">NSWindow</span></tt></a></h4>
<ul>
<li><p class="first"><tt class="docutils literal"><span class="pre">graphicsPort</span></tt></p>
<p>This method is not yet supported</p>
</li>
...
<h3><a class="toc-backref" href="#id21" name="foundation-framework">Foundation framework</a></h3>
...
<p>The <tt class="docutils literal"><span class="pre">-forward::</span></tt> method is not supported. It's functionality can be accessed
using the python function <tt class="docutils literal"><span class="pre">apply</span></tt>. The <tt class="docutils literal"><span class="pre">performv::</span></tt> method is also not
...
<h4><a class="toc-backref" href="#id22" name="class-nsarray">Class <tt class="docutils literal"><span class="pre">NSArray</span></tt></a></h4>
<ul>
<li><p class="first"><tt class="docutils literal"><span class="pre">initWithObjects:</span></tt>, <tt class="docutils literal"><span class="pre">arrayWithObjects:</span></tt></p>
<p>These methods are not supported, use <tt class="docutils literal"><span class="pre">initWithArray:</span></tt> instead.</p>
</li>
...
<h4><a class="toc-backref" href="#id23" name="class-nsautoreleasepool">Class <tt class="docutils literal"><span class="pre">NSAutoreleasePool</span></tt></a></h4>
...
<h4><a class="toc-backref" href="#id24" name="class-nsbundle">Class <tt class="docutils literal"><span class="pre">NSBundle</span></tt></a></h4>
<ul>
<li><p class="first"><tt class="docutils literal"><span class="pre">bundleForClass:</span></tt></p>
<p>This method does not work correctly for classes defined in Python, these
all seem be defined in the <tt class="docutils literal"><span class="pre">mainBundle()</span></tt>. As a workaround for plugin
bundles built with py2app, you can declare <tt class="docutils literal"><span class="pre">__bundle_hack__</span> <span class="pre">=</span> <span class="pre">True</span></tt>
on one class in the bundle (probably the NSPrincipalClass).  For this
class, <tt class="docutils literal"><span class="pre">bundleForClass:</span></tt> will return the expected value.  See
Examples/Plugins for examples of this.</p>
</li>
</ul>
</div>
<div class="section" id="class-nscoder">
<h4><a class="toc-backref" href="#id25" name="class-nscoder">Class <tt class="docutils literal"><span class="pre">NSCoder</span></tt></a></h4>
...
<p>Use multiple calls to <tt class="docutils literal"><span class="pre">decodeValueOfObjCType:at:</span></tt> instead. Note that
...
<h4><a class="toc-backref" href="#id26" name="class-nsdata">Class <tt class="docutils literal"><span class="pre">NSData</span></tt></a></h4>
<ul>
...
<li><p class="first"><tt class="docutils literal"><span class="pre">getBytes:</span></tt>, <tt class="docutils literal"><span class="pre">getBytes:length:</span></tt>, <tt class="docutils literal"><span class="pre">getBytes:range:</span></tt>
Use <tt class="docutils literal"><span class="pre">bytes</span></tt> instead, and then use subscripting to get the
desired range.</p>
</li>
</ul>
</div>
<div class="section" id="class-nsdecimalnumber-and-the-nsdecimal-type">
<h4><a class="toc-backref" href="#id27" name="class-nsdecimalnumber-and-the-nsdecimal-type">Class <tt class="docutils literal"><span class="pre">NSDecimalNumber</span></tt> and the <tt class="docutils literal"><span class="pre">NSDecimal</span></tt> type</a></h4>
...
<h4><a class="toc-backref" href="#id28" name="class-nsdictionary">Class <tt class="docutils literal"><span class="pre">NSDictionary</span></tt></a></h4>
...
<h4><a class="toc-backref" href="#id29" name="class-nsexception">Class <tt class="docutils literal"><span class="pre">NSException</span></tt></a></h4>
<ul>
...
arguments. Use Python's <tt class="docutils literal"><span class="pre">%</span></tt> operator to format the message.</p>
</li>
</ul>
</div>
<div class="section" id="class-nsfault">
<h4><a class="toc-backref" href="#id30" name="class-nsfault">Class <tt class="docutils literal"><span class="pre">NSFault</span></tt></a></h4>
...
<h4><a class="toc-backref" href="#id31" name="class-nsindexset">Class <tt class="docutils literal"><span class="pre">NSIndexSet</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id32" name="class-nsinvocation">Class <tt class="docutils literal"><span class="pre">NSInvocation</span></tt></a></h4>
...
be present in 3th party code. This leads to problems when <tt class="docutils literal"><span class="pre">forwardInvocation:</span></tt>
is used to call a method that has such a struct as one of its arguments.</p>
</div>
<div class="section" id="class-nsmutablearray">
<h4><a class="toc-backref" href="#id33" name="class-nsmutablearray">Class <tt class="docutils literal"><span class="pre">NSMutableArray</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id34" name="class-nsmutablestring">Class <tt class="docutils literal"><span class="pre">NSMutableString</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id35" name="class-nsnetservice">Class <tt class="docutils literal"><span class="pre">NSNetService</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id36" name="class-nsobject">Class <tt class="docutils literal"><span class="pre">NSObject</span></tt></a></h4>
<ul>
...
instance methods: you have to pass <tt class="docutils literal"><span class="pre">self</span></tt> and the method arguments.</p>
...
<h4><a class="toc-backref" href="#id37" name="class-nsscriptobjectspecifier">Class <tt class="docutils literal"><span class="pre">NSScriptObjectSpecifier</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id38" name="class-nsset">Class <tt class="docutils literal"><span class="pre">NSSet</span></tt></a></h4>
<ul>
<li><p class="first"><tt class="docutils literal"><span class="pre">initWithObjects:</span></tt>, <tt class="docutils literal"><span class="pre">setWithObjects:</span></tt></p>
<p>This method is not supported, use <tt class="docutils literal"><span class="pre">initWithArray:</span></tt> instead.</p>
</li>
</ul>
</div>
<div class="section" id="class-nsstring">
<h4><a class="toc-backref" href="#id39" name="class-nsstring">Class <tt class="docutils literal"><span class="pre">NSString</span></tt></a></h4>
<p>Objective-C strings are usually represented as instances of a subclass of
the Python type <tt class="docutils literal"><span class="pre">unicode</span></tt>. It is possible to access the &quot;real&quot; Objective-C
string by using the method <tt class="docutils literal"><span class="pre">NSString</span></tt>. This should only be necessary when
...
<h4><a class="toc-backref" href="#id40" name="class-nsthread">class <tt class="docutils literal"><span class="pre">NSThread</span></tt></a></h4>
...
<tt class="docutils literal"><span class="pre">thread</span></tt> or <tt class="docutils literal"><span class="pre">threading</span></tt> module, or called <tt class="docutils literal"><span class="pre">objc.enableThreading</span></tt> before
...
<h3><a class="toc-backref" href="#id41" name="interfacebuilder-framework">InterfaceBuilder framework</a></h3>
...
<h4><a class="toc-backref" href="#id42" name="class-ibobjcsourceparser">Class <tt class="docutils literal"><span class="pre">IBObjCSourceParser</span></tt></a></h4>
<ul class="simple">
<li><tt class="docutils literal"><span class="pre">parseClass:</span></tt></li>
</ul>
</div>
<div class="section" id="id1">
<h4><a class="toc-backref" href="#id43" name="id1">Class <tt class="docutils literal"><span class="pre">NSView</span></tt></a></h4>
<ul>
...
<h4><a class="toc-backref" href="#id44" name="class-nsibobjectdata">Class <tt class="docutils literal"><span class="pre">NSIBObjectData</span></tt></a></h4>
<ul class="simple">
...
<h4><a class="toc-backref" href="#id45" name="class-ibobjectcontainer">Class <tt class="docutils literal"><span class="pre">IBObjectContainer</span></tt></a></h4>
<ul class="simple">
...
<h4><a class="toc-backref" href="#id46" name="class-ibxmldecoder">Class <tt class="docutils literal"><span class="pre">IBXMLDecoder</span></tt></a></h4>
<ul class="simple">
...
<h4><a class="toc-backref" href="#id47" name="class-ibsplitscrollview">Class <tt class="docutils literal"><span class="pre">IBSplitScrollView</span></tt></a></h4>
<ul class="simple">
...
<h3><a class="toc-backref" href="#id48" name="preferencepanes-framework">PreferencePanes framework</a></h3>
...
<h3><a class="toc-backref" href="#id49" name="screensaver-framework">ScreenSaver framework</a></h3>
<div class="section" id="class-screensaverdefaults">
<h4><a class="toc-backref" href="#id50" name="class-screensaverdefaults">Class <tt class="docutils literal"><span class="pre">ScreenSaverDefaults</span></tt></a></h4>
<p>This class is fully supported.</p>
</div>
<div class="section" id="class-screensaverview">
<h4><a class="toc-backref" href="#id51" name="class-screensaverview">Class <tt class="docutils literal"><span class="pre">ScreenSaverView</span></tt></a></h4>
<p>This class is fully supported.</p>
</div>
</div>
</div>
