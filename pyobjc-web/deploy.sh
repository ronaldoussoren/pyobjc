...
# server.
rsync --progress -C -e ssh --delete  -v -z -rltgoD --exclude 'cvs-snapshots' docroot/ "${1:-ronaldoussoren}@shell.sourceforge.net:/home/groups/p/py/pyobjc/htdocs/"
...
ssh "${1:-ronaldoussoren}@shell.sourceforge.net" "chmod -R g+w /home/groups/p/py/pyobjc/htdocs  2>/dev/null"
