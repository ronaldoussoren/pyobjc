...
objc.registerNewKeywordsFromSelector("MEAddressAnnotation", b"init")
objc.registerNewKeywordsFromSelector("MEComposeSession", b"init")
objc.registerNewKeywordsFromSelector("MEDecodedMessage", b"init")
...
objc.registerNewKeywordsFromSelector("MEDecodedMessageBanner", b"init")
objc.registerNewKeywordsFromSelector(
    "MEDecodedMessageBanner", b"initWithTitle:primaryActionTitle:dismissable:"
)
objc.registerNewKeywordsFromSelector("MEEmailAddress", b"init")
...
objc.registerNewKeywordsFromSelector("MEExtensionManager", b"init")
objc.registerNewKeywordsFromSelector("MEMessage", b"init")
objc.registerNewKeywordsFromSelector("MEMessageAction", b"init")
objc.registerNewKeywordsFromSelector("MEMessageActionDecision", b"init")
objc.registerNewKeywordsFromSelector("MEMessageEncodingResult", b"init")
objc.registerNewKeywordsFromSelector(
    "MEMessageEncodingResult", b"initWithEncodedMessage:signingError:encryptionError:"
)
objc.registerNewKeywordsFromSelector("MEMessageSecurityInformation", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("MEMessageSigner", b"init")
objc.registerNewKeywordsFromSelector(
    "MEMessageSigner", b"initWithEmailAddresses:signatureLabel:context:"
)
objc.registerNewKeywordsFromSelector("MEOutgoingMessageEncodingStatus", b"init")
objc.registerNewKeywordsFromSelector(
    "MEOutgoingMessageEncodingStatus",
    b"initWithCanSign:canEncrypt:securityError:addressesFailingEncryption:",
)

objc.registerNewKeywords("MEMessageAction", ("flag",), "flagActionWithFlag_")
objc.registerNewKeywords(
    "MEMessageAction", ("color",), "setBackgroundColorActionWithColor_"
)
expressions = {}
formal_protocols = {
    "MEComposeSessionHandler": "MEComposeSessionHandler",
    "MEContentBlocker": "MEContentBlocker",
    "MEExtension": "MEExtension",
    "MEMessageActionHandler": "MEMessageActionHandler",
    "MEMessageDecoder": "MEMessageDecoder",
    "MEMessageEncoder": "MEMessageEncoder",
    "MEMessageSecurityHandler": "MEMessageSecurityHandler",
}
