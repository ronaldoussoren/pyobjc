...
class TestPKError(TestCase):
    def test_enums(self):
        ...
        self.assertIsEnumType(PassKit.PKPaymentErrorCode)
        ...
        self.assertIsEnumType(PassKit.PKPassKitErrorCode)
        ...
        self.assertIsEnumType(PassKit.PKAddSecureElementPassErrorCode)
