...
#
# Last update: Sun Aug 16 11:48:19 2026
#
# flake8: noqa
...
try:
    ...
    r(b"NSObject", b"issuerIdentifiers", {"required": True, "retval": {"type": b"@"}})
    r(
        b"NSObject",
    ...
    r(
        b"PKPassLibrary",
        b"addPassesFromArchiveAtFileURL:completionHandler:",
        {
            "arguments": {
                3: {
                    "callable": {
    ...
    r(
        b"PKPassLibrary",
        b"addPassesFromArchiveWithData:completionHandler:",
        {
            "arguments": {
                3: {
                    "callable": {
    ...
    r(
        b"PKPassLibrary",
        b"addPassesWithData:completionHandler:",
        {
            "arguments": {
                3: {
                    "callable": {
    ...
    r(b"PKSecureElementPass", b"isProvisioningAvailable", {"retval": {"type": b"Z"}})
    r(
...
expressions = {}
formal_protocols = {
    "PKIdentityDocumentDescriptor": "PKIdentityDocumentDescriptor",
    "PKIssuerProvisioningExtensionAuthorizationProviding": "PKIssuerProvisioningExtensionAuthorizationProviding",
    ...
    "PKPaymentInformationRequestHandling": "PKPaymentInformationRequestHandling",
    "PKVehicleConnectionDelegate": "PKVehicleConnectionDelegate",
}
