...
class TestHKDefines(TestCase):
    def test_constants(self):
        ...
        self.assertEqual(HealthKit.HKErrorHealthDataUnavailable, 0)
        self.assertEqual(HealthKit.HKErrorHealthDataRestricted, 1)
        self.assertEqual(HealthKit.HKErrorInvalidArgument, 2)
        self.assertEqual(HealthKit.HKErrorAuthorizationDenied, 3)
        self.assertEqual(HealthKit.HKErrorAuthorizationNotDetermined, 4)
        self.assertEqual(HealthKit.HKErrorDatabaseInaccessible, 5)
        self.assertEqual(HealthKit.HKErrorUserCanceled, 6)
        self.assertEqual(HealthKit.HKErrorAnotherWorkoutSessionStarted, 6)
        self.assertEqual(HealthKit.HKErrorUserExitedWorkoutSession, 7)
        self.assertEqual(HealthKit.HKErrorRequiredAuthorizationDenied, 8)
        self.assertEqual(HealthKit.HKErrorNoData, 9)
