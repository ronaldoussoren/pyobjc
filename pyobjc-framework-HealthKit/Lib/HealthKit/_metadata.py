...
#
# Last update: Wed Jul  5 22:13:11 2023
#
# flake8: noqa
...
try:
    ...
    r(
        b"NSObject",
        b"workoutSession:didReceiveDataFromRemoteDevice:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}},
