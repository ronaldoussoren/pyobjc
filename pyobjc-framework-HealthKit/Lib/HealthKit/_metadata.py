...
misc.update(
    {
        ...
        "HKCategoryValueMenopausalState": NewType(
            "HKCategoryValueMenopausalState", int
        ),
...
try:
    ...
    r(
        b"HKHealthStore",
        b"getEarliestAuthorizedSampleDateForTypes:completion:",
        {
            "arguments": {
                3: {
                    "callable": {
...
objc.registerNewKeywordsFromSelector("HKAttachment", b"init")
objc.registerNewKeywordsFromSelector("HKAttachmentStore", b"initWithHealthStore:")
objc.registerNewKeywordsFromSelector("HKAudiogramSensitivityPoint", b"init")
objc.registerNewKeywordsFromSelector(
    "HKAudiogramSensitivityPointClampingRange", b"init"
)
objc.registerNewKeywordsFromSelector("HKAudiogramSensitivityTest", b"init")
objc.registerNewKeywordsFromSelector(
    "HKAudiogramSensitivityTest",
    b"initWithSensitivity:type:masked:side:clampingRange:error:",
)
objc.registerNewKeywordsFromSelector("HKCategorySample", b"init")
objc.registerNewKeywordsFromSelector("HKClinicalCoding", b"init")
objc.registerNewKeywordsFromSelector(
    "HKClinicalCoding", b"initWithSystem:version:code:"
)
objc.registerNewKeywordsFromSelector("HKClinicalRecord", b"init")
objc.registerNewKeywordsFromSelector("HKContactsLensSpecification", b"init")
objc.registerNewKeywordsFromSelector(
    "HKContactsLensSpecification",
    b"initWithSphere:cylinder:axis:addPower:baseCurve:diameter:",
)
objc.registerNewKeywordsFromSelector("HKContactsPrescription", b"init")
objc.registerNewKeywordsFromSelector(
    "HKCorrelationQuery", b"initWithType:predicate:samplePredicates:completion:"
)
objc.registerNewKeywordsFromSelector("HKDeletedObject", b"init")
objc.registerNewKeywordsFromSelector("HKDevice", b"init")
objc.registerNewKeywordsFromSelector(
    "HKDevice",
...
objc.registerNewKeywordsFromSelector("HKFHIRResource", b"init")
objc.registerNewKeywordsFromSelector("HKFHIRVersion", b"init")
objc.registerNewKeywordsFromSelector("HKGAD7Assessment", b"init")
objc.registerNewKeywordsFromSelector("HKGlassesLensSpecification", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("HKGlassesPrescription", b"init")
objc.registerNewKeywordsFromSelector("HKHealthConceptIdentifier", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("HKLensSpecification", b"init")
objc.registerNewKeywordsFromSelector(
    "HKLiveWorkoutBuilder", b"initWithHealthStore:configuration:device:"
)
objc.registerNewKeywordsFromSelector("HKLiveWorkoutDataSource", b"init")
objc.registerNewKeywordsFromSelector(
    "HKLiveWorkoutDataSource", b"initWithHealthStore:workoutConfiguration:"
)
objc.registerNewKeywordsFromSelector("HKLiveWorkoutZoneUpdate", b"init")
objc.registerNewKeywordsFromSelector("HKMedicationConcept", b"init")
objc.registerNewKeywordsFromSelector("HKMedicationDoseEvent", b"init")
objc.registerNewKeywordsFromSelector("HKObject", b"init")
objc.registerNewKeywordsFromSelector("HKObjectType", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("HKPHQ9Assessment", b"init")
objc.registerNewKeywordsFromSelector("HKQuantity", b"init")
objc.registerNewKeywordsFromSelector("HKQuantitySeriesSampleBuilder", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("HKQuery", b"init")
objc.registerNewKeywordsFromSelector("HKQueryAnchor", b"init")
objc.registerNewKeywordsFromSelector("HKQueryDescriptor", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("HKScoredAssessment", b"init")
objc.registerNewKeywordsFromSelector("HKSeriesBuilder", b"init")
objc.registerNewKeywordsFromSelector("HKSource", b"init")
objc.registerNewKeywordsFromSelector(
    "HKSourceQuery", b"initWithSampleType:samplePredicate:completionHandler:"
)
objc.registerNewKeywordsFromSelector("HKSourceRevision", b"init")
...
objc.registerNewKeywordsFromSelector("HKStateOfMind", b"init")
objc.registerNewKeywordsFromSelector("HKStatistics", b"init")
objc.registerNewKeywordsFromSelector("HKStatisticsCollection", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("HKUnit", b"init")
objc.registerNewKeywordsFromSelector("HKUserAnnotatedMedication", b"init")
objc.registerNewKeywordsFromSelector(
    "HKUserAnnotatedMedicationQuery", b"initWithPredicate:limit:resultsHandler:"
)
objc.registerNewKeywordsFromSelector("HKVerifiableClinicalRecord", b"init")
objc.registerNewKeywordsFromSelector("HKVerifiableClinicalRecordQuery", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("HKVerifiableClinicalRecordSubject", b"init")
objc.registerNewKeywordsFromSelector("HKVisionPrescription", b"init")
objc.registerNewKeywordsFromSelector("HKVisionPrism", b"init")
...
objc.registerNewKeywordsFromSelector("HKWorkoutActivity", b"init")
objc.registerNewKeywordsFromSelector(
    "HKWorkoutActivity", b"initWithWorkoutConfiguration:startDate:endDate:metadata:"
)
objc.registerNewKeywordsFromSelector("HKWorkoutBuilder", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("HKWorkoutEvent", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("HKWorkoutSession", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywords(
    "HKAudiogramSample",
    ("sensitivityPoints", "startDate", "endDate", "device", "metadata"),
    "audiogramSampleWithSensitivityPoints_startDate_endDate_device_metadata_",
)
objc.registerNewKeywords(
    "HKAudiogramSample",
    ("sensitivityPoints", "startDate", "endDate", "metadata"),
    "audiogramSampleWithSensitivityPoints_startDate_endDate_metadata_",
)
objc.registerNewKeywords(
    "HKAudiogramSensitivityPoint",
    ("frequency", "leftEarSensitivity", "rightEarSensitivity", "error"),
    "sensitivityPointWithFrequency_leftEarSensitivity_rightEarSensitivity_error_",
)
objc.registerNewKeywords(
    "HKAudiogramSensitivityPoint",
    ("frequency", "tests", "error"),
    "sensitivityPointWithFrequency_tests_error_",
)
objc.registerNewKeywords(
    "HKAudiogramSensitivityPointClampingRange",
    ("lowerBound", "upperBound", "error"),
    "clampingRangeWithLowerBound_upperBound_error_",
)
objc.registerNewKeywords(
    "HKCDADocumentSample",
    ("data", "startDate", "endDate", "metadata", "validationError"),
    "CDADocumentSampleWithData_startDate_endDate_metadata_validationError_",
)
objc.registerNewKeywords(
    "HKCategorySample",
    ("type", "value", "startDate", "endDate"),
    "categorySampleWithType_value_startDate_endDate_",
)
objc.registerNewKeywords(
    "HKCategorySample",
    ("type", "value", "startDate", "endDate", "device", "metadata"),
    "categorySampleWithType_value_startDate_endDate_device_metadata_",
)
objc.registerNewKeywords(
    "HKCategorySample",
    ("type", "value", "startDate", "endDate", "metadata"),
    "categorySampleWithType_value_startDate_endDate_metadata_",
)
objc.registerNewKeywords(
    ...
    "prescriptionWithRightEyeSpecification_leftEyeSpecification_brand_dateIssued_expirationDate_device_metadata_",
)
objc.registerNewKeywords(
    "HKContactsPrescription",
    ("type", "dateIssued", "expirationDate", "device", "metadata"),
    "prescriptionWithType_dateIssued_expirationDate_device_metadata_",
)
objc.registerNewKeywords(
    "HKCorrelation",
    ("type", "startDate", "endDate", "objects"),
    "correlationWithType_startDate_endDate_objects_",
)
objc.registerNewKeywords(
    "HKCorrelation",
    ("type", "startDate", "endDate", "objects", "device", "metadata"),
    "correlationWithType_startDate_endDate_objects_device_metadata_",
)
objc.registerNewKeywords(
    "HKCorrelation",
    ("type", "startDate", "endDate", "objects", "metadata"),
    "correlationWithType_startDate_endDate_objects_metadata_",
)
objc.registerNewKeywords(
    "HKGAD7Assessment", ("date", "answers"), "assessmentWithDate_answers_"
)
objc.registerNewKeywords(
    "HKGAD7Assessment",
    ("date", "answers", "metadata"),
    "assessmentWithDate_answers_metadata_",
)
objc.registerNewKeywords(
    ...
    "prescriptionWithRightEyeSpecification_leftEyeSpecification_dateIssued_expirationDate_device_metadata_",
)
objc.registerNewKeywords(
    "HKGlassesPrescription",
    ("type", "dateIssued", "expirationDate", "device", "metadata"),
...
objc.registerNewKeywords(
    "HKPHQ9Assessment", ("date", "answers"), "assessmentWithDate_answers_"
)
objc.registerNewKeywords(
    "HKPHQ9Assessment",
    ("date", "answers", "metadata"),
...
objc.registerNewKeywords(
    "HKQuantity", ("unit", "doubleValue"), "quantityWithUnit_doubleValue_"
)
objc.registerNewKeywords(
    "HKQuantitySample",
    ("type", "quantity", "startDate", "endDate"),
    "quantitySampleWithType_quantity_startDate_endDate_",
)
objc.registerNewKeywords(
    "HKQuantitySample",
    ("type", "quantity", "startDate", "endDate", "device", "metadata"),
    "quantitySampleWithType_quantity_startDate_endDate_device_metadata_",
)
objc.registerNewKeywords(
    "HKQuantitySample",
    ("type", "quantity", "startDate", "endDate", "metadata"),
    "quantitySampleWithType_quantity_startDate_endDate_metadata_",
)
objc.registerNewKeywords(
    "HKStateOfMind",
    ("date", "kind", "valence", "labels", "associations"),
    "stateOfMindWithDate_kind_valence_labels_associations_",
)
objc.registerNewKeywords(
    "HKStateOfMind",
    ("date", "kind", "valence", "labels", "associations", "metadata"),
    "stateOfMindWithDate_kind_valence_labels_associations_metadata_",
)
objc.registerNewKeywords("HKUnit", ("metricPrefix",), "gramUnitWithMetricPrefix_")
objc.registerNewKeywords("HKUnit", ("metricPrefix",), "hertzUnitWithMetricPrefix_")
objc.registerNewKeywords("HKUnit", ("metricPrefix",), "jouleUnitWithMetricPrefix_")
objc.registerNewKeywords("HKUnit", ("metricPrefix",), "literUnitWithMetricPrefix_")
objc.registerNewKeywords("HKUnit", ("metricPrefix",), "luxUnitWithMetricPrefix_")
objc.registerNewKeywords("HKUnit", ("metricPrefix",), "meterUnitWithMetricPrefix_")
objc.registerNewKeywords(
    "HKUnit", ("metricPrefix", "molarMass"), "moleUnitWithMetricPrefix_molarMass_"
)
objc.registerNewKeywords("HKUnit", ("molarMass",), "moleUnitWithMolarMass_")
objc.registerNewKeywords("HKUnit", ("metricPrefix",), "pascalUnitWithMetricPrefix_")
objc.registerNewKeywords(
    "HKUnit", ("metricPrefix",), "radianAngleUnitWithMetricPrefix_"
)
objc.registerNewKeywords("HKUnit", ("metricPrefix",), "secondUnitWithMetricPrefix_")
objc.registerNewKeywords("HKUnit", ("metricPrefix",), "siemenUnitWithMetricPrefix_")
objc.registerNewKeywords("HKUnit", ("metricPrefix",), "voltUnitWithMetricPrefix_")
objc.registerNewKeywords("HKUnit", ("metricPrefix",), "wattUnitWithMetricPrefix_")
objc.registerNewKeywords(
...
objc.registerNewKeywords(
    ...
    "workoutWithActivityType_startDate_endDate_",
)
objc.registerNewKeywords(
    "HKWorkout",
    (
    ...
    "workoutWithActivityType_startDate_endDate_duration_totalEnergyBurned_totalDistance_device_metadata_",
)
objc.registerNewKeywords(
    "HKWorkout",
    (
    ...
    "workoutWithActivityType_startDate_endDate_duration_totalEnergyBurned_totalDistance_metadata_",
)
objc.registerNewKeywords(
    "HKWorkout",
    (
    ...
    "workoutWithActivityType_startDate_endDate_workoutEvents_totalEnergyBurned_totalDistance_device_metadata_",
)
objc.registerNewKeywords(
    "HKWorkout",
    (
    ...
    "workoutWithActivityType_startDate_endDate_workoutEvents_totalEnergyBurned_totalDistance_metadata_",
)
objc.registerNewKeywords(
    "HKWorkout",
    (
    ...
    "workoutWithActivityType_startDate_endDate_workoutEvents_totalEnergyBurned_totalDistance_totalFlightsClimbed_device_metadata_",
)
objc.registerNewKeywords(
    "HKWorkout",
    (
    ...
    "workoutWithActivityType_startDate_endDate_workoutEvents_totalEnergyBurned_totalDistance_totalSwimmingStrokeCount_device_metadata_",
)
objc.registerNewKeywords(
    "HKWorkoutEvent",
    ("type", "dateInterval", "metadata"),
    "workoutEventWithType_dateInterval_metadata_",
)
objc.registerNewKeywords(
    "HKWorkoutEvent", ("type", "date"), "workoutEventWithType_date_"
)
objc.registerNewKeywords(
    "HKWorkoutEvent",
    ("type", "date", "metadata"),
    "workoutEventWithType_date_metadata_",
)
expressions = {}
formal_protocols = {
    "HKLiveWorkoutBuilderDelegate": "HKLiveWorkoutBuilderDelegate",
    "HKWorkoutSessionDelegate": "HKWorkoutSessionDelegate",
}
