...
#
# Last update: Tue Jun 21 15:38:57 2022
#
# flake8: noqa
...
functions = {
    "HKAppleWalkingSteadinessClassificationForQuantity": (b"Z@^q^@",),
...
try:
    ...
    r(
        ...
        {"arguments": {5: {"type": b"{_NSOperatingSystemVersion=qqq}"}}},
    )
    r(
        b"HKSourceRevision",
