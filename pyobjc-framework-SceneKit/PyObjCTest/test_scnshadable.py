...
if os_level_key(os_release()) < os_level_key("10.12") or sys.maxsize >= 2 ** 32:
    ...
    class TestSCNShadableHelper(SceneKit.NSObject):
        ...
        def program_bindValueForSymbol_atLocation_programID_renderer_(
            self, p, s, l, pp, r
        ):
            return 1
    ...
    class TestSCNShadable(TestCase):
        ...
        def test_constants10_9(self):
            ...
            self.assertIsInstance(
                SceneKit.SCNShaderModifierEntryPointLightingModel, unicode
            )
        ...
        def testMethods(self):
            ...
            self.assertArgIsBlock(
                TestSCNShadableHelper.handleBindingOfSymbol_usingBlock_,
                1,
                SCNBindingBlock,
            )
            self.assertArgIsBlock(
