...
if os_level_key(os_release()) < os_level_key('10.12') or sys.maxsize >= 2**32:
    ...
    _C_SCNVector3 = b'{SCNVector3=' + objc._C_CGFloat + objc._C_CGFloat + objc._C_CGFloat + b'}'
    _C_SCNVector4 = b'{SCNVector4=' + objc._C_CGFloat + objc._C_CGFloat + objc._C_CGFloat + objc._C_CGFloat + b'}'
    ...
    class TestSCNConstraint (TestCase):
        ...
        def testMethods10_13(self):
            ...
            self.assertArgIsBOOL(SceneKit.SCNTransformConstraint.positionConstraintInWorldSpace_withBlock_, 0)
            self.assertArgIsBlock(SceneKit.SCNTransformConstraint.positionConstraintInWorldSpace_withBlock_, 1, _C_SCNVector3 + objc._C_ID + _C_SCNVector3)
            self.assertArgIsBlock(SceneKit.SCNTransformConstraint.orientationConstraintInWorldSpace_withBlock_, 1, _C_SCNVector4 + objc._C_ID + _C_SCNVector4)
