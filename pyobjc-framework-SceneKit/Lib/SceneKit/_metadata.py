...
functions = {
    ...
    "SCNMatrix4FromMat4": (b"{CATransform3D=dddddddddddddddd}{simd_float4x4=[4<4f>]}",),
    "SCNMatrix4Scale": (
    ...
    "SCNVector4FromFloat4": (b"{SCNVector4=dddd}<4f>",),
...
objc.registerNewKeywordsFromSelector("SCNAudioPlayer", b"init")
...
objc.registerNewKeywords(
    "SCNAnimationEvent", ("keyTime", "block"), "animationEventWithKeyTime_block_"
)
objc.registerNewKeywords(
    "SCNAvoidOccluderConstraint", ("target",), "avoidOccluderConstraintWithTarget_"
)
objc.registerNewKeywords(
    "SCNBox",
...
objc.registerNewKeywords(
    "SCNCapsule", ("capRadius", "height"), "capsuleWithCapRadius_height_"
)
objc.registerNewKeywords(
    "SCNCone",
...
objc.registerNewKeywords(
    "SCNCylinder", ("radius", "height"), "cylinderWithRadius_height_"
)
objc.registerNewKeywords(
    "SCNDistanceConstraint", ("target",), "distanceConstraintWithTarget_"
)
objc.registerNewKeywords(
    "SCNGeometry", ("sources", "elements"), "geometryWithSources_elements_"
)
objc.registerNewKeywords(
    "SCNGeometry",
    ("sources", "elements", "sourceChannels"),
    "geometryWithSources_elements_sourceChannels_",
)
objc.registerNewKeywords(
    "SCNGeometryElement",
    ("buffer", "primitiveType", "primitiveCount", "bytesPerIndex"),
    "geometryElementWithBuffer_primitiveType_primitiveCount_bytesPerIndex_",
)
objc.registerNewKeywords(
    "SCNGeometryElement",
    (
    ...
    "geometryElementWithBuffer_primitiveType_primitiveCount_indicesChannelCount_interleavedIndicesChannels_bytesPerIndex_",
)
objc.registerNewKeywords(
    "SCNGeometryElement",
    ("data", "primitiveType", "primitiveCount", "bytesPerIndex"),
...
objc.registerNewKeywords(
    ...
    "geometryElementWithData_primitiveType_primitiveCount_indicesChannelCount_interleavedIndicesChannels_bytesPerIndex_",
)
objc.registerNewKeywords(
    "SCNGeometrySource",
    ("buffer", "vertexFormat", "semantic", "vertexCount", "dataOffset", "dataStride"),
...
objc.registerNewKeywords(
    "SCNGeometrySource", ("normals", "count"), "geometrySourceWithNormals_count_"
)
objc.registerNewKeywords(
    "SCNGeometrySource",
...
objc.registerNewKeywords(
    "SCNGeometrySource", ("vertices", "count"), "geometrySourceWithVertices_count_"
)
objc.registerNewKeywords(
    "SCNLevelOfDetail",
    ("geometry", "screenSpaceRadius"),
    "levelOfDetailWithGeometry_screenSpaceRadius_",
)
objc.registerNewKeywords(
    "SCNLevelOfDetail",
    ("geometry", "worldSpaceDistance"),
    "levelOfDetailWithGeometry_worldSpaceDistance_",
)
objc.registerNewKeywords(
    "SCNLookAtConstraint", ("target",), "lookAtConstraintWithTarget_"
)
objc.registerNewKeywords(
    "SCNMaterialProperty", ("contents",), "materialPropertyWithContents_"
)
objc.registerNewKeywords(
    "SCNParticlePropertyController", ("animation",), "controllerWithAnimation_"
)
objc.registerNewKeywords(
...
objc.registerNewKeywords(
    "SCNPhysicsBallSocketJoint", ("body", "anchor"), "jointWithBody_anchor_"
)
objc.registerNewKeywords("SCNPhysicsBody", ("type", "shape"), "bodyWithType_shape_")
objc.registerNewKeywords(
    "SCNPhysicsConeTwistJoint",
    ("bodyA", "frameA", "bodyB", "frameB"),
    "jointWithBodyA_frameA_bodyB_frameB_",
)
objc.registerNewKeywords(
    "SCNPhysicsConeTwistJoint", ("body", "frame"), "jointWithBody_frame_"
)
objc.registerNewKeywords(
    "SCNPhysicsHingeJoint",
    ("bodyA", "axisA", "anchorA", "bodyB", "axisB", "anchorB"),
    "jointWithBodyA_axisA_anchorA_bodyB_axisB_anchorB_",
)
objc.registerNewKeywords(
    "SCNPhysicsHingeJoint", ("body", "axis", "anchor"), "jointWithBody_axis_anchor_"
)
objc.registerNewKeywords(
    "SCNPhysicsShape", ("geometry", "options"), "shapeWithGeometry_options_"
)
objc.registerNewKeywords(
    "SCNPhysicsShape", ("node", "options"), "shapeWithNode_options_"
)
objc.registerNewKeywords(
    "SCNPhysicsShape", ("shapes", "transforms"), "shapeWithShapes_transforms_"
)
objc.registerNewKeywords(
...
objc.registerNewKeywords(
    "SCNPhysicsSliderJoint", ("body", "axis", "anchor"), "jointWithBody_axis_anchor_"
)
objc.registerNewKeywords(
    "SCNPhysicsVehicle", ("chassisBody", "wheels"), "vehicleWithChassisBody_wheels_"
)
objc.registerNewKeywords("SCNPhysicsVehicleWheel", ("node",), "wheelWithNode_")
objc.registerNewKeywords("SCNPlane", ("width", "height"), "planeWithWidth_height_")
objc.registerNewKeywords(
    "SCNPyramid", ("width", "height", "length"), "pyramidWithWidth_height_length_"
)
objc.registerNewKeywords(
    "SCNRenderer", ("context", "options"), "rendererWithContext_options_"
)
objc.registerNewKeywords(
    "SCNRenderer", ("device", "options"), "rendererWithDevice_options_"
)
objc.registerNewKeywords(
    "SCNReplicatorConstraint", ("target",), "replicatorConstraintWithTarget_"
)
objc.registerNewKeywords(
    "SCNScene", ("URL", "options", "error"), "sceneWithURL_options_error_"
)
objc.registerNewKeywords(
    "SCNShape", ("path", "extrusionDepth"), "shapeWithPath_extrusionDepth_"
)
objc.registerNewKeywords(
    "SCNSkinner",
    (
...
objc.registerNewKeywords("SCNSphere", ("radius",), "sphereWithRadius_")
objc.registerNewKeywords(
    "SCNText", ("string", "extrusionDepth"), "textWithString_extrusionDepth_"
)
objc.registerNewKeywords(
    "SCNTorus", ("ringRadius", "pipeRadius"), "torusWithRingRadius_pipeRadius_"
)
objc.registerNewKeywords(
    "SCNTube",
...
expressions = {}
formal_protocols = {
    "SCNActionable": "SCNActionable",
    "SCNAnimatable": "SCNAnimatable",
    "SCNAnimation": "SCNAnimation",
    "SCNAvoidOccluderConstraintDelegate": "SCNAvoidOccluderConstraintDelegate",
    "SCNBoundingVolume": "SCNBoundingVolume",
    "SCNBufferStream": "SCNBufferStream",
    "SCNCameraControlConfiguration": "SCNCameraControlConfiguration",
    "SCNCameraControllerDelegate": "SCNCameraControllerDelegate",
    "SCNNodeRendererDelegate": "SCNNodeRendererDelegate",
    "SCNPhysicsContactDelegate": "SCNPhysicsContactDelegate",
    "SCNProgramDelegate": "SCNProgramDelegate",
    "SCNSceneExportDelegate": "SCNSceneExportDelegate",
    "SCNSceneRenderer": "SCNSceneRenderer",
    "SCNSceneRendererDelegate": "SCNSceneRendererDelegate",
    "SCNShadable": "SCNShadable",
    "SCNTechniqueSupport": "SCNTechniqueSupport",
}
