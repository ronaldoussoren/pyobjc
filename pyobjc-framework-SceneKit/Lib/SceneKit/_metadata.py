...
misc.update(
    {
        "SCNVector4": objc.createStructType(
            "SCNVector4",
            sel32or64(b"{SCNVector4=ffff}", b"{SCNVector4=dddd}"),
            ["x", "y", "z", "w"],
        ),
        "SCNVector3": objc.createStructType(
            "SCNVector3",
            sel32or64(b"{SCNVector3=fff}", b"{SCNVector3=ddd}"),
            ["x", "y", "z"],
        ),
    }
)
...
constants = constants + "$SCNMatrix4Identity@%s$" % (
    sel32or64("{CATransform3D=ffffffffffffffff}", "{CATransform3D=dddddddddddddddd}"),
)
constants = constants + "$SCNVector4Zero@%s$" % (
    sel32or64("{SCNVector4=ffff}", "{SCNVector4=dddd}"),
)
constants = constants + "$SCNVector3Zero@%s$" % (
    sel32or64("{SCNVector3=fff}", "{SCNVector3=ddd}"),
)
...
misc.update(
    {
        "SCNPhysicsCollisionCategoryAll": sel32or64(
            4_294_967_295, 18_446_744_073_709_551_615
        )
    }
)
misc.update({})
functions = {
    "SCNMatrix4IsIdentity": (
        sel32or64(
            b"B{CATransform3D=ffffffffffffffff}", b"B{CATransform3D=dddddddddddddddd}"
        ),
    ),
    "SCNVector4Make": (sel32or64(b"{SCNVector4=ffff}ffff", b"{SCNVector4=dddd}dddd"),),
    "SCNMatrix4EqualToMatrix4": (
        sel32or64(
            b"B{CATransform3D=ffffffffffffffff}{CATransform3D=ffffffffffffffff}",
    ...
    "SCNMatrix4FromMat4": (
        sel32or64(
            b"{CATransform3D=ffffffffffffffff}{_matrix_float4x4=[4$]}",
            b"{CATransform3D=dddddddddddddddd}{_matrix_float4x4=[4$]}",
        ),
    ),
    "SCNMatrix4Scale": (
        sel32or64(
            b"{CATransform3D=ffffffffffffffff}{CATransform3D=ffffffffffffffff}fff",
            b"{CATransform3D=dddddddddddddddd}{CATransform3D=dddddddddddddddd}ddd",
        ),
    ),
    "SCNMatrix4MakeRotation": (
        sel32or64(
            b"{CATransform3D=ffffffffffffffff}ffff",
            b"{CATransform3D=dddddddddddddddd}dddd",
        ),
    ),
    "SCNVector4FromGLKVector4": (
        sel32or64(
            b"{SCNVector4=ffff}(_GLKVector4={=ffff}{=ffff}{=ffff}[4f])",
            b"{SCNVector4=dddd}(_GLKVector4={=ffff}{=ffff}{=ffff}[4f])",
        ),
    ),
    "SCNExportJavaScriptModule": (b"v@",),
    "SCNVector4ToFloat4": (sel32or64(b"${SCNVector4=ffff}", b"${SCNVector4=dddd}"),),
    "SCNVector3EqualToVector3": (
        sel32or64(
            b"B{SCNVector3=fff}{SCNVector3=fff}", b"B{SCNVector3=ddd}{SCNVector3=ddd}"
        ),
    ),
    "SCNMatrix4ToGLKMatrix4": (
        sel32or64(
            b"(_GLKMatrix4={=ffffffffffffffff}[16f]){CATransform3D=ffffffffffffffff}",
            b"(_GLKMatrix4={=ffffffffffffffff}[16f]){CATransform3D=dddddddddddddddd}",
        ),
    ),
    "SCNMatrix4ToMat4": (
        sel32or64(
            b"{_matrix_float4x4=[4$]}{CATransform3D=ffffffffffffffff}",
            b"{_matrix_float4x4=[4$]}{CATransform3D=dddddddddddddddd}",
        ),
    ),
    ...
    "SCNMatrix4FromGLKMatrix4": (
        sel32or64(
            b"{CATransform3D=ffffffffffffffff}(_GLKMatrix4={=ffffffffffffffff}[16f])",
            b"{CATransform3D=dddddddddddddddd}(_GLKMatrix4={=ffffffffffffffff}[16f])",
        ),
    ),
    "SCNMatrix4Invert": (
        sel32or64(
            b"{CATransform3D=ffffffffffffffff}{CATransform3D=ffffffffffffffff}",
            b"{CATransform3D=dddddddddddddddd}{CATransform3D=dddddddddddddddd}",
        ),
    ),
    "SCNVector4ToGLKVector4": (
        sel32or64(
            b"(_GLKVector4={=ffff}{=ffff}{=ffff}[4f]){SCNVector4=ffff}",
            b"(_GLKVector4={=ffff}{=ffff}{=ffff}[4f]){SCNVector4=dddd}",
        ),
    ),
    "SCNMatrix4Rotate": (
        sel32or64(
            b"{CATransform3D=ffffffffffffffff}{CATransform3D=ffffffffffffffff}ffff",
            b"{CATransform3D=dddddddddddddddd}{CATransform3D=dddddddddddddddd}dddd",
        ),
    ),
    "SCNVector3ToGLKVector3": (
        sel32or64(
            b"(_GLKVector3={=fff}{=fff}{=fff}[3f]){SCNVector3=fff}",
            b"(_GLKVector3={=fff}{=fff}{=fff}[3f]){SCNVector3=ddd}",
        ),
    ),
    "SCNVector3Make": (sel32or64(b"{SCNVector3=fff}fff", b"{SCNVector3=ddd}ddd"),),
    "SCNVector4FromFloat4": (sel32or64(b"{SCNVector4=ffff}$", b"{SCNVector4=dddd}$"),),
    "SCNVector3FromGLKVector3": (
        sel32or64(
            b"{SCNVector3=fff}(_GLKVector3={=fff}{=fff}{=fff}[3f])",
            b"{SCNVector3=ddd}(_GLKVector3={=fff}{=fff}{=fff}[3f])",
        ),
    ),
    "SCNMatrix4Mult": (
        sel32or64(
            b"{CATransform3D=ffffffffffffffff}{CATransform3D=ffffffffffffffff}{CATransform3D=ffffffffffffffff}",
...
try:
    ...
    r(
        ...
        b"getBoundingSphereCenter:radius:",
        {
            ...
            "arguments": {
                ...
                3: {"type": sel32or64(b"^f", b"^d"), "type_modifier": b"o"},
            },
        },
    )
    r(
    ...
    r(
        ...
        b"hitTest:options:",
        {
            ...
            "retval": {"type": b"@"},
            "arguments": {
                2: {"type": sel32or64(b"{CGPoint=ff}", b"{CGPoint=dd}")},
                3: {"type": b"@"},
            },
        },
    )
    ...
    r(
        ...
        {
            "required": True,
            "retval": {"type": sel32or64(b"{SCNVector3=fff}", b"{SCNVector3=ddd}")},
            "arguments": {
                2: {"type": sel32or64(b"{SCNVector3=fff}", b"{SCNVector3=ddd}")}
            },
        },
    )
    r(
