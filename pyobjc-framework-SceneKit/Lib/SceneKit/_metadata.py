...
#
# Last update: Sun Jun 28 10:58:06 2020
#
# flake8: noqa
...
misc.update(
    {
        "SCNVector4": objc.createStructType(
            "SCNVector4", b"{SCNVector4=dddd}", ["x", "y", "z", "w"]
        ),
        "SCNVector3": objc.createStructType(
            "SCNVector3", b"{SCNVector3=ddd}", ["x", "y", "z"]
        ),
    }
)
...
functions = {
    ...
    "SCNMatrix4FromMat4": (b"{CATransform3D=dddddddddddddddd}{_matrix_float4x4=[4$]}",),
    "SCNMatrix4Scale": (
    ...
    "SCNVector4ToFloat4": (b"${SCNVector4=dddd}",),
    ...
    "SCNMatrix4ToMat4": (b"{_matrix_float4x4=[4$]}{CATransform3D=dddddddddddddddd}",),
    ...
    "SCNVector4FromFloat4": (b"{SCNVector4=dddd}$",),
