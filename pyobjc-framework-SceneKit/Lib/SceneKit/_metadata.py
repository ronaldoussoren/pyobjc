...
#
# Last update: Sat Aug  6 14:31:30 2022
#
# flake8: noqa
...
try:
    ...
    r(b"SCNNode", b"simdOrientation", {"retval": {"type": b"{_simd_quatf=<4f>}"}})
    r(b"SCNNode", b"simdPivot", {"retval": {"type": b"{_simd_float4x4=[4<4f>]}"}})
    r(
        b"SCNNode",
        b"simdPosition",
        {"full_signature": b"<3f>@:", "retval": {"type": b"<3f>"}},
    ...
    r(
        ...
        b"simdRotateBy:aroundTarget:",
        {
            ...
            "arguments": {2: {"type": b"{_simd_quatf=<4f>}"}, 3: {"type": b"<3f>"}},
        },
    )
    r(
        b"SCNNode",
    ...
    r(b"SCNNode", b"simdTransform", {"retval": {"type": b"{_simd_float4x4=[4<4f>]}"}})
    r(
        b"SCNNode",
        b"simdWorldFront",
        {"full_signature": b"<3f>@:", "retval": {"type": b"<3f>"}},
    )
    r(b"SCNNode", b"simdWorldOrientation", {"retval": {"type": b"{_simd_quatf=<4f>}"}})
    r(
        b"SCNNode",
        b"simdWorldPosition",
        {"full_signature": b"<3f>@:", "retval": {"type": b"<3f>"}},
