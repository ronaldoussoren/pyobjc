...
#
# Last update: Mon Jun 10 11:13:11 2019
...
try:
    ...
    r(b'NSObject', b'addAnimationPlayer:forKey:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    ...
    r(b'NSObject', b'animationPlayerForKey:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'avoidOccluderConstraint:didAvoidOccluder:forNode:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'avoidOccluderConstraint:shouldAvoidOccluder:forNode:', {'required': False, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'cameraInertiaDidEndForController:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'cameraInertiaWillStartForController:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'colorPixelFormat', {'required': True, 'retval': {'type': sel32or64(b'I', b'Q')}})
    r(b'NSObject', b'commandQueue', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'context', {'required': True, 'retval': {'type': b'^v'}})
    r(b'NSObject', b'currentRenderCommandEncoder', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'currentTime', {'required': True, 'retval': {'type': b'd'}})
    r(b'NSObject', b'currentViewport', {'required': True, 'retval': {'type': b'{CGRect={CGPoint=dd}{CGSize=dd}}'}})
    r(b'NSObject', b'debugOptions', {'required': True, 'retval': {'type': sel32or64(b'I', b'Q')}})
    r(b'NSObject', b'delegate', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'depthPixelFormat', {'required': True, 'retval': {'type': sel32or64(b'I', b'Q')}})
    r(b'NSObject', b'device', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'flyModeVelocity', {'required': True, 'retval': {'type': sel32or64(b'f', b'd')}})
    ...
    r(b'NSObject', b'isTemporalAntialiasingEnabled', {'required': True, 'retval': {'type': b'Z'}})
    r(b'NSObject', b'loops', {'required': True, 'retval': {'type': b'Z'}})
    r(b'NSObject', b'nodesInsideFrustumWithPointOfView:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'overlaySKScene', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'panSensitivity', {'required': True, 'retval': {'type': sel32or64(b'f', b'd')}})
    ...
    r(b'NSObject', b'presentScene:withTransition:incomingPointOfView:completionHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}, 'type': '@?'}}})
    ...
    r(b'NSObject', b'removeAnimationForKey:blendOutDuration:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': sel32or64(b'f', b'd')}}})
    ...
    r(b'NSObject', b'renderer:didApplyConstraintsAtTime:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'd'}}})
    ...
    r(b'NSObject', b'renderingAPI', {'required': True, 'retval': {'type': sel32or64(b'I', b'Q')}})
    r(b'NSObject', b'resumeAnimationForKey:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'rotationSensitivity', {'required': True, 'retval': {'type': sel32or64(b'f', b'd')}})
    ...
    r(b'NSObject', b'setAllowsTranslation:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': 'Z'}}})
    r(b'NSObject', b'setAudioListener:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'setAutoSwitchToFreeCamera:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': 'Z'}}})
    ...
    r(b'NSObject', b'setDebugOptions:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': sel32or64(b'I', b'Q')}}})
    ...
    r(b'NSObject', b'setFlyModeVelocity:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': sel32or64(b'f', b'd')}}})
    ...
    r(b'NSObject', b'setPanSensitivity:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': sel32or64(b'f', b'd')}}})
    ...
    r(b'NSObject', b'setRotationSensitivity:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': sel32or64(b'f', b'd')}}})
    ...
    r(b'NSObject', b'setSpeed:forAnimationKey:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': sel32or64(b'f', b'd')}, 3: {'type': b'@'}}})
    ...
    r(b'NSObject', b'setTemporalAntialiasingEnabled:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'Z'}}})
    r(b'NSObject', b'setTruckSensitivity:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': sel32or64(b'f', b'd')}}})
    r(b'NSObject', b'setUsesReverseZ:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'Z'}}})
    r(b'NSObject', b'shaderModifiers', {'required': False, 'retval': {'type': b'@'}})
    r(b'NSObject', b'showsStatistics', {'required': True, 'retval': {'type': b'Z'}})
    r(b'NSObject', b'stencilPixelFormat', {'required': True, 'retval': {'type': sel32or64(b'I', b'Q')}})
    r(b'NSObject', b'technique', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'truckSensitivity', {'required': True, 'retval': {'type': sel32or64(b'f', b'd')}})
    ...
    r(b'NSObject', b'writeBytes:length:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': 'n^v', 'c_array_length_in_arg': 3}, 3: {'type': sel32or64(b'I', b'Q')}}})
    ...
    r(b'SCNAction', b'playAudioSource:waitForCompletion:', {'arguments': {3: {'type': b'Z'}}})
    ...
    r(b'SCNHitTestResult', b'simdModelTransform', {'retval': {'type': b'{_simd_float4x4=?}'}})
    ...
    r(b'SCNNode', b'setSimdTransform:', {'arguments': {2: {'type': b'{_simd_float4x4=?}'}}})
    r(b'SCNNode', b'setSimdWorldOrientation:', {'arguments': {2: {'type': b'{_simd_quatf=}'}}})
    r(b'SCNNode', b'setSimdWorldTransform:', {'arguments': {2: {'type': b'{_simd_float4x4=?}'}}})
    r(b'SCNNode', b'simdConvertTransform:fromNode:', {'retval': {'type': b'{_simd_float4x4=?}'}, 'arguments': {2: {'type': b'{_simd_float4x4=?}'}}})
    r(b'SCNNode', b'simdConvertTransform:toNode:', {'retval': {'type': b'{_simd_float4x4=?}'}, 'arguments': {2: {'type': b'{_simd_float4x4=?}'}}})
    ...
    r(b'SCNNode', b'simdRotateBy:aroundTarget:', {'arguments': {2: {'type': b'{_simd_quatf=}'}}})
    ...
    r(b'SCNView', b'setDrawableResizesAsynchronously:', {'arguments': {2: {'type': b'Z'}}})
