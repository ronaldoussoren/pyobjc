...
#
# Last update: Sun May 24 11:53:04 2026
#
# flake8: noqa
...
objc.registerNewKeywordsFromSelector("MTKMesh", b"init")
objc.registerNewKeywordsFromSelector("MTKMesh", b"initWithMesh:device:error:")
objc.registerNewKeywordsFromSelector("MTKMeshBuffer", b"init")
objc.registerNewKeywordsFromSelector("MTKMeshBufferAllocator", b"init")
objc.registerNewKeywordsFromSelector("MTKMeshBufferAllocator", b"initWithDevice:")
objc.registerNewKeywordsFromSelector("MTKSubmesh", b"init")
objc.registerNewKeywordsFromSelector("MTKTextureLoader", b"init")
