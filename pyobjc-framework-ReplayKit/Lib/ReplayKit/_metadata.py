...
objc.registerNewKeywordsFromSelector("RPScreenRecorder", b"init")
expressions = {}
formal_protocols = {
    "RPBroadcastActivityControllerDelegate": "RPBroadcastActivityControllerDelegate",
    "RPBroadcastControllerDelegate": "RPBroadcastControllerDelegate",
    "RPPreviewViewControllerDelegate": "RPPreviewViewControllerDelegate",
    "RPScreenRecorderDelegate": "RPScreenRecorderDelegate",
}
