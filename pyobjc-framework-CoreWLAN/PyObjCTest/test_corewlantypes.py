...
class TestCoreWLANTypes (TestCase):
    def testConstants(self):
        ...
        selfc.assertEqual(CoreWLAN.kCWSecurityWPA3Personal, 11)
        selfc.assertEqual(CoreWLAN.kCWSecurityWPA3Enterprise, 12)
        selfc.assertEqual(CoreWLAN.kCWSecurityWPA3Transition, 13)
