...
class TestCWWiFiClient (TestCase):
    ...
    def testProtocols10_10(self):
        ...
        self.assertArgHasType(TestCWWifiClientHelper.linkQualityDidChangeForWiFiInterfaceWithName_rssi_transmitRate_, 1, objc._C_NSInteger, objc._C_DBL)
    ...
    def testMethods10_10(self):
        ...
        self.assertResultIsBOOL(CoreWLAN.CWWiFiClient.stopMonitoringAllEventsAndReturnError_)
        self.assertArgIsOut(CoreWLAN.CWWiFiClient.stopMonitoringAllEventsAndReturnError_, 0)
