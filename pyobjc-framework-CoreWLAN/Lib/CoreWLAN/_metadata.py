...
misc.update(
    {
        "kCWSecurityUnknown": sel32or64(2_147_483_647, 9_223_372_036_854_775_807),
        "CWEventTypeUnknown": sel32or64(2_147_483_647, 9_223_372_036_854_775_807),
    }
)
misc.update({})
functions = {
    ...
    "CWKeychainSetEAPUsernameAndPassword": (
        sel32or64(
            b"l^{__CFData=}^{__CFString=}^{__CFString=}",
            b"i^{__CFData=}^{__CFString=}^{__CFString=}",
        ),
    ),
    "CWKeychainDeleteWiFiEAPUsernameAndPassword": (sel32or64(b"li@", b"iq@"),),
    "CWKeychainDeletePassword": (sel32or64(b"l^{__CFData=}", b"i^{__CFData=}"),),
    "CWKeychainCopyEAPIdentityList": (
        sel32or64(b"l^^{__CFArray=}", b"i^^{__CFArray=}"),
        "",
        {
    ...
    "CWKeychainCopyWiFiEAPIdentity": (
        sel32or64(b"li@^^{OpaqueSecIdentityRef=}", b"iq@^^{__SecIdentity=}"),
        "",
        {
            "retval": {"already_cfretained": True},
    ...
    "CWKeychainSetWiFiEAPUsernameAndPassword": (sel32or64(b"li@@@", b"iq@@@"),),
    ...
    "CWKeychainSetPassword": (
        sel32or64(b"l^{__CFData=}^{__CFString=}", b"i^{__CFData=}^{__CFString=}"),
    ),
    ...
    "CWKeychainDeleteEAPUsernameAndPassword": (
        sel32or64(b"l^{__CFData=}", b"i^{__CFData=}"),
    ),
    ...
    "CWKeychainDeleteWiFiPassword": (sel32or64(b"li@", b"iq@"),),
    "CWMergeNetworks": (b"@@",),
    "CWKeychainSetWiFiPassword": (sel32or64(b"li@@", b"iq@@"),),
