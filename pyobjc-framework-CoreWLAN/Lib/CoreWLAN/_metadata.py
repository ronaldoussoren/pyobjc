...
objc.registerNewKeywordsFromSelector("CWConfiguration", b"init")
...
objc.registerNewKeywordsFromSelector("CWNetworkProfile", b"init")
objc.registerNewKeywordsFromSelector("CWNetworkProfile", b"initWithNetworkProfile:")
objc.registerNewKeywordsFromSelector("CWWiFiClient", b"init")

objc.registerNewKeywords("CWInterface", ("name",), "interfaceWithName_")
expressions = {}
formal_protocols = {
    "CWEventDelegate": "CWEventDelegate",
}
