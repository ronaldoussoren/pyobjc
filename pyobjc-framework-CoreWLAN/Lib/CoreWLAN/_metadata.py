...
#
# Last update: Sat Aug  3 22:02:28 2019
...
misc.update({})
functions={'CWKeychainFindWiFiPassword': (sel32or64(b'li@^@', b'iq@^@'), '', {'arguments': {2: {'type_modifier': 'o'}}}), 'CWKeychainSetEAPIdentity': (sel32or64(b'l^{__CFData=}^{OpaqueSecIdentityRef=}', b'i^{__CFData=}^{__SecIdentity=}'),), 'CWKeychainSetEAPUsernameAndPassword': (sel32or64(b'l^{__CFData=}^{__CFString=}^{__CFString=}', b'i^{__CFData=}^{__CFString=}^{__CFString=}'),), 'CWKeychainDeleteWiFiEAPUsernameAndPassword': (sel32or64(b'li@', b'iq@'),), 'CWKeychainDeletePassword': (sel32or64(b'l^{__CFData=}', b'i^{__CFData=}'),), 'CWKeychainCopyEAPIdentityList': (sel32or64(b'l^^{__CFArray=}', b'i^^{__CFArray=}'), '', {'retval': {'already_cfretained': True}, 'arguments': {0: {'already_cfretained': True, 'type_modifier': 'o'}}}), 'CWKeychainCopyWiFiEAPIdentity': (sel32or64(b'li@^^{OpaqueSecIdentityRef=}', b'iq@^^{__SecIdentity=}'), '', {'retval': {'already_cfretained': True}, 'arguments': {2: {'already_cfretained': True, 'type_modifier': 'o'}}}), 'CWKeychainSetWiFiEAPUsernameAndPassword': (sel32or64(b'li@@@', b'iq@@@'),), 'CWKeychainFindWiFiEAPUsernameAndPassword': (sel32or64(b'li@^@^@', b'iq@^@^@'), '', {'arguments': {2: {'type_modifier': 'o'}, 3: {'type_modifier': 'o'}}}), 'CWKeychainCopyEAPUsernameAndPassword': (sel32or64(b'l^{__CFData=}^^{__CFString=}^^{__CFString=}', b'i^{__CFData=}^^{__CFString=}^^{__CFString=}'), '', {'retval': {'already_cfretained': True}, 'arguments': {1: {'already_cfretained': True, 'type_modifier': 'o'}, 2: {'already_cfretained': True, 'type_modifier': 'o'}}}), 'CWKeychainSetPassword': (sel32or64(b'l^{__CFData=}^{__CFString=}', b'i^{__CFData=}^{__CFString=}'),), 'CWKeychainCopyPassword': (sel32or64(b'l^{__CFData=}^^{__CFString=}', b'i^{__CFData=}^^{__CFString=}'), '', {'retval': {'already_cfretained': True}, 'arguments': {1: {'already_cfretained': True, 'type_modifier': 'o'}}}), 'CWKeychainDeleteEAPUsernameAndPassword': (sel32or64(b'l^{__CFData=}', b'i^{__CFData=}'),), 'CWKeychainCopyEAPIdentity': (sel32or64(b'l^{__CFData=}^^{OpaqueSecIdentityRef=}', b'i^{__CFData=}^^{__SecIdentity=}'), '', {'retval': {'already_cfretained': True}, 'arguments': {1: {'already_cfretained': True, 'type_modifier': 'o'}}}), 'CWKeychainDeleteWiFiPassword': (sel32or64(b'li@', b'iq@'),), 'CWMergeNetworks': (b'@@',), 'CWKeychainSetWiFiPassword': (sel32or64(b'li@@', b'iq@@'),), 'CWKeychainSetWiFiEAPIdentity': (sel32or64(b'li@^{OpaqueSecIdentityRef=}', b'iq@^{__SecIdentity=}'),)}
...
try:
    ...
    r(b'CWConfiguration', b'setRememberJoinedNetworks:', {'arguments': {2: {'type': 'Z'}}})
    ...
    r(b'CWConfiguration', b'setRequireAdministratorForAssociation:', {'arguments': {2: {'type': 'Z'}}})
    r(b'CWConfiguration', b'setRequireAdministratorForIBSSMode:', {'arguments': {2: {'type': 'Z'}}})
    r(b'CWConfiguration', b'setRequireAdministratorForPower:', {'arguments': {2: {'type': 'Z'}}})
