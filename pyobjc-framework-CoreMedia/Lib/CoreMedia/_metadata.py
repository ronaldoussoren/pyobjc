...
functions = {
    ...
    "CMBufferQueueInstallTriggerHandlerWithIntegerThreshold": (
        b"i^{opaqueCMBufferQueue=}iq^^{opaqueCMBufferQueueTriggerToken=}@?",
        "",
        {
            "arguments": {
                3: {"type_modifier": "o"},
    ...
    "CMClockImplementsGetPreferredStartTimePattern": (b"Z^{OpaqueCMClock=}",),
    ...
    "CMBlockBufferGetDataPointer": (
        ...
        "",
        {
            "arguments": {
                2: {"type_modifier": "o"},
                3: {"type_modifier": "o"},
                4: {"type_modifier": "o", "c_array_length_in_arg": 2},
            }
        },
    ),
    ...
    "CMClockGetPreferredStartTimePattern": (
        b"i^{OpaqueCMClock=}^{CMTime=qiIq}^{CMTime=qiIq}^{CMTime=qiIq}",
        "",
        {
            "arguments": {
                1: {"type_modifier": "o"},
    ...
    "CMBufferQueueInstallTriggerHandler": (
        b"i^{opaqueCMBufferQueue=}i{CMTime=qiIq}^^{opaqueCMBufferQueueTriggerToken=}@?",
        "",
        {
            "arguments": {
                3: {"type_modifier": "o"},
    ...
    "CMIsAnyDisplaySynchronizedToLockedGenlockSignal": (b"Z",),
