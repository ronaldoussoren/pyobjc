...
#
# Last update: Sat Jul  1 13:56:53 2023
#
# flake8: noqa
...
functions = {
    ...
    "CMTagCollectionCountTagsWithFilterFunction": (b"q^{OpaqueCMTagCollection=}^?^v",),
    ...
    "CMTagCollectionAddTagsFromArray": (b"i^{OpaqueCMTagCollection=}^{CMTag=IIQ}q",),
    ...
    "CMTagCollectionApplyUntil": (b"{CMTag=IIQ}^{OpaqueCMTagCollection=}^?^v",),
    ...
    "CMTagCollectionGetTags": (b"i^{OpaqueCMTagCollection=}^{CMTag=IIQ}q^q",),
    ...
    "CMTagCollectionApply": (b"v^{OpaqueCMTagCollection=}^?^v",),
