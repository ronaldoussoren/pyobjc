...
class TestCMSampleBuffer(TestCase):
    def test_constants(self):
        ...
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferNotification_DataBecameReady, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferConduitNotification_InhibitOutputUntil, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferConduitNotificationParameter_ResumeTag, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferConduitNotification_ResetOutput, unicode
        )
        self.assertIsInstance(
        ...
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferConsumerNotification_BufferConsumed, unicode
        )
        ...
        self.assertIsInstance(
            CoreMedia.kCMSampleAttachmentKey_HasRedundantCoding, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleAttachmentKey_IsDependedOnByOthers, unicode
        )
        self.assertIsInstance(CoreMedia.kCMSampleAttachmentKey_DependsOnOthers, unicode)
        self.assertIsInstance(
            CoreMedia.kCMSampleAttachmentKey_EarlierDisplayTimesAllowed, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleAttachmentKey_DisplayImmediately, unicode
        )
        self.assertIsInstance(CoreMedia.kCMSampleAttachmentKey_DoNotDisplay, unicode)
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferAttachmentKey_ResetDecoderBeforeDecoding, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferAttachmentKey_DrainAfterDecoding, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferAttachmentKey_PostNotificationWhenConsumed, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferAttachmentKey_ResumeOutput, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferAttachmentKey_TransitionID, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferAttachmentKey_TrimDurationAtStart, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferAttachmentKey_TrimDurationAtEnd, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferAttachmentKey_SpeedMultiplier, unicode
        )
        ...
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferAttachmentKey_DisplayEmptyMediaImmediately, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferAttachmentKey_EndsPreviousSampleDuration, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferAttachmentKey_SampleReferenceURL, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferAttachmentKey_SampleReferenceByteOffset, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferAttachmentKey_GradualDecoderRefresh, unicode
        )
    ...
    def test_constants10_10(self):
        ...
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferNotificationParameter_OSStatus, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleBufferAttachmentKey_ForceKeyFrame, unicode
        )

    @min_os_level("10.13")
    def test_constants10_13(self):
        self.assertIsInstance(
            CoreMedia.kCMSampleAttachmentKey_HEVCTemporalLevelInfo, unicode
        )
        self.assertIsInstance(
        ...
        self.assertIsInstance(
            CoreMedia.kCMHEVCTemporalLevelInfoKey_ConstraintIndicatorFlags, unicode
        )
        self.assertIsInstance(CoreMedia.kCMHEVCTemporalLevelInfoKey_LevelIndex, unicode)
        self.assertIsInstance(
            CoreMedia.kCMSampleAttachmentKey_HEVCTemporalSubLayerAccess, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleAttachmentKey_HEVCStepwiseTemporalSubLayerAccess, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMSampleAttachmentKey_HEVCSyncSampleNALUnitType, unicode
        )
