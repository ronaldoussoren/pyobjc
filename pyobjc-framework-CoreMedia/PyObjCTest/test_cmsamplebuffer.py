...
class TestCMSampleBuffer (TestCase):
    ...
    def test_functions(self):
        ...
        self.assertArgSizeInArg(CoreMedia.CMAudioSampleBufferCreateWithPacketDescriptions, 8, 7)
        ...
        self.assertArgSizeInArg(CoreMedia.CMAudioSampleBufferCreateReadyWithPacketDescriptions, 5, 4)
        ...
        self.assertArgIsIn(CoreMedia.CMSampleBufferCreateForImageBuffer, 5)
        self.assertArgIsOut(CoreMedia.CMSampleBufferCreate, 6)
        self.assertArgIsCFRetained(CoreMedia.CMSampleBufferCreate, 6)
