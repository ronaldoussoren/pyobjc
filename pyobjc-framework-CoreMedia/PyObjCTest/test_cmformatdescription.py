...
class TestCMFormatDescription(TestCase):
    ...
    def test_constants10_7(self):
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_OriginalCompressionSettings, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_SampleDescriptionExtensionAtoms,
            unicode,
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_VerbatimSampleDescription, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_VerbatimISOSampleEntry, unicode
        )

        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_FormatName, unicode
        )
        self.assertIsInstance(CoreMedia.kCMFormatDescriptionExtension_Depth, unicode)

        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionKey_CleanApertureWidthRational, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionKey_CleanApertureHeightRational, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionKey_CleanApertureHorizontalOffsetRational,
            unicode,
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionKey_CleanApertureVerticalOffsetRational,
            unicode,
        )

        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_FullRangeVideo, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_ICCProfile, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_BytesPerRow, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionConformsToMPEG2VideoProfile, unicode
        )

        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_TemporalQuality, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_SpatialQuality, unicode
        )

        self.assertIsInstance(CoreMedia.kCMFormatDescriptionExtension_Version, unicode)
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_RevisionLevel, unicode
        )
        ...
        self.assertIsInstance(
            CoreMedia.kCMTextFormatDescriptionExtension_DisplayFlags, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMTextFormatDescriptionExtension_BackgroundColor, unicode
        )
        ...
        self.assertIsInstance(
            CoreMedia.kCMTextFormatDescriptionExtension_DefaultTextBox, unicode
        )
        ...
        self.assertIsInstance(
            CoreMedia.kCMTextFormatDescriptionExtension_DefaultStyle, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMTextFormatDescriptionStyle_StartChar, unicode
        )
        ...
        self.assertIsInstance(
            CoreMedia.kCMTextFormatDescriptionStyle_ForegroundColor, unicode
        )
        self.assertIsInstance(CoreMedia.kCMTextFormatDescriptionStyle_FontSize, unicode)
        self.assertIsInstance(
            CoreMedia.kCMTextFormatDescriptionExtension_HorizontalJustification, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMTextFormatDescriptionExtension_VerticalJustification, unicode
        )
        self.assertIsInstance(CoreMedia.kCMTextFormatDescriptionStyle_EndChar, unicode)
        self.assertIsInstance(
            CoreMedia.kCMTextFormatDescriptionExtension_FontTable, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMTextFormatDescriptionExtension_TextJustification, unicode
        )
        ...
        self.assertIsInstance(
            CoreMedia.kCMTextFormatDescriptionExtension_DefaultFontName, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMTimeCodeFormatDescriptionExtension_SourceReferenceName, unicode
        )
        self.assertIsInstance(CoreMedia.kCMTimeCodeFormatDescriptionKey_Value, unicode)
        self.assertIsInstance(
            CoreMedia.kCMTimeCodeFormatDescriptionKey_LangCode, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtensionKey_MetadataKeyTable, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMMetadataFormatDescriptionKey_Namespace, unicode
        )
        self.assertIsInstance(CoreMedia.kCMMetadataFormatDescriptionKey_Value, unicode)
        self.assertIsInstance(
            CoreMedia.kCMMetadataFormatDescriptionKey_LocalID, unicode
        )
    ...
    def test_constants10_10(self):
        self.assertIsInstance(
            CoreMedia.kCMMetadataFormatDescriptionKey_DataType, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMMetadataFormatDescriptionKey_DataTypeNamespace, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMMetadataFormatDescriptionKey_ConformingDataTypes, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMMetadataFormatDescriptionKey_LanguageTag, unicode
        )
        self.assertIsInstance(
    ...
    def test_constants10_11(self):
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_VerbatimImageDescription, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_CleanAperture, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionKey_CleanApertureWidth, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionKey_CleanApertureHeight, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionKey_CleanApertureHorizontalOffset, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionKey_CleanApertureVerticalOffset, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_FieldCount, unicode
        )

        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_FieldDetail, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionFieldDetail_TemporalTopFirst, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionFieldDetail_TemporalBottomFirst, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionFieldDetail_SpatialFirstLineEarly, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionFieldDetail_SpatialFirstLineLate, unicode
        )

        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_PixelAspectRatio, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionKey_PixelAspectRatioHorizontalSpacing, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionKey_PixelAspectRatioVerticalSpacing, unicode
        )

        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_ColorPrimaries, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionColorPrimaries_ITU_R_709_2, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionColorPrimaries_EBU_3213, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionColorPrimaries_SMPTE_C, unicode
        )

        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionColorPrimaries_DCI_P3, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionColorPrimaries_P3_D65, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionColorPrimaries_ITU_R_2020, unicode
        )

        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_TransferFunction, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionTransferFunction_ITU_R_709_2, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionTransferFunction_SMPTE_240M_1995, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionTransferFunction_UseGamma, unicode
        )

        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionTransferFunction_ITU_R_2020, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_GammaLevel, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_YCbCrMatrix, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionYCbCrMatrix_ITU_R_709_2, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionYCbCrMatrix_ITU_R_601_4, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionYCbCrMatrix_SMPTE_240M_1995, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionYCbCrMatrix_ITU_R_2020, unicode
        )

        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_ChromaLocationTopField, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_ChromaLocationBottomField, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionChromaLocation_Left, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionChromaLocation_Center, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionChromaLocation_TopLeft, unicode
        )
        self.assertIsInstance(CoreMedia.kCMFormatDescriptionChromaLocation_Top, unicode)
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionChromaLocation_BottomLeft, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionChromaLocation_Bottom, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionChromaLocation_DV420, unicode
        )

        self.assertIsInstance(
            CoreMedia.kCMMetadataFormatDescriptionKey_StructuralDependency, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMMetadataFormatDescriptionKey_SetupData, unicode
        )
        self.assertIsInstance(
    ...
    def test_constants10_12(self):
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionTransferFunction_SMPTE_ST_428_1, unicode
        )

    @min_os_level("10.13")
    def test_constants10_13(self):
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionTransferFunction_SMPTE_ST_2084_PQ, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionTransferFunction_ITU_R_2100_HLG, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_MasteringDisplayColorVolume, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_ContentLightLevelInfo, unicode
        )

    @min_os_level("10.14")
    def test_constants10_14(self):
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionTransferFunction_Linear, unicode
        )
    ...
    def test_constants10_15(self):
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionTransferFunction_sRGB, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_AuxiliaryTypeInfo, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_AlphaChannelMode, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionAlphaChannelMode_StraightAlpha, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionAlphaChannelMode_PremultipliedAlpha, unicode
        )
        self.assertIsInstance(
            CoreMedia.kCMFormatDescriptionExtension_ContainsAlphaChannel, unicode
        )
