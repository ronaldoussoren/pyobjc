...
#
# Last update: Fri Aug  9 18:31:12 2019
...
try:
    ...
    r(b'MLFeatureValue', b'featureValueWithCGImage_orientation_constraint_options_error_', {'arguments': {6: {'type_modifier': b'o'}}})
    r(b'MLFeatureValue', b'featureValueWithCGImage_orientation_pixelsWide_pixelsHigh_pixelFormatType_options_error_', {'arguments': {8: {'type_modifier': b'o'}}})
    ...
    r(b'MLFeatureValue', b'featureValueWithImageAtURL_orientation_constraint_options_error_', {'arguments': {6: {'type_modifier': b'o'}}})
    r(b'MLFeatureValue', b'featureValueWithImageAtURL_orientation_pixelsWide_pixelsHigh_pixelFormatType_options_error_', {'arguments': {8: {'type_modifier': b'o'}}})
    ...
    r(b'NSObject', b'writeToURL:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'o^@'}}})
