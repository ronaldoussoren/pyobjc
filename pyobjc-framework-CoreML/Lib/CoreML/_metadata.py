...
#
# Last update: Mon Jul 10 22:38:33 2017
...
constants = '''$MLModelAuthorKey$MLModelDescriptionKey$MLModelLicenseKey$MLModelVersionStringKey$'''
enums = '''$MLFeatureTypeDictionary@6$MLFeatureTypeDouble@2$MLFeatureTypeImage@4$MLFeatureTypeInt64@1$MLFeatureTypeInvalid@0$MLFeatureTypeMultiArray@5$MLFeatureTypeString@3$MLModelErrorDescriptionMismatch@2$MLModelErrorFeatureType@1$MLModelErrorGeneric@0$MLModelErrorIO@3$MLMultiArrayDataTypeDouble@65600$MLMultiArrayDataTypeFloat32@65568$MLMultiArrayDataTypeInt32@131104$'''
misc.update({})
