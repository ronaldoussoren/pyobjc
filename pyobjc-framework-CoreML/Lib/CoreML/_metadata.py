...
#
# Last update: Fri Jan 26 20:11:23 2024
#
# flake8: noqa
...
aliases = {"MODELCOLLECTION_SUNSET": "API_DEPRECATED"}
...
try:
    ...
    r(
        b"MLEvaluationPlan",
        b"evaluationPlanOfModelStructure:configuration:error:",
    ...
    r(
        b"MLModelStructure",
        b"modelStructureOfModelAtURL:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
