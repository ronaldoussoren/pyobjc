...
try:
    ...
    r(
        b"MLFeatureValue",
        b"featureValueWithCGImage_orientation_constraint_options_error_",
        {"arguments": {6: {"type_modifier": b"o"}}},
    )
    r(
        b"MLFeatureValue",
        b"featureValueWithCGImage_orientation_pixelsWide_pixelsHigh_pixelFormatType_options_error_",
    ...
    r(
        b"MLFeatureValue",
        b"featureValueWithImageAtURL_orientation_constraint_options_error_",
        {"arguments": {6: {"type_modifier": b"o"}}},
    )
    r(
        b"MLFeatureValue",
        b"featureValueWithImageAtURL_orientation_pixelsWide_pixelsHigh_pixelFormatType_options_error_",
        {"arguments": {8: {"type_modifier": b"o"}}},
    )
