...
if sys.maxsize > 2 ** 32:
    ...
    class TestMLMultiArray (TestCase):
        def testConstants(self):
            self.assertEqual(MLMultiArrayDataTypeDouble, 0x10000 | 64)
            self.assertEqual(MLMultiArrayDataTypeFloat32, 0x10000 | 32)
            self.assertEqual(MLMultiArrayDataTypeInt32, 0x20000 | 32)
        ...
        def testMethods(self):
            ...
            self.assertArgBlock(CoreML.MLMultiArray.initWithDataPointer_shape_dataType_strides_deallocator_error_, 4, b'v^v')
