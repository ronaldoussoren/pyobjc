...
if sys.maxsize > 2 ** 32:
    ...
    class TestMLFeatureValue_MLImageConversion (TestCase):
        ...
        def test_methods10_15(self):
            ...
            self.assertArgIsOut(CoreML.MLFeatureValue.featureValueWithImageAtURL_orientation_pixelsWide_pixelsHigh_pixelFormatType_options_error_, 6)
            self.assertArgIsOut(CoreML.MLFeatureValue.featureValueWithImageAtURL_orientation_constraint_options_error_, 4)
            self.assertArgIsOut(CoreML.MLFeatureValue.featureValueWithCGImage_orientation_pixelsWide_pixelsHigh_pixelFormatType_options_error_, 6)
            self.assertArgIsOut(CoreML.MLFeatureValue.featureValueWithCGImage_orientation_constraint_options_error_, 4)
