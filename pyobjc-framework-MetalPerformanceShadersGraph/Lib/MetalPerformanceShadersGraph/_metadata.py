...
try:
    ...
    r(b"MPSGraphSDPADescriptor", b"isCausal", {"retval": {"type": b"Z"}})
    r(b"MPSGraphSDPADescriptor", b"setIsCausal:", {"arguments": {2: {"type": b"Z"}}})
...
objc.registerNewKeywordsFromSelector("MPSGraph", b"init")
...
objc.registerNewKeywordsFromSelector("MPSGraphOperation", b"init")
objc.registerNewKeywordsFromSelector("MPSGraphShapedType", b"initWithShape:dataType:")
objc.registerNewKeywordsFromSelector("MPSGraphTensor", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywords(
    ...
    "descriptorWithStrideInX_strideInY_dilationRateInX_dilationRateInY_groups_paddingStyle_dataLayout_weightsLayout_",
)
objc.registerNewKeywords(
    ...
    "descriptorWithStrideInX_strideInY_strideInZ_dilationRateInX_dilationRateInY_dilationRateInZ_groups_paddingLeft_paddingRight_paddingTop_paddingBottom_paddingFront_paddingBack_paddingStyle_dataLayout_weightsLayout_",
)
objc.registerNewKeywords(
    "MPSGraphConvolution3DOpDescriptor",
    (
    ...
    "descriptorWithStrideInX_strideInY_strideInZ_dilationRateInX_dilationRateInY_dilationRateInZ_groups_paddingStyle_dataLayout_weightsLayout_",
)
objc.registerNewKeywords(
    "MPSGraphCreateSparseOpDescriptor",
    ("storageType", "dataType"),
    "descriptorWithStorageType_dataType_",
)
objc.registerNewKeywords(
    "MPSGraphDepthwiseConvolution2DOpDescriptor",
    ("dataLayout", "weightsLayout"),
    "descriptorWithDataLayout_weightsLayout_",
)
objc.registerNewKeywords(
    "MPSGraphDepthwiseConvolution2DOpDescriptor",
    (
    ...
    "descriptorWithStrideInX_strideInY_dilationRateInX_dilationRateInY_paddingLeft_paddingRight_paddingTop_paddingBottom_paddingStyle_dataLayout_weightsLayout_",
)
objc.registerNewKeywords(
    "MPSGraphDepthwiseConvolution3DOpDescriptor",
    ("paddingStyle",),
    "descriptorWithPaddingStyle_",
)
objc.registerNewKeywords(
    "MPSGraphDepthwiseConvolution3DOpDescriptor",
    ("strides", "dilationRates", "paddingValues", "paddingStyle"),
    "descriptorWithStrides_dilationRates_paddingValues_paddingStyle_",
)
objc.registerNewKeywords("MPSGraphDevice", ("MTLDevice",), "deviceWithMTLDevice_")
objc.registerNewKeywords(
    ...
    "descriptorWithKernelWidth_kernelHeight_strideInX_strideInY_dilationRateInX_dilationRateInY_dataLayout_",
)
objc.registerNewKeywords(
    "MPSGraphImToColOpDescriptor",
    (
    ...
    "descriptorWithKernelWidth_kernelHeight_strideInX_strideInY_dilationRateInX_dilationRateInY_paddingLeft_paddingRight_paddingTop_paddingBottom_dataLayout_",
)
objc.registerNewKeywords(
    ...
    "descriptorWithKernelWidth_kernelHeight_strideInX_strideInY_dilationRateInX_dilationRateInY_paddingLeft_paddingRight_paddingTop_paddingBottom_paddingStyle_dataLayout_",
)
objc.registerNewKeywords(
    "MPSGraphPooling2DOpDescriptor",
    (
    ...
    "descriptorWithKernelWidth_kernelHeight_strideInX_strideInY_paddingStyle_dataLayout_",
)
objc.registerNewKeywords(
    "MPSGraphPooling4DOpDescriptor",
    ("kernelSizes", "paddingStyle"),
    "descriptorWithKernelSizes_paddingStyle_",
)
objc.registerNewKeywords(
    "MPSGraphPooling4DOpDescriptor",
    ("kernelSizes", "strides", "dilationRates", "paddingValues", "paddingStyle"),
    "descriptorWithKernelSizes_strides_dilationRates_paddingValues_paddingStyle_",
)
objc.registerNewKeywords(
    "MPSGraphRandomOpDescriptor",
    ("distribution", "dataType"),
    "descriptorWithDistribution_dataType_",
)
objc.registerNewKeywords("MPSGraphSDPADescriptor", ("scale",), "descriptorWithScale_")
objc.registerNewKeywords(
    "MPSGraphStencilOpDescriptor",
    ("explicitPadding",),
    "descriptorWithExplicitPadding_",
)
objc.registerNewKeywords(
    "MPSGraphStencilOpDescriptor",
    ("offsets", "explicitPadding"),
    "descriptorWithOffsets_explicitPadding_",
)
objc.registerNewKeywords(
    "MPSGraphStencilOpDescriptor", ("paddingStyle",), "descriptorWithPaddingStyle_"
)
objc.registerNewKeywords(
    "MPSGraphStencilOpDescriptor",
    (
    ...
    "descriptorWithReductionMode_offsets_strides_dilationRates_explicitPadding_boundaryMode_paddingStyle_paddingConstant_",
)
expressions = {}
