...
try:
    ...
    r(
        b"UTType",
        b"typeWithIdentifier:allowUndeclared:",
...
objc.registerNewKeywords(
    "UTType", ("identifier", "allowUndeclared"), "typeWithIdentifier_allowUndeclared_"
)
