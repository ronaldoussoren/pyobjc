...
class TestSTWebpageController(TestCase):
    def test_methods(self):
        ...
        self.assertArgIsBOOL(ScreenTime.STWebpageController.setSuppressUsageRecording_, 0)
        ...
        self.assertArgIsBOOL(ScreenTime.STWebpageController.setURLIsPictureInPicture_, 0)

        self.assertResultIsBOOL(ScreenTime.STWebpageController.URLIsBlocked)

        self.assertResultIsBOOL(ScreenTime.STWebpageController.setBundleIdentifier_error_)
        self.assertArgIsOut(ScreenTime.STWebpageController.setBundleIdentifier_error_, 1)
