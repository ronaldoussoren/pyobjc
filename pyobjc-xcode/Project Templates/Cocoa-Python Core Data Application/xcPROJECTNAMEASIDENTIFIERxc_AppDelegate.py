...
class xcPROJECTNAMEASIDENTIFIERxc_AppDelegate(NSObject):
    ...
    def persistentStoreCoordinator(self):
        ...
        storePath = os.path.join(
            applicationSupportFolder, "xcPROJECTNAMEASIDENTIFIERxc.xml"
        )
        url = NSURL.fileURLWithPath_(storePath)
        self._persistentStoreCoordinator = NSPersistentStoreCoordinator.alloc().initWithManagedObjectModel_(
