...
class TestObjectAPI (TestCase):
    ...
    def test_functions(self):
        ...
        self.assertResultHasType(libdispatch.dispatch_get_context, objc._C_PTR + objc._C_VOID)
        ...
        self.assertArgHasType(libdispatch.dispatch_set_context, 1, objc._C_PTR + objc._C_VOID)
