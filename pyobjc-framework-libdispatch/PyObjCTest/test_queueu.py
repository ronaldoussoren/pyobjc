...
class TestQueueAPI (TestCase):
    ...
    def test_functions(self):
       ...
       self.assertArgHasType(libdispatch.dispatch_async, 0, objc._C_ID) # dispatch_queue_t
       self.assertArgIsBlock(libdispatch.dispatch_async, 1, b'v')

       self.assertResultHasType(libdispatch.dispatch_async_f, objc._C_VOID)
       self.assertArgHasType(libdispatch.dispatch_async_f, 0, objc._C_ID) # dispatch_queue_t
       ...
       self.assertArgHasType(libdispatch.dispatch_sync, 0, objc._C_ID) # dispatch_queue_t
       self.assertArgIsBlock(libdispatch.dispatch_sync, 1, b'v')

       self.assertResultHasType(libdispatch.dispatch_sync_f, objc._C_VOID)
       self.assertArgHasType(libdispatch.dispatch_sync_f, 0, objc._C_ID) # dispatch_queue_t
       ...
       self.assertArgHasType(libdispatch.dispatch_apply, 1, objc._C_ID) # dispatch_queue_t
       ...
       self.assertArgHasType(libdispatch.dispatch_apply_f, 1, objc._C_ID) # dispatch_queue_t
       ...
       self.assertResultHasType(libdispatch.dispatch_queue_get_label, objc._C_PTR + objc._C_CHAR_AS_TEXT)
       ...
       self.assertArgHasType(libdispatch.dispatch_queue_create, 0, objc._C_IN + objc._C_PTR + objc._C_CHAR_AS_TEXT)
       ...
       self.assertArgHasType(libdispatch.dispatch_after, 1, objc._C_ID) # dispatch_queue_t
       ...
       self.assertArgHasType(libdispatch.dispatch_after_f, 1, objc._C_ID) # dispatch_queue_t
    ...
    def testFunctions10_7(self):
       ...
       self.assertArgHasType(libdispatch.dispatch_barrier_async, 0, objc._C_ID) # dispatch_queue_t
       ...
       self.assertArgHasType(libdispatch.dispatch_barrier_async_f, 0, objc._C_ID) # dispatch_queue_t
       self.assertArgHasType(libdispatch.dispatch_barrier_async_f, 1, objc._C_PTR + objc._C_VOID)
       ...
       self.assertArgHasType(libdispatch.dispatch_barrier_sync, 0, objc._C_ID) # dispatch_queue_t
       ...
       self.assertArgHasType(libdispatch.dispatch_barrier_sync_f, 0, objc._C_ID) # dispatch_queue_t
       self.assertArgHasType(libdispatch.dispatch_barrier_sync_f, 1, objc._C_PTR + objc._C_VOID)
       ...
       self.assertArgHasType(libdispatch.dispatch_queue_set_specific, 0, objc._C_ID) # dispatch_queue_t
       self.assertArgHasType(libdispatch.dispatch_queue_set_specific, 1, objc._C_PTR + objc._C_VOID)
       self.assertArgHasType(libdispatch.dispatch_queue_set_specific, 2, objc._C_PTR + objc._C_VOID)
       self.assertArgIsFunction(libdispatch.dispatch_queue_set_specific, 3, b'v^v', 1)

       self.assertResultHasType(libdispatch.dispatch_queue_get_specific, objc._C_PTR + objc._C_VOID)
       self.assertArgHasType(libdispatch.dispatch_queue_get_specific, 0, objc._C_ID) # dispatch_queue_t
       self.assertArgHasType(libdispatch.dispatch_queue_get_specific, 1, objc._C_PTR + objc._C_VOID)

       self.assertResultHasType(libdispatch.dispatch_get_specific, objc._C_PTR + objc._C_VOID)
       self.assertArgHasType(libdispatch.dispatch_get_specific, 0, objc._C_PTR + objc._C_VOID)

    @min_os_level('10.10')
    def testFunctions10_10(self):
       self.assertResultHasType(libdispatch.dispatch_queue_attr_make_with_qos_class, objc._C_ID)
       self.assertArgHasType(libdispatch.dispatch_queue_attr_make_with_qos_class, 0, objc._C_ID)
       self.assertArgHasType(libdispatch.dispatch_queue_attr_make_with_qos_class, 1, objc._C_UINT)
       self.assertArgHasType(libdispatch.dispatch_queue_attr_make_with_qos_class, 2, objc._C_INT)
       ...
       self.assertArgHasType(libdispatch.dispatch_queue_get_qos_class, 1, objc._C_OUT + objc._C_PTR + objc._C_INT)

    @min_os_level('10.12')
    def testFunctions10_12(self):
       self.assertResultHasType(libdispatch.dispatch_queue_attr_make_initially_inactive, objc._C_ID)
       self.assertArgHasType(libdispatch.dispatch_queue_attr_make_initially_inactive, 0, objc._C_ID)

       self.assertResultHasType(libdispatch.dispatch_queue_attr_make_with_autorelease_frequency, objc._C_ID)
       self.assertArgHasType(libdispatch.dispatch_queue_attr_make_with_autorelease_frequency, 0, objc._C_ID)
       self.assertArgHasType(libdispatch.dispatch_queue_attr_make_with_autorelease_frequency, 1, objc._C_ULNG)

       self.assertResultHasType(libdispatch.dispatch_queue_create_with_target, objc._C_ID)
       self.assertArgHasType(libdispatch.dispatch_queue_create_with_target, 0, objc._C_IN + objc._C_PTR + objc._C_CHAR_AS_TEXT)
       self.assertArgIsNullTerminated(libdispatch.dispatch_queue_create_with_target, 0)
       self.assertArgHasType(libdispatch.dispatch_queue_create_with_target, 1, objc._C_ID)
       self.assertArgHasType(libdispatch.dispatch_queue_create_with_target, 2, objc._C_ID)
