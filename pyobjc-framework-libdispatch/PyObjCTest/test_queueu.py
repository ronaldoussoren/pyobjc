...
class TestQueueAPI(TestCase):
    ...
    def test_functions10_14(self):
        ...
        self.assertResultHasType(libdispatch.dispatch_barrier_async_and_wait, objc._C_VOID)
        self.assertArgHasType(
        ...
        self.assertResultHasType(libdispatch.dispatch_barrier_async_and_wait_f, objc._C_VOID)
        self.assertArgHasType(
        ...
        self.assertArgIsFunction(libdispatch.dispatch_barrier_async_and_wait_f, 2, b"v^v", 1)
