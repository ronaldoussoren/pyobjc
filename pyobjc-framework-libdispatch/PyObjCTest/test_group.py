...
class TestGroupAPI (TestCase):
    ...
    def test_functions(self):
        ...
        self.assertArgHasType(libdispatch.dispatch_group_async, 1, objc._C_ID) # dispatch_queue_t
        ...
        self.assertArgHasType(libdispatch.dispatch_group_async_f, 0, objc._C_ID) # dispatch_group_t
        self.assertArgHasType(libdispatch.dispatch_group_async_f, 1, objc._C_ID) # dispatch_queue_t
        ...
        self.assertArgHasType(libdispatch.dispatch_group_wait, 0, objc._C_ID) # dispatch_group_t
        ...
        self.assertArgHasType(libdispatch.dispatch_group_notify, 0, objc._C_ID) # dispatch_group_t
        self.assertArgHasType(libdispatch.dispatch_group_notify, 1, objc._C_ID) # dispatch_queue_t
        ...
        self.assertArgHasType(libdispatch.dispatch_group_notify_f, 0, objc._C_ID) # dispatch_group_t
        self.assertArgHasType(libdispatch.dispatch_group_notify_f, 1, objc._C_ID) # dispatch_queue_t
        ...
        self.assertArgHasType(libdispatch.dispatch_group_enter, 0, objc._C_ID) # dispatch_group_t

        self.assertResultHasType(libdispatch.dispatch_group_leave, objc._C_VOID)
        self.assertArgHasType(libdispatch.dispatch_group_leave, 0, objc._C_ID) # dispatch_group_t
