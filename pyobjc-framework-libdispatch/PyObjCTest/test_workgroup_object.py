...
class TestWorkgroupObjectAPI(TestCase):
    ...
    def test_functions(self):
        ...
        self.assertResultHasType(dispatch.os_workgroup_create_with_workgroup, objc._C_ID)
        self.assertArgHasType(
        ...
        self.assertArgHasType(dispatch.os_workgroup_create_with_workgroup, 1, objc._C_ID)
        ...
        self.assertResultHasType(dispatch.os_workgroup_max_parallel_threads, objc._C_INT)
