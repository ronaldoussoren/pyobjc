...
class TestBlockAPI (TestCase):
    ...
    def test_functions(self):
        ...
        self.assertArgHasType(libdispatch.dispatch_block_create_with_qos_class, 0, objc._C_ULNG)
        self.assertArgHasType(libdispatch.dispatch_block_create_with_qos_class, 1, objc._C_UINT)
        self.assertArgHasType(libdispatch.dispatch_block_create_with_qos_class, 2, objc._C_INT)
        ...
        self.assertArgHasType(libdispatch.dispatch_block_notify, 1, objc._C_ID) # dispatch_queue_t
