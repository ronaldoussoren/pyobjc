...
class TestTime (TestCase):
    def test_constants(self):
        self.assertEqual(libdispatch.NSEC_PER_SEC, 1000000000)
        self.assertEqual(libdispatch.NSEC_PER_MSEC, 1000000)
        self.assertEqual(libdispatch.USEC_PER_SEC, 1000000)
