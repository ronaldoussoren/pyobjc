...
class TestIoAPI (TestCase):
    ...
    def test_functions(self):
        ...
        self.assertArgHasType(libdispatch.dispatch_read, 2,  objc._C_ID) # dispatch_queue_t
        ...
        self.assertArgHasType(libdispatch.dispatch_write, 1,  objc._C_ID) # dispatch_data_t
        self.assertArgHasType(libdispatch.dispatch_write, 2,  objc._C_ID) # dispatch_queue_t
        ...
        self.assertArgHasType(libdispatch.dispatch_io_create_with_path, 1,  objc._C_IN + objc._C_PTR + objc._C_CHAR_AS_TEXT)
        ...
        self.assertArgHasType(libdispatch.dispatch_io_create_with_io, 1,  objc._C_ID) # dispatch_io_t
        self.assertArgHasType(libdispatch.dispatch_io_create_with_io, 2,  objc._C_ID) # dispatch_queue_t
        self.assertArgIsBlock(libdispatch.dispatch_write, 3,  b'v@i')

        self.assertResultHasType(libdispatch.dispatch_io_read, objc._C_VOID)
        self.assertArgHasType(libdispatch.dispatch_io_read, 0,  objc._C_ID) # dispatch_io_t
        ...
        self.assertArgHasType(libdispatch.dispatch_io_read, 3,  objc._C_ID) # dispatch_queue_t
        ...
        self.assertArgHasType(libdispatch.dispatch_io_write, 0,  objc._C_ID) # dispatch_io_t
        self.assertArgHasType(libdispatch.dispatch_io_write, 1,  objc._C_LNGLNG)
        self.assertArgHasType(libdispatch.dispatch_io_write, 2,  objc._C_ID) # dispatch_data_t
        self.assertArgHasType(libdispatch.dispatch_io_write, 3,  objc._C_ID) # dispatch_queue_t
        ...
        self.assertArgHasType(libdispatch.dispatch_io_close, 0,  objc._C_ID) # dispatch_io_t
        ...
        self.assertArgHasType(libdispatch.dispatch_io_barrier, 0,  objc._C_ID) # dispatch_io_t
        ...
        self.assertArgHasType(libdispatch.dispatch_io_get_descriptor, 0,  objc._C_ID) # dispatch_io_t

        self.assertResultHasType(libdispatch.dispatch_io_set_high_water, objc._C_VOID)
        self.assertArgHasType(libdispatch.dispatch_io_set_high_water, 0,  objc._C_ID) # dispatch_io_t
        ...
        self.assertArgHasType(libdispatch.dispatch_io_set_low_water, 0,  objc._C_ID) # dispatch_io_t
        ...
        self.assertArgHasType(libdispatch.dispatch_io_set_interval, 0,  objc._C_ID) # dispatch_io_t
