...
class TestSourceAPI(TestCase):
    ...
    def test_constants(self):
        self.assertIsInstance(
            libdispatch.DISPATCH_SOURCE_TYPE_DATA_ADD, libdispatch.dispatch_source_t
        )
        self.assertIsInstance(
            libdispatch.DISPATCH_SOURCE_TYPE_DATA_OR, libdispatch.dispatch_source_t
        )
        self.assertIsInstance(
            libdispatch.DISPATCH_SOURCE_TYPE_MACH_SEND, libdispatch.dispatch_source_t
        )
        self.assertIsInstance(
        ...
        self.assertIsInstance(
            libdispatch.DISPATCH_SOURCE_TYPE_READ, libdispatch.dispatch_source_t
        )
        self.assertIsInstance(
            libdispatch.DISPATCH_SOURCE_TYPE_SIGNAL, libdispatch.dispatch_source_t
        )
        self.assertIsInstance(
            libdispatch.DISPATCH_SOURCE_TYPE_TIMER, libdispatch.dispatch_source_t
        )
        self.assertIsInstance(
            libdispatch.DISPATCH_SOURCE_TYPE_VNODE, libdispatch.dispatch_source_t
        )
        self.assertIsInstance(
            libdispatch.DISPATCH_SOURCE_TYPE_WRITE, libdispatch.dispatch_source_t
        )
    ...
    def test_constants10_13(self):
        self.assertIsInstance(
            libdispatch.DISPATCH_SOURCE_TYPE_DATA_REPLACE, libdispatch.dispatch_source_t
        )

    @min_os_level("10.6")
    def test_functions(self):
        self.assertResultIsRetained(libdispatch.dispatch_source_create)
        self.assertResultHasType(libdispatch.dispatch_source_create, objc._C_ID)
        self.assertArgHasType(
            libdispatch.dispatch_source_create,
            0,
            libdispatch.dispatch_source_t.__typestr__,
        )
        ...
        self.assertResultHasType(
            libdispatch.dispatch_source_set_event_handler, objc._C_VOID
        )
        self.assertArgHasType(
            libdispatch.dispatch_source_set_event_handler, 0, objc._C_ID
        )
        self.assertArgIsBlock(libdispatch.dispatch_source_set_event_handler, 1, b"v")

        self.assertResultHasType(
            libdispatch.dispatch_source_set_event_handler_f, objc._C_VOID
        )
        self.assertArgHasType(
            libdispatch.dispatch_source_set_event_handler_f, 0, objc._C_ID
        )
        self.assertArgIsFunction(
            libdispatch.dispatch_source_set_event_handler_f, 1, b"v^v", 1
        )

        self.assertResultHasType(
            libdispatch.dispatch_source_set_cancel_handler, objc._C_VOID
        )
        self.assertArgHasType(
            libdispatch.dispatch_source_set_cancel_handler, 0, objc._C_ID
        )
        self.assertArgIsBlock(libdispatch.dispatch_source_set_cancel_handler, 1, b"v")

        self.assertResultHasType(
            libdispatch.dispatch_source_set_cancel_handler_f, objc._C_VOID
        )
        self.assertArgHasType(
            libdispatch.dispatch_source_set_cancel_handler_f, 0, objc._C_ID
        )
        self.assertArgIsFunction(
            libdispatch.dispatch_source_set_cancel_handler_f, 1, b"v^v", 1
        )
        ...
        self.assertResultHasType(
            libdispatch.dispatch_source_set_registration_handler, objc._C_VOID
        )
        self.assertArgHasType(
            libdispatch.dispatch_source_set_registration_handler, 0, objc._C_ID
        )
        self.assertArgIsBlock(
            libdispatch.dispatch_source_set_registration_handler, 1, b"v"
        )

        self.assertResultHasType(
            libdispatch.dispatch_source_set_registration_handler_f, objc._C_VOID
        )
        self.assertArgHasType(
            libdispatch.dispatch_source_set_registration_handler_f, 0, objc._C_ID
        )
        self.assertArgIsFunction(
