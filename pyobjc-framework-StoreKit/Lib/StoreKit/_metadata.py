...
#
# Last update: Fri Aug  9 18:42:44 2019
...
try:
    ...
    r(b'SKArcadeService', b'arcadeSubscriptionStatusWithNonce:resultHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'@'}, 'arguments': {0: {'type': b'@'}, 1: {'type': b'I'}, 2: {'type': b'@'}, 3: {'type': b'I'}, 4: {'type': b'@'}}}}}})
    r(b'SKArcadeService', b'registerArcadeAppWithRandomFromLib:randomFromLibLength:resultHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'@'}, 'arguments': {0: {'type': b'@'}, 1: {'type': b'I'}, 2: {'type': b'@'}, 3: {'type': b'I'}, 4: {'type': b'@'}}}}}})
