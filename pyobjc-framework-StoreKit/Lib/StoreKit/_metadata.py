...
#
# Last update: Sun Sep 29 13:13:39 2019
...
try:
    r(b'NSObject', b'cloudServiceSetupViewControllerDidDismiss:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'paymentQueue:shouldContinueTransaction:inStorefront:', {'required': False, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    ...
    r(b'NSObject', b'paymentQueueDidChangeStorefront:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'paymentQueueRestoreCompletedTransactionsFinished:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'productViewControllerDidFinish:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'SKArcadeService', b'arcadeSubscriptionStatusWithNonce:resultHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'@'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'I'}, 3: {'type': b'@'}, 4: {'type': b'I'}, 5: {'type': b'@'}}}}}})
    r(b'SKArcadeService', b'registerArcadeAppWithRandomFromLib:randomFromLibLength:resultHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'I'}, 3: {'type': b'@'}, 4: {'type': b'I'}, 5: {'type': b'@'}}}}}})
