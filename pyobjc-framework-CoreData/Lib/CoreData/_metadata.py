...
try:
    ...
    r(b"NSEntityDescription", b"isAbstract", {"retval": {"type": b"Z"}})
    r(b"NSEntityDescription", b"isKindOfEntity:", {"retval": {"type": b"Z"}})
    r(b"NSEntityDescription", b"setAbstract:", {"arguments": {2: {"type": b"Z"}}})
    r(
    ...
    r(b"NSFetchIndexElementDescription", b"isAscending", {"retval": {"type": b"Z"}})
    r(
    ...
    r(b"NSFetchRequest", b"includesPendingChanges", {"retval": {"type": b"Z"}})
    r(b"NSFetchRequest", b"includesPropertyValues", {"retval": {"type": b"Z"}})
    r(b"NSFetchRequest", b"includesSubentities", {"retval": {"type": b"Z"}})
    r(b"NSFetchRequest", b"returnsDistinctResults", {"retval": {"type": b"Z"}})
    r(b"NSFetchRequest", b"returnsObjectsAsFaults", {"retval": {"type": b"Z"}})
    r(
        b"NSFetchRequest",
    ...
    r(b"NSFetchRequest", b"setIncludesSubentities:", {"arguments": {2: {"type": b"Z"}}})
    r(
        b"NSFetchRequest",
    ...
    r(b"NSFetchRequestExpression", b"isCountOnlyRequest", {"retval": {"type": b"Z"}})
    r(
    ...
    r(b"NSManagedObject", b"hasFaultForRelationshipNamed:", {"retval": {"type": b"Z"}})
    r(b"NSManagedObject", b"hasPersistentChangedValues", {"retval": {"type": b"Z"}})
    r(b"NSManagedObject", b"isDeleted", {"retval": {"type": b"Z"}})
    r(b"NSManagedObject", b"isFault", {"retval": {"type": b"Z"}})
    r(b"NSManagedObject", b"isInserted", {"retval": {"type": b"Z"}})
    r(b"NSManagedObject", b"isUpdated", {"retval": {"type": b"Z"}})
    ...
    r(b"NSManagedObjectContext", b"hasChanges", {"retval": {"type": b"Z"}})
    r(
        b"NSManagedObjectContext",
    ...
    r(b"NSManagedObjectContext", b"tryLock", {"retval": {"type": b"Z"}})
    r(b"NSManagedObjectID", b"isTemporaryID", {"retval": {"type": b"Z"}})
    r(
    ...
    r(
        ...
        {"retval": {"type": b"Z"}, "arguments": {9: {"type_modifier": b"o"}}},
    )
    r(
        b"NSMigrationManager",
    ...
    r(b"NSPersistentStore", b"isReadOnly", {"retval": {"type": b"Z"}})
    r(
        b"NSPersistentStore",
        b"loadMetadata:",
        {"retval": {"type": b"Z"}, "arguments": {2: {"type_modifier": b"o"}}},
    ...
    r(b"NSPersistentStore", b"setReadOnly:", {"arguments": {2: {"type": b"Z"}}})
    r(
    ...
    r(b"NSPersistentStoreCoordinator", b"tryLock", {"retval": {"type": b"Z"}})
    r(b"NSPersistentStoreDescription", b"isReadOnly", {"retval": {"type": b"Z"}})
    r(
    ...
    r(b"NSPropertyDescription", b"isIndexed", {"retval": {"type": b"Z"}})
    r(b"NSPropertyDescription", b"isIndexedBySpotlight", {"retval": {"type": b"Z"}})
    r(b"NSPropertyDescription", b"isOptional", {"retval": {"type": b"Z"}})
    r(b"NSPropertyDescription", b"isStoredInExternalRecord", {"retval": {"type": b"Z"}})
    r(b"NSPropertyDescription", b"isTransient", {"retval": {"type": b"Z"}})
    r(b"NSPropertyDescription", b"setIndexed:", {"arguments": {2: {"type": b"Z"}}})
    r(
        b"NSPropertyDescription",
        b"setIndexedBySpotlight:",
        {"arguments": {2: {"type": b"Z"}}},
    )
    r(b"NSPropertyDescription", b"setOptional:", {"arguments": {2: {"type": b"Z"}}})
    r(
        b"NSPropertyDescription",
        b"setStoredInExternalRecord:",
        {"arguments": {2: {"type": b"Z"}}},
    )
    r(b"NSPropertyDescription", b"setTransient:", {"arguments": {2: {"type": b"Z"}}})
    r(b"NSRelationshipDescription", b"isOrdered", {"retval": {"type": b"Z"}})
    r(b"NSRelationshipDescription", b"isToMany", {"retval": {"type": b"Z"}})
...
expressions = {}
formal_protocols = {
    "NSFetchRequestResult": "NSFetchRequestResult",
