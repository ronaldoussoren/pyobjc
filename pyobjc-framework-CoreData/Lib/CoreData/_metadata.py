...
#
# Last update: Sun Nov 15 11:05:36 2020
#
# flake8: noqa
...
try:
    ...
    r(b'NSAttributeDescription', b'preservesValueInHistoryOnDeletion', {'retval': {'type': b'Z'}})
    r(b'NSAttributeDescription', b'setAllowsExternalBinaryDataStorage:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSAttributeDescription', b'setPreservesValueInHistoryOnDeletion:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSBatchInsertRequest', b'batchInsertRequestWithEntityName:dictionaryHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSBatchInsertRequest', b'batchInsertRequestWithEntityName:managedObjectHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSBatchInsertRequest', b'dictionaryHandler', {'retval': {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}})
    r(b'NSBatchInsertRequest', b'initWithEntity:dictionaryHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSBatchInsertRequest', b'initWithEntity:managedObjectHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSBatchInsertRequest', b'initWithEntityName:dictionaryHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSBatchInsertRequest', b'initWithEntityName:managedObjectHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSBatchInsertRequest', b'managedObjectHandler', {'retval': {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}})
    r(b'NSBatchInsertRequest', b'setDictionaryHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSBatchInsertRequest', b'setManagedObjectHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    ...
    r(b'NSCoreDataCoreSpotlightDelegate', b'searchableIndex:reindexAllSearchableItemsWithAcknowledgementHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    ...
    r(b'NSManagedObject', b'contextShouldIgnoreUnmodeledPropertyChanges', {'retval': {'type': b'Z'}})
    ...
    r(b'NSObject', b'controller:didChangeContentWithDifference:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'controller:didChangeContentWithSnapshot:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'controller:didChangeObject:atIndexPath:forChangeType:newIndexPath:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': sel32or64(b'I', b'Q')}, 6: {'type': b'@'}}})
    r(b'NSObject', b'controller:didChangeSection:atIndex:forChangeType:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': sel32or64(b'I', b'Q')}, 5: {'type': sel32or64(b'I', b'Q')}}})
    r(b'NSObject', b'controller:sectionIndexTitleForSectionName:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'controllerDidChangeContent:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'controllerWillChangeContent:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSPersistentCloudKitContainer', b'canDeleteRecordForManagedObjectWithID:', {'retval': {'type': 'Z'}})
    r(b'NSPersistentCloudKitContainer', b'canModifyManagedObjectsInStore:', {'retval': {'type': 'Z'}})
    r(b'NSPersistentCloudKitContainer', b'canUpdateRecordForManagedObjectWithID:', {'retval': {'type': 'Z'}})
    r(b'NSPersistentCloudKitContainer', b'initializeCloudKitSchemaWithOptions:error:', {'retval': {'type': b'Z'}, 'arguments': {3: {'type_modifier': b'o'}}})
    ...
    r(b'NSPersistentStoreCoordinator', b'metadataForPersistentStoreOfType:URL:options:error:', {'arguments': {5: {'type_modifier': b'o'}}})
