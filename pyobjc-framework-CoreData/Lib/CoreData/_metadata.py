...
#
# Last update: Tue Aug 19 22:29:49 2014
...
try:
    ...
    r(b'NSPersistentStoreCoordinator', b'removeUbiquitousContentAndPersistentStoreAtURL:options:error:', {'retval': {'type': b'Z'}, 'arguments': {6: {'type_modifier': b'o'}}})
