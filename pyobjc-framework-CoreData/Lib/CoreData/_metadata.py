...
#
# Last update: Sun Jun 30 14:35:42 2019
...
try:
    ...
    r(b'NSPersistentCloudKitContainerOptions', b'setShouldInitializeSchema:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSPersistentCloudKitContainerOptions', b'shouldInitializeSchema', {'retval': {'type': b'Z'}})
