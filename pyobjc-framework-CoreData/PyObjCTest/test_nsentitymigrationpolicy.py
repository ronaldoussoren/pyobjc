...
class TestNSEntityMigrationPolicy(TestCase):
    ...
    def testMethods(self):
        ...
        self.assertResultIsBOOL(
            NSEntityMigrationPolicy.createRelationshipsForDestinationInstance_entityMapping_manager_error_
        )
        self.assertArgIsOut(
            NSEntityMigrationPolicy.createRelationshipsForDestinationInstance_entityMapping_manager_error_,
            3,
        ...
        self.assertResultIsBOOL(
            NSEntityMigrationPolicy.endRelationshipCreationForEntityMapping_manager_error_
        )
        self.assertArgIsOut(
            NSEntityMigrationPolicy.endRelationshipCreationForEntityMapping_manager_error_,
            2,
        ...
        self.assertResultIsBOOL(
            NSEntityMigrationPolicy.performCustomValidationForEntityMapping_manager_error_
        )
        self.assertArgIsOut(
            NSEntityMigrationPolicy.performCustomValidationForEntityMapping_manager_error_,
            2,
