...
class TestNSPersistentStoreCoordinator(TestCase):
    def testConstants(self):
        ...
        self.assertIsInstance(
            NSPersistentStoreCoordinatorStoresDidChangeNotification, unicode
        )
    ...
    def testConstants10_5(self):
        ...
        self.assertIsInstance(
            NSPersistentStoreCoordinatorWillRemoveStoreNotification, unicode
        )
    ...
    def testConstants10_7(self):
        ...
        self.assertIsInstance(
            NSPersistentStoreDidImportUbiquitousContentChangesNotification, unicode
        )
    ...
    def testConstants10_9(self):
        ...
        self.assertIsInstance(
            NSPersistentStoreCoordinatorStoresWillChangeNotification, unicode
        )
    ...
    def testConstants10_15(self):
        self.assertIsInstance(
            NSPersistentStoreRemoteChangeNotificationPostOptionKey, unicode
        )
    ...
    def testMethods(self):
        ...
        self.assertArgIsOut(
            NSPersistentStoreCoordinator.metadataForPersistentStoreWithURL_error_, 1
        )

    @min_os_level("10.5")
    def testMethods10_5(self):
        self.assertArgIsOut(
            NSPersistentStoreCoordinator.metadataForPersistentStoreOfType_URL_error_, 2
        )
        self.assertResultIsBOOL(
            NSPersistentStoreCoordinator.setMetadata_forPersistentStoreOfType_URL_error_
        )
        self.assertArgIsOut(
            NSPersistentStoreCoordinator.setMetadata_forPersistentStoreOfType_URL_error_,
            3,
    ...
    def testMethods10_6(self):
        self.assertArgIsOut(
            NSPersistentStoreCoordinator.importStoreWithIdentifier_fromExternalRecordsDirectory_toURL_options_withType_error_,
            5,
        )
    ...
    def testMethods10_7(self):
        self.assertArgIsOut(
            NSPersistentStoreCoordinator.executeRequest_withContext_error_, 2
        )

    @min_os_level("10.9")
    def testMethods10_9(self):
        self.assertArgIsOut(
            NSPersistentStoreCoordinator.setMetadata_forPersistentStoreOfType_URL_options_error_,
            4,
        )
        self.assertResultIsBOOL(
            NSPersistentStoreCoordinator.setMetadata_forPersistentStoreOfType_URL_options_error_
        ...
        self.assertArgIsOut(
            NSPersistentStoreCoordinator.removeUbiquitousContentAndPersistentStoreAtURL_options_error_,
            2,
        )
        self.assertResultIsBOOL(
            NSPersistentStoreCoordinator.removeUbiquitousContentAndPersistentStoreAtURL_options_error_
    ...
    def testMethods10_11(self):
        self.assertArgIsOut(
            NSPersistentStoreCoordinator.destroyPersistentStoreAtURL_withType_options_error_,
            3,
        )
        self.assertResultIsBOOL(
            NSPersistentStoreCoordinator.destroyPersistentStoreAtURL_withType_options_error_
        ...
        self.assertArgIsOut(
            NSPersistentStoreCoordinator.replacePersistentStoreAtURL_destinationOptions_withPersistentStoreFromURL_sourceOptions_storeType_error_,
            5,
        )
        self.assertResultIsBOOL(
            NSPersistentStoreCoordinator.replacePersistentStoreAtURL_destinationOptions_withPersistentStoreFromURL_sourceOptions_storeType_error_
    ...
    def testMethods10_12(self):
        self.assertArgIsBlock(
            NSPersistentStoreCoordinator.addPersistentStoreWithDescription_completionHandler_,
            1,
            b"v@@",
        )
