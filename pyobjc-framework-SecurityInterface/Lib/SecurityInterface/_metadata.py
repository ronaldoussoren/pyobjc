...
#
# Last update: Sun Mar 22 15:04:50 2020
#
# flake8: noqa
...
try:
    ...
    r(
        ...
        b"authorizationRights",
        {
            "retval": {
                "type": sel32or64(
                    b"^{_AuthorizationRights=L^{_AuthorizationItem=^cL^vL}}",
    ...
    r(
        ...
        {"arguments": {6: {"sel_of_type": sel32or64(b"v@:@i^v", b"v@:@q^v")}}},
    )
    r(
        ...
        b"beginSheetForWindow:modalDelegate:didEndSelector:contextInfo:settings:keychain:",
        {
            "arguments": {
                ...
                6: {
                    "type": sel32or64(
                        b"^{SecKeychainSettings=LZZL}", b"^{SecKeychainSettings=IZZI}"
                    )
                },
            }
        },
