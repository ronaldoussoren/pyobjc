...
objc.registerNewKeywordsFromSelector("OSLogPosition", b"init")
objc.registerNewKeywordsFromSelector("OSLogStore", b"init")

objc.registerNewKeywords("OSLogStore", ("scope", "error"), "storeWithScope_error_")
objc.registerNewKeywords("OSLogStore", ("URL", "error"), "storeWithURL_error_")
expressions = {}
formal_protocols = {
    "OSLogEntryFromProcess": "OSLogEntryFromProcess",
    "OSLogEntryWithPayload": "OSLogEntryWithPayload",
}
