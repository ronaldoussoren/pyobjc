...
#
# Last update: Sat Jun 27 17:22:16 2020
#
# flake8: noqa
...
try:
    ...
    r(b'OSLogStore', b'entriesEnumeratorAndReturnError:', {'arguments': {2: {'type_modifier': b'o'}}})
    r(b'OSLogStore', b'entriesEnumeratorWithOptions:position:predicate:error:', {'arguments': {5: {'type_modifier': b'o'}}})
    r(b'OSLogStore', b'localStoreAndReturnError:', {'arguments': {2: {'type_modifier': b'o'}}})
    r(b'OSLogStore', b'storeWithScope:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    r(b'OSLogStore', b'storeWithURL:error:', {'arguments': {3: {'type_modifier': b'o'}}})
finally:
