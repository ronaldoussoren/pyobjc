...
if sys.maxsize > 2**32:
    ...
    class TestCNChangeHistoryFetchRequest (TestCase):
        ...
        def test_methods(self):
            ...
            self.assertArgIsBOOL(Contacts.CNChangeHistoryFetchRequest.setShouldUnifyResults_, 0)
            ...
            self.assertArgIsBOOL(Contacts.CNChangeHistoryFetchRequest.setIncludeGroupChanges_, 0)
