...
#
# Last update: Sun Jun 21 12:24:52 2026
#
# flake8: noqa
...
misc.update(
    {
        "kMERAWProcessorProcessorInfoKey": "ProcessorInfo",
        "kMEVideoDecoderCodecInfoKey": "CodecInfo",
        "kMERAWProcessorCodecNameKey": "CodecName",
        "kMEVideoDecoderCodecNameKey": "CodecName",
        "kMERAWProcessorCodecTypeKey": "CodecType",
        ...
        "kMERAWProcessorObjectNameKey": "ObjectName",
        "kMERAWProcessorClassImplementationIDKey": "ClassImplementationID",
        "kMEFormatReaderSidecarFileNameExtensionArrayKey": "MTSidecarFileNameExtensionArray",
...
try:
    ...
    r(b"MEFileInfo", b"duration", {"retval": {"type": b"{CMTime=qiIq}"}})
    r(b"MEFileInfo", b"setDuration:", {"arguments": {2: {"type": b"{CMTime=qiIq}"}}})
    r(
...
objc.registerNewKeywordsFromSelector("MEByteSource", b"init")
objc.registerNewKeywordsFromSelector("MEEstimatedSampleLocation", b"init")
...
objc.registerNewKeywordsFromSelector("MESampleCursorChunk", b"init")
objc.registerNewKeywordsFromSelector(
    "MESampleCursorChunk",
    b"initWithByteSource:chunkStorageRange:chunkInfo:sampleIndexWithinChunk:",
)
objc.registerNewKeywordsFromSelector("MESampleLocation", b"init")
objc.registerNewKeywordsFromSelector(
    "MESampleLocation", b"initWithByteSource:sampleLocation:"
)
objc.registerNewKeywordsFromSelector("METrackInfo", b"init")
objc.registerNewKeywordsFromSelector(
    "METrackInfo", b"initWithMediaType:trackID:formatDescriptions:"
)
expressions = {}
formal_protocols = {
    "MEFormatReader": "MEFormatReader",
    "MEFormatReaderExtension": "MEFormatReaderExtension",
    "MERAWProcessor": "MERAWProcessor",
    "MERAWProcessorExtension": "MERAWProcessorExtension",
    "MESampleCursor": "MESampleCursor",
    "METrackReader": "METrackReader",
    "MEVideoDecoder": "MEVideoDecoder",
    "MEVideoDecoderExtension": "MEVideoDecoderExtension",
}
