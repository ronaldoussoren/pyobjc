...
#
# Last update: Fri May 22 15:00:28 2026
#
# flake8: noqa
        ...
        "",
        {
            "arguments": {
                2: {
                    ...
                    "function": {
                        "args": [{"typestr": "^{__DADisk=}"}, {"typestr": "^v"}],
                        "retval": {"typestr": "^{__DADissenter=}"},
                    },
