...
class TestDADisk(TestCase):
    ...
    def test_constants(self):
        ...
        self.assertIsInstance(
            DiskArbitration.kDADiskDescriptionMediaRemovableKey, unicode
        )
        ...
        self.assertIsInstance(
            DiskArbitration.kDADiskDescriptionDeviceProtocolKey, unicode
        )
        self.assertIsInstance(
    ...
    def test_constants10_14_4(self):
        self.assertIsInstance(
            DiskArbitration.kDADiskDescriptionMediaEncryptedKey, unicode
        )
        self.assertIsInstance(
            DiskArbitration.kDADiskDescriptionMediaEncryptionDetailKey, unicode
        )
        self.assertIsInstance(
            DiskArbitration.kDADiskDescriptionDeviceTDMLockedKey, unicode
        )
