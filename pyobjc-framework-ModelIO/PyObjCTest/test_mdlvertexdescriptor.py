...
if sys.maxsize > 2 ** 32:
    ...
    class TestMDLVertexDescriptor(TestCase):
        def testConstants(self):
            self.assertIsInstance(ModelIO.MDLVertexAttributeAnisotropy, unicode)
            self.assertIsInstance(ModelIO.MDLVertexAttributeBinormal, unicode)
            self.assertIsInstance(ModelIO.MDLVertexAttributeBitangent, unicode)
            self.assertIsInstance(ModelIO.MDLVertexAttributeColor, unicode)
            self.assertIsInstance(ModelIO.MDLVertexAttributeEdgeCrease, unicode)
            self.assertIsInstance(ModelIO.MDLVertexAttributeJointIndices, unicode)
            self.assertIsInstance(ModelIO.MDLVertexAttributeJointWeights, unicode)
            self.assertIsInstance(ModelIO.MDLVertexAttributeNormal, unicode)
            self.assertIsInstance(ModelIO.MDLVertexAttributeOcclusionValue, unicode)
            self.assertIsInstance(ModelIO.MDLVertexAttributePosition, unicode)
            self.assertIsInstance(ModelIO.MDLVertexAttributeShadingBasisU, unicode)
            self.assertIsInstance(ModelIO.MDLVertexAttributeShadingBasisV, unicode)
            self.assertIsInstance(ModelIO.MDLVertexAttributeSubdivisionStencil, unicode)
            self.assertIsInstance(ModelIO.MDLVertexAttributeTangent, unicode)
            self.assertIsInstance(ModelIO.MDLVertexAttributeTextureCoordinate, unicode)
            ...
            self.assertEqual(
                ModelIO.MDLVertexFormatInt, ModelIO.MDLVertexFormatIntBits | 1
            )
            self.assertEqual(
