...
if sys.maxsize > 2**32:
    ...
    class TestMDLAnimatedValue (TestCase):
        ...
        def testMethods(self):
            ...
            self.assertArgSizeInArg(ModelIO.MDLAnimatedScalar.getDoubleArray_maxCount_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedScalar.getDoubleArray_maxCount_, 0)
        ...
        def testMethodsVector(self):
            ...
            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector3Array.setFloat3Array_count_atTime_, 0, 1)
            self.assertArgIsIn(ModelIO.MDLAnimatedVector3Array.setFloat3Array_count_atTime_, 0)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector3Array.setDouble3Array_count_atTime_, 0, 1)
            self.assertArgIsIn(ModelIO.MDLAnimatedVector3Array.setDouble3Array_count_atTime_, 0)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector3Array.getFloat3Array_maxCount_atTime_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedVector3Array.getFloat3Array_maxCount_atTime_, 0)
            self.assertArgIsOut(ModelIO.MDLAnimatedVector3Array.getFloat3Array_maxCount_atTime_, 0)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector3Array.getDouble3Array_maxCount_atTime_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedVector3Array.getDouble3Array_maxCount_atTime_, 0)
            self.assertArgIsOut(ModelIO.MDLAnimatedVector3Array.getDouble3Array_maxCount_atTime_, 0)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector3Array.resetWithFloat3Array_count_atTimes_count_, 0, 1)
            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector3Array.resetWithFloat3Array_count_atTimes_count_, 2, 3)
            self.assertArgIsIn(ModelIO.MDLAnimatedVector3Array.resetWithFloat3Array_count_atTimes_count_, 0)
            self.assertArgIsIn(ModelIO.MDLAnimatedVector3Array.resetWithFloat3Array_count_atTimes_count_, 2)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector3Array.resetWithDouble3Array_count_atTimes_count_, 0, 1)
            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector3Array.resetWithDouble3Array_count_atTimes_count_, 2, 3)
            self.assertArgIsIn(ModelIO.MDLAnimatedVector3Array.resetWithDouble3Array_count_atTimes_count_, 0)
            self.assertArgIsIn(ModelIO.MDLAnimatedVector3Array.resetWithDouble3Array_count_atTimes_count_, 2)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector3Array.getFloat3Array_maxCount_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedVector3Array.getFloat3Array_maxCount_, 0)
            self.assertArgIsOut(ModelIO.MDLAnimatedVector3Array.getFloat3Array_maxCount_, 0)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector3Array.getDouble3Array_maxCount_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedVector3Array.getDouble3Array_maxCount_, 0)
            self.assertArgIsOut(ModelIO.MDLAnimatedVector3Array.getDouble3Array_maxCount_, 0)




            self.assertArgSizeInArg(ModelIO.MDLAnimatedQuaternionArray.setFloatQuaternionArray_count_atTime_, 0, 1)
            self.assertArgIsIn(ModelIO.MDLAnimatedQuaternionArray.setFloatQuaternionArray_count_atTime_, 0)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedQuaternionArray.setDoubleQuaternionArray_count_atTime_, 0, 1)
            self.assertArgIsIn(ModelIO.MDLAnimatedQuaternionArray.setDoubleQuaternionArray_count_atTime_, 0)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedQuaternionArray.getFloatQuaternionArray_maxCount_atTime_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedQuaternionArray.getFloatQuaternionArray_maxCount_atTime_, 0)
            self.assertArgIsOut(ModelIO.MDLAnimatedQuaternionArray.getFloatQuaternionArray_maxCount_atTime_, 0)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedQuaternionArray.getDoubleQuaternionArray_maxCount_atTime_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedQuaternionArray.getDoubleQuaternionArray_maxCount_atTime_, 0)
            self.assertArgIsOut(ModelIO.MDLAnimatedQuaternionArray.getDoubleQuaternionArray_maxCount_atTime_, 0)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedQuaternionArray.resetWithFloatQuaternionArray_count_atTimes_count_, 0, 1)
            self.assertArgSizeInArg(ModelIO.MDLAnimatedQuaternionArray.resetWithFloatQuaternionArray_count_atTimes_count_, 2, 3)
            self.assertArgIsIn(ModelIO.MDLAnimatedQuaternionArray.resetWithFloatQuaternionArray_count_atTimes_count_, 0)
            self.assertArgIsIn(ModelIO.MDLAnimatedQuaternionArray.resetWithFloatQuaternionArray_count_atTimes_count_, 2)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedQuaternionArray.resetWithDoubleQuaternionArray_count_atTimes_count_, 0, 1)
            self.assertArgSizeInArg(ModelIO.MDLAnimatedQuaternionArray.resetWithDoubleQuaternionArray_count_atTimes_count_, 2, 3)
            self.assertArgIsIn(ModelIO.MDLAnimatedQuaternionArray.resetWithDoubleQuaternionArray_count_atTimes_count_, 0)
            self.assertArgIsIn(ModelIO.MDLAnimatedQuaternionArray.resetWithDoubleQuaternionArray_count_atTimes_count_, 2)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedQuaternionArray.getFloatQuaternionArray_maxCount_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedQuaternionArray.getFloatQuaternionArray_maxCount_, 0)
            self.assertArgIsOut(ModelIO.MDLAnimatedQuaternionArray.getFloatQuaternionArray_maxCount_, 0)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedQuaternionArray.getDoubleQuaternionArray_maxCount_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedQuaternionArray.getDoubleQuaternionArray_maxCount_, 0)
            self.assertArgIsOut(ModelIO.MDLAnimatedQuaternionArray.getDoubleQuaternionArray_maxCount_, 0)
            ...
            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector2.getFloat2Array_maxCount_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedVector2.getFloat2Array_maxCount_, 0)
            self.assertArgIsOut(ModelIO.MDLAnimatedVector2.getFloat2Array_maxCount_, 0)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector2.getDouble2Array_maxCount_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedVector2.getDouble2Array_maxCount_, 0)
            ...
            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector3.getFloat3Array_maxCount_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedVector3.getFloat3Array_maxCount_, 0)
            self.assertArgIsOut(ModelIO.MDLAnimatedVector3.getFloat3Array_maxCount_, 0)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector3.getDouble3Array_maxCount_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedVector3.getDouble3Array_maxCount_, 0)
            ...
            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector4.getFloat4Array_maxCount_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedVector4.getFloat4Array_maxCount_, 0)
            self.assertArgIsOut(ModelIO.MDLAnimatedVector4.getFloat4Array_maxCount_, 0)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector4.getDouble4Array_maxCount_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedVector4.getDouble4Array_maxCount_, 0)
            ...
            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector4x4.getFloat4x4Array_maxCount_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedVector4x4.getFloat4x4Array_maxCount_, 0)
            self.assertArgIsOut(ModelIO.MDLAnimatedVector4x4.getFloat4x4Array_maxCount_, 0)

            self.assertArgSizeInArg(ModelIO.MDLAnimatedVector4x4.getDouble4x4Array_maxCount_, 0, 1)
            self.assertArgSizeInResult(ModelIO.MDLAnimatedVector4x4.getDouble4x4Array_maxCount_, 0)
