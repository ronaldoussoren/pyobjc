...
#
# Last update: Sun Aug  7 14:51:57 2022
#
# flake8: noqa
...
try:
    ...
    r(
        ...
        b"double4x4AtTime:",
        {
            ...
            "retval": {"type": b"{_matrix_double4x4=[4<4d>]}"},
        },
    )
    r(
        b"MDLAnimatedMatrix4x4",
    ...
    r(
        ...
        {
            "full_signature": b"Q@:^{_matrix_double4x4=[4<4d>]}Q",
            "arguments": {
                2: {
                    "c_array_lengt_in_result": True,
                    "type": b"^{_matrix_double4x4=[4<4d>]}",
                    "type_modifier": b"o",
                    "c_array_length_in_arg": 3,
                }
            },
    ...
    r(
        ...
        {
            "full_signature": b"Q@:^{_matrix_float4x4=[4<4f>]}Q",
            "arguments": {
                2: {
                    "c_array_lengt_in_result": True,
                    "type": b"^{_matrix_float4x4=[4<4f>]}",
                    "type_modifier": b"o",
                    "c_array_length_in_arg": 3,
                }
            },
    ...
    r(
        ...
        {
            "full_signature": b"v@:^{_matrix_double4x4=[4<4d>]}^dQ",
            "arguments": {2: {"type": b"^{_matrix_double4x4=[4<4d>]}"}},
        },
    )
    r(
        b"MDLAnimatedMatrix4x4",
    ...
    r(
        ...
        {
            "full_signature": b"v@:^{_matrix_float4x4=[4<4f>]}^dQ",
    ...
    r(
        ...
        {
            "full_signature": b"{_simd_quatd=<4d>}@:d",
            "retval": {"type": b"{_simd_quatd=<4d>}"},
        },
    )
    r(
        b"MDLAnimatedQuaternion",
        ...
        {
            "full_signature": b"{_simd_quatf=<4f>}@:d",
    ...
    r(
        ...
        {
            "full_signature": b"Q@:^{_simd_quatd=<4d>}Q",
            "arguments": {2: {"type": b"^{_simd_quatd=<4d>}"}},
        },
    )
    r(
        b"MDLAnimatedQuaternion",
        ...
        {
            "full_signature": b"Q@:^{_simd_quatf=<4f>}Q",
    ...
    r(
        ...
        {
            "full_signature": b"v@:^{_simd_quatd=<4d>}^dQ",
            "arguments": {2: {"type": b"^{_simd_quatd=<4d>}"}},
        },
    )
    r(
        ...
        {
            "full_signature": b"v@:^{_simd_quatf=<4f>}^dQ",
            "arguments": {2: {"type": b"^{_simd_quatf=<4f>}"}},
        },
    )
    r(
    ...
    r(
        ...
        {
            "full_signature": b"Q@:^{_simd_quatd=<4d>}Qd",
            "arguments": {
                2: {
                    "c_array_length_in_arg": 3,
                    "type": b"^{_simd_quatd=<4d>}",
    ...
    r(
        ...
        {
            "full_signature": b"Q@:^{_simd_quatf=<4f>}Qd",
            "arguments": {
                2: {
                    "c_array_length_in_arg": 3,
                    "type": b"^{_simd_quatf=<4f>}",
    ...
    r(
        ...
        {
            "full_signature": b"v@:^{_simd_quatd=<4d>}Q^dQ",
            "arguments": {
                2: {
                    "type": b"^{_simd_quatd=<4d>}",
                    "type_modifier": b"n",
    ...
    r(
        ...
        {
            "full_signature": b"v@:^{_simd_quatf=<4f>}Q^dQ",
            "arguments": {
                2: {
                    "type": b"^{_simd_quatf=<4f>}",
                    "type_modifier": b"n",
    ...
    r(
        ...
        {
            "full_signature": b"v@:^{_simd_quatd=<4d>}Qd",
            "arguments": {
                2: {
                    "type": b"^{_simd_quatd=<4d>}",
                    "type_modifier": b"n",
    ...
    r(
        ...
        {
            "full_signature": b"v@:^{_simd_quatf=<4f>}Qd",
            "arguments": {
                2: {
                    "type": b"^{_simd_quatf=<4f>}",
                    "type_modifier": b"n",
    ...
    r(
        ...
        {"full_signature": b"v@:^<2d>^dQ", "arguments": {2: {"type": b"^<2d>"}}},
    )
    r(
        b"MDLAnimatedVector2",
    ...
    r(
        ...
        {"full_signature": b"v@:^<2f>^dQ", "arguments": {2: {"type": b"^<2f>"}}},
    )
    r(
        b"MDLAnimatedVector2",
    ...
    r(
        ...
        {"full_signature": b"v@:^<3d>^dQ", "arguments": {2: {"type": b"^<3d>"}}},
    )
    r(
        b"MDLAnimatedVector3",
    ...
    r(
        ...
        {"full_signature": b"v@:^<3f>^dQ", "arguments": {2: {"type": b"^<3f>"}}},
    )
    r(
        b"MDLAnimatedVector3",
    ...
    r(
        ...
        {"full_signature": b"v@:^<4d>^dQ", "arguments": {2: {"type": b"^<4d>"}}},
    )
    r(
        b"MDLAnimatedVector4",
    ...
    r(
        ...
        {"full_signature": b"v@:^<4f>^dQ", "arguments": {2: {"type": b"^<4f>"}}},
    )
    r(
        b"MDLAnimatedVector4",
    ...
    r(
        ...
        b"boundingBox",
        {
            ...
            "retval": {"type": b"{_MDLAxisAlignedBoundingBox=<3f><3f>}"},
        },
    )
    r(
        b"MDLAsset",
    ...
    r(
        ...
        b"frameBoundingBox:setNearAndFar:",
        {
            ...
            "arguments": {
                2: {"type": b"{_MDLAxisAlignedBoundingBox=<3f><3f>}"},
                3: {"type": "Z"},
            },
        },
    )
    ...
    r(
        ...
        b"initWithName:semantic:matrix4x4:",
        {
            ...
            "arguments": {4: {"type": b"{_matrix_float4x4=[4<4f>]}"}},
        },
    )
    r(
        b"MDLMaterialProperty",
    ...
    r(
        ...
        {
            "full_signature": b"v@:^{_matrix_double4x4=[4<4d>]}Q",
            "arguments": {
                2: {
                    "type": b"^{_matrix_double4x4=[4<4d>]}",
                    "type_modifier": b"n",
    ...
    r(
        ...
        {
            "full_signature": b"v@:^{_matrix_float4x4=[4<4f>]}Q",
            "arguments": {
                2: {
                    "type": b"^{_matrix_float4x4=[4<4f>]}",
                    "type_modifier": b"n",
    ...
    r(
        ...
        b"initWithMatrix:resetsTransform:",
        {
            ...
            "arguments": {2: {"type": b"{_matrix_float4x4=[4<4f>]}"}, 3: {"type": "Z"}},
        },
    )
    r(
        b"MDLTransform",
    ...
    r(
        ...
        b"initWithData:boundingBox:voxelExtent:",
        {
            ...
            "arguments": {3: {"type": b"{_MDLAxisAlignedBoundingBox=<3f><3f>}"}},
        },
    )
    ...
    r(
        ...
        b"voxelIndexExtent",
        {
            ...
            "retval": {"type": b"{_MDLVoxelIndexExtent=<4i><4i>}"},
        },
    )
    r(
        b"MDLVoxelArray",
        ...
        {
            "full_signature": b"@@:{_MDLVoxelIndexExtent=<4i><4i>}",
            "arguments": {2: {"type": b"{_MDLVoxelIndexExtent=<4i><4i>}"}},
        },
    )
    ...
    r(
        ...
        b"setBoundingBox:",
        {
            ...
            "required": True,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"{_MDLAxisAlignedBoundingBox=<3f><3f>}"}},
        },
    )
    r(
        b"NSObject",
    ...
    r(
        ...
        b"setLocalTransform:forTime:",
        {
            ...
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"{_matrix_float4x4=[4<4f>]}"}, 3: {"type": "d"}},
        },
    )
    r(
        b"NSObject",
