...
try:
    ...
    r(b'MDLAnimatedScalar', b'copyDoubleArrayInto:maxCount:', {'arguments': {2: {'c_array_length_in_result': True, 'type_modifier': b'o', 'c_array_length_in_arg': 3}}})
    r(b'MDLAnimatedScalar', b'copyFloatArrayInto:maxCount:', {'arguments': {2: {'c_array_length_in_result': True, 'type_modifier': b'o', 'c_array_length_in_arg': 3}}})
    ...
    r(b'MDLAnimatedValue', b'copyTimesInto:maxCount:', {'arguments': {2: {'c_array_lengt_in_result': True, 'type_modifier': b'o', 'c_array_length_in_arg': 3}}})
    ...
    r(b'MDLAsset', b'initWithURL:bufferAllocator:preserveIndexing:error:', {'arguments': {5: {'type_modifier': b'o'}}})
    ...
    r(b'MDLMesh', b'makeVerticesUniqueAndReturnError:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type_modifier': b'o'}}})
    ...
    r(b'MDLMorphDeformer', b'copyShapeSetTargetWeightsInto:maxCount:', {'arguments': {3: {'c_array_lenght_in_result': True, 'type_modifier': b'n', 'c_array_length_in_arg': 4}}})
