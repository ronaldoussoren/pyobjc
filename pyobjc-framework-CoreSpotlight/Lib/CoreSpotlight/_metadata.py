...
#
# Last update: Sat Jun 25 21:32:40 2022
#
# flake8: noqa
...
try:
    ...
    r(
        b"CSSearchableIndex",
        b"provideDataForBundle:identifier:type:completionHandler:",
        {
            "arguments": {
                5: {
                    "callable": {
