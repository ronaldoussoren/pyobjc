...
class TestCSUserQuery(TestCase):
    ...
    def testMethods13_0(self):
        ...
        self.assertArgIsBOOL(CoreSpotlight.CSUserQueryContext.setEnableRankedResults_, 0)

        self.assertResultIsBlock(CoreSpotlight.CSUserQuery.foundSuggestionsHandler, b"v@")
