...
#
# Last update: Tue Feb 21 23:10:12 2012
...
try:
    r('NSObject', b'exceptionHandler:shouldHandleException:mask:', {'retval': {'type': 'Z'}})
    r('NSObject', b'exceptionHandler:shouldLogException:mask:', {'retval': {'type': 'Z'}})
finally:
    objc._updatingMetadata(False)
protocols={'NSExceptionHandlerDelegate': objc.informal_protocol('NSExceptionHandlerDelegate', [objc.selector(None, 'exceptionHandler:shouldLogException:mask:', sel32or64(b'Z@:@@I', b'Z@:@@L'), isRequired=False), objc.selector(None, 'exceptionHandler:shouldHandleException:mask:', sel32or64(b'Z@:@@I', b'Z@:@@L'), isRequired=False)])}
