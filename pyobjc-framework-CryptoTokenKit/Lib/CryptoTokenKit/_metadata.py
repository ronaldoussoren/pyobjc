...
#
# Last update: Tue Jun 30 22:46:37 2026
#
# flake8: noqa
...
objc.registerNewKeywordsFromSelector("TKSmartCardSlotNFCSession", b"init")
...
objc.registerNewKeywordsFromSelector("TKSmartCardTokenRegistrationManager", b"init")
objc.registerNewKeywordsFromSelector("TKTLVRecord", b"init")
objc.registerNewKeywordsFromSelector("TKToken", b"init")
objc.registerNewKeywordsFromSelector("TKToken", b"initWithTokenDriver:instanceID:")
objc.registerNewKeywordsFromSelector("TKTokenConfiguration", b"init")
objc.registerNewKeywordsFromSelector("TKTokenDriverConfiguration", b"init")
objc.registerNewKeywordsFromSelector("TKTokenKeyAlgorithm", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("TKTokenKeychainContents", b"init")
objc.registerNewKeywordsFromSelector("TKTokenKeychainItem", b"init")
...
objc.registerNewKeywordsFromSelector("TKTokenSession", b"init")
objc.registerNewKeywordsFromSelector("TKTokenSession", b"initWithToken:")
objc.registerNewKeywordsFromSelector("TKTokenWatcher", b"init")
objc.registerNewKeywordsFromSelector("TKTokenWatcher", b"initWithInsertionHandler:")
objc.registerNewKeywordsFromSelector("TKTokenWatcherTokenInfo", b"init")
expressions = {}
formal_protocols = {
    "TKSmartCardTokenDriverDelegate": "TKSmartCardTokenDriverDelegate",
    "TKSmartCardUserInteractionDelegate": "TKSmartCardUserInteractionDelegate",
    "TKTokenDelegate": "TKTokenDelegate",
    "TKTokenDriverDelegate": "TKTokenDriverDelegate",
    "TKTokenSessionDelegate": "TKTokenSessionDelegate",
}
