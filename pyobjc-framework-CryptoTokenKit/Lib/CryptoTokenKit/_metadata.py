...
#
# Last update: Mon Jun 10 22:28:34 2019
...
try:
    ...
    r(b'NSObject', b'tokenDriver:tokenForConfiguration:error:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'^@'}}})
