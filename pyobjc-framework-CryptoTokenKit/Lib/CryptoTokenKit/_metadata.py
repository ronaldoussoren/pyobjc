...
#
# Last update: Sat Aug  3 22:06:04 2019
...
misc.update({})
aliases = {'TKSmartCardNoSlot': 'TKSmartCardSlotStateMissing', 'TKSmartCardSlotMuteCard': 'TKSmartCardSlotStateMuteCard', 'TKSmartCardSlotProbing': 'TKSmartCardSlotStateProbing', 'TKErrorTokenNotFound': 'TKErrorCodeTokenNotFound', 'TKSmartCardSlotValidCard': 'TKSmartCardSlotStateValidCard', 'TKErrorObjectNotFound': 'TKErrorCodeObjectNotFound', 'TKSmartCardSlotEmpty': 'TKSmartCardSlotStateEmpty', 'TKErrorAuthenticationFailed': 'TKErrorCodeAuthenticationFailed'}
r = objc.registerMetaDataForSelector
objc._updatingMetadata(True)
try:
    r(b'NSObject', b'characterEnteredInUserInteraction:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'correctionKeyPressedInUserInteraction:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'invalidCharacterEnteredInUserInteraction:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'newPINConfirmationRequestedInUserInteraction:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'newPINRequestedInUserInteraction:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'oldPINRequestedInUserInteraction:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'token:createSessionWithError:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'o^@'}}})
    r(b'NSObject', b'token:terminateSession:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'tokenDriver:createTokenForSmartCard:AID:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': 'o^@'}}})
    r(b'NSObject', b'tokenDriver:terminateToken:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'tokenDriver:tokenForConfiguration:error:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': 'o^@'}}})
    r(b'NSObject', b'tokenSession:beginAuthForOperation:constraint:error:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'q'}, 4: {'type': b'@'}, 5: {'type': 'o^@'}}})
    r(b'NSObject', b'tokenSession:decryptData:usingKey:algorithm:error:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}, 6: {'type': 'o^@'}}})
    r(b'NSObject', b'tokenSession:performKeyExchangeWithPublicKey:usingKey:algorithm:parameters:error:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}, 6: {'type': b'@'}, 7: {'type': 'o^@'}}})
    r(b'NSObject', b'tokenSession:signData:usingKey:algorithm:error:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}, 6: {'type': 'o^@'}}})
    r(b'NSObject', b'tokenSession:supportsOperation:usingKey:algorithm:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'q'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'validationKeyPressedInUserInteraction:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'TKTokenConfiguration', b'certificateForObjectID:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    r(b'TKTokenConfiguration', b'keyForObjectID:error:', {'arguments': {3: {'type_modifier': b'o'}}})
