...
if sys.maxsize > 2 ** 32:
    ...
    class TestFinderSync (TestCase):
        ...
        def testMethods(self):
            ...
            self.assertArgIsBlock(CryptoTokenKit.TKSmartCard.beginSessionWithReply_, 0, b"v" + objc._C_BOOL + b"@")
            ...
            self.assertArgIsBlock(CryptoTokenKit.TKSmartCard.sendIns_p1_p2_data_le_reply_, 5, b"v@H@")
