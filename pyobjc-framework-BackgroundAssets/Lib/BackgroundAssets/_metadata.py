...
try:
    r(
        ...
        b"URLForPath:asLocalizedForLanguage:error:",
    ...
    r(
        b"BAAssetPackManager",
        b"contentsAtPath:asLocalizedForLanguage:options:error:",
    ...
    r(
        b"BAAssetPackManager",
        b"ensureLocalAvailabilityOfAssetPacks:completionHandler:",
        {
            "arguments": {
                3: {
                    "callable": {
    ...
    r(
        b"BAAssetPackManager",
        b"ensureLocalAvailabilityOfAssetPacks:requireLatestVersions:completionHandler:",
        {
            "arguments": {
                3: {"type": b"Z"},
                4: {
    ...
    r(
        b"BAAssetPackManager",
        b"fileDescriptorForPath:asLocalizedForLanguage:error:",
        {"arguments": {4: {"type_modifier": b"o"}}},
    )
    r(
        b"BAAssetPackManager",
    ...
    r(
        b"BAAssetPackManager",
        b"getLocallyAvailableLanguagesWithCompletionHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
    ...
    r(
        b"BAAssetPackManager",
        b"getManifestWithCompletionHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
    ...
    r(
        b"BAAssetPackManager",
        b"reconcilePreferredLanguagesWithCompletionHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
...
formal_protocols = {
    ...
    "BADownloaderExtension": "BADownloaderExtension",
    "BAManagedAssetPackDownloadDelegate": "BAManagedAssetPackDownloadDelegate",
    "BAManagedDownloaderExtension": "BAManagedDownloaderExtension",
}
