...
#
# Last update: Tue Jun 30 22:41:41 2026
#
# flake8: noqa
...
misc.update(
    {
        "IMVideoOptimizationOptions": NewType("IMVideoOptimizationOptions", int),
        "IMAVManagerState": NewType("IMAVManagerState", int),
        "IMPersonStatus": NewType("IMPersonStatus", int),
        "IMServiceStatus": NewType("IMServiceStatus", int),
    }
)
misc.update({})
