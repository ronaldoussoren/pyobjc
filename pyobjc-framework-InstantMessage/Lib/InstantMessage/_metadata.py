...
#
# Last update: Sun Mar 22 15:12:13 2020
#
# flake8: noqa
    ...
    "IMVideoDataSource": objc.informal_protocol(
        ...
        [
            objc.selector(
                ...
                b"renderIntoPixelBuffer:forTime:",
                sel32or64(
                    b"Z@:^{__CVBuffer=}^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssLLLssss}QQ}",
            ...
            objc.selector(
                ...
                b"renderIntoOpenGLBuffer:onScreen:forTime:",
                sel32or64(
                    b"Z@:^{__CVBuffer=}^i^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssLLLssss}QQ}",
