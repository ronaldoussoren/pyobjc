...
#
# Last update: Fri May 18 15:07:14 2012
...
try:
    ...
    r('NSObject', b'getPixelBufferPixelFormat:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': sel32or64(b'^I', b'^Q'), 'type_modifier': b'o'}}})
    ...
    objc._updatingMetadata(False)
protocols={'IMVideoDataSource': objc.informal_protocol('IMVideoDataSource', [objc.selector(None, 'renderIntoPixelBuffer:forTime:', sel32or64(b'Z@:^{__CVBuffer=}^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssLLLssss}QQ}', b'Z@:^{__CVBuffer=}^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssIIIssss}QQ}'), isRequired=False), objc.selector(None, 'getPixelBufferPixelFormat:', sel32or64(b'v@:^I', b'v@:^Q'), isRequired=False), objc.selector(None, 'getOpenGLBufferContext:pixelFormat:', b'v@:^^{_CGLContextObject=}^^{_CGLPixelFormatObject=}', isRequired=False), objc.selector(None, 'renderIntoOpenGLBuffer:onScreen:forTime:', sel32or64(b'Z@:^{__CVBuffer=}^i^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssLLLssss}QQ}', b'Z@:^{__CVBuffer=}^i^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssIIIssss}QQ}'), isRequired=False)])}
expressions = {}
