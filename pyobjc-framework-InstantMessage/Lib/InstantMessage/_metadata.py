...
#
# Last update: Tue Feb 14 22:29:36 2012
...
try:
    ...
    r('NSObject', b'renderIntoOpenGLBuffer:onScreen:forTime:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': '^{__CVBuffer=}'}, 3: {'type_modifier': b'n'}, 4: {'type': b'^{_CVTimeStamp=IiqQdq{CVSMPTETime=}QQ}', 'type_modifier': b'n'}}})
    r('NSObject', b'renderIntoPixelBuffer:forTime:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': '^{__CVBuffer=}'}, 3: {'type': b'^{_CVTimeStamp=IiqQdq{CVSMPTETime=}QQ}', 'type_modifier': b'n'}}})
finally:
