...
#
# Last update: Tue May 29 07:42:53 2012
...
try:
    ...
    objc._updatingMetadata(False)
protocols={'IMVideoDataSource': objc.informal_protocol('IMVideoDataSource', [objc.selector(None, b'renderIntoPixelBuffer:forTime:', sel32or64(b'Z@:^{__CVBuffer=}^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssLLLssss}QQ}', b'Z@:^{__CVBuffer=}^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssIIIssss}QQ}'), isRequired=False), objc.selector(None, b'getPixelBufferPixelFormat:', sel32or64(b'v@:^I', b'v@:^Q'), isRequired=False), objc.selector(None, b'getOpenGLBufferContext:pixelFormat:', b'v@:^^{_CGLContextObject=}^^{_CGLPixelFormatObject=}', isRequired=False), objc.selector(None, b'renderIntoOpenGLBuffer:onScreen:forTime:', sel32or64(b'Z@:^{__CVBuffer=}^i^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssLLLssss}QQ}', b'Z@:^{__CVBuffer=}^i^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssIIIssss}QQ}'), isRequired=False)])}
expressions = {}
