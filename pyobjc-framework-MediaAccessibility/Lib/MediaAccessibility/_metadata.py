...
#
# Last update: Sun Mar 22 14:59:55 2020
#
# flake8: noqa
...
functions = {
    "MACaptionAppearanceCopyFontDescriptorForStyle": (
        sel32or64(b"^{__CTFontDescriptor=}l^ll", b"^{__CTFontDescriptor=}q^qq"),
        "",
        {
    ...
    "MACaptionAppearanceCopyForegroundColor": (
        sel32or64(b"^{CGColor=}l^l", b"^{CGColor=}q^q"),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {1: {"null_accepted": True, "type_modifier": "o"}},
    ...
    "MACaptionAppearanceCopySelectedLanguages": (
        sel32or64(b"^{__CFArray=}l", b"^{__CFArray=}q"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "MACaptionAppearanceGetDisplayType": (sel32or64(b"ll", b"qq"),),
    "MACaptionAppearanceGetWindowRoundedCornerRadius": (
        sel32or64(b"fl^l", b"dq^q"),
        "",
        {"arguments": {1: {"null_accepted": True, "type_modifier": "o"}}},
    ),
    "MACaptionAppearanceSetDisplayType": (sel32or64(b"vll", b"vqq"),),
    ...
    "MACaptionAppearanceGetTextEdgeStyle": (
        sel32or64(b"ll^l", b"qq^q"),
        "",
        {"arguments": {1: {"null_accepted": True, "type_modifier": "o"}}},
    ),
    "MACaptionAppearanceAddSelectedLanguage": (
        sel32or64(b"Bl^{__CFString=}", b"Bq^{__CFString=}"),
        "",
        {"arguments": {1: {"null_accepted": True, "type_modifier": "o"}}},
    ),
