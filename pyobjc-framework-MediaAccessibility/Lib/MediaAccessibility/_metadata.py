...
#
# Last update: Sun Aug 10 21:16:15 2014
...
constants = '''$MAMediaCharacteristicDescribesMusicAndSoundForAccessibility@^{__CFString=}$MAMediaCharacteristicTranscribesSpokenDialogForAccessibility@^{__CFString=}$kMACaptionAppearanceSettingsChangedNotification@^{__CFString=}$'''
