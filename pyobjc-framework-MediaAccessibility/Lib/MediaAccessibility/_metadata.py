...
functions = {
    ...
    "MACaptionAppearanceSetActiveProfileID": (b"v^{__CFString=}",),
    ...
    "MACaptionAppearanceExecuteBlockForProfileID": (
        b"v^{__CFString=}@?",
        "",
        {
            "arguments": {
    ...
    "MACaptionAppearanceCopyProfileName": (
...
objc.registerNewKeywordsFromSelector("MAMusicHapticsManager", b"init")
expressions = {}
