...
try:
    r(b'CHHapticEngine', b'createAdvancedPlayerWithPattern:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    r(b'CHHapticEngine', b'createPlayerWithPattern:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    r(b'CHHapticEngine', b'initAndReturnError:', {'arguments': {2: {'type_modifier': b'o'}}})
    r(b'CHHapticEngine', b'initWithAudioSession:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    ...
    r(b'CHHapticEngine', b'notifyWhenPlayersFinished:', {'arguments': {2: {'callable': {'retval': {'type': b'q'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'CHHapticEngine', b'playPatternFromData:error:', {'retval': {'type': b'Z'}, 'arguments': {3: {'type_modifier': b'o'}}})
    r(b'CHHapticEngine', b'playPatternFromURL:error:', {'retval': {'type': b'Z'}, 'arguments': {3: {'type_modifier': b'o'}}})
    r(b'CHHapticEngine', b'playsHapticsOnly', {'retval': {'type': b'Z'}})
    r(b'CHHapticEngine', b'registerAudioResource:options:error:', {'arguments': {4: {'type_modifier': b'o'}}})
    r(b'CHHapticEngine', b'resetHandler', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}})
    ...
    r(b'CHHapticEngine', b'setResetHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'CHHapticEngine', b'setStoppedHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'q'}}}}}})
    r(b'CHHapticEngine', b'startAndReturnError:', {'retval': {'type': b'Z'}, 'arguments': {2: {'type_modifier': b'o'}}})
    r(b'CHHapticEngine', b'startWithCompletionHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'CHHapticEngine', b'stopWithCompletionHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'CHHapticEngine', b'stoppedHandler', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'q'}}}}})
    r(b'CHHapticEngine', b'unregisterAudioResource:error:', {'retval': {'type': b'Z'}, 'arguments': {3: {'type_modifier': b'o'}}})
    r(b'CHHapticPattern', b'exportDictionaryAndReturnError:', {'arguments': {2: {'type_modifier': b'o'}}})
    r(b'CHHapticPattern', b'initWithDictionary:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    r(b'CHHapticPattern', b'initWithEvents:parameterCurves:error:', {'arguments': {4: {'type_modifier': b'o'}}})
    r(b'CHHapticPattern', b'initWithEvents:parameters:error:', {'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSObject', b'attributesForDynamicParameter:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'attributesForEventParameter:eventType:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'cancelAndReturnError:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'completionHandler', {'required': True, 'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}, 'type': b'@?'}})
    ...
    r(b'NSObject', b'pauseAtTime:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'd'}, 3: {'type': b'^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'playbackRate', {'required': True, 'retval': {'type': b'f'}})
    r(b'NSObject', b'resumeAtTime:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'd'}, 3: {'type': b'^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'scheduleParameterCurve:atTime:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'd'}, 4: {'type': b'^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'seekToOffset:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'd'}, 3: {'type': b'^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'sendParameters:atTime:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'd'}, 4: {'type': b'^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'setCompletionHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}, 'type': b'@?'}}})
    r(b'NSObject', b'setIsMuted:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'Z'}}})
    r(b'NSObject', b'setLoopEnabled:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'Z'}}})
    r(b'NSObject', b'setLoopEnd:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'd'}}})
    r(b'NSObject', b'setPlaybackRate:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'f'}}})
    r(b'NSObject', b'startAtTime:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'd'}, 3: {'type': b'^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'stopAtTime:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'd'}, 3: {'type': b'^@', 'type_modifier': b'o'}}})
