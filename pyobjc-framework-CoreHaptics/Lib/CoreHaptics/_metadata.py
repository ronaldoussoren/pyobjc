...
#
# Last update: Sat Jul 27 09:44:07 2019
...
try:
    ...
    r(b'CHHapticEngine', b'playPatternFromData:error:', {'retval': {'type': b'Z'}})
    r(b'CHHapticEngine', b'playPatternFromURL:error:', {'retval': {'type': b'Z'}})
    ...
    r(b'CHHapticEngine', b'startAndReturnError:', {'retval': {'type': b'Z'}})
    r(b'CHHapticEngine', b'unregisterAudioResource:error:', {'retval': {'type': b'Z'}})
    r(b'NSObject', b'attributesForDynamicParameter:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@'}}})
    r(b'NSObject', b'attributesForEventParameter:eventType:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'^@'}}})
    r(b'NSObject', b'cancelAndReturnError:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'^@'}}})
    ...
    r(b'NSObject', b'pauseAtTime:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'd'}, 3: {'type': b'^@'}}})
    r(b'NSObject', b'playbackRate', {'required': True, 'retval': {'type': b'f'}})
    r(b'NSObject', b'resumeAtTime:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'd'}, 3: {'type': b'^@'}}})
    r(b'NSObject', b'scheduleParameterCurve:atTime:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'd'}, 4: {'type': b'^@'}}})
    r(b'NSObject', b'seekToOffset:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'd'}, 3: {'type': b'^@'}}})
    r(b'NSObject', b'sendParameters:atTime:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'd'}, 4: {'type': b'^@'}}})
    r(b'NSObject', b'setCompletionHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@?'}}})
    ...
    r(b'NSObject', b'startAtTime:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'd'}, 3: {'type': b'^@'}}})
    r(b'NSObject', b'stopAtTime:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'd'}, 3: {'type': b'^@'}}})
