...
class TestCHHapticPatternPlayerHelper (CoreHaptics.NSObject):
    def startAtTime_error_(self, a, b): return 1
    def stopAtTime_error_(self, a, b): return 1
    def sendParameters_atTime_error_(self, a, b, c): return 1
    def scheduleParameterCurve_atTime_error_(self, a, b, c): return 1
    def cancelAndReturnError_(self, a): return 1
    def isMuted(self): return 1
    def setIsMuted_(self, a): return 1

    def pauseAtTime_error_(self, a, b): return 1
    def resumeAtTime_error_(self, a, b): return 1
    def seekToOffset_error_(self, a, b): return 1
    def loopEnabled(self): return 1
    def setLoopEnabled_(self, a): pass
    def loopEnd(self): return 1
    def setLoopEnd_(self, a): pass
    def playbackRate(self): return 1
    def setPlaybackRate_(self, a): pass
    #def isMuted(self): return 1
    #def setIsMuted_(self, a): pass
    def completionHandler(self): return 1
    def setCompletionHandler_(self, a): pass
...
class TestCHHapticPatternPlayer (TestCase):
    ...
    def test_methods(self):
        ...
        self.assertResultIsBOOL(TestCHHapticPatternPlayerHelper.sendParameters_atTime_error_)
        self.assertArgIsOut(TestCHHapticPatternPlayerHelper.sendParameters_atTime_error_, 2)

        self.assertResultIsBOOL(TestCHHapticPatternPlayerHelper.scheduleParameterCurve_atTime_error_)
        self.assertArgIsOut(TestCHHapticPatternPlayerHelper.scheduleParameterCurve_atTime_error_, 2)
        ...
        self.assertArgHasType(TestCHHapticPatternPlayerHelper.pauseAtTime_error_, 0, objc._C_DBL)
        ...
        self.assertArgHasType(TestCHHapticPatternPlayerHelper.resumeAtTime_error_, 0, objc._C_DBL)
        ...
        self.assertArgHasType(TestCHHapticPatternPlayerHelper.seekToOffset_error_, 0, objc._C_DBL)
