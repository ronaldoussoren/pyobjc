...
class TestCHHapticDeviceCapabilityHelper (CoreHaptics.NSObject):
    def minValue(self): return 1
    def maxValue(self): return 1
    def defaultValue(self): return 1
...
class TestCHHapticDeviceCapability (TestCase):
    ...
    def test_protocols(self):
        objc.protocolNamed('CHHapticParameterAttributes')
        objc.protocolNamed('CHHapticDeviceCapability')
    ...
    def test_methods(self):
        ...
        self.assertResultHasType(TestCHHapticDeviceCapabilityHelper.defaultValue, objc._C_FLT)
        ...
        self.assertArgHasType(TestCHHapticDeviceCapabilityHelper.attributesForEventParameter_eventType_error_, 2, b'o^@')
        self.assertArgHasType(TestCHHapticDeviceCapabilityHelper.attributesForDynamicParameter_error_, 1, b'o^@')
