...
if sys.maxsize > 2 ** 32:
    ...
    class TestNLEmbedding (TestCase):
        ...
        def test_methods(self):
            ...
            self.assertArgIsBlock(NaturalLanguage.NLEmbedding.enumerateNeighborsForString_maximumCount_distanceType_usingBlock_, 3, b'v@do^Z')
            self.assertArgIsBlock(NaturalLanguage.NLEmbedding.enumerateNeighborsForString_maximumCount_maximumDistance_distanceType_usingBlock_, 4, b'v@do^Z')
            ...
            self.assertResultIsBOOL(NaturalLanguage.NLEmbedding.writeEmbeddingForDictionary_language_revision_toURL_error_)
            self.assertArgIsOut(NaturalLanguage.NLEmbedding.writeEmbeddingForDictionary_language_revision_toURL_error_, 4)
