...
#
# Last update: Wed Jun  6 12:54:25 2018
...
try:
    ...
    r(b'NSTagger', b'enumerateTagsInRange:unit:scheme:options:usingBlock:', {'arguments': {6: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'Q'}, 2: {'type': b'{_NSRange=QQ}'}, 3: {'type': b'o^Z'}}}}}})
    r(b'NSTokenizer', b'enumerateTokensInRange:usingBlock:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'{_NSRange=QQ}'}, 2: {'type': b'Q'}, 3: {'type': b'o^Z'}}}}}})
finally:
