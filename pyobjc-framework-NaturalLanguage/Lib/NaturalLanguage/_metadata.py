...
#
# Last update: Fri Jun 28 16:38:17 2019
...
try:
    ...
    r(b'NLEmbedding', b'getVector:forString:', {'retval': {'type': b'Z'}})
    r(b'NLEmbedding', b'writeEmbeddingForDictionary:language:revision:toURL:error:', {'retval': {'type': b'Z'}})
    r(b'NLGazetteer', b'writeGazetteerForDictionary:language:toURL:error:', {'retval': {'type': b'Z'}})
