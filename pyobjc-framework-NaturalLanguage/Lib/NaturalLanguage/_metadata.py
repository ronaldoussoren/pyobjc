...
#
# Last update: Thu May 28 22:18:05 2026
#
# flake8: noqa
...
objc.registerNewKeywordsFromSelector("NLContextualEmbedding", b"init")
objc.registerNewKeywordsFromSelector("NLContextualEmbeddingResult", b"init")
...
objc.registerNewKeywordsFromSelector("NLLanguageRecognizer", b"init")
...
objc.registerNewKeywords(
    ...
    ("modelIdentifier",),
    "contextualEmbeddingWithModelIdentifier_",
)
objc.registerNewKeywords(
    "NLEmbedding", ("contentsOfURL", "error"), "embeddingWithContentsOfURL_error_"
)
objc.registerNewKeywords(
    "NLModel", ("contentsOfURL", "error"), "modelWithContentsOfURL_error_"
)
objc.registerNewKeywords("NLModel", ("MLModel", "error"), "modelWithMLModel_error_")
expressions = {}
