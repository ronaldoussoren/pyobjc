...
objc.registerNewKeywordsFromSelector("OSSystemExtensionManager", b"init")
expressions = {}
formal_protocols = {
    "OSSystemExtensionRequestDelegate": "OSSystemExtensionRequestDelegate",
    "OSSystemExtensionsWorkspaceObserver": "OSSystemExtensionsWorkspaceObserver",
}
