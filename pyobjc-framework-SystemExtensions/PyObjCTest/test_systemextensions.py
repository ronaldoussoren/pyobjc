...
class TestSystemExtensions (TestCase):
    ...
    def test_constants10_15(self):
        ...
        self.assertIsInstance(SystemExtensions.NSSystemExtensionUsageDescriptionKey, unicode)
        ...
        self.assertEqual(SystemExtensions.OSSystemExtensionErrorUnsupportedParentBundleLocation, 3)
        self.assertEqual(SystemExtensions.OSSystemExtensionErrorExtensionNotFound, 4)
        self.assertEqual(SystemExtensions.OSSystemExtensionErrorExtensionMissingIdentifier, 5)
        self.assertEqual(SystemExtensions.OSSystemExtensionErrorDuplicateExtensionIdentifer, 6)
        self.assertEqual(SystemExtensions.OSSystemExtensionErrorUnknownExtensionCategory, 7)
        ...
        self.assertEqual(SystemExtensions.OSSystemExtensionErrorForbiddenBySystemPolicy, 10)
        ...
        self.assertEqual(SystemExtensions.OSSystemExtensionRequestWillCompleteAfterReboot, 1)
