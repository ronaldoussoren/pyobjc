...
#
# Last update: Sat Aug 14 12:27:33 2021
#
# flake8: noqa
...
try:
    ...
    r(b'GCController', b'setShouldMonitorBackgroundEvents', {'arguments': {2: {'type': 'Z'}}})
    r(b'GCController', b'setShouldMonitorBackgroundEvents:', {'arguments': {2: {'type': b'Z'}}})
