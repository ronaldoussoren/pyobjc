...
#
# Last update: Tue Aug 11 09:32:17 2026
#
# flake8: noqa
...
misc.update(
    {
        ...
        "GCControllerHomeButtonSettingsCustomizationActivity": NewType(
            "GCControllerHomeButtonSettingsCustomizationActivity", int
        ),
        "GCSystemGestureState": NewType("GCSystemGestureState", int),
        "GCControllerHomeButtonSettingCustomizationStatus": NewType(
            "GCControllerHomeButtonSettingCustomizationStatus", int
        ),
        ...
        "GCControllerHomeButtonSettingInAppAction": NewType(
            "GCControllerHomeButtonSettingInAppAction", int
        ),
        "GCControllerHomeButtonSettingSystemAction": NewType(
            "GCControllerHomeButtonSettingSystemAction", int
        ),
...
try:
    ...
    r(
        b"GCControllerHomeButtonSettingsManager",
        b"openControllerHomeButtonSettingsForActivity:error:",
        {"retval": {"type": b"Z"}, "arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"GCControllerHomeButtonSettingsManager",
        b"readControllerHomeButtonInAppAction:withError:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"GCControllerHomeButtonSettingsManager",
        b"readControllerHomeButtonInAppActionWithError:",
        {"arguments": {2: {"type_modifier": b"o"}}},
    )
    r(
        b"GCControllerHomeButtonSettingsManager",
        b"readControllerHomeButtonSystemAction:withError:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"GCControllerHomeButtonSettingsManager",
        b"readControllerHomeButtonSystemActionWithError:",
        {"arguments": {2: {"type_modifier": b"o"}}},
    )
    r(
        b"GCControllerHomeButtonSettingsManager",
        b"setSettingsDidChangeHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
    ...
    r(b"GCSpatialAccessory", b"conformsToDeviceType:", {"retval": {"type": b"Z"}})
    ...
    r(b"NSObject", b"forceInput", {"required": True, "retval": {"type": b"@"}})
    ...
    r(
        b"NSObject",
        b"inputStateForSpatialAccessoryAnchorTimestamp:",
        {"required": True, "retval": {"type": b"@"}, "arguments": {2: {"type": b"d"}}},
    )
    r(
        b"NSObject",
    ...
    r(b"NSObject", b"maximumValue", {"required": True, "retval": {"type": b"d"}})
    r(b"NSObject", b"minimumValue", {"required": True, "retval": {"type": b"d"}})
    ...
    r(b"NSObject", b"physicalExtents", {"required": True, "retval": {"type": b"@"}})
    r(
        b"NSObject",
    ...
    r(b"NSObject", b"scaledValue", {"required": True, "retval": {"type": b"d"}})
    r(
        b"NSObject",
...
objc.registerNewKeywordsFromSelector("GCColor", b"init")
objc.registerNewKeywordsFromSelector("GCColor", b"initWithRed:green:blue:")
objc.registerNewKeywordsFromSelector("GCControllerHomeButtonSettingsManager", b"init")
objc.registerNewKeywordsFromSelector(
    "GCControllerHomeButtonSettingsManager", b"initWithQueue:"
)
objc.registerNewKeywordsFromSelector("GCDeviceBattery", b"init")
objc.registerNewKeywordsFromSelector("GCDeviceLight", b"init")
objc.registerNewKeywordsFromSelector("GCDeviceType", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("GCPhysicalInputElementCollection", b"init")
objc.registerNewKeywordsFromSelector("GCRacingWheel", b"init")
objc.registerNewKeywordsFromSelector("GCSteeringWheelElement", b"init")

objc.registerNewKeywords("GCDeviceType", ("identifier",), "deviceTypeWithIdentifier_")
objc.registerNewKeywords("NSValue", ("GCPoint2",), "valueWithGCPoint2_")
expressions = {}
formal_protocols = {
    "GCAxis2DInput": "GCAxis2DInput",
    "GCAxisElement": "GCAxisElement",
    "GCAxisElementName": "GCAxisElementName",
    "GCAxisInput": "GCAxisInput",
    "GCButtonElement": "GCButtonElement",
    "GCButtonElementName": "GCButtonElementName",
    "GCDevice": "GCDevice",
    "GCDevicePhysicalInput": "GCDevicePhysicalInput",
    "GCDevicePhysicalInputState": "GCDevicePhysicalInputState",
    "GCDevicePhysicalInputStateDiff": "GCDevicePhysicalInputStateDiff",
    "GCDirectionPadElement": "GCDirectionPadElement",
    "GCDirectionPadElementName": "GCDirectionPadElementName",
    "GCLinearInput": "GCLinearInput",
    "GCPhysicalInputElement": "GCPhysicalInputElement",
    "GCPhysicalInputElementName": "GCPhysicalInputElementName",
    "GCPhysicalInputExtents": "GCPhysicalInputExtents",
    "GCPhysicalInputSource": "GCPhysicalInputSource",
    "GCPressedStateInput": "GCPressedStateInput",
    "GCRelativeInput": "GCRelativeInput",
    "GCSwitchElement": "GCSwitchElement",
    "GCSwitchElementName": "GCSwitchElementName",
    "GCSwitchPositionInput": "GCSwitchPositionInput",
    "GCTouchedStateInput": "GCTouchedStateInput",
}
