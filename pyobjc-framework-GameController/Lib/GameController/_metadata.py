...
#
# Last update: Sat Jul 30 14:51:50 2022
#
# flake8: noqa
...
misc.update(
    {
        ...
        "GCDualSenseAdaptiveTriggerPositionalResistiveStrengths": objc.createStructType(
            ...
            b"{_GCDualSenseAdaptiveTriggerPositionalResistiveStrengths=[10f]}",
            ["values"],
        ),
        ...
        "GCDualSenseAdaptiveTriggerPositionalAmplitudes": objc.createStructType(
            ...
            b"{_GCDualSenseAdaptiveTriggerPositionalAmplitudes=[10f]}",
            ["values"],
        ),
...
try:
    ...
    r(
        ...
        b"setModeFeedbackWithResistiveStrengths:",
        {
            "arguments": {
                2: {
                    "type": b"{_GCDualSenseAdaptiveTriggerPositionalResistiveStrengths=[10f]}"
                }
            }
        },
    )
    r(
        ...
        {
            "arguments": {
                2: {"type": b"{_GCDualSenseAdaptiveTriggerPositionalAmplitudes=[10f]}"}
            }
        },
    )
    r(
