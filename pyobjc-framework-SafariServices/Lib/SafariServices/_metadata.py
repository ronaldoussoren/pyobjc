...
#
# Last update: Wed Jul 22 22:13:33 2026
#
# flake8: noqa
...
try:
    ...
    r(
        b"SFSafariSettings",
        b"checkAutoFillUserNamesAndPasswordsEnabledWithCompletionHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
...
objc.registerNewKeywordsFromSelector("SFSafariApplication", b"init")
objc.registerNewKeywordsFromSelector("SFSafariExtension", b"init")
objc.registerNewKeywordsFromSelector("SFSafariPage", b"init")
objc.registerNewKeywordsFromSelector("SFSafariSettings", b"init")
objc.registerNewKeywordsFromSelector("SFSafariTab", b"init")
objc.registerNewKeywordsFromSelector("SFSafariToolbarItem", b"init")
objc.registerNewKeywordsFromSelector("SFSafariWindow", b"init")
objc.registerNewKeywordsFromSelector("SFUniversalLink", b"init")
objc.registerNewKeywordsFromSelector("SFUniversalLink", b"initWithWebpageURL:")
expressions = {}
formal_protocols = {
    "SFSafariExtensionHandling": "SFSafariExtensionHandling",
}
