...
if sys.maxsize > 2 ** 32:
    ...
    class TestSFSafariExtensionHandlingHelper (SafariServices.NSObject):
        ...
        def additionalRequestHeadersForURL_completionHandler_(self, a, b): pass
    ...
    class TestSFSafariExtensionHandling (TestCase):
        ...
        def testMethods(self):
            ...
            self.assertArgIsBlock(TestSFSafariExtensionHandlingHelper.additionalRequestHeadersForURL_completionHandler_, 1, b'v@')
