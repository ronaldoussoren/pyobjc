...
#
# Last update: Sun May 24 11:55:38 2026
#
# flake8: noqa
...
try:
    ...
    r(
        b"NSObject",
        b"pushRegistry:didReceiveIncomingVoIPPushWithPayload:metadata:withCompletionHandler:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {
    ...
    r(b"PKVoIPPushMetadata", b"mustReport", {"retval": {"type": b"Z"}})
finally:
    objc._updatingMetadata(False)

objc.registerNewKeywordsFromSelector("PKPushRegistry", b"init")
