...
#
# Last update: Sun Jun 21 12:25:14 2026
#
# flake8: noqa
...
misc.update(
    {
        ...
        "GKGameActivityState": NewType("GKGameActivityState", int),
        ...
        "GKGameActivityPlayStyle": NewType("GKGameActivityPlayStyle", int),
...
try:
    ...
    r(
        b"GKAccessPoint",
        b"triggerAccessPointForArcadeWithHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
    ...
    r(
        b"GKAccessPoint",
        b"triggerAccessPointForChallengesWithHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
    ...
    r(
        b"GKAccessPoint",
        b"triggerAccessPointForFriendingWithHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
    ...
    r(
        b"GKAccessPoint",
        b"triggerAccessPointForPlayTogetherWithHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
    ...
    r(
        b"GKAccessPoint",
        b"triggerAccessPointWithChallengeDefinitionID:handler:",
        {
            "arguments": {
                3: {
                    "callable": {
    ...
    r(
        b"GKAccessPoint",
        b"triggerAccessPointWithGameActivity:handler:",
        {
            "arguments": {
                3: {
                    "callable": {
    ...
    r(
        b"GKAccessPoint",
        b"triggerAccessPointWithGameActivityDefinitionID:handler:",
        {
            "arguments": {
                3: {
                    "callable": {
    ...
    r(
        b"GKChallengeDefinition",
        b"hasActiveChallengesWithCompletionHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
    ...
    r(b"GKChallengeDefinition", b"isRepeatable", {"retval": {"type": b"Z"}})
    r(
        b"GKChallengeDefinition",
        b"loadChallengeDefinitionsWithCompletionHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
    ...
    r(
        b"GKGameActivity",
        b"checkPendingGameActivityExistenceWithCompletionHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
    ...
    r(
        b"GKGameActivity",
        b"findMatchWithCompletionHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
    ...
    r(
        b"GKGameActivity",
        b"findPlayersForHostedMatchWithCompletionHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
    ...
    r(b"GKGameActivity", b"isValidPartyCode:", {"retval": {"type": b"Z"}})
    r(
        b"GKGameActivity",
        b"startWithDefinition:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"GKGameActivity",
        b"startWithDefinition:partyCode:error:",
        {"arguments": {4: {"type_modifier": b"o"}}},
    )
    r(
        b"GKGameActivityDefinition",
        b"loadAchievementDescriptionsWithCompletionHandler:",
        {
            "arguments": {
                2: {
    ...
    r(
        b"GKGameActivityDefinition",
        b"loadGameActivityDefinitionsWithCompletionHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
    ...
    r(
        b"GKGameActivityDefinition",
        b"loadGameActivityDefinitionsWithIDs:completionHandler:",
        {
            "arguments": {
                3: {
                    "callable": {
    ...
    r(b"GKGameActivityDefinition", b"supportsPartyCode", {"retval": {"type": b"Z"}})
    r(
        b"GKGameActivityDefinition",
        b"supportsUnlimitedPlayers",
        {"retval": {"type": b"Z"}},
    )
    r(
        b"GKGameSession",
    ...
    r(b"GKLeaderboard", b"isHidden", {"retval": {"type": b"Z"}})
    ...
    r(
        b"NSObject",
        b"player:wantsToPlayGameActivity:completionHandler:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {
...
objc.registerNewKeywordsFromSelector("GKGameActivity", b"init")
objc.registerNewKeywordsFromSelector("GKGameActivity", b"initWithDefinition:")
objc.registerNewKeywordsFromSelector("GKGameActivityDefinition", b"init")
...
objc.registerNewKeywordsFromSelector("GKLeaderboard", b"init")
...
objc.registerNewKeywordsFromSelector("GKLeaderboardEntry", b"init")
...
objc.registerNewKeywords(
    "GKPlayer", ("identifier",), "anonymousGuestPlayerWithIdentifier_"
)
expressions = {}
formal_protocols = {
    "GKAchievementViewControllerDelegate": "GKAchievementViewControllerDelegate",
    "GKChallengeEventHandlerDelegate": "GKChallengeEventHandlerDelegate",
    "GKChallengeListener": "GKChallengeListener",
    "GKChallengesViewControllerDelegate": "GKChallengesViewControllerDelegate",
    "GKFriendRequestComposeViewControllerDelegate": "GKFriendRequestComposeViewControllerDelegate",
    "GKGameActivityListener": "GKGameActivityListener",
    "GKGameCenterControllerDelegate": "GKGameCenterControllerDelegate",
    "GKGameSessionEventListener": "GKGameSessionEventListener",
    "GKInviteEventListener": "GKInviteEventListener",
    "GKLeaderboardViewControllerDelegate": "GKLeaderboardViewControllerDelegate",
    "GKLocalPlayerListener": "GKLocalPlayerListener",
    "GKMatchDelegate": "GKMatchDelegate",
    "GKMatchmakerViewControllerDelegate": "GKMatchmakerViewControllerDelegate",
    "GKSavedGameListener": "GKSavedGameListener",
    "GKSessionDelegate": "GKSessionDelegate",
    "GKTurnBasedEventHandlerDelegate": "GKTurnBasedEventHandlerDelegate",
    "GKTurnBasedEventListener": "GKTurnBasedEventListener",
    "GKTurnBasedMatchmakerViewControllerDelegate": "GKTurnBasedMatchmakerViewControllerDelegate",
    "GKViewController": "GKViewController",
    "GKVoiceChatClient": "GKVoiceChatClient",
}
