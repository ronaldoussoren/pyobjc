...
class TestGKAchievementDescriptionHelper (GameKit.GKAchievementDescription):
    ...
    def isReplayable(self): return 1

class TestGKAchievementDescription (TestCase):
    def testMethods(self):
        self.assertArgIsBlock(GameKit.GKAchievementDescription.loadAchievementDescriptionsWithCompletionHandler_, 0, b'v@@')
        ...
        self.assertArgIsBlock(GameKit.GKAchievementDescription.loadImageWithCompletionHandler_, 0, b'v@@')
