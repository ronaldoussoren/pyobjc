...
class TestAudioHardwareBase (TestCase):
    def testStructs(self):
        ...
        self.assertEqual(v.mFormat, 0)
        self.assertEqual(v.mSampleRateRange, 0)
    ...
    def testConstants(self):
        ...
        self.assertEqual(CoreAudio.kAudioHardwareUnsupportedOperationError, fourcc(b'unop'))
        ...
        self.assertEqual(CoreAudio.kAudioObjectPropertyElementCategoryName, fourcc(b'lccn'))
        ...
        self.assertEqual(CoreAudio.kAudioPlugInPropertyTranslateUIDToDevice, fourcc(b'uidd'))
        ...
        self.assertEqual(CoreAudio.kAudioPlugInPropertyTranslateUIDToClockDevice, fourcc(b'uidc'))

        self.assertEqual(CoreAudio.kAudioTransportManagerClassID, fourcc(b'trpm'))

        self.assertEqual(CoreAudio.kAudioTransportManagerPropertyEndPointList, fourcc(b'end#'))
        self.assertEqual(CoreAudio.kAudioTransportManagerPropertyTranslateUIDToEndPoint, fourcc(b'uide'))
        self.assertEqual(CoreAudio.kAudioTransportManagerPropertyTransportType, fourcc(b'tran'))
        ...
        self.assertEqual(CoreAudio.kAudioDevicePropertyConfigurationApplication, fourcc(b'capp'))
        ...
        self.assertEqual(CoreAudio.kAudioDevicePropertyDeviceCanBeDefaultDevice, fourcc(b'dflt'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyDeviceCanBeDefaultSystemDevice, fourcc(b'sflt'))
        ...
        self.assertEqual(CoreAudio.kAudioDevicePropertyAvailableNominalSampleRates, fourcc(b'nsr#'))
        ...
        self.assertEqual(CoreAudio.kAudioDevicePropertyPreferredChannelsForStereo, fourcc(b'dch2'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyPreferredChannelLayout, fourcc(b'srnd'))
        ...
        self.assertEqual(CoreAudio.kAudioClockDevicePropertyTransportType, fourcc(b'tran'))
        self.assertEqual(CoreAudio.kAudioClockDevicePropertyClockDomain, fourcc(b'clkd'))
        self.assertEqual(CoreAudio.kAudioClockDevicePropertyDeviceIsAlive, fourcc(b'livn'))
        self.assertEqual(CoreAudio.kAudioClockDevicePropertyDeviceIsRunning, fourcc(b'goin'))
        ...
        self.assertEqual(CoreAudio.kAudioClockDevicePropertyNominalSampleRate, fourcc(b'nsrt'))
        self.assertEqual(CoreAudio.kAudioClockDevicePropertyAvailableNominalSampleRates, fourcc(b'nsr#'))
        ...
        self.assertEqual(CoreAudio.kAudioEndPointDevicePropertyComposition, fourcc(b'acom'))
        self.assertEqual(CoreAudio.kAudioEndPointDevicePropertyEndPointList, fourcc(b'agrp'))
        ...
        self.assertEqual(CoreAudio.kAudioStreamTerminalTypeDigitalAudioInterface, fourcc(b'spdf'))
        ...
        self.assertEqual(CoreAudio.kAudioStreamTerminalTypeReceiverSpeaker, fourcc(b'rspk'))
        self.assertEqual(CoreAudio.kAudioStreamTerminalTypeMicrophone, fourcc(b'micr'))
        self.assertEqual(CoreAudio.kAudioStreamTerminalTypeHeadsetMicrophone, fourcc(b'hmic'))
        self.assertEqual(CoreAudio.kAudioStreamTerminalTypeReceiverMicrophone, fourcc(b'rmic'))
        ...
        self.assertEqual(CoreAudio.kAudioStreamPropertyLatency, CoreAudio.kAudioDevicePropertyLatency)
        self.assertEqual(CoreAudio.kAudioStreamPropertyVirtualFormat, fourcc(b'sfmt'))
        self.assertEqual(CoreAudio.kAudioStreamPropertyAvailableVirtualFormats, fourcc(b'sfma'))
        self.assertEqual(CoreAudio.kAudioStreamPropertyPhysicalFormat, fourcc(b'pft '))
        self.assertEqual(CoreAudio.kAudioStreamPropertyAvailablePhysicalFormats, fourcc(b'pfta'))
        ...
        self.assertEqual(CoreAudio.kAudioLevelControlPropertyDecibelValue, fourcc(b'lcdv'))
        self.assertEqual(CoreAudio.kAudioLevelControlPropertyDecibelRange, fourcc(b'lcdr'))
        self.assertEqual(CoreAudio.kAudioLevelControlPropertyConvertScalarToDecibels, fourcc(b'lcsd'))
        self.assertEqual(CoreAudio.kAudioLevelControlPropertyConvertDecibelsToScalar, fourcc(b'lcds'))
        ...
        self.assertEqual(CoreAudio.kAudioSelectorControlPropertyCurrentItem, fourcc(b'scci'))
        self.assertEqual(CoreAudio.kAudioSelectorControlPropertyAvailableItems, fourcc(b'scai'))
        ...
        self.assertEqual(CoreAudio.kAudioStereoPanControlPropertyPanningChannels, fourcc(b'spcc'))
