...
class TestAudioHardware (TestCase):
    def testConstants(self):
        ...
        self.assertEqual(CoreAudio.kAudioHardwarePropertyDefaultInputDevice, fourcc(b'dIn '))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyDefaultOutputDevice, fourcc(b'dOut'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyDefaultSystemOutputDevice, fourcc(b'sOut'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyTranslateUIDToDevice, fourcc(b'uidd'))
        ...
        self.assertEqual(CoreAudio.kAudioHardwarePropertyTranslateBundleIDToPlugIn, fourcc(b'bidp'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyTransportManagerList, fourcc(b'tmg#'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyTranslateBundleIDToTransportManager, fourcc(b'tmbi'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyBoxList, fourcc(b'box#'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyTranslateUIDToBox, fourcc(b'uidb'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyClockDeviceList, fourcc(b'clk#'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyTranslateUIDToClockDevice, fourcc(b'uidc'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyProcessIsMaster, fourcc(b'mast'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyIsInitingOrExiting, fourcc(b'inot'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyUserIDChanged, fourcc(b'euid'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyProcessIsAudible, fourcc(b'pmut'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertySleepingIsAllowed, fourcc(b'slep'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyUnloadingIsAllowed, fourcc(b'unld'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyHogModeIsAllowed, fourcc(b'hogr'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyUserSessionIsActiveOrHeadless, fourcc(b'user'))
        self.assertEqual(CoreAudio.kAudioHardwarePropertyServiceRestarted, fourcc(b'srst'))
        ...
        self.assertEqual(CoreAudio.kAudioTransportManagerCreateEndPointDevice, fourcc(b'cdev'))
        self.assertEqual(CoreAudio.kAudioTransportManagerDestroyEndPointDevice, fourcc(b'ddev'))
        ...
        self.assertEqual(CoreAudio.kAudioDevicePropertyDeviceIsRunningSomewhere, fourcc(b'gone'))
        self.assertEqual(CoreAudio.kAudioDeviceProcessorOverload, fourcc(b'over'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyIOStoppedAbnormally, fourcc(b'stpd'))
        ...
        self.assertEqual(CoreAudio.kAudioDevicePropertyBufferFrameSizeRange, fourcc(b'fsz#'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyUsesVariableBufferFrameSizes, fourcc(b'vfsz'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyIOCycleUsage, fourcc(b'ncyc'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyStreamConfiguration, fourcc(b'slay'))
        ...
        self.assertEqual(CoreAudio.kAudioDevicePropertyVolumeRangeDecibels, fourcc(b'vdb#'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyVolumeScalarToDecibels, fourcc(b'v2db'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyVolumeDecibelsToScalar, fourcc(b'db2v'))
        ...
        self.assertEqual(CoreAudio.kAudioDevicePropertyDataSourceNameForIDCFString, fourcc(b'lscn'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyDataSourceKindForID, fourcc(b'ssck'))
        ...
        self.assertEqual(CoreAudio.kAudioDevicePropertyClockSourceNameForIDCFString, fourcc(b'lcsn'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyClockSourceKindForID, fourcc(b'csck'))
        ...
        self.assertEqual(CoreAudio.kAudioDevicePropertyPlayThruVolumeScalar, fourcc(b'mvsc'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyPlayThruVolumeDecibels, fourcc(b'mvdb'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyPlayThruVolumeRangeDecibels, fourcc(b'mvd#'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyPlayThruVolumeScalarToDecibels, fourcc(b'mv2d'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyPlayThruVolumeDecibelsToScalar, fourcc(b'mv2s'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyPlayThruStereoPan, fourcc(b'mspn'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyPlayThruStereoPanChannels, fourcc(b'msp#'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyPlayThruDestination, fourcc(b'mdds'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyPlayThruDestinations, fourcc(b'mdd#'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyPlayThruDestinationNameForIDCFString, fourcc(b'mddc'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyChannelNominalLineLevel, fourcc(b'nlvl'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyChannelNominalLineLevels, fourcc(b'nlv#'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyChannelNominalLineLevelNameForIDCFString, fourcc(b'lcnl'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyHighPassFilterSetting, fourcc(b'hipf'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyHighPassFilterSettings, fourcc(b'hip#'))
        self.assertEqual(CoreAudio.kAudioDevicePropertyHighPassFilterSettingNameForIDCFString, fourcc(b'hipl'))
        ...
        self.assertEqual(CoreAudio.kAudioDevicePropertySubVolumeRangeDecibels, fourcc(b'svd#'))
        self.assertEqual(CoreAudio.kAudioDevicePropertySubVolumeScalarToDecibels, fourcc(b'sv2d'))
        ...
        self.assertEqual(CoreAudio.kAudioAggregateDevicePropertyFullSubDeviceList, fourcc(b'grup'))
        self.assertEqual(CoreAudio.kAudioAggregateDevicePropertyActiveSubDeviceList, fourcc(b'agrp'))
        self.assertEqual(CoreAudio.kAudioAggregateDevicePropertyComposition, fourcc(b'acom'))
        self.assertEqual(CoreAudio.kAudioAggregateDevicePropertyMasterSubDevice, fourcc(b'amst'))
        self.assertEqual(CoreAudio.kAudioAggregateDevicePropertyClockDevice, fourcc(b'apcd'))
        ...
        self.assertEqual(CoreAudio.kAudioSubDeviceDriftCompensationQualityKey, b"drift quality")

        self.assertEqual(CoreAudio.kAudioSubDevicePropertyExtraLatency, fourcc(b'xltc'))
        self.assertEqual(CoreAudio.kAudioSubDevicePropertyDriftCompensation, fourcc(b'drft'))
        self.assertEqual(CoreAudio.kAudioSubDevicePropertyDriftCompensationQuality, fourcc(b'drfq'))
    ...
    def testFunctions(self):
        ...
        self.assertArgIsBlock(CoreAudio.AudioObjectRemovePropertyListenerBlock, 3, AudioObjectPropertyListenerBlock)
        ...
        self.assertArgIsBlock(CoreAudio.AudioDeviceCreateIOProcIDWithBlock, 3, AudioDeviceIOBlock)
