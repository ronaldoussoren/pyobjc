...
class TestAudioHardwareDeprecated(TestCase):
    def testConstants(self):
        ...
        self.assertEqual(
            CoreAudio.kAudioLevelControlPropertyDecibelsToScalarTransferFunction,
            fourcc(b"lctf"),
        )
        ...
        self.assertEqual(
            CoreAudio.kAudioHardwareRunLoopMode, b"com.apple.audio.CoreAudio"
        )
        ...
        self.assertEqual(
            CoreAudio.kAudioHardwarePropertyBootChimeVolumeScalar, fourcc(b"bbvs")
        )
        self.assertEqual(
        ...
        self.assertEqual(
            CoreAudio.kAudioDevicePropertyDriverShouldOwniSub, fourcc(b"isub")
        )
        self.assertEqual(
        ...
        self.assertEqual(
            CoreAudio.kAudioDevicePropertyDeviceManufacturer, fourcc(b"makr")
        )
        self.assertEqual(
        ...
        self.assertEqual(
            CoreAudio.kAudioDevicePropertyRegisterBufferList, fourcc(b"rbuf")
        )
        ...
        self.assertEqual(
            CoreAudio.kAudioDevicePropertyChannelCategoryName, fourcc(b"ccnm")
        )
        self.assertEqual(
        ...
        self.assertEqual(
            CoreAudio.kAudioDevicePropertyClockSourceNameForID, fourcc(b"cscn")
        )
        self.assertEqual(
            CoreAudio.kAudioDevicePropertyPlayThruDestinationNameForID, fourcc(b"mddn")
        )
        self.assertEqual(
        ...
        self.assertEqual(
            CoreAudio.kAudioStreamPropertyPhysicalFormatSupported, fourcc(b"pft?")
        )
        self.assertEqual(
    ...
    def testFunctions(self):
        ...
        self.assertArgIsFunction(
            CoreAudio.AudioHardwareAddPropertyListener,
            1,
        ...
        self.assertArgIsFunction(
            CoreAudio.AudioHardwareRemovePropertyListener,
            1,
            AudioHardwarePropertyListenerProc,
            True,
        )
        ...
        self.assertArgIsFunction(
            CoreAudio.AudioDeviceAddIOProc, 1, AudioDeviceIOProc, True
        )
        self.assertArgIsFunction(
            CoreAudio.AudioDeviceRemoveIOProc, 1, AudioDeviceIOProc, True
        )
        ...
        self.assertArgIsFunction(
            CoreAudio.AudioDeviceAddPropertyListener,
            4,
        ...
        self.assertArgIsFunction(
            CoreAudio.AudioDeviceRemovePropertyListener,
            4,
            AudioDevicePropertyListenerProc,
            True,
        )
        ...
        self.assertArgIsFunction(
            CoreAudio.AudioStreamAddPropertyListener,
            3,
        ...
        self.assertArgIsFunction(
            CoreAudio.AudioStreamRemovePropertyListener,
            3,
            AudioStreamPropertyListenerProc,
            True,
        )
