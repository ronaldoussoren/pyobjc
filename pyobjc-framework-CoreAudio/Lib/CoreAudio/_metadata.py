...
#
# Last update: Sun Mar 15 13:00:16 2020
#
# flake8: noqa
...
misc.update(
    {
        "AudioClassDescription": objc.createStructType(
            ...
            sel32or64(b"{AudioClassDescription=LLL}", b"{AudioClassDescription=III}"),
            ["mType", "mSubType", "mManufacturer"],
        ),
        "AudioStreamPacketDescription": objc.createStructType(
            "AudioStreamPacketDescription",
            sel32or64(
                b"{AudioStreamPacketDescription=qLL}",
        ...
        "AudioStreamRangedDescription": objc.createStructType(
            ...
            sel32or64(
                b"{AudioStreamRangedDescription={AudioStreamBasicDescription=dLLLLLLLL}{AudioValueRange=dd}}",
        ...
        "AudioChannelDescription": objc.createStructType(
            ...
            sel32or64(
                b"{AudioChannelDescription=LL[3f]}", b"{AudioChannelDescription=II[3f]}"
            ),
        ...
        "AudioChannelLayout": objc.createStructType(
            "AudioChannelLayout",
            sel32or64(
                b"{AudioChannelLayout=LLL[1{AudioChannelDescription=LL[3f]}]}",
        ...
        "AudioValueRange": objc.createStructType(
            "AudioValueRange", b"{AudioValueRange=dd}", ["mMinimum", "mMaximum"]
        ),
        "AudioTimeStamp": objc.createStructType(
            "AudioTimeStamp",
            sel32or64(
                b"{AudioTimeStamp=dQdQ{SMPTETime=ssLLLssss}LL}",
        ...
        "AudioHardwareIOProcStreamUsage": objc.createStructType(
            ...
            sel32or64(
                b"{AudioHardwareIOProcStreamUsage=^vL[1L]}",
        ...
        "AudioStreamBasicDescription": objc.createStructType(
            ...
            sel32or64(
                b"{AudioStreamBasicDescription=dLLLLLLLL}",
        ...
        "AudioObjectPropertyAddress": objc.createStructType(
            ...
            sel32or64(
                b"{AudioObjectPropertyAddress=LLL}", b"{AudioObjectPropertyAddress=III}"
            ),
...
functions = {
    "AudioDeviceSetProperty": (
        sel32or64(
            b"lL^{AudioTimeStamp=dQdQ{SMPTETime=ssLLLssss}LL}LZLL^v",
    ...
    "FillOutAudioTimeStampWithSampleAndHostTime": (
        sel32or64(
            b"vo^{AudioTimeStamp=dQdQ{SMPTETime=ssLLLssss}LL}dQ",
            b"vo^{AudioTimeStamp=dQdQ{SMPTETime=ssIIIssss}II}dQ",
        ),
    ),
    "AudioObjectRemovePropertyListenerBlock": (
        sel32or64(
            b"lL^{AudioObjectPropertyAddress=LLL}@@?",
                ...
                3: {
                    "callable": {
                        ...
                        "arguments": {
                            ...
                            2: {
                                "type": sel32or64(
                                    b"n^{AudioObjectPropertyAddress=LLL}",
                                    b"n^{AudioObjectPropertyAddress=III}",
                                ),
    ...
    "AudioDeviceStartAtTime": (
        sel32or64(
            b"lL^?^{AudioTimeStamp=dQdQ{SMPTETime=ssLLLssss}LL}L",
    ...
    "AudioDeviceGetProperty": (
        sel32or64(b"lLLZL^L^v", b"iIIZI^I^v"),
        "",
        {
            "arguments": {
                4: {"type_modifier": "N"},
    ...
    "AudioObjectSetPropertyData": (
        sel32or64(
            b"lL^{AudioObjectPropertyAddress=LLL}L^vL^v",
    ...
    "AudioObjectAddPropertyListener": (
        sel32or64(
            b"lL^{AudioObjectPropertyAddress=LLL}^?^v",
    ...
    "AudioHardwareAddRunLoopSource": (
        sel32or64(b"l^{__CFRunLoopSource=}", b"i^{__CFRunLoopSource=}"),
    ),
    "AudioStreamSetProperty": (
        sel32or64(
            b"lL^{AudioTimeStamp=dQdQ{SMPTETime=ssLLLssss}LL}LLL^v",
    ...
    "AudioStreamGetPropertyInfo": (
        sel32or64(b"lLLL^L^Z", b"iIII^I^Z"),
        "",
    ...
    "AudioDeviceStop": (sel32or64(b"lL^?", b"iI^?"),),
    "AudioHardwareGetPropertyInfo": (
        sel32or64(b"lL^L^Z", b"iI^I^Z"),
        "",
    ...
    "AudioHardwareUnload": (sel32or64(b"l", b"i"), "", {"variadic": True}),
    "AudioStreamGetProperty": (
        sel32or64(b"lLLL^L^v", b"iIII^I^v"),
        "",
        {
            "arguments": {
                3: {"type_modifier": "N"},
    ...
    "FillOutAudioTimeStampWithSampleTime": (
        sel32or64(
            b"vo^{AudioTimeStamp=dQdQ{SMPTETime=ssLLLssss}LL}d",
            b"vo^{AudioTimeStamp=dQdQ{SMPTETime=ssIIIssss}II}d",
        ),
    ),
    "CalculateLPCMFlags": (b"IIIBBB",),
    "AudioHardwareCreateAggregateDevice": (
        sel32or64(b"l^{__CFDictionary=}^L", b"i^{__CFDictionary=}^I"),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {1: {"type_modifier": "o"}},
    ...
    "AudioHardwareDestroyAggregateDevice": (sel32or64(b"lL", b"iI"),),
    "AudioDeviceAddIOProc": (
        sel32or64(b"lL^?^v", b"iI^?^v"),
        "",
        {
            "arguments": {
                1: {
    ...
    "FillOutAudioTimeStampWithHostTime": (
        sel32or64(
            b"vo^{AudioTimeStamp=dQdQ{SMPTETime=ssLLLssss}LL}Q",
            b"vo^{AudioTimeStamp=dQdQ{SMPTETime=ssIIIssss}II}Q",
        ),
    ),
    "AudioObjectGetPropertyData": (
        sel32or64(
            b"lL^{AudioObjectPropertyAddress=LLL}L^v^L^v",
    ...
    "FillOutASBDForLPCM": (
        sel32or64(
            b"vo^{AudioStreamBasicDescription=dLLLLLLLL}dIIIBBB",
            b"vo^{AudioStreamBasicDescription=dIIIIIIII}dIIIBBB",
        ),
    ),
    "AudioObjectShow": (sel32or64(b"vL", b"vI"),),
    ...
    "AudioHardwareSetProperty": (
        sel32or64(b"lLL^v", b"iII^v"),
        "",
        {"arguments": {2: {"c_array_length_in_arg": 1, "type_modifier": "n"}}},
    ),
    "IsAudioFormatNativeEndian": (
        sel32or64(
            b"Bn^{AudioStreamBasicDescription=dLLLLLLLL}",
            b"Bn^{AudioStreamBasicDescription=dIIIIIIII}",
        ),
    ),
    ...
    "AudioDeviceGetCurrentTime": (
        sel32or64(
            b"lL^{AudioTimeStamp=dQdQ{SMPTETime=ssLLLssss}LL}",
            b"iI^{AudioTimeStamp=dQdQ{SMPTETime=ssIIIssss}II}",
        ),
        "",
        {"arguments": {1: {"type_modifier": "o"}}},
    ),
    "AudioChannelLayoutTag_GetNumberOfChannels": (sel32or64(b"LL", b"II"),),
    ...
    "AudioDeviceStart": (sel32or64(b"lL^?", b"iI^?"),),
    "AudioDeviceCreateIOProcIDWithBlock": (
        sel32or64(b"l^^?L@@?", b"i^^?I@@?"),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "AudioDeviceGetPropertyInfo": (
        sel32or64(b"lLLZL^L^Z", b"iIIZI^I^Z"),
        "",
    ...
    "AudioDeviceRead": (
        sel32or64(
            b"lL^{AudioTimeStamp=dQdQ{SMPTETime=ssLLLssss}LL}^{AudioBufferList=L[1{AudioBuffer=LL^v}]}",
    ...
    "AudioObjectIsPropertySettable": (
        sel32or64(
            b"lL^{AudioObjectPropertyAddress=LLL}^Z",
    ...
    "AudioDeviceTranslateTime": (
        sel32or64(
            b"lL^{AudioTimeStamp=dQdQ{SMPTETime=ssLLLssss}LL}^{AudioTimeStamp=dQdQ{SMPTETime=ssLLLssss}LL}",
    ...
    "AudioObjectGetPropertyDataSize": (
        sel32or64(
            b"lL^{AudioObjectPropertyAddress=LLL}L^v^L",
    ...
    "AudioDeviceDestroyIOProcID": (sel32or64(b"lL^?", b"iI^?"),),
}
aliases = {
