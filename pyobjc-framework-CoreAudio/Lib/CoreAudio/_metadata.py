...
misc.update(
    {
        ...
        "AudioStreamPacketDependencyDescription": objc.createStructType(
            "CoreAudio.AudioStreamPacketDependencyDescription",
            b"{AudioStreamPacketDependencyDescription=IIII}",
            ["mIsIndependentlyDecodable", "mPreRollCount", "mFlags", "mReserved"],
        ),
                ...
                3: {
                    "callable": {
                        ...
                        "arguments": {
                            ...
                            1: {"type": b"I"},
                            2: {
                                "type": b"n^{AudioObjectPropertyAddress=III}",
...
try:
    ...
    r(b"CATapDescription", b"isProcessRestoreEnabled", {"retval": {"type": "Z"}})
