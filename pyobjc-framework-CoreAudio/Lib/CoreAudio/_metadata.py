...
#
# Last update: Fri May 22 14:57:41 2026
#
# flake8: noqa
                ...
                2: {
                    "callable": {
                        ...
                        "arguments": {
                            0: {"type": b"I"},
                            1: {"type": b"I"},
                            2: {"type": b"^{AudioObjectPropertyAddress=III}"},
                            3: {"type": b"^v"},
                        },
                    },
                    "function": {
                        "args": [
                            {"typestr": "I"},
                            {"typestr": "I"},
                            {"typestr": "n^{AudioObjectPropertyAddress=III}"},
                            {"typestr": "^v"},
                        ],
                        "retval": {"typestr": "i"},
                    },
                ...
                1: {
                    ...
                    "function": {
                        "args": [
                            {"typestr": "I"},
                            {
                                "typestr": "n^{AudioTimeStamp=dQdQ{SMPTETime=ssIIIssss}II}"
                            },
