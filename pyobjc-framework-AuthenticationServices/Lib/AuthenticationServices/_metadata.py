...
#
# Last update: Fri Oct 18 16:29:56 2019
...
try:
    r(b'ASAuthorizationAppleIDProvider', b'getCredentialStateForUserID:completion:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'q'}, 2: {'type': b'@'}}}}}})
    r(b'ASAuthorizationProviderExtensionAuthorizationRequest', b'presentAuthorizationViewControllerWithCompletion:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'Z'}, 2: {'type': b'@'}}}}}})
    ...
    r(b'ASWebAuthenticationSession', b'initWithURL:callbackURLScheme:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
