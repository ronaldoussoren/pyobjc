...
try:
    ...
    r(
        b"ASAuthorizationProviderExtensionLoginConfiguration",
        b"includePlatformSSOAuthorizationScopes",
        {"retval": {"type": b"Z"}},
    )
    r(
        b"ASAuthorizationProviderExtensionLoginConfiguration",
    ...
    r(
        b"ASAuthorizationProviderExtensionLoginConfiguration",
        b"setIncludePlatformSSOAuthorizationScopes:",
    ...
    r(
        b"NSObject",
        b"displayNamesForGroups:loginManager:completion:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {
    ...
    r(
        b"NSObject",
        b"profilePictureForUserUsingLoginManager:completion:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {
...
expressions = {}
formal_protocols = {
    "ASAccountAuthenticationModificationControllerDelegate": "ASAccountAuthenticationModificationControllerDelegate",
    "ASAccountAuthenticationModificationControllerPresentationContextProviding": "ASAccountAuthenticationModificationControllerPresentationContextProviding",
    "ASAuthorizationControllerDelegate": "ASAuthorizationControllerDelegate",
    "ASAuthorizationControllerPresentationContextProviding": "ASAuthorizationControllerPresentationContextProviding",
    "ASAuthorizationCredential": "ASAuthorizationCredential",
    "ASAuthorizationProvider": "ASAuthorizationProvider",
    "ASAuthorizationProviderExtensionAuthorizationRequestHandler": "ASAuthorizationProviderExtensionAuthorizationRequestHandler",
    "ASAuthorizationProviderExtensionRegistrationHandler": "ASAuthorizationProviderExtensionRegistrationHandler",
    "ASAuthorizationPublicKeyCredentialAssertion": "ASAuthorizationPublicKeyCredentialAssertion",
    "ASAuthorizationPublicKeyCredentialAssertionRequest": "ASAuthorizationPublicKeyCredentialAssertionRequest",
    "ASAuthorizationPublicKeyCredentialDescriptor": "ASAuthorizationPublicKeyCredentialDescriptor",
    "ASAuthorizationPublicKeyCredentialRegistration": "ASAuthorizationPublicKeyCredentialRegistration",
    "ASAuthorizationPublicKeyCredentialRegistrationRequest": "ASAuthorizationPublicKeyCredentialRegistrationRequest",
    "ASAuthorizationWebBrowserExternallyAuthenticatableRequest": "ASAuthorizationWebBrowserExternallyAuthenticatableRequest",
    "ASAuthorizationWebBrowserPlatformPublicKeyCredentialAssertionRequest": "ASAuthorizationWebBrowserPlatformPublicKeyCredentialAssertionRequest",
    "ASAuthorizationWebBrowserPlatformPublicKeyCredentialProvider": "ASAuthorizationWebBrowserPlatformPublicKeyCredentialProvider",
    "ASAuthorizationWebBrowserPlatformPublicKeyCredentialRegistrationRequest": "ASAuthorizationWebBrowserPlatformPublicKeyCredentialRegistrationRequest",
    "ASAuthorizationWebBrowserSecurityKeyPublicKeyCredentialAssertionRequest": "ASAuthorizationWebBrowserSecurityKeyPublicKeyCredentialAssertionRequest",
    "ASAuthorizationWebBrowserSecurityKeyPublicKeyCredentialProvider": "ASAuthorizationWebBrowserSecurityKeyPublicKeyCredentialProvider",
    "ASAuthorizationWebBrowserSecurityKeyPublicKeyCredentialRegistrationRequest": "ASAuthorizationWebBrowserSecurityKeyPublicKeyCredentialRegistrationRequest",
    "ASCredentialIdentity": "ASCredentialIdentity",
    "ASCredentialRequest": "ASCredentialRequest",
    "ASPublicKeyCredential": "ASPublicKeyCredential",
    "ASWebAuthenticationPresentationContextProviding": "ASWebAuthenticationPresentationContextProviding",
    "ASWebAuthenticationSessionRequestDelegate": "ASWebAuthenticationSessionRequestDelegate",
    "ASWebAuthenticationSessionWebBrowserSessionHandling": "ASWebAuthenticationSessionWebBrowserSessionHandling",
}
