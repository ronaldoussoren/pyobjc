...
#
# Last update: Fri Jun 28 13:04:39 2024
#
# flake8: noqa
...
try:
    ...
    r(
        b"ASSettingsHelper",
        b"requestCredentialProviderExtensionEnablementWithCompletionHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
