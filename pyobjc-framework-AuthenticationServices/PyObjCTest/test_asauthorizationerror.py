...
class TestASAuthorization(TestCase):
    def test_constants(self):
        ...
        self.assertEqual(AuthenticationServices.ASAuthorizationErrorInvalidResponse, 1002)
        ...
        self.assertEqual(AuthenticationServices.ASAuthorizationErrorNotInteractive, 1005)
        self.assertEqual(
