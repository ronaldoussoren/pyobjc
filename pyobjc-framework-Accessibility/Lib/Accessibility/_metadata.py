...
#
# Last update: Tue Aug 11 09:28:44 2026
#
# flake8: noqa
...
misc = {}
constants = """$AXAnimatedImagesEnabledDidChangeNotification$AXApplicationAccessibilityEnabledDidChangeNotification$AXMFiHearingDevicePairedUUIDsDidChangeNotification$AXMFiHearingDeviceStreamingEarDidChangeNotification$AXPrefersActionSliderAlternativeDidChangeNotification$AXPrefersHorizontalTextLayoutDidChangeNotification$AXPrefersNonBlinkingTextInsertionIndicatorDidChangeNotification$AXReduceHighlightingEffectsEnabledDidChangeNotification$AXShowBordersEnabledStatusDidChangeNotification$AXSpeechAttributeSSML$AXTechnologyAutomation$AXTechnologyFullKeyboardAccess$AXTechnologyHoverText$AXTechnologySpeakScreen$AXTechnologySwitchControl$AXTechnologyVoiceControl$AXTechnologyVoiceOver$AXTechnologyZoom$"""
enums = """$AXChartContentDirectionBottomToTop@3$AXChartContentDirectionLeftToRight@0$AXChartContentDirectionRadialClockwise@4$AXChartContentDirectionRadialCounterClockwise@5$AXChartContentDirectionRightToLeft@1$AXChartContentDirectionTopToBottom@2$AXCustomContentImportanceDefault@0$AXCustomContentImportanceHigh@1$AXHearingDeviceEarBoth@6$AXHearingDeviceEarLeft@2$AXHearingDeviceEarNone@0$AXHearingDeviceEarRight@4$AXScaleTypeLinear@0$AXScaleTypeLn@2$AXScaleTypeLog10@1$AXSettingsFeatureAllowAppsToAddAudioToCalls@2$AXSettingsFeatureAssistiveTouch@3$AXSettingsFeatureAssistiveTouchDevices@4$AXSettingsFeatureCaptionStyles@6$AXSettingsFeatureDwellControl@5$AXSettingsFeaturePersonalVoiceAllowAppsToRequestToUse@1$"""
misc.update(
    {
...
try:
    r(b"AXBrailleTable", b"isEightDot", {"retval": {"type": b"Z"}})
    r(
...
objc.registerNewKeywordsFromSelector("AXBrailleMap", b"init")
objc.registerNewKeywordsFromSelector("AXBrailleTable", b"init")
objc.registerNewKeywordsFromSelector("AXBrailleTable", b"initWithIdentifier:")
objc.registerNewKeywordsFromSelector("AXBrailleTranslationResult", b"init")
objc.registerNewKeywordsFromSelector("AXBrailleTranslator", b"init")
objc.registerNewKeywordsFromSelector("AXBrailleTranslator", b"initWithBrailleTable:")
objc.registerNewKeywordsFromSelector("AXCategoricalDataAxisDescriptor", b"init")
...
objc.registerNewKeywordsFromSelector("AXChartDescriptor", b"init")
objc.registerNewKeywordsFromSelector(
    "AXChartDescriptor",
...
objc.registerNewKeywordsFromSelector("AXCustomContent", b"init")
objc.registerNewKeywordsFromSelector("AXDataPoint", b"init")
...
objc.registerNewKeywordsFromSelector("AXDataPointValue", b"init")
objc.registerNewKeywordsFromSelector("AXDataSeriesDescriptor", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("AXNumericDataAxisDescriptor", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("AXRequest", b"init")

objc.registerNewKeywords(
    "AXCustomContent",
    ("attributedLabel", "attributedValue"),
    "customContentWithAttributedLabel_attributedValue_",
)
objc.registerNewKeywords(
    "AXCustomContent", ("label", "value"), "customContentWithLabel_value_"
)
objc.registerNewKeywords("AXDataPointValue", ("category",), "valueWithCategory_")
objc.registerNewKeywords("AXDataPointValue", ("number",), "valueWithNumber_")
expressions = {}
formal_protocols = {
    "AXBrailleMapRenderer": "AXBrailleMapRenderer",
    "AXChart": "AXChart",
    "AXCustomContentProvider": "AXCustomContentProvider",
    "AXDataAxisDescriptor": "AXDataAxisDescriptor",
    "AXMathExpressionProvider": "AXMathExpressionProvider",
}
