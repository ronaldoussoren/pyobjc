...
/**
 *
 * GL.EXT.clip_volume_hint Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_EXT_clip_volume_hint)
...
#define glInitClipVolumeHintEXT() InitExtension("GL_EXT_clip_volume_hint", proc_names)
%}

int glInitClipVolumeHintEXT();
DOC(glInitClipVolumeHintEXT, "glInitClipVolumeHintEXT() -> bool")
