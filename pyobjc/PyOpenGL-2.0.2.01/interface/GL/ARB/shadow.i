...
/**
 *
 * GL.ARB.shadow Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_ARB_shadow)
...
#define glInitShadowARB() InitExtension("GL_ARB_shadow", proc_names)
%}

int glInitShadowARB();
DOC(glInitShadowARB, "glInitShadowARB() -> bool")
