...
/**
 *
 * GL.MESA.pack_invert Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_MESA_pack_invert)
...
#define glInitPackInvertMESA() InitExtension("GL_MESA_pack_invert", proc_names)
%}

int glInitPackInvertMESA();
DOC(glInitPackInvertMESA, "glInitPackInvertMESA() -> bool")

%{
PyObject *__info()
{
	if (glInitPackInvertMESA())
	{
