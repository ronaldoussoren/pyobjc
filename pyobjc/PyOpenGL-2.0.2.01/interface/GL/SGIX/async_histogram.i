...
/**
 *
 * GL.SGIX.async_histogram Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_SGIX_async_histogram)
...
#define glInitAsyncHistogramSGIX() InitExtension("GL_SGIX_async_histogram", proc_names)
%}

int glInitAsyncHistogramSGIX();
DOC(glInitAsyncHistogramSGIX, "glInitAsyncHistogramSGIX() -> bool")
