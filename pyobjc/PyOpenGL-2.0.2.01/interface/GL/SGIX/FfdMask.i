...
/**
 *
 * GL.SGIX.FfdMask Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_FfdMaskSGIX)
...
{
#if !EXT_DEFINES_PROTO || !defined(GL_SGIX_FfdMask)

#endif
	NULL
};

#define glInitFfdmaskSGIX() InitExtension("GL_SGIX_FfdMask", proc_names)
%}

int glInitFfdmaskSGIX();
DOC(glInitFfdmaskSGIX, "glInitFfdmaskSGIX() -> bool")

%{
PyObject *__info()
{
	if (glInitFfdmaskSGIX())
	{
