...
/**
 *
 * GL.SGIX.vertex_preclip Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_SGIX_vertex_preclip)
...
#define glInitVertexPreclipSGIX() InitExtension("GL_SGIX_vertex_preclip", proc_names)
%}

int glInitVertexPreclipSGIX();
DOC(glInitVertexPreclipSGIX, "glInitVertexPreclipSGIX() -> bool")
