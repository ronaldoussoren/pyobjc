...
/**
 *
 * GL.SGIX.texture_select Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_SGIX_texture_select)
...
#define glInitTextureSelectSGIX() InitExtension("GL_SGIX_texture_select", proc_names)
%}

int glInitTextureSelectSGIX();
DOC(glInitTextureSelectSGIX, "glInitTextureSelectSGIX() -> bool")

%{
PyObject *__info()
{
	if (glInitTextureSelectSGIX())
	{
