...
/**
 *
 * GL.SGIX.ycrcb Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_SGIX_ycrcb)
...
#define glInitYcrcbSGIX() InitExtension("GL_SGIX_ycrcb", proc_names)
%}

int glInitYcrcbSGIX();
DOC(glInitYcrcbSGIX, "glInitYcrcbSGIX() -> bool")
