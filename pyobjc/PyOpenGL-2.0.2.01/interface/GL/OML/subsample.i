...
/**
 *
 * GL.OML.subsample Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_OML_subsample)
...
#define glInitSubsampleOML() InitExtension("GL_OML_subsample", proc_names)
%}

int glInitSubsampleOML();
DOC(glInitSubsampleOML, "glInitSubsampleOML() -> bool")
