...
class PyInterpreterBootstrap(NSObject):
    def startWithBundle_(self, bundle):
        d = {}
        NSApplicationLoad()
        v = bundle.loadNibFile_externalNameTable_withZone_(u'PyInterpreter.nib', d, None)
        
PyInterpreterBootstrap.alloc().init().performSelectorOnMainThread_withObject_waitUntilDone_(
    'startWithBundle:',
    myBundle,
    False,
)
