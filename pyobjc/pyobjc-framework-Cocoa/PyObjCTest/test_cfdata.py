...
class TestData (TestCase):
    ...
    def testCreation(self):
        self.assertArgHasType(CFDataCreate, 1,  'n^v')
        ...
        self.assertArgHasType(CFDataCreateWithBytesNoCopy, 1, 'n^v')
    ...
    def testInspection(self):
        ...
        self.assertEqual(CFDataGetBytePtr(data)[0] , 'h')
        ...
        self.assertArgHasType(CFDataAppendBytes, 1, 'n^v')
        ...
        self.assertEqual(CFDataGetBytes(mutableData, (0, 9), None), 'pel world')

        self.assertArgHasType(CFDataReplaceBytes, 2, 'n^v')
        self.assertArgSizeInArg(CFDataReplaceBytes, 2, 3)
        CFDataReplaceBytes(mutableData, (0, 3), "hello", 5)
        self.assertEqual(CFDataGetBytes(mutableData, (0, 9), None), 'hello world'[:9])

        CFDataDeleteBytes(mutableData, (0, 6))
        self.assertEqual(CFDataGetBytes(mutableData, (0, 5), None), 'world')
