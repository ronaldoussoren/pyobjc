...
objc.registerNewKeywordsFromSelector("VSAccountApplicationProvider", b"init")
objc.registerNewKeywordsFromSelector(
    "VSAccountApplicationProvider", b"initWithLocalizedDisplayName:identifier:"
)
objc.registerNewKeywordsFromSelector("VSAccountManagerResult", b"init")
objc.registerNewKeywordsFromSelector("VSAppleSubscription", b"init")
objc.registerNewKeywordsFromSelector(
    "VSAppleSubscription", b"initWithCustomerID:productCodes:"
)
objc.registerNewKeywordsFromSelector("VSAutoSignInToken", b"init")
objc.registerNewKeywordsFromSelector("VSAutoSignInTokenUpdateContext", b"init")
objc.registerNewKeywordsFromSelector("VSUserAccount", b"init")
objc.registerNewKeywordsFromSelector("VSUserAccount", b"initWithAccountType:updateURL:")
expressions = {}
formal_protocols = {
    "VSAccountManagerDelegate": "VSAccountManagerDelegate",
}
