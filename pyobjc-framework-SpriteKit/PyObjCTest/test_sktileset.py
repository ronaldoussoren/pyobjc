...
if sys.maxsize > 2 ** 32:
    ...
    class TestSKTileSet (TestCase):
        ...
        def testConstants(self):
            ...
            self.assertEqual(SpriteKit.SKTileAdjacencyAll,
            ...
            self.assertEqual(SpriteKit.SKTileHexFlatAdjacencyAll,
            ...
            self.assertEqual(SpriteKit.SKTileHexPointyAdjacencyAdd,
            ...
            self.assertEqual(SpriteKit.SKTileAdjacencyUpEdge,
                    SpriteKit.SKTileAdjacencyRight |
                    SpriteKit.SKTileAdjacencyLowerRight |
                    SpriteKit.SKTileAdjacencyDown |
                    SpriteKit.SKTileAdjacencyLowerLeft |
                    SpriteKit.SKTileAdjacencyLeft)
            self.assertEqual(SpriteKit.SKTileAdjacencyUpperRightEdge,
                    SpriteKit.SKTileAdjacencyDown |
                    SpriteKit.SKTileAdjacencyLowerLeft |
                    SpriteKit.SKTileAdjacencyLeft)
            self.assertEqual(SpriteKit.SKTileAdjacencyRightEdge,
                SpriteKit.SKTileAdjacencyDown |
                SpriteKit.SKTileAdjacencyLowerLeft |
                SpriteKit.SKTileAdjacencyLeft |
                SpriteKit.SKTileAdjacencyUpperLeft |
                SpriteKit.SKTileAdjacencyUp)
            self.assertEqual(SpriteKit.SKTileAdjacencyLowerRightEdge,
                SpriteKit.SKTileAdjacencyLeft |
                SpriteKit.SKTileAdjacencyUpperLeft |
                SpriteKit.SKTileAdjacencyUp)
            self.assertEqual(SpriteKit.SKTileAdjacencyDownEdge,
                SpriteKit.SKTileAdjacencyUp |
                SpriteKit.SKTileAdjacencyUpperRight |
                SpriteKit.SKTileAdjacencyRight |
                SpriteKit.SKTileAdjacencyLeft |
                SpriteKit.SKTileAdjacencyUpperLeft)
            self.assertEqual(SpriteKit.SKTileAdjacencyLowerLeftEdge,
                SpriteKit.SKTileAdjacencyUp |
                SpriteKit.SKTileAdjacencyUpperRight |
                SpriteKit.SKTileAdjacencyRight)
            self.assertEqual(SpriteKit.SKTileAdjacencyLeftEdge,
                SpriteKit.SKTileAdjacencyUp |
                SpriteKit.SKTileAdjacencyUpperRight |
                SpriteKit.SKTileAdjacencyRight |
                SpriteKit.SKTileAdjacencyLowerRight |
                SpriteKit.SKTileAdjacencyDown)
            self.assertEqual(SpriteKit.SKTileAdjacencyUpperLeftEdge,
                SpriteKit.SKTileAdjacencyRight |
                SpriteKit.SKTileAdjacencyLowerRight |
                SpriteKit.SKTileAdjacencyDown)
            self.assertEqual(SpriteKit.SKTileAdjacencyUpperRightCorner,
                SpriteKit.SKTileAdjacencyUp |
                SpriteKit.SKTileAdjacencyUpperRight |
                SpriteKit.SKTileAdjacencyRight |
                SpriteKit.SKTileAdjacencyLowerRight |
                ...
                SpriteKit.SKTileAdjacencyLeft |
                SpriteKit.SKTileAdjacencyUpperLeft)
            self.assertEqual(SpriteKit.SKTileAdjacencyLowerRightCorner,
                SpriteKit.SKTileAdjacencyUp |
                SpriteKit.SKTileAdjacencyUpperRight |
                SpriteKit.SKTileAdjacencyRight |
                SpriteKit.SKTileAdjacencyLowerRight |
                ...
                SpriteKit.SKTileAdjacencyLowerLeft |
                SpriteKit.SKTileAdjacencyLeft)
            self.assertEqual(SpriteKit.SKTileAdjacencyLowerLeftCorner,
                SpriteKit.SKTileAdjacencyUp |
                SpriteKit.SKTileAdjacencyRight |
                SpriteKit.SKTileAdjacencyLowerRight |
                SpriteKit.SKTileAdjacencyDown |
                ...
                SpriteKit.SKTileAdjacencyLeft |
                SpriteKit.SKTileAdjacencyUpperLeft)
            self.assertEqual(SpriteKit.SKTileAdjacencyUpperLeftCorner,
                SpriteKit.SKTileAdjacencyUp |
                SpriteKit.SKTileAdjacencyUpperRight |
                SpriteKit.SKTileAdjacencyRight |
                SpriteKit.SKTileAdjacencyDown |
