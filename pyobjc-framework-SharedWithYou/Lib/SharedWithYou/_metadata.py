...
#
# Last update: Wed Jul  1 22:23:16 2026
#
# flake8: noqa
...
misc = {}
constants = """$NSPasteboardTypeCollaborationMetadata$SWCollaborationMetadataTypeIdentifier$SWCopyRepresentationTypeIdentifier$"""
...
try:
    ...
    r(b"SWCollaborationView", b"hasPendingAccessRequests", {"retval": {"type": b"Z"}})
    r(
        b"SWCollaborationView",
        b"setHasPendingAccessRequests:",
...
expressions = {}
formal_protocols = {
    "SWCollaborationViewDelegate": "SWCollaborationViewDelegate",
    "SWHighlightCenterDelegate": "SWHighlightCenterDelegate",
    "SWHighlightEvent": "SWHighlightEvent",
}
