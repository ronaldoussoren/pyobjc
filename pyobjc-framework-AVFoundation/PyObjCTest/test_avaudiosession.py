...
class TestAVAudioSession (TestCase):
    def testConstants(self):
        self.assertEqual(AVFoundation.AVAudioSessionSetActiveOptionNotifyOthersOnDeactivation, 1)
        ...
        self.assertEqual(AVFoundation.AVAudioSessionRouteChangeReasonNewDeviceAvailable, 1)
        self.assertEqual(AVFoundation.AVAudioSessionRouteChangeReasonOldDeviceUnavailable, 2)
        ...
        self.assertEqual(AVFoundation.AVAudioSessionRouteChangeReasonNoSuitableRouteForCategory, 7)
        self.assertEqual(AVFoundation.AVAudioSessionRouteChangeReasonRouteConfigurationChange, 8)
        ...
        self.assertEqual(AVFoundation.AVAudioSessionCategoryOptionInterruptSpokenAudioAndMixWithOthers, 0x11)
        self.assertEqual(AVFoundation.AVAudioSessionCategoryOptionAllowBluetoothA2DP, 0x20)
        ...
        self.assertEqual(AVFoundation.AVAudioSessionRecordPermissionUndetermined, fourcc(b'undt'))
        self.assertEqual(AVFoundation.AVAudioSessionRecordPermissionDenied, fourcc(b'deny'))
        self.assertEqual(AVFoundation.AVAudioSessionRecordPermissionGranted, fourcc(b'grnt'))
