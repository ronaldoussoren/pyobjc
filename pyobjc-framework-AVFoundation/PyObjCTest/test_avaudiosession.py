...
class TestAVAudioSession(TestCase):
    def testConstants(self):
        ...
        self.assertEqual(AVFoundation.AVAudioSessionRouteChangeReasonCategoryChange, 3)  # noqa: B950
        self.assertEqual(AVFoundation.AVAudioSessionRouteChangeReasonOverride, 4)  # noqa: B950
        self.assertEqual(AVFoundation.AVAudioSessionRouteChangeReasonWakeFromSleep, 6)  # noqa: B950
        self.assertEqual(
        ...
        self.assertEqual(AVFoundation.AVAudioSessionCategoryOptionMixWithOthers, 0x1)  # noqa: B950
        self.assertEqual(AVFoundation.AVAudioSessionCategoryOptionDuckOthers, 0x2)  # noqa: B950
        ...
        self.assertEqual(AVFoundation.AVAudioSessionSilenceSecondaryAudioHintTypeEnd, 0)  # noqa: B950
        ...
        self.assertEqual(AVFoundation.AVAudioSessionRouteSharingPolicyDefault, 0)  # noqa: B950
        self.assertEqual(AVFoundation.AVAudioSessionRouteSharingPolicyLongFormAudio, 1)  # noqa: B950
        self.assertEqual(
            AVFoundation.AVAudioSessionRouteSharingPolicyLongForm,
            AVFoundation.AVAudioSessionRouteSharingPolicyLongFormAudio,
        )
        self.assertEqual(AVFoundation.AVAudioSessionRouteSharingPolicyIndependent, 2)  # noqa: B950

        self.assertEqual(AVFoundation.AVAudioSessionPromptStyleNone, fourcc(b"none"))  # noqa: B950
        self.assertEqual(AVFoundation.AVAudioSessionPromptStyleShort, fourcc(b"shrt"))  # noqa: B950
        self.assertEqual(AVFoundation.AVAudioSessionPromptStyleNormal, fourcc(b"nrml"))  # noqa: B950
    ...
    def test_constants11_0(self):
        ...
        self.assertIsInstance(AVFoundation.AVAudioSessionRouteChangePreviousRouteKey, str)
        self.assertIsInstance(
