...
if __name__ == "__main__":
    ...
    def testConstants10_15(self):
        self.assertIsInstance(AVFoundation.AVOutputSettingsPresetHEVC1920x1080WithAlpha, unicode)
        self.assertIsInstance(AVFoundation.AVOutputSettingsPresetHEVC3840x2160WithAlpha, unicode)
