...
class TestAVAssetWriterInput (TestCase):
    ...
    def testMethods10_10(self):
        ...
        self.assertArgIsBOOL(AVFoundation.AVAssetWriterInput.setPerformsMultiPassEncodingIfSupported_)
    ...
    def testMethods10_9(self):
        self.assertResultIsBOOL(AVFoundation.AVAssetWriterInput.marksOutputTrackAsEnabled_)
