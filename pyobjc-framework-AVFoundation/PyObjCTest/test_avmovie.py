...
class TestAVMovie(TestCase):
    ...
    def testConstants10_10(self):
        ...
        self.assertEqual(
            AVFoundation.AVMovieWritingTruncateDestinationToMovieHeaderOnly, 1 << 0
        )

        self.assertIsInstance(
            AVFoundation.AVFragmentedMovieContainsMovieFragmentsDidChangeNotification,
            unicode,
        )
        self.assertIsInstance(
            AVFoundation.AVFragmentedMovieDurationDidChangeNotification, unicode
        )
        self.assertIsInstance(
            AVFoundation.AVFragmentedMovieWasDefragmentedNotification, unicode
        )
    ...
    def testMethods10_11(self):
        ...
        self.assertArgIsOut(
            AVFoundation.AVMovie.writeMovieHeaderToURL_fileType_options_error_, 3
        )
        ...
        self.assertArgIsOut(
            AVFoundation.AVMutableMovie.movieWithSettingsFromMovie_options_error_, 2
        )
        self.assertArgIsOut(
            AVFoundation.AVMutableMovie.initWithSettingsFromMovie_options_error_, 2
        )
        ...
        self.assertResultIsBOOL(
            AVFoundation.AVMutableMovie.insertTimeRange_ofAsset_atTime_copySampleData_error_
        )
