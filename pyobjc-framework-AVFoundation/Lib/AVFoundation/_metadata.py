...
misc.update(
    {
        "AVAudio3DPoint": objc.createStructType(
            "AVAudio3DPoint", b"{AVAudio3DPoint=fff}", ["x", "y", "z"]
        ),
        ...
        "AVPixelAspectRatio": objc.createStructType(
            "AVPixelAspectRatio",
            sel32or64(b"{_AVPixelAspectRatio=ii}", b"{_AVPixelAspectRatio=qq}"),
        ...
        "AVBeatRange": objc.createStructType(
            "AVBeatRange", b"{_AVBeatRange=dd}", ["start", "length"]
        ),
        ...
        "AVEdgeWidths": objc.createStructType(
            "AVEdgeWidths",
            sel32or64(b"{_AVEdgeWidths=ffff}", b"{_AVEdgeWidths=dddd}"),
...
functions = {
    ...
    "AVMakeRectWithAspectRatioInsideRect": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}{CGSize=ff}{CGRect={CGPoint=ff}{CGSize=ff}}",
...
try:
    ...
    r(
        ...
        b"setManualRenderingInputPCMFormat:inputBlock:",
        {
            ...
            "arguments": {
                3: {
                    "callable": {
                        "retval": {"type": b"^{AudioBufferList=L[1{AudioBuffer=LL^v}]}"},
    ...
    r(
        ...
        b"extrinsicMatrix",
        {"retval": {"type": b"{_matrix_float4x3=?}"}},
    )
    r(
        b"AVCameraCalibrationData",
        b"intrinsicMatrix",
    ...
    r(
        ...
        {
            "retval": {"type": b"{_AVCaptureWhiteBalanceGains=fff}"},
            "arguments": {2: {"type": b"{_AVCaptureWhiteBalanceChromaticityValues=ff}"}},
        },
    )
    r(
        b"AVCaptureDevice",
        ...
        b"addPeriodicTimeObserverForInterval:queue:usingBlock:",
        {
            "arguments": {
                ...
                4: {
                    "callable": {
                        "retval": {"type": b"v"},
                        "arguments": {0: {"type": b"^v"}, 1: {"type": b"{_CMTime=qiIq}"}},
                    }
                },
            }
        },
    ...
    r(
        ...
        b"edgeWidths",
        {"retval": {"type": sel32or64(b"{_AVEdgeWidths=ffff}", b"{_AVEdgeWidths=dddd}")}},
    )
    r(
        b"AVVideoCompositionRenderContext",
    ...
    r(
        ...
        b"pixelAspectRatio",
        {
            "retval": {
                "type": sel32or64(
                    b"{_AVPixelAspectRatio=ii}", b"{_AVPixelAspectRatio=qq}"
                )
            }
        },
    )
