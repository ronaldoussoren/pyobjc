...
#
# Last update: Sun Jul 11 21:17:26 2021
#
# flake8: noqa
...
try:
    ...
    r(
        ...
        b"conformsCaptionTimeRange",
        {"retval": {"type": b"Z"}},
    )
    r(
        b"AVCaptionFormatConformer",
        b"setConformsCaptionTimeRange:",
        {"arguments": {2: {"type": b"Z"}}},
    )
    r(
        b"AVCaptionGroup",
    ...
    r(
        ...
        b"interstitialEventWithPrimaryItem:identifier:date:templateItems:restrictions:resumptionOffset:playoutLimit:",
    ...
    r(
        b"AVPlayerInterstitialEvent",
        b"interstitialEventWithPrimaryItem:identifier:time:templateItems:restrictions:resumptionOffset:playoutLimit:",
        {
            "arguments": {
                4: {"type": b"{_CMTime=qiIq}"},
    ...
    r(
        b"NSObject",
        b"captionAdaptor:didParseCaption:skippingUnsupportedSourceSyntaxElements:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}, 4: {"type": b"@"}},
