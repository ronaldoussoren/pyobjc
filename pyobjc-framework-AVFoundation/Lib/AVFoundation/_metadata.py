...
#
# Last update: Tue Aug  7 20:57:03 2018
...
try:
    ...
    r(b'AVCaptureDevice', b'requestAccessForMediaType:completionHandler:', {'arguments': {3: {'callable': {'arguments': { 0: {'type': b'^v' }, 1: {'type': b'Z'}}, 'retval':{'type':'v'}}}}})
