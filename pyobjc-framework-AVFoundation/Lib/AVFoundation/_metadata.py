...
#
# Last update: Sun Jun 17 14:09:23 2018
...
try:
    ...
    r(b'AVAudioInputNode', b'setManualRenderingInputPCMFormat:inputBlock:', {'retval': {'type': b'Z'}})
    ...
    r(b'AVContentKeyRequest', b'respondByRequestingPersistableContentKeyRequestAndReturnError:', {'retval': {'type': b'Z'}})
    ...
    r(b'AVMutableMovieTrack', b'appendSampleBuffer:decodeTime:presentationTime:error:', {'retval': {'type': b'Z'}, 'arguments': {3: {'type': b'^{_CMTime=qiIq}'}, 4: {'type': b'^{_CMTime=qiIq}'}}})
    ...
    r(b'AVSampleBufferAudioRenderer', b'flushFromSourceTime:completionHandler:', {'arguments': {2: {'type': b'{_CMTime=qiIq}'}}})
    ...
    r(b'AVSampleBufferRenderSynchronizer', b'addPeriodicTimeObserverForInterval:queue:usingBlock:', {'arguments': {2: {'type': b'{_CMTime=qiIq}'}}})
    ...
    r(b'NSObject', b'requestMediaDataWhenReadyOnQueue:usingBlock:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@?'}}})
