...
#
# Last update: Sun Jun 28 10:45:36 2020
#
# flake8: noqa
...
misc.update(
    {
        ...
        "AVEdgeWidths": objc.createStructType(
            "AVEdgeWidths", b"{_AVEdgeWidths=dddd}", ["left", "top", "right", "bottom"]
        ),
