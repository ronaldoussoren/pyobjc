...
misc.update(
    {
        ...
        "AVAudioSessionResumptionRecommendation": NewType(
            "AVAudioSessionResumptionRecommendation", int
        ),
        ...
        "AVAudioSessionDeactivationSource": NewType(
            "AVAudioSessionDeactivationSource", int
        ),
        ...
        "AVAudioSessionDeactivationOptions": NewType(
            "AVAudioSessionDeactivationOptions", int
        ),
...
try:
    ...
    r(
        b"AVAudioEngine",
        b"connect:to:format:error:",
        {"retval": {"type": b"Z"}, "arguments": {5: {"type_modifier": b"o"}}},
    )
    r(
        b"AVAudioEngine",
        b"connect:to:fromBus:toBus:format:error:",
        {"retval": {"type": b"Z"}, "arguments": {7: {"type_modifier": b"o"}}},
    )
    r(
        b"AVAudioEngine",
        b"connect:toConnectionPoints:fromBus:format:error:",
    ...
    r(
        b"AVAudioEngine",
        b"connectMIDI:to:format:eventListProvider:",
        {
            "arguments": {
                5: {
                    "callable": {
    ...
    r(
        b"AVAudioEngine",
        b"connectMIDI:toNodes:format:eventListProvider:",
        {
            "arguments": {
                5: {
                    "callable": {
    ...
    r(
        b"AVAudioNode",
        b"installTapOnBus:bufferSize:format:error:block:",
        {
            "retval": {"type": b"Z"},
            "arguments": {
                6: {
    ...
    r(b"AVAudioPlayerNode", b"playAndReturnError:", {"retval": {"type": b"Z"}})
    r(b"AVAudioPlayerNode", b"playAtTime:error:", {"retval": {"type": b"Z"}})
    r(
        b"AVAudioPlayerNode",
    ...
    r(
        b"AVAudioSession",
        b"deactivateWithOptions:completionHandler:",
        {
            "arguments": {
                3: {
                    "callable": {
...
objc.registerNewKeywordsFromSelector("AVAudioFormat", b"initWithFormatDescription:")
...
objc.registerNewKeywordsFromSelector("AVAudioSessionDeactivationContext", b"init")
objc.registerNewKeywordsFromSelector("AVAudioSessionInterruptionContext", b"init")
objc.registerNewKeywordsFromSelector("AVAudioSessionResumptionContext", b"init")
objc.registerNewKeywordsFromSelector("AVAudioSinkNode", b"init")
objc.registerNewKeywordsFromSelector(
    "AVAudioSinkNode", b"initWithRealtimeSafeReceiverBlock:"
)
...
objc.registerNewKeywordsFromSelector(
    "AVAudioSourceNode", b"initWithFormat:realtimeSafeRenderBlock:"
)
objc.registerNewKeywordsFromSelector(
    "AVAudioSourceNode", b"initWithFormat:renderBlock:"
)
objc.registerNewKeywordsFromSelector(
    "AVAudioSourceNode", b"initWithRealtimeSafeRenderBlock:"
)
