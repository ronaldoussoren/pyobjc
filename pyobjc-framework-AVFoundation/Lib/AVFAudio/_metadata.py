...
try:
    ...
    r(b'AVAudioEngine', b'connectMIDI:to:format:block:', {'arguments': {5: {'callable': {'retval': {'type': b'i'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'q'}, 2: {'type': b'C'}, 3: {'type': b'q'}, 4: {'type': b'^C'}}}}}})
    r(b'AVAudioEngine', b'connectMIDI:to:format:eventListBlock:', {'arguments': {5: {'callable': {'retval': {'type': b'i'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'q'}, 2: {'type': b'C'}, 3: {'type': b'^{MIDIEventList=iI[1{MIDIEventPacket=QI[64I]}]}'}}}}}})
    r(b'AVAudioEngine', b'connectMIDI:toNodes:format:block:', {'arguments': {5: {'callable': {'retval': {'type': b'i'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'q'}, 2: {'type': b'C'}, 3: {'type': b'q'}, 4: {'type': b'^C'}}}}}})
    r(b'AVAudioEngine', b'connectMIDI:toNodes:format:eventListBlock:', {'arguments': {5: {'callable': {'retval': {'type': b'i'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'q'}, 2: {'type': b'C'}, 3: {'type': b'^{MIDIEventList=iI[1{MIDIEventPacket=QI[64I]}]}'}}}}}})
    r(b'AVAudioEngine', b'enableManualRenderingMode:format:maximumFrameCount:error:', {'retval': {'type': b'Z'}})
    ...
    r(b'AVAudioEngine', b'manualRenderingBlock', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}})
    r(b'AVAudioEngine', b'setAutoShutdownEnabled:', {'arguments': {2: {'type': b'Z'}}})
    r(b'AVAudioEngine', b'startAndReturnError:', {'retval': {'type': b'Z'}})
    r(b'AVAudioEnvironmentNode', b'isListenerHeadTrackingEnabled', {'retval': {'type': b'Z'}})
    r(b'AVAudioEnvironmentNode', b'setListenerHeadTrackingEnabled:', {'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'AVAudioFile', b'initForReading:commonFormat:interleaved:error:', {'arguments': {4: {'type': b'Z'}}})
    r(b'AVAudioFile', b'initForWriting:settings:commonFormat:interleaved:error:', {'arguments': {5: {'type': b'Z'}}})
    ...
    r(b'AVAudioInputNode', b'setManualRenderingInputPCMFormat:inputBlock:', {'retval': {'type': b'Z'}, 'arguments': {3: {'callable': {'retval': {'type': b'{AudioBufferList=I[1{AudioBuffer=II^v}]}'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'I'}}}}}})
    r(b'AVAudioInputNode', b'setMutedSpeechActivityEventListener:', {'retval': {'type': b'Z'}, 'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'q'}}}}}})
    ...
    r(b'AVAudioInputNode', b'setVoiceProcessingOtherAudioDuckingConfiguration:', {'arguments': {2: {'type': b'{AVAudioVoiceProcessingOtherAudioDuckingConfiguration=Zq}'}}})
    r(b'AVAudioInputNode', b'voiceProcessingOtherAudioDuckingConfiguration', {'retval': {'type': b'{AVAudioVoiceProcessingOtherAudioDuckingConfiguration=Zq}'}})
    ...
    r(b'AVAudioSequencer', b'writeToURL:SMPTEResolution:replaceExisting:error:', {'retval': {'type': b'Z'}, 'arguments': {4: {'type': b'Z'}}})
    ...
    r(b'AVAudioSession', b'prefersInterruptionOnRouteDisconnect', {'retval': {'type': b'Z'}})
    r(b'AVAudioSession', b'prefersNoInterruptionsFromSystemAlerts', {'retval': {'type': b'Z'}})
    ...
    r(b'AVAudioSession', b'setOutputMuted:error:', {'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'AVAudioSession', b'setPreferredMicrophoneInjectionMode:error:', {'retval': {'type': b'Z'}})
    ...
    r(b'AVAudioSession', b'setPrefersEchoCancelledInput:error:', {'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'Z'}, 3: {'type_modifier': b'o'}}})
    r(b'AVAudioSession', b'setPrefersInterruptionOnRouteDisconnect:error:', {'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'Z'}}})
    r(b'AVAudioSession', b'setPrefersNoInterruptionsFromSystemAlerts:error:', {'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'Z'}}})
    r(b'AVAudioSession', b'setSupportsMultichannelContent:error:', {'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'AVAudioSessionPortDescription', b'isSpatialAudioEnabled', {'retval': {'type': b'Z'}})
    r(b'AVAudioSessionPortDescription', b'setPreferredDataSource:error:', {'retval': {'type': b'Z'}})
    r(b'AVAudioSinkNode', b'initWithReceiverBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'i'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'^{AudioTimeStamp=dQdQ{SMPTETime=ssIIIssss}II}'}, 2: {'type': b'I'}, 3: {'type': b'^{AudioBufferList=I[1{AudioBuffer=II^v}]}'}}}}}})
    r(b'AVAudioSourceNode', b'initWithFormat:renderBlock:', {'arguments': {3: {'callable': {'retval': {'type': b'i'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'^Z'}, 2: {'type': b'^{AudioTimeStamp=dQdQ{SMPTETime=ssIIIssss}II}'}, 3: {'type': b'I'}, 4: {'type': b'^{AudioBufferList=I[1{AudioBuffer=II^v}]}'}}}}}})
    r(b'AVAudioSourceNode', b'initWithRenderBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'i'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'^Z'}, 2: {'type': b'^{AudioTimeStamp=dQdQ{SMPTETime=ssIIIssss}II}'}, 3: {'type': b'I'}, 4: {'type': b'^{AudioBufferList=I[1{AudioBuffer=II^v}]}'}}}}}})
    ...
    r(b'AVAudioUnitComponentManager', b'componentsPassingTest:', {'arguments': {2: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'o^Z'}}}}}})
    ...
    r(b'AVMIDIPlayer', b'play:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'AVMusicTrack', b'enumerateEventsInRange:usingBlock:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'^d'}, 3: {'type': b'^Z'}}}}}})
    ...
    r(b'AVMusicTrack', b'setUsesAutomatedParameters:', {'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'AVSpeechSynthesisProviderAudioUnit', b'speechSynthesisOutputMetadataBlock', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}})
    ...
    r(b'NSObject', b'destinationForMixer:bus:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'setRenderingAlgorithm:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'q'}}})
    ...
    r(b'NSObject', b'speechSynthesizer:willSpeakMarker:utterance:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'speechSynthesizer:willSpeakRangeOfSpeechString:utterance:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'{_NSRange=QQ}'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'volume', {'required': True, 'retval': {'type': b'f'}})
finally:
    objc._updatingMetadata(False)

objc.registerNewKeywordsFromSelector('AVAUPresetEvent', b'initWithScope:element:dictionary:')
objc.registerNewKeywordsFromSelector('AVAudioApplication', b'init')
objc.registerNewKeywordsFromSelector('AVAudioChannelLayout', b'init')
...
objc.registerNewKeywordsFromSelector('AVAudioCompressedBuffer', b'initWithFormat:packetCapacity:')
objc.registerNewKeywordsFromSelector('AVAudioCompressedBuffer', b'initWithFormat:packetCapacity:maximumPacketSize:')
objc.registerNewKeywordsFromSelector('AVAudioConnectionPoint', b'init')
...
objc.registerNewKeywordsFromSelector('AVAudioEngine', b'init')
objc.registerNewKeywordsFromSelector('AVAudioEnvironmentDistanceAttenuationParameters', b'init')
objc.registerNewKeywordsFromSelector('AVAudioEnvironmentNode', b'init')
objc.registerNewKeywordsFromSelector('AVAudioEnvironmentReverbParameters', b'init')
objc.registerNewKeywordsFromSelector('AVAudioFile', b'init')
objc.registerNewKeywordsFromSelector('AVAudioFile', b'initForReading:commonFormat:interleaved:error:')
objc.registerNewKeywordsFromSelector('AVAudioFile', b'initForReading:error:')
objc.registerNewKeywordsFromSelector('AVAudioFile', b'initForWriting:settings:commonFormat:interleaved:error:')
objc.registerNewKeywordsFromSelector('AVAudioFile', b'initForWriting:settings:error:')
objc.registerNewKeywordsFromSelector('AVAudioFormat', b'initStandardFormatWithSampleRate:channelLayout:')
objc.registerNewKeywordsFromSelector('AVAudioFormat', b'initStandardFormatWithSampleRate:channels:')
objc.registerNewKeywordsFromSelector('AVAudioFormat', b'initWithCMAudioFormatDescription:')
objc.registerNewKeywordsFromSelector('AVAudioFormat', b'initWithCommonFormat:sampleRate:channels:interleaved:')
objc.registerNewKeywordsFromSelector('AVAudioFormat', b'initWithCommonFormat:sampleRate:interleaved:channelLayout:')
...
objc.registerNewKeywordsFromSelector('AVAudioFormat', b'initWithStreamDescription:channelLayout:')
objc.registerNewKeywordsFromSelector('AVAudioInputNode', b'init')
objc.registerNewKeywordsFromSelector('AVAudioMixerNode', b'init')
objc.registerNewKeywordsFromSelector('AVAudioMixingDestination', b'init')
objc.registerNewKeywordsFromSelector('AVAudioOutputNode', b'init')
objc.registerNewKeywordsFromSelector('AVAudioPCMBuffer', b'initWithPCMFormat:bufferListNoCopy:deallocator:')
objc.registerNewKeywordsFromSelector('AVAudioPCMBuffer', b'initWithPCMFormat:frameCapacity:')
objc.registerNewKeywordsFromSelector('AVAudioPlayer', b'initWithContentsOfURL:error:')
objc.registerNewKeywordsFromSelector('AVAudioPlayer', b'initWithContentsOfURL:fileTypeHint:error:')
objc.registerNewKeywordsFromSelector('AVAudioPlayer', b'initWithData:error:')
objc.registerNewKeywordsFromSelector('AVAudioPlayer', b'initWithData:fileTypeHint:error:')
objc.registerNewKeywordsFromSelector('AVAudioPlayerNode', b'init')
...
objc.registerNewKeywordsFromSelector('AVAudioRoutingArbiter', b'init')
objc.registerNewKeywordsFromSelector('AVAudioSequencer', b'init')
objc.registerNewKeywordsFromSelector('AVAudioSequencer', b'initWithAudioEngine:')
objc.registerNewKeywordsFromSelector('AVAudioSession', b'init')
objc.registerNewKeywordsFromSelector('AVAudioSinkNode', b'init')
objc.registerNewKeywordsFromSelector('AVAudioSinkNode', b'initWithReceiverBlock:')
objc.registerNewKeywordsFromSelector('AVAudioSourceNode', b'init')
objc.registerNewKeywordsFromSelector('AVAudioSourceNode', b'initWithFormat:renderBlock:')
objc.registerNewKeywordsFromSelector('AVAudioSourceNode', b'initWithRenderBlock:')
objc.registerNewKeywordsFromSelector('AVAudioTime', b'initWithAudioTimeStamp:sampleRate:')
objc.registerNewKeywordsFromSelector('AVAudioTime', b'initWithHostTime:')
objc.registerNewKeywordsFromSelector('AVAudioTime', b'initWithHostTime:sampleTime:atRate:')
...
objc.registerNewKeywordsFromSelector('AVAudioUnitEQFilterParameters', b'init')
objc.registerNewKeywordsFromSelector('AVAudioUnitEffect', b'initWithAudioComponentDescription:')
objc.registerNewKeywordsFromSelector('AVAudioUnitGenerator', b'initWithAudioComponentDescription:')
objc.registerNewKeywordsFromSelector('AVAudioUnitMIDIInstrument', b'initWithAudioComponentDescription:')
objc.registerNewKeywordsFromSelector('AVAudioUnitTimeEffect', b'initWithAudioComponentDescription:')
objc.registerNewKeywordsFromSelector('AVExtendedNoteOnEvent', b'initWithMIDINote:velocity:groupID:duration:')
objc.registerNewKeywordsFromSelector('AVExtendedNoteOnEvent', b'initWithMIDINote:velocity:instrumentID:groupID:duration:')
objc.registerNewKeywordsFromSelector('AVExtendedTempoEvent', b'initWithTempo:')
objc.registerNewKeywordsFromSelector('AVMIDIChannelPressureEvent', b'initWithChannel:pressure:')
objc.registerNewKeywordsFromSelector('AVMIDIControlChangeEvent', b'initWithChannel:messageType:value:')
objc.registerNewKeywordsFromSelector('AVMIDIMetaEvent', b'initWithType:data:')
objc.registerNewKeywordsFromSelector('AVMIDINoteEvent', b'initWithChannel:key:velocity:duration:')
objc.registerNewKeywordsFromSelector('AVMIDIPitchBendEvent', b'initWithChannel:value:')
objc.registerNewKeywordsFromSelector('AVMIDIPlayer', b'initWithContentsOfURL:soundBankURL:error:')
objc.registerNewKeywordsFromSelector('AVMIDIPlayer', b'initWithData:soundBankURL:error:')
objc.registerNewKeywordsFromSelector('AVMIDIPolyPressureEvent', b'initWithChannel:key:pressure:')
objc.registerNewKeywordsFromSelector('AVMIDIProgramChangeEvent', b'initWithChannel:programNumber:')
...
objc.registerNewKeywordsFromSelector('AVParameterEvent', b'initWithParameterID:scope:element:value:')
objc.registerNewKeywordsFromSelector('AVSpeechSynthesisMarker', b'initWithBookmarkName:atByteSampleOffset:')
objc.registerNewKeywordsFromSelector('AVSpeechSynthesisMarker', b'initWithMarkerType:forTextRange:atByteSampleOffset:')
objc.registerNewKeywordsFromSelector('AVSpeechSynthesisMarker', b'initWithParagraphRange:atByteSampleOffset:')
objc.registerNewKeywordsFromSelector('AVSpeechSynthesisMarker', b'initWithPhonemeString:atByteSampleOffset:')
objc.registerNewKeywordsFromSelector('AVSpeechSynthesisMarker', b'initWithSentenceRange:atByteSampleOffset:')
objc.registerNewKeywordsFromSelector('AVSpeechSynthesisMarker', b'initWithWordRange:atByteSampleOffset:')
objc.registerNewKeywordsFromSelector('AVSpeechSynthesisProviderRequest', b'init')
objc.registerNewKeywordsFromSelector('AVSpeechSynthesisProviderRequest', b'initWithSSMLRepresentation:voice:')
objc.registerNewKeywordsFromSelector('AVSpeechSynthesisProviderVoice', b'init')
objc.registerNewKeywordsFromSelector('AVSpeechSynthesisProviderVoice', b'initWithName:identifier:primaryLanguages:supportedLanguages:')
objc.registerNewKeywordsFromSelector('AVSpeechUtterance', b'initWithAttributedString:')
objc.registerNewKeywordsFromSelector('AVSpeechUtterance', b'initWithSSMLRepresentation:')
objc.registerNewKeywordsFromSelector('AVSpeechUtterance', b'initWithString:')
expressions = {}
formal_protocols={
    'AVAudio3DMixing': 'AVAudio3DMixing',
    'AVAudioMixing': 'AVAudioMixing',
    ...
    'AVAudioStereoMixing': 'AVAudioStereoMixing',
    'AVSpeechSynthesizerDelegate': 'AVSpeechSynthesizerDelegate',
}
