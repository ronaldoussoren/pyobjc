...
#
# Last update: Sun Mar 22 15:14:39 2020
#
# flake8: noqa
...
functions = {
    "MTAudioProcessingTapGetSourceAudio": (
        sel32or64(
            b"l^{opaqueMTAudioProcessingTap=}l^{AudioBufferList=L[1{AudioBuffer=LL^v}]}^I^{_CMTimeRange={_CMTime=qiIq}{_CMTime=qiIq}}^l",
    ...
    "MTAudioProcessingTapGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "MTCopyLocalizedNameForMediaSubType": (
        sel32or64(b"^{__CFString=}LL", b"^{__CFString=}II"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
}
