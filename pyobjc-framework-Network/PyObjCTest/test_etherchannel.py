...
if sys.maxsize > 2 ** 32:
    ...
    class TestEtherChannel (TestCase):
        ...
        def test_functions10_15(self):
            ...
            self.assertArgIsBlock(Network.nw_ethernet_channel_set_state_changed_handler, 1, nw_ethernet_channel_state_changed_handler_t)

            Network.nw_ethernet_channel_set_queue
            Network.nw_ethernet_channel_start
            Network.nw_ethernet_channel_cancel

            self.assertArgIsBlock(Network.nw_ethernet_channel_set_receive_handler, 1, nw_ethernet_channel_receive_handler_t)
            self.assertArgIsBlock(Network.nw_ethernet_channel_send, 4, nw_ethernet_channel_send_completion_t)
