...
if sys.maxsize > 2 ** 32:
    ...
    class TestTxtRecord (TestCase):
        ...
        def test_functions10_15(self):
            ...
            self.assertArgIsBlock(Network.nw_txt_record_access_key, 2, nw_txt_record_access_key_t)
            ...
            self.assertArgIsBlock(Network.nw_txt_record_access_bytes, 1, nw_txt_record_access_bytes_t)
