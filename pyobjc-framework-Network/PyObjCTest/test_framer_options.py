...
if sys.maxsize > 2 ** 32:
    ...
    class TestFramerOptions (TestCase):
        ...
        def test_functions10_15(self):
            ...
            self.assertArgIsBlock(Network.nw_framer_create_definition, 2, nw_framer_start_handler_t)

            self.assertResultIsRetained(Network.nw_framer_create_options)

            self.assertArgIsBlock(Network.nw_framer_set_input_handler, 1, nw_framer_input_handler_t)

            self.assertArgIsBlock(Network.nw_framer_set_output_handler, 1, nw_framer_output_handler_t)

            self.assertArgIsBlock(Network.nw_framer_set_wakeup_handler, 1, nw_framer_wakeup_handler_t)

            self.assertArgIsBlock(Network.nw_framer_set_stop_handler, 1, nw_framer_stop_handler_t)

            self.assertArgIsBlock(Network.nw_framer_set_cleanup_handler, 1, nw_framer_cleanup_handler_t)
