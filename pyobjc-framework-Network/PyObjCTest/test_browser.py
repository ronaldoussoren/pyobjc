...
if sys.maxsize > 2 ** 32:
    ...
    class TestBrowser (TestCase):
        ...
        def test_functions10_15(self):
            ...
            self.assertArgIsBlock(Network.nw_browser_set_browse_results_changed_handler, 1, nw_browser_browse_results_changed_handler_t)
            self.assertArgIsBlock(Network.nw_browser_set_state_changed_handler, 1, nw_browser_state_changed_handler_t)
