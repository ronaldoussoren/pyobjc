...
#
# Last update: Sat Jun 27 18:36:14 2020
#
# flake8: noqa
...
functions = {
    ...
    "nw_establishment_report_enumerate_resolution_reports": (b"v@@?",),
    ...
    "nw_connection_group_copy_remote_endpoint_for_message": (b"@@@",),
    ...
    "nw_connection_group_set_receive_handler": (b"v@IB@?",),
    ...
    "nw_connection_group_send_message": (b"v@@@@@?",),
    "nw_parameters_get_expired_dns_behavior": (b"I@",),
    "nw_txt_record_find_key": (
        b"I@^t",
        "",
        {"arguments": {1: {"c_array_delimited_by_null": 1, "type_modifier": "n"}}},
    ),
    ...
    "nw_connection_group_set_state_changed_handler": (b"v@@?",),
    ...
    "nw_connection_group_extract_connection_for_message": (b"@@@",),
    ...
    "nw_connection_group_copy_local_endpoint_for_message": (b"@@@",),
    "nw_txt_record_apply": (
        b"B@@?",
        "",
        {
    ...
    "nw_group_descriptor_enumerate_endpoints": (b"v@@?",),
