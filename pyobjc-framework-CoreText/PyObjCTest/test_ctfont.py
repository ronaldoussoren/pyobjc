...
class TestCTFont(TestCase):
    ...
    def testConstants(self):
        ...
        self.assertEqual(kCTFontNoFontType, 4_294_967_295)  # (uint32_t)-1
    ...
    def testFunctions(self):
        ...
        descriptor = CTFontDescriptorCreateWithNameAndSize("Optima Bold", 14.0)
        self.assertIsInstance(descriptor, CTFontDescriptorRef)

        font = CTFontCreateWithFontDescriptor(descriptor, 5.0, None)
        self.assertIsInstance(font, CTFontRef)
        self.assertResultIsCFRetained(CTFontCreateWithFontDescriptor)

        font = CTFontCreateUIFontForLanguage(kCTFontMiniSystemFontType, 10.0, "nl_NL")
        self.assertIsInstance(font, CTFontRef)
        self.assertResultIsCFRetained(CTFontCreateUIFontForLanguage)

        font2 = CTFontCreateCopyWithAttributes(font, 9.0, None, None)
        ...
        font2 = CTFontCreateCopyWithSymbolicTraits(
            font, 14.0, None, kCTFontBoldTrait, kCTFontBoldTrait
        )
        self.assertIsInstance(font2, CTFontRef)
        self.assertResultIsCFRetained(CTFontCreateCopyWithAttributes)

        font2 = CTFontCreateCopyWithFamily(font, 14.0, None, "Lucida Grande")
        self.assertIsInstance(font2, CTFontRef)
        ...
        v, gl = CTFontGetGlyphsForCharacters(font, b"hello".decode("latin1"), None, 5)
        ...
        v, r = CTFontGetBoundingRectsForGlyphs(
            font, kCTFontDefaultOrientation, gl, None, 5
        )
        self.assertIsInstance(v, CGRect)
        ...
        v, r = CTFontGetAdvancesForGlyphs(font, kCTFontDefaultOrientation, gl, None, 5)
        self.assertIsInstance(v, float)
        self.assertIsInstance(r, tuple)
        self.assertEqual(len(r), 5)
    ...
    def testFunctions10_6_crash(self):
        descr = CTFontDescriptorCreateWithNameAndSize(b"Courier".decode("latin1"), 14.0)
