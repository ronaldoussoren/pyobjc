...
class TestCTFontManager (TestCase):
    ...
    def testConstants10_6(self):
        ...
        self.assertEqual(CoreText.kCTFontManagerScopeUser, CoreText.kCTFontManagerScopePersistent)


        self.assertIsInstance(CoreText.kCTFontManagerBundleIdentifier, unicode)
        ...
        self.assertIsInstance(CoreText.kCTFontManagerRegisteredFontsChangedNotification, unicode)
    ...
    def testFunctions10_6(self):
        ...
        self.assertArgHasType(CoreText.CTFontManagerCompareFontFamilyNames, 0, b"^{__CFString=}")
        self.assertArgHasType(CoreText.CTFontManagerCompareFontFamilyNames, 1, b"^{__CFString=}")
        ...
        self.assertArgHasType(CoreText.CTFontManagerEnableFontDescriptors, 1, objc._C_BOOL)
        ...
        self.assertResultIsCFRetained(CoreText.CTFontManagerCreateFontRequestRunLoopSource)
        self.assertArgIsBlock(CoreText.CTFontManagerCreateFontRequestRunLoopSource, 1, b"@@i")
    ...
    def testFunctions10_15(self):
        self.assertArgIsBlock(CoreText.CTFontManagerRegisterFontURLs, 3, objc._C_BOOL + objc._C_ID + objc._C_BOOL)
        self.assertArgIsBlock(CoreText.CTFontManagerUnregisterFontURLs, 2, objc._C_BOOL + objc._C_ID + objc._C_BOOL)
