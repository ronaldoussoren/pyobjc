...
#
# Last update: Sun Mar 22 17:15:31 2020
#
# flake8: noqa
...
functions = {
    ...
    "CTFontManagerCompareFontFamilyNames": (
        sel32or64(
            b"l^{__CFString=}^{__CFString=}^v", b"q^{__CFString=}^{__CFString=}^v"
        ),
    ),
    ...
    "CTFontGetPlatformFont": (
        sel32or64(
            b"L^{__CTFont=}^^{__CTFontDescriptor}",
    ...
    "CTRunGetTypographicBounds": (
        sel32or64(
            b"d^{__CTRun=}{_CFRange=ll}^f^f^f", b"d^{__CTRun=}{_CFRange=qq}^d^d^d"
        ),
        "",
        {
            "arguments": {
