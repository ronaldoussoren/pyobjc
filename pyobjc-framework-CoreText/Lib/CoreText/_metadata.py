...
#
# Last update: Fri Aug  9 11:08:25 2019
...
misc.update(
    {
        "sfntInstance": objc.createStructType(
            "sfntInstance",
            sel32or64(b"{sfntInstance=ss[1l]}", b"{sfntInstance=ss[1i]}"),
            ["nameID", "flags", "coord"],
        ),
        "sfntFontDescriptor": objc.createStructType(
            "sfntFontDescriptor",
            sel32or64(b"{sfntFontDescriptor=Ll}", b"{sfntFontDescriptor=Ii}"),
            ["name", "value"],
        ),
        "sfntCMapExtendedSubHeader": objc.createStructType(
            "sfntCMapExtendedSubHeader",
            sel32or64(
                b"{sfntCMapExtendedSubHeader=SSLL}", b"{sfntCMapExtendedSubHeader=SSII}"
            ),
            ["format", "reserved", "length", "language"],
        ),
        "sfntVariationAxis": objc.createStructType(
            "sfntVariationAxis",
            sel32or64(b"{sfntVariationAxis=Llllss}", b"{sfntVariationAxis=Iiiiss}"),
            ["axisTag", "minValue", "defaultValue", "maxValue", "flags", "nameID"],
        ),
        "CTParagraphStyleSetting": objc.createStructType(
            "CTParagraphStyleSetting",
            sel32or64(
                b"{CTParagraphStyleSetting=IL^v}", b"{CTParagraphStyleSetting=IQ^v}"
            ),
        ...
        "sfntVariationHeader": objc.createStructType(
            "sfntVariationHeader",
            sel32or64(
                b"{sfntVariationHeader=lSSSSSS[1{sfntVariationAxis=Llllss}][1{sfntInstance=ss[1l]}]}",
        ...
        "sfntDescriptorHeader": objc.createStructType(
            ...
            sel32or64(
                b"{sfntDescriptorHeader=ll[1{sfntFontDescriptor=Ll}]}",
        ...
        "sfntDirectory": objc.createStructType(
            "sfntDirectory",
            sel32or64(
                b"{sfntDirectory=LSSSS[1{sfntDirectoryEntry=LLLL}]}",
        ...
        "sfntFeatureName": objc.createStructType(
            "sfntFeatureName",
            sel32or64(b"{sfntFeatureName=SSlSs}", b"{sfntFeatureName=SSiSs}"),
            ["featureType", "settingCount", "offsetToSettings", "featureFlags", "nameID"],
        ),
        "sfntDirectoryEntry": objc.createStructType(
            "sfntDirectoryEntry",
            sel32or64(b"{sfntDirectoryEntry=LLLL}", b"{sfntDirectoryEntry=IIII}"),
            ["tableTag", "checkSum", "offset", "length"],
        ),
        "sfntCMapEncoding": objc.createStructType(
            "sfntCMapEncoding",
            sel32or64(b"{sfntCMapEncoding=SSL}", b"{sfntCMapEncoding=SSI}"),
        ...
        "sfntFontRunFeature": objc.createStructType(
            "sfntFontRunFeature", b"{sfntFontRunFeature=SS}", ["featureType", "setting"]
        ),
        ...
        "sfntCMapHeader": objc.createStructType(
            "sfntCMapHeader",
            sel32or64(
                b"{sfntCMapHeader=SS[1{sfntCMapEncoding=SSL}]}",
        ...
        "FontVariation": objc.createStructType(
            "FontVariation",
            sel32or64(b"{FontVariation=Ll}", b"{FontVariation=Ii}"),
            ["name", "value"],
        ),
        "sfntFeatureHeader": objc.createStructType(
            "sfntFeatureHeader",
            sel32or64(
                b"{sfntFeatureHeader=lSSl[1{sfntFeatureName=SSlSs}][1{sfntFontFeatureSetting=Ss}][1{sfntFontRunFeature=SS}]}",
...
functions = {
    ...
    "CTFramesetterCreateFrame": (
        sel32or64(
            b"^{__CTFrame=}^{__CTFramesetter=}{_CFRange=ll}^{CGPath=}^{__CFDictionary=}",
            b"^{__CTFrame=}^{__CTFramesetter=}{_CFRange=qq}^{CGPath=}^{__CFDictionary=}",
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CTTypesetterSuggestClusterBreak": (
        sel32or64(b"l^{__CTTypesetter=}ld", b"q^{__CTTypesetter=}qd"),
    ),
    "CTFontCreateCopyWithFamily": (
        sel32or64(
            b"^{__CTFont=}^{__CTFont=}f^{CGAffineTransform=ffffff}^{__CFString=}",
    ...
    "CTFontGetGlyphsForCharacters": (
        sel32or64(b"B^{__CTFont=}^T^Sl", b"B^{__CTFont=}^T^Sq"),
        "",
        {
            "arguments": {
    ...
    "CTLineGetPenOffsetForFlush": (sel32or64(b"d^{__CTLine=}fd", b"d^{__CTLine=}dd"),),
    "CTTypesetterSuggestLineBreak": (
        sel32or64(b"l^{__CTTypesetter=}ld", b"q^{__CTTypesetter=}qd"),
    ),
    "CTFontCreateWithGraphicsFont": (
        sel32or64(
            b"^{__CTFont=}^{CGFont=}f^{CGAffineTransform=ffffff}^{__CTFontDescriptor=}",
    ...
    "CTRunGetStringRange": (
        sel32or64(b"{_CFRange=ll}^{__CTRun=}", b"{_CFRange=qq}^{__CTRun=}"),
    ),
    "CTFontCreateWithQuickdrawInstance": (
        sel32or64(b"^{__CTFont=}*sCf", b"^{__CTFont=}*sCd"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CTFontManagerCreateFontRequestRunLoopSource": (
        sel32or64(b"^{__CFRunLoopSource=}l@?", b"^{__CFRunLoopSource=}q@?"),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "CTRunDelegateGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "CTFontManagerCompareFontFamilyNames": (
        sel32or64(b"l^{__CFString=}^{__CFString=}^v", b"q^{__CFString=}^{__CFString=}^v"),
    ),
    "CTRubyAnnotationCreate": (
        sel32or64(
            b"^{__CTRubyAnnotation=}CCf[4^{__CFString=}]",
            b"^{__CTRubyAnnotation=}CCd[4^{__CFString=}]",
        ),
        "",
        {
            "retval": {"already_cfretained": True},
    ...
    "CTRunGetStringIndicesPtr": (
        sel32or64(b"r^i^{__CTRun=}", b"r^q^{__CTRun=}"),
        "",
        {"retval": {"c_array_of_variable_length": True}},
    ),
    "CTFontGetAscent": (sel32or64(b"f^{__CTFont=}", b"d^{__CTFont=}"),),
    ...
    "CTTypesetterCreateLine": (
        sel32or64(
            b"^{__CTLine=}^{__CTTypesetter=}{_CFRange=ll}",
            b"^{__CTLine=}^{__CTTypesetter=}{_CFRange=qq}",
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CTFontGetDescent": (sel32or64(b"f^{__CTFont=}", b"d^{__CTFont=}"),),
    "CTFontCreateWithFontDescriptor": (
        sel32or64(
            b"^{__CTFont=}^{__CTFontDescriptor=}f^{CGAffineTransform=ffffff}",
    ...
    "CTFontGetVerticalTranslationsForGlyphs": (
        sel32or64(b"v^{__CTFont=}^S^{_NSSize=ff}l", b"v^{__CTFont=}^S^{CGSize=dd}q"),
        "",
        {
            "arguments": {
                1: {"c_array_length_in_arg": 3, "type_modifier": "n"},
    ...
    "CTFontGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "CTFontCreatePathForGlyph": (
        sel32or64(
            b"^{CGPath=}^{__CTFont=}S^{CGAffineTransform=ffffff}",
    ...
    "CTRunGetBaseAdvancesAndOrigins": (
        b"v^{__CTRun=}{_CFRange=qq}^{CGSize=dd}^{CGPoint=dd}",
        "",
        {
            "arguments": {
    ...
    "CTFontGetOpticalBoundsForGlyphs": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}^{__CTFont=}^S^{_NSRect={_NSPoint=ff}{_NSSize=ff}}lL",
    ...
    "CTFontCreateWithFontDescriptorAndOptions": (
        sel32or64(
            b"^{__CTFont=}^{__CTFontDescriptor=}f^{CGAffineTransform=ffffff}L",
    ...
    "CTFontGetMatrix": (
        sel32or64(
            b"{CGAffineTransform=ffffff}^{__CTFont=}",
    ...
    "CTFontCreateCopyWithAttributes": (
        sel32or64(
            b"^{__CTFont=}^{__CTFont=}f^{CGAffineTransform=ffffff}^{__CTFontDescriptor=}",
    ...
    "CTRubyAnnotationGetSizeFactor": (
        sel32or64(b"f^{__CTRubyAnnotation=}", b"d^{__CTRubyAnnotation=}"),
    ),
    ...
    "CTGlyphInfoGetTypeID": (sel32or64(b"L", b"Q"),),
    "CTParagraphStyleCreate": (
        sel32or64(
            b"^{__CTParagraphStyle=}^{CTParagraphStyleSetting=II^v}L",
    ...
    "CTRunGetImageBounds": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}^{__CTRun=}^{CGContext=}{_CFRange=ll}",
            b"{CGRect={CGPoint=dd}{CGSize=dd}}^{__CTRun=}^{CGContext=}{_CFRange=qq}",
        ),
    ),
    "CTFontManagerIsSupportedFont": (b"B^{__CFURL=}",),
    "CTRunGetAdvancesPtr": (
        sel32or64(b"^{CGSize=ff}^{__CTRun=}", b"^{CGSize=dd}^{__CTRun=}"),
        "",
        {"retval": {"c_array_of_variable_length": True}},
    ),
    ...
    "CTFontCollectionSetExclusionDescriptors": (b"v^{__CTFontCollection=}^{__CFArray=}",),
    ...
    "CTFrameGetTypeID": (sel32or64(b"L", b"Q"),),
    "CTFramesetterGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "CTFontDrawGlyphs": (
        sel32or64(
            b"v^{__CTFont=}^S^{CGPoint=ff}L^{CGContext=}",
    ...
    "CTFontGetGlyphCount": (sel32or64(b"l^{__CTFont=}", b"q^{__CTFont=}"),),
    ...
    "CTFontGetBoundingRectsForGlyphs": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}^{__CTFont=}I^S^{_NSRect={_NSPoint=ff}{_NSSize=ff}}l",
    ...
    "CTFontGetBoundingBox": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}^{__CTFont=}",
    ...
    "CTLineGetImageBounds": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}^{__CTLine=}^{CGContext=}",
    ...
    "CTFontGetAdvancesForGlyphs": (
        sel32or64(b"d^{__CTFont=}I^S^{_NSSize=ff}l", b"d^{__CTFont=}I^S^{CGSize=dd}q"),
        "",
        {
            "arguments": {
                2: {"c_array_length_in_arg": 4, "type_modifier": "n"},
    ...
    "CTFontCreateWithPlatformFont": (
        sel32or64(
            b"^{__CTFont=}Lf^{CGAffineTransform=ffffff}^{__CTFontDescriptor=}",
    ...
    "CTFontCreateForStringWithLanguage": (
        b"^{__CTFont=}^{__CTFont=}^{__CFString=}{_CFRange=qq}^{__CFString=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CTTypesetterSuggestClusterBreakWithOffset": (
        sel32or64(b"l^{__CTTypesetter=}ldd", b"q^{__CTTypesetter=}qdd"),
    ),
    "CTRunGetTypeID": (sel32or64(b"L", b"Q"),),
    "CTRubyAnnotationGetTextForPosition": (b"^{__CFString=}^{__CTRubyAnnotation=}C",),
    "CTLineGetTypographicBounds": (
        sel32or64(b"d^{__CTLine=}^f^f^f", b"d^{__CTLine=}^d^d^d"),
        "",
        {
            "arguments": {
                1: {"type_modifier": "o"},
    ...
    "CTFontGetPlatformFont": (
        sel32or64(
            b"L^{__CTFont=}^^{__CTFontDescriptor}", b"I^{__CTFont=}^^{__CTFontDescriptor}"
        ),
        "",
    ...
    "CTFontCopyTable": (
        sel32or64(b"^{__CFData=}^{__CTFont=}LI", b"^{__CFData=}^{__CTFont=}II"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CTFontGetStringEncoding": (sel32or64(b"L^{__CTFont=}", b"I^{__CTFont=}"),),
    "CTRunGetStringIndices": (
        sel32or64(b"v^{__CTRun=}{_CFRange=ll}^l", b"v^{__CTRun=}{_CFRange=qq}^q"),
        "",
        {"arguments": {2: {"c_array_length_in_arg": 1, "type_modifier": "o"}}},
    ),
    "CTRunGetAdvances": (
        sel32or64(
            b"v^{__CTRun=}{_CFRange=ll}^{_NSSize=ff}",
            b"v^{__CTRun=}{_CFRange=qq}^{CGSize=dd}",
        ),
        "",
        {"arguments": {2: {"c_array_length_in_arg": 1, "type_modifier": "o"}}},
    ),
    ...
    "CTParagraphStyleGetValueForSpecifier": (
        sel32or64(b"B^{__CTParagraphStyle=}IL^v", b"B^{__CTParagraphStyle=}IQ^v"),
        "",
        {"arguments": {3: {"c_array_length_in_arg": 2, "type_modifier": "o"}}},
    ),
    "CTLineGetOffsetForStringIndex": (
        sel32or64(b"f^{__CTLine=}l^f", b"d^{__CTLine=}q^d"),
        "",
    ...
    "CTFontGetSize": (sel32or64(b"f^{__CTFont=}", b"d^{__CTFont=}"),),
    "CTFontCollectionGetTypeID": (sel32or64(b"L", b"Q"),),
    "CTFontGetGlyphWithName": (b"S^{__CTFont=}^{__CFString=}",),
    "CTLineGetGlyphRuns": (b"^{__CFArray=}^{__CTLine=}",),
    "CTFontCreateWithNameAndOptions": (
        sel32or64(
            b"^{__CTFont=}^{__CFString=}f^{CGAffineTransform=ffffff}L",
    ...
    "CTFontGetCapHeight": (sel32or64(b"f^{__CTFont=}", b"d^{__CTFont=}"),),
    "CTFontGetUnderlineThickness": (sel32or64(b"f^{__CTFont=}", b"d^{__CTFont=}"),),
    ...
    "CTLineGetGlyphCount": (sel32or64(b"l^{__CTLine=}", b"q^{__CTLine=}"),),
    ...
    "CTRubyAnnotationGetTypeID": (sel32or64(b"L", b"Q"),),
    "CTTypesetterGetTypeID": (sel32or64(b"L", b"Q"),),
    "CTRunGetTextMatrix": (
        sel32or64(
            b"{CGAffineTransform=ffffff}^{__CTRun=}",
            b"{CGAffineTransform=dddddd}^{__CTRun=}",
        ),
    ),
    "CTFontGetLigatureCaretPositions": (
        sel32or64(b"l^{__CTFont=}S^fl", b"q^{__CTFont=}S^dq"),
        "",
    ...
    "CTFontDescriptorCreateWithNameAndSize": (
        sel32or64(
            b"^{__CTFontDescriptor=}^{__CFString=}f",
    ...
    "CTLineGetStringRange": (
        sel32or64(b"{_CFRange=ll}^{__CTLine=}", b"{_CFRange=qq}^{__CTLine=}"),
    ),
    ...
    "CTLineCreateJustifiedLine": (
        sel32or64(b"^{__CTLine=}^{__CTLine=}fd", b"^{__CTLine=}^{__CTLine=}dd"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CTRunGetGlyphCount": (sel32or64(b"l^{__CTRun=}", b"q^{__CTRun=}"),),
    ...
    "CTFrameGetStringRange": (
        sel32or64(b"{_CFRange=ll}^{__CTFrame=}", b"{_CFRange=qq}^{__CTFrame=}"),
    ),
    "CTFrameGetLineOrigins": (
        sel32or64(
            b"v^{__CTFrame=}{_CFRange=ll}^{_NSPoint=ff}",
            b"v^{__CTFrame=}{_CFRange=qq}^{CGPoint=dd}",
        ),
        "",
        {"arguments": {2: {"c_array_length_in_arg": 1, "type_modifier": "o"}}},
    ),
    "CTFontCreateWithName": (
        sel32or64(
            b"^{__CTFont=}^{__CFString=}f^{CGAffineTransform=ffffff}",
    ...
    "CTLineGetBoundsWithOptions": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}^{__CTLine=}L",
            b"{CGRect={CGPoint=dd}{CGSize=dd}}^{__CTLine=}Q",
        ),
    ),
    ...
    "CTFontGetXHeight": (sel32or64(b"f^{__CTFont=}", b"d^{__CTFont=}"),),
    "CTRunGetPositions": (
        sel32or64(
            b"v^{__CTRun=}{_CFRange=ll}^{_NSPoint=ff}",
            b"v^{__CTRun=}{_CFRange=qq}^{CGPoint=dd}",
        ),
        "",
        {"arguments": {2: {"c_array_length_in_arg": 1, "type_modifier": "o"}}},
    ),
    "CTFontDescriptorCreateCopyWithVariation": (
        sel32or64(
            b"^{__CTFontDescriptor=}^{__CTFontDescriptor=}^{__CFNumber=}f",
    ...
    "CTFontDescriptorGetTypeID": (sel32or64(b"L", b"Q"),),
    "CTFontCollectionCreateMatchingFontDescriptors": (
        b"^{__CFArray=}^{__CTFontCollection=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CTTextTabGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "CTFontCreateCopyWithSymbolicTraits": (
        sel32or64(
            b"^{__CTFont=}^{__CTFont=}f^{CGAffineTransform=ffffff}II",
    ...
    "CTRunDraw": (
        sel32or64(
            b"v^{__CTRun=}^{CGContext=}{_CFRange=ll}",
            b"v^{__CTRun=}^{CGContext=}{_CFRange=qq}",
        ),
    ),
    "CTLineGetStringIndexForPosition": (
        sel32or64(b"l^{__CTLine=}{CGPoint=ff}", b"q^{__CTLine=}{CGPoint=dd}"),
    ),
    ...
    "CTFontGetLeading": (sel32or64(b"f^{__CTFont=}", b"d^{__CTFont=}"),),
    "CTRunGetGlyphs": (
        sel32or64(b"v^{__CTRun=}{_CFRange=ll}^S", b"v^{__CTRun=}{_CFRange=qq}^S"),
        "",
        {"arguments": {2: {"c_array_length_in_arg": 1, "type_modifier": "o"}}},
    ),
    ...
    "CTRunDelegateCreate": (
        sel32or64(
            b"^{__CTRunDelegate=}^{_CTRunDelegateCallbacks=l^?^?^?^?}^v",
            b"^{__CTRunDelegate=}^{_CTRunDelegateCallbacks=q^?^?^?^?}^v",
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CTTypesetterCreateLineWithOffset": (
        sel32or64(
            b"^{__CTLine=}^{__CTTypesetter=}{_CFRange=ll}d",
            b"^{__CTLine=}^{__CTTypesetter=}{_CFRange=qq}d",
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CTFontGetUnderlinePosition": (sel32or64(b"f^{__CTFont=}", b"d^{__CTFont=}"),),
    "CTRunGetTypographicBounds": (
        sel32or64(b"d^{__CTRun=}{_CFRange=ll}^f^f^f", b"d^{__CTRun=}{_CFRange=qq}^d^d^d"),
        "",
        {
            "arguments": {
                2: {"type_modifier": "o"},
    ...
    "CTFontGetSlantAngle": (sel32or64(b"f^{__CTFont=}", b"d^{__CTFont=}"),),
    "CTFramesetterSuggestFrameSizeWithConstraints": (
        sel32or64(
            b"{CGSize=ff}^{__CTTypesetter=}{_CFRange=ll}@{CGSize=ff}^{_CFRange=ll}",
            b"{CGSize=dd}^{__CTTypesetter=}{_CFRange=qq}@{CGSize=dd}^{_CFRange=qq}",
        ),
        "",
    ...
    "CTFontCreateForString": (
        sel32or64(
            b"^{__CTFont=}^{__CTFont=}^{__CFString=}{_CFRange=ll}",
            b"^{__CTFont=}^{__CTFont=}^{__CFString=}{_CFRange=qq}",
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CTGlyphInfoGetGlyphName": (b"^{__CFString=}^{__CTGlyphInfo=}",),
    "CTParagraphStyleGetTypeID": (sel32or64(b"L", b"Q"),),
    "CTFontCreateUIFontForLanguage": (
        sel32or64(b"^{__CTFont=}If^{__CFString=}", b"^{__CTFont=}Id^{__CFString=}"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CTLineGetTypeID": (sel32or64(b"L", b"Q"),),
    "CTRunGetPositionsPtr": (
        sel32or64(b"r^{_NSPoint=ff}^{__CTRun=}", b"r^{CGPoint=dd}^{__CTRun=}"),
        "",
        {"retval": {"c_array_of_variable_length": True}},
    ),
}
...
cftypes = [
    ...
    ("CTParagraphStyleRef", b"^{__CTParagraphStyle=}", "CTParagraphStyleGetTypeID", None),
