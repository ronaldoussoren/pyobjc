...
functions = {
    ...
    "CTFramesetterCreateWithTypesetter": (
        b"^{__CTFramesetter=}^{__CTTypesetter=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CTTextTabCreate": (
    ...
    "CTFramesetterSuggestFrameSizeWithConstraints": (
        b"{CGSize=dd}^{__CTFramesetter=}{CFRange=qq}^{__CFDictionary=}{CGSize=dd}^{CFRange=qq}",
        "",
