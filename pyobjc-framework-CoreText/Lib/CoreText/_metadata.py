...
#
# Last update: Sun Jun 28 11:05:25 2020
#
# flake8: noqa
...
misc.update(
    {
        ...
        "sfntFontDescriptor": objc.createStructType(
            "sfntFontDescriptor", b"{sfntFontDescriptor=Ii}", ["name", "value"]
        ),
        ...
        "FontVariation": objc.createStructType(
            "FontVariation", b"{FontVariation=Ii}", ["name", "value"]
        ),
...
functions = {
    ...
    "CTLineGetStringRange": (b"{_CFRange=qq}^{__CTLine=}",),
    ...
    "CTFrameGetStringRange": (b"{_CFRange=qq}^{__CTFrame=}",),
    ...
    "CTFrameGetVisibleStringRange": (b"{_CFRange=qq}^{__CTFrame=}",),
