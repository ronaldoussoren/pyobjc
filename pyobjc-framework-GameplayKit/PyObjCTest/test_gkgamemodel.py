...
if sys.maxsize >= 2 ** 32:
    ...
    class TestGKGameModelHelper (GameplayKit.NSObject):
        ...
        def setValue_(self, v): pass

        def playerId(self): return 1
        def setPlayerId_(self, v): pass

        def scoreForPlayer_(self, p): return 1
        def isWinForPlayer_(self, p): return 1
        def isLossForPlayer_(self, p): return 1
