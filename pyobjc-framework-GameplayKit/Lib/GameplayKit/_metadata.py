...
#
# Last update: Fri Jun 12 15:10:27 2026
#
# flake8: noqa
...
try:
    ...
    r(
        ...
        b"addElement:withBox:",
        {
            ...
            "arguments": {2: {"type": "@"}, 3: {"type": b"{GKBox=<3f><3f>}"}},
        },
    )
    r(
        b"GKOctree",
    ...
    r(b"GKQuadtree", b"addElement:withBox:", {"arguments": {2: {"type": "@"}}})
    r(
        b"GKQuadtree",
        b"addElement:withPoint:",
        {
            "full_signature": b"@@:@<2f>",
            "arguments": {2: {"type": "@"}, 3: {"type": b"<2f>"}},
        },
    )
    r(
        b"GKQuadtree",
        b"addElement:withQuad:",
        {
            ...
            "arguments": {2: {"type": "@"}, 3: {"type": b"{GKQuad=<2f><2f>}"}},
        },
    )
    r(
        b"GKQuadtree",
    ...
    r(
        ...
        b"addElement:boundingRectMin:boundingRectMax:splitStrategy:",
        {
            ...
            "arguments": {2: {"type": "@"}, 3: {"type": b"<2f>"}, 4: {"type": b"<2f>"}},
        },
    )
    r(
        b"GKRTree",
...
objc.registerNewKeywordsFromSelector("GKARC4RandomSource", b"init")
...
objc.registerNewKeywordsFromSelector("GKEntity", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("GKLinearCongruentialRandomSource", b"init")
objc.registerNewKeywordsFromSelector(
    "GKLinearCongruentialRandomSource", b"initWithSeed:"
)
objc.registerNewKeywordsFromSelector("GKMersenneTwisterRandomSource", b"init")
...
objc.registerNewKeywordsFromSelector("GKNoise", b"init")
...
objc.registerNewKeywordsFromSelector("GKNoiseMap", b"init")
...
objc.registerNewKeywordsFromSelector("GKRandomSource", b"init")
...
objc.registerNewKeywordsFromSelector("GKRuleSystem", b"init")
...
objc.registerNewKeywordsFromSelector("GKState", b"init")
...
objc.registerNewKeywords("GKBehavior", ("goal", "weight"), "behaviorWithGoal_weight_")
objc.registerNewKeywords("GKBehavior", ("goals",), "behaviorWithGoals_")
objc.registerNewKeywords(
    "GKBehavior", ("goals", "andWeights"), "behaviorWithGoals_andWeights_"
)
objc.registerNewKeywords("GKBehavior", ("weightedGoals",), "behaviorWithWeightedGoals_")
objc.registerNewKeywords(
    "GKCompositeBehavior", ("behaviors",), "behaviorWithBehaviors_"
)
objc.registerNewKeywords(
    "GKCompositeBehavior",
    ("behaviors", "andWeights"),
    "behaviorWithBehaviors_andWeights_",
)
objc.registerNewKeywords(
    "GKGoal",
    ("agents", "maxDistance", "maxAngle"),
...
objc.registerNewKeywords(
    "GKNoise",
    ("componentNoises", "selectionNoise"),
    "noiseWithComponentNoises_selectionNoise_",
)
objc.registerNewKeywords(
    "GKNoise",
    (
        ...
        "selectionNoise",
        "componentBoundaries",
        "boundaryBlendDistances",
    ),
    "noiseWithComponentNoises_selectionNoise_componentBoundaries_boundaryBlendDistances_",
)
objc.registerNewKeywords(
    "GKRandomDistribution", ("sideCount",), "distributionForDieWithSideCount_"
)
objc.registerNewKeywords(
...
objc.registerNewKeywords(
    "GKRule", ("blockPredicate", "action"), "ruleWithBlockPredicate_action_"
)
objc.registerNewKeywords(
    "GKRule",
    ("predicate", "assertingFact", "grade"),
    "ruleWithPredicate_assertingFact_grade_",
)
objc.registerNewKeywords(
    "GKRule",
    ("predicate", "retractingFact", "grade"),
    "ruleWithPredicate_retractingFact_grade_",
)
objc.registerNewKeywords("GKScene", ("fileNamed",), "sceneWithFileNamed_")
objc.registerNewKeywords(
    "GKScene", ("fileNamed", "rootNode"), "sceneWithFileNamed_rootNode_"
)
objc.registerNewKeywords("SKTexture", ("noiseMap",), "textureWithNoiseMap_")
expressions = {}
formal_protocols = {
    "GKAgentDelegate": "GKAgentDelegate",
    "GKGameModel": "GKGameModel",
    "GKGameModelPlayer": "GKGameModelPlayer",
    "GKGameModelUpdate": "GKGameModelUpdate",
    "GKRandom": "GKRandom",
    "GKSceneRootNodeType": "GKSceneRootNodeType",
    "GKStrategist": "GKStrategist",
}
