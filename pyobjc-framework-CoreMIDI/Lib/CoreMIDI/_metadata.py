...
objc.registerNewKeywordsFromSelector("MIDI2DeviceInfo", b"init")
objc.registerNewKeywordsFromSelector(
    "MIDI2DeviceInfo", b"initWithManufacturerID:family:modelNumber:revisionLevel:"
)
objc.registerNewKeywordsFromSelector("MIDICIDevice", b"init")
objc.registerNewKeywordsFromSelector("MIDICIDeviceInfo", b"init")
objc.registerNewKeywordsFromSelector(
    "MIDICIDeviceInfo", b"initWithDestination:manufacturer:family:model:revision:"
)
objc.registerNewKeywordsFromSelector("MIDICIDiscoveredNode", b"init")
objc.registerNewKeywordsFromSelector("MIDICIProfile", b"init")
...
objc.registerNewKeywordsFromSelector("MIDICIProfileState", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("MIDICIResponder", b"init")
objc.registerNewKeywordsFromSelector(
    "MIDICIResponder",
    b"initWithDeviceInfo:profileDelegate:profileStates:supportProperties:",
)
objc.registerNewKeywordsFromSelector("MIDICISession", b"init")
objc.registerNewKeywordsFromSelector(
    "MIDICISession", b"initWithDiscoveredNode:dataReadyHandler:disconnectHandler:"
)
objc.registerNewKeywordsFromSelector("MIDIUMPCIProfile", b"init")
objc.registerNewKeywordsFromSelector("MIDIUMPEndpoint", b"init")
objc.registerNewKeywordsFromSelector("MIDIUMPFunctionBlock", b"init")
objc.registerNewKeywordsFromSelector(
    "MIDIUMPMutableEndpoint",
    b"initWithName:deviceInfo:productInstanceID:MIDIProtocol:destinationCallback:",
)
objc.registerNewKeywordsFromSelector("MIDIUMPMutableFunctionBlock", b"init")
objc.registerNewKeywordsFromSelector(
    "MIDIUMPMutableFunctionBlock",
    b"initWithName:direction:firstGroup:totalGroupsSpanned:maxSysEx8Streams:MIDI1Info:UIHint:isEnabled:",
)

objc.registerNewKeywords("MIDINetworkConnection", ("host",), "connectionWithHost_")
objc.registerNewKeywords(
    "MIDINetworkHost", ("name", "address", "port"), "hostWithName_address_port_"
)
objc.registerNewKeywords(
    "MIDINetworkHost",
...
objc.registerNewKeywords(
    "MIDINetworkHost", ("name", "netService"), "hostWithName_netService_"
)
expressions = {}
formal_protocols = {
    "MIDICIProfileResponderDelegate": "MIDICIProfileResponderDelegate",
}
