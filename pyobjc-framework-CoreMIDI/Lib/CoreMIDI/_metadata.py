...
functions = {
    ...
    "MIDISetupFromData": (b"i^{__CFData=}^I",),
    "MIDIGetSerialPortDrivers": (b"i^^{__CFArray=}",),
    ...
    "MIDIDeviceNewEntity": (b"iI^{__CFString=}iZQQ^I",),
    ...
    "MIDIDeviceAddEntity": (b"iI^{__CFString=}ZQQ^I",),
    "MIDIThruConnectionFind": (b"i^{__CFString=}^^{__CFData=}",),
    ...
    "MIDIEndpointGetRefCons": (b"iI^^v^^v",),
    "MIDIRestart": (b"i",),
    ...
    "MIDIThruConnectionGetParams": (b"iI^^{__CFData=}",),
    ...
    "MIDIGetSerialPortOwner": (b"i^{__CFString=}^^{__CFString=}",),
    "MIDIGetDevice": (b"IQ",),
