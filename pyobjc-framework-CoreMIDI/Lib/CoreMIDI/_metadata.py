...
#
# Last update: Sun Nov 15 11:17:23 2020
#
# flake8: noqa
...
misc.update(
    {
        ...
        "MIDIMessage_96": objc.createStructType(
            "MIDIMessage_96", b"{MIDIMessage_96=III}", ["word0", "word1", "word2"]
        ),
        ...
        "MIDIMessage_64": objc.createStructType(
            "MIDIMessage_64", b"{MIDIMessage_64=II}", ["word0", "word1"]
        ),
