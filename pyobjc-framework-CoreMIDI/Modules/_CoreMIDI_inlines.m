...
static PyObjC_function_map function_map[] = {
    ...
    {"MIDI2EndpointDiscoveryMessage",
     (PyObjC_Function_Pointer)&MIDI2EndpointDiscoveryMessage},
    {"MIDI2EndpointInfoNotificationMessage",
     (PyObjC_Function_Pointer)&MIDI2EndpointInfoNotificationMessage},
    {"MIDI2EndpointDeviceIdentityNotificationMessage",
     (PyObjC_Function_Pointer)&MIDI2EndpointDeviceIdentityNotificationMessage},
    {"MIDI2EndpointNameNotificationMessage",
     (PyObjC_Function_Pointer)&MIDI2EndpointNameNotificationMessage},
    {"MIDI2EndpointProductInstanceIDNotificationMessage",
     (PyObjC_Function_Pointer)&MIDI2EndpointProductInstanceIDNotificationMessage},
    {"MIDI2StreamConfigurationRequestMessage",
     (PyObjC_Function_Pointer)&MIDI2StreamConfigurationRequestMessage},
    {"MIDI2StreamConfigurationNotificationMessage",
     (PyObjC_Function_Pointer)&MIDI2StreamConfigurationNotificationMessage},
    {"MIDI2FunctionBlockDiscoveryMessage",
     (PyObjC_Function_Pointer)&MIDI2FunctionBlockDiscoveryMessage},
    {"MIDI2FunctionBlockInfoNotificationMessage",
     (PyObjC_Function_Pointer)&MIDI2FunctionBlockInfoNotificationMessage},
    {"MIDI2FunctionBlockNameNotificationMessage",
     (PyObjC_Function_Pointer)&MIDI2FunctionBlockNameNotificationMessage},
    ...
    {"MIDIJitterReductionClockMessage",
     (PyObjC_Function_Pointer)&MIDIJitterReductionClockMessage},
    {"MIDIJitterReductionTimestampMessage",
     (PyObjC_Function_Pointer)&MIDIJitterReductionTimestampMessage},
    {"MIDIDeltaClockstampTicksPerQuarterNoteMessage",
     (PyObjC_Function_Pointer)&MIDIDeltaClockstampTicksPerQuarterNoteMessage},
    {"MIDITicksSinceLastEventMessage",
     (PyObjC_Function_Pointer)&MIDITicksSinceLastEventMessage},
