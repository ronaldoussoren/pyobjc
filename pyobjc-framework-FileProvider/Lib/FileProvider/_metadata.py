...
try:
    ...
    r(
        b"NSFileProviderManager",
        b"signalResolvedForError:completionHandler:",
        {
            "arguments": {
                3: {
                    "callable": {
    ...
    r(
        b"NSObject",
        b"itemForIdentifier:completionHandler:",
        {
            "required": True,
            "retval": {"type": b"@"},
            "arguments": {
    ...
    r(
        b"NSObject",
        b"modifyItem:baseVersion:changedFields:contents:options:completionHandler:",
        {
            "required": True,
            "retval": {"type": b"@"},
            "arguments": {
