...
class TestNSFileProviderExtension(TestCase):
    ...
    def test_methods(self):
        ...
        self.assertArgIsBlock(FileProvider.NSFileProviderExtension.providePlaceholderAtURL_completionHandler_, 1, b'v@')
        self.assertArgIsBlock(FileProvider.NSFileProviderExtension.startProvidingItemAtURL_completionHandler_, 1, b'v@')
