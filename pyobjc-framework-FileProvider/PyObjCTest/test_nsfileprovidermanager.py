...
class TestNSFileProviderManager(TestCase):
    ...
    def test_methods10_15(self):
        ...
        self.assertArgIsBlock(
            FileProvider.NSFileProviderManager.getUserVisibleURLForItemIdentifier_completionHandler_,
            1,
            b"v@@",
        )
        self.assertArgIsBlock(
            FileProvider.NSFileProviderManager.getIdentifierForUserVisibleFileAtURL_completionHandler_,
            1,
            b"v@@@",
        )
        ...
        self.assertArgIsBlock(
            FileProvider.NSFileProviderManager.setDownloadPolicy_forItemWithIdentifier_completionHandler_,
            2,
            b"v@",
        )
        self.assertArgIsBlock(
