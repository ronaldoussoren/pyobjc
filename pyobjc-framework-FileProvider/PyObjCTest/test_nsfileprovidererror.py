...
class TestNSFileProviderError(TestCase):
    def test_constants(self):
        ...
        self.assertEqual(FileProvider.NSFileProviderErrorOlderExtensionVersionRunning, -2003)
        self.assertEqual(FileProvider.NSFileProviderErrorNewerExtensionVersionFound, -2004)
