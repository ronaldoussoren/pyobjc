...
class TestNSFileProviderReplicatedExtensionHelper(FileProvider.NSObject):
    ...
    def fetchContentsForItemWithIdentifier_version_usingExistingContentsAtURL_request_completionHandler_(self, a, b, c, d, e):
        return 1

    def supportedServiceSourcesForItemIdentifier_completionHandler_(self, a, b):
        return 1

    def performActionWithIdentifier_onItemsWithIdentifiers_completionHandler_(self, a, b, c):
        return 1
...
class TestNSFileProviderReplicatedExtension(TestCase):
    ...
    def test_methods(self):
        ...
        self.assertArgIsBlock(
            TestNSFileProviderReplicatedExtensionHelper.fetchContentsForItemWithIdentifier_version_usingExistingContentsAtURL_request_completionHandler_,
            4,
            b"v@@@",
        )
