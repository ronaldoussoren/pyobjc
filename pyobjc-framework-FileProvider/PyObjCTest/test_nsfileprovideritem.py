...
class TestNSFileProviderItemHelper (FileProvider.NSObject):
    def isUserReadable(self): return 1
    ...
    def isDownloading(self): return 1
    def isExcludedFromSync(self): return 1
    def isMostRecentVersionDownloaded(self): return 1
    def isShared(self): return 1
    def isSharedByCurrentUser(self): return 1
...
class TestNSFileProviderItem (TestCase):
    def test_constants(self):
        ...
        self.assertEqual(FileProvider.NSFileProviderItemCapabilitiesAllowsReparenting, 1 << 2)
        self.assertEqual(FileProvider.NSFileProviderItemCapabilitiesAllowsRenaming, 1 << 3)
        self.assertEqual(FileProvider.NSFileProviderItemCapabilitiesAllowsTrashing, 1 << 4)
        self.assertEqual(FileProvider.NSFileProviderItemCapabilitiesAllowsDeleting, 1 << 5)
        self.assertEqual(FileProvider.NSFileProviderItemCapabilitiesAllowsAddingSubItems, FileProvider.NSFileProviderItemCapabilitiesAllowsWriting)
        self.assertEqual(FileProvider.NSFileProviderItemCapabilitiesAllowsContentEnumerating, FileProvider.NSFileProviderItemCapabilitiesAllowsReading)
        self.assertEqual(FileProvider.NSFileProviderItemCapabilitiesAllowsAll,
    ...
    def test_methods(self):
        ...
        self.assertResultIsBOOL(TestNSFileProviderItemHelper.isMostRecentVersionDownloaded)
