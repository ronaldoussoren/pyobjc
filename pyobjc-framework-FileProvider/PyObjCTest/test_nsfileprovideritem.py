...
class TestNSFileProviderItem(TestCase):
    def test_constants(self):
        ...
        self.assertIsInstance(FileProvider.NSFileProviderWorkingSetContainerItemIdentifier, str)
        self.assertIsInstance(FileProvider.NSFileProviderTrashContainerItemIdentifier, str)
    ...
    def test_methods(self):
        self.assertResultHasType(TestNSFileProviderItemHelper.capabilities, objc._C_NSUInteger)
        self.assertResultHasType(TestNSFileProviderItemHelper.fileSystemFlags, objc._C_NSUInteger)
