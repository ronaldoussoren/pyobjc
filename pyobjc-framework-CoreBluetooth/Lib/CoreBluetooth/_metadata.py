...
misc.update(
    {
        ...
        "CBChannelSoundingSessionConfigurationRole": NewType(
            "CBChannelSoundingSessionConfigurationRole", int
        ),
...
try:
    ...
    r(
        b"NSObject",
        b"peripheral:didCompleteChannelSoundingSession:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}},
    ...
    r(
        b"NSObject",
        b"peripheral:didReceiveChannelSoundingProcedureResults:error:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}, 4: {"type": b"@"}},
...
objc.registerNewKeywordsFromSelector("CBChannelSoundingProcedureResults", b"init")
objc.registerNewKeywordsFromSelector("CBChannelSoundingSessionConfiguration", b"init")
objc.registerNewKeywordsFromSelector(
    "CBChannelSoundingSessionConfiguration", b"initWithRole:"
)
...
formal_protocols = {
    ...
    "CBPeripheralDelegate": "CBPeripheralDelegate",
    "CBPeripheralManagerDelegate": "CBPeripheralManagerDelegate",
}
