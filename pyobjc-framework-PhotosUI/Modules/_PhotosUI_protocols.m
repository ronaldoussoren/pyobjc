...
static void __attribute__((__used__)) use_protocols(void)
{
    ...
    p = PyObjC_IdToPython(@protocol(PHProjectTypeDescriptionDataSource)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(PHProjectTypeDescriptionInvalidator)); Py_XDECREF(p);
