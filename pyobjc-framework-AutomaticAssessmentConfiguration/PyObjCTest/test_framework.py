...
class TestAEAssessmentSessionDelegateHelper (AutomaticAssessmentConfiguration.NSObject):
    def assessmentSessionDidBegin_(self, a): pass
    def assessmentSessionDidFailToBegin_error_(self, a, b): pass
    def assessmentSessionDidInterrupt_error_(self, a, b): pass
    def assessmentSessionDidEnd_(self, a): pass
