...
#
# Last update: Sun Jun 12 21:52:10 2022
#
# flake8: noqa
...
misc = {}
constants = """$LAErrorDomain$LARightDidBecomeAuthorizedNotification$LARightDidBecomeUnauthorizedNotification$LATouchIDAuthenticationMaximumAllowableReuseDuration@d$"""
...
try:
    ...
    r(
        b"null",
        b"evaluateRight:localizedReason:reply:",
        {
            "arguments": {
                4: {
                    "callable": {
