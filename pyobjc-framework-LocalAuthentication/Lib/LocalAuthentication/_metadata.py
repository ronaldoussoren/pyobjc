...
#
# Last update: Sun Jul  2 12:59:43 2017
...
try:
    ...
    r(b'LAContext', b'withCurrentContextExecute:queue:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
finally:
