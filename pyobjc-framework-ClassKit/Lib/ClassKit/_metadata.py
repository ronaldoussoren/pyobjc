...
try:
    ...
    r(
        b"CLSDataStore",
        b"checkIsAssignedDocument:completion:",
        {
            "arguments": {
                3: {
                    "callable": {
...
objc.registerNewKeywordsFromSelector("CLSActivityItem", b"init")
objc.registerNewKeywordsFromSelector("CLSBinaryItem", b"initWithIdentifier:title:type:")
objc.registerNewKeywordsFromSelector("CLSContext", b"init")
objc.registerNewKeywordsFromSelector("CLSContext", b"initWithType:identifier:title:")
objc.registerNewKeywordsFromSelector("CLSDataStore", b"init")
objc.registerNewKeywordsFromSelector("CLSObject", b"init")
objc.registerNewKeywordsFromSelector(
    "CLSProgressReportingCapability", b"initWithKind:details:"
)
objc.registerNewKeywordsFromSelector("CLSQuantityItem", b"initWithIdentifier:title:")
objc.registerNewKeywordsFromSelector(
    "CLSScoreItem", b"initWithIdentifier:title:score:maxScore:"
)
expressions = {}
formal_protocols = {
    "CLSContextProvider": "CLSContextProvider",
    "CLSDataStoreDelegate": "CLSDataStoreDelegate",
}
