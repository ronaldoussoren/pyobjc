...
class TestDVDPlayback (TestCase):
    def testConstants(self):
        ...
        self.assertEqual(DVDPlayback.kDVDSubpictureExtensionCodeClosedCaptionNormalSize, 5)
        self.assertEqual(DVDPlayback.kDVDSubpictureExtensionCodeClosedCaptionBiggerSize, 6)
        ...
        self.assertEqual(DVDPlayback.kDVDSubpictureExtensionDirectorsCommentNormalSize, 13)
        self.assertEqual(DVDPlayback.kDVDSubpictureExtensionDirectorsCommentBiggerSize, 14)
    ...
    def testFunctions(self):
        ...
        self.assertArgIsFunction(DVDPlayback.DVDSetFatalErrorCallBack, 0, DVDFatalErrCallBackFunctionPtr, True)

        self.assertArgIsFunction(DVDPlayback.DVDRegisterEventCallBack, 0, DVDEventCallBackFunctionPtr, True)
