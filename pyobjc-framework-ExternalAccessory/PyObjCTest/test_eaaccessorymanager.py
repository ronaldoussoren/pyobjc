...
if sys.maxsize > 2 ** 32:
    ...
    class TestEAAccessoryManager(TestCase):
        def testConstants(self):
            ...
            self.assertEqual(
                ExternalAccessory.EABluetoothAccessoryPickerResultNotFound, 1
            )
            self.assertEqual(
            ...
            self.assertIsInstance(
                ExternalAccessory.EAAccessoryDidConnectNotification, unicode
            )
            self.assertIsInstance(
                ExternalAccessory.EAAccessoryDidDisconnectNotification, unicode
            )
