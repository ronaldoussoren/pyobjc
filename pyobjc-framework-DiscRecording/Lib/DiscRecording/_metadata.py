...
#
# Last update: Sun Jul 11 21:36:51 2021
#
# flake8: noqa
...
misc.update(
    {
        "DRFileForkSizeInfo": objc.createStructType(
            "DRFileForkSizeInfo", b"{DRFileForkSizeInfo=IIQ}", ["fork", "query", "size"]
        ),
