...
#
# Last update: Sun Mar 22 08:55:07 2020
#
# flake8: noqa
...
misc.update(
    {
        "DRFileForkSizeInfo": objc.createStructType(
            "DRFileForkSizeInfo",
            sel32or64(b"{DRFileForkSizeInfo=LLQ}", b"{DRFileForkSizeInfo=IIQ}"),
            ["fork", "query", "size"],
        ),
        "DRFileProductionInfo": objc.createStructType(
            "DRFileProductionInfo",
            sel32or64(
                b"{DRFileProductionInfo=Q^vLLLL}", b"{DRFileProductionInfo=Q^vIIII}"
            ),
...
constants = constants + "$kDRRefConCFTypeCallbacks@%s$" % (
    sel32or64("{DRRefConCallbacks=L^?^?}", "{DRRefConCallbacks=Q^?^?}"),
)
...
functions = {
    ...
    "DRDeviceAcquireExclusiveAccess": (
        sel32or64(b"l^{__DRDevice=}", b"i^{__DRDevice=}"),
    ),
    ...
    "DRFilesystemTrackEstimateOverhead": (sel32or64(b"QQLL", b"QQII"),),
    "DRFSObjectSetBaseName": (b"v@^{__CFString=}",),
    "DRDeviceGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "DRBurnGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "DRTrackSpeedTest": (sel32or64(b"f^{__DRTrack=}LL", b"f^{__DRTrack=}II"),),
    ...
    "DRDeviceCloseTray": (sel32or64(b"l^{__DRDevice=}", b"i^{__DRDevice=}"),),
    "DRBurnCopyStatus": (
    ...
    "DREraseGetTypeID": (sel32or64(b"L", b"Q"),),
    "DRDeviceOpenTray": (sel32or64(b"l^{__DRDevice=}", b"i^{__DRDevice=}"),),
    ...
    "DRFileCreateVirtualWithData": (
        sel32or64(b"^{__DRFile=}^{__CFString=}^vL", b"^{__DRFile=}^{__CFString=}^vI"),
        "",
        {
            "retval": {"already_cfretained": True},
    ...
    "DRCDTextBlockFlatten": (
        sel32or64(b"L^{__DRCDTextBlock=}", b"I^{__DRCDTextBlock=}"),
    ),
    "DRSetRefCon": (
        sel32or64(b"v@^v^{DRRefConCallbacks=L^?^?}", b"v@^v^{DRRefConCallbacks=Q^?^?}"),
    ),
    ...
    "DRFileCreateVirtualLink": (
        sel32or64(b"^{__DRFile=}@L^{__CFString=}", b"^{__DRFile=}@I^{__CFString=}"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "DRDeviceEjectMedia": (sel32or64(b"l^{__DRDevice=}", b"i^{__DRDevice=}"),),
    ...
    "DRNotificationCenterGetTypeID": (sel32or64(b"L", b"Q"),),
    "DRFolderCountChildren": (sel32or64(b"L^{__DRFolder=}", b"I^{__DRFolder=}"),),
    ...
    "DRCDTextBlockSetValue": (
        sel32or64(
            b"v^{__DRCDTextBlock=}l^{__CFString=}@",
            b"v^{__DRCDTextBlock=}q^{__CFString=}@",
        ),
    ),
    "DREraseSetProperties": (b"v^{__DRErase=}^{__CFDictionary=}",),
    "DREraseStart": (sel32or64(b"l^{__DRErase=}", b"i^{__DRErase=}"),),
    "DRFolderRemoveChild": (b"v^{__DRFolder=}@",),
    "DRFolderGetTypeID": (sel32or64(b"L", b"Q"),),
    "DRBurnWriteLayout": (sel32or64(b"l^{__DRBurn=}@", b"i^{__DRBurn=}@"),),
    "DRTrackEstimateLength": (b"Q^{__DRTrack=}",),
    "DRBurnAbort": (b"v^{__DRBurn=}",),
    "DRFSObjectGetParent": (b"^{__DRFolder=}@",),
    "DRFSObjectSetFilesystemMask": (sel32or64(b"v@L", b"v@I"),),
    "DRFileGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "DRCDTextBlockGetTypeID": (sel32or64(b"L", b"Q"),),
    "DRAudioTrackCreate": (
    ...
    "DRCDTextBlockCreate": (
        sel32or64(
            b"^{__DRCDTextBlock=}^{__CFString=}L", b"^{__DRCDTextBlock=}^{__CFString=}I"
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "DRTrackGetTypeID": (sel32or64(b"L", b"Q"),),
}
aliases = {
