...
if sys.maxsize > 2 ** 32:
    ...
    class TestINSearchForMessagesIntentHelper(Intents.NSObject):
        ...
        def resolveRecipientsForSearchForMessages_withCompletion_(
        ...
        def resolveAttributesForSearchForMessages_withCompletion_(
            self, intent, completion
        ):
            pass
        ...
        def resolveGroupNamesForSearchForMessages_withCompletion_(
            self, intent, completion
        ):
            pass
