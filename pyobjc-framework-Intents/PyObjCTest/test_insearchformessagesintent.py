...
if sys.maxsize > 2 ** 32:
    ...
    class TestINSearchForMessagesIntentHelper (Intents.NSObject):
        def handleSearchForMessages_completion_(self, intent, completion): pass
        def confirmSearchForMessages_completion_(self, intent, completion): pass
        def resolveRecipientsForSearchForMessages_withCompletion_(self, intent, completion): pass
        def resolveSendersForSearchForMessages_withCompletion_(self, intent, completion): pass
        def resolveSearchTermsForSearchForMessages_withCompletion_(self, intent, completion): pass
        def resolveAttributesForSearchForMessages_withCompletion_(self, intent, completion): pass
        def resolveDateTimeRangeForSearchForMessages_withCompletion_(self, intent, completion): pass
    ...
    class TestINSearchForMessagesIntent (TestCase):
        ...
        def testMethods(self):
            self.assertArgIsBlock(TestINSearchForMessagesIntentHelper.handleSearchForMessages_completion_, 1, b'v@')
            self.assertArgIsBlock(TestINSearchForMessagesIntentHelper.confirmSearchForMessages_completion_, 1, b'v@')
