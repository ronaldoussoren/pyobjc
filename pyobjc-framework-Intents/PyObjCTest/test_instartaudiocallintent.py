...
if sys.maxsize > 2 ** 32:
    ...
    class TestINStartAudioCallIntentHelper (Intents.NSObject):
        ...
        def resolveDestinationTypeForStartAudioCall_withCompletion_(self, intent, completion): pass
    ...
    class TestINStartAudioCallIntent (TestCase):
        ...
        def testMethods(self):
            ...
            self.assertArgIsBlock(TestINStartAudioCallIntentHelper.resolveDestinationTypeForStartAudioCall_withCompletion_, 1, b'v@')
