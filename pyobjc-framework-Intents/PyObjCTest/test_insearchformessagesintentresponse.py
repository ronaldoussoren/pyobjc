...
if sys.maxsize > 2 ** 32:
    ...
    class TestINSearchForMessagesIntentResponse(TestCase):
        ...
        def testConstants(self):
            self.assertEqual(
                Intents.INSearchForMessagesIntentResponseCodeUnspecified, 0
            )
            ...
            self.assertEqual(
                Intents.INSearchForMessagesIntentResponseCodeFailureRequiringAppLaunch,
                5,
            )
            self.assertEqual(
            ...
            self.assertEqual(
                Intents.INSearchForMessagesIntentResponseCodeFailureMessageTooManyResults,
                7,
            )
