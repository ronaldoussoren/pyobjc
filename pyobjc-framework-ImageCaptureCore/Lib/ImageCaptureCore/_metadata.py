...
try:
    ...
    r(
        b"ICCameraFile",
        b"requestFingerprintWithCompletion:",
        {
            "arguments": {
                2: {
                    "callable": {
...
objc.registerNewKeywordsFromSelector("ICDeviceBrowser", b"init")
expressions = {
...
formal_protocols = {
    "ICCameraDeviceDelegate": "ICCameraDeviceDelegate",
    "ICCameraDeviceDownloadDelegate": "ICCameraDeviceDownloadDelegate",
    "ICDeviceBrowserDelegate": "ICDeviceBrowserDelegate",
    "ICDeviceDelegate": "ICDeviceDelegate",
    "ICScannerDeviceDelegate": "ICScannerDeviceDelegate",
}
