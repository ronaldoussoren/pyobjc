...
#
# Last update: Sun Nov 15 12:33:48 2020
#
# flake8: noqa
...
try:
    ...
    r(b'ICCameraDevice', b'setPtpEventHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    ...
    r(b'ICDeviceBrowser', b'requestContentsAuthorizationWithCompletion:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'ICDeviceBrowser', b'requestControlAuthorizationWithCompletion:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    ...
    r(b'NSObject', b'deviceBrowserDidCancelSuspendOperations:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'deviceBrowserDidEnumerateLocalDevices:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'deviceBrowserDidResumeOperations:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'deviceBrowserDidSuspendOperations:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'deviceBrowserWillSuspendOperations:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
...
expressions = {'ICReturnCodeObjectDataEmpty': 'ICReturnCodeObjectOffset-3', 'ICReturnCodeObjectCouldNotBeRead': 'ICReturnCodeObjectOffset-2', 'ICReturnCodeObjectDataOffsetInvalid': 'ICReturnCodeObjectOffset-1'}
