...
#
# Last update: Sat Jul  1 14:04:37 2023
#
# flake8: noqa
...
try:
    ...
    r(
        b"NSObject",
        b"syncEngine:shouldFetchChangesForZoneID:",
        {
            "required": False,
            "retval": {"type": b"Z"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}},
