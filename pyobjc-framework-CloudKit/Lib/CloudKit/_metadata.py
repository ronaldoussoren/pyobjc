...
#
# Last update: Fri Jun 10 21:25:22 2022
#
# flake8: noqa
...
misc.update(
    {
        ...
        "CKSharingOptions": NewType("CKSharingOptions", int),
...
try:
    ...
    r(
        b"NSItemProvider",
        b"registerCKShareWithContainer:sharingOptions:preparationHandler:",
        {
            "arguments": {
                4: {
                    "callable": {
