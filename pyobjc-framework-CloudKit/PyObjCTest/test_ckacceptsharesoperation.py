...
class TestCKSyncEngineState(TestCase):
    def test_constants(self):
        ...
        self.assertEqual(CloudKit.CKSyncEnginePendingRecordZoneChangeTypeDeleteRecord, 1)
    ...
    def test_methods14_0(self):
        ...
        self.assertArgIsBOOL(CloudKit.CKSyncEngineState.setHasPendingUntrackedChanges_, 0)
