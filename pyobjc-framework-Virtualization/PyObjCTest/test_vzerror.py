...
class TestVZError(TestCase):
    def test_constants(self):
        ...
        self.assertEqual(Virtualization.VZErrorUserCanceled, 9)
        ...
        self.assertEqual(Virtualization.VZErrorInstallationCanceled, 10007)
        self.assertEqual(Virtualization.VZErrorInstallationFailed, 10008)
