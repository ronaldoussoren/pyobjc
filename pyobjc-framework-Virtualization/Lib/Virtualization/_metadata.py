...
#
# Last update: Sun Jul 11 21:55:20 2021
#
# flake8: noqa
...
enums = """$VZDiskImageSynchronizationModeFsync@2$VZDiskImageSynchronizationModeFull@1$VZDiskImageSynchronizationModeNone@3$VZErrorInternal@1$VZErrorInvalidDiskImage@5$VZErrorInvalidVirtualMachineConfiguration@2$VZErrorInvalidVirtualMachineState@3$VZErrorInvalidVirtualMachineStateTransition@4$VZMacAuxiliaryStorageInitializationOptionAllowOverwrite@1$VZVirtualMachineStateError@3$VZVirtualMachineStatePaused@2$VZVirtualMachineStatePausing@5$VZVirtualMachineStateResuming@6$VZVirtualMachineStateRunning@1$VZVirtualMachineStateStarting@4$VZVirtualMachineStateStopped@0$VZVirtualMachineStateStopping@7$"""
misc.update({})
...
try:
    ...
    r(
        b"VZDiskImageStorageDeviceAttachment",
        b"initWithURL:readOnly:synchronizationMode:error:",
    ...
    r(
        ...
        b"loadRestoreImageFromURL:completionHandler:",
        {
            "arguments": {
                3: {
                    "callable": {
