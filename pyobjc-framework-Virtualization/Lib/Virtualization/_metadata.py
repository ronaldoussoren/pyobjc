...
try:
    ...
    r(
        b"NSObject",
        b"customVirtioConfiguration:didCreateDevice:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}},
    ...
    r(
        b"NSObject",
        b"customVirtioDevice:didReceiveNotificationForQueue:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}},
    ...
    r(
        b"NSObject",
        b"customVirtioDeviceDidAcceptDriverOk:",
        {"required": False, "retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    )
    r(
        b"NSObject",
        b"customVirtioDeviceSaveStateForRestore:",
        {"required": False, "retval": {"type": b"@"}, "arguments": {2: {"type": b"@"}}},
    )
    r(
        b"NSObject",
        b"customVirtioDeviceShouldRestore:saveState:",
        {
            "required": False,
            "retval": {"type": b"Z"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}},
    ...
    r(
        b"NSObject",
        b"customVirtioDeviceWillPause:",
        {"required": False, "retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    )
    r(
        b"NSObject",
        b"customVirtioDeviceWillReset:",
        {"required": False, "retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    )
    r(
        b"NSObject",
        b"customVirtioDeviceWillResume:",
        {"required": False, "retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    )
    r(
        b"NSObject",
        b"customVirtioDeviceWillStop:",
        {"required": False, "retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    )
    r(
        b"NSObject",
    ...
    r(
        b"NSObject",
        b"usbController:usbPassthroughDeviceDidDisconnect:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}},
    ...
    r(
        b"VZCustomVirtioDevice",
        b"updateDeviceSpecificConfiguration:completionHandler:",
        {
            "arguments": {
                3: {
                    "callable": {
    ...
    r(
        b"VZCustomVirtioDeviceConfiguration",
        b"setSupportsSaveRestore:",
        {"arguments": {2: {"type": b"Z"}}},
    )
    r(
        b"VZCustomVirtioDeviceConfiguration",
        b"supportsSaveRestore",
        {"retval": {"type": b"Z"}},
    )
    r(
    ...
    r(b"VZDiskImageStorageDeviceAttachment", b"isReadOnly", {"retval": {"type": b"Z"}})
    r(
        b"VZEFISignatureList",
        b"initWithContentsOfURL:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"VZEFIVariableStore",
        b"disableSecureBootWithError:",
        {"retval": {"type": b"Z"}, "arguments": {2: {"type_modifier": b"o"}}},
    )
    r(
        b"VZEFIVariableStore",
        b"enableSecureBootUsingDefaultPlatformKeyWithError:",
        {"retval": {"type": b"Z"}, "arguments": {2: {"type_modifier": b"o"}}},
    )
    r(
        b"VZEFIVariableStore",
        b"enableSecureBootWithPlatformKey:error:",
        {"retval": {"type": b"Z"}, "arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"VZEFIVariableStore",
        b"enrollDefaultSecureBootSignaturesWithError:",
        {"retval": {"type": b"Z"}, "arguments": {2: {"type_modifier": b"o"}}},
    )
    r(
        b"VZEFIVariableStore",
        b"enrollSecureBootSignatures:error:",
        {"retval": {"type": b"Z"}, "arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"VZEFIVariableStore",
        b"getEnrolledSecureBootSignaturesWithError:",
        {"arguments": {2: {"type_modifier": b"o"}}},
    )
    r(
        b"VZEFIVariableStore",
        b"getSecureBootEnabled:error:",
        {
            "retval": {"type": b"Z"},
            "arguments": {
                2: {"type": b"^Z", "type_modifier": b"o"},
                3: {"type_modifier": b"o"},
            },
        },
    )
    ...
    r(
        b"VZMacGuestProvisioningOptions",
        b"enablesRemoteLogin",
        {"retval": {"type": b"Z"}},
    )
    r(
        b"VZMacGuestProvisioningOptions",
        b"logsInAutomatically",
        {"retval": {"type": b"Z"}},
    )
    r(
        b"VZMacGuestProvisioningOptions",
        b"setEnablesRemoteLogin:",
        {"arguments": {2: {"type": b"Z"}}},
    )
    r(
        b"VZMacGuestProvisioningOptions",
        b"setLogsInAutomatically:",
        {"arguments": {2: {"type": b"Z"}}},
    )
    ...
    r(
        ...
        b"setGuestProvisioningOptions:error:",
        {"retval": {"type": b"Z"}, "arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"VZMacOSVirtualMachineStartOptions",
    ...
    r(
        b"VZVirtioQueueElement",
        b"peekIntoReadBuffersWithExactLength:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"VZVirtioQueueElement",
        b"readBytesIntoBuffer:exactLength:error:",
        {
            "retval": {"type": b"Z"},
            "arguments": {
    ...
    r(
        b"VZVirtioQueueElement",
        b"readBytesWithExactLength:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"VZVirtioQueueElement",
        b"writeBuffer:exactLength:error:",
        {
            "retval": {"type": b"Z"},
            "arguments": {
    ...
    r(
        b"VZVirtioSharedMemoryRegion",
        b"mapMemory:atOffset:size:completionHandler:",
        {
            "arguments": {
                5: {
                    "callable": {
    ...
    r(
        b"VZVirtioSharedMemoryRegion",
        b"unmapMemoryAtOffset:size:completionHandler:",
        {
            "arguments": {
                4: {
                    "callable": {
...
objc.registerNewKeywordsFromSelector("VZCustomVirtioDevice", b"init")
objc.registerNewKeywordsFromSelector(
    "VZCustomVirtioDeviceDelegateProvider", b"initWithDeviceQueue:delegate:"
)
objc.registerNewKeywordsFromSelector("VZCustomVirtioDeviceProvider", b"init")
...
objc.registerNewKeywordsFromSelector("VZEFISignature", b"init")
objc.registerNewKeywordsFromSelector("VZEFISignatureDatabaseConfiguration", b"init")
objc.registerNewKeywordsFromSelector(
    "VZEFISignatureDatabaseConfiguration",
    b"initWithKeyExchangeKeys:dbSignatures:dbxSignatures:",
)
objc.registerNewKeywordsFromSelector("VZEFISignatureList", b"init")
objc.registerNewKeywordsFromSelector(
    "VZEFISignatureList", b"initWithContentsOfURL:error:"
)
objc.registerNewKeywordsFromSelector("VZEFISignatureList", b"initWithSignatures:")
objc.registerNewKeywordsFromSelector("VZEFISignatureSHA256Hash", b"init")
objc.registerNewKeywordsFromSelector("VZEFISignatureSHA256Hash", b"initWithData:")
objc.registerNewKeywordsFromSelector("VZEFISignatureX509Certificate", b"init")
objc.registerNewKeywordsFromSelector(
    "VZEFISignatureX509Certificate", b"initWithCertificate:"
)
...
objc.registerNewKeywordsFromSelector("VZGuestMemoryMapping", b"init")
objc.registerNewKeywordsFromSelector("VZGuestProvisioningOptions", b"init")
...
objc.registerNewKeywordsFromSelector("VZMacGuestProvisioningOptions", b"init")
...
objc.registerNewKeywordsFromSelector("VZNegotiatedVirtioFeatureSet", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("VZUSBPassthroughDevice", b"init")
objc.registerNewKeywordsFromSelector(
    "VZUSBPassthroughDevice", b"initWithConfiguration:error:"
)
objc.registerNewKeywordsFromSelector("VZUSBPassthroughDeviceConfiguration", b"init")
objc.registerNewKeywordsFromSelector(
    "VZUSBPassthroughDeviceConfiguration", b"initWithDevice:"
)
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("VZVirtioDeviceSpecificConfiguration", b"init")
objc.registerNewKeywordsFromSelector(
    "VZVirtioDeviceSpecificConfiguration", b"initWithConfigurationData:"
)
objc.registerNewKeywordsFromSelector("VZVirtioEntropyDeviceConfiguration", b"init")
objc.registerNewKeywordsFromSelector("VZVirtioFeatureSet", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("VZVirtioQueue", b"init")
objc.registerNewKeywordsFromSelector("VZVirtioQueueElement", b"init")
objc.registerNewKeywordsFromSelector("VZVirtioSharedMemoryRegion", b"init")
objc.registerNewKeywordsFromSelector("VZVirtioSharedMemoryRegionConfiguration", b"init")
objc.registerNewKeywordsFromSelector(
    "VZVirtioSharedMemoryRegionConfiguration", b"initWithRegionID:size:"
)
...
expressions = {}
formal_protocols = {
    "VZCustomVirtioDeviceConfigurationDelegate": "VZCustomVirtioDeviceConfigurationDelegate",
    "VZCustomVirtioDeviceDelegate": "VZCustomVirtioDeviceDelegate",
    "VZGraphicsDisplayObserver": "VZGraphicsDisplayObserver",
    "VZNetworkBlockDeviceStorageDeviceAttachmentDelegate": "VZNetworkBlockDeviceStorageDeviceAttachmentDelegate",
    "VZUSBControllerDelegate": "VZUSBControllerDelegate",
    "VZUSBDevice": "VZUSBDevice",
    "VZUSBDeviceConfiguration": "VZUSBDeviceConfiguration",
    "VZVirtioConsoleDeviceDelegate": "VZVirtioConsoleDeviceDelegate",
    "VZVirtioSocketListenerDelegate": "VZVirtioSocketListenerDelegate",
    "VZVirtualMachineDelegate": "VZVirtualMachineDelegate",
}
