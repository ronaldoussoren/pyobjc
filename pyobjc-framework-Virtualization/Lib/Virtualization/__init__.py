...
def _setup():
    ...
    for cls, sel in (
        ...
        ("VZCustomVirtioDevice", b"init"),
        ("VZCustomVirtioDevice", b"new"),
        ("VZCustomVirtioDeviceProvider", b"init"),
        ("VZCustomVirtioDeviceProvider", b"new"),
        ("VZEFISignature", b"init"),
        ("VZEFISignature", b"new"),
        ("VZEFISignatureDatabaseConfiguration", b"init"),
        ("VZEFISignatureDatabaseConfiguration", b"new"),
        ("VZEFISignatureList", b"init"),
        ("VZEFISignatureList", b"new"),
        ("VZEFISignatureSHA256Hash", b"init"),
        ("VZEFISignatureSHA256Hash", b"new"),
        ("VZEFISignatureX509Certificate", b"init"),
        ("VZEFISignatureX509Certificate", b"new"),
        ("VZGuestMemoryMapping", b"init"),
        ("VZGuestMemoryMapping", b"new"),
        ("VZGuestProvisioningOptions", b"init"),
        ("VZGuestProvisioningOptions", b"new"),
        ("VZNegotiatedVirtioFeatureSet", b"init"),
        ("VZNegotiatedVirtioFeatureSet", b"new"),
        ("VZUSBPassthroughDevice", b"init"),
        ("VZUSBPassthroughDevice", b"new"),
        ("VZUSBPassthroughDeviceConfiguration", b"init"),
        ("VZUSBPassthroughDeviceConfiguration", b"new"),
        ("VZVirtioDeviceSpecificConfiguration", b"init"),
        ("VZVirtioDeviceSpecificConfiguration", b"new"),
        ("VZVirtioFeatureSet", b"init"),
        ("VZVirtioFeatureSet", b"new"),
        ("VZVirtioQueue", b"init"),
        ("VZVirtioQueue", b"new"),
        ("VZVirtioQueueElement", b"init"),
        ("VZVirtioQueueElement", b"new"),
        ("VZVirtioSharedMemoryRegion", b"init"),
        ("VZVirtioSharedMemoryRegion", b"new"),
        ("VZVirtioSharedMemoryRegionConfiguration", b"init"),
        ("VZVirtioSharedMemoryRegionConfiguration", b"new"),
    ):
