...
GL_MIRRORED_REPEAT_IBM = _texture_mirrored_repeat.GL_MIRRORED_REPEAT_IBM

glInitTextureMirroredRepeatIBM = _texture_mirrored_repeat.glInitTextureMirroredRepeatIBM
