...
/*-----------------------------------------------
              @(target):= _misc_attribute.so
  ------------------------------------------------*/
#define SWIG_init    init_misc_attribute

#define SWIG_name    "_misc_attribute"
...
#define glInitMiscAttributeEXT() InitExtension("GL_EXT_misc_attribute", proc_names)
 ...
 static char _doc_glInitMiscAttributeEXT[] = "glInitMiscAttributeEXT() -> bool"; 
...
extern "C" {
#endif
static PyObject *_wrap_glInitMiscAttributeEXT(PyObject *self, PyObject *args) {
    PyObject *resultobj;
    int result;
    
    if(!PyArg_ParseTuple(args,(char *)":glInitMiscAttributeEXT")) goto fail;
    {
        result = (int)glInitMiscAttributeEXT();
...
static PyMethodDef SwigMethods[] = {
	 { (char *)"glInitMiscAttributeEXT", _wrap_glInitMiscAttributeEXT, METH_VARARGS, NULL},
