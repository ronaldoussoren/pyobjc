...
/**
 *
 * GL.ARB.depth_texture Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_ARB_depth_texture)
...
#define glInitDepthTextureARB() InitExtension("GL_ARB_depth_texture", proc_names)
%}

int glInitDepthTextureARB();
DOC(glInitDepthTextureARB, "glInitDepthTextureARB() -> bool")

%{
PyObject *__info()
{
	if (glInitDepthTextureARB())
	{
