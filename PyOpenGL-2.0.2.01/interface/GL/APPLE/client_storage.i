...
/**
 *
 * GL.APPLE.client_storage Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_APPLE_client_storage)
...
#define glInitClientStorageAPPLE() InitExtension("GL_APPLE_client_storage", proc_names)
%}

int glInitClientStorageAPPLE();
DOC(glInitClientStorageAPPLE, "glInitClientStorageAPPLE() -> bool")

%{
PyObject *__info()
{
	if (glInitClientStorageAPPLE())
	{
