...
/**
 *
 * GL.SGIS.texture_border_clamp Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_SGIS_texture_border_clamp)
...
#define glInitTextureBorderClampSGIS() InitExtension("GL_SGIS_texture_border_clamp", proc_names)
%}

int glInitTextureBorderClampSGIS();
DOC(glInitTextureBorderClampSGIS, "glInitTextureBorderClampSGIS() -> bool")
