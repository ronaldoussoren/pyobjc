...
/**
 *
 * GL.NV.blend_square Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_NV_blend_square)
...
#define glInitBlendSquareNV() InitExtension("GL_NV_blend_square", proc_names)
%}

int glInitBlendSquareNV();
DOC(glInitBlendSquareNV, "glInitBlendSquareNV() -> bool")
