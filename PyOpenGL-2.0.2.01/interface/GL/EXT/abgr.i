...
/**
 *
 * GL.EXT.abgr Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_EXT_abgr)
...
#define glInitAbgrEXT() InitExtension("GL_EXT_abgr", proc_names)
%}

int glInitAbgrEXT();
DOC(glInitAbgrEXT, "glInitAbgrEXT() -> bool")
