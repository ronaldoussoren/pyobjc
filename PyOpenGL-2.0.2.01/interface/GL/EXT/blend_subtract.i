...
/**
 *
 * GL.EXT.blend_subtract Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_EXT_blend_subtract)
...
#define glInitBlendSubtractEXT() InitExtension("GL_EXT_blend_subtract", proc_names)
%}

int glInitBlendSubtractEXT();
DOC(glInitBlendSubtractEXT, "glInitBlendSubtractEXT() -> bool")
