...
/**
 *
 * GL.EXT.cmyka Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_EXT_cmyka)
...
#define glInitCmykaEXT() InitExtension("GL_EXT_cmyka", proc_names)
%}

int glInitCmykaEXT();
DOC(glInitCmykaEXT, "glInitCmykaEXT() -> bool")
