...
/**
 *
 * GL.SUN.slice_accum Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_SUN_slice_accum)
...
#define glInitSliceAccumSUN() InitExtension("GL_SUN_slice_accum", proc_names)
%}

int glInitSliceAccumSUN();
DOC(glInitSliceAccumSUN, "glInitSliceAccumSUN() -> bool")

%{
PyObject *__info()
{
	if (glInitSliceAccumSUN())
	{
