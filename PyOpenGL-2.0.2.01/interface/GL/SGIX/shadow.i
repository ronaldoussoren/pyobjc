...
/**
 *
 * GL.SGIX.shadow Module for PyOpenGL
 * 
...
#if !EXT_DEFINES_PROTO || !defined(GL_SGIX_shadow)
...
#define glInitShadowSGIX() InitExtension("GL_SGIX_shadow", proc_names)
%}

int glInitShadowSGIX();
DOC(glInitShadowSGIX, "glInitShadowSGIX() -> bool")
