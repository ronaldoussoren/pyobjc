...
class TestCFOpenDirectoryConstants (TestCase):
    ...
    def testConstants10_9(self):
        ...
        self.assertIsInstance(CFOpenDirectory.kODPolicyTypePasswordCannotBeAccountName, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyTypePasswordChangeRequired, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyTypePasswordHistory, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyTypePasswordMinimumNumberOfCharacters, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyTypePasswordMaximumNumberOfCharacters, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyTypePasswordMaximumAgeInMinutes, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyTypePasswordRequiresAlpha, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyTypePasswordRequiresMixedCase, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyTypePasswordRequiresNumeric, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyTypePasswordRequiresSymbol, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyTypePasswordSelfModification, unicode)
    ...
    def testConstants10_10(self):
        ...
        self.assertIsInstance(CFOpenDirectory.kODPolicyAttributePasswordHistoryDepth, unicode)
        ...
        self.assertIsInstance(CFOpenDirectory.kODPolicyAttributeFailedAuthentications, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyAttributeMaximumFailedAuthentications, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyAttributeLastFailedAuthenticationTime, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyAttributeLastAuthenticationTime, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyAttributeLastPasswordChangeTime, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyAttributeNewPasswordRequiredTime, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyAttributeCreationTime, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyAttributeExpiresEveryNDays, unicode)
        ...
        self.assertIsInstance(CFOpenDirectory.kODPolicyAttributeEnableOnDayOfWeek, unicode)
        self.assertIsInstance(CFOpenDirectory.kODPolicyAttributeExpiresOnDayOfWeek, unicode)
