...
#
# Last update: Sun Aug  4 21:20:49 2019
...
functions = {
    ...
    "ODNodeGetTypeID": (sel32or64(b"L", b"Q"),),
    "ODNodeCustomCall": (
        sel32or64(
            b"^{__CFData=}^{_ODNode=}l^{__CFData=}^^{__CFError}",
    ...
    "ODQueryCreateWithNodeType": (
        sel32or64(
            b"^{_ODQuery=}^{__CFAllocator=}I@@I@@l^^{__CFError}",
    ...
    "ODQueryCreateWithNode": (
        sel32or64(
            b"^{_ODQuery=}^{__CFAllocator=}^{_ODNode=}@@I@@l^^{__CFError}",
    ...
    "ODContextGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "ODRecordGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "ODQueryGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "ODSessionGetTypeID": (sel32or64(b"L", b"Q"),),
    "ODRecordCopyDetails": (
