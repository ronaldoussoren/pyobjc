...
misc.update(
    {
        "ODNodeType": NewType("ODNodeType", int),
        "ODMatchType": NewType("ODMatchType", int),
    }
)
misc.update({})
functions = {
    "ODNodeCopySubnodeNames": (
        b"^{__CFArray=}^{__ODNode=}^^{__CFError=}",
        "",
        {
    ...
    "ODRecordVerifyPasswordExtended": (
        b"B^{__ODRecord=}@^{__CFArray=}^^{__CFArray=}^^{__ODContext=}^^{__CFError=}",
        "",
        {
            "arguments": {
                3: {"type_modifier": "o"},
    ...
    "ODNodeCreateCopy": (
        b"^{__ODNode=}^{__CFAllocator=}^{__ODNode=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "ODNodeGetTypeID": (b"Q",),
    "ODNodeCustomCall": (
        b"^{__CFData=}^{__ODNode=}q^{__CFData=}^^{__CFError=}",
        "",
        {
            "arguments": {
                3: {
    ...
    "ODRecordSetNodeCredentials": (
        b"B^{__ODRecord=}^{__CFString=}^{__CFString=}^^{__CFError=}",
        "",
        {
            "arguments": {
                3: {
    ...
    "ODRecordGetRecordName": (b"^{__CFString=}^{__ODRecord=}",),
    "ODNodeRemovePolicy": (
    ...
    "ODNodeSetCredentialsExtended": (
        b"B^{__ODNode=}@@^{__CFArray=}^^{__CFArray=}^^{__ODContext=}^^{__CFError=}",
        "",
        {
            "arguments": {
                4: {"type_modifier": "o"},
    ...
    "ODQuerySynchronize": (b"v^{__ODQuery=}",),
    "ODRecordSecondsUntilPasswordExpires": (b"q^{__ODRecord=}",),
    "ODSessionCopyNodeNames": (
        b"^{__CFArray=}^{__CFAllocator=}^{__ODSession=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "ODRecordGetRecordType": (b"^{__CFString=}^{__ODRecord=}",),
    "ODRecordAddMember": (
        b"B^{__ODRecord=}^{__ODRecord=}^^{__CFError=}",
        "",
        {
            "arguments": {
                2: {
    ...
    "ODNodeCopyRecord": (
        b"^{__ODRecord=}^{__ODNode=}@^{__CFString=}@^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "ODQueryScheduleWithRunLoop": (b"v^{__ODQuery=}^{__CFRunLoop=}^{__CFString=}",),
    "ODNodeGetName": (b"^{__CFString=}^{__ODNode=}",),
    "ODSessionCreate": (
        b"^{__ODSession=}^{__CFAllocator=}^{__CFDictionary=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "ODQueryCreateWithNodeType": (
        b"^{__ODQuery=}^{__CFAllocator=}I@@I@@q^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "ODQuerySetDispatchQueue": (b"v^{__ODQuery=}@",),
    ...
    "ODNodeCopyDetails": (
        b"^{__CFDictionary=}^{__ODNode=}^{__CFArray=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "ODQueryCreateWithNode": (
        b"^{__ODQuery=}^{__CFAllocator=}^{__ODNode=}@@I@@q^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "ODRecordCopyPasswordPolicy": (
        b"^{__CFDictionary=}^{__CFAllocator=}^{__ODRecord=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "ODNodeCreateRecord": (
        b"^{__ODRecord=}^{__ODNode=}@^{__CFString=}^{__CFDictionary=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "ODRecordCopyValues": (
        b"^{__CFArray=}^{__ODRecord=}@^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "ODNodeCreateWithName": (
        b"^{__ODNode=}^{__CFAllocator=}^{__ODSession=}^{__CFString=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "ODRecordCopyDetails": (
        b"^{__CFDictionary=}^{__ODRecord=}^{__CFArray=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "ODNodeSetCredentialsUsingKerberosCache": (
        b"B^{__ODNode=}^{__CFString=}^^{__CFError=}",
        "",
        {
            "arguments": {
                2: {
    ...
    "ODQueryCopyResults": (
        b"^{__CFArray=}^{__ODQuery=}B^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "ODNodeCreateWithNodeType": (
        b"^{__ODNode=}^{__CFAllocator=}^{__ODSession=}I^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "ODQueryUnscheduleFromRunLoop": (b"v^{__ODQuery=}^{__CFRunLoop=}^{__CFString=}",),
