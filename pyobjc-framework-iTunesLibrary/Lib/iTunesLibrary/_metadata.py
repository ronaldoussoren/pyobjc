...
#
# Last update: Tue Jun 26 22:25:29 2018
...
try:
    ...
    r(b'ITLibrary', b'initWithAPIVersion:options:error:', {'arguments': {4: {'type': 'Z'}}})
    r(b'ITLibrary', b'libraryWithAPIVersion:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    r(b'ITLibrary', b'libraryWithAPIVersion:options:error:', {'arguments': {4: {'type': 'Z'}}})
