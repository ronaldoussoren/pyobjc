...
class TestIconsCore(TestCase):
    ...
    def testFunctions32(self):
        ...
        LaunchServices.GetIconRefFromFile
        self.assertArgIsOut(LaunchServices.GetIconRefFromFolder, 5)

        LaunchServices.RegisterIconRefFromResource
        LaunchServices.OverrideIconRefFromResource
        LaunchServices.FlushIconRefs
        LaunchServices.FlushIconRefsByVolume

        self.assertArgIsOut(LaunchServices.RegisterIconRefFromIconFile, 3)

        LaunchServices.ReadIconFile
        LaunchServices.WriteIconFile
