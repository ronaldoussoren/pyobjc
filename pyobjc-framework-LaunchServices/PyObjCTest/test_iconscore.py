...
class TestIconsCore (TestCase):
    def testConstants(self):
        ...
        self.assertEqual(LaunchServices.genericDocumentIconResource, LaunchServices.kGenericDocumentIconResource)
        self.assertEqual(LaunchServices.genericStationeryIconResource, LaunchServices.kGenericStationeryIconResource)
        self.assertEqual(LaunchServices.genericEditionFileIconResource, LaunchServices.kGenericEditionFileIconResource)
        self.assertEqual(LaunchServices.genericApplicationIconResource, LaunchServices.kGenericApplicationIconResource)
        self.assertEqual(LaunchServices.genericDeskAccessoryIconResource, LaunchServices.kGenericDeskAccessoryIconResource)
        self.assertEqual(LaunchServices.genericFolderIconResource, LaunchServices.kGenericFolderIconResource)
        self.assertEqual(LaunchServices.privateFolderIconResource, LaunchServices.kPrivateFolderIconResource)
        self.assertEqual(LaunchServices.floppyIconResource, LaunchServices.kFloppyIconResource)
        self.assertEqual(LaunchServices.trashIconResource, LaunchServices.kTrashIconResource)
        self.assertEqual(LaunchServices.genericRAMDiskIconResource, LaunchServices.kGenericRAMDiskIconResource)
        self.assertEqual(LaunchServices.genericCDROMIconResource, LaunchServices.kGenericCDROMIconResource)
        self.assertEqual(LaunchServices.desktopIconResource, LaunchServices.kDesktopIconResource)
        self.assertEqual(LaunchServices.openFolderIconResource, LaunchServices.kOpenFolderIconResource)
        self.assertEqual(LaunchServices.genericHardDiskIconResource, LaunchServices.kGenericHardDiskIconResource)
        self.assertEqual(LaunchServices.genericFileServerIconResource, LaunchServices.kGenericFileServerIconResource)
        self.assertEqual(LaunchServices.genericSuitcaseIconResource, LaunchServices.kGenericSuitcaseIconResource)
        self.assertEqual(LaunchServices.genericMoverObjectIconResource, LaunchServices.kGenericMoverObjectIconResource)
        self.assertEqual(LaunchServices.genericPreferencesIconResource, LaunchServices.kGenericPreferencesIconResource)
        self.assertEqual(LaunchServices.genericQueryDocumentIconResource, LaunchServices.kGenericQueryDocumentIconResource)
        self.assertEqual(LaunchServices.genericExtensionIconResource, LaunchServices.kGenericExtensionIconResource)
        self.assertEqual(LaunchServices.systemFolderIconResource, LaunchServices.kSystemFolderIconResource)
        self.assertEqual(LaunchServices.appleMenuFolderIconResource, LaunchServices.kAppleMenuFolderIconResource)
        ...
        self.assertEqual(LaunchServices.startupFolderIconResource, LaunchServices.kStartupFolderIconResource)
        self.assertEqual(LaunchServices.ownedFolderIconResource, LaunchServices.kOwnedFolderIconResource)
        self.assertEqual(LaunchServices.dropFolderIconResource, LaunchServices.kDropFolderIconResource)
        self.assertEqual(LaunchServices.sharedFolderIconResource, LaunchServices.kSharedFolderIconResource)
        self.assertEqual(LaunchServices.mountedFolderIconResource, LaunchServices.kMountedFolderIconResource)
        self.assertEqual(LaunchServices.controlPanelFolderIconResource, LaunchServices.kControlPanelFolderIconResource)
        self.assertEqual(LaunchServices.printMonitorFolderIconResource, LaunchServices.kPrintMonitorFolderIconResource)
        self.assertEqual(LaunchServices.preferencesFolderIconResource, LaunchServices.kPreferencesFolderIconResource)
        self.assertEqual(LaunchServices.extensionsFolderIconResource, LaunchServices.kExtensionsFolderIconResource)
        self.assertEqual(LaunchServices.fontsFolderIconResource, LaunchServices.kFontsFolderIconResource)
        self.assertEqual(LaunchServices.fullTrashIconResource, LaunchServices.kFullTrashIconResource)
        ...
        self.assertEqual(LaunchServices.kInternationResourcesIcon, LaunchServices.kInternationalResourcesIcon)
        ...
        self.assertEqual(LaunchServices.kInternetLocationAppleTalkZoneIcon, fourcc(b'ilat'))
        ...
        self.assertEqual(LaunchServices.kInternetLocationNSLNeighborhoodIcon, fourcc(b'ilns'))
        ...
        self.assertEqual(LaunchServices.kControlStripModulesFolderIcon, cast_int(0x736476C4))
        ...
        self.assertEqual(LaunchServices.kScriptingAdditionsFolderIcon, cast_int(0xC4736372))
        ...
        self.assertEqual(LaunchServices.kSystemExtensionDisabledFolderIcon, fourcc(b'macD'))
        ...
        self.assertEqual(LaunchServices.kIconServicesCatalogInfoMask, 531550)
    ...
    def testFunctions(self):
        ...
        err, icon = LaunchServices.GetIconRef(0, LaunchServices.kSystemIconsCreator, LaunchServices.kShortcutIcon, None)
        ...
        try:
            ...
            self.assertArgHasType(LaunchServices.GetIconRefFromFileInfo, 2, objc._C_IN + objc._C_PTR + objc._C_UNICHAR)
            ...
            self.assertArgHasType(LaunchServices.GetCustomIconsEnabled, 1, objc._C_OUT + objc._C_PTR + objc._C_NSBOOL)
