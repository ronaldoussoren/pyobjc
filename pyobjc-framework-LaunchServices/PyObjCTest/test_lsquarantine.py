...
class TestLSQuarantine(TestCase):
    def testConstants(self):
        ...
        self.assertIsInstance(
            LaunchServices.kLSQuarantineAgentBundleIdentifierKey, unicode
        )
        ...
        self.assertIsInstance(
            LaunchServices.kLSQuarantineTypeInstantMessageAttachment, unicode
        )
        self.assertIsInstance(
            LaunchServices.kLSQuarantineTypeCalendarEventAttachment, unicode
        )
