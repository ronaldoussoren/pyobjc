...
#
# Last update: Sun May 24 11:54:54 2026
#
# flake8: noqa
...
objc.registerNewKeywordsFromSelector("PHASEAmbientMixerDefinition", b"init")
...
objc.registerNewKeywordsFromSelector("PHASEAsset", b"init")
objc.registerNewKeywordsFromSelector("PHASEAssetRegistry", b"init")
objc.registerNewKeywordsFromSelector("PHASEBlendNodeDefinition", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector(
    "PHASECardioidDirectivityModelSubbandParameters", b"init"
)
objc.registerNewKeywordsFromSelector("PHASEChannelMixerDefinition", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector(
    "PHASEConeDirectivityModelSubbandParameters", b"init"
)
objc.registerNewKeywordsFromSelector("PHASEContainerNodeDefinition", b"init")
objc.registerNewKeywordsFromSelector(
    "PHASEContainerNodeDefinition", b"initWithIdentifier:"
)
objc.registerNewKeywordsFromSelector("PHASEDefinition", b"init")
objc.registerNewKeywordsFromSelector("PHASEDirectivityModelParameters", b"init")
objc.registerNewKeywordsFromSelector("PHASEDistanceModelFadeOutParameters", b"init")
objc.registerNewKeywordsFromSelector(
    "PHASEDistanceModelFadeOutParameters", b"initWithCullDistance:"
)
objc.registerNewKeywordsFromSelector("PHASEDistanceModelParameters", b"init")
objc.registerNewKeywordsFromSelector("PHASEDucker", b"init")
objc.registerNewKeywordsFromSelector(
    "PHASEDucker",
    b"initWithEngine:sourceGroups:targetGroups:gain:attackTime:releaseTime:attackCurve:releaseCurve:",
)
objc.registerNewKeywordsFromSelector("PHASEEngine", b"init")
objc.registerNewKeywordsFromSelector("PHASEEngine", b"initWithUpdateMode:")
objc.registerNewKeywordsFromSelector(
    "PHASEEngine", b"initWithUpdateMode:renderingMode:"
)
objc.registerNewKeywordsFromSelector("PHASEEnvelope", b"init")
objc.registerNewKeywordsFromSelector("PHASEEnvelope", b"initWithStartPoint:segments:")
objc.registerNewKeywordsFromSelector("PHASEEnvelopeDistanceModelParameters", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("PHASEGeneratorNodeDefinition", b"init")
objc.registerNewKeywordsFromSelector(
    "PHASEGeometricSpreadingDistanceModelParameters", b"init"
)
objc.registerNewKeywordsFromSelector("PHASEGlobalMetaParameterAsset", b"init")
objc.registerNewKeywordsFromSelector("PHASEGroup", b"init")
objc.registerNewKeywordsFromSelector("PHASEGroup", b"initWithIdentifier:")
objc.registerNewKeywordsFromSelector("PHASEGroupPreset", b"init")
objc.registerNewKeywordsFromSelector(
    "PHASEGroupPreset", b"initWithEngine:settings:timeToTarget:timeToReset:"
)
objc.registerNewKeywordsFromSelector("PHASEGroupPresetSetting", b"init")
objc.registerNewKeywordsFromSelector(
    "PHASEGroupPresetSetting", b"initWithGain:rate:gainCurveType:rateCurveType:"
)
objc.registerNewKeywordsFromSelector("PHASEListener", b"init")
objc.registerNewKeywordsFromSelector("PHASEListener", b"initWithEngine:")
objc.registerNewKeywordsFromSelector("PHASEMappedMetaParameterDefinition", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("PHASEMaterial", b"init")
objc.registerNewKeywordsFromSelector("PHASEMaterial", b"initWithEngine:preset:")
objc.registerNewKeywordsFromSelector("PHASEMedium", b"init")
objc.registerNewKeywordsFromSelector("PHASEMedium", b"initWithEngine:preset:")
objc.registerNewKeywordsFromSelector("PHASEMetaParameter", b"init")
objc.registerNewKeywordsFromSelector("PHASEMetaParameterDefinition", b"init")
objc.registerNewKeywordsFromSelector("PHASEMixer", b"init")
objc.registerNewKeywordsFromSelector("PHASEMixerDefinition", b"init")
objc.registerNewKeywordsFromSelector("PHASENumberMetaParameter", b"init")
objc.registerNewKeywordsFromSelector("PHASENumberMetaParameterDefinition", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("PHASEObject", b"init")
objc.registerNewKeywordsFromSelector("PHASEObject", b"initWithEngine:")
objc.registerNewKeywordsFromSelector("PHASEOccluder", b"init")
...
objc.registerNewKeywordsFromSelector("PHASEPullStreamNode", b"init")
objc.registerNewKeywordsFromSelector("PHASEPullStreamNodeDefinition", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("PHASEPushStreamNode", b"init")
objc.registerNewKeywordsFromSelector("PHASEPushStreamNodeDefinition", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("PHASERandomNodeDefinition", b"init")
objc.registerNewKeywordsFromSelector(
    "PHASERandomNodeDefinition", b"initWithIdentifier:"
)
objc.registerNewKeywordsFromSelector("PHASESamplerNodeDefinition", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("PHASEShape", b"init")
...
objc.registerNewKeywordsFromSelector("PHASEShapeElement", b"init")
objc.registerNewKeywordsFromSelector("PHASESoundAsset", b"init")
objc.registerNewKeywordsFromSelector("PHASESoundEvent", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("PHASESoundEventNodeAsset", b"init")
objc.registerNewKeywordsFromSelector("PHASESoundEventNodeDefinition", b"init")
objc.registerNewKeywordsFromSelector("PHASESource", b"init")
...
objc.registerNewKeywordsFromSelector("PHASESpatialMixerDefinition", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("PHASESpatialPipeline", b"init")
objc.registerNewKeywordsFromSelector("PHASESpatialPipeline", b"initWithFlags:")
objc.registerNewKeywordsFromSelector("PHASEStreamNode", b"init")
objc.registerNewKeywordsFromSelector("PHASEStringMetaParameter", b"init")
objc.registerNewKeywordsFromSelector("PHASEStringMetaParameterDefinition", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("PHASESwitchNodeDefinition", b"init")
objc.registerNewKeywordsFromSelector(
