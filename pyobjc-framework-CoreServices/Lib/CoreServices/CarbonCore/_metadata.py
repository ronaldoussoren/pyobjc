...
#
# Last update: Sun Aug  4 16:05:44 2019
...
misc.update(
    {
        "ScriptCodeRun": objc.createStructType(
            "ScriptCodeRun",
            sel32or64(b"{ScriptCodeRun=Ls}", b"{ScriptCodeRun=Qs}"),
            ["offset", "script"],
        ),
        ...
        "TextEncodingRun": objc.createStructType(
            "TextEncodingRun",
            sel32or64(b"{TextEncodingRun=LL}", b"{TextEncodingRun=QI}"),
            ["offset", "textEncoding"],
        ),
        "TECInfo": objc.createStructType(
            "TECInfo",
            sel32or64(b"{TECInfo=SSLLL[32C][32C]SS}", b"{TECInfo=SSIII[32C][32C]SS}"),
            [
                "format",
                "tecVersion",
...
functions = {
    ...
    "GetTextEncodingFormat": (sel32or64(b"LL", b"II"),),
    "LocaleStringToLangAndRegionCodes": (
        sel32or64(b"l^t^s^s", b"i^t^s^s"),
        "",
        {
            "arguments": {
    ...
    "TECCreateSniffer": (
        sel32or64(
            b"l^^{OpaqueTECSnifferObjectRef=}^LL", b"i^^{OpaqueTECSnifferObjectRef=}^IQ"
        ),
        "",
        {
    ...
    "TECGetTextEncodingFromInternetNameOrMIB": (
        sel32or64(b"l^LL^{__CFString=}l", b"i^II^{__CFString=}i"),
        "",
        {"arguments": {0: {"type_modifier": "o"}, 2: {"type_modifier": "n"}}},
    ),
    "GetTextEncodingFromScriptInfo": (
        sel32or64(b"lsss^L", b"isss^I"),
        "",
    ...
    "RevertTextEncodingToScriptInfo": (
        sel32or64(b"lL^s^s[256C]", b"iI^s^s[256C]"),
        "",
        {
            "arguments": {
                1: {"type_modifier": "o"},
    ...
    "TECCountWebTextEncodings": (
        sel32or64(b"ls^L", b"is^Q"),
        "",
        {"arguments": {1: {"type_modifier": "o"}}},
    ),
    "UCIsSurrogateLowCharacter": (b"ZT",),
    "TECCreateOneToManyConverter": (
        sel32or64(b"l^^{OpaqueTECObjectRef=}LL^L", b"i^^{OpaqueTECObjectRef=}IQ^I"),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "TECSniffTextEncoding": (
        sel32or64(
            b"l^{OpaqueTECSnifferObjectRef=}^CL^LL^LL^LL",
    ...
    "TECGetInfo": (
        sel32or64(b"l^^^{TECInfo=SSLLL[32C][32C]SS}", b"i^^^{TECInfo=SSIII[32C][32C]SS}"),
        "",
        {"arguments": {0: {"type_modifier": "o"}}},
    ),
    "CreateTextEncoding": (
        sel32or64(b"LLLL", b"IIII"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "TECCountDirectTextEncodingConversions": (
        sel32or64(b"l^L", b"i^Q"),
        "",
        {"arguments": {0: {"type_modifier": "o"}}},
    ),
    "TECGetTextEncodingInternetName": (
        sel32or64(b"lL[256C]", b"iI[256C]"),
        "",
        {"arguments": {1: {"type_modifier": "o"}}},
    ),
    ...
    "ResolveDefaultTextEncoding": (sel32or64(b"LL", b"II"),),
    "LocaleRefFromLocaleString": (
        sel32or64(b"l^t^^{OpaqueLocaleRef=}", b"i^t^^{OpaqueLocaleRef=}"),
        "",
        {
            "arguments": {
                0: {"c_array_delimited_by_null": True, "type_modifier": "n"},
    ...
    "GetTextEncodingBase": (sel32or64(b"LL", b"II"),),
    "TECGetAvailableSniffers": (
        sel32or64(b"l^LL^L", b"i^IQ^Q"),
        "",
        {
            "arguments": {
    ...
    "TECSetBasicOptions": (
        sel32or64(b"l^{OpaqueTECObjectRef=}L", b"i^{OpaqueTECObjectRef=}I"),
    ),
    "CSBackupSetItemExcluded": (sel32or64(b"l^{__CFURL=}ZZ", b"i^{__CFURL=}ZZ"),),
    "CSDiskSpaceGetRecoveryEstimate": (b"Q^{__CFURL=}",),
    "LocaleOperationCountNames": (sel32or64(b"lL^L", b"iI^Q"),),
    "TECDisposeSniffer": (
        sel32or64(b"l^{OpaqueTECSnifferObjectRef=}", b"i^{OpaqueTECSnifferObjectRef=}"),
    ),
    "TECConvertTextToMultipleEncodings": (
        sel32or64(
            b"l^{OpaqueTECObjectRef=}^CL^L^CL^L^{TextEncodingRun=LL}L^L",
    ...
    "TECFlushText": (
        sel32or64(b"l^{OpaqueTECObjectRef=}^CL^L", b"i^{OpaqueTECObjectRef=}^CQ^Q"),
        "",
        {
            "arguments": {
                1: {"c_array_length_in_arg": (2, 3), "type_modifier": "o"},
    ...
    "TECFlushMultipleEncodings": (
        sel32or64(
            b"l^{OpaqueTECObjectRef=}^CL^L^{TextEncodingRun=LL}L^L",
    ...
    "UpgradeScriptInfoToTextEncoding": (
        sel32or64(b"lsss^C^L", b"isss^C^I"),
        "",
    ...
    "UCGetUnicodeScalarValueForSurrogatePair": (sel32or64(b"LTT", b"ITT"),),
    "UCIsSurrogateHighCharacter": (b"ZT",),
    "TECCountSubTextEncodings": (
        sel32or64(b"lL^L", b"iI^Q"),
        "",
        {"arguments": {1: {"type_modifier": "o"}}},
    ),
    "TECConvertText": (
        sel32or64(
            b"l^{OpaqueTECObjectRef=}^CL^L^CL^L", b"i^{OpaqueTECObjectRef=}^CQ^Q^CQ^Q"
        ),
        "",
        {
            "arguments": {
    ...
    "TECGetDirectTextEncodingConversions": (
        sel32or64(b"l^{TECConversionInfo=LLSS}L^L", b"i^{TECConversionInfo=IISS}Q^Q"),
        "",
        {
            "arguments": {
                0: {"c_array_length_in_arg": (1, 2), "type_modifier": "o"},
    ...
    "GetTextEncodingName": (
        sel32or64(b"lLLsLL^L^s^L^t", b"iIIsIQ^Q^s^I^t"),
        "",
        {
            "arguments": {
    ...
    "LocaleRefGetPartString": (
        sel32or64(b"l^{OpaqueLocaleRef=}LL^c", b"i^{OpaqueLocaleRef=}IQ^c"),
        "",
        {"arguments": {3: {"c_array_delimited_by_null": True, "type_modifier": "o"}}},
    ),
    "TECGetSubTextEncodings": (
        sel32or64(b"lL^LL^L", b"iI^IQ^Q"),
        "",
        {
            "arguments": {
                1: {"c_array_length_in_arg": (2, 3), "type_modifier": "o"},
    ...
    "TECCopyTextEncodingInternetNameAndMIB": (
        sel32or64(b"lLL^^{__CFString=}^l", b"iII^^{__CFString=}^i"),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "LocaleRefFromLangOrRegionCode": (
        sel32or64(b"lss^^{OpaqueLocaleRef=}", b"iss^^{OpaqueLocaleRef=}"),
        "",
        {"arguments": {2: {"type_modifier": "o"}}},
    ),
    "TECCreateConverterFromPath": (
        sel32or64(b"l^^{OpaqueTECObjectRef=}^LL", b"i^^{OpaqueTECObjectRef=}^IQ"),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "TECCreateConverter": (
        sel32or64(b"l^^{OpaqueTECObjectRef=}LL", b"i^^{OpaqueTECObjectRef=}II"),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {0: {"type_modifier": "o"}},
    ...
    "LocaleOperationGetName": (
        sel32or64(b"lL^{OpaqueLocaleRef=}L^L^t", b"iI^{OpaqueLocaleRef=}Q^Q^t"),
        "",
        {
            "arguments": {
                3: {"type_modifier": "o"},
    ...
    "ConvertBundlePreLocator": (
        b"s^{CFragSystem7Locator=l(_union CFragSystem7Locator::(anonymous at /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.13.sdk/System/Library/Frameworks/CoreServices.framework/Frameworks/CarbonCore.framework/Headers/CodeFragments.h:508:3)={CFragSystem7DiskFlatLocator=^{FSSpec}II}{CFragSystem7MemoryLocator=^vICCS}{CFragSystem7SegmentedLocator=^{FSSpec}IsS}{CFragCFBundleLocator=^{__CFBundle}II})(={CFragSystem7DiskFlatLocator=^{FSSpec}II}{CFragSystem7MemoryLocator=^vICCS}{CFragSystem7SegmentedLocator=^{FSSpec}IsS}{CFragCFBundleLocator=^{__CFBundle}II})}",
    ),
    "LocaleOperationGetIndName": (
        sel32or64(b"lLLL^L^t^^{OpaqueLocaleRef=}", b"iIQQ^Q^t^^{OpaqueLocaleRef=}"),
        "",
        {
            "arguments": {
                3: {"type_modifier": "o"},
