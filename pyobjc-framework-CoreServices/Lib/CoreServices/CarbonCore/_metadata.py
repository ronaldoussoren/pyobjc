...
functions = {
    ...
    "GetTextEncodingName": (
        ...
        {
            "arguments": {
                8: {"type_modifier": "o", "c_array_length_in_arg": (4, 5)},
                5: {"type_modifier": "o"},
                6: {"type_modifier": "o"},
                7: {"type_modifier": "o"},
            }
    ...
    "LocaleOperationGetName": (
        ...
        "",
        {
            "arguments": {
                3: {"type_modifier": "o"},
                4: {"type_modifier": "o", "c_array_length_in_arg": (2, 3)},
            }
        },
    ),
