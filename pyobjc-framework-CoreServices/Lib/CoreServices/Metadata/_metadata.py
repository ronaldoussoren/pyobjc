...
#
# Last update: Sun Aug  4 16:07:38 2019
...
misc.update(
    {
        "MDQueryBatchingParams": objc.createStructType(
            ...
            sel32or64(
                b"{_MDQueryBatchingParams=LLLLLL}", b"{_MDQueryBatchingParams=QQQQQQ}"
            ),
            [
                "first_max_num",
                "first_max_ms",
...
functions = {
    ...
    "MDLabelGetTypeID": (sel32or64(b"L", b"Q"),),
    "MDQueryGetAttributeValueOfResultAtIndex": (
        sel32or64(b"@^{__MDQuery=}^{__CFString=}l", b"@^{__MDQuery=}^{__CFString=}q"),
    ),
    ...
    "MDQueryGetIndexOfResult": (sel32or64(b"l^{__MDQuery=}@", b"q^{__MDQuery=}@"),),
    ...
    "MDQueryGetBatchingParameters": (
        sel32or64(
            b"{_MDQueryBatchingParams=LLLLLL}^{__MDQuery=}",
            b"{_MDQueryBatchingParams=QQQQQQ}^{__MDQuery=}",
        ),
    ),
    "MDCopyLabelWithUUID": (
    ...
    "MDQuerySetMaxCount": (sel32or64(b"v^{__MDQuery=}l", b"v^{__MDQuery=}q"),),
    ...
    "MDQuerySetCreateValueFunction": (
        sel32or64(
            b"v^{__MDQuery=}^?^v^{_CFArrayCallBacks=l^?^?^?^?}",
    ...
    "MDQuerySetSearchScope": (
        sel32or64(b"v^{__MDQuery=}^{__CFArray=}L", b"v^{__MDQuery=}^{__CFArray=}I"),
    ),
    ...
    "MDQueryExecute": (sel32or64(b"Z^{__MDQuery=}L", b"Z^{__MDQuery=}Q"),),
    "MDQuerySetDispatchQueue": (b"v^{__MDQuery=}@",),
    "MDLabelSetAttributes": (b"Z^{__MDLabel=}^{__CFDictionary=}",),
    "MDItemGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "MDQuerySetBatchingParameters": (
        sel32or64(
            b"v^{__MDQuery=}{_MDQueryBatchingParams=LLLLLL}",
            b"v^{__MDQuery=}{_MDQueryBatchingParams=QQQQQQ}",
        ),
    ),
    "MDQueryCreateSubset": (
    ...
    "MDQueryGetTypeID": (sel32or64(b"L", b"Q"),),
    "MDItemCreateWithURL": (
    ...
    "MDQueryGetCountOfResultsWithAttributeValue": (
        sel32or64(b"l^{__MDQuery=}^{__CFString=}@", b"q^{__MDQuery=}^{__CFString=}@"),
    ),
