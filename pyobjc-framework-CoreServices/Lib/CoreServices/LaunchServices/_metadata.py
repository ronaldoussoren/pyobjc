...
#
# Last update: Sun Aug  4 16:07:27 2019
...
misc.update(
    {
        "LSItemInfoRecord": objc.createStructType(
            "LSItemInfoRecord",
            sel32or64(
                b"{LSItemInfoRecord=LLL^{__CFString=}^{__CFString=}L}",
                b"{LSItemInfoRecord=III^{__CFString=}}",
            ),
            sel32or64(
                ["flags", "filetype", "creator", "extension", "iconFileName", "kindID"],
        ...
        "LSLaunchFSRefSpec": objc.createStructType(
            "LSLaunchFSRefSpec",
            sel32or64(
                b"{LSLaunchFSRefSpec=^{FSRef=[80C]}L^{FSRef=[80C]}^{AEDesc=L^^{OpaqueAEDataStorageType=}}L^v}",
        ...
        "LSApplicationParameters": objc.createStructType(
            ...
            sel32or64(
                b"{LSApplicationParameters=lL^{FSRef=[80C]}^v^{__CFDictionary=}^{__CFArray=}^{AEDesc=L^^{OpaqueAEDataStorageType=}}}",
        ...
        "LSLaunchURLSpec": objc.createStructType(
            "LSLaunchURLSpec",
            sel32or64(
                b"{LSLaunchURLSpec=^{__CFURL=}^{__CFArray=}^{AEDesc=L^^{OpaqueAEDataStorageType=}}L^v}",
...
functions = {
    ...
    "LSCopyItemInfoForRef": (
        sel32or64(
            b"l^{FSRef=[80C]}L^{LSItemInfoRecord=LLL^{__CFString=}^{__CFString=}L}",
    ...
    "GetIconRefFromTypeInfo": (
        sel32or64(
            b"sLL^{__CFString=}^{__CFString=}L^^{OpaqueIconRef=}",
    ...
    "ReadIconFromFSRef": (
        sel32or64(
            b"l^{FSRef=[80C]}^^^{IconFamilyResource=Ll[1{IconFamilyElement=Ll[1C]}]}",
    ...
    "LSSharedFileListRemoveAllItems": (
        sel32or64(b"l^{OpaqueLSSharedFileListRef=}", b"i^{OpaqueLSSharedFileListRef=}"),
    ),
    "LSCopyItemAttribute": (
        sel32or64(
    ...
    "LSSharedFileListItemMove": (
        sel32or64(
            b"l^{OpaqueLSSharedFileListRef=}^{OpaqueLSSharedFileListItemRef=}^{OpaqueLSSharedFileListItemRef=}",
            b"i^{OpaqueLSSharedFileListRef=}^{OpaqueLSSharedFileListItemRef=}^{OpaqueLSSharedFileListItemRef=}",
        ),
    ),
    "LSSetDefaultRoleHandlerForContentType": (
        sel32or64(b"l^{__CFString=}L^{__CFString=}", b"i^{__CFString=}I^{__CFString=}"),
    ),
    "LSSetHandlerOptionsForContentType": (
        sel32or64(b"l^{__CFString=}L", b"i^{__CFString=}I"),
    ),
    "LSSharedFileListGetTypeID": (sel32or64(b"L", b"Q"),),
    "LSInit": (sel32or64(b"lL", b"iI"),),
    ...
    "LSCopyAllRoleHandlersForContentType": (
        sel32or64(b"^{__CFArray=}^{__CFString=}L", b"^{__CFArray=}^{__CFString=}I"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "IsDataAvailableInIconRef": (
        sel32or64(b"ZL^{OpaqueIconRef=}", b"ZI^{OpaqueIconRef=}"),
    ),
    "IsValidIconRef": (b"Z^{OpaqueIconRef=}",),
    "LSCanRefAcceptItem": (
        sel32or64(
            b"l^{FSRef=[80C]}^{FSRef=[80C]}LL^Z", b"i^{FSRef=[80C]}^{FSRef=[80C]}II^Z"
        ),
        "",
        {
            "arguments": {
    ...
    "LSCopyKindStringForTypeInfo": (
        sel32or64(
            b"lLL^{__CFString=}^^{__CFString=}", b"iII^{__CFString=}^^{__CFString=}"
        ),
        "",
        {
            "retval": {"already_cfretained": True},
    ...
    "FlushIconRefs": (b"sLL",),
    "LSSetExtensionHiddenForURL": (sel32or64(b"l^{__CFURL=}Z", b"i^{__CFURL=}Z"),),
    "LSOpenFSRef": (
        sel32or64(b"l^{FSRef=[80C]}^{FSRef=[80C]}", b"i^{FSRef=[80C]}^{FSRef=[80C]}"),
        "",
    ...
    "RegisterIconRefFromIconFile": (
        b"sLL^{FSSpec=sl[64C]}^^{OpaqueIconRef=}",
        "",
    ...
    "LSSharedFileListItemSetProperty": (
        sel32or64(
            b"l^{OpaqueLSSharedFileListItemRef=}^{__CFString=}@",
    ...
    "LSGetApplicationForInfo": (
        sel32or64(
            b"lLL^{__CFString=}L^{FSRef=[80C]}^^{__CFURL=}",
    ...
    "LSSharedFileListItemGetTypeID": (sel32or64(b"L", b"Q"),),
    "GetIconRefFromComponent": (
        sel32or64(
            b"l^{ComponentRecord=[1l]}^^{OpaqueIconRef=}",
    ...
    "LSSharedFileListSetProperty": (
        sel32or64(
            b"l^{OpaqueLSSharedFileListRef=}^{__CFString=}@",
            b"i^{OpaqueLSSharedFileListRef=}^{__CFString=}@",
        ),
    ),
    "LSSharedFileListItemCopyResolvedURL": (
        sel32or64(
            b"^{__CFURL=}^{OpaqueLSSharedFileListItemRef=}L^^{__CFError=}",
    ...
    "LSCopyApplicationForMIMEType": (
        sel32or64(b"l^{__CFString=}L^^{__CFURL=}", b"i^{__CFString=}I^^{__CFURL=}"),
        "",
        {
            "retval": {"already_cfretained": True},
    ...
    "LSSharedFileListItemResolve": (
        sel32or64(
            b"l^{OpaqueLSSharedFileListItemRef=}L^^{__CFURL=}^{FSRef=[80C]}",
    ...
    "GetIconRefFromIconFamilyPtr": (
        sel32or64(
            b"l^{IconFamilyResource=Ll[1{IconFamilyElement=Ll[1C]}]}l^^{OpaqueIconRef=}",
    ...
    "WriteIconFile": (
        b"s^^{IconFamilyResource=Ll[1{IconFamilyElement=Ll[1C]}]}^{FSSpec=sl[64C]}",
    ),
    ...
    "LSCanURLAcceptURL": (
        sel32or64(b"l^{__CFURL=}^{__CFURL=}LL^Z", b"i^{__CFURL=}^{__CFURL=}II^Z"),
        "",
        {"arguments": {4: {"type_modifier": "o"}}},
    ),
    "GetIconRefFromFile": (
        b"s^{FSSpec=sl[64C]}^^{OpaqueIconRef=}^s",
        "",
    ...
    "LSSharedFileListSetAuthorization": (
        sel32or64(
            b"l^{OpaqueLSSharedFileListRef=}^{AuthorizationOpaqueRef=}",
            b"i^{OpaqueLSSharedFileListRef=}^{AuthorizationOpaqueRef=}",
        ),
    ),
    "LSOpenItemsWithRole": (
        sel32or64(
            b"l^{FSRef=[80C]}lL^{AEKeyDesc=L{AEDesc=L^^{OpaqueAEDataStorageType=}}}^{LSApplicationParameters=lL^{FSRef=[80C]}^v^{__CFDictionary=}^{__CFArray=}^{AEDesc=L^^{OpaqueAEDataStorageType=}}}^{ProcessSerialNumber=LL}l",
    ...
    "RegisterIconRefFromResource": (b"sLL^{FSSpec=sl[64C]}s^^{OpaqueIconRef=}",),
    "LSSharedFileListGetSeedValue": (
        sel32or64(b"L^{OpaqueLSSharedFileListRef=}", b"I^{OpaqueLSSharedFileListRef=}"),
    ),
    "LSOpenApplication": (
        sel32or64(
            b"l^{LSApplicationParameters=lL^{FSRef=[80C]}^v^{__CFDictionary=}^{__CFArray=}^{AEDesc=L^^{OpaqueAEDataStorageType=}}}^{ProcessSerialNumber=LL}",
    ...
    "LSGetApplicationForItem": (
        sel32or64(
            b"l^{FSRef=[80C]}L^{FSRef=[80C]}^^{__CFURL=}",
    ...
    "LSSetDefaultHandlerForURLScheme": (
        sel32or64(b"l^{__CFString=}^{__CFString=}", b"i^{__CFString=}^{__CFString=}"),
    ),
    "GetIconRef": (
        sel32or64(b"ssLL^^{OpaqueIconRef=}", b"ssII^^{OpaqueIconRef=}"),
        "",
        {"arguments": {3: {"type_modifier": "o"}}},
    ),
    "LSRegisterURL": (sel32or64(b"l^{__CFURL=}Z", b"i^{__CFURL=}Z"),),
    "GetIconRefOwners": (
        b"s^{OpaqueIconRef=}^S",
        "",
        {"arguments": {1: {"type_modifier": "o"}}},
    ...
    "LSCopyDefaultApplicationURLForContentType": (
        sel32or64(
            b"^{__CFURL=}^{__CFString=}L^^{__CFError=}",
    ...
    "ReadIconFile": (
        b"s^{FSSpec=sl[64C]}^^^{IconFamilyResource=Ll[1{IconFamilyElement=Ll[1C]}]}",
    ),
    ...
    "UTGetOSTypeFromString": (sel32or64(b"L^{__CFString=}", b"I^{__CFString=}"),),
    "LSGetApplicationForURL": (
        sel32or64(
            b"l^{__CFURL=}L^{FSRef=[80C]}^^{__CFURL=}",
    ...
    "LSOpenURLsWithRole": (
        sel32or64(
            b"l^{__CFArray=}L^{AEKeyDesc=L{AEDesc=L^^{OpaqueAEDataStorageType=}}}^{LSApplicationParameters=lL^{FSRef=[80C]}^v^{__CFDictionary=}^{__CFArray=}^{AEDesc=L^^{OpaqueAEDataStorageType=}}}^{ProcessSerialNumber=LL}l",
    ...
    "LSCopyDefaultRoleHandlerForContentType": (
        sel32or64(b"^{__CFString=}^{__CFString=}L", b"^{__CFString=}^{__CFString=}I"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "UnregisterIconRef": (sel32or64(b"sLL", b"sII"),),
    "LSOpenFromURLSpec": (
        sel32or64(
            b"l^{LSLaunchURLSpec=^{__CFURL=}^{__CFArray=}^{AEDesc=L^^{OpaqueAEDataStorageType=}}L^v}^^{__CFURL=}",
    ...
    "LSRegisterFSRef": (
        sel32or64(b"l^{FSRef=[80C]}Z", b"i^{FSRef=[80C]}Z"),
        "",
        {"arguments": {0: {"type_modifier": "n"}}},
    ),
    "LSSetItemAttribute": (
    ...
    "LSCopyKindStringForRef": (
        sel32or64(b"l^{FSRef=[80C]}^^{__CFString=}", b"i^{FSRef=[80C]}^^{__CFString=}"),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "RegisterIconRefFromIconFamily": (
        sel32or64(
            b"sLL^^{IconFamilyResource=Ll[1{IconFamilyElement=Ll[1C]}]}^^{OpaqueIconRef=}",
    ...
    "LSCopyDisplayNameForURL": (
        sel32or64(b"l^{__CFURL=}^^{__CFString=}", b"i^{__CFURL=}^^{__CFString=}"),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {1: {"already_cfretained": True, "type_modifier": "o"}},
    ...
    "GetIconRefFromFolder": (
        sel32or64(b"ssllcc^^{OpaqueIconRef=}", b"ssiicc^^{OpaqueIconRef=}"),
        "",
        {"arguments": {5: {"type_modifier": "o"}}},
    ),
    ...
    "OverrideIconRefFromResource": (b"s^{OpaqueIconRef=}^{FSSpec=sl[64C]}s",),
    "LSGetExtensionInfo": (
        sel32or64(b"lL^T^L", b"iQ^T^Q"),
        "",
        {
            "arguments": {
    ...
    "GetIconRefFromFileInfo": (
        sel32or64(
            b"l^{FSRef=[80C]}L^TL^{FSCatalogInfo=SsLLCCCC{UTCDateTime=SLS}{UTCDateTime=SLS}{UTCDateTime=SLS}{UTCDateTime=SLS}{UTCDateTime=SLS}[4L][16C][16C]QQQQLL}L^^{OpaqueIconRef=}^s",
    ...
    "FlushIconRefsByVolume": (b"ss",),
    "GetCustomIconsEnabled": (b"ss^Z", "", {"arguments": {1: {"type_modifier": "o"}}}),
    "LSCopyItemInfoForURL": (
        sel32or64(
            b"l^{__CFURL=}L^{LSItemInfoRecord=LLL^{__CFString=}^{__CFString=}L}",
    ...
    "LSFindApplicationForInfo": (
        sel32or64(
            b"lL^{__CFString=}^{__CFString=}^{FSRef=[80C]}^^{__CFURL=}",
    ...
    "LSOpenFromRefSpec": (
        sel32or64(
            b"l^{LSLaunchFSRefSpec=^{FSRef=[80C]}L^{FSRef=[80C]}^{AEDesc=L^^{OpaqueAEDataStorageType=}}L^v}^{FSRef=[80C]}",
    ...
    "LSSharedFileListItemRemove": (
        sel32or64(
            b"l^{OpaqueLSSharedFileListRef=}^{OpaqueLSSharedFileListItemRef=}",
    ...
    "LSCopyApplicationURLsForURL": (
        sel32or64(b"^{__CFArray=}^{__CFURL=}L", b"^{__CFArray=}^{__CFURL=}I"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "LSOpenCFURLRef": (
        sel32or64(b"l^{__CFURL=}^^{__CFURL=}", b"i^{__CFURL=}^^{__CFURL=}"),
        "",
        {"arguments": {1: {"already_cfretained": True, "type_modifier": "o"}}},
    ),
    "LSSharedFileListCopySnapshot": (
        sel32or64(
            b"^{__CFArray=}^{OpaqueLSSharedFileListRef=}^L",
    ...
    "LSSharedFileListItemGetID": (
        sel32or64(
            b"L^{OpaqueLSSharedFileListItemRef=}", b"I^{OpaqueLSSharedFileListItemRef=}"
        ),
    ),
}
aliases = {
