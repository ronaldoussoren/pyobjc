...
class TestFolders (TestCase):
    ...
    def test_not_wrapped(self):
        ...
        self.assert_not_wrapped('kFolderManagerFolderInMacOS9FolderIfMacOSXIsInstalledMask')
        self.assert_not_wrapped('kFolderManagerFolderInMacOS9FolderIfMacOSXIsInstalledBit')
        ...
        self.assert_not_wrapped('kFolderManagerNewlyCreatedFolderShouldHaveDotLocalizedCreatedWithinMask')
