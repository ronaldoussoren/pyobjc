...
class TestLSInfo (TestCase):
    ...
    def testFunctions(self):
        ...
        ok, info = CoreServices.LSCopyItemInfoForURL(url, CoreServices.kLSRequestExtension|CoreServices.kLSRequestTypeCreator, None)
        ...
        ok, status = CoreServices.LSCanURLAcceptURL(url, url, CoreServices.kLSRolesAll, CoreServices.kLSAcceptDefault, None)
        self.assertIsInstance(ok, (int, long))
        ...
        default_role = CoreServices.LSCopyDefaultRoleHandlerForContentType("public.plain-text", CoreServices.kLSRolesAll)
        ...
        v = CoreServices.LSCopyAllRoleHandlersForContentType("public.plain-text", CoreServices.kLSRolesAll)
        self.assertIsInstance(v, CoreServices.CFArrayRef)
        for a in v:
            self.assertIsInstance(a, unicode)


        ok = CoreServices.LSSetDefaultRoleHandlerForContentType("public.plain-text", CoreServices.kLSRolesAll, default_role)
        self.assertIsInstance(ok, (int, long))
    ...
    def testFSRef(self):
        ...
        ok, info = CoreServices.LSCopyItemInfoForRef(ref, CoreServices.kLSRequestExtension|CoreServices.kLSRequestTypeCreator, None)
        self.assertEqual(ok, 0)
        self.assertIsInstance(info, CoreServices.LSItemInfoRecord)
        ...
        ok = CoreServices.LSSetItemAttribute(ref, CoreServices.kLSRolesAll, CoreServices.kLSItemRoleHandlerDisplayName, b"foo".decode('latin1'))
        self.assertIsInstance(ok, (int, long))
    ...
    def testFunctions10_10(self):
        ...
        self.assertResultIsCFRetained(CoreServices.LSCopyDefaultApplicationURLForContentType)
        self.assertArgIsOut(CoreServices.LSCopyDefaultApplicationURLForContentType, 2)

        self.assertResultIsCFRetained(CoreServices.LSCopyApplicationURLsForBundleIdentifier)
