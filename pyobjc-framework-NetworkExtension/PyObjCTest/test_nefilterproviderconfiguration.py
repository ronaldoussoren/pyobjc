...
if sys.maxsize >= 2 ** 32:
    ...
    class NEFilterProviderConfiguration (TestCase):
        ...
        def testMethods10_15(self):
            self.assertResultIsBOOL(NetworkExtension.NEFilterProviderConfiguration.filterPackets)
            self.assertArgIsBOOL(NetworkExtension.NEFilterProviderConfiguration.setFilterPackets_, 0)
