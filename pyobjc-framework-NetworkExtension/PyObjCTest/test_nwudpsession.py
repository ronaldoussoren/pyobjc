...
if sys.maxsize >= 2 ** 32:
    ...
    class TestNWTCPConnection (TestCase):
        ...
        def testMethods(self):
            ...
            self.assertArgIsBlock(NetworkExtension.NWUDPSession.setReadHandler_maxDatagrams_, 0, b'v@@')
            self.assertArgIsBlock(NetworkExtension.NWUDPSession.writeDatagram_completionHandler_, 1, b'v@')
