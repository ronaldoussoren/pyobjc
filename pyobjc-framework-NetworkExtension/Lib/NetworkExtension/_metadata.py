...
misc.update(
    {
        ...
        "NEPacketTunnelNetworkSettingsIPFamily": NewType(
            "NEPacketTunnelNetworkSettingsIPFamily", int
        ),
...
try:
    ...
    r(b"NEAppPushManager", b"matchMissionCriticalService", {"retval": {"type": b"Z"}})
    r(
        b"NEAppPushManager",
    ...
    r(
        b"NEAppPushManager",
        b"setMatchMissionCriticalService:",
    ...
    r(b"NEPacketTunnelNetworkSettings", b"enforceRoutes", {"retval": {"type": b"Z"}})
    r(b"NEPacketTunnelNetworkSettings", b"excludeAPNs", {"retval": {"type": b"Z"}})
    r(
        b"NEPacketTunnelNetworkSettings",
        b"excludeCellularServices",
        {"retval": {"type": b"Z"}},
    )
    r(
        b"NEPacketTunnelNetworkSettings",
        b"excludeDeviceCommunication",
        {"retval": {"type": b"Z"}},
    )
    r(
        b"NEPacketTunnelNetworkSettings",
...
expressions = {}
formal_protocols = {
    "NEAppPushDelegate": "NEAppPushDelegate",
    "NWTCPConnectionAuthenticationDelegate": "NWTCPConnectionAuthenticationDelegate",
}
