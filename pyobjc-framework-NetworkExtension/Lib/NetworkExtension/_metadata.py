...
#
# Last update: Sat Jul 23 10:02:58 2016
...
try:
    ...
    r(b'NEProvider', b'displayMessage:completionHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'Z'}}}, 'type': '@?'}}})
