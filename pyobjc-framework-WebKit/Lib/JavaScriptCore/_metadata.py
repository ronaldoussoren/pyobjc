...
functions = {
    ...
    "JSObjectGetTypedArrayByteOffset": (
        sel32or64(
            b"L^{OpaqueJSContext=}^{OpaqueJSValue=}^^{OpaqueJSValue=}",
    ...
    "JSObjectMakeError": (
        sel32or64(
            b"^{OpaqueJSValue=}^{OpaqueJSContext=}L^^{OpaqueJSValue=}^^{OpaqueJSValue=}",
    ...
    "JSObjectCallAsFunction": (
        sel32or64(
            b"^{OpaqueJSValue=}^{OpaqueJSContext=}^{OpaqueJSValue=}^{OpaqueJSValue=}L^^{OpaqueJSValue=}^^{OpaqueJSValue=}",
    ...
    "JSPropertyNameArrayGetCount": (
        sel32or64(b"L^{OpaqueJSPropertyNameArray=}", b"Q^{OpaqueJSPropertyNameArray=}"),
    ),
    "JSStringGetLength": (sel32or64(b"L^{OpaqueJSString=}", b"Q^{OpaqueJSString=}"),),
    "JSValueToObject": (
    ...
    "JSStringGetMaximumUTF8CStringSize": (
        sel32or64(b"L^{OpaqueJSString=}", b"Q^{OpaqueJSString=}"),
    ),
    "JSStringCreateWithCharacters": (
        sel32or64(b"^{OpaqueJSString=}^TL", b"^{OpaqueJSString=}^TQ"),
        "",
        {
            "retval": {"already_cfretained": True},
    ...
    "JSObjectMakeTypedArrayWithArrayBufferAndOffset": (
        sel32or64(
            b"^{OpaqueJSValue=}^{OpaqueJSContext=}I^{OpaqueJSValue=}LL^^{OpaqueJSValue=}",
    ...
    "JSObjectCallAsConstructor": (
        sel32or64(
            b"^{OpaqueJSValue=}^{OpaqueJSContext=}^{OpaqueJSValue=}L^^{OpaqueJSValue=}^^{OpaqueJSValue=}",
    ...
    "JSStringGetUTF8CString": (
        sel32or64(b"L^{OpaqueJSString=}^tL", b"Q^{OpaqueJSString=}^tQ"),
        "",
        {
            "arguments": {
                1: {
    ...
    "JSObjectMakeArrayBufferWithBytesNoCopy": (
        sel32or64(
            b"^{OpaqueJSValue=}^{OpaqueJSContext=}^vL^?^v^^{OpaqueJSValue=}",
    ...
    "JSPropertyNameArrayGetNameAtIndex": (
        sel32or64(
            b"^{OpaqueJSString=}^{OpaqueJSPropertyNameArray=}L",
