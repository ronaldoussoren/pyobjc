...
#
# Last update: Tue Sep 22 23:26:41 2015
...
try:
    ...
    r(b'NSObject', b'webView:decidePolicyForNavigationAction:decisionHandler:', {'arguments': {4: {'typestr_override': '@?', 'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'i', b'q')}}}}}})
    r(b'NSObject', b'webView:decidePolicyForNavigationResponse:decisionHandler:', {'arguments': {4: {'typestr_override': '@?', 'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'i', b'q')}}}}}})
    r(b'NSObject', b'webView:didReceiveAuthenticationChallenge:completionHandler:', {'arguments': {4: {'typestr_override': '@?', 'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'i', b'q')}, 2: {'type': b'@'}}}}}})
    ...
    r(b'NSObject', b'webView:runJavaScriptAlertPanelWithMessage:initiatedByFrame:completionHandler:', {'arguments': {5: {'typestr_override': '@?', 'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    ...
    r(b'NSObject', b'webView:runJavaScriptConfirmPanelWithMessage:initiatedByFrame:completionHandler:', {'arguments': {5: {'typestr_override': '@?', 'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'NSObject', b'webView:runJavaScriptTextInputPanelWithPrompt:defaultText:initiatedByFrame:completionHandler:', {'arguments': {6: {'typestr_override': '@?', 'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
...
try:
    ...
    r(b'NSObject', b'webView:decidePolicyForNavigationAction:decisionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'typestr_override': '@?', 'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'i', b'q')}}}, 'type': b'@?'}}})
    r(b'NSObject', b'webView:decidePolicyForNavigationResponse:decisionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'typestr_override': '@?', 'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'i', b'q')}}}, 'type': b'@?'}}})
    ...
    r(b'NSObject', b'webView:didReceiveAuthenticationChallenge:completionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'typestr_override': '@?', 'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'i', b'q')}, 2: {'type': b'@'}}}, 'type': b'@?'}}})
    ...
    r(b'NSObject', b'webView:runJavaScriptAlertPanelWithMessage:initiatedByFrame:completionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'typestr_override': '@?', 'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}, 'type': b'@?'}}})
    r(b'NSObject', b'webView:runJavaScriptConfirmPanelWithMessage:initiatedByFrame:completionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'typestr_override': '@?', 'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}, 'type': b'@?'}}})
    r(b'NSObject', b'webView:runJavaScriptTextInputPanelWithPrompt:defaultText:initiatedByFrame:completionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}, 6: {'typestr_override': '@?', 'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}, 'type': b'@?'}}})
finally:
    objc._updatingMetadata(False)
r = objc.registerMetaDataForSelector
objc._updatingMetadata(True)
