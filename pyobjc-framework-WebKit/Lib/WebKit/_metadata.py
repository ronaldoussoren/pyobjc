...
#
# Last update: Tue Apr  6 21:18:42 2021
#
# flake8: noqa
...
try:
    ...
    r(b'NSAttributedString', b'loadFromHTMLWithData:options:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}}}})
    r(b'NSAttributedString', b'loadFromHTMLWithFileURL:options:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}}}})
    r(b'NSAttributedString', b'loadFromHTMLWithRequest:options:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}}}})
    r(b'NSAttributedString', b'loadFromHTMLWithString:options:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}}}})
    ...
    r(b'NSObject', b'cookiesDidChangeInCookieStore:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'didFailWithError:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'didFinish', {'required': True, 'retval': {'type': b'v'}})
    r(b'NSObject', b'didReceiveData:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'didReceiveResponse:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'download:decideDestinationUsingResponse:suggestedFilename:completionHandler:', {'arguments': {5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}, 'type': '@?'}}})
    r(b'NSObject', b'download:didReceiveAuthenticationChallenge:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'q'}, 2: {'type': b'@'}}}, 'type': '@?'}}})
    r(b'NSObject', b'download:willPerformHTTPRedirection:newRequest:decisionHandler:', {'arguments': {5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'q'}}}, 'type': '@?'}}})
    r(b'NSObject', b'downloadWindowForAuthenticationSheet:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'undoManagerForWebView:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'userContentController:didReceiveScriptMessage:replyHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}, 'type': '@?'}}})
    ...
    r(b'NSObject', b'webPlugInCallJava:isStatic:returnType:method:arguments:callingURL:exceptionDescription:', {'retval': {'type': b'(jvalue=CcSsiqfd^{_jobject=})'}, 'arguments': {2: {'type': '^{_jobject=}'}, 3: {'type': 'Z'}, 4: {'type': b'i'}, 5: {'type': '^{_jmethodID=}'}, 6: {'type': '^(jvalue=CcSsiqfd^{_jobject})'}, 7: {'type': b'@'}, 8: {'type': b'^@', 'type_modifier': b'o'}}})
    ...
    r(b'NSObject', b'webView:authenticationChallenge:shouldAllowDeprecatedTLS:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'Z'}}}, 'type': '@?'}}})
    r(b'NSObject', b'webView:contextMenuItemsForElement:defaultMenuItems:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:createWebViewModalDialogWithRequest:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    ...
    r(b'NSObject', b'webView:createWebViewWithRequest:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:decidePolicyForMIMEType:request:frame:decisionListener:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}, 6: {'type': b'@'}}})
    ...
    r(b'NSObject', b'webView:decidePolicyForNavigationAction:preferences:decisionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'q'}, 2: {'type': b'@'}}}, 'type': b'@?'}}})
    r(b'NSObject', b'webView:decidePolicyForNavigationAction:request:frame:decisionListener:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}, 6: {'type': b'@'}}})
    ...
    r(b'NSObject', b'webView:decidePolicyForNewWindowAction:request:newFrameName:decisionListener:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}, 6: {'type': b'@'}}})
    r(b'NSObject', b'webView:didCancelClientRedirectForFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:didChangeLocationWithinPageForFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:didClearWindowObject:forFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:didCommitLoadForFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:didCommitNavigation:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:didCreateJavaScriptContext:forFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:didFailLoadWithError:forFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:didFailNavigation:withError:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:didFailProvisionalLoadWithError:forFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    ...
    r(b'NSObject', b'webView:didFinishLoadForFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    ...
    r(b'NSObject', b'webView:didReceiveIcon:forFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:didReceiveServerRedirectForProvisionalLoadForFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    ...
    r(b'NSObject', b'webView:didReceiveTitle:forFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:didStartProvisionalLoadForFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:didStartProvisionalNavigation:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:doCommandBySelector:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': ':'}}})
    r(b'NSObject', b'webView:dragDestinationActionMaskForDraggingInfo:', {'required': False, 'retval': {'type': b'Q'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:dragSourceActionMaskForPoint:', {'required': False, 'retval': {'type': b'Q'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'{CGPoint=dd}'}}})
    r(b'NSObject', b'webView:drawFooterInRect:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'{CGRect={CGPoint=dd}{CGSize=dd}}'}}})
    r(b'NSObject', b'webView:drawHeaderInRect:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'{CGRect={CGPoint=dd}{CGSize=dd}}'}}})
    r(b'NSObject', b'webView:identifierForInitialRequest:fromDataSource:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:makeFirstResponder:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:mouseDidMoveOverElement:modifierFlags:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'Q'}}})
    r(b'NSObject', b'webView:plugInFailedWithError:dataSource:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:printFrameView:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:resource:didCancelAuthenticationChallenge:fromDataSource:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'webView:resource:didFailLoadingWithError:fromDataSource:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'webView:resource:didFinishLoadingFromDataSource:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:resource:didReceiveAuthenticationChallenge:fromDataSource:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'webView:resource:didReceiveContentLength:fromDataSource:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'q'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'webView:resource:didReceiveResponse:fromDataSource:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'webView:resource:willSendRequest:redirectResponse:fromDataSource:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}, 6: {'type': b'@'}}})
    r(b'NSObject', b'webView:runBeforeUnloadConfirmPanelWithMessage:initiatedByFrame:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:runJavaScriptAlertPanelWithMessage:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:runJavaScriptAlertPanelWithMessage:initiatedByFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    ...
    r(b'NSObject', b'webView:runJavaScriptConfirmPanelWithMessage:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:runJavaScriptConfirmPanelWithMessage:initiatedByFrame:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    ...
    r(b'NSObject', b'webView:runJavaScriptTextInputPanelWithPrompt:defaultText:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:runJavaScriptTextInputPanelWithPrompt:defaultText:initiatedByFrame:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    ...
    r(b'NSObject', b'webView:runOpenPanelForFileButtonWithResultListener:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:runOpenPanelForFileButtonWithResultListener:allowMultipleFiles:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': 'Z'}}})
    r(b'NSObject', b'webView:runOpenPanelWithParameters:initiatedByFrame:completionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}, 'type': '@?'}}})
    r(b'NSObject', b'webView:setContentRect:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'{CGRect={CGPoint=dd}{CGSize=dd}}'}}})
    r(b'NSObject', b'webView:setFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'{CGRect={CGPoint=dd}{CGSize=dd}}'}}})
    r(b'NSObject', b'webView:setResizable:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'Z'}}})
    r(b'NSObject', b'webView:setStatusBarVisible:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'Z'}}})
    r(b'NSObject', b'webView:setStatusText:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:setToolbarsVisible:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'Z'}}})
    r(b'NSObject', b'webView:shouldApplyStyle:toElementsInDOMRange:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:shouldBeginEditingInDOMRange:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:shouldChangeSelectedDOMRange:toDOMRange:affinity:stillSelecting:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'Q'}, 6: {'type': 'Z'}}})
    r(b'NSObject', b'webView:shouldChangeTypingStyle:toStyle:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:shouldDeleteDOMRange:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:shouldEndEditingInDOMRange:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:shouldInsertNode:replacingDOMRange:givenAction:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'q'}}})
    r(b'NSObject', b'webView:shouldInsertText:replacingDOMRange:givenAction:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'q'}}})
    r(b'NSObject', b'webView:shouldPerformAction:fromSender:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': ':'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:startURLSchemeTask:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:stopURLSchemeTask:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:unableToImplementPolicyWithError:frame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:validateUserInterfaceItem:defaultValidation:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': 'Z'}}})
    r(b'NSObject', b'webView:willCloseFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webView:willPerformClientRedirectToURL:delay:fireDate:forFrame:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'd'}, 5: {'type': b'@'}, 6: {'type': b'@'}}})
    r(b'NSObject', b'webView:willPerformDragDestinationAction:forDraggingInfo:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:willPerformDragSourceAction:fromPoint:withPasteboard:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}, 4: {'type': b'{CGPoint=dd}'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'webView:windowScriptObjectAvailable:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'webViewAreToolbarsVisible:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewClose:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewContentRect:', {'required': False, 'retval': {'type': b'{CGRect={CGPoint=dd}{CGSize=dd}}'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewDidBeginEditing:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewDidChange:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewDidChangeSelection:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewDidChangeTypingStyle:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewDidClose:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewDidEndEditing:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewFirstResponder:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewFocus:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewFooterHeight:', {'required': False, 'retval': {'type': b'f'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewFrame:', {'required': False, 'retval': {'type': b'{CGRect={CGPoint=dd}{CGSize=dd}}'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewHeaderHeight:', {'required': False, 'retval': {'type': b'f'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewIsResizable:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewIsStatusBarVisible:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewRunModal:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewShow:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewStatusText:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewUnfocus:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'webViewWebContentProcessDidTerminate:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'WKDownload', b'cancel:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    ...
    r(b'WKNavigationAction', b'setShouldPerformDownload:', {'arguments': {2: {'type': 'Z'}}})
    ...
    r(b'WKPreferences', b'setFraudulentWebsiteWarningEnabled:', {'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'WKPreferences', b'setTextInteractionEnabled:', {'arguments': {2: {'type': 'Z'}}})
    ...
    r(b'WKSnapshotConfiguration', b'setAfterScreenUpdates:', {'arguments': {2: {'type': 'Z'}}})
    r(b'WKUserScript', b'initWithSource:injectionTime:forMainFrameOnly:', {'arguments': {4: {'type': b'Z'}}})
    r(b'WKUserScript', b'initWithSource:injectionTime:forMainFrameOnly:inContentWorld:', {'arguments': {4: {'type': 'Z'}}})
    ...
    r(b'WKWebView', b'callAsyncJavaScript:arguments:inContentWorld:completionHandler:', {'arguments': {5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'WKWebView', b'callAsyncJavaScript:arguments:inFrame:inContentWorld:completionHandler:', {'arguments': {6: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'WKWebView', b'canGoBack', {'retval': {'type': b'Z'}})
    r(b'WKWebView', b'canGoForward', {'retval': {'type': b'Z'}})
    r(b'WKWebView', b'createPDFWithConfiguration:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'WKWebView', b'createWebArchiveDataWithCompletionHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    ...
    r(b'WKWebView', b'evaluateJavaScript:inContentWorld:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'WKWebView', b'evaluateJavaScript:inFrame:inContentWorld:completionHandler:', {'arguments': {5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'WKWebView', b'findString:withConfiguration:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    ...
    r(b'WKWebView', b'pauseAllMediaPlayback:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'WKWebView', b'requestMediaPlaybackState:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'q'}}}}}})
    r(b'WKWebView', b'resumeAllMediaPlayback:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'WKWebView', b'resumeDownloadFromResumeData:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    ...
    r(b'WKWebView', b'startDownloadUsingRequest:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'WKWebView', b'suspendAllMediaPlayback:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    ...
    r(b'WKWebViewConfiguration', b'limitsNavigationsToAppBoundDomains', {'retval': {'type': b'Z'}})
    ...
    r(b'WKWebViewConfiguration', b'setLimitsNavigationsToAppBoundDomains:', {'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'WKWebpagePreferences', b'setAllowsContentJavaScript:', {'arguments': {2: {'type': b'Z'}}})
