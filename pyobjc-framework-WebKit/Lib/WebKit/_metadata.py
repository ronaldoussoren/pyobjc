...
#
# Last update: Thu Jul  9 12:18:38 2026
#
# flake8: noqa
...
try:
    ...
    r(
        ...
        b"autofillScriptingEnabled",
        {"retval": {"type": b"Z"}},
    )
    r(
        b"WKContentWorldConfiguration",
        b"elementUserInfoEnabled",
        {"retval": {"type": b"Z"}},
    )
    r(b"WKContentWorldConfiguration", b"isInspectable", {"retval": {"type": b"Z"}})
    r(
        b"WKContentWorldConfiguration",
        b"jsHandleCreationEnabled",
        {"retval": {"type": b"Z"}},
    )
    r(
        b"WKContentWorldConfiguration",
        b"legacyBuiltinOverridesEnabled",
        {"retval": {"type": b"Z"}},
    )
    r(
        b"WKContentWorldConfiguration",
        b"nodeSerializationEnabled",
        {"retval": {"type": b"Z"}},
    )
    r(
        b"WKContentWorldConfiguration",
        b"openClosedShadowRootsEnabled",
        {"retval": {"type": b"Z"}},
    )
    r(
        b"WKContentWorldConfiguration",
    ...
    r(
        b"WKContentWorldConfiguration",
        b"setNodeSerializationEnabled:",
        {"arguments": {2: {"type": b"Z"}}},
    )
    r(
        b"WKContentWorldConfiguration",
        b"setOpenClosedShadowRootsEnabled:",
        {"arguments": {2: {"type": b"Z"}}},
    )
    r(
        b"WKDownload",
    ...
    r(
        b"WKPreferences",
        b"setSafeBrowsingEnabled:",
        {"arguments": {0: {"type_override": "Z"}}},
    )
    r(
        b"WKPreferences",
...
objc.registerNewKeywordsFromSelector("WKJSScriptingBuffer", b"init")
objc.registerNewKeywordsFromSelector("WKJSScriptingBuffer", b"initWithData:")
objc.registerNewKeywordsFromSelector("WKJSSerializedNode", b"init")
