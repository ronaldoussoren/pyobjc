...
#
# Last update: Fri May 25 17:45:41 2012
...
try:
    ...
    r(b'NSObject', b'acceptNode:', {'retval': {'type': 's'}})
    r(b'NSObject', b'addEventListener:::', {'arguments': {4: {'type': 'Z'}}})
    r(b'NSObject', b'addEventListener:listener:useCapture:', {'arguments': {4: {'type': 'Z'}}})
    r(b'NSObject', b'canProvideDocumentSource', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'dispatchEvent:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'removeEventListener:::', {'arguments': {4: {'type': 'Z'}}})
    r(b'NSObject', b'removeEventListener:listener:useCapture:', {'arguments': {4: {'type': 'Z'}}})
    r(b'NSObject', b'searchFor:direction:caseSensitive:wrap:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': 'Z'}, 4: {'type': 'Z'}, 5: {'type': 'Z'}}})
    r(b'NSObject', b'setNeedsLayout:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSObject', b'supportsTextEncoding', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'webPlugInCallJava:isStatic:returnType:method:arguments:callingURL:exceptionDescription:', {'arguments': {2: {'type': '^{_jobject=}'}, 3: {'type': 'Z'}, 5: {'type': '^{_jmethodID=}'}, 6: {'type': '^(jvalue=CcSsiqfd^{_jobject})'}, 8: {'type_modifier': b'o'}}})
    r(b'NSObject', b'webPlugInGetApplet', {'retval': {'type': '^{_jobject=}'}})
    r(b'NSObject', b'webPlugInSetIsSelected:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSObject', b'webScriptNameForKey:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type': 'n^t'}}})
    r(b'NSObject', b'webScriptNameForSelector:', {'arguments': {2: {'type': ':'}}})
    r(b'NSObject', b'webView:doCommandBySelector:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': ':'}}})
    r(b'NSObject', b'webView:runBeforeUnloadConfirmPanelWithMessage:initiatedByFrame:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'webView:runJavaScriptConfirmPanelWithMessage:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'webView:runJavaScriptConfirmPanelWithMessage:initiatedByFrame:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'webView:runOpenPanelForFileButtonWithResultListener:allowMultipleFiles:', {'arguments': {4: {'type': 'Z'}}})
    r(b'NSObject', b'webView:setResizable:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSObject', b'webView:setStatusBarVisible:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSObject', b'webView:setToolbarsVisible:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSObject', b'webView:shouldApplyStyle:toElementsInDOMRange:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'webView:shouldBeginEditingInDOMRange:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'webView:shouldChangeSelectedDOMRange:toDOMRange:affinity:stillSelecting:', {'retval': {'type': 'Z'}, 'arguments': {6: {'type': 'Z'}}})
    r(b'NSObject', b'webView:shouldChangeTypingStyle:toStyle:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'webView:shouldDeleteDOMRange:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'webView:shouldEndEditingInDOMRange:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'webView:shouldInsertNode:replacingDOMRange:givenAction:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'webView:shouldInsertText:replacingDOMRange:givenAction:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'webView:shouldPerformAction:fromSender:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': ':'}}})
    r(b'NSObject', b'webView:validateUserInterfaceItem:defaultValidation:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': 'Z'}}})
    r(b'NSObject', b'webViewAreToolbarsVisible:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'webViewIsResizable:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'webViewIsStatusBarVisible:', {'retval': {'type': 'Z'}})
...
try:
    ...
    r(b'NSObject', b'webView:shouldInsertNode:replacingDOMRange:givenAction:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'i'}}})
    r(b'NSObject', b'webView:shouldInsertText:replacingDOMRange:givenAction:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'i'}}})
    ...
    r(b'NSObject', b'webView:willPerformDragDestinationAction:forDraggingInfo:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'i'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'webView:willPerformDragSourceAction:fromPoint:withPasteboard:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'i'}, 4: {'type': sel32or64(b'{_NSPoint=ff}', b'{CGPoint=dd}')}, 5: {'type': b'@'}}})
