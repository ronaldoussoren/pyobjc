...
#
# Last update: Wed Feb 20 11:33:49 2019
...
try:
    ...
    r(b'WKPreferences', b'isSafeBrowsingEnabled', {'retval': {'type': 'Z'}})
    ...
    r(b'WKPreferences', b'setSafeBrowsingEnabled:', {'arguments': {2: {'type': 'Z'}}})
