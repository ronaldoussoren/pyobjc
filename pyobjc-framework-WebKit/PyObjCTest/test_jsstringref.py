...
class TestJSBase (TestCase):
    def test_functions(self):
        ...
        self.assertArgHasType(JavaScriptCore.JSStringRetain, 0, JavaScriptCore.JSStringRef.__typestr__)

        self.assertArgHasType(JavaScriptCore.JSStringRelease, 0, JavaScriptCore.JSStringRef.__typestr__)
        self.assertArgHasType(JavaScriptCore.JSStringGetLength, 0, JavaScriptCore.JSStringRef.__typestr__)
        ...
        self.assertTrue(JavaScriptCore.JSStringGetMaximumUTF8CStringSize(val) >= len("hello world") + 1)
