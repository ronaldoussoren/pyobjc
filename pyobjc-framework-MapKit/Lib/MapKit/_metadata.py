...
#
# Last update: Sat Aug  3 08:53:03 2019
...
try:
    ...
    r(b'MKCircle', b'circleWithCenterCoordinate:radius:', {'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}}})
    ...
    r(b'MKGeoJSONDecoder', b'geoJSONObjectsWithData:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    r(b'MKGeodesicPolyline', b'polylineWithCoordinates:count:', {'arguments': {2: {'type': b'^{CLLocationCoordinate2D=dd}', 'type_modifier': b'n', 'c_array_length_in_arg': 3}}})
    ...
    r(b'MKLocalSearchCompleter', b'region', {'retval': {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}})
    r(b'MKLocalSearchCompleter', b'setRegion:', {'arguments': {2: {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}}})
    r(b'MKLocalSearchRequest', b'initWithNaturalLanguageQuery:region:', {'arguments': {3: {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}}})
    r(b'MKLocalSearchRequest', b'region', {'retval': {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}})
    r(b'MKLocalSearchRequest', b'setRegion:', {'arguments': {2: {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}}})
    r(b'MKLocalSearchResponse', b'boundingRegion', {'retval': {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}})
    r(b'MKMapCamera', b'cameraLookingAtCenterCoordinate:fromEyeCoordinate:eyeAltitude:', {'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}, 3: {'type': b'{CLLocationCoordinate2D=dd}'}}})
    r(b'MKMapCamera', b'centerCoordinate', {'retval': {'type': b'{CLLocationCoordinate2D=dd}'}})
    r(b'MKMapCamera', b'setCenterCoordinate:', {'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}}})
    r(b'MKMapCameraBoundary', b'initWithCoordinateRegion:', {'arguments': {2: {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}}})
    r(b'MKMapCameraBoundary', b'initWithMapRect:', {'arguments': {2: {'type': b'{_MKMapRect={_MKMapPoint=dd}{_MKMapSize=dd}}'}}})
    r(b'MKMapCameraBoundary', b'mapRect', {'retval': {'type': b'{_MKMapRect={_MKMapPoint=dd}{_MKMapSize=dd}}'}})
    r(b'MKMapCameraBoundary', b'region', {'retval': {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}})
    ...
    r(b'MKMapSnapshot', b'pointForCoordinate:', {'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}}})
    r(b'MKMapSnapshotOptions', b'mapRect', {'retval': {'type': b'{_MKMapRect={_MKMapPoint=dd}{_MKMapSize=dd}}'}})
    r(b'MKMapSnapshotOptions', b'region', {'retval': {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}})
    r(b'MKMapSnapshotOptions', b'setMapRect:', {'arguments': {2: {'type': b'{_MKMapRect={_MKMapPoint=dd}{_MKMapSize=dd}}'}}})
    r(b'MKMapSnapshotOptions', b'setRegion:', {'arguments': {2: {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}}})
    ...
    r(b'MKMapView', b'centerCoordinate', {'retval': {'type': b'{CLLocationCoordinate2D=dd}'}})
    r(b'MKMapView', b'convertCoordinate:toPointToView:', {'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}}})
    r(b'MKMapView', b'convertPoint:toCoordinateFromView:', {'retval': {'type': b'{CLLocationCoordinate2D=dd}'}})
    r(b'MKMapView', b'convertRect:toRegionFromView:', {'retval': {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}})
    r(b'MKMapView', b'convertRegion:toRectToView:', {'arguments': {2: {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}}})
    ...
    r(b'MKMapView', b'region', {'retval': {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}})
    r(b'MKMapView', b'regionThatFits:', {'retval': {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}, 'arguments': {2: {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}}})
    ...
    r(b'MKMapView', b'setCenterCoordinate:', {'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}}})
    r(b'MKMapView', b'setCenterCoordinate:animated:', {'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}, 3: {'type': b'Z'}}})
    r(b'MKMapView', b'setPitchEnabled:', {'arguments': {2: {'type': b'Z'}}})
    r(b'MKMapView', b'setRegion:', {'arguments': {2: {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}}})
    r(b'MKMapView', b'setRegion:animated:', {'arguments': {2: {'type': b'{_MKCoordinateRegion={CLLocationCoordinate2D=dd}{_MKCoordinateSpan=dd}}'}, 3: {'type': b'Z'}}})
    ...
    r(b'MKMultiPoint', b'getCoordinates:range:', {'arguments': {2: {'type': b'^{CLLocationCoordinate2D=dd}', 'type_modifier': b'o', 'c_array_length_in_arg': 3}}})
    r(b'MKMultiPoint', b'points', {'retval': {'type': b'^{_MKMapPoint=dd}', 'c_array_of_variable_length': True}})
    r(b'MKOverlayPathRenderer', b'setShouldRasterize:', {'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'MKPlacemark', b'initWithCoordinate:addressDictionary:', {'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}}})
    r(b'MKPointAnnotation', b'coordinate', {'retval': {'type': b'{CLLocationCoordinate2D=dd}'}})
    r(b'MKPointAnnotation', b'setCoordinate:', {'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}}})
    ...
    r(b'MKPolygon', b'polygonWithCoordinates:count:', {'arguments': {2: {'type': b'^{CLLocationCoordinate2D=dd}', 'type_modifier': b'n', 'c_array_length_in_arg': 3}}})
    r(b'MKPolygon', b'polygonWithCoordinates:count:interiorPolygons:', {'arguments': {2: {'type': b'^{CLLocationCoordinate2D=dd}', 'type_modifier': b'n', 'c_array_length_in_arg': 3}}})
    ...
    r(b'MKPolyline', b'polylineWithCoordinates:count:', {'arguments': {2: {'type': b'^{CLLocationCoordinate2D=dd}', 'type_modifier': b'n', 'c_array_length_in_arg': 3}}})
    ...
    r(b'NSObject', b'completer:didFailWithError:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'completerDidUpdateResults:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'coordinate', {'required': True, 'retval': {'type': b'{CLLocationCoordinate2D=dd}'}})
    ...
    r(b'NSObject', b'mapView:clusterAnnotationForMemberAnnotations:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    ...
    r(b'NSObject', b'mapViewDidChangeVisibleRegion:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'setCoordinate:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}}})
    ...
    r(b'NSValue', b'MKCoordinateValue', {'retval': {'type': b'{CLLocationCoordinate2D=dd}'}})
    r(b'NSValue', b'valueWithMKCoordinate:', {'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}}})
