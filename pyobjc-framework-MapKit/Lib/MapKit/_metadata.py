...
#
# Last update: Sun Aug 10 14:47:51 2014
...
misc.update({'null': objc.createStructType('null', b'{=qqqd}', ['x', 'y', 'z', 'contentScaleFactor'])})
constants = '''$MKAnnotationCalloutInfoDidChangeNotification$MKErrorDomain$MKLaunchOptionsDirectionsModeDriving$MKLaunchOptionsDirectionsModeKey$MKLaunchOptionsDirectionsModeWalking$MKLaunchOptionsMapCenterKey$MKLaunchOptionsMapSpanKey$MKLaunchOptionsMapTypeKey$MKLaunchOptionsShowsTrafficKey$MKMapRectNull@{_MKMapRect={_MKMapPoint=dd}{_MKMapSize=dd}}$MKMapRectWorld@{_MKMapRect={_MKMapPoint=dd}{_MKMapSize=dd}}$MKMapSizeWorld@{_MKMapSize=dd}$'''
...
try:
    ...
    r(b'MKGeodesicPolyline', b'polylineWithCoordinates:count:', {'arguments': {2: {'type': b'^{_CLLocationCoordinate2D=dd}'}}})
    r(b'MKGeodesicPolyline', b'polylineWithPoints:count:', {'arguments': {2: {'type': b'^{_MKMapPoint=dd}'}}})
    ...
    r(b'MKMultiPoint', b'getCoordinates:range:', {'arguments': {2: {'type': b'^{_CLLocationCoordinate2D=dd}'}}})
    r(b'MKMultiPoint', b'points', {'retval': {'type': b'^{_MKMapPoint=dd}'}})
    ...
    r(b'MKPolygon', b'polygonWithCoordinates:count:', {'arguments': {2: {'type': b'^{_CLLocationCoordinate2D=dd}'}}})
    r(b'MKPolygon', b'polygonWithCoordinates:count:interiorPolygons:', {'arguments': {2: {'type': b'^{_CLLocationCoordinate2D=dd}'}}})
    r(b'MKPolygon', b'polygonWithPoints:count:', {'arguments': {2: {'type': b'^{_MKMapPoint=dd}'}}})
    r(b'MKPolygon', b'polygonWithPoints:count:interiorPolygons:', {'arguments': {2: {'type': b'^{_MKMapPoint=dd}'}}})
    r(b'MKPolyline', b'polylineWithCoordinates:count:', {'arguments': {2: {'type': b'^{_CLLocationCoordinate2D=dd}'}}})
    r(b'MKPolyline', b'polylineWithPoints:count:', {'arguments': {2: {'type': b'^{_MKMapPoint=dd}'}}})
    ...
    r(b'MKTileOverlay', b'loadTileAtPath:result:', {'arguments': {2: {'type': b'{_MKTileOverlayPath=qqqd}'}}})
