...
try:
    r(
        b"NSObject",
        b"authenticatorDidAuthenticate:",
        {"retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    )
    r(
        b"NSObject",
        b"authenticatorDidNotAuthenticate:",
        {"retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    )
    r(
        b"NSObject",
        b"connectionDidClose:",
        {"retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    )
    r(
        b"NSObject",
        b"connectionDidNotOpen:withError:",
    ...
    r(
        b"NSObject",
        b"fileDownload:decideDestinationWithSuggestedPath:",
        {"retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}}},
    )
    r(
        b"NSObject",
        b"fileDownload:didCreateDestination:",
        {"retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}}},
    )
    r(
        b"NSObject",
        b"fileDownload:didFailWithError:",
        {"retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}}},
    )
    r(
        b"NSObject",
        b"fileDownload:didReceiveAttributes:",
        {"retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}}},
    )
    r(
        b"NSObject",
        b"fileDownload:didReceiveData:",
        {"retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}}},
    )
    r(
        b"NSObject",
        b"fileDownloadDidBegin:",
        {"retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    )
    r(
        b"NSObject",
        b"fileDownloadDidFinish:",
        {"retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    )
finally:
    objc._updatingMetadata(False)
protocols = {
    "XGAuthenticatorDelegate": objc.informal_protocol(
        "XGAuthenticatorDelegate",
        [
            objc.selector(
                None, b"authenticatorDidNotAuthenticate:", b"v@:@", isRequired=False
            ),
            objc.selector(
                None, b"authenticatorDidAuthenticate:", b"v@:@", isRequired=False
            ),
        ],
    ),
    "XGFileDownloadDelegate": objc.informal_protocol(
        ...
        [
            ...
            objc.selector(
                None, b"fileDownload:didReceiveAttributes:", b"v@:@@", isRequired=False
            ),
            objc.selector(None, b"fileDownloadDidFinish:", b"v@:@", isRequired=False),
            objc.selector(
                None, b"fileDownload:didFailWithError:", b"v@:@@", isRequired=False
            ),
            objc.selector(
                None, b"fileDownload:didReceiveData:", b"v@:@@", isRequired=False
            ),
            objc.selector(None, b"fileDownloadDidBegin:", b"v@:@", isRequired=False),
            objc.selector(
                None, b"fileDownload:didCreateDestination:", b"v@:@@", isRequired=False
            ),
        ],
    ),
    "XGConnectionDelegate": objc.informal_protocol(
        "XGConnectionDelegate",
        [
            objc.selector(None, b"connectionDidOpen:", b"v@:@", isRequired=False),
            objc.selector(None, b"connectionDidClose:", b"v@:@", isRequired=False),
            objc.selector(
                None, b"connectionDidNotOpen:withError:", b"v@:@@", isRequired=False
            ),
        ],
    ),
}
