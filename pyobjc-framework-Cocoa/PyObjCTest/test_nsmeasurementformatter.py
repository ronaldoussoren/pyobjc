...
class TestNSMeasurementFormatter(TestCase):
    ...
    def testConstants(self):
        self.assertEqual(Foundation.NSMeasurementFormatterUnitOptionsProvidedUnit, 1 << 0)
        self.assertEqual(Foundation.NSMeasurementFormatterUnitOptionsNaturalScale, 1 << 1)
        self.assertEqual(
