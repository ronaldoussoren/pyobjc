...
class TestNSEnergyFormatter(TestCase):
    ...
    def testMethods10_10(self):
        ...
        self.assertResultIsBOOL(
            NSEnergyFormatter.getObjectValue_forString_errorDescription_
        )
        self.assertArgIsOut(
            NSEnergyFormatter.getObjectValue_forString_errorDescription_, 0
        )
        self.assertArgIsOut(
            NSEnergyFormatter.getObjectValue_forString_errorDescription_, 2
        )
