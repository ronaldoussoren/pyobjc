...
class TestNSTextInputClient (TestCase):
    ...
    def testMethods(self):
        ...
        self.assertArgHasType(TestNSTextInputClientHelper.attributedSubstringForProposedRange_actualRange_, 1, 'o^' + NSRange.__typestr__)
        ...
        self.assertArgHasType(TestNSTextInputClientHelper.firstRectForCharacterRange_actualRange_, 1, 'o^' + NSRange.__typestr__)
