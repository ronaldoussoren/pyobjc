...
class TestNSDocument(TestCase):
    ...
    def testMethods(self):
        ...
        self.assertArgIsOut(
            NSDocument.writeToURL_ofType_forSaveOperation_originalContentsURL_error_, 4
        )
        self.assertArgIsOut(
            NSDocument.fileAttributesToWriteToURL_ofType_forSaveOperation_originalContentsURL_error_,
            4,
        )
        self.assertResultIsBOOL(NSDocument.keepBackupFile)
        self.assertArgIsSEL(
            NSDocument.saveDocumentWithDelegate_didSaveSelector_contextInfo_,
            1,
            b"v@:@" + objc._C_NSBOOL + b"^v",
        )
        self.assertArgHasType(
            NSDocument.saveDocumentWithDelegate_didSaveSelector_contextInfo_, 2, b"^v"
        )
        self.assertArgIsSEL(
            NSDocument.runModalSavePanelForSaveOperation_delegate_didSaveSelector_contextInfo_,
            2,
            b"v@:@" + objc._C_NSBOOL + b"^v",
        )
        self.assertArgHasType(
        ...
        self.assertArgIsSEL(
            NSDocument.saveToURL_ofType_forSaveOperation_delegate_didSaveSelector_contextInfo_,
            4,
            b"v@:@" + objc._C_NSBOOL + b"^v",
        )
        self.assertArgHasType(
        ...
        self.assertArgIsSEL(
            NSDocument.autosaveDocumentWithDelegate_didAutosaveSelector_contextInfo_,
            1,
            b"v@:@" + objc._C_NSBOOL + b"^v",
        )
        self.assertArgHasType(
        ...
        self.assertArgIsSEL(
            NSDocument.canCloseDocumentWithDelegate_shouldCloseSelector_contextInfo_,
            1,
            b"v@:@" + objc._C_NSBOOL + b"^v",
        )
        self.assertArgHasType(
        ...
        self.assertArgIsSEL(
            NSDocument.runModalPageLayoutWithPrintInfo_delegate_didRunSelector_contextInfo_,
            2,
            b"v@:@" + objc._C_NSBOOL + b"^v",
        )
        self.assertArgHasType(
        ...
        self.assertArgIsSEL(
            NSDocument.printDocumentWithSettings_showPrintPanel_delegate_didPrintSelector_contextInfo_,
            3,
            b"v@:@" + objc._C_NSBOOL + b"^v",
        )
        self.assertArgHasType(
        ...
        self.assertArgIsSEL(
            NSDocument.runModalPrintOperation_delegate_didRunSelector_contextInfo_,
            2,
            b"v@:@" + objc._C_NSBOOL + b"^v",
        )
        self.assertArgHasType(
        ...
        self.assertArgIsSEL(
            NSDocument.presentError_modalForWindow_delegate_didPresentSelector_contextInfo_,
            3,
            b"v@:" + objc._C_NSBOOL + b"^v",
        )
        self.assertArgHasType(
        ...
        self.assertArgIsSEL(
            NSDocument.shouldCloseWindowController_delegate_shouldCloseSelector_contextInfo_,
            2,
            b"v@:@" + objc._C_NSBOOL + b"^v",
        )
        self.assertArgHasType(
        ...
        self.assertArgIsSEL(
            NSDocument.saveToFile_saveOperation_delegate_didSaveSelector_contextInfo_,
            3,
            b"v@:@" + objc._C_NSBOOL + b"^v",
        )
        self.assertArgHasType(
    ...
    def testMethods10_7(self):
        self.assertArgIsBOOL(
            NSDocument.performActivityWithSynchronousWaiting_usingBlock_, 0
        )
        self.assertArgIsBlock(
            NSDocument.performActivityWithSynchronousWaiting_usingBlock_, 1, b"v"
        )
        ...
        self.assertArgIsBlock(
            NSDocument.saveToURL_ofType_forSaveOperation_completionHandler_, 3, b"v@"
        )
        self.assertResultIsBOOL(
            NSDocument.canAsynchronouslyWriteToURL_ofType_forSaveOperation_
        )
        ...
        self.assertArgIsBOOL(
            NSDocument.autosaveWithImplicitCancellability_completionHandler_, 0
        )
        self.assertArgIsBlock(
            NSDocument.autosaveWithImplicitCancellability_completionHandler_, 1, b"v@"
        )
        ...
        self.assertArgIsSEL(
            NSDocument.duplicateDocumentWithDelegate_didDuplicateSelector_contextInfo_,
            1,
            b"v@" + objc._C_NSBOOL + b"^v",
        )
    ...
    def testMethods10_8(self):
        ...
        self.assertArgIsBlock(
            NSDocument.moveDocumentWithCompletionHandler_, 0, b"v" + objc._C_NSBOOL
        )
        self.assertArgIsBlock(
            NSDocument.moveToURL_completionHandler_, 1, b"v" + objc._C_NSBOOL
        )
        self.assertArgIsBlock(
            NSDocument.lockDocumentWithCompletionHandler_, 0, b"v" + objc._C_NSBOOL
        )
        self.assertArgIsBlock(NSDocument.lockWithCompletionHandler_, 0, b"v@")
        self.assertArgIsBlock(
            NSDocument.unlockDocumentWithCompletionHandler_, 0, b"v" + objc._C_NSBOOL
        )
        self.assertArgIsBlock(NSDocument.unlockWithCompletionHandler_, 0, b"v@")
    ...
    def testMethods10_12(self):
        ...
        self.assertArgIsBlock(
            NSDocument.stopBrowsingVersionsWithCompletionHandler_, 0, b"v"
        )
    ...
    def testMethods10_13(self):
        ...
        self.assertArgIsBlock(
            NSDocument.shareDocumentWithSharingService_completionHandler_, 1, b"vZ"
        )
