...
class TestNSToolbarItemGroup (TestCase):
    ...
    def test_methods(self):
        self.assertArgIsSEL(NSToolbarItemGroup.groupWithItemIdentifier_titles_selectionMode_labels_target_action_, 5, b'v@:@')
        self.assertArgIsSEL(NSToolbarItemGroup.groupWithItemIdentifier_images_selectionMode_labels_target_action_, 5, b'v@:@')
