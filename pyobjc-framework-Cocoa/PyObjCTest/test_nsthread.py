...
class TestNSThread (TestCase):
    def testMethods(self):
        ...
        self.assertArgIsSEL(NSThread.detachNewThreadSelector_toTarget_withObject_, 0, 'v@:@')
        self.assertResultIsBOOL(NSThread.setThreadPriority_)

        self.assertArgIsSEL(NSThread.performSelectorOnMainThread_withObject_waitUntilDone_modes_, 0, 'v@:@')
        self.assertArgIsBOOL(NSThread.performSelectorOnMainThread_withObject_waitUntilDone_modes_, 2)
        self.assertArgIsSEL(NSThread.performSelectorOnMainThread_withObject_waitUntilDone_, 0, 'v@:@')
        self.assertArgIsBOOL(NSThread.performSelectorOnMainThread_withObject_waitUntilDone_, 2)

    @min_os_level('10.5')
    def testMethods10_5(self):
        self.assertArgIsSEL(NSThread.initWithTarget_selector_object_, 1, 'v@:@')
        ...
        self.assertArgIsSEL(NSThread.performSelector_onThread_withObject_waitUntilDone_modes_, 0, 'v@:@')
        self.assertArgIsBOOL(NSThread.performSelector_onThread_withObject_waitUntilDone_modes_, 3)
        self.assertArgIsSEL(NSThread.performSelector_onThread_withObject_waitUntilDone_, 0, 'v@:@')
        self.assertArgIsBOOL(NSThread.performSelector_onThread_withObject_waitUntilDone_, 3)
        self.assertArgIsSEL(NSThread.performSelectorInBackground_withObject_, 0, 'v@:@')
