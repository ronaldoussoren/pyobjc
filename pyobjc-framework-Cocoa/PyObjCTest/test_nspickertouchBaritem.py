...
class TestNSPickerTouchBarItem (TestCase):
    ...
    def test_nethods10_15(self):
        self.assertArgIsSEL(AppKit.NSPickerTouchBarItem.pickerTouchBarItemWithIdentifier_labels_selectionMode_target_action_, 4, b'v@:@')
        self.assertArgIsSEL(AppKit.NSPickerTouchBarItem.pickerTouchBarItemWithIdentifier_images_selectionMode_target_action_, 4, b'v@:@')
