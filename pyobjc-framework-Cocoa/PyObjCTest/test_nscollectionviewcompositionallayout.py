...
NSCollectionLayoutSectionVisibleItemsInvalidationHandler = b'v@' + AppKit.NSPoint.__typestr__ + b'@'
...
class TestNSCollectionViewCompositionalLayoutHelper (AppKit.NSObject):
    def contentSize(self): return 1
    def effectiveContentSize(self): return 1
    def contentInsets(self): return 1
    def effectiveContentInsets(self): return 1
    def alpha(self): return 1
    def zIndex(self): return 1
    def isHidden(self): return 1
    def frame(self): return 1
    def bounds(self): return 1
    def representedElementCategory(self): return 1
...
class TestNSCollectionViewCompositionalLayout (TestCase):
    def test_constants(self):
        ...
        self.assertEqual(AppKit.NSDirectionalRectEdgeAll, AppKit.NSDirectionalRectEdgeTop | AppKit.NSDirectionalRectEdgeLeading | AppKit.NSDirectionalRectEdgeBottom | AppKit.NSDirectionalRectEdgeTrailing)
        ...
        self.assertEqual(AppKit.NSCollectionLayoutSectionOrthogonalScrollingBehaviorNone, 0)
        self.assertEqual(AppKit.NSCollectionLayoutSectionOrthogonalScrollingBehaviorContinuous, 1)
        self.assertEqual(AppKit.NSCollectionLayoutSectionOrthogonalScrollingBehaviorContinuousGroupLeadingBoundary, 2)
        self.assertEqual(AppKit.NSCollectionLayoutSectionOrthogonalScrollingBehaviorPaging, 3)
        self.assertEqual(AppKit.NSCollectionLayoutSectionOrthogonalScrollingBehaviorGroupPaging, 4)
        self.assertEqual(AppKit.NSCollectionLayoutSectionOrthogonalScrollingBehaviorGroupPagingCentered, 5)
    ...
    def test_methods_10_15(self):
        self.assertArgIsBlock(AppKit.NSCollectionViewCompositionalLayout.initWithSectionProvider_, 0, NSCollectionViewCompositionalLayoutSectionProvider)
        self.assertArgIsBlock(AppKit.NSCollectionViewCompositionalLayout.initWithSectionProvider_configuration_, 0, NSCollectionViewCompositionalLayoutSectionProvider)

        self.assertResultIsBOOL(AppKit.NSCollectionLayoutSection.supplementariesFollowContentInsets)
        self.assertArgIsBOOL(AppKit.NSCollectionLayoutSection.setSupplementariesFollowContentInsets_, 0)

        self.assertResultIsBlock(AppKit.NSCollectionLayoutSection.visibleItemsInvalidationHandler, NSCollectionLayoutSectionVisibleItemsInvalidationHandler)
        self.assertArgIsBlock(AppKit.NSCollectionLayoutSection.setVisibleItemsInvalidationHandler_, 0, NSCollectionLayoutSectionVisibleItemsInvalidationHandler)
        ...
        self.assertResultHasType(TestNSCollectionViewCompositionalLayoutHelper.contentInsets, AppKit.NSDirectionalEdgeInsets.__typestr__)
        self.assertResultHasType(TestNSCollectionViewCompositionalLayoutHelper.effectiveContentInsets, AppKit.NSDirectionalEdgeInsets.__typestr__)
        self.assertResultHasType(TestNSCollectionViewCompositionalLayoutHelper.alpha, objc._C_CGFloat)
        self.assertResultHasType(TestNSCollectionViewCompositionalLayoutHelper.zIndex, objc._C_NSInteger)
        ...
        self.assertResultIsBlock(AppKit.NSCollectionViewDiffableDataSource.supplementaryViewProvider, NSCollectionViewDiffableDataSourceSupplementaryViewProvider)
        self.assertArgIsBlock(AppKit.NSCollectionViewDiffableDataSource.setSupplementaryViewProvider_, 0, NSCollectionViewDiffableDataSourceSupplementaryViewProvider)
