...
class TestNSAccessibilityProtocols(TestCase):
    ...
    def testProtocolObjects(self):
        ...
        self.assertProtocolExists("NSAccessibilityCheckBox", AppKit)
        self.assertProtocolExists("NSAccessibilityStaticText", AppKit)
        self.assertProtocolExists("NSAccessibilityNavigableStaticText", AppKit)
        self.assertProtocolExists("NSAccessibilityProgressIndicator", AppKit)
        self.assertProtocolExists("NSAccessibilityStepper", AppKit)
        self.assertProtocolExists("NSAccessibilitySlider", AppKit)
        self.assertProtocolExists("NSAccessibilityImage", AppKit)
        self.assertProtocolExists("NSAccessibilityContainsTransientUI", AppKit)
        self.assertProtocolExists("NSAccessibilityTable", AppKit)
        self.assertProtocolExists("NSAccessibilityOutline", AppKit)
        self.assertProtocolExists("NSAccessibilityList", AppKit)
        self.assertProtocolExists("NSAccessibilityRow", AppKit)
        self.assertProtocolExists("NSAccessibilityLayoutArea", AppKit)
        self.assertProtocolExists("NSAccessibilityLayoutItem", AppKit)
