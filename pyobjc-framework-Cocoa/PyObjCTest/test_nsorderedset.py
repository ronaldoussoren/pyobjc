...
class TestNSOrderedSet(TestCase):
    ...
    def testMethods10_7(self):
        ...
        self.assertArgIsBlock(
            NSOrderedSet.enumerateObjectsUsingBlock_,
            0,
            b"v@" + objc._C_NSUInteger + b"o^" + objc._C_NSBOOL,
        )
        self.assertArgIsBlock(
            NSOrderedSet.enumerateObjectsWithOptions_usingBlock_,
            1,
            b"v@" + objc._C_NSUInteger + b"o^" + objc._C_NSBOOL,
        )
        self.assertArgIsBlock(
            NSOrderedSet.enumerateObjectsAtIndexes_options_usingBlock_,
            2,
            b"v@" + objc._C_NSUInteger + b"o^" + objc._C_NSBOOL,
        )

        self.assertArgIsBlock(
            NSOrderedSet.indexOfObjectPassingTest_,
            0,
            objc._C_NSBOOL + b"@" + objc._C_NSUInteger + b"o^" + objc._C_NSBOOL,
        )
        self.assertArgIsBlock(
            NSOrderedSet.indexOfObjectWithOptions_passingTest_,
            1,
            objc._C_NSBOOL + b"@" + objc._C_NSUInteger + b"o^" + objc._C_NSBOOL,
        )
        self.assertArgIsBlock(
            NSOrderedSet.indexOfObjectAtIndexes_options_passingTest_,
            2,
            objc._C_NSBOOL + b"@" + objc._C_NSUInteger + b"o^" + objc._C_NSBOOL,
        )

        self.assertArgIsBlock(
            NSOrderedSet.indexesOfObjectsPassingTest_,
            0,
            objc._C_NSBOOL + b"@" + objc._C_NSUInteger + b"o^" + objc._C_NSBOOL,
        )
        self.assertArgIsBlock(
            NSOrderedSet.indexesOfObjectsWithOptions_passingTest_,
            1,
            objc._C_NSBOOL + b"@" + objc._C_NSUInteger + b"o^" + objc._C_NSBOOL,
        )
        self.assertArgIsBlock(
            NSOrderedSet.indexesOfObjectsAtIndexes_options_passingTest_,
            2,
            objc._C_NSBOOL + b"@" + objc._C_NSUInteger + b"o^" + objc._C_NSBOOL,
        )

        self.assertArgIsBlock(
            NSOrderedSet.indexOfObject_inSortedRange_options_usingComparator_,
            3,
            objc._C_NSInteger + b"@@",
        )
        ...
        self.assertArgIsBlock(
            NSMutableOrderedSet.sortUsingComparator_, 0, objc._C_NSInteger + b"@@"
        )
        self.assertArgIsBlock(
            NSMutableOrderedSet.sortWithOptions_usingComparator_,
            1,
            objc._C_NSInteger + b"@@",
        )
        self.assertArgIsBlock(
            NSMutableOrderedSet.sortRange_options_usingComparator_,
            2,
            objc._C_NSInteger + b"@@",
        )

        self.assertArgIsBlock(
            NSOrderedSet.sortedArrayUsingComparator_, 0, objc._C_NSInteger + b"@@"
        )
        self.assertArgIsBlock(
            NSOrderedSet.sortedArrayWithOptions_usingComparator_,
            1,
            objc._C_NSInteger + b"@@",
        )
