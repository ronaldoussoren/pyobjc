...
class TestNSString(TestCase):
    ...
    def testCompare(self):
        self.assertTrue(
            NSString.localizedCaseInsensitiveCompare_(
...
class TestNSStringBridging(TestCase):
    ...
    def testBasicComparison(self):
        self.assertEqual(
            ...
            NSString.stringWithString_(b"unifoo".decode("ascii")),
        )
...
class TestPickle(TestCase):
    ...
    def testMethods(self):
        ...
        self.assertResultIsBOOL(
            NSString.getBytes_maxLength_usedLength_encoding_options_range_remainingRange_
        )
        ...
        self.assertArgSizeInArg(
            NSString.initWithCharactersNoCopy_length_freeWhenDone_, 0, 1
        )
        self.assertArgIsBOOL(NSString.initWithCharactersNoCopy_length_freeWhenDone_, 2)
        self.assertArgHasType(
            NSString.initWithCharacters_length_, 0, b"n^" + objc._C_UNICHAR
        )
        self.assertArgSizeInArg(NSString.initWithCharacters_length_, 0, 1)
        self.assertArgHasType(
            NSString.initWithUTF8String_, 0, b"n^" + objc._C_CHAR_AS_TEXT
        )
        ...
        self.assertArgIsBOOL(
            NSString.initWithBytesNoCopy_length_encoding_freeWhenDone_, 3
        )

        self.assertArgHasType(
            NSString.stringWithCharacters_length_, 0, b"n^" + objc._C_UNICHAR
        )
        self.assertArgSizeInArg(NSString.stringWithCharacters_length_, 0, 1)
        self.assertArgHasType(
            NSString.stringWithUTF8String_, 0, b"n^" + objc._C_CHAR_AS_TEXT
        )
    ...
    def testMethods10_6(self):
        self.assertArgHasType(
            NSString.enumerateSubstringsInRange_options_usingBlock_,
            0,
            NSRange.__typestr__,
        )
        ...
        self.assertArgIsBlock(
            NSString.enumerateLinesUsingBlock_, 0, b"v@o^" + objc._C_NSBOOL
        )
    ...
    def testConstants10_10(self):
        ...
        self.assertIsInstance(
            NSStringEncodingDetectionUseOnlySuggestedEncodingsKey, unicode
        )
    ...
    def testMethods10_10(self):
        self.assertArgHasType(
            NSString.stringEncodingForData_encodingOptions_convertedString_usedLossyConversion_,
            2,
            b"o^@",
        )
        self.assertArgHasType(
