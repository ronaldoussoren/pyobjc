...
class TestNSLayoutManagerHelper(NSObject):
    def layoutManager_shouldUseTemporaryAttributes_forDrawingToScreen_atCharacterIndex_effectiveRange_(
        self, a, b, c, d, e
    ):
        return 1
    ...
    def layoutManager_boundingBoxForControlGlyphAtIndex_forTextContainer_proposedLineFragment_glyphPosition_characterIndex_(
        self, l, i, c, f, p, i2
    ):
        return 1
    ...
    def layoutManager_shouldSetLineFragmentRect_lineFragmentUsedRect_baselineOffset_inTextContainer_forGlyphRange_(
        self, l, fr, ur, o, c, r
    ):
        return 1
...
class TestNSLayoutManager(TestCase):
    ...
    def testProtocols(self):
        ...
        self.assertArgHasType(
            TestNSLayoutManagerHelper.layoutManager_shouldGenerateGlyphs_properties_characterIndexes_forGlyphRange_,
            1,
            b"n^" + objc._C_USHT,
        )
        self.assertArgHasType(
        ...
        self.assertResultHasType(
            TestNSLayoutManagerHelper.layoutManager_lineSpacingAfterGlyphAtIndex_withProposedLineFragmentRect_,
            objc._C_CGFloat,
        )
        self.assertArgHasType(
            TestNSLayoutManagerHelper.layoutManager_lineSpacingAfterGlyphAtIndex_withProposedLineFragmentRect_,
        ...
        self.assertResultHasType(
            TestNSLayoutManagerHelper.layoutManager_paragraphSpacingBeforeGlyphAtIndex_withProposedLineFragmentRect_,
            objc._C_CGFloat,
        )
        self.assertArgHasType(
            TestNSLayoutManagerHelper.layoutManager_paragraphSpacingBeforeGlyphAtIndex_withProposedLineFragmentRect_,
        ...
        self.assertResultHasType(
            TestNSLayoutManagerHelper.layoutManager_paragraphSpacingAfterGlyphAtIndex_withProposedLineFragmentRect_,
            objc._C_CGFloat,
        )
        self.assertArgHasType(
            TestNSLayoutManagerHelper.layoutManager_paragraphSpacingAfterGlyphAtIndex_withProposedLineFragmentRect_,
        ...
        self.assertResultHasType(
            TestNSLayoutManagerHelper.layoutManager_shouldBreakLineByWordBeforeCharacterAtIndex_,
            objc._C_NSBOOL,
        )
        self.assertArgHasType(
            TestNSLayoutManagerHelper.layoutManager_shouldBreakLineByWordBeforeCharacterAtIndex_,
        ...
        self.assertResultHasType(
            TestNSLayoutManagerHelper.layoutManager_shouldBreakLineByHyphenatingBeforeCharacterAtIndex_,
            objc._C_NSBOOL,
        )
        self.assertArgHasType(
            TestNSLayoutManagerHelper.layoutManager_shouldBreakLineByWordBeforeCharacterAtIndex_,
        ...
        self.assertResultHasType(
            TestNSLayoutManagerHelper.layoutManager_boundingBoxForControlGlyphAtIndex_forTextContainer_proposedLineFragment_glyphPosition_characterIndex_,
            NSRect.__typestr__,
        )
        self.assertArgHasType(
            TestNSLayoutManagerHelper.layoutManager_boundingBoxForControlGlyphAtIndex_forTextContainer_proposedLineFragment_glyphPosition_characterIndex_,
        ...
        self.assertResultIsBOOL(
            TestNSLayoutManagerHelper.layoutManager_shouldSetLineFragmentRect_lineFragmentUsedRect_baselineOffset_inTextContainer_forGlyphRange_
        )
        self.assertArgHasType(
            TestNSLayoutManagerHelper.layoutManager_shouldSetLineFragmentRect_lineFragmentUsedRect_baselineOffset_inTextContainer_forGlyphRange_,
            1,
    ...
    def testMethods(self):
        ...
        self.assertArgIsOut(
            NSLayoutManager.invalidateGlyphsForCharacterRange_changeInLength_actualCharacterRange_,
            2,
        )
        self.assertArgIsOut(
            NSLayoutManager.invalidateLayoutForCharacterRange_isSoft_actualCharacterRange_,
            2,
        )
        ...
        self.assertArgIsOut(
            NSLayoutManager.textContainerForGlyphAtIndex_effectiveRange_, 1
        )
        self.assertArgIsOut(
            NSLayoutManager.lineFragmentRectForGlyphAtIndex_effectiveRange_, 1
        )
        self.assertArgIsOut(
            NSLayoutManager.lineFragmentUsedRectForGlyphAtIndex_effectiveRange_, 1
        )
        self.assertArgIsOut(
            NSLayoutManager.layoutRectForTextBlock_atIndex_effectiveRange_, 2
        )
        self.assertArgIsOut(
            NSLayoutManager.boundsRectForTextBlock_atIndex_effectiveRange_, 2
        )
        self.assertArgIsOut(
            NSLayoutManager.glyphRangeForCharacterRange_actualCharacterRange_, 1
        )
        self.assertArgIsOut(
            NSLayoutManager.characterRangeForGlyphRange_actualGlyphRange_, 1
        )
        self.assertArgIsOut(
            NSLayoutManager.temporaryAttributesAtCharacterIndex_effectiveRange_, 1
        )
        self.assertArgIsOut(
            NSLayoutManager.lineFragmentRectForGlyphAtIndex_effectiveRange_withoutAdditionalLayout_,
            1,
        )
        ...
        self.assertArgIsOut(
            NSLayoutManager.lineFragmentUsedRectForGlyphAtIndex_effectiveRange_withoutAdditionalLayout_,
            1,
        )
        self.assertArgIsBOOL(
            NSLayoutManager.lineFragmentUsedRectForGlyphAtIndex_effectiveRange_withoutAdditionalLayout_,
        ...
        self.assertArgIsOut(
            NSLayoutManager.textContainerForGlyphAtIndex_effectiveRange_withoutAdditionalLayout_,
            1,
        )
        self.assertArgIsBOOL(
            NSLayoutManager.textContainerForGlyphAtIndex_effectiveRange_withoutAdditionalLayout_,
        ...
        self.assertArgIsOut(
            NSLayoutManager.glyphIndexForPoint_inTextContainer_fractionOfDistanceThroughGlyph_,
            2,
        )

        self.assertResultSizeInArg(
            NSLayoutManager.rectArrayForCharacterRange_withinSelectedCharacterRange_inTextContainer_rectCount_,
            3,
        )
        self.assertArgIsOut(
            NSLayoutManager.rectArrayForCharacterRange_withinSelectedCharacterRange_inTextContainer_rectCount_,
        ...
        self.assertResultSizeInArg(
            NSLayoutManager.rectArrayForGlyphRange_withinSelectedGlyphRange_inTextContainer_rectCount_,
            3,
        )
        self.assertArgIsOut(
            NSLayoutManager.rectArrayForGlyphRange_withinSelectedGlyphRange_inTextContainer_rectCount_,
        ...
        self.assertArgIsOut(
            NSLayoutManager.getGlyphsInRange_glyphs_characterIndexes_glyphInscriptions_elasticBits_,
            1,
        )
        self.assertArgSizeInArg(
            NSLayoutManager.getGlyphsInRange_glyphs_characterIndexes_glyphInscriptions_elasticBits_,
        ...
        self.assertArgIsOut(
            NSLayoutManager.getGlyphsInRange_glyphs_characterIndexes_glyphInscriptions_elasticBits_bidiLevels_,
            1,
        )
        self.assertArgSizeInArg(
            NSLayoutManager.getGlyphsInRange_glyphs_characterIndexes_glyphInscriptions_elasticBits_bidiLevels_,
        ...
        self.assertArgHasType(
            NSLayoutManager.showPackedGlyphs_length_glyphRange_atPoint_font_color_printingAdjustment_,
            0,
            b"n^v",
        )
        self.assertArgSizeInArg(
        ...
        self.assertArgIsBOOL(
            NSLayoutManager.setDrawsOutsideLineFragment_forGlyphAtIndex_, 0
        )
    ...
    def testMethods10_5(self):
        ...
        self.assertArgHasType(
            NSLayoutManager.glyphAtIndex_isValidIndex_, 1, b"o^" + objc._C_NSBOOL
        )

        self.assertArgIsIn(
            NSLayoutManager.setLocations_startingGlyphIndexes_count_forGlyphRange_, 0
        )
        self.assertArgSizeInArg(
            NSLayoutManager.setLocations_startingGlyphIndexes_count_forGlyphRange_, 0, 2
        )
        self.assertArgIsIn(
            NSLayoutManager.setLocations_startingGlyphIndexes_count_forGlyphRange_, 1
        )
        self.assertArgSizeInArg(
            NSLayoutManager.setLocations_startingGlyphIndexes_count_forGlyphRange_, 1, 2
        )

        self.assertArgIsOut(
            NSLayoutManager.temporaryAttribute_atCharacterIndex_effectiveRange_, 2
        )
        self.assertArgIsOut(
            NSLayoutManager.temporaryAttribute_atCharacterIndex_longestEffectiveRange_inRange_,
            2,
        )
        self.assertArgIsOut(
            NSLayoutManager.temporaryAttributesAtCharacterIndex_longestEffectiveRange_inRange_,
            1,
        )

        self.assertArgIsBOOL(
            TestNSLayoutManagerHelper.layoutManager_shouldUseTemporaryAttributes_forDrawingToScreen_atCharacterIndex_effectiveRange_,
            2,
        )
        self.assertArgHasType(
            TestNSLayoutManagerHelper.layoutManager_shouldUseTemporaryAttributes_forDrawingToScreen_atCharacterIndex_effectiveRange_,
        ...
        self.assertArgIsBOOL(
            TestNSLayoutManagerHelper.layoutManager_didCompleteLayoutForTextContainer_atEnd_,
            2,
        )

        self.assertArgIsBOOL(
            NSLayoutManager.getLineFragmentInsertionPointsForCharacterAtIndex_alternatePositions_inDisplayOrder_positions_characterIndexes_,
            1,
        )
        self.assertArgIsBOOL(
            NSLayoutManager.getLineFragmentInsertionPointsForCharacterAtIndex_alternatePositions_inDisplayOrder_positions_characterIndexes_,
    ...
    def testMethods10_5_not_available(self):
        ...
        self.assertArgIsOut(
            NSLayoutManager.getGlyphsInRange_glyphs_properties_characterIndexes_bidiLevels_,
            1,
        )
        self.assertArgIsOut(
            NSLayoutManager.getGlyphsInRange_glyphs_properties_characterIndexes_bidiLevels_,
    ...
    def testMethods10_5_fail(self):
        self.fail(
            "Buffer size is non-trivial: - (NSUInteger)getLineFragmentInsertionPointsForCharacterAtIndex:(NSUInteger)charIndex alternatePositions:(BOOL)aFlag inDisplayOrder:(BOOL)dFlag positions:(CGFloat *)positions characterIndexes:(NSUInteger *)charIndexes;"
        )

    @min_os_level("10.6")
    def testMethods10_6(self):
        self.assertArgHasType(
            NSLayoutManager.characterIndexForPoint_inTextContainer_fractionOfDistanceBetweenInsertionPoints_,
            0,
            NSPoint.__typestr__,
        )
        self.assertArgIsOut(
        ...
        self.assertArgHasType(
            NSLayoutManager.fillBackgroundRectArray_count_forCharacterRange_color_,
            0,
            b"N^" + NSRect.__typestr__,
        )
        self.assertArgSizeInArg(
            NSLayoutManager.fillBackgroundRectArray_count_forCharacterRange_color_, 0, 1
        )
        self.assertArgHasType(
            NSLayoutManager.fillBackgroundRectArray_count_forCharacterRange_color_,
            2,
    ...
    def testMethods10_11(self):
        self.assertArgSizeInArg(
            NSLayoutManager.setGlyphs_properties_characterIndexes_font_forGlyphRange_,
            0,
            4,
        )
        self.assertArgSizeInArg(
        ...
        self.assertArgIsBlock(
            NSLayoutManager.enumerateLineFragmentsForGlyphRange_usingBlock_,
            1,
            b"v"
            + NSRect.__typestr__
            + NSRect.__typestr__
        ...
        self.assertArgIsBlock(
            NSLayoutManager.enumerateEnclosingRectsForGlyphRange_withinSelectedGlyphRange_inTextContainer_usingBlock_,
            3,
            b"v" + NSRect.__typestr__ + b"o^Z",
        )
    ...
    def testMethods10_15(self):
        ...
        self.assertArgIsIn(
            NSLayoutManager.showCGGlyphs_positions_count_font_textMatrix_attributes_inContext_,
            0,
        )
        self.assertArgSizeInArg(
            NSLayoutManager.showCGGlyphs_positions_count_font_textMatrix_attributes_inContext_,
