...
class TestNSURLSession(TestCase):
    ...
    def testMethods10_10(self):
        ...
        self.assertArgIsBlock(
            NSURLSession.uploadTaskWithRequest_fromData_completionHandler_, 2, b"v@@@"
        )
        self.assertArgIsBlock(
            NSURLSession.downloadTaskWithURL_completionHandler_, 1, b"v@@@"
        )
        self.assertArgIsBlock(
            NSURLSession.downloadTaskWithResumeData_completionHandler_, 1, b"v@@@"
        )
        ...
        self.assertArgIsBlock(
            TestNSURLSessionHelper.URLSession_task_willPerformHTTPRedirection_newRequest_completionHandler_,
            4,
            b"v@",
        )
        self.assertArgIsBlock(
        ...
        self.assertArgHasType(
            TestNSURLSessionHelper.URLSession_task_didSendBodyData_totalBytesSent_totalBytesExpectedToSend_,
            2,
            objc._C_LNG_LNG,
        )
        self.assertArgHasType(
        ...
        self.assertArgHasType(
            TestNSURLSessionHelper.URLSession_downloadTask_didWriteData_totalBytesWritten_totalBytesExpectedToWrite_,
            2,
            objc._C_LNG_LNG,
        )
        self.assertArgHasType(
        ...
        self.assertArgHasType(
            TestNSURLSessionHelper.URLSession_downloadTask_didResumeAtOffset_expectedTotalBytes_,
            2,
            objc._C_LNG_LNG,
        )
        self.assertArgHasType(
    ...
    def testMethods10_11(self):
        ...
        self.assertArgIsBlock(
            TestNSURLSessionStreamTaskHelper.readDataOfMinLength_maxLength_timeout_completionHandler_,
            3,
            b"v@Z@",
        )
        self.assertArgIsBlock(
    ...
    def testMethods10_15(self):
        self.assertArgIsBlock(
            NSURLSessionWebSocketTask.sendMessage_completionHandler_, 1, b"v@"
        )
        self.assertArgIsBlock(
            NSURLSessionWebSocketTask.receiveMessageWithCompletionHandler_, 0, b"v@@"
        )
        self.assertArgIsBlock(
            NSURLSessionWebSocketTask.sendPingWithPongReceiveHandler_, 0, b"v@"
        )
