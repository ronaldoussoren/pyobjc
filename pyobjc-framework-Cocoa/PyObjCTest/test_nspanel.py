...
class TestNSPanel (TestCase):
    ...
    def testFunctions(self):
        ...
        self.assertArgIsSEL(NSBeginAlertSheet, 6, 'v@:@'+objc._C_NSInteger+'^v')
        self.assertArgIsSEL(NSBeginAlertSheet, 7, 'v@:@'+objc._C_NSInteger+'^v')
        self.assertArgHasType(NSBeginAlertSheet, 8, '^v')
        self.assertArgIsPrintf(NSBeginInformationalAlertSheet, 9)
        self.assertArgIsSEL(NSBeginInformationalAlertSheet, 6, 'v@:@'+objc._C_NSInteger+'^v')
        self.assertArgIsSEL(NSBeginInformationalAlertSheet, 7, 'v@:@'+objc._C_NSInteger+'^v')
        self.assertArgHasType(NSBeginInformationalAlertSheet, 8, '^v')
        self.assertArgIsPrintf(NSBeginCriticalAlertSheet, 9)
        self.assertArgIsSEL(NSBeginCriticalAlertSheet, 6, 'v@:@'+objc._C_NSInteger+'^v')
        self.assertArgIsSEL(NSBeginCriticalAlertSheet, 7, 'v@:@'+objc._C_NSInteger+'^v')
        self.assertArgHasType(NSBeginCriticalAlertSheet, 8, '^v')
