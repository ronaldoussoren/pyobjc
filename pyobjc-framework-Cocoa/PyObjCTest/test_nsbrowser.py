...
class TestNSBrowser(TestCase):
    ...
    def testDelegate(self):
        ...
        self.assertArgHasType(
            TestNSBrowserHelper.browser_namesOfPromisedFilesDroppedAtDestination_forDraggedRowsWithIndexes_inColumn_,
            3,
            objc._C_NSInteger,
        )
        ...
        self.assertArgHasType(
            TestNSBrowserHelper.browser_draggingImageForRowsWithIndexes_inColumn_withEvent_offset_,
            2,
            objc._C_NSInteger,
        )
        self.assertArgHasType(
