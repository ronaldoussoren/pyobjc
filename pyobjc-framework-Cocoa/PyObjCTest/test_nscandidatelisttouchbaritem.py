...
class TestNSCandidateListTouchBarItem(TestCase):
    ...
    def testMethods10_12(self):
        ...
        self.assertArgIsBOOL(
            NSCandidateListTouchBarItem.updateWithInsertionPointVisibility_, 0
        )

        self.assertResultIsBOOL(
            NSCandidateListTouchBarItem.allowsTextInputContextCandidates
        )
        self.assertArgIsBOOL(
            NSCandidateListTouchBarItem.setAllowsTextInputContextCandidates_, 0
        )

        self.assertResultIsBlock(
            NSCandidateListTouchBarItem.attributedStringForCandidate,
            b"@@" + objc._C_NSInteger,
        )
        self.assertArgIsBlock(
            NSCandidateListTouchBarItem.setAttributedStringForCandidate_,
            0,
            b"@@" + objc._C_NSInteger,
        )

        self.assertArgHasType(
            TestNSCandidateListTouchBarItemHelper.candidateListTouchBarItem_beginSelectingCandidateAtIndex_,
            1,
            objc._C_NSInteger,
        )
        self.assertArgHasType(
            TestNSCandidateListTouchBarItemHelper.candidateListTouchBarItem_changeSelectionFromCandidateAtIndex_toIndex_,
            1,
            objc._C_NSInteger,
        )
        self.assertArgHasType(
        ...
        self.assertArgHasType(
            TestNSCandidateListTouchBarItemHelper.candidateListTouchBarItem_endSelectingCandidateAtIndex_,
            1,
            objc._C_NSInteger,
        )
        self.assertArgIsBOOL(
            TestNSCandidateListTouchBarItemHelper.candidateListTouchBarItem_changedCandidateListVisibility_,
            1,
        )
