...
#
# Last update: Sat Jun 27 18:34:34 2020
#
# flake8: noqa
...
misc.update(
    {
        ...
        "CFStreamError": objc.createStructType(
            "CFStreamError", b"{_CFStreamError=qi}", ["domain", "error"]
        ),
        "CFXMLEntityReferenceInfo": objc.createStructType(
            "CFXMLEntityReferenceInfo", b"{_CFXMLEntityReferenceInfo=q}", ["entityType"]
        ),
        ...
        "CFRange": objc.createStructType(
            "CFRange", b"{_CFRange=qq}", ["location", "length"]
        ),
...
functions = {
    ...
    "CFCalendarGetRangeOfUnit": (b"{_CFRange=qq}^{__CFCalendar=}QQd",),
    ...
    "CFMachPortGetContext": (b"v^{__CFMachPort=}^{_CFMachPortContext=q^v^?^?^?}",),
    ...
    "CFStringReplace": (b"v^{__CFString=}{_CFRange=qq}^{__CFString=}",),
    ...
    "CFDataFind": (b"{_CFRange=qq}^{__CFData=}^{__CFData=}{_CFRange=qq}Q",),
    "CFMachPortCreate": (
    ...
    "CFBitVectorGetLastIndexOfBit": (b"q^{__CFBitVector=}{_CFRange=qq}I",),
    "CFDataCreateMutable": (
    ...
    "CFArrayGetLastIndexOfValue": (b"q^{__CFArray=}{_CFRange=qq}@",),
    ...
    "CFCharacterSetRemoveCharactersInRange": (b"v^{__CFCharacterSet=}{_CFRange=qq}",),
    ...
    "CFArrayGetFirstIndexOfValue": (b"q^{__CFArray=}{_CFRange=qq}@",),
    ...
    "CFBitVectorSetBits": (b"v^{__CFBitVector=}{_CFRange=qq}I",),
    ...
    "CFBitVectorFlipBits": (b"v^{__CFBitVector=}{_CFRange=qq}",),
    ...
    "CFTreeSetContext": (b"v^{__CFTree=}^{_CFTreeContext=q^v^?^?^?}",),
    ...
    "CFTreeGetContext": (b"v^{__CFTree=}^{_CFTreeContext=q^v^?^?^?}",),
    ...
    "CFStringCompareWithOptions": (b"q^{__CFString=}^{__CFString=}{_CFRange=qq}Q",),
    ...
    "CFStringFind": (b"{_CFRange=qq}^{__CFString=}^{__CFString=}Q",),
    ...
    "CFBitVectorContainsBit": (b"Z^{__CFBitVector=}{_CFRange=qq}I",),
    ...
    "CFArrayContainsValue": (b"Z^{__CFArray=}{_CFRange=qq}@",),
    ...
    "CFGregorianDateIsValid": (b"Z{_CFGregorianDate=iccccd}Q",),
    "CFAutorelease": (b"@@",),
    ...
    "CFStringTokenizerGetCurrentTokenRange": (b"{_CFRange=qq}^{__CFStringTokenizer=}",),
    ...
    "CFGregorianDateGetAbsoluteTime": (b"d{_CFGregorianDate=iccccd}^{__CFTimeZone=}",),
    ...
    "CFArrayGetCountOfValue": (b"q^{__CFArray=}{_CFRange=qq}@",),
    ...
    "CFStringDelete": (b"v^{__CFString=}{_CFRange=qq}",),
    ...
    "CFBitVectorGetBits": (
        b"v^{__CFBitVector=}{_CFRange=qq}^C",
        "",
    ...
    "CFCharacterSetAddCharactersInRange": (b"v^{__CFCharacterSet=}{_CFRange=qq}",),
    "CFMessagePortIsRemote": (b"Z^{__CFMessagePort=}",),
    "CFURLGetTypeID": (b"Q",),
    "CFReadStreamGetError": (b"{_CFStreamError=qi}^{__CFReadStream=}",),
    ...
    "CFStringGetLineBounds": (
        b"v^{__CFString=}{_CFRange=qq}^q^q^q",
        "",
        {
            "arguments": {
                2: {"type_modifier": "o"},
    ...
    "CFCalendarGetMinimumRangeOfUnit": (b"{_CFRange=qq}^{__CFCalendar=}Q",),
    ...
    "CFSocketGetContext": (b"v^{__CFSocket=}^{_CFSocketContext=q^v^?^?^?}",),
    ...
    "CFArrayAppendArray": (b"v^{__CFArray=}^{__CFArray=}{_CFRange=qq}",),
    ...
    "CFStringGetRangeOfComposedCharactersAtIndex": (b"{_CFRange=qq}^{__CFString=}q",),
    ...
    "CFBitVectorGetFirstIndexOfBit": (b"q^{__CFBitVector=}{_CFRange=qq}I",),
    ...
    "CFAbsoluteTimeGetGregorianDate": (b"{_CFGregorianDate=iccccd}d^{__CFTimeZone=}",),
