...
#
# Last update: Fri Feb 17 21:25:10 2023
#
# flake8: noqa
...
misc.update(
    {
        ...
        "CFRange": objc.createStructType(
            "CoreFoundation.CFRange", b"{_CFRange=qq}", ["location", "length"]
        ),
        ...
        "CFStreamError": objc.createStructType(
            "CoreFoundation.CFStreamError", b"{_CFStreamError=qi}", ["domain", "error"]
        ),
        ...
        "CFSwappedFloat64": objc.createStructType(
            "CoreFoundation.CFSwappedFloat64", b"{_CFSwappedFloat64=Q}", ["v"]
        ),
...
functions = {
    ...
    "CFStringCreateStringWithValidatedFormatAndArguments": (
        selAorI(
            b"^{__CFString=}^{__CFAllocator=}^{__CFDictionary=}^{__CFString=}^{__CFString=}^c^^{__CFError=}",
            b"^{__CFString=}^{__CFAllocator=}^{__CFDictionary=}^{__CFString=}^{__CFString=}[1{__va_list_tag=II^v^v}]^^{__CFError=}",
        ),
        "",
        {
            "retval": {"already_cfretained": True},
            ...
            "suggestion": "use CFStringCreateStringWithValidatedFormat instead",
        },
    ),
