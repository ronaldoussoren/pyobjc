...
#
# Last update: Sun May 17 09:11:04 2026
#
# flake8: noqa
...
misc.update(
    {
        "CFSetCallBacks": objc.createOpaquePointerType(
            "CFSetCallBacks", b"^{CFSetCallBacks=q^?^?^?^?^?}"
        ),
        "CFArrayCallBacks": objc.createOpaquePointerType(
            "CFArrayCallBacks", b"^{CFArrayCallBacks=q^?^?^?^?}"
        ),
        "CFBagCallBacks": objc.createOpaquePointerType(
            "CFBagCallBacks", b"^{CFBagCallBacks=q^?^?^?^?^?}"
        ),
        "CFDictionaryValueCallBacks": objc.createOpaquePointerType(
            "CFDictionaryValueCallBacks", b"^{CFDictionaryValueCallBacks=q^?^?^?^?}"
        ),
        "CFDictionaryKeyCallBacks": objc.createOpaquePointerType(
            "CFDictionaryKeyCallBacks", b"^{CFDictionaryKeyCallBacks=q^?^?^?^?^?}"
        ),
    }
)
expressions = {
