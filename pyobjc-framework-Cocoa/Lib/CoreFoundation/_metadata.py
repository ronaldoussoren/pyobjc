...
#
# Last update: Sun Aug 16 11:48:16 2026
#
# flake8: noqa
...
functions = {
    ...
    "CFStringGetFileSystemRepresentation": (
        b"Z^{__CFString=}^tq",
        "",
        {"arguments": {1: {"type_modifier": "o", "c_array_length_in_arg": 2}}},
    ),
    ...
    "CFStringSetExternalCharactersNoCopy": (
        ...
        {
            "retval": {"already_cfretained": True},
            "arguments": {1: {"type_modifier": "n", "c_array_length_in_arg": 3}},
        },
    ),
    ...
    "CFMessagePortCreateLocal": (
        b"^{__CFMessagePort=}^{__CFAllocator=}^{__CFString=}^?@^Z",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "CFCalendarGetComponentDifference": (
        b"Z^{__CFCalendar=}ddQ^t",
        "",
        {
            "c_array_delimited_by_null": True,
            "arguments": {4: {"c_array_delimited_by_null": True, "type_modifier": "n"}},
            "variadic": True,
        },
    ),
    ...
    "CFMachPortCreate": (
        b"^{__CFMachPort=}^{__CFAllocator=}^?@^Z",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "CFStringGetBytes": (
        ...
        {
            "arguments": {
                5: {"type_modifier": "o", "c_array_length_in_arg": (6, 7)},
                7: {"type_modifier": "o"},
            }
        },
    ),
    ...
    "CFNumberFormatterGetValueFromString": (
        b"Z^{__CFNumberFormatter=}^{__CFString=}^{CFRange=qq}q^v",
        "",
        {"arguments": {2: {"type_modifier": "N"}, 4: {"type_modifier": "o"}}},
    ),
    ...
    "CFRunLoopSourceCreate": (
        b"^{__CFRunLoopSource=}^{__CFAllocator=}q@",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CFDataReplaceBytes": (
        ...
        "",
        {"arguments": {2: {"type_modifier": "n", "c_array_length_in_arg": 3}}},
    ),
    "CFDataGetBytePtr": (
        b"^v^{__CFData=}",
        "",
    ...
    "CFErrorCreateWithUserInfoKeysAndValues": (
        ...
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
                3: {"type_modifier": "n", "c_array_length_in_arg": 5},
    ...
    "CFBagGetValues": (
        b"v^{__CFBag=}^@",
        "",
        {"arguments": {1: {"type_modifier": "o", "c_array_of_variable_length": True}}},
    ),
    ...
    "CFSocketCreate": (
        b"^{__CFSocket=}^{__CFAllocator=}iiiQ^?@",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "CFMachPortCreateWithPort": (
        b"^{__CFMachPort=}^{__CFAllocator=}I^?@^Z",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "CFNumberFormatterCreateStringWithValue": (
        b"^{__CFString=}^{__CFAllocator=}^{__CFNumberFormatter=}q^v",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CFBinaryHeapCreate": (
        b"^{__CFBinaryHeap=}^{__CFAllocator=}q@@",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CFDictionaryGetKeysAndValues": (
        ...
        {
            "arguments": {
                1: {"type_modifier": "o", "c_array_of_variable_length": True},
    ...
    "CFSocketCreateConnectedToSocketSignature": (
        b"^{__CFSocket=}^{__CFAllocator=}^{CFSocketSignature=iii^{__CFData=}}Q^?@d",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "CFFileDescriptorCreate": (
        b"^{__CFFileDescriptor=}^{__CFAllocator=}iZ^?@",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "CFSocketCreateWithSocketSignature": (
        b"^{__CFSocket=}^{__CFAllocator=}^{CFSocketSignature=iii^{__CFData=}}Q^?@",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
