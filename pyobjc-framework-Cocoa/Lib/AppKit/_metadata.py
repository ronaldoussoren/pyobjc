...
#
# Last update: Sat Jul 22 10:29:49 2023
#
# flake8: noqa
    ...
    "NSBeginCriticalAlertSheet": (
        ...
        "",
        {
            "arguments": {
                ...
                6: {"sel_of_type": sel32or64(b"v@:@i^v", b"v@:@q^v")},
                7: {"sel_of_type": sel32or64(b"v@:@i^v", b"v@:@q^v")},
            },
            "variadic": True,
        },
    ),
...
try:
    ...
    r(
        ...
        b"boundingBoxForControlGlyphAtIndex:forTextContainer:proposedLineFragment:glyphPosition:characterIndex:",
        {
            ...
            "arguments": {
                ...
                5: {"type": sel32or64(b"{_NSPoint=ff}", b"{CGPoint=dd}")},
                6: {"type": sel32or64(b"I", b"Q")},
            },
        },
    )
    r(
    ...
    r(
        ...
        {
            "arguments": {
                2: {"type": sel32or64(b"{_NSSize=ff}", b"{CGSize=dd}")},
    ...
    r(
        ...
        {"retval": {"type": "Z"}, "arguments": {2: {"type": sel32or64(b"I", b"Q")}}},
    )
    r(
        b"NSATSTypesetter",
    ...
    r(
        ...
        b"willSetLineFragmentRect:forGlyphRange:usedRect:baselineOffset:",
        {
            "arguments": {
                ...
                5: {"type": sel32or64(b"^f", b"^d"), "type_modifier": b"N"},
            }
        },
    )
    r(
    ...
    r(
        ...
        {
            "arguments": {
                5: {"sel_of_type": sel32or64(b"v@:@i^v", b"v@:@q^v")},
                6: {"type": "^v"},
            }
        },
    )
    ...
    r(
        ...
        {
            "arguments": {
                2: {"c_array_of_variable_length": True},
    ...
    r(
        ...
        {"arguments": {5: {"type": sel32or64(b"{_NSPoint=ff}", b"{CGPoint=dd}")}}},
    )
    r(
        b"NSCursor",
        b"initWithImage:hotSpot:",
        {"arguments": {3: {"type": sel32or64(b"{_NSPoint=ff}", b"{CGPoint=dd}")}}},
    )
    ...
    r(
        b"NSImage",
        b"initWithCGImage:size:",
        {"arguments": {3: {"type": sel32or64(b"{_NSSize=ff}", b"{CGSize=dd}")}}},
    )
    r(
        b"NSImage",
        b"initWithIconRef:",
    ...
    r(
        ...
        b"drawStrikethroughForGlyphRange:strikethroughType:baselineOffset:lineFragmentRect:lineFragmentGlyphRange:containerOrigin:",
        {
            "arguments": {
                ...
                6: {"type": sel32or64(b"{_NSRange=II}", b"{_NSRange=QQ}")},
                7: {"type": sel32or64(b"{_NSPoint=ff}", b"{CGPoint=dd}")},
            }
        },
    )
    r(
    ...
    r(
        ...
        b"getLineFragmentInsertionPointsForCharacterAtIndex:alternatePositions:inDisplayOrder:positions:characterIndexes:",
        {
            "arguments": {
                3: {"type": "Z"},
                4: {"type": "Z"},
                5: {"type": sel32or64(b"r^f", b"r^d"), "type_modifier": b"o"},
                6: {"type": sel32or64(b"^I", b"^Q"), "type_modifier": b"o"},
            }
        },
    )
    r(
    ...
    r(
        ...
        b"showPackedGlyphs:length:glyphRange:atPoint:font:color:printingAdjustment:",
        {
            "arguments": {
                ...
                4: {"type": sel32or64(b"{_NSRange=II}", b"{_NSRange=QQ}")},
                5: {"type": sel32or64(b"{_NSPoint=ff}", b"{CGPoint=dd}")},
                8: {"type": sel32or64(b"{_NSSize=ff}", b"{CGSize=dd}")},
            }
        },
    )
    ...
    r(
        ...
        b"strikethroughGlyphRange:strikethroughType:lineFragmentRect:lineFragmentGlyphRange:containerOrigin:",
        {
            "arguments": {
                ...
                5: {"type": sel32or64(b"{_NSRange=II}", b"{_NSRange=QQ}")},
                6: {"type": sel32or64(b"{_NSPoint=ff}", b"{CGPoint=dd}")},
            }
        },
    )
    r(
    ...
    r(
        b"NSMatrix",
        b"sortUsingSelector:",
        {"arguments": {2: {"sel_of_type": sel32or64(b"i@:@", b"q@:@")}}},
    )
    ...
    r(
        ...
        b"browser:draggingImageForRowsWithIndexes:inColumn:withEvent:offset:",
        {
            ...
            "arguments": {
                ...
                4: {"type": b"q"},
                5: {"type": b"@"},
                6: {"type": sel32or64(b"N^{_NSPoint=ff}", b"N^{CGPoint=dd}")},
            },
        },
    )
    r(
    ...
    r(
        ...
        b"collectionView:draggingImageForItemsAtIndexPaths:withEvent:offset:",
        {
            ...
            "arguments": {
                ...
                4: {"type": b"@"},
                5: {
                    "type": sel32or64(b"^{_NSPoint=ff}", b"^{CGPoint=dd}"),
                    "type_modifier": b"N",
                },
            },
        },
    ...
    r(
        ...
        b"collectionView:layout:insetForSectionAtIndex:",
        {
            "required": False,
            "retval": {
                "type": sel32or64(b"{NSEdgeInsets=ffff}", b"{NSEdgeInsets=dddd}")
            },
            "arguments": {
                2: {"type": b"@"},
                3: {"type": b"@"},
    ...
    r(
        ...
        b"collectionView:validateDrop:proposedIndex:dropOperation:",
        {
            ...
            "arguments": {
                2: {"type": b"@"},
                3: {"type": b"@"},
                4: {"type": sel32or64(b"^i", b"^q"), "type_modifier": b"N"},
                5: {"type": sel32or64(b"^i", b"^q"), "type_modifier": b"N"},
            },
        },
    )
    r(
    ...
    r(
        ...
        b"contentViewAtIndex:effectiveCharacterRange:",
        {
            ...
            "arguments": {
                2: {"type": sel32or64(b"I", b"Q")},
                3: {"type": sel32or64(b"o^{_NSRange=II}", b"o^{_NSRange=QQ}")},
            },
        },
    )
    r(
    ...
    r(
        ...
        b"datePickerCell:validateProposedDateValue:timeInterval:",
        {
            ...
            "arguments": {
                ...
                4: {"type": sel32or64(b"^f", b"^d"), "type_modifier": b"N"},
            },
        },
    )
    r(
    ...
    r(
        ...
        {"retval": {"type": sel32or64(b"I", b"Q")}, "arguments": {2: {"type": "Z"}}},
    )
    r(
        b"NSObject",
        b"draggingUpdated:",
    ...
    r(
        ...
        b"drawerWillResizeContents:toSize:",
        {
            ...
            "arguments": {
                2: {"type": b"@"},
                3: {"type": sel32or64(b"{_NSSize=ff}", b"{CGSize=dd}")},
            },
        },
    )
    r(
    ...
    r(
        ...
        {"retval": {"type": "i"}, "arguments": {2: {"type": sel32or64(b"I", b"Q")}}},
    )
    r(
        b"NSObject",
        b"hyphenationFactorForGlyphAtIndex:",
        {"retval": {"type": "f"}, "arguments": {2: {"type": sel32or64(b"I", b"Q")}}},
    )
    ...
    r(
        ...
        b"layoutManager:shouldGenerateGlyphs:properties:characterIndexes:forGlyphRange:",
        {
            "arguments": {
                ...
                4: {"type": sel32or64(b"n^I", b"n^Q"), "c_array_length_in_arg": 6},
                5: {"type": sel32or64(b"n^I", b"n^Q"), "c_array_length_in_arg": 6},
                6: {"type": sel32or64(b"{_NSRange=II}", b"{_NSRange=QQ}")},
            }
        },
    )
    r(
        ...
        b"layoutManager:shouldSetLineFragmentRect:lineFragmentUsedRect:baselineOffset:inTextContainer:forGlyphRange:",
        {
            ...
            "arguments": {
                ...
                3: {
                    "type": sel32or64(
                        b"N^{_NSRect={_NSPoint=ff}{_NSSize=ff}}",
                        b"N^{CGRect={CGPoint=dd}{CGSize=dd}}",
                    )
                },
                4: {
                    "type": sel32or64(
    ...
    r(
        ...
        b"layoutManager:textContainer:didChangeGeometryFromSize:",
        {
            ...
            "arguments": {
                2: {"type": b"@"},
                3: {"type": b"@"},
                4: {"type": sel32or64(b"{_NSSize=ff}", b"{CGSize=dd}")},
            },
        },
    )
    r(
    ...
    r(
        ...
        {"arguments": {4: {"type": sel32or64(b"{_NSPoint=ff}", b"{CGPoint=dd}")}}},
    )
    r(
        b"NSObject",
    ...
    r(
        ...
        b"performFeedbackPattern:performanceTime:",
        {
            "required": True,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"q"}, 3: {"type": sel32or64(b"I", b"Q")}},
        },
    )
    r(
        b"NSObject",
    ...
    r(
        ...
        b"rulerView:pointForlocation:",
        {
            ...
            "arguments": {3: {"type": sel32or64(b"f", b"d")}},
        },
    )
    r(
        b"NSObject",
    ...
    r(
        ...
        {
            "arguments": {
                6: {"type": ":", "sel_of_type": sel32or64(b"v@:@i^v", b"v@:@q^v")},
                7: {"type": "^v"},
            }
        },
    )
    ...
    r(
        b"NSPageLayout",
        b"beginSheetUsingPrintInfo:on:completionHandler:",
        {
            "arguments": {
                4: {
                    "callable": {
    ...
    r(
        ...
        {
            "retval": {"type": sel32or64(b"f", b"d")},
            "arguments": {4: {"type": sel32or64(b"f", b"d")}},
        },
    )
    r(
        b"NSTextView",
    ...
    r(
        ...
        {
            "arguments": {
                2: {"type": sel32or64(b"^^{_NSRect}", b"^^{CGRect}")},
