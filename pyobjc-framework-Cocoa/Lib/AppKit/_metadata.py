...
#
# Last update: Mon Oct  1 16:46:58 2012
...
misc.update({'NSEdgeInsets': objc.createStructType('NSEdgeInsets', sel32or64(b'{_NSEdgeInsets=ffff}', b'{_NSEdgeInsets=dddd}'), ['top', 'left', 'bottom', 'right']), 'NSOpenGLPixelFormatAuxiliary': objc.createStructType('NSOpenGLPixelFormatAuxiliary', b'{_CGLPixelFormatObject=}', []), 'NSScreenAuxiliaryOpaque': objc.createStructType('NSScreenAuxiliaryOpaque', b'{NSScreenAuxiliary=}', []), 'NSOpenGLContextAuxiliary': objc.createStructType('NSOpenGLContextAuxiliary', b'{_CGLContextObject=}', [])})
...
try:
    ...
    r(b'NSCustomImageRep', b'initWithSize:flipped:drawingHandler:', {'arguments': {3: {'type': b'Z'}}})
    ...
    r(b'NSImage', b'imageWithSize:flipped:drawingHandler:', {'arguments': {3: {'type': b'Z'}}})
