...
#
# Last update: Tue Jul 23 22:29:29 2024
#
# flake8: noqa
...
misc.update(
    {
        ...
        "NSWritingToolsAllowedInputOptions": NewType(
            "NSWritingToolsAllowedInputOptions", int
        ),
...
try:
    ...
    r(
        b"NSObject",
        b"setWritingToolsAllowedInputOptions:",
        {"required": False, "retval": {"type": b"v"}, "arguments": {2: {"type": b"Q"}}},
    )
    r(
        b"NSObject",
    ...
    r(
        b"NSObject",
        b"writingToolsAllowedInputOptions",
        {"required": False, "retval": {"type": b"Q"}},
    )
    r(
        b"NSObject",
