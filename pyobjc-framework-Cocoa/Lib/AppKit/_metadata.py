...
#
# Last update: Tue Feb 11 22:00:46 2020
#
# flake8: noqa
...
misc.update(
    {
        "NSAnyEventMask": sel32or64(4294967295, 18446744073709551615),
        "NSTouchPhaseAny": sel32or64(4294967295, 18446744073709551615),
        "NS_USER_ACTIVITY_SUPPORTED": sel32or64(0, 1),
        "NSAttachmentCharacter": u"\ufffc",
        "NSDragOperationEvery": sel32or64(4294967295, 18446744073709551615),
    }
)
misc.update(
    {
