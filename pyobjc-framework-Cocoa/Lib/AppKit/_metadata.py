...
misc.update({'_CFlags': objc.createStructType('_CFlags', sel32or64(b'{__CFlags=IIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII}', b'{__CFlags=IIIIQIIIIIIIIIIIQIIIIIIIIIIIIIIQIIIIIIIIIIIIIIIII}'), ['state', 'highlighted', 'disabled', 'editable', 'type', 'vCentered', 'hCentered', 'bordered', 'bezeled', 'selectable', 'scrollable', 'continuous', 'actOnMouseDown', 'isLeaf', 'invalidObjectValue', 'invalidFont', 'lineBreakMode', 'cellReserved1', 'singleLineMode', 'actOnMouseDragged', 'isLoaded', 'truncateLastLine', 'dontActOnMouseUp', 'isWhite', 'useUserKeyEquivalent', 'showsFirstResponder', 'focusRingType', 'wasSelectable', 'hasInvalidObject', 'allowsEditingTextAttributes', 'importsGraphics', 'alignment', 'layoutDirectionRTL', 'backgroundStyle', 'cellReserved2', 'refusesFirstResponder', 'needsHighlightedText', 'dontAllowsUndo', 'currentlyEditing', 'allowsMixedState', 'inMixedState', 'sendsActionOnEndEditing', 'inSendAction', 'menuWasSet', 'controlTint', 'controlSize', 'branchImageDisabled', 'drawingInRevealover', 'needsHighlightedTextHint']), 'NSEdgeInsets': objc.createStructType('NSEdgeInsets', sel32or64(b'{_NSEdgeInsets=ffff}', b'{_NSEdgeInsets=dddd}'), ['top', 'left', 'bottom', 'right']), '_Brflags': objc.createStructType('_Brflags', b'{__Brflags=IIIIIIIIIIIIIIIIIIIIIIIIIII}', ['firstVisibleCalculationDisabled', 'prefersAllColumnUserResizing', 'usesSmallScrollers', 'usesSmallSizeTitleFont', 'actionNeedsToBeSent', 'acceptsFirstMouse', 'refusesFirstResponder', 'disableCompositing', 'delegateSelectsCellsByRow', 'allowsIncrementalSearching', 'time', 'hasHorizontalScroller', 'prohibitEmptySel', 'sendActionOnArrowKeys', 'dontDrawTitles', 'acceptArrowKeys', 'delegateValidatesColumns', 'delegateDoesNotCreateRowsInMatrix', 'delegateSelectsCellsByString', 'delegateSetsTitles', 'delegateImplementsWillDisplayCell', 'separateColumns', 'titleFromPrevious', 'isTitled', 'reuseColumns', 'allowsBranchSelection', 'allowsMultipleSelection']), 'NSScreenAuxiliaryOpaque': objc.createStructType('NSScreenAuxiliaryOpaque', b'{NSScreenAuxiliary=}', []), '_MFlags': objc.createStructType('_MFlags', b'{__MFlags=IIIIIIIIIIIIIIIIIIIIIIIIIIIII}', ['reservedMatrix', 'drawingContextMenuHighlightOnAllSelectedRows', 'drawingContextMenuHighlight', 'browserOptimizationsEnabled', 'needsRedrawBeforeFirstLiveResizeCache', 'tmpAllowNonVisibleCellsToBecomeFirstResponder', 'subclassIsSafeForLiveResize', 'hasCachedSubclassIsSafeForLiveResize', 'liveResizeImageCacheingEnabled', 'checkForSimpleTrackingMode', 'useSimpleTrackingMode', 'refusesFirstResponder', 'dontScroll', 'changingSelectionWithKeyboard', 'onlySetKeyCell', 'currentlySelectingCell', 'allowsIncrementalSearching', 'tabKeyTraversesCellsExplicitlySet', 'tabKeyTraversesCells', 'drawingAncestor', 'autosizeCells', 'drawsBackground', 'drawsCellBackground', 'selectionByRect', 'autoscroll', 'allowEmptySel', 'listMode', 'radioMode', 'highlightMode']), '_MVFlags': objc.createStructType('_MVFlags', b'{__MVFlags=IIIIII}', ['editable', 'loopMode', 'playsEveryFrame', 'playsSelectionOnly', 'controllerVisible', 'reserved']), '_NSProgressIndicatorThreadInfo': objc.createStructType('_NSProgressIndicatorThreadInfo', b'{__NSProgressIndicatorThreadInfo=}', []), '_BCFlags2': objc.createStructType('_BCFlags2', b'{__BCFlags2=IIIIII}', ['bezelStyle', 'showsBorderOnlyWhileMouseInside', 'mouseInside', 'bezelStyle2', 'imageScaling', 'keyEquivalentModifierMask']), '_TvFlags': objc.createStructType('_TvFlags', b'{__TvFlags=IIIIIIIIIIIIIIIIIII}', ['refusesFirstResponder', 'movedPostingDisableCount', 'selectionPostingDisableCount', 'dataSourceSetObjectValue', 'oldAutoresizesAllColumnsToFit', 'delegateSelectionShouldChangeInTableView', 'delegateShouldSelectTableColumn', 'delegateShouldSelectRow', 'delegateShouldEditTableColumn', 'delegateWillDisplayCell', 'compareWidthWithSuperview', 'changingLayout', 'selectionType', 'allowsColumnSelection', 'allowsMultipleSelection', 'allowsEmptySelection', 'oldDrawsGridFlag', 'allowsColumnResizing', 'allowsColumnReordering']), 'NSOpenGLPixelFormatAuxiliary': objc.createStructType('NSOpenGLPixelFormatAuxiliary', b'{_CGLPixelFormatObject=}', []), 'NSOpenGLContextAuxiliary': objc.createStructType('NSOpenGLContextAuxiliary', b'{_CGLContextObject=}', []), 'NSTypesetterGlyphInfo': objc.createStructType('NSTypesetterGlyphInfo', b'{_NSTypesetterGlyphInfo={_NSPoint=ff}fffI@{_NSSize=ff}{=III}}', ['curLocation', 'extent', 'belowBaseline', 'aboveBaseline', 'glyphCharacterIndex', 'font', 'attachmentSize', '_giflags']), '_NSThreadPrivate': objc.createStructType('_NSThreadPrivate', b'{NSThreadPrivate=}', []), '_VFlags': objc.createStructType('_VFlags', b'{__VFlags=IIIIIIIIIIIIIIIIIIIIII}', ['aboutToResize', 'retainCountOverMax', 'retainCount', 'interfaceStyle1', 'specialArchiving', 'needsDisplayForBounds', 'interfaceStyle0', 'removingWithoutInvalidation', 'needsBoundsChangeNote', 'boundsChangeNotesSuspended', 'focusChangeNotesSuspended', 'needsFrameChangeNote', 'frameChangeNotesSuspended', 'noVerticalAutosizing', 'newGState', 'validGState', 'needsDisplay', 'wantsGState', 'autoresizeSubviews', 'autosizing', 'rotatedOrScaledFromBase', 'rotatedFromBase'])})
...
misc.update({'NSAnyEventMask': sel32or64(4294967295, 18446744073709551615), 'NSTouchPhaseAny': sel32or64(4294967295, 18446744073709551615), 'NSAttachmentCharacter': b'\xef\xbf\xbc'.decode("utf-8"), 'NSDragOperationEvery': sel32or64(4294967295, 18446744073709551615)})
...
try:
    ...
    r(b'NSApplication', b'restoreWindowWithIdentifier:state:completionHandler:', {'retval': {'type': b'Z'}})
    ...
    r(b'NSDocument', b'autosaveWithImplicitCancellability:completionHandler:', {'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'NSDocument', b'checkAutosavingSafetyAndReturnError:', {'retval': {'type': b'Z'}})
    ...
    r(b'NSDocument', b'performActivityWithSynchronousWaiting:usingBlock:', {'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'NSDocumentController', b'duplicateDocumentWithContentsOfURL:copying:displayName:error:', {'arguments': {3: {'type': b'Z'}}})
    ...
    r(b'NSDocumentController', b'openDocumentWithContentsOfURL:display:completionHandler:', {'arguments': {3: {'type': b'Z'}}})
    ...
    r(b'NSDocumentController', b'reopenDocumentForURL:withContentsOfURL:display:completionHandler:', {'arguments': {4: {'type': b'Z'}}})
    ...
    r(b'NSFontCollection', b'hideFontCollectionWithName:visibility:error:', {'retval': {'type': b'Z'}})
    r(b'NSFontCollection', b'renameFontCollectionWithName:visibility:toName:error:', {'retval': {'type': b'Z'}})
    r(b'NSFontCollection', b'showFontCollection:withName:visibility:error:', {'retval': {'type': b'Z'}})
    ...
    r(b'NSObject', b'browser:draggingImageForRowsWithIndexes:inColumn:withEvent:offset:', {'retval': {'type': '@'}, 'arguments': {4: {'type': sel32or64(b'i', b'q')}, 6: {'type_modifier': b'N'}}})
    ...
    r(b'NSObject', b'browser:validateDrop:proposedRow:column:dropOperation:', {'retval': {'type': 'I'}, 'arguments': {4: {'type_modifier': b'N'}, 5: {'type_modifier': b'N'}, 6: {'type_modifier': b'N'}}})
    ...
    r(b'NSSimpleHorizontalTypesetter', b'typesetterLaidOneGlyph:', {'arguments': {2: {'type_modifier': b'N'}}})
    ...
    r(b'NSView', b'alignmentRectInsets', {'retval': {'type': sel32or64(b'{_NSEdgeInsets=ffff}', b'{_NSEdgeInsets=dddd}')}})
...
try:
    ...
    r(b'NSObject', b'allowsMultipleSelection', {'retval': {'type': b'Z'}})
    r(b'NSObject', b'alphaControlAddedOrRemoved:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'animatesToDestination', {'retval': {'type': b'Z'}})
    ...
    r(b'NSObject', b'browser:draggingImageForRowsWithIndexes:inColumn:withEvent:offset:', {'required': False, 'retval': {'type': '@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': sel32or64(b'i', b'q')}, 5: {'type': b'@'}, 6: {'type': sel32or64(b'^{_NSPoint=ff}', b'^{CGPoint=dd}'), 'type_modifier': b'N'}}})
    ...
    r(b'NSObject', b'browser:validateDrop:proposedRow:column:dropOperation:', {'required': False, 'retval': {'type': 'I'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': sel32or64(b'^i', b'^q'), 'type_modifier': b'N'}, 5: {'type': sel32or64(b'^i', b'^q'), 'type_modifier': b'N'}, 6: {'type': sel32or64(b'^I', b'^Q'), 'type_modifier': b'N'}}})
    ...
    r(b'NSObject', b'contentViewAtIndex:effectiveCharacterRange:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': sel32or64(b'^{_NSRange=II}', b'^{_NSRange=QQ}')}}})
    ...
    r(b'NSObject', b'draggingFormation', {'retval': {'type': sel32or64(b'i', b'q')}})
    ...
    r(b'NSObject', b'enumerateDraggingItemsWithOptions:forView:classes:searchOptions:usingBlock:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}, 6: {'type': b'@?'}}})
    r(b'NSObject', b'findBarView', {'retval': {'type': b'@'}})
    ...
    r(b'NSObject', b'firstSelectedRange', {'retval': {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}})
    ...
    r(b'NSObject', b'identifier', {'retval': {'type': b'@'}})
    ...
    r(b'NSObject', b'numberOfValidItemsForDrop', {'retval': {'type': sel32or64(b'i', b'q')}})
    ...
    r(b'NSObject', b'selectedRange', {'required': True, 'retval': {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}})
    r(b'NSObject', b'selectedRanges', {'retval': {'type': b'@'}})
    ...
    r(b'NSObject', b'setAnimatesToDestination:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'NSObject', b'setDraggingFormation:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'setEditable:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'Z'}}})
    r(b'NSObject', b'setFindBarView:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'setFindBarVisible:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'Z'}}})
    r(b'NSObject', b'setFirstSelectedRange:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSObject', b'setIdentifier:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'setNumberOfValidItemsForDrop:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'setSelectable:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'Z'}}})
    r(b'NSObject', b'setSelectedRanges:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'string', {'retval': {'type': b'@'}})
    ...
    r(b'NSObject', b'visibleCharacterRanges', {'retval': {'type': b'@'}})
