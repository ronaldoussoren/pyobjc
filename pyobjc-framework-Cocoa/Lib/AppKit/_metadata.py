...
#
# Last update: Sat Mar  1 10:26:39 2025
#
# flake8: noqa
...
try:
    ...
    r(
        b"NSObject",
        b"allowsWritingToolsAffordance",
        {"required": False, "retval": {"type": b"Z"}},
    )
    ...
    r(b"NSPasteboardImageProperties", b"hasAlpha", {"retval": {"type": b"Z"}})
    r(
        b"NSPasteboardItem",
        b"detectMetadataForTypes:completionHandler:",
        {
    ...
    r(b"NSTextView", b"allowsWritingToolsAffordance", {"retval": {"type": b"Z"}})
    r(
        b"NSTextView",
