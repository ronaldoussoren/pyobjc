...
#
# Last update: Sun Jun 30 15:59:40 2019
...
try:
    ...
    r(b'NSObject', b'annotatedSubstringForProposedRange:actualRange:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'{_NSRange=QQ}'}, 3: {'type': b'^{_NSRange=QQ}'}}})
    ...
    r(b'NSObject', b'viewForRange:firstRect:actualRange:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'{_NSRange=QQ}'}, 3: {'type': b'^{CGRect={CGPoint=dd}{CGSize=dd}}'}, 4: {'type': b'^{_NSRange=QQ}'}}})
