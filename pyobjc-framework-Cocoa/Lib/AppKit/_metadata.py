...
#
# Last update: Wed Jul 12 07:22:52 2017
...
try:
    ...
    r(b'NSFontAssetRequest', b'downloadFontAssetsWithCompletionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
