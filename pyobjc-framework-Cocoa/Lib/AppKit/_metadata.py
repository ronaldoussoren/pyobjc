...
misc.update(
    {
        ...
        "NSWritingToolsCoordinatorTextDecoration": NewType(
            "NSWritingToolsCoordinatorTextDecoration", int
        ),
        ...
        "NSMenuItemImageVisibility": NewType("NSMenuItemImageVisibility", int),
        ...
        "NSSegmentedControlRole": NewType("NSSegmentedControlRole", int),
        "NSScreenTouchCapabilities": NewType("NSScreenTouchCapabilities", int),
        ...
        "NSControlEvents": NewType("NSControlEvents", int),
        "NSTIFFCompression": NewType("NSTIFFCompression", int),
        "NSTextAttachmentViewProviderReusePolicy": NewType(
            "NSTextAttachmentViewProviderReusePolicy", int
        ),
        ...
        "NSTextSelectionMode": NewType("NSTextSelectionMode", int),
        ...
        "NSViewExclusiveGestureBehavior": NewType(
            "NSViewExclusiveGestureBehavior", int
        ),
        ...
        "NSToolbarItemGroupRole": NewType("NSToolbarItemGroupRole", int),
...
misc.update(
    {
        ...
        "NSOpenGLPixelFormatAttribute": NewType("NSOpenGLPixelFormatAttribute", int),
...
functions = {
    ...
    "NSApplicationMain": (
        b"ii^^t",
        "",
        {"arguments": {1: {"type_modifier": "n", "c_array_length_in_arg": 0}}},
    ),
    "NSOpenGLGetVersion": (
        b"v^i^i",
        "",
    ...
    "NSConvertGlyphsToPackedGlyphs": (
        ...
        "",
        {
            "arguments": {
                ...
                3: {"type_modifier": "o", "c_array_of_varialbe_length": True},
            }
        },
    ),
    "NSGetFileType": (b"@@",),
...
aliases = {
    "NSTextBlockMinimumHeight": "NSTextBlockDimensionMinimumHeight",
    "NSTextBlockPercentageValueType": "NSTextBlockValueTypePercentage",
    "NSBezelStyleRoundedDisclosure": "NSBezelStylePushDisclosure",
    "NSTextTableFixedLayoutAlgorithm": "NSTextTableLayoutAlgorithmFixed",
    "NSTextBlockWidth": "NSTextBlockDimensionWidth",
    "NSBezelStyleRegularSquare": "NSBezelStyleFlexiblePush",
    "NSTextBlockHeight": "NSTextBlockDimensionHeight",
    ...
    "NSTextBlockTopAlignment": "NSTextBlockVerticalAlignmentTop",
    "NSTextBlockBaselineAlignment": "NSTextBlockVerticalAlignmentBaseline",
    ...
    "NSTextBlockMargin": "NSTextBlockLayerMargin",
    ...
    "NSTextBlockAbsoluteValueType": "NSTextBlockValueTypeAbsolute",
    "NSTextBlockMinimumWidth": "NSTextBlockDimensionMinimumWidth",
    ...
    "NSTextTableAutomaticLayoutAlgorithm": "NSTextTableLayoutAlgorithmAutomatic",
    "NSScreenSaverWindowLevel": "kCGScreenSaverWindowLevel",
    "NSTextBlockBottomAlignment": "NSTextBlockVerticalAlignmentBottom",
    ...
    "NSTextBlockBorder": "NSTextBlockLayerBorder",
    ...
    "NSTextBlockMiddleAlignment": "NSTextBlockVerticalAlignmentMiddle",
    ...
    "NSTextBlockMaximumWidth": "NSTextBlockDimensionMaximumWidth",
    "NSTextBlockPadding": "NSTextBlockLayerPadding",
    "NSFontDescriptorTraitEmphasized": "NSFontDescriptorTraitBold",
    "NSTextBlockMaximumHeight": "NSTextBlockDimensionMaximumHeight",
}
misc.update(
    {
...
try:
    ...
    r(b"NSAttributedString", b"containsAttachmentsInRange:", {"retval": {"type": b"Z"}})
    r(
        b"NSAttributedString",
    ...
    r(
        b"NSControl",
        b"removeTarget:action:forControlEvents:",
        {"arguments": {3: {"sel_of_type": b"v@:@@"}}},
    )
    r(
        b"NSControl",
    ...
    r(b"NSEvent", b"isTouchSwipeNavigationEnabled", {"retval": {"type": b"Z"}})
    r(
        b"NSEvent",
    ...
    r(
        b"NSGestureRecognizer",
        b"isCancellableByScrollGesture",
        {"retval": {"type": b"Z"}},
    )
    ...
    r(
        b"NSGestureRecognizer",
        b"setCancellableByScrollGesture:",
        {"arguments": {2: {"type": b"Z"}}},
    )
    r(
        b"NSGestureRecognizer",
    ...
    r(b"NSGlassEffectView", b"effectIsInteractive", {"retval": {"type": b"Z"}})
    r(
        b"NSGlassEffectView",
        b"setEffectIsInteractive:",
        {"arguments": {2: {"type": b"Z"}}},
    )
    r(
        b"NSGlyphGenerator",
    ...
    r(
        b"NSObject",
        b"browser:draggingSession:endedAtPoint:operation:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {
    ...
    r(
        b"NSObject",
        b"browser:draggingSession:willBeginAtPoint:forRowsWithIndexes:column:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {
    ...
    r(
        b"NSObject",
        b"browser:pasteboardWriterForRow:column:",
        {
            "required": False,
            "retval": {"type": b"@"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"q"}, 4: {"type": b"q"}},
    ...
    r(
        b"NSObject",
        b"convertInteractionPoint:toContainerAtLocation:",
        {
            "required": False,
            "retval": {"type": b"{CGPoint=dd}"},
    ...
    r(b"NSObject", b"hash", {"required": True, "retval": {"type": b"Q"}})
    r(
        b"NSObject",
        b"highlight:withFrame:inView:",
        {
    ...
    r(
        b"NSObject",
        b"selectionManager:frameOfTextContainerAtPoint:",
        {
            "required": False,
            "retval": {"type": b"{CGRect={CGPoint=dd}{CGSize=dd}}"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"{CGPoint=dd}"}},
    ...
    r(
        b"NSObject",
        b"selectionManager:locationOfTextContainerAtPoint:",
        {
            "required": False,
            "retval": {"type": b"@"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"{CGPoint=dd}"}},
    ...
    r(
        b"NSObject",
        b"selectionManager:makeDraggingSessionWithGesture:",
        {
            "required": False,
            "retval": {"type": b"@"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}},
    ...
    r(
        b"NSObject",
        b"selectionManager:shouldBeginSelectionAtPoint:",
        {
            "required": False,
            "retval": {"type": b"Z"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"{CGPoint=dd}"}},
    ...
    r(
        b"NSObject",
        b"selectionManagerDidEndSelection:",
        {"required": False, "retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    )
    r(
        b"NSObject",
        b"selectionManagerWillBeginSelection:",
        {"required": False, "retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    )
    r(
        b"NSObject",
    ...
    r(
        b"NSObject",
        b"statusItem:didBeginExpandedInterfaceSession:",
        {
            "required": True,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}},
    ...
    r(
        b"NSObject",
        b"statusItemDidEndExpandedInterfaceSession:animated:",
        {
            "required": True,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"Z"}},
    ...
    r(
        b"NSObject",
        b"textLayoutManager:cacheTextAttachmentViewProvider:forTextAttachment:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}, 4: {"type": b"@"}},
    ...
    r(
        b"NSObject",
        b"textLayoutManager:retrieveCachedTextAttachmentViewProviderForTextAttachment:",
        {
            "required": False,
            "retval": {"type": b"@"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}},
    ...
    r(b"NSObject", b"textSelection", {"required": True, "retval": {"type": b"@"}})
    r(
        b"NSObject",
    ...
    r(
        b"NSObject",
        b"textViewportLayoutController:cacheRenderingSurface:forKey:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}, 4: {"type": b"@"}},
    ...
    r(
        b"NSObject",
        b"textViewportLayoutController:renderingSurfaceForTextLayoutFragment:",
        {
            "required": False,
            "retval": {"type": b"@"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}},
    ...
    r(
        b"NSObject",
        b"textViewportLayoutController:retrieveCachedRenderingSurfaceForKey:",
        {
            "required": False,
            "retval": {"type": b"@"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}},
    ...
    r(
        b"NSObject",
        b"textViewportLayoutControllerReceivedSetNeedsLayout:",
        {"required": False, "retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    )
    r(
        b"NSObject",
    ...
    r(
        b"NSObject",
        b"writingToolsCoordinator:requestsGrammarResultsForContext:completion:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {
    ...
    r(
        b"NSObject",
        b"writingToolsCoordinator:requestsPreviewForTextAnimation:ofRange:inContext:textDecoration:completion:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {
    ...
    r(
        b"NSObject",
        b"writingToolsCoordinator:setGrammarCheckingEnabled:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"Z"}},
    ...
    r(b"NSRefreshController", b"action", {"retval": {"sel_of_type": b"v@:@"}})
    r(b"NSRefreshController", b"isRefreshing", {"retval": {"type": b"Z"}})
    r(
        b"NSRefreshController",
        b"setAction:",
        {"arguments": {2: {"sel_of_type": b"v@:@"}}},
    )
    ...
    r(
        b"NSSavePanel",
        b"beginSheetForDirectory:file:types:modalForWindow:modalDelegate:didEndSelector:contextInfo:",
        {"arguments": {8: {"type": "^v"}, 7: {"sel_of_type": b"v@:@q^v"}}},
    )
    r(
        b"NSSavePanel",
        b"beginSheetModalForWindow:completionHandler:",
    ...
    r(b"NSScrollView", b"isTouchScrollingEnabled", {"retval": {"type": b"Z"}})
    ...
    r(b"NSScrollView", b"setTouchScrollingEnabled:", {"arguments": {2: {"type": b"Z"}}})
    r(
        b"NSScrollView",
    ...
    r(
        ...
        b"printingAdjustmentInLayoutManager:forNominallySpacedGlyphRange:packedGlyphs:count:",
        {
            ...
            "arguments": {
                3: {"type": "{_NSRange=QQ}"},
                4: {"type": "^v", "type_modifier": b"n", "c_array_length_in_arg": 5},
            },
        },
    )
    r(
    ...
    r(
        b"NSWritingToolsCoordinator",
        b"showGrammarPresentationForRange:inContext:",
        {"retval": {"type": b"Z"}},
    )
    r(
...
objc.registerNewKeywordsFromSelector("NSAccessibilityCustomRotorItemResult", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSAdaptiveImageGlyph", b"init")
...
objc.registerNewKeywordsFromSelector("NSBindingSelectionMarker", b"init")
objc.registerNewKeywordsFromSelector(
    "NSBitmapImageRep",
    b"initWithBitmapDataPlanes:pixelsWide:pixelsHigh:bitsPerSample:samplesPerPixel:hasAlpha:isPlanar:colorSpaceName:bitmapFormat:bytesPerRow:bitsPerPixel:",
)
...
objc.registerNewKeywordsFromSelector("NSCell", b"init")
...
objc.registerNewKeywordsFromSelector("NSCollectionLayoutAnchor", b"init")
objc.registerNewKeywordsFromSelector(
    "NSCollectionLayoutBoundarySupplementaryItem", b"init"
)
objc.registerNewKeywordsFromSelector("NSCollectionLayoutDecorationItem", b"init")
objc.registerNewKeywordsFromSelector("NSCollectionLayoutDimension", b"init")
objc.registerNewKeywordsFromSelector("NSCollectionLayoutEdgeSpacing", b"init")
objc.registerNewKeywordsFromSelector("NSCollectionLayoutGroup", b"init")
objc.registerNewKeywordsFromSelector("NSCollectionLayoutGroupCustomItem", b"init")
objc.registerNewKeywordsFromSelector("NSCollectionLayoutItem", b"init")
objc.registerNewKeywordsFromSelector("NSCollectionLayoutSection", b"init")
objc.registerNewKeywordsFromSelector("NSCollectionLayoutSize", b"init")
objc.registerNewKeywordsFromSelector("NSCollectionLayoutSpacing", b"init")
objc.registerNewKeywordsFromSelector("NSCollectionLayoutSupplementaryItem", b"init")
objc.registerNewKeywordsFromSelector("NSCollectionViewCompositionalLayout", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSCollectionViewDiffableDataSource", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSColor", b"init")
...
objc.registerNewKeywordsFromSelector("NSController", b"init")
...
objc.registerNewKeywordsFromSelector("NSDataAsset", b"init")
...
objc.registerNewKeywordsFromSelector("NSDictionaryControllerKeyValuePair", b"init")
objc.registerNewKeywordsFromSelector("NSDocument", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSDocumentController", b"init")
objc.registerNewKeywordsFromSelector("NSDocumentController", b"initWithCoder:")
objc.registerNewKeywordsFromSelector("NSDraggingImageComponent", b"init")
objc.registerNewKeywordsFromSelector("NSDraggingImageComponent", b"initWithKey:")
objc.registerNewKeywordsFromSelector("NSDraggingItem", b"init")
...
objc.registerNewKeywordsFromSelector("NSFilePromiseProvider", b"init")
objc.registerNewKeywordsFromSelector(
    "NSFilePromiseProvider", b"initWithFileType:delegate:"
)
objc.registerNewKeywordsFromSelector("NSFontAssetRequest", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSImageRep", b"init")
...
objc.registerNewKeywordsFromSelector("NSLayoutManager", b"init")
...
objc.registerNewKeywordsFromSelector("NSMenuItemBadge", b"init")
...
objc.registerNewKeywordsFromSelector("NSMovie", b"init")
...
objc.registerNewKeywordsFromSelector("NSPopover", b"init")
...
objc.registerNewKeywordsFromSelector("NSPreviewRepresentingActivityItem", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSPrintInfo", b"init")
...
objc.registerNewKeywordsFromSelector("NSResponder", b"init")
objc.registerNewKeywordsFromSelector("NSResponder", b"initWithCoder:")
objc.registerNewKeywordsFromSelector("NSRulerMarker", b"init")
...
objc.registerNewKeywordsFromSelector("NSScrollEdgeEffectStyle", b"init")
...
objc.registerNewKeywordsFromSelector("NSScrubberLayout", b"init")
...
objc.registerNewKeywordsFromSelector("NSScrubberSelectionStyle", b"init")
...
objc.registerNewKeywordsFromSelector("NSShadow", b"init")
objc.registerNewKeywordsFromSelector("NSShadow", b"initWithCoder:")
objc.registerNewKeywordsFromSelector("NSSharingCollaborationModeRestriction", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSSharingService", b"init")
objc.registerNewKeywordsFromSelector(
    "NSSharingService", b"initWithTitle:image:alternateImage:handler:"
)
objc.registerNewKeywordsFromSelector("NSSharingServicePicker", b"init")
...
objc.registerNewKeywordsFromSelector("NSSpeechRecognizer", b"init")
...
objc.registerNewKeywordsFromSelector("NSTableViewDiffableDataSource", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSTextAttachmentViewProvider", b"init")
objc.registerNewKeywordsFromSelector(
    "NSTextAttachmentViewProvider",
    b"initWithTextAttachment:parentView:textLayoutManager:location:",
)
objc.registerNewKeywordsFromSelector("NSTextBlock", b"init")
objc.registerNewKeywordsFromSelector("NSTextBlock", b"initWithCoder:")
objc.registerNewKeywordsFromSelector("NSTextCheckingController", b"init")
...
objc.registerNewKeywordsFromSelector("NSTextContentManager", b"init")
...
objc.registerNewKeywordsFromSelector("NSTextFinder", b"init")
objc.registerNewKeywordsFromSelector("NSTextFinder", b"initWithCoder:")
objc.registerNewKeywordsFromSelector("NSTextInputContext", b"init")
objc.registerNewKeywordsFromSelector("NSTextInputContext", b"initWithClient:")
objc.registerNewKeywordsFromSelector("NSTextLayoutFragment", b"init")
...
objc.registerNewKeywordsFromSelector("NSTextLayoutManager", b"init")
objc.registerNewKeywordsFromSelector("NSTextLayoutManager", b"initWithCoder:")
objc.registerNewKeywordsFromSelector("NSTextLineFragment", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSTextPreview", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSTextRange", b"init")
...
objc.registerNewKeywordsFromSelector("NSTextSelection", b"init")
...
objc.registerNewKeywordsFromSelector("NSTextSelectionNavigation", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSTextTableBlock", b"initWithCoder:")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSTextViewportLayoutController", b"init")
objc.registerNewKeywordsFromSelector(
    "NSTextViewportLayoutController", b"initWithTextLayoutManager:"
)
objc.registerNewKeywordsFromSelector("NSToolbar", b"init")
...
objc.registerNewKeywordsFromSelector("NSTouchBar", b"init")
objc.registerNewKeywordsFromSelector("NSTouchBar", b"initWithCoder:")
objc.registerNewKeywordsFromSelector("NSTouchBarItem", b"init")
...
objc.registerNewKeywordsFromSelector("NSUserInterfaceCompressionOptions", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSViewCornerConfiguration", b"init")
objc.registerNewKeywordsFromSelector("NSViewCornerRadii", b"init")
objc.registerNewKeywordsFromSelector("NSViewCornerRadius", b"init")
objc.registerNewKeywordsFromSelector("NSViewLayoutRegion", b"init")
...
objc.registerNewKeywordsFromSelector("NSWritingToolsCoordinatorContext", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywords(
    "NSAttributedString",
    ("adaptiveImageGlyph", "attributes"),
    "attributedStringWithAdaptiveImageGlyph_attributes_",
)
objc.registerNewKeywords(
    "NSAttributedString",
    ("attachment", "attributes"),
    "attributedStringWithAttachment_attributes_",
)
objc.registerNewKeywords(
    "NSButton", ("image", "target", "action"), "buttonWithImage_target_action_"
)
objc.registerNewKeywords(
    "NSButton",
    ("title", "image", "target", "action"),
    "buttonWithTitle_image_target_action_",
)
objc.registerNewKeywords(
    "NSButton", ("title", "target", "action"), "buttonWithTitle_target_action_"
)
objc.registerNewKeywords(
    "NSButton", ("title", "target", "action"), "checkboxWithTitle_target_action_"
)
objc.registerNewKeywords(
    "NSButton", ("title", "target", "action"), "radioButtonWithTitle_target_action_"
)
objc.registerNewKeywords(
    "NSButtonTouchBarItem",
    ("identifier", "image", "target", "action"),
    "buttonTouchBarItemWithIdentifier_image_target_action_",
)
objc.registerNewKeywords(
    "NSButtonTouchBarItem",
    ("identifier", "title", "image", "target", "action"),
    "buttonTouchBarItemWithIdentifier_title_image_target_action_",
)
objc.registerNewKeywords(
    "NSButtonTouchBarItem",
    ("identifier", "title", "target", "action"),
    "buttonTouchBarItemWithIdentifier_title_target_action_",
)
objc.registerNewKeywords(
    "NSCollectionLayoutAnchor", ("edges",), "layoutAnchorWithEdges_"
)
objc.registerNewKeywords(
    "NSCollectionLayoutAnchor",
    ("edges", "absoluteOffset"),
    "layoutAnchorWithEdges_absoluteOffset_",
)
objc.registerNewKeywords(
    "NSCollectionLayoutAnchor",
    ("edges", "fractionalOffset"),
    "layoutAnchorWithEdges_fractionalOffset_",
)
objc.registerNewKeywords(
    "NSCollectionLayoutBoundarySupplementaryItem",
    ("layoutSize", "elementKind", "alignment"),
    "boundarySupplementaryItemWithLayoutSize_elementKind_alignment_",
)
objc.registerNewKeywords(
    "NSCollectionLayoutBoundarySupplementaryItem",
    ("layoutSize", "elementKind", "alignment", "absoluteOffset"),
    "boundarySupplementaryItemWithLayoutSize_elementKind_alignment_absoluteOffset_",
)
objc.registerNewKeywords(
    "NSCollectionLayoutDecorationItem",
    ("elementKind",),
    "backgroundDecorationItemWithElementKind_",
)
objc.registerNewKeywords(
    "NSCollectionLayoutGroup",
    ("layoutSize", "itemProvider"),
    "customGroupWithLayoutSize_itemProvider_",
)
objc.registerNewKeywords(
    "NSCollectionLayoutGroup",
    ("layoutSize", "subitem", "count"),
    "horizontalGroupWithLayoutSize_subitem_count_",
)
objc.registerNewKeywords(
    "NSCollectionLayoutGroup",
    ("layoutSize", "subitems"),
    "horizontalGroupWithLayoutSize_subitems_",
)
objc.registerNewKeywords(
    "NSCollectionLayoutGroup",
    ("layoutSize", "subitem", "count"),
    "verticalGroupWithLayoutSize_subitem_count_",
)
objc.registerNewKeywords(
    "NSCollectionLayoutGroup",
    ("layoutSize", "subitems"),
    "verticalGroupWithLayoutSize_subitems_",
)
objc.registerNewKeywords(
    "NSCollectionLayoutGroupCustomItem", ("frame",), "customItemWithFrame_"
)
objc.registerNewKeywords(
    "NSCollectionLayoutGroupCustomItem",
    ("frame", "zIndex"),
    "customItemWithFrame_zIndex_",
)
objc.registerNewKeywords(
    "NSCollectionLayoutItem", ("layoutSize",), "itemWithLayoutSize_"
)
objc.registerNewKeywords(
    "NSCollectionLayoutItem",
    ("layoutSize", "supplementaryItems"),
    "itemWithLayoutSize_supplementaryItems_",
)
objc.registerNewKeywords("NSCollectionLayoutSection", ("group",), "sectionWithGroup_")
objc.registerNewKeywords(
...
objc.registerNewKeywords(
    ...
    ("layoutSize", "elementKind", "containerAnchor"),
    "supplementaryItemWithLayoutSize_elementKind_containerAnchor_",
)
objc.registerNewKeywords(
    "NSCollectionLayoutSupplementaryItem",
    ("layoutSize", "elementKind", "containerAnchor", "itemAnchor"),
    "supplementaryItemWithLayoutSize_elementKind_containerAnchor_itemAnchor_",
)
objc.registerNewKeywords(
    "NSCollectionViewLayoutAttributes",
    ("indexPath",),
    "layoutAttributesForItemWithIndexPath_",
)
objc.registerNewKeywords(
    "NSColorPickerTouchBarItem", ("identifier",), "colorPickerWithIdentifier_"
)
objc.registerNewKeywords(
    "NSColorPickerTouchBarItem",
    ("identifier", "buttonImage"),
    "colorPickerWithIdentifier_buttonImage_",
)
objc.registerNewKeywords(
    "NSColorPickerTouchBarItem", ("identifier",), "strokeColorPickerWithIdentifier_"
)
objc.registerNewKeywords(
    "NSColorPickerTouchBarItem", ("identifier",), "textColorPickerWithIdentifier_"
)
objc.registerNewKeywords("NSColorWell", ("style",), "colorWellWithStyle_")
objc.registerNewKeywords(
    "NSComboButton",
    ("image", "menu", "target", "action"),
    "comboButtonWithImage_menu_target_action_",
)
objc.registerNewKeywords(
    "NSComboButton",
    ("title", "image", "menu", "target", "action"),
    "comboButtonWithTitle_image_menu_target_action_",
)
objc.registerNewKeywords(
    "NSComboButton",
    ("title", "menu", "target", "action"),
    "comboButtonWithTitle_menu_target_action_",
)
objc.registerNewKeywords(
    "NSFileManager", ("authorization",), "fileManagerWithAuthorization_"
)
objc.registerNewKeywords(
    "NSGridView", ("numberOfColumns", "rows"), "gridViewWithNumberOfColumns_rows_"
)
objc.registerNewKeywords("NSGridView", ("views",), "gridViewWithViews_")
objc.registerNewKeywords(
    "NSGroupTouchBarItem", ("identifier",), "alertStyleGroupItemWithIdentifier_"
)
objc.registerNewKeywords(
    "NSGroupTouchBarItem", ("identifier", "items"), "groupItemWithIdentifier_items_"
)
objc.registerNewKeywords(
    "NSGroupTouchBarItem",
    ("identifier", "items", "allowedCompressionOptions"),
    "groupItemWithIdentifier_items_allowedCompressionOptions_",
)
objc.registerNewKeywords(
    "NSImage",
    ("size", "flipped", "drawingHandler"),
    "imageWithSize_flipped_drawingHandler_",
)
objc.registerNewKeywords(
    "NSImage",
    ("symbolName", "bundle", "variableValue"),
    "imageWithSymbolName_bundle_variableValue_",
)
objc.registerNewKeywords(
    "NSImage", ("symbolName", "variableValue"), "imageWithSymbolName_variableValue_"
)
objc.registerNewKeywords(
    "NSImage",
...
objc.registerNewKeywords(
    "NSImage",
    ("systemSymbolName", "variableValue", "accessibilityDescription"),
    "imageWithSystemSymbolName_variableValue_accessibilityDescription_",
)
objc.registerNewKeywords(
    "NSImageSymbolConfiguration",
    ("colorRenderingMode",),
    "configurationWithColorRenderingMode_",
)
objc.registerNewKeywords(
    "NSImageSymbolConfiguration",
    ("hierarchicalColor",),
...
objc.registerNewKeywords(
    "NSImageSymbolConfiguration", ("paletteColors",), "configurationWithPaletteColors_"
)
objc.registerNewKeywords(
    "NSImageSymbolConfiguration",
    ("pointSize", "weight"),
...
objc.registerNewKeywords(
    "NSImageSymbolConfiguration", ("scale",), "configurationWithScale_"
)
objc.registerNewKeywords(
    "NSImageSymbolConfiguration", ("textStyle",), "configurationWithTextStyle_"
)
objc.registerNewKeywords(
    "NSImageSymbolConfiguration",
    ("textStyle", "scale"),
    "configurationWithTextStyle_scale_",
)
objc.registerNewKeywords(
    "NSImageSymbolConfiguration",
    ("variableValueMode",),
    "configurationWithVariableValueMode_",
)
objc.registerNewKeywords("NSImageView", ("image",), "imageViewWithImage_")
objc.registerNewKeywords(
    "NSLayoutConstraint",
...
objc.registerNewKeywords(
    "NSMenu",
    ("colors", "titles", "selectionHandler"),
    "paletteMenuWithColors_titles_selectionHandler_",
)
objc.registerNewKeywords(
    "NSMenu",
    ("colors", "titles", "templateImage", "selectionHandler"),
    "paletteMenuWithColors_titles_templateImage_selectionHandler_",
)
objc.registerNewKeywords("NSMenuItem", ("title",), "sectionHeaderWithTitle_")
objc.registerNewKeywords(
    "NSPickerTouchBarItem",
    ("identifier", "images", "selectionMode", "target", "action"),
    "pickerTouchBarItemWithIdentifier_images_selectionMode_target_action_",
)
objc.registerNewKeywords(
    "NSPickerTouchBarItem",
    ("identifier", "labels", "selectionMode", "target", "action"),
    "pickerTouchBarItemWithIdentifier_labels_selectionMode_target_action_",
)
objc.registerNewKeywords(
    "NSPopUpButton", ("menu", "target", "action"), "popUpButtonWithMenu_target_action_"
)
objc.registerNewKeywords(
    "NSPopUpButton", ("image", "menu"), "pullDownButtonWithImage_menu_"
)
objc.registerNewKeywords(
    "NSPopUpButton", ("title", "image", "menu"), "pullDownButtonWithTitle_image_menu_"
)
objc.registerNewKeywords(
    "NSPopUpButton", ("title", "menu"), "pullDownButtonWithTitle_menu_"
)
objc.registerNewKeywords(
...
objc.registerNewKeywords(
    "NSSegmentedControl",
    ("images", "trackingMode", "target", "action"),
    "segmentedControlWithImages_trackingMode_target_action_",
)
objc.registerNewKeywords(
    "NSSegmentedControl",
    ("labels", "trackingMode", "target", "action"),
    "segmentedControlWithLabels_trackingMode_target_action_",
)
objc.registerNewKeywords(
    "NSSet", ("collectionViewIndexPath",), "setWithCollectionViewIndexPath_"
)
objc.registerNewKeywords(
    "NSSet", ("collectionViewIndexPaths",), "setWithCollectionViewIndexPaths_"
)
objc.registerNewKeywords("NSSlider", ("target", "action"), "sliderWithTarget_action_")
objc.registerNewKeywords(
    "NSSlider",
    ("value", "minValue", "maxValue", "target", "action"),
    "sliderWithValue_minValue_maxValue_target_action_",
)
objc.registerNewKeywords(
    "NSSplitViewItem", ("viewController",), "contentListWithViewController_"
)
objc.registerNewKeywords(
    "NSSplitViewItem", ("viewController",), "inspectorWithViewController_"
)
objc.registerNewKeywords(
    "NSSplitViewItem", ("viewController",), "sidebarWithViewController_"
)
objc.registerNewKeywords(
    "NSSplitViewItem", ("viewController",), "splitViewItemWithViewController_"
)
objc.registerNewKeywords("NSStackView", ("views",), "stackViewWithViews_")
objc.registerNewKeywords(
    "NSStepperTouchBarItem",
    ("identifier", "drawingHandler"),
    "stepperTouchBarItemWithIdentifier_drawingHandler_",
)
objc.registerNewKeywords(
    "NSStepperTouchBarItem",
    ("identifier", "formatter"),
    "stepperTouchBarItemWithIdentifier_formatter_",
)
objc.registerNewKeywords(
    "NSStoryboard", ("name", "bundle"), "storyboardWithName_bundle_"
)
objc.registerNewKeywords(
    "NSStoryboardSegue",
    ("identifier", "source", "destination", "performHandler"),
    "segueWithIdentifier_source_destination_performHandler_",
)
objc.registerNewKeywords(
    "NSTabViewItem", ("viewController",), "tabViewItemWithViewController_"
)
objc.registerNewKeywords(
...
objc.registerNewKeywords(
    "NSTextField", ("attributedString",), "labelWithAttributedString_"
)
objc.registerNewKeywords("NSTextField", ("string",), "labelWithString_")
objc.registerNewKeywords("NSTextField", ("string",), "textFieldWithString_")
objc.registerNewKeywords("NSTextField", ("string",), "wrappingLabelWithString_")
objc.registerNewKeywords(
    "NSTextListElement",
    ("childElements", "textList", "nestingLevel"),
    "textListElementWithChildElements_textList_nestingLevel_",
)
objc.registerNewKeywords(
    "NSTextListElement",
    ("contents", "markerAttributes", "textList", "childElements"),
    "textListElementWithContents_markerAttributes_textList_childElements_",
)
objc.registerNewKeywords(
    "NSTintConfiguration", ("fixedColor",), "tintConfigurationWithFixedColor_"
)
objc.registerNewKeywords(
    "NSTintConfiguration", ("preferredColor",), "tintConfigurationWithPreferredColor_"
)
objc.registerNewKeywords(
    "NSToolbarItemGroup",
    ("itemIdentifier", "images", "selectionMode", "labels", "target", "action"),
    "groupWithItemIdentifier_images_selectionMode_labels_target_action_",
)
objc.registerNewKeywords(
    "NSToolbarItemGroup",
    ("itemIdentifier", "titles", "selectionMode", "labels", "target", "action"),
    "groupWithItemIdentifier_titles_selectionMode_labels_target_action_",
)
objc.registerNewKeywords(
    "NSTrackingSeparatorToolbarItem",
    ("identifier", "splitView", "dividerIndex"),
    "trackingSeparatorToolbarItemWithIdentifier_splitView_dividerIndex_",
)
objc.registerNewKeywords(
    "NSWindow", ("contentViewController",), "windowWithContentViewController_"
)
protocols = {
...
formal_protocols = {
    ...
    "NSAccessibilityButton": "NSAccessibilityButton",
    "NSAccessibilityCheckBox": "NSAccessibilityCheckBox",
    "NSAccessibilityColor": "NSAccessibilityColor",
    "NSAccessibilityContainsTransientUI": "NSAccessibilityContainsTransientUI",
    "NSAccessibilityCustomRotorItemSearchDelegate": "NSAccessibilityCustomRotorItemSearchDelegate",
    "NSAccessibilityElementLoading": "NSAccessibilityElementLoading",
    "NSAccessibilityElementProtocol": "NSAccessibilityElement",
    "NSAccessibilityGroup": "NSAccessibilityGroup",
    "NSAccessibilityImage": "NSAccessibilityImage",
    "NSAccessibilityLayoutArea": "NSAccessibilityLayoutArea",
    "NSAccessibilityLayoutItem": "NSAccessibilityLayoutItem",
    "NSAccessibilityList": "NSAccessibilityList",
    "NSAccessibilityNavigableStaticText": "NSAccessibilityNavigableStaticText",
    "NSAccessibilityOutline": "NSAccessibilityOutline",
    "NSAccessibilityProgressIndicator": "NSAccessibilityProgressIndicator",
    "NSAccessibilityRadioButton": "NSAccessibilityRadioButton",
    "NSAccessibilityRow": "NSAccessibilityRow",
    "NSAccessibilitySlider": "NSAccessibilitySlider",
    "NSAccessibilityStaticText": "NSAccessibilityStaticText",
    "NSAccessibilityStepper": "NSAccessibilityStepper",
    "NSAccessibilitySwitch": "NSAccessibilitySwitch",
    "NSAccessibilityTable": "NSAccessibilityTable",
    "NSAlertDelegate": "NSAlertDelegate",
    "NSAlignmentFeedbackToken": "NSAlignmentFeedbackToken",
    "NSAnimatablePropertyContainer": "NSAnimatablePropertyContainer",
    "NSAnimationDelegate": "NSAnimationDelegate",
    "NSAppearanceCustomization": "NSAppearanceCustomization",
    "NSApplicationDelegate": "NSApplicationDelegate",
    "NSBrowserDelegate": "NSBrowserDelegate",
    "NSCandidateListTouchBarItemDelegate": "NSCandidateListTouchBarItemDelegate",
    "NSChangeSpelling": "NSChangeSpelling",
    "NSCloudSharingServiceDelegate": "NSCloudSharingServiceDelegate",
    "NSCloudSharingValidation": "NSCloudSharingValidation",
    "NSCollectionLayoutContainerProtocol": "NSCollectionLayoutContainer",
    "NSCollectionLayoutEnvironmentProtocol": "NSCollectionLayoutEnvironment",
    "NSCollectionLayoutVisibleItemProtocol": "NSCollectionLayoutVisibleItem",
    ...
    "NSCollectionViewElement": "NSCollectionViewElement",
    "NSCollectionViewPrefetching": "NSCollectionViewPrefetching",
    "NSCollectionViewSectionHeaderView": "NSCollectionViewSectionHeaderView",
    "NSColorChanging": "NSColorChanging",
    "NSColorPickingCustom": "NSColorPickingCustom",
    "NSColorPickingDefault": "NSColorPickingDefault",
    "NSComboBoxCellDataSource": "NSComboBoxCellDataSource",
    "NSComboBoxDataSource": "NSComboBoxDataSource",
    "NSComboBoxDelegate": "NSComboBoxDelegate",
    "NSControlTextEditingDelegate": "NSControlTextEditingDelegate",
    "NSDatePickerCellDelegate": "NSDatePickerCellDelegate",
    "NSDockTilePlugIn": "NSDockTilePlugIn",
    "NSDraggingDestination": "NSDraggingDestination",
    "NSDraggingInfo": "NSDraggingInfo",
    "NSDraggingSource": "NSDraggingSource",
    "NSDrawerDelegate": "NSDrawerDelegate",
    "NSEditor": "NSEditor",
    "NSEditorRegistration": "NSEditorRegistration",
    "NSFilePromiseProviderDelegate": "NSFilePromiseProviderDelegate",
    "NSFontChanging": "NSFontChanging",
    "NSGestureRecognizerDelegate": "NSGestureRecognizerDelegate",
    "NSGlyphStorage": "NSGlyphStorage",
    "NSHapticFeedbackPerformer": "NSHapticFeedbackPerformer",
    "NSIgnoreMisspelledWords": "NSIgnoreMisspelledWords",
    "NSImageDelegate": "NSImageDelegate",
    "NSInputServerMouseTracker": "NSInputServerMouseTracker",
    "NSInputServiceProvider": "NSInputServiceProvider",
    "NSLayoutManagerDelegate": "NSLayoutManagerDelegate",
    "NSMatrixDelegate": "NSMatrixDelegate",
    "NSMenuDelegate": "NSMenuDelegate",
    "NSMenuItemValidation": "NSMenuItemValidation",
    ...
    "NSPageControllerDelegate": "NSPageControllerDelegate",
    "NSPasteboardItemDataProvider": "NSPasteboardItemDataProvider",
    "NSPasteboardReading": "NSPasteboardReading",
    "NSPasteboardTypeOwner": "NSPasteboardTypeOwner",
    "NSPasteboardWriting": "NSPasteboardWriting",
    "NSPathCellDelegate": "NSPathCellDelegate",
    "NSPathControlDelegate": "NSPathControlDelegate",
    "NSPopoverDelegate": "NSPopoverDelegate",
    "NSPreviewRepresentableActivityItem": "NSPreviewRepresentableActivityItem",
    "NSPrintPanelAccessorizing": "NSPrintPanelAccessorizing",
    "NSRuleEditorDelegate": "NSRuleEditorDelegate",
    ...
    "NSSearchFieldDelegate": "NSSearchFieldDelegate",
    "NSSeguePerforming": "NSSeguePerforming",
    "NSServicesMenuRequestor": "NSServicesMenuRequestor",
    "NSSharingServiceDelegate": "NSSharingServiceDelegate",
    "NSSharingServicePickerDelegate": "NSSharingServicePickerDelegate",
    "NSSharingServicePickerToolbarItemDelegate": "NSSharingServicePickerToolbarItemDelegate",
    "NSSharingServicePickerTouchBarItemDelegate": "NSSharingServicePickerTouchBarItemDelegate",
    "NSSoundDelegate": "NSSoundDelegate",
    "NSSpeechRecognizerDelegate": "NSSpeechRecognizerDelegate",
    "NSSpeechSynthesizerDelegate": "NSSpeechSynthesizerDelegate",
    "NSSplitViewDelegate": "NSSplitViewDelegate",
    "NSSpringLoadingDestination": "NSSpringLoadingDestination",
    "NSStackViewDelegate": "NSStackViewDelegate",
    "NSStandardKeyBindingResponding": "NSStandardKeyBindingResponding",
    "NSStatusItemExpandedInterfaceDelegate": "NSStatusItemExpandedInterfaceDelegate",
    "NSTabViewDelegate": "NSTabViewDelegate",
    "NSTableViewDataSource": "NSTableViewDataSource",
    "NSTableViewDelegate": "NSTableViewDelegate",
    "NSTextAttachmentCellProtocol": "NSTextAttachmentCell",
    "NSTextAttachmentContainer": "NSTextAttachmentContainer",
    "NSTextAttachmentLayout": "NSTextAttachmentLayout",
    "NSTextCheckingClient": "NSTextCheckingClient",
    "NSTextContent": "NSTextContent",
    "NSTextContentManagerDelegate": "NSTextContentManagerDelegate",
    "NSTextContentStorageDelegate": "NSTextContentStorageDelegate",
    "NSTextDelegate": "NSTextDelegate",
    "NSTextElementProvider": "NSTextElementProvider",
    "NSTextFieldDelegate": "NSTextFieldDelegate",
    "NSTextFinderBarContainer": "NSTextFinderBarContainer",
    "NSTextFinderClient": "NSTextFinderClient",
    "NSTextInput": "NSTextInput",
    "NSTextInputClient": "NSTextInputClient",
    "NSTextInputTraits": "NSTextInputTraits",
    "NSTextLayoutManagerDelegate": "NSTextLayoutManagerDelegate",
    "NSTextLayoutOrientationProvider": "NSTextLayoutOrientationProvider",
    "NSTextLocation": "NSTextLocation",
    "NSTextSelectionDataSource": "NSTextSelectionDataSource",
    "NSTextSelectionManagerDelegate": "NSTextSelectionManagerDelegate",
    "NSTextStorageDelegate": "NSTextStorageDelegate",
    "NSTextStorageObserving": "NSTextStorageObserving",
    "NSTextViewDelegate": "NSTextViewDelegate",
    "NSTextViewportLayoutControllerDelegate": "NSTextViewportLayoutControllerDelegate",
    "NSTextViewportRenderingSurface": "NSTextViewportRenderingSurface",
    "NSTextViewportRenderingSurfaceKey": "NSTextViewportRenderingSurfaceKey",
    "NSTokenFieldCellDelegate": "NSTokenFieldCellDelegate",
    "NSTokenFieldDelegate": "NSTokenFieldDelegate",
    "NSToolbarDelegate": "NSToolbarDelegate",
    "NSToolbarItemValidation": "NSToolbarItemValidation",
    "NSTouchBarDelegate": "NSTouchBarDelegate",
    "NSTouchBarProvider": "NSTouchBarProvider",
    "NSUserActivityRestoring": "NSUserActivityRestoring",
    "NSUserInterfaceCompression": "NSUserInterfaceCompression",
    "NSUserInterfaceItemIdentification": "NSUserInterfaceItemIdentification",
    "NSUserInterfaceItemSearching": "NSUserInterfaceItemSearching",
    "NSUserInterfaceValidations": "NSUserInterfaceValidations",
    "NSValidatedUserInterfaceItem": "NSValidatedUserInterfaceItem",
    "NSViewContentSelectionInfo": "NSViewContentSelectionInfo",
    "NSViewControllerPresentationAnimator": "NSViewControllerPresentationAnimator",
    "NSViewLayerContentScaleDelegate": "NSViewLayerContentScaleDelegate",
    "NSViewToolTipOwner": "NSViewToolTipOwner",
    "NSWindowDelegate": "NSWindowDelegate",
    "NSWindowRestoration": "NSWindowRestoration",
    "NSWritingToolsCoordinatorDelegate": "NSWritingToolsCoordinatorDelegate",
}
