...
#
# Last update: Wed Nov 25 11:04:33 2015
...
try:
    ...
    r(b'NSApplication', b'restoreWindowWithIdentifier:state:completionHandler:', {'retval': {'type': b'Z'}, 'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    ...
    r(b'NSBundle', b'loadNibNamed:owner:topLevelObjects:', {'retval': {'type': b'Z'}})
    ...
    r(b'NSEvent', b'addLocalMonitorForEventsMatchingMask:handler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    ...
    r(b'NSObject', b'accessibilitySetOverrideValue:forAttribute:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'accessibilitySetValue:forAttribute:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'action', {'retval': {'type': ':'}})
    r(b'NSObject', b'activeConversationChanged:toNewConversation:', {'retval': {'type': 'v'}, 'arguments': {3: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'activeConversationWillChange:fromOldConversation:', {'retval': {'type': 'v'}, 'arguments': {3: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'alertShowHelp:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'alphaControlAddedOrRemoved:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'animation:didReachProgressMark:', {'retval': {'type': 'v'}, 'arguments': {3: {'type': 'f'}}})
    r(b'NSObject', b'animation:valueForProgress:', {'retval': {'type': 'f'}, 'arguments': {3: {'type': 'f'}}})
    r(b'NSObject', b'animationDidEnd:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'animationDidStop:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'animationShouldStart:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'application:continueUserActivity:restorationHandler:', {'arguments': {7: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSObject', b'application:delegateHandlesKey:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'application:openFile:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'application:openFileWithoutUI:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'application:openFiles:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'application:openTempFile:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'application:printFile:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'application:printFiles:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'application:printFiles:withSettings:showPrintPanels:', {'retval': {'type': 'I'}, 'arguments': {5: {'type': 'Z'}}})
    r(b'NSObject', b'applicationDidBecomeActive:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'applicationDidChangeScreenParameters:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'applicationDidFinishLaunching:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'applicationDidHide:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'applicationDidResignActive:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'applicationDidUnhide:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'applicationDidUpdate:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'applicationOpenUntitledFile:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'applicationShouldHandleReopen:hasVisibleWindows:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': 'Z'}}})
    r(b'NSObject', b'applicationShouldOpenUntitledFile:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'applicationShouldTerminate:', {'retval': {'type': 'I'}})
    r(b'NSObject', b'applicationShouldTerminateAfterLastWindowClosed:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'browser:acceptDrop:atRow:column:dropOperation:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': sel32or64(b'i', b'q')}, 5: {'type': sel32or64(b'i', b'q')}, 6: {'type': 'I'}}})
    r(b'NSObject', b'browser:canDragRowsWithIndexes:inColumn:withEvent:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'browser:createRowsForColumn:inMatrix:', {'retval': {'type': 'v'}, 'arguments': {3: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'browser:draggingImageForRowsWithIndexes:inColumn:withEvent:offset:', {'arguments': {6: {'type': sel32or64(b'N^{_NSPoint=ff}', b'N^{CGPoint=dd}')}}})
    ...
    r(b'NSObject', b'browser:isColumnValid:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'browser:isLeafItem:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'browser:selectCellWithString:inColumn:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'browser:selectRow:inColumn:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': sel32or64(b'i', b'q')}, 4: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'browser:shouldEditItem:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'browser:shouldShowCellExpansionForRow:column:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': sel32or64(b'i', b'q')}, 4: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'browser:shouldSizeColumn:forUserResize:toWidth:', {'retval': {'type': sel32or64(b'f', b'd')}, 'arguments': {3: {'type': sel32or64(b'i', b'q')}, 4: {'type': 'Z'}, 5: {'type': sel32or64(b'f', b'd')}}})
    r(b'NSObject', b'browser:shouldTypeSelectForEvent:withCurrentSearchString:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'browser:validateDrop:proposedRow:column:dropOperation:', {'retval': {'type': sel32or64(b'I', b'Q')}, 'arguments': {4: {'type_modifier': b'N'}, 5: {'type_modifier': b'N'}, 6: {'type_modifier': b'N'}}})
    r(b'NSObject', b'browser:willDisplayCell:atRow:column:', {'arguments': {4: {'type': sel32or64(b'i', b'q')}, 5: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'browser:writeRowsWithIndexes:inColumn:toPasteboard:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'canBeDisabled', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'collectionView:acceptDrop:index:dropOperation:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': sel32or64(b'i', b'q')}, 5: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'collectionView:canDragItemsAtIndexes:withEvent:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'collectionView:draggingSession:willBeginAtPoint:forItemsAtIndexes:', {'arguments': {4: {'type': sel32or64(b'{_NSPoint=ff}', b'{CGPoint=dd}')}}})
    r(b'NSObject', b'collectionView:numerOfItemsInSection:', {'retval': {'type': sel32or64(b'I', b'Q')}})
    r(b'NSObject', b'collectionView:pasteboardWriterForItemAtIndex:', {'arguments': {3: {'type': sel32or64(b'i', b'q')}}})
    ...
    r(b'NSObject', b'collectionView:writeItemsAtIndexes:toPasteboard:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'commitEditingAndReturnError:', {'retval': {'type': b'Z'}})
    r(b'NSObject', b'commitEditingWithDelegate:didCommitSelector:contextInfo:', {'retval': {'type': 'v'}, 'arguments': {3: {'type': ':', 'sel_of_type': b'v@:@Z^v'}, 4: {'type': '^v'}}})
    ...
    r(b'NSObject', b'contentViewAtIndex:effectiveCharacterRange:', {'arguments': {3: {'type': sel32or64(b'o^{_NSRange=II}', b'o^{_NSRange=QQ}')}}})
    r(b'NSObject', b'control:didFailToFormatString:errorDescription:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'control:didFailToValidatePartialString:errorDescription:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'control:isValidObject:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'control:textShouldBeginEditing:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'control:textShouldEndEditing:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'control:textView:doCommandBySelector:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': ':', 'sel_of_type': b'v@:@'}}})
    r(b'NSObject', b'conversationIdentifier', {'retval': {'type': sel32or64(b'i', b'q')}})
    r(b'NSObject', b'currentMode', {'retval': {'type': 'i'}})
    r(b'NSObject', b'datePickerCell:validateProposedDateValue:timeInterval:', {'arguments': {3: {'type': '^@', 'type_modifier': b'N'}, 4: {'type': sel32or64(b'^f', b'^d'), 'type_modifier': b'N'}}})
    r(b'NSObject', b'doCommandBySelector:', {'arguments': {2: {'type': ':', 'sel_of_type': b'v@:@'}}})
    r(b'NSObject', b'doCommandBySelector:client:', {'arguments': {2: {'type': ':', 'sel_of_type': b'v@:@'}}})
    r(b'NSObject', b'draggedImage:beganAt:', {'arguments': {3: {'type': sel32or64(b'{_NSPoint=ff}', b'{CGPoint=dd}')}}})
    r(b'NSObject', b'draggedImage:endedAt:deposited:', {'arguments': {3: {'type': sel32or64(b'{_NSPoint=ff}', b'{CGPoint=dd}')}, 4: {'type': 'Z'}}})
    ...
    r(b'NSObject', b'drawWithFrame:inView:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': sel32or64(b'{_NSRect={_NSPoint=ff}{_NSSize=ff}}', b'{CGRect={CGPoint=dd}{CGSize=dd}}')}}})
    r(b'NSObject', b'drawWithFrame:inView:characterIndex:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': sel32or64(b'{_NSRect={_NSPoint=ff}{_NSSize=ff}}', b'{CGRect={CGPoint=dd}{CGSize=dd}}')}, 4: {'type': sel32or64(b'I', b'Q')}}})
    r(b'NSObject', b'drawWithFrame:inView:characterIndex:layoutManager:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': sel32or64(b'{_NSRect={_NSPoint=ff}{_NSSize=ff}}', b'{CGRect={CGPoint=dd}{CGSize=dd}}')}, 4: {'type': sel32or64(b'I', b'Q')}}})
    r(b'NSObject', b'drawerShouldClose:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'drawerShouldOpen:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'drawsVerticallyForCharacterAtIndex:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'enumerateDraggingItemsWithOptions:forView:classes:searchOptions:usingBlock:', {'arguments': {6: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'i', b'q')}, 3: {'type': b'o^Z'}}}}}})
    ...
    r(b'NSObject', b'fontManager:willIncludeFont:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'hasMarkedText', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'highlight:withFrame:inView:', {'arguments': {2: {'type': 'Z'}, 3: {'type': sel32or64(b'{_NSRect={_NSPoint=ff}{_NSSize=ff}}', b'{CGRect={CGPoint=dd}{CGSize=dd}}')}}})
    ...
    r(b'NSObject', b'insertGlyphs:length:forStartingGlyphAtIndex:characterIndex:', {'arguments': {2: {'type': '^I', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 3: {'type': sel32or64(b'I', b'Q')}, 4: {'type': sel32or64(b'I', b'Q')}, 5: {'type': sel32or64(b'I', b'Q')}}})
    r(b'NSObject', b'insertNewButtonImage:in:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': '@'}, 3: {'type': '@'}}})
    r(b'NSObject', b'insertText:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': '@'}}})
    r(b'NSObject', b'insertText:client:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': '@'}, 3: {'type': '@'}}})
    r(b'NSObject', b'insertText:replacementRange:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': '@'}, 3: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSObject', b'ioCommandBySelector:', {'arguments': {2: {'type': ':', 'sel_of_type': b'v@:@'}}})
    r(b'NSObject', b'isContentDiscarded', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'isEditable', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'isExplicitlyIncluded', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'isFindBarVisible', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'isSelectable', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'layer:shouldInheritContentsScale:fromWindow:', {'retval': {'type': b'Z'}})
    r(b'NSObject', b'layoutManager:didCompleteLayoutForTextContainer:atEnd:', {'arguments': {4: {'type': 'Z'}}})
    r(b'NSObject', b'layoutManager:shouldGenerateGlyphs:properties:characterIndexes:forGlyphRange:', {'arguments': {3: {'type': 'n^S'}, 4: {'type': sel32or64(b'n^I', b'n^Q')}, 5: {'type': sel32or64(b'n^I', b'n^Q')}, 6: {'type': sel32or64(b'^{_NSRange=II}', b'^{_NSRange=QQ}')}}})
    r(b'NSObject', b'layoutManager:shouldUseTemporaryAttributes:forDrawingToScreen:atCharacterIndex:effectiveRange:', {'arguments': {4: {'type': 'Z'}, 5: {'type': sel32or64(b'I', b'Q')}, 6: {'type': sel32or64(b'^{_NSRange=II}', b'^{_NSRange=QQ}'), 'type_modifier': b'o'}}})
    ...
    r(b'NSObject', b'menu:updateItem:atIndex:shouldCancel:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': sel32or64(b'i', b'q')}, 5: {'type': 'Z'}}})
    r(b'NSObject', b'menuHasKeyEquivalent:forEvent:target:action:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': '^@', 'type_modifier': b'o'}, 5: {'type': '^:', 'type_modifier': b'o'}}})
    r(b'NSObject', b'minContentSize', {'retval': {'type': sel32or64(b'{_NSSize=ff}', b'{CGSize=dd}')}})
    r(b'NSObject', b'mouseDownOnCharacterIndex:atCoordinate:withModifier:client:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': sel32or64(b'{_NSPoint=ff}', b'{CGPoint=dd}')}, 4: {'type': sel32or64(b'I', b'Q')}}})
    r(b'NSObject', b'mouseDraggedOnCharacterIndex:atCoordinate:withModifier:client:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': sel32or64(b'{_NSPoint=ff}', b'{CGPoint=dd}')}, 4: {'type': sel32or64(b'I', b'Q')}}})
    ...
    r(b'NSObject', b'outlineView:acceptDrop:item:childIndex:', {'retval': {'type': 'Z'}, 'arguments': {5: {'type': sel32or64(b'i', b'q')}}})
    ...
    r(b'NSObject', b'outlineView:isGroupItem:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'outlineView:isItemExpandable:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'outlineView:numberOfChildrenOfItem:', {'retval': {'type': sel32or64(b'i', b'q')}})
    r(b'NSObject', b'outlineView:shouldCollapseItem:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'outlineView:shouldEditTableColumn:item:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'outlineView:shouldExpandItem:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'outlineView:shouldReorderColumn:toColumn:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': sel32or64(b'i', b'q')}, 4: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'outlineView:shouldSelectItem:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'outlineView:shouldSelectTableColumn:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'outlineView:shouldShowCellExpansionForTableColumn:item:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'outlineView:shouldShowOutlineCellForItem:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'outlineView:shouldTrackCell:forTableColumn:item:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'outlineView:shouldTypeSelectForEvent:withCurrentSearchString:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'outlineView:sizeToFitWidthOfColumn:', {'retval': {'type': sel32or64(b'f', b'd')}, 'arguments': {3: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'outlineView:sortDescriptorsDidChange:', {'retval': {'type': 'v'}})
    ...
    r(b'NSObject', b'outlineView:writeItems:toPasteboard:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'panel:compareFilename:with:caseSensitive:', {'retval': {'type': sel32or64(b'i', b'q')}, 'arguments': {5: {'type': 'Z'}}})
    r(b'NSObject', b'panel:isValidFilename:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'panel:shouldEnableURL:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'panel:shouldShowFilename:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'panel:userEnteredFilename:confirmed:', {'arguments': {4: {'type': 'Z'}}})
    r(b'NSObject', b'panel:validateURL:error:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': '^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'panel:willExpand:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSObject', b'pathControl:acceptDrop:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'pathControl:shouldDragPathComponentCell:withPasteboard:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'pathControl:validateDrop:', {'retval': {'type': sel32or64(b'I', b'Q')}})
    r(b'NSObject', b'pathControl:willDisplayOpenPanel:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'pathControl:willPopUpMenu:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'performDragOperation:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'prepareForDragOperation:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'provideNewView:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSObject', b'readSelectionFromPasteboard:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'restoreWindowWithIdentifier:state:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    ...
    r(b'NSObject', b'searchForItemsWithSearchString:resultLimit:matchedItemHandler:', {'arguments': {3: {'type': sel32or64(b'i', b'q')}, 4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}, 'type': '@?'}}})
    r(b'NSObject', b'selectedRange', {'retval': {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}})
    r(b'NSObject', b'selectionShouldChangeInOutlineView:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'selectionShouldChangeInTableView:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'setFindBarVisible:', {'arguments': {2: {'type': 'Z'}}})
    ...
    r(b'NSObject', b'setMode:', {'arguments': {2: {'type': 'i'}}})
    r(b'NSObject', b'showRelativeToRect:ofView:preferredEdge:', {'arguments': {2: {'type': sel32or64(b'{_NSRect={_NSPoint=ff}{_NSSize=ff}}', b'{CGRect={CGPoint=dd}{CGSize=dd}}')}}})
    r(b'NSObject', b'slideDraggedImageTo:', {'arguments': {2: {'type': sel32or64(b'{_NSPoint=ff}', b'{CGPoint=dd}')}}})
    r(b'NSObject', b'sound:didFinishPlaying:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSObject', b'speechSynthesizer:didEncounterErrorAtIndex:ofString:message:', {'arguments': {3: {'type': sel32or64(b'I', b'Q')}}})
    r(b'NSObject', b'speechSynthesizer:didFinishSpeaking:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSObject', b'speechSynthesizer:willSpeakPhoneme:', {'arguments': {3: {'type': 's'}}})
    ...
    r(b'NSObject', b'splitView:canCollapseSubview:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'splitView:shouldAdjustSizeOfSubview:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'splitView:shouldCollapseSubview:forDoubleClickOnDividerAtIndex:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'splitView:shouldHideDividerAtIndex:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': sel32or64(b'i', b'q')}}})
    ...
    r(b'NSObject', b'supportsMode:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': 'i'}}})
    r(b'NSObject', b'tabView:didSelectTabViewItem:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'tabView:shouldSelectTabViewItem:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'tableView:acceptDrop:row:dropOperation:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': sel32or64(b'i', b'q')}, 5: {'type': sel32or64(b'I', b'Q')}}})
    r(b'NSObject', b'tableView:dataCellForTableColumn:row:', {'retval': {'type': '@'}, 'arguments': {4: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'tableView:heightOfRow:', {'retval': {'type': sel32or64(b'f', b'd')}, 'arguments': {3: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'tableView:isGroupRow:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': sel32or64(b'i', b'q')}}})
    ...
    r(b'NSObject', b'tableView:pasteboardWriterForRow:', {'arguments': {3: {'type': sel32or64(b'i', b'q')}}})
    ...
    r(b'NSObject', b'tableView:shouldEditTableColumn:row:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'tableView:shouldReorderColumn:toColumn:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': sel32or64(b'i', b'q')}, 4: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'tableView:shouldSelectRow:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'tableView:shouldSelectTableColumn:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'tableView:shouldShowCellExpansionForTableColumn:row:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'tableView:shouldTrackCell:forTableColumn:row:', {'retval': {'type': 'Z'}, 'arguments': {5: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'tableView:shouldTypeSelectForEvent:withCurrentSearchString:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'tableView:willDisplayCell:forTableColumn:row:', {'retval': {'type': 'v'}, 'arguments': {5: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'tableView:writeRows:toPasteboard:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'tableView:writeRowsWithIndexes:toPasteboard:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'tag', {'retval': {'type': sel32or64(b'i', b'q')}})
    r(b'NSObject', b'textShouldBeginEditing:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'textShouldEndEditing:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'textView:clickedOnLink:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'textView:clickedOnLink:atIndex:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': sel32or64(b'I', b'Q')}}})
    ...
    r(b'NSObject', b'textView:doCommandBySelector:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': ':', 'sel_of_type': b'v@:@'}}})
    ...
    r(b'NSObject', b'textView:shouldChangeTextInRange:replacementString:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSObject', b'textView:shouldChangeTextInRanges:replacementStrings:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'textView:writeCell:atIndex:toPasteboard:type:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': sel32or64(b'I', b'Q')}}})
    ...
    r(b'NSObject', b'tokenField:hasMenuForRepresentedObject:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'tokenField:writeRepresentedObjects:toPasteboard:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'tokenFieldCell:hasMenuForRepresentedObject:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'tokenFieldCell:writeRepresentedObjects:toPasteboard:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'toolbar:itemForItemIdentifier:willBeInsertedIntoToolbar:', {'arguments': {4: {'type': 'Z'}}})
    r(b'NSObject', b'trackMouse:inRect:ofView:atCharacterIndex:untilMouseUp:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': sel32or64(b'{_NSRect={_NSPoint=ff}{_NSSize=ff}}', b'{CGRect={CGPoint=dd}{CGSize=dd}}')}, 5: {'type': sel32or64(b'I', b'Q')}, 6: {'type': 'Z'}}})
    r(b'NSObject', b'trackMouse:inRect:ofView:untilMouseUp:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': sel32or64(b'{_NSRect={_NSPoint=ff}{_NSSize=ff}}', b'{CGRect={CGPoint=dd}{CGSize=dd}}')}, 5: {'type': 'Z'}}})
    r(b'NSObject', b'validModesForFontPanel:', {'retval': {'type': sel32or64(b'I', b'Q')}})
    r(b'NSObject', b'validateMenuItem:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'validateToolbarItem:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'validateUserInterfaceItem:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'valueClassForBinding:', {'retval': {'type': '#'}})
    r(b'NSObject', b'view:stringForToolTip:point:userData:', {'arguments': {3: {'type': 'i'}, 4: {'type': sel32or64(b'{_NSPoint=ff}', b'{CGPoint=dd}')}, 5: {'type': '^v'}}})
    r(b'NSObject', b'wantsPeriodicDraggingUpdates', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'wantsToDelayTextChangeNotifications', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'wantsToHandleMouseEvents', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'wantsToInterpretAllKeystrokes', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'wantsToTrackMouse', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'wantsToTrackMouseForEvent:inRect:ofView:atCharacterIndex:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': sel32or64(b'{_NSRect={_NSPoint=ff}{_NSSize=ff}}', b'{CGRect={CGPoint=dd}{CGSize=dd}}')}, 5: {'type': sel32or64(b'I', b'Q')}}})
    r(b'NSObject', b'window:shouldDragDocumentWithEvent:from:withPasteboard:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type': sel32or64(b'{_NSPoint=ff}', b'{CGPoint=dd}')}}})
    r(b'NSObject', b'window:shouldPopUpDocumentPathMenu:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'windowShouldClose:', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'windowShouldZoom:toFrame:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': sel32or64(b'{_NSRect={_NSPoint=ff}{_NSSize=ff}}', b'{CGRect={CGPoint=dd}{CGSize=dd}}')}}})
    ...
    r(b'NSObject', b'writeSelectionToPasteboard:types:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSOpenGLContext', b'setOffScreen:width:height:rowbytes:', {'arguments': {2: {'c_array_of_variable_length': True}}})
    r(b'NSOpenGLContext', b'setValues:forParameter:', {'arguments': {2: {'type_modifier': b'n'}}})
    ...
    r(b'NSOpenGLLayer', b'drawInOpenGLContext:pixelFormat:forLayerTime:displayTime:', {'arguments': {5: {'type': sel32or64(b'^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssLLLssss}QQ}', b'^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssIIIssss}QQ}')}}})
    ...
    r(b'NSSavePanel', b'beginSheetForDirectory:file:types:modalForWindow:modalDelegate:didEndSelector:contextInfo:', {'arguments': {8: {'type': '^v'}, 7: {'sel_of_type': sel32or64(b'v@:@i^v', b'v@:@q^v')}}})
...
try:
    ...
    r(b'NSObject', b'accessibilityAttributedStringForRange:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    ...
    r(b'NSObject', b'accessibilityColumnHeaderUIElements', {'required': True, 'retval': {'type': b'@'}})
    ...
    r(b'NSObject', b'accessibilityColumns', {'required': False, 'retval': {'type': b'@'}})
    ...
    r(b'NSObject', b'accessibilityDisclosureLevel', {'required': False, 'retval': {'type': sel32or64(b'i', b'q')}})
    ...
    r(b'NSObject', b'accessibilityPerformDecrement', {'required': True, 'retval': {'type': b'Z'}})
    r(b'NSObject', b'accessibilityPerformDecrement', {'required': True, 'retval': {'type': b'Z'}})
    r(b'NSObject', b'accessibilityPerformDecrement', {'required': True, 'retval': {'type': b'Z'}})
    ...
    r(b'NSObject', b'accessibilityPerformIncrement', {'required': False, 'retval': {'type': b'Z'}})
    r(b'NSObject', b'accessibilityPerformIncrement', {'required': True, 'retval': {'type': b'Z'}})
    r(b'NSObject', b'accessibilityPerformIncrement', {'required': True, 'retval': {'type': b'Z'}})
    ...
    r(b'NSObject', b'accessibilityRowHeaderUIElements', {'required': True, 'retval': {'type': b'@'}})
    ...
    r(b'NSObject', b'accessibilitySelectedCells', {'required': False, 'retval': {'type': b'@'}})
    ...
    r(b'NSObject', b'accessibilitySelectedColumns', {'required': False, 'retval': {'type': b'@'}})
    r(b'NSObject', b'accessibilitySelectedRows', {'required': False, 'retval': {'type': b'@'}})
    r(b'NSObject', b'accessibilitySelectedRows', {'required': True, 'retval': {'type': b'@'}})
    ...
    r(b'NSObject', b'accessibilityValue', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'accessibilityValue', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'accessibilityValue', {'required': False, 'retval': {'type': b'@'}})
    r(b'NSObject', b'accessibilityValue', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'accessibilityValue', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'accessibilityValue', {'required': True, 'retval': {'type': b'@'}})
    ...
    r(b'NSObject', b'accessibilityVisibleCells', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'accessibilityVisibleCharacterRange', {'required': False, 'retval': {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}})
    r(b'NSObject', b'accessibilityVisibleCharacterRange', {'required': True, 'retval': {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}})
    r(b'NSObject', b'accessibilityVisibleChildren', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'accessibilityVisibleColumns', {'required': True, 'retval': {'type': b'@'}})
    ...
    r(b'NSObject', b'accessibilityVisibleRows', {'required': True, 'retval': {'type': b'@'}})
    ...
    r(b'NSObject', b'application:continueUserActivity:restorationHandler:', {'required': False, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@?'}, 7: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    ...
    r(b'NSObject', b'control:textView:doCommandBySelector:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'sel_of_type': b'v@:@', 'type': ':'}}})
    ...
    r(b'NSObject', b'doCommandBySelector:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'sel_of_type': b'v@:@', 'type': ':'}}})
    r(b'NSObject', b'doCommandBySelector:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'sel_of_type': b'v@:@', 'type': ':'}}})
    r(b'NSObject', b'doCommandBySelector:client:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'sel_of_type': b'v@:@', 'type': ':'}, 3: {'type': b'@'}}})
    ...
    r(b'NSObject', b'isAccessibilityFocused', {'required': True, 'retval': {'type': b'Z'}})
    ...
    r(b'NSObject', b'restoreWindowWithIdentifier:state:completionHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@?'}}})
    ...
    r(b'NSObject', b'setAccessibilityFrame:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': sel32or64(b'{_NSRect={_NSPoint=ff}{_NSSize=ff}}', b'{CGRect={CGPoint=dd}{CGSize=dd}}')}}})
    ...
    r(b'NSObject', b'setAccessibilitySelectedRows:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'textView:doCommandBySelector:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'sel_of_type': b'v@:@', 'type': ':'}}})
...
try:
    ...
    r(b'NSObject', b'accessibilityFocusedUIElement', {'retval': {'type': b'@'}})
    ...
    r(b'NSObject', b'commitEditingWithDelegate:didCommitSelector:contextInfo:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'sel_of_type': b'v@:@Z^v', 'type': ':'}, 4: {'type': '^v'}}})
    r(b'NSObject', b'concludeDragOperation:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'draggedImage:movedTo:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': sel32or64(b'{_NSPoint=ff}', b'{CGPoint=dd}')}}})
    r(b'NSObject', b'draggingEnded:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'draggingEntered:', {'retval': {'type': sel32or64(b'I', b'Q')}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'draggingExited:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'draggingSourceOperationMaskForLocal:', {'retval': {'type': sel32or64(b'I', b'Q')}, 'arguments': {2: {'type': 'Z'}}})
    r(b'NSObject', b'draggingSourceOperationMaskForLocal:', {'retval': {'type': sel32or64(b'I', b'Q')}, 'arguments': {2: {'type': 'Z'}}})
    r(b'NSObject', b'draggingUpdated:', {'retval': {'type': sel32or64(b'I', b'Q')}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'namesOfPromisedFilesDroppedAtDestination:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'namesOfPromisedFilesDroppedAtDestination:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'outlineViewColumnDidMove:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'outlineViewColumnDidResize:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'outlineViewItemDidCollapse:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'outlineViewItemDidExpand:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'outlineViewItemWillCollapse:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'outlineViewItemWillExpand:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'outlineViewSelectionDidChange:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'outlineViewSelectionIsChanging:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'performDragOperation:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'prepareForDragOperation:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'prepareForInterfaceBuilder', {'retval': {'type': b'v'}})
    r(b'NSObject', b'readSelectionFromPasteboard:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
