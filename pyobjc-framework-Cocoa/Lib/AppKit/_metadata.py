...
#
# Last update: Wed Sep 16 21:59:44 2015
...
try:
    ...
    r(b'NSObject', b'restoreWindowWithIdentifier:state:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}, 'type': '@?'}}})
    ...
    r(b'NSOpenGLContext', b'setValues:forParameter:', {'arguments': {2: {'c_array_delimited_by_null': True}}})
    r(b'NSOpenGLLayer', b'canDrawInOpenGLContext:pixelFormat:forLayerTime:displayTime:', {'retval': {'type': 'Z'}, 'arguments': {5: {'type': sel32or64(b'^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssLLLssss}QQ}', b'^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssIIIssss}QQ}')}}})
