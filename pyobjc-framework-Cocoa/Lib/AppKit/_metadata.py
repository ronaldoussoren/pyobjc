...
#
# Last update: Tue Oct  2 22:04:22 2012
...
misc.update({'NSModalSession': objc.createOpaquePointerType('AppKit.NSModalSession', b'^{_NSModalSession}')})
...
try:
    ...
    r(b'NSObject', b'tableView:pastboardWriterForRow:', {'arguments': {3: {'type': sel32or64(b'i', b'q')}}})
...
try:
    ...
    r(b'NSObject', b'setFindBarVisible:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': 'Z'}}})
