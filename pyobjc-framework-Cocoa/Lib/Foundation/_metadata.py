...
#
# Last update: Fri Aug 12 16:53:06 2022
#
# flake8: noqa
...
misc.update(
    {
        ...
        "NSRect": objc.createStructType(
            "Foundation.NSRect", b"{CGRect={CGPoint=dd}{CGSize=dd}}", ["origin", "size"]
        ),
        ...
        "NSSize": objc.createStructType(
            "Foundation.NSSize", b"{CGSize=dd}", ["width", "height"]
        ),
        "NSPoint": objc.createStructType(
            "Foundation.NSPoint", b"{CGPoint=dd}", ["x", "y"]
        ),
        "NSSwappedDouble": objc.createStructType(
            "Foundation.NSSwappedDouble", b"{_NSSwappedDouble=Q}", ["v"]
        ),
        "NSMapEnumerator": objc.createStructType(
            "Foundation.NSMapEnumerator",
            b"{_NSMapEnumerator=QQ^v}",
            ["_pi", "_si", "_bs"],
        ),
        "NSSwappedFloat": objc.createStructType(
            "Foundation.NSSwappedFloat", b"{_NSSwappedFloat=I}", ["v"]
        ),
...
try:
    ...
    r(
        ...
        {"arguments": {5: {"type_modifier": b"o"}}, "variadic": True},
    )
    r(
        b"NSString",
    ...
    r(
        ...
        {"arguments": {2: {"printf_format": True}, 4: {"type": "o"}}},
    )
    r(
        b"NSString",
    ...
    r(
        ...
        {"arguments": {2: {"printf_format": True}, 5: {"type": "o"}}},
    )
