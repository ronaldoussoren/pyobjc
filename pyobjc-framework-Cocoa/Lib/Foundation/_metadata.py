...
#
# Last update: Mon May 14 11:15:32 2012
...
misc.update({'NSHashEnumerator': objc.createStructType('NSHashEnumerator', sel32or64('{_NSHashEnumerator=II^v}', '{_NSHashEnumerator=QQ^v}'), [u'_pi', u'_si', u'_bs']), 'NSAffineTransformStruct': objc.createStructType('NSAffineTransformStruct', sel32or64('{_NSAffineTransformStruct=ffffff}', '{_NSAffineTransformStruct=dddddd}'), [u'm11', u'm12', u'm21', u'm22', u'tX', u'tY']), 'NSRect': objc.createStructType('NSRect', sel32or64('{_NSRect={_NSPoint=ff}{_NSSize=ff}}', '{CGRect={CGPoint=dd}{CGSize=dd}}'), [u'origin', u'size']), 'NSRange': objc.createStructType('NSRange', sel32or64('{_NSRange=II}', '{_NSRange=QQ}'), [u'location', u'length']), 'NSZone': objc.createStructType('NSZone', '{_NSZone=}', []), 'NSDecimal': objc.createStructType('NSDecimal', '{_NSDecimal=iIIII[8S]}', [u'_exponent', u'_length', u'_isNegative', u'_isCompact', u'_reserved', u'_mantissa']), 'NSSize': objc.createStructType('NSSize', sel32or64('{_NSSize=ff}', '{CGSize=dd}'), [u'width', u'height']), 'NSPoint': objc.createStructType('NSPoint', sel32or64('{_NSPoint=ff}', '{CGPoint=dd}'), [u'x', u'y']), 'NSSwappedDouble': objc.createStructType('NSSwappedDouble', '{_NSSwappedDouble=Q}', [u'v']), 'NSMapEnumerator': objc.createStructType('NSMapEnumerator', sel32or64('{_NSMapEnumerator=II^v}', '{_NSMapEnumerator=QQ^v}'), [u'_pi', u'_si', u'_bs']), 'NSSwappedFloat': objc.createStructType('NSSwappedFloat', '{_NSSwappedFloat=I}', [u'v'])})
...
try:
    ...
    r('NSData', b'dataWithBytesNoCopy:length:freeWhenDone:', {'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 4: {'type': 'Z'}}})
    ...
    r('NSData', b'initWithBytesNoCopy:length:freeWhenDone:', {'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 4: {'type': 'Z'}}})
    ...
    r('NSObject', b'exceptionDuringOperation:error:leftOperand:rightOperand:', {'retval': {'type': '@'}, 'arguments': {2: {'type': ':'}, 3: {'type': sel32or64(u'I', u'Q')}}})
...
try:
    ...
    r('NSObject', b'class', {'required': True, 'retval': {'type': b'#'}})
    ...
    r('NSObject', b'exceptionDuringOperation:error:leftOperand:rightOperand:', {'required': True, 'retval': {'type': '@'}, 'arguments': {2: {'type': ':'}, 3: {'type': sel32or64(u'I', u'Q')}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
