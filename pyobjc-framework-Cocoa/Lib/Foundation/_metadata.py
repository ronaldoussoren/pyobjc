...
misc.update({'NSAppleEventManagerSuspensionID': objc.createOpaquePointerType('Foundation.NSAppleEventManagerSuspensionID', b'^{__NSAppleEventManagerSuspension=}'), 'NSZonePtr': objc.createOpaquePointerType('Foundation.NSZonePtr', b'^{_NSZone=}')})
...
try:
    ...
    r(b'NSObject', b'roundingMode', {'retval': {'type': 'I'}})
...
try:
    ...
    r(b'NSObject', b'presentedItemOperationQueue', {'retval': {'type': b'@'}})
    r(b'NSObject', b'presentedItemURL', {'retval': {'type': b'@'}})
    ...
    r(b'NSObject', b'primaryPresentedItemURL', {'retval': {'type': b'@'}})
    ...
    r(b'NSObject', b'roundingMode', {'required': True, 'retval': {'type': 'I'}})
