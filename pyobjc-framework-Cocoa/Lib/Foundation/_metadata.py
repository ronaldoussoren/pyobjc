...
try:
    ...
    r('NSDecimalNumber', b'decimalValue', {'retval': {'type': b'{_NSDecimal=b8b4b1b1b18[8S]}'}})
    ...
    r('NSScanner', b'scanDecimal:', {'retval': {'type': 'Z'}, 'arguments': {2: {'null_accepted': False, 'type': b'^{_NSDecimal=b8b4b1b1b18[8S]}'}}})
