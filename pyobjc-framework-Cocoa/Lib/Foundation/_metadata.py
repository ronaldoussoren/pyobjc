...
#
# Last update: Mon Oct  1 16:54:11 2012
...
try:
    ...
    r(b'NSFileManager', b'trashItemAtURL:resultingItemURL:error:', {'retval': {'type': b'Z'}})
...
try:
    ...
    r(b'NSObject', b'remoteObjectProxyWithErrorHandler:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@?'}}})
