...
misc.update(
    {
        ...
        "NSStringEncoding": NewType("NSStringEncoding", int),
...
aliases = {
    ...
    "NS_SWIFT_UI_ACTOR": "NS_SWIFT_MAIN_ACTOR",
...
try:
    ...
    r(
        ...
        b"decodeValuesOfObjCTypes:",
        {
            ...
            "suggestion": "Use the basic encoding methods instead.",
            "variadic": True,
        },
    )
    r(
    ...
    r(
        ...
        b"dataWithBytesNoCopy:length:",
        {
            ...
            "suggestion": "Use the 'dataWithBytesNoCopy:length:freeWhenDone:' method instead.",
        },
    )
    r(
        b"NSData",
        ...
        {
            "doc": "The program will crash when the buffer passed in is garbage collected before Objective-C is done with it.",
            "arguments": {
                2: {"type": "^v", "type_modifier": b"n", "c_array_length_in_arg": 3},
                4: {
                    "doc": "Value must be false, the C API will call free(3 on the buffer otherwise.",
                    "type": "Z",
                },
            },
        },
    ...
    r(
        ...
        {
            "arguments": {2: {"type": "^v"}},
            "suggestion": "Use the *bytes* method instead.",
        },
    )
    r(
        b"NSData",
    ...
    r(
        ...
        {"suggestion": "use +raise:format: instead"},
    )
    r(
        b"NSExpression",
        b"expressionBlock",
    ...
    r(
        ...
        {
            "retval": {"type": b"Z"},
            "arguments": {3: {"type": b"^Z", "type_modifier": b"o"}},
        },
    )
    r(
        b"NSFileManager",
    ...
    r(
        b"NSObject",
        b"visitExpressionKeyPath:scope:key:error:",
        {
            "required": False,
            "retval": {"type": b"Z"},
            "arguments": {
    ...
    r(
        b"NSObject",
        b"visitOperatorType:error:",
        {
            "required": False,
            "retval": {"type": b"Z"},
            "arguments": {2: {"type": b"Q"}, 3: {"type": b"^@", "type_modifier": b"o"}},
        },
    )
    r(
        b"NSObject",
        b"visitPredicate:error:",
        {
            "required": False,
            "retval": {"type": b"Z"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"^@", "type_modifier": b"o"}},
    ...
    r(
        b"NSPredicate",
        b"allowEvaluationWithValidator:error:",
        {"retval": {"type": b"Z"}, "arguments": {3: {"type_modifier": b"o"}}},
    )
...
objc.registerNewKeywordsFromSelector("NSAffineTransform", b"init")
...
objc.registerNewKeywordsFromSelector("NSArray", b"init")
...
objc.registerNewKeywordsFromSelector(
    "NSAttributedStringMarkdownParsingOptions", b"init"
)
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSBundleResourceRequest", b"init")
...
objc.registerNewKeywordsFromSelector("NSCalendar", b"init")
...
objc.registerNewKeywordsFromSelector("NSDate", b"init")
...
objc.registerNewKeywordsFromSelector("NSDateInterval", b"init")
...
objc.registerNewKeywordsFromSelector("NSDictionary", b"init")
...
objc.registerNewKeywordsFromSelector("NSDistributedLock", b"init")
objc.registerNewKeywordsFromSelector("NSDistributedLock", b"initWithPath:")
objc.registerNewKeywordsFromSelector("NSError", b"init")
...
objc.registerNewKeywordsFromSelector("NSISO8601DateFormatter", b"init")
...
objc.registerNewKeywordsFromSelector("NSInflectionRule", b"init")
...
objc.registerNewKeywordsFromSelector("NSItemProvider", b"init")
...
objc.registerNewKeywordsFromSelector("NSKeyValueSharedObservers", b"init")
objc.registerNewKeywordsFromSelector(
    "NSKeyValueSharedObservers", b"initWithObservableClass:"
)
objc.registerNewKeywordsFromSelector("NSKeyValueSharedObserversSnapshot", b"init")
objc.registerNewKeywordsFromSelector("NSKeyedArchiver", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSKeyedUnarchiver", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSLocale", b"init")
...
objc.registerNewKeywordsFromSelector("NSLocalizedNumberFormatRule", b"init")
...
objc.registerNewKeywordsFromSelector("NSMeasurement", b"init")
...
objc.registerNewKeywordsFromSelector("NSMorphologyPronoun", b"init")
objc.registerNewKeywordsFromSelector(
    "NSMorphologyPronoun", b"initWithPronoun:morphology:dependentMorphology:"
)
objc.registerNewKeywordsFromSelector("NSMutableArray", b"init")
...
objc.registerNewKeywordsFromSelector("NSMutableDictionary", b"init")
...
objc.registerNewKeywordsFromSelector("NSMutableOrderedSet", b"init")
...
objc.registerNewKeywordsFromSelector("NSMutableSet", b"init")
...
objc.registerNewKeywordsFromSelector("NSNetServiceBrowser", b"init")
objc.registerNewKeywordsFromSelector("NSNotification", b"init")
...
objc.registerNewKeywordsFromSelector("NSOrderedCollectionChange", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSOrderedSet", b"init")
...
objc.registerNewKeywordsFromSelector("NSPresentationIntent", b"init")
...
objc.registerNewKeywordsFromSelector("NSScriptCommandDescription", b"init")
...
objc.registerNewKeywordsFromSelector("NSScriptWhoseTest", b"init")
objc.registerNewKeywordsFromSelector("NSScriptWhoseTest", b"initWithCoder:")
objc.registerNewKeywordsFromSelector("NSSet", b"init")
...
objc.registerNewKeywordsFromSelector("NSSocketPort", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSSpecifierTest", b"init")
...
objc.registerNewKeywordsFromSelector("NSString", b"init")
...
objc.registerNewKeywordsFromSelector("NSTask", b"init")
objc.registerNewKeywordsFromSelector("NSTermOfAddress", b"init")
objc.registerNewKeywordsFromSelector("NSThread", b"init")
...
objc.registerNewKeywordsFromSelector("NSURLComponents", b"init")
...
objc.registerNewKeywordsFromSelector("NSURLSession", b"init")
objc.registerNewKeywordsFromSelector("NSURLSessionConfiguration", b"init")
objc.registerNewKeywordsFromSelector("NSURLSessionDataTask", b"init")
objc.registerNewKeywordsFromSelector("NSURLSessionDownloadTask", b"init")
objc.registerNewKeywordsFromSelector("NSURLSessionStreamTask", b"init")
objc.registerNewKeywordsFromSelector("NSURLSessionTask", b"init")
objc.registerNewKeywordsFromSelector("NSURLSessionTaskMetrics", b"init")
objc.registerNewKeywordsFromSelector("NSURLSessionTaskTransactionMetrics", b"init")
objc.registerNewKeywordsFromSelector("NSURLSessionUploadTask", b"init")
objc.registerNewKeywordsFromSelector("NSURLSessionWebSocketMessage", b"init")
...
objc.registerNewKeywordsFromSelector("NSURLSessionWebSocketTask", b"init")
objc.registerNewKeywordsFromSelector("NSUUID", b"init")
...
objc.registerNewKeywordsFromSelector("NSUnit", b"init")
...
objc.registerNewKeywordsFromSelector("NSUserActivity", b"init")
objc.registerNewKeywordsFromSelector("NSUserActivity", b"initWithActivityType:")
objc.registerNewKeywordsFromSelector("NSUserDefaults", b"init")
...
objc.registerNewKeywordsFromSelector("NSUserNotification", b"init")
...
objc.registerNewKeywordsFromSelector("NSXMLDTD", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSXMLDTDNode", b"init")
...
objc.registerNewKeywordsFromSelector("NSXMLDocument", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("NSXMLNode", b"init")
...
objc.registerNewKeywords("NSArray", ("object",), "arrayWithObject_")
objc.registerNewKeywords(
    "NSAttributedString", ("format",), "localizedAttributedStringWithFormat_"
)
objc.registerNewKeywords(
    "NSAttributedString",
    ("format", "context"),
...
objc.registerNewKeywords("NSBlockOperation", ("block",), "blockOperationWithBlock_")
objc.registerNewKeywords(
    "NSConnection", ("registeredName", "host"), "connectionWithRegisteredName_host_"
)
objc.registerNewKeywords(
    "NSConnection",
    ("registeredName", "host", "usingNameServer"),
    "connectionWithRegisteredName_host_usingNameServer_",
)
objc.registerNewKeywords(
    "NSConnection", ("name", "rootObject"), "serviceConnectionWithName_rootObject_"
)
objc.registerNewKeywords(
    "NSConnection",
    ("name", "rootObject", "usingNameServer"),
    "serviceConnectionWithName_rootObject_usingNameServer_",
)
objc.registerNewKeywords(
    "NSDictionary", ("object", "forKey"), "dictionaryWithObject_forKey_"
)
objc.registerNewKeywords(
    "NSFileAccessIntent", ("URL", "options"), "readingIntentWithURL_options_"
)
objc.registerNewKeywords(
    "NSFileAccessIntent", ("URL", "options"), "writingIntentWithURL_options_"
)
objc.registerNewKeywords("NSHost", ("address",), "hostWithAddress_")
objc.registerNewKeywords("NSHost", ("name",), "hostWithName_")
objc.registerNewKeywords(
    "NSNotification", ("name", "object"), "notificationWithName_object_"
)
objc.registerNewKeywords("NSSet", ("object",), "setWithObject_")
objc.registerNewKeywords("NSTimeZone", ("abbreviation",), "timeZoneWithAbbreviation_")
objc.registerNewKeywords(
    "NSUserNotificationAction", ("identifier", "title"), "actionWithIdentifier_title_"
)
protocols = {
...
formal_protocols = {
    "NSCacheDelegate": "NSCacheDelegate",
    "NSCoding": "NSCoding",
    "NSConnectionDelegate": "NSConnectionDelegate",
    "NSCopying": "NSCopying",
    "NSDecimalNumberBehaviors": "NSDecimalNumberBehaviors",
    ...
    "NSFilePresenter": "NSFilePresenter",
    "NSItemProviderReading": "NSItemProviderReading",
    "NSItemProviderWriting": "NSItemProviderWriting",
    "NSKeyedArchiverDelegate": "NSKeyedArchiverDelegate",
    "NSKeyedUnarchiverDelegate": "NSKeyedUnarchiverDelegate",
    "NSLocking": "NSLocking",
    "NSMachPortDelegate": "NSMachPortDelegate",
    "NSMetadataQueryDelegate": "NSMetadataQueryDelegate",
    "NSMutableCopying": "NSMutableCopying",
    "NSNetServiceBrowserDelegate": "NSNetServiceBrowserDelegate",
    "NSNetServiceDelegate": "NSNetServiceDelegate",
    "NSObjectProtocol": "NSObject",
    "NSPortDelegate": "NSPortDelegate",
    "NSPredicateValidating": "NSPredicateValidating",
    "NSProgressReporting": "NSProgressReporting",
    "NSSecureCoding": "NSSecureCoding",
    "NSSpellServerDelegate": "NSSpellServerDelegate",
    "NSStreamDelegate": "NSStreamDelegate",
    "NSURLAuthenticationChallengeSender": "NSURLAuthenticationChallengeSender",
    "NSURLConnectionDataDelegate": "NSURLConnectionDataDelegate",
    "NSURLConnectionDelegate": "NSURLConnectionDelegate",
    "NSURLConnectionDownloadDelegate": "NSURLConnectionDownloadDelegate",
    "NSURLDownloadDelegate": "NSURLDownloadDelegate",
    "NSURLHandleClient": "NSURLHandleClient",
    "NSURLProtocolClient": "NSURLProtocolClient",
    ...
    "NSURLSessionStreamDelegate": "NSURLSessionStreamDelegate",
    "NSURLSessionTaskDelegate": "NSURLSessionTaskDelegate",
    "NSURLSessionWebSocketDelegate": "NSURLSessionWebSocketDelegate",
    ...
    "NSXPCListenerDelegate": "NSXPCListenerDelegate",
    "NSXPCProxyCreating": "NSXPCProxyCreating",
}
