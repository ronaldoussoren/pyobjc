...
#
# Last update: Sun Jul 11 22:05:28 2021
#
# flake8: noqa
...
misc.update(
    {
        "NSEdgeInsets": objc.createStructType(
            "NSEdgeInsets", b"{NSEdgeInsets=dddd}", ["top", "left", "bottom", "right"]
        ),
        "NSHashEnumerator": objc.createStructType(
            "NSHashEnumerator", b"{_NSHashEnumerator=QQ^v}", ["_pi", "_si", "_bs"]
        ),
        ...
        "NSRect": objc.createStructType(
            "NSRect", b"{CGRect={CGPoint=dd}{CGSize=dd}}", ["origin", "size"]
        ),
...
functions = {
    ...
    "NSEnumerateMapTable": (b"{_NSMapEnumerator=QQ^v}@",),
    ...
    "NSEnumerateHashTable": (b"{_NSHashEnumerator=QQ^v}@",),
...
try:
    ...
    r(b"NSAttributedString", b"initWithFormat:options:locale:", {"variadic": True})
    r(
        b"NSAttributedString",
    ...
    r(b"NSMutableAttributedString", b"appendLocalizedFormat:", {"variadic": True})
    r(
        b"NSMutableAttributedString",
    ...
    r(
        ...
        {
            "retval": {"type": b"Z"},
            "arguments": {2: {"type": b"{_NSOperatingSystemVersion=qqq}"}},
        },
    )
