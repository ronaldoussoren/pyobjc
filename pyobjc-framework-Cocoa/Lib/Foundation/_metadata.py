...
constants = constants + "$NSZeroPoint@%s$" % (
    sel32or64("{_NSPoint=ff}", "{CGPoint=dd}"),
)
...
constants = constants + "$NSZeroRect@%s$" % (
    sel32or64(
        "{_NSRect={_NSPoint=ff}{_NSSize=ff}}", "{CGRect={CGPoint=dd}{CGSize=dd}}"
    ),
)
...
functions = {
    ...
    "NSIsEmptyRect": (
        sel32or64(
            b"Z{_NSRect={_NSPoint=ff}{_NSSize=ff}}",
            b"Z{CGRect={CGPoint=dd}{CGSize=dd}}",
        ),
    ),
    "NSHeight": (
        sel32or64(
            b"f{_NSRect={_NSPoint=ff}{_NSSize=ff}}",
            b"d{CGRect={CGPoint=dd}{CGSize=dd}}",
        ),
    ),
    "NSHomeDirectory": (b"@",),
    "NSResetMapTable": (b"v@",),
    ...
    "NSNextMapEnumeratorPair": (
        sel32or64(
            b"Z^{_NSMapEnumerator=II^v}^^v^^v", b"Z^{_NSMapEnumerator=QQ^v}^^v^^v"
        ),
    ),
    ...
    "NSSizeToCGSize": (
        sel32or64(b"{CGSize=ff}{_NSSize=ff}", b"{CGSize=dd}{CGSize=dd}"),
    ),
...
protocols = {
    "NSCoderMethods": objc.informal_protocol(
        ...
        [
            ...
            objc.selector(
                None, b"version", sel32or64(b"i@:", b"q@:"), isRequired=False
            ),
            objc.selector(
