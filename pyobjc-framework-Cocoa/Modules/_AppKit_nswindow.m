...
call_NSWindow_windowRef(PyObject* method, PyObject* self, PyObject* arguments)
{
    ...
    Py_BEGIN_ALLOW_THREADS
        @try {
            ...
            windowRef = ((void* (*)(struct objc_super*, SEL))objc_msgSendSuper)(
...
call_NSWindow_initWithWindowRef_(PyObject* method, PyObject* self, PyObject* arguments)
{
    ...
    Py_BEGIN_ALLOW_THREADS
        @try {
            ...
            objc_result = ((id(*)(struct objc_super*, SEL, void*))objc_msgSendSuper)(
                &super, PyObjCSelector_GetSelector(method), windowRef);
    ...
    if (objc_result == nil && PyErr_Occurred())
        return nil;
...
static void
imp_NSWindow_initWithWindowRef_(void* cif __attribute__((__unused__)), void* resp,
...
static int
setup_nswindows(PyObject* m __attribute__((__unused__)))
{
