...
static void __attribute__((__used__)) use_protocols(void)
{
    ...
    p = PyObjC_IdToPython(@protocol(NSAccessibility)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityButton)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityCheckBox)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityContainsTransientUI)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityElement)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityGroup)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityImage)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityLayoutArea)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityLayoutItem)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityList)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityNavigableStaticText)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityOutline)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityProgressIndicator)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityRadioButton)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityRow)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilitySlider)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityStaticText)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityStepper)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilitySwitch)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSAccessibilityTable)); Py_XDECREF(p);
    ...
    p = PyObjC_IdToPython(@protocol(NSAppearanceCustomization)); Py_XDECREF(p);
    ...
    p = PyObjC_IdToPython(@protocol(NSGestureRecognizerDelegate)); Py_XDECREF(p);
    ...
    p = PyObjC_IdToPython(@protocol(NSSeguePerforming)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSServicesMenuRequestor)); Py_XDECREF(p);
    ...
    p = PyObjC_IdToPython(@protocol(NSStackViewDelegate)); Py_XDECREF(p);
    ...
    p = PyObjC_IdToPython(@protocol(NSViewControllerPresentationAnimator)); Py_XDECREF(p);
...
#endif
#if PyObjC_BUILD_RELEASE >= 1011
    p = PyObjC_IdToPython(@protocol(NSTextAttachmentContainer)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSCollectionViewDataSource)); Py_XDECREF(p);
#endif
