...
static void __attribute__((__used__)) use_protocols(void)
{
    ...
    p = PyObjC_IdToPython(@protocol(NSURLSessionDataDelegate)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSURLSessionDelegate)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSURLSessionDownloadDelegate)); Py_XDECREF(p);
    p = PyObjC_IdToPython(@protocol(NSURLSessionTaskDelegate)); Py_XDECREF(p);
