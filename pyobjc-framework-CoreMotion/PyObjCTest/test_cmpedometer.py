...
class TestCMPedometer (TestCase):
    ...
    def test_methods10_15(self):
        ...
        self.assertArgIsBlock(CoreMotion.CMPedometer.queryPedometerDataFromDate_toDate_withHandler_, 2, CMPedometerHandler)
        self.assertArgIsBlock(CoreMotion.CMPedometer.startPedometerUpdatesFromDate_withHandler_, 1, CMPedometerHandler)
        self.assertArgIsBlock(CoreMotion.CMPedometer.startPedometerEventUpdatesWithHandler_, 0, CMPedometerEventHandler)
