...
try:
    r(
        ...
        b"acceleration",
        {"retval": {"type": "{CMAcceleration=ddd}"}},
    )
    ...
    r(b"CMAttitude", b"quaternion", {"retval": {"type": "{CMQuaternion=dddd}"}})
    r(
        b"CMAttitude",
        b"rotationMatrix",
        {"retval": {"type": "{CMRotationMatrix=ddddddddd}"}},
    )
    ...
    r(b"CMDeviceMotion", b"gravity", {"retval": {"type": "{CMAcceleration=ddd}"}})
    r(
        b"CMDeviceMotion",
        b"magneticField",
        {"retval": {"type": "{CMCalibratedMagneticField={CMMagneticField=ddd}i}"}},
    )
    r(b"CMDeviceMotion", b"rotationRate", {"retval": {"type": "{CMRotationRate=ddd}"}})
    r(
        b"CMDeviceMotion",
        b"userAcceleration",
        {"retval": {"type": "{CMAcceleration=ddd}"}},
    ...
    r(b"CMGyroData", b"rotationRate", {"retval": {"type": "{CMRotationRate=ddd}"}})
    ...
    r(
        ...
        b"magneticField",
        {"retval": {"type": "{CMMagneticField=ddd}"}},
    )
    ...
    r(
        ...
        b"rotationRate",
        {"retval": {"type": "{CMRotationRate=ddd}"}},
    )
    r(
        b"CMSensorRecorder",
...
objc.registerNewKeywordsFromSelector("CMFallDetectionEvent", b"init")
expressions = {}
formal_protocols = {
    "CMBodyIdentifiable": "CMBodyIdentifiable",
    "CMFallDetectionDelegate": "CMFallDetectionDelegate",
    "CMHeadphoneMotionManagerDelegate": "CMHeadphoneMotionManagerDelegate",
    "CMWaterSubmersionManagerDelegate": "CMWaterSubmersionManagerDelegate",
}
