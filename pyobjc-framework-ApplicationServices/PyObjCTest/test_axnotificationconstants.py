...
class TestAXNotificationConstants (TestCase):
    def testConstants(self):
        self.assertEqual(HIServices.kAXFocusedWindowChangedNotification, "AXFocusedWindowChanged")
        self.assertEqual(HIServices.kAXFocusedUIElementChangedNotification, "AXFocusedUIElementChanged")
        self.assertEqual(HIServices.kAXApplicationActivatedNotification, "AXApplicationActivated")
        self.assertEqual(HIServices.kAXApplicationDeactivatedNotification, "AXApplicationDeactivated")
        self.assertEqual(HIServices.kAXApplicationHiddenNotification, "AXApplicationHidden")
        ...
        self.assertEqual(HIServices.kAXWindowMiniaturizedNotification, "AXWindowMiniaturized")
        self.assertEqual(HIServices.kAXWindowDeminiaturizedNotification, "AXWindowDeminiaturized")
        ...
        self.assertEqual(HIServices.kAXUIElementDestroyedNotification, "AXUIElementDestroyed")
        self.assertEqual(HIServices.kAXElementBusyChangedNotification, "AXElementBusyChanged")
        ...
        self.assertEqual(HIServices.kAXSelectedCellsChangedNotification, "AXSelectedCellsChanged")
        self.assertEqual(HIServices.kAXUnitsChangedNotification, "AXUnitsChanged")
        self.assertEqual(HIServices.kAXSelectedChildrenMovedNotification, "AXSelectedChildrenMoved")
        self.assertEqual(HIServices.kAXSelectedChildrenChangedNotification, "AXSelectedChildrenChanged")
        ...
        self.assertEqual(HIServices.kAXSelectedRowsChangedNotification, "AXSelectedRowsChanged")
        self.assertEqual(HIServices.kAXSelectedColumnsChangedNotification, "AXSelectedColumnsChanged")
        self.assertEqual(HIServices.kAXSelectedTextChangedNotification, "AXSelectedTextChanged")
        ...
        self.assertEqual(HIServices.kAXAnnouncementRequestedNotification, "AXAnnouncementRequested")
