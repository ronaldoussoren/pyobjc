...
class TestAXAttributeConstants (TestCase):
    def testConstants(self):
         ...
         self.assertEqual(HIServices.kAXSelectedTextRangesAttribute, "AXSelectedTextRanges")
         self.assertEqual(HIServices.kAXVisibleCharacterRangeAttribute, "AXVisibleCharacterRange")
         self.assertEqual(HIServices.kAXNumberOfCharactersAttribute, "AXNumberOfCharacters")
         self.assertEqual(HIServices.kAXSharedTextUIElementsAttribute, "AXSharedTextUIElements")
         self.assertEqual(HIServices.kAXSharedCharacterRangeAttribute, "AXSharedCharacterRange")
         self.assertEqual(HIServices.kAXSharedFocusElementsAttribute, "AXSharedFocusElements")
         self.assertEqual(HIServices.kAXInsertionPointLineNumberAttribute, "AXInsertionPointLineNumber")
         ...
         self.assertEqual(HIServices.kAXMenuItemCmdVirtualKeyAttribute, "AXMenuItemCmdVirtualKey")
         self.assertEqual(HIServices.kAXMenuItemCmdGlyphAttribute, "AXMenuItemCmdGlyph")
         self.assertEqual(HIServices.kAXMenuItemCmdModifiersAttribute, "AXMenuItemCmdModifiers")
         self.assertEqual(HIServices.kAXMenuItemMarkCharAttribute, "AXMenuItemMarkChar")
         self.assertEqual(HIServices.kAXMenuItemPrimaryUIElementAttribute, "AXMenuItemPrimaryUIElement")
         ...
         self.assertEqual(HIServices.kAXHorizontalScrollBarAttribute, "AXHorizontalScrollBar")
         ...
         self.assertEqual(HIServices.kAXShownMenuUIElementAttribute, "AXShownMenuUIElement")
         self.assertEqual(HIServices.kAXServesAsTitleForUIElementsAttribute, "AXServesAsTitleForUIElements")
         ...
         self.assertEqual(HIServices.kAXMatteContentUIElementAttribute, "AXMatteContentUIElement")
         ...
         self.assertEqual(HIServices.kAXMarkerTypeDescriptionAttribute, "AXMarkerTypeDescription")
         self.assertEqual(HIServices.kAXIsApplicationRunningAttribute, "AXIsApplicationRunning")
         ...
         self.assertEqual(HIServices.kAXFocusedApplicationAttribute, "AXFocusedApplication")
         ...
         self.assertEqual(HIServices.kAXRowHeaderUIElementsAttribute, "AXRowHeaderUIElements")
         self.assertEqual(HIServices.kAXColumnHeaderUIElementsAttribute, "AXColumnHeaderUIElements")
         ...
         self.assertEqual(HIServices.kAXHorizontalUnitDescriptionAttribute, "AXHorizontalUnitDescription")
         self.assertEqual(HIServices.kAXVerticalUnitDescriptionAttribute, "AXVerticalUnitDescription")
         ...
         self.assertEqual(HIServices.kAXAlternateUIVisibleAttribute, "AXAlternateUIVisible")
         self.assertEqual(HIServices.kAXLineForIndexParameterizedAttribute, "AXLineForIndex")
         self.assertEqual(HIServices.kAXRangeForLineParameterizedAttribute, "AXRangeForLine")
         self.assertEqual(HIServices.kAXStringForRangeParameterizedAttribute, "AXStringForRange")
         self.assertEqual(HIServices.kAXRangeForPositionParameterizedAttribute, "AXRangeForPosition")
         self.assertEqual(HIServices.kAXRangeForIndexParameterizedAttribute, "AXRangeForIndex")
         self.assertEqual(HIServices.kAXBoundsForRangeParameterizedAttribute, "AXBoundsForRange")
         self.assertEqual(HIServices.kAXRTFForRangeParameterizedAttribute, "AXRTFForRange")
         self.assertEqual(HIServices.kAXAttributedStringForRangeParameterizedAttribute, "AXAttributedStringForRange")
         self.assertEqual(HIServices.kAXStyleRangeForIndexParameterizedAttribute, "AXStyleRangeForIndex")
         self.assertEqual(HIServices.kAXCellForColumnAndRowParameterizedAttribute, "AXCellForColumnAndRow")
         self.assertEqual(HIServices.kAXLayoutPointForScreenPointParameterizedAttribute, "AXLayoutPointForScreenPoint")
         self.assertEqual(HIServices.kAXLayoutSizeForScreenSizeParameterizedAttribute, "AXLayoutSizeForScreenSize")
         self.assertEqual(HIServices.kAXScreenPointForLayoutPointParameterizedAttribute, "AXScreenPointForLayoutPoint")
         self.assertEqual(HIServices.kAXScreenSizeForLayoutSizeParameterizedAttribute, "AXScreenSizeForLayoutSize")
