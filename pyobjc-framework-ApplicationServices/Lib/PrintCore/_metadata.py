...
#
# Last update: Sun Aug  4 20:39:59 2019
...
misc.update(
    {
        ...
        "kPMSchedulerPDEKindID": b"com.apple.print.pde.SchedulerKind".decode("utf-8"),
        "kPMServerLocal": None,
        "kPMJobPINPDEKindID": b"com.apple.print.pde.jobPIN".decode("utf-8"),
        "kPMPageToPaperMappingTypeStr": b"com.apple.print.PageToPaperMappingType",
        "SUMMARY_DISPLAY_ORDER": b"Summary, Display, Order".decode("utf-8"),
        "kPMColorPDEKindID": b"com.apple.print.pde.ColorKind".decode("utf-8"),
        "kPMBorderTypeStr": b"com.apple.print.PrintSettings.PMBorderType",
        "kPMPrinterFeaturesPDEKindID": b"com.apple.print.pde.PrinterFeaturesKind".decode(
            "utf-8"
        ),
        "kPMGraphicsContextCoreGraphics": b"com.apple.graphicscontext.coregraphics".decode(
            "utf-8"
        ),
        "kPMColorSyncProfileIDStr": b"com.apple.print.PrintSettings.PMColorSyncProfileID",
        "kPMFaxToneDialingStr": b"faxToneDialing",
        "kPDFWorkflowItemsKey": b"items".decode("utf-8"),
        "kPMCoverPagePDEKindID": b"com.apple.print.pde.CoverPageKind".decode("utf-8"),
        "kPMFaxSubjectLabelStr": b"faxSubjectLabel",
        "kGeneralPageSetupDialogTypeIDStr": b"6E6ED964-B738-11D3-952F-0050E4603277".decode(
            "utf-8"
        ),
        "kPMCopiesAndPagesPDEKindID": b"com.apple.print.pde.CopiesAndPagesKind".decode(
            "utf-8"
        ),
        "kAppPageSetupDialogTypeIDStr": b"B9A0DA98-E57F-11D3-9E83-0050E4603277".decode(
            "utf-8"
        ),
        "kPMDocumentFormatDefault": b"com.apple.documentformat.default".decode("utf-8"),
        "kPDFWorkflowDisplayNameKey": b"displayName".decode("utf-8"),
        "kPMNoPageFormat": None,
        "kPMImagingOptionsPDEKindID": b"com.apple.print.pde.ImagingOptionsKind".decode(
            "utf-8"
        ),
        "kPDFWorkflowModifiedKey": b"wasModifiedInline".decode("utf-8"),
        ...
        "kPrinterModuleTypeIDStr": b"BDB091F4-E57F-11D3-B5CC-0050E4603277".decode(
            "utf-8"
        ),
        "kPMInkPDEKindID": b"com.apple.print.pde.InkKind".decode("utf-8"),
        "kPMSandboxCompatiblePDEs": b"PMSandboxCompatiblePDEs".decode("utf-8"),
        ...
        "kPMFaxModemPDEKindID": b"com.apple.print.pde.FaxModemKind".decode("utf-8"),
        "kPMPageToPaperMediaNameStr": b"com.apple.print.PageToPaperMappingMediaName",
        "kPMPageAttributesKindID": b"com.apple.print.pde.PageAttributesKind".decode(
            "utf-8"
        ),
        ...
        "kPMErrorHandlingPDEKindID": b"com.apple.print.pde.ErrorHandlingKind".decode(
            "utf-8"
        ),
        "kPMApplicationColorMatchingStr": b"AP_ApplicationColorMatching",
        "kPMPresetGraphicsTypeAll": b"All".decode("utf-8"),
        ...
        "kPMUnsupportedPDEKindID": b"com.apple.print.pde.UnsupportedPDEKind".decode(
            "utf-8"
        ),
        "kPMCustomProfilePathStr": b"PMCustomProfilePath",
        "kPMLayoutDirectionStr": b"com.apple.print.PrintSettings.PMLayoutDirection",
        "kPMFaxCoverPagePDEKindID": b"com.apple.print.pde.FaxCoverPageKind".decode(
            "utf-8"
        ),
        "kPMFaxSheetsLabelStr": b"faxSheetsLabel",
        "kPMFaxToLabelStr": b"faxToLabel",
        "kPMFaxWaitForDialToneStr": b"faxWaitForDialTone",
        "kGeneralPrintDialogTypeIDStr": b"C1BF838E-B72A-11D3-9644-0050E4603277".decode(
            "utf-8"
        ),
        "kPMJobStateStr": b"com.apple.print.PrintSettings.PMJobState",
        "kPMLayoutRowsStr": b"com.apple.print.PrintSettings.PMLayoutRows",
        "kPMDocumentFormatPDF": b"application/pdf".decode("utf-8"),
        "kPMOutputOptionsPDEKindID": b"com.apple.print.pde.OutputOptionsKind".decode(
            "utf-8"
        ),
        "kPDFWorkflowItemURLKey": b"itemURL".decode("utf-8"),
        "kPMPPDDescriptionType": b"PMPPDDescriptionType".decode("utf-8"),
        "kPMPresetGraphicsTypeNone": b"None".decode("utf-8"),
        "kPMCopiesStr": b"com.apple.print.PrintSettings.PMCopies",
        "kPMPresetGraphicsTypeGeneral": b"General".decode("utf-8"),
        "kPMColorMatchingModeStr": b"AP_ColorMatchingMode",
        "kAppPrintThumbnailTypeIDStr": b"9320FE03-B5D5-11D5-84D1-003065D6135E".decode(
            "utf-8"
        ),
        "kPMFaxAddressesPDEKindID": b"com.apple.print.pde.FaxAddressesKind".decode(
            "utf-8"
        ),
        "kPMFitToPageStr": b"fit-to-page",
        "kPMFaxSubjectStr": b"faxSubject",
        "kPMPresetGraphicsTypeKey": b"com.apple.print.preset.graphicsType".decode(
            "utf-8"
        ),
        "kPMCustomPaperSizePDEKindID": b"com.apple.print.pde.CustomPaperSizeKind".decode(
            "utf-8"
        ),
        ...
        "kPMDuplexPDEKindID": b"com.apple.print.pde.DuplexKind".decode("utf-8"),
        ...
        "kPMMediaQualityPDEKindID": b"com.apple.print.pde.MediaQualityPDEKind".decode(
            "utf-8"
        ),
        "kPMDocumentFormatPostScript": b"application/postscript".decode("utf-8"),
        "kPMPresetGraphicsTypePhoto": b"Photo".decode("utf-8"),
        "kPMDuplexingStr": b"com.apple.print.PrintSettings.PMDuplexing",
        "kPMPaperHandlingPDEKindID": b"com.apple.print.pde.PaperHandlingKind".decode(
            "utf-8"
        ),
        "kPMFaxToStr": b"faxTo",
        "kPMSummaryPanelKindID": b"com.apple.print.pde.SummaryKind".decode("utf-8"),
        "kPMRotationScalingPDEKindID": b"com.apple.print.pde.RotationScalingKind".decode(
            "utf-8"
        ),
        "kPMPDFEffectsPDEKindID": b"com.apple.print.pde.PDFEffects".decode("utf-8"),
