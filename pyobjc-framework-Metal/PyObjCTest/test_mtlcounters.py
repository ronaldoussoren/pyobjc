...
class TestMTLCountersHelper (Metal.NSObject):
    def sampleCount(self): return 1
    def resolveCounterRange_(self, a): return 1
...
class TestMTLCounters (TestCase):
    ...
    def test_constants10_15(self):
        ...
        self.assertIsInstance(Metal.MTLCommonCounterPostTessellationVertexInvocations, unicode)
        ...
        self.assertIsInstance(Metal.MTLCommonCounterPostTessellationVertexCycles, unicode)
    ...
    def test_methods(self):
        ...
        self.assertArgHasType(TestMTLCountersHelper.resolveCounterRange_, 0, Metal.NSRange.__typestr__)
