...
class TestMTLPixelFormat(TestCase):
    def test_enums(self):
        ...
        self.assertEqual(Metal.MTLPixelFormatRGB8Unorm, 45)
        self.assertEqual(Metal.MTLPixelFormatRGB8Snorm, 46)
        self.assertEqual(Metal.MTLPixelFormatRGB8Uint, 47)
        self.assertEqual(Metal.MTLPixelFormatRGB8Sint, 48)
        ...
        self.assertEqual(Metal.MTLPixelFormatRGB16Unorm, 95)
        self.assertEqual(Metal.MTLPixelFormatRGB16Snorm, 96)
        self.assertEqual(Metal.MTLPixelFormatRGB16Uint, 97)
        self.assertEqual(Metal.MTLPixelFormatRGB16Sint, 98)
        self.assertEqual(Metal.MTLPixelFormatRGB16Float, 99)
        ...
        self.assertEqual(Metal.MTLPixelFormatRGB32Uint, 120)
        self.assertEqual(Metal.MTLPixelFormatRGB32Sint, 121)
        self.assertEqual(Metal.MTLPixelFormatRGB32Float, 122)
        ...
        self.assertEqual(Metal.MTLPixelFormatASTC_6x5_HDR, 225)
        self.assertEqual(Metal.MTLPixelFormatASTC_6x6_HDR, 226)
        self.assertEqual(Metal.MTLPixelFormatASTC_8x5_HDR, 228)
        self.assertEqual(Metal.MTLPixelFormatASTC_8x6_HDR, 229)
        self.assertEqual(Metal.MTLPixelFormatASTC_8x8_HDR, 230)
        self.assertEqual(Metal.MTLPixelFormatASTC_10x5_HDR, 231)
        self.assertEqual(Metal.MTLPixelFormatASTC_10x6_HDR, 232)
        self.assertEqual(Metal.MTLPixelFormatASTC_10x8_HDR, 233)
        self.assertEqual(Metal.MTLPixelFormatASTC_10x10_HDR, 234)
        self.assertEqual(Metal.MTLPixelFormatASTC_12x10_HDR, 235)
        self.assertEqual(Metal.MTLPixelFormatASTC_12x12_HDR, 236)
