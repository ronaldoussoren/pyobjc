...
class TestMTLCommandBuffer (TestCase):
    ...
    def test_methods(self):
        ...
        self.assertArgIsBlock(TestMTLCommandBufferHelper.addScheduledHandler_, 0, MTLCommandBufferHandler)

        self.assertArgHasType(TestMTLCommandBufferHelper.presentDrawable_atTime_, 1, objc._C_DBL)
