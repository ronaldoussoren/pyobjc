...
class TestMTL4CompilerHelper(Metal.NSObject):
    ...
    def newDynamicLibraryWithURL_completionHandler_(self, a, b):
        return 1

    def newRenderPipelineStateWithDescriptor_compilerTaskOptions_error_(self, a, b, c):
        return 1
...
class TestMTL4Compiler(TestCase):
    ...
    def test_protocol_methods(self):
        self.assertResultIsRetained(
            TestMTL4CompilerHelper.newLibraryWithDescriptor_error_
        )
        self.assertArgHasType(
            TestMTL4CompilerHelper.newLibraryWithDescriptor_error_, 1, b"o^@"
        )

        self.assertResultIsRetained(TestMTL4CompilerHelper.newDynamicLibrary_error_)
        self.assertArgHasType(
            TestMTL4CompilerHelper.newDynamicLibrary_error_, 1, b"o^@"
        )

        self.assertResultIsRetained(
            TestMTL4CompilerHelper.newDynamicLibraryWithURL_error_
        )
        self.assertArgHasType(
        ...
        self.assertResultIsRetained(
            TestMTL4CompilerHelper.newDynamicLibraryWithURL_completionHandler_
        )
        self.assertArgIsBlock(
            TestMTL4CompilerHelper.newDynamicLibraryWithURL_completionHandler_,
            1,
        ...
        self.assertResultIsRetained(
            TestMTL4CompilerHelper.newRenderPipelineStateWithDescriptor_compilerTaskOptions_error_
        )
        self.assertArgHasType(
            TestMTL4CompilerHelper.newRenderPipelineStateWithDescriptor_compilerTaskOptions_error_,
            2,
        ...
        self.assertResultIsRetained(
            TestMTL4CompilerHelper.newRenderPipelineStateWithDescriptor_dynamicLinkingDescriptor_error_
        )
        self.assertArgHasType(
            TestMTL4CompilerHelper.newRenderPipelineStateWithDescriptor_dynamicLinkingDescriptor_error_,
            2,
