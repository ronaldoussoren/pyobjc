...
class TestMTLHeapHelper (Metal.NSObject):
    ...
    def usedSize(self): return 1
    def maxAvailableSizeWithAlignment_(self, a): return 1
    def newBufferWithLength_options_(self, a, b): return 1
    def setPurgeableState_(self, a): return 1
    def type(self): return 1
    def newBufferWithLength_options_offset_(self, a, b, c): return 1
    def newTextureWithDescriptor_offset_(self, a, b): return 1
...
class TestMTLHeap (TestCase):
    ...
    def test_methods(self):
        ...
        self.assertResultHasType(TestMTLHeapHelper.maxAvailableSizeWithAlignment_, objc._C_NSUInteger)
        self.assertArgHasType(TestMTLHeapHelper.maxAvailableSizeWithAlignment_, 0, objc._C_NSUInteger)

        self.assertArgHasType(TestMTLHeapHelper.newBufferWithLength_options_, 0, objc._C_NSUInteger)
        self.assertArgHasType(TestMTLHeapHelper.newBufferWithLength_options_, 1, objc._C_NSUInteger)
        ...
        self.assertArgHasType(TestMTLHeapHelper.newBufferWithLength_options_offset_, 2, objc._C_NSUInteger)

        self.assertArgHasType(TestMTLHeapHelper.newTextureWithDescriptor_offset_, 1, objc._C_NSUInteger)
