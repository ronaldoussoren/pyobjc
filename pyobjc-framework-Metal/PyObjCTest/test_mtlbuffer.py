...
class TestMTLBufferHelper (Metal.NSObject):
    ...
    def didModifyRange_(self, a): pass
    def newTextureWithDescriptor_offset_bytesPerRow_(self, a, b, c): return 1
    def addDebugMarker_range_(self, a, b): pass
...
class TestMTLBuffer (TestCase):
    ...
    def test_methods(self):
        ...
        self.assertArgHasType(TestMTLBufferHelper.newTextureWithDescriptor_offset_bytesPerRow_, 1, objc._C_NSUInteger)
        self.assertArgHasType(TestMTLBufferHelper.newTextureWithDescriptor_offset_bytesPerRow_, 2, objc._C_NSUInteger)

        self.assertArgHasType(TestMTLBufferHelper.addDebugMarker_range_, 1, Metal.NSRange.__typestr__)
