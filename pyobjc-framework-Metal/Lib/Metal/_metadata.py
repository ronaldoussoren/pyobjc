...
#
# Last update: Sun Jun 19 13:40:35 2022
#
# flake8: noqa
...
functions = {
    ...
    "MTLIOCompressionContextAppendData": (b"v^v^vQ",),
}
aliases = {
...
try:
    ...
    r(
        b"NSObject",
        b"allocateScratchBufferWithMinimumSize:",
    ...
    r(b"NSObject", b"gpuHandle", {"required": True, "retval": {"type": b"Q"}})
    r(
        b"NSObject",
        b"gpuResourceID",
    ...
    r(
        ...
        b"setMeshBytes:length:atIndex:",
        {
            "required": True,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"^v"}, 3: {"type": b"Q"}, 4: {"type": b"Q"}},
        },
    )
    r(
        b"NSObject",
