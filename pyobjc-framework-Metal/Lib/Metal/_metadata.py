...
#
# Last update: Wed Nov 20 13:17:45 2019
...
misc.update({})
functions={'MTLTextureSwizzleChannelsMake': (b'{_MTLTextureSwizzleChannels=CCCC}CCCC',), 'MTLOriginMake': (b'{_MTLOrigin=QQQ}QQQ',), 'MTLRegionMake3D': (b'{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}QQQQQQ',), 'MTLRegionMake1D': (b'{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}QQ',), 'MTLSamplePositionMake': (b'{_MTLSamplePosition=ff}ff',), 'MTLRegionMake2D': (b'{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}QQQQ',), 'MTLRemoveDeviceObserver': (b'v@',), 'MTLCopyAllDevicesWithObserver': (b'@^@@?', '', {'retval': {'already_cfretained': True}}), 'MTLIndirectCommandBufferExecutionRangeMake': (b'{_MTLIndirectCommandBufferExecutionRange=II}II',), 'MTLClearColorMake': (b'{_MTLClearColor=dddd}dddd',), 'MTLCreateSystemDefaultDevice': (b'@', '', {'retval': {'already_cfretained': True}}), 'MTLCopyAllDevices': (b'@', '', {'retval': {'already_cfretained': True}}), 'MTLSizeMake': (b'{_MTLSize=QQQ}QQQ',)}
...
try:
    ...
    r(b'MTLCaptureManager', b'startCaptureWithDescriptor:error:', {'retval': {'type': b'Z'}})
