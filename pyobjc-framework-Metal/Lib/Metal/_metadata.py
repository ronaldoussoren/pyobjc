...
#
# Last update: Sun Dec 15 22:42:58 2019
...
try:
    ...
    r(b'MTLRenderPassDescriptor', b'getSamplePositions:count:', {'arguments': {2: {'type': b'^{_MTLSamplePosition=ff}', 'type_modifier': b'o', 'c_array_length_in_arg': 3}}})
