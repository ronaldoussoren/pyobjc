...
#
# Last update: Tue Dec 10 22:46:46 2019
...
misc.update({'MTLClearColor': objc.createStructType('MTLClearColor', b'{_MTLClearColor=dddd}', ['red', 'green', 'blue', 'alpha']), 'MTLOrigin': objc.createStructType('MTLOrigin', b'{_MTLOrigin=QQQ}', ['x', 'y', 'z']), 'MTLIndirectCommandBufferExecutionRange': objc.createStructType('MTLIndirectCommandBufferExecutionRange', b'{_MTLIndirectCommandBufferExecutionRange=II}', ['location', 'length']), 'MTLScissorRect': objc.createStructType('MTLScissorRect', b'{_MTLScissorRect=QQQQ}', ['x', 'y', 'width', 'height']), 'MTLCounterResultStageUtilization': objc.createStructType('MTLCounterResultStageUtilization', b'{_MTLCounterResultStageUtilization=QQQQQQ}', ['totalCycles', 'vertexCycles', 'tessellationCycles', 'postTessellationVertexCycles', 'fragmentCycles', 'renderTargetCycles']), 'MTLDrawPrimitivesIndirectArguments': objc.createStructType('MTLDrawPrimitivesIndirectArguments', b'{_MTLDrawPrimitivesIndirectArguments=IIII}', ['vertexCount', 'instanceCount', 'vertexStart', 'baseInstance']), 'MTLCounterResultTimestamp': objc.createStructType('MTLCounterResultTimestamp', b'{_MTLCounterResultTimestamp=Q}', ['timestamp']), 'MTLDispatchThreadgroupsIndirectArguments': objc.createStructType('MTLDispatchThreadgroupsIndirectArguments', b'{_MTLDispatchThreadgroupsIndirectArguments=[3I]}', ['threadgroupsPerGrid']), 'MTLViewport': objc.createStructType('MTLViewport', b'{_MTLViewport=dddddd}', ['originX', 'originY', 'width', 'height', 'znear', 'zfar']), 'MTLDrawPatchIndirectArguments': objc.createStructType('MTLDrawPatchIndirectArguments', b'{_MTLDrawPatchIndirectArguments=IIII}', ['patchCount', 'instanceCount', 'patchStart', 'baseInstance']), 'MTLTriangleTessellationFactorsHalf': objc.createStructType('MTLTriangleTessellationFactorsHalf', b'{_MTLTriangleTessellationFactorsHalf=[3S]S}', ['edgeTessellationFactor', 'insideTessellationFactor']), 'MTLTextureSwizzleChannels': objc.createStructType('MTLTextureSwizzleChannels', b'{_MTLTextureSwizzleChannels=CCCC}', ['red', 'green', 'blue', 'alpha']), 'MTLStageInRegionIndirectArguments': objc.createStructType('MTLStageInRegionIndirectArguments', b'{_MTLStageInRegionIndirectArguments=[3I][3I]}', ['stageInOrigin', 'stageInSize']), 'MTLSizeAndAlign': objc.createStructType('MTLSizeAndAlign', b'{_MTLSizeAndAlign=QQ}', ['size', 'align']), 'MTLQuadTessellationFactorsHalf': objc.createStructType('MTLQuadTessellationFactorsHalf', b'{_MTLQuadTessellationFactorsHalf=[4S][2S]}', ['edgeTessellationFactor', 'insideTessellationFactor']), 'MTLSize': objc.createStructType('MTLSize', b'{_MTLSize=QQQ}', ['width', 'height', 'depth']), 'MTLSamplePosition': objc.createStructType('MTLSamplePosition', b'{_MTLSamplePosition=ff}', ['x', 'y']), 'MTLRegion': objc.createStructType('MTLRegion', b'{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}', ['origin', 'size']), 'MTLCounterResultStatistic': objc.createStructType('MTLCounterResultStatistic', b'{_MTLCounterResultStatistic=QQQQQQQQ}', ['tessellationInputPatches', 'vertexInvocations', 'postTessellationVertexInvocations', 'clipperInvocations', 'clipperPrimitivesOut', 'fragmentInvocations', 'fragmentsPassed', 'computeKernelInvocations']), 'MTLDrawIndexedPrimitivesIndirectArguments': objc.createStructType('MTLDrawIndexedPrimitivesIndirectArguments', b'{_MTLDrawIndexedPrimitivesIndirectArguments=IIIiI}', ['indexCount', 'instanceCount', 'indexStart', 'baseVertex', 'baseInstance'])})
...
try:
    ...
    r(b'MTLRenderPassDescriptor', b'getSamplePositions:count:', {'arguments': {2: {'type': b'^{_MTLSamplePosition=ff}'}}})
    r(b'MTLRenderPassDescriptor', b'setSamplePositions:count:', {'arguments': {2: {'type': b'^{_MTLSamplePosition=ff}'}}})
    ...
    r(b'NSObject', b'addCompletedHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@?'}}})
    r(b'NSObject', b'addDebugMarker:range:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'addScheduledHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@?'}}})
    ...
    r(b'NSObject', b'contents', {'required': True, 'retval': {'type': b'^v'}})
    ...
    r(b'NSObject', b'fillBuffer:range:value:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'{_NSRange=QQ}'}, 4: {'type': b'C'}}})
    ...
    r(b'NSObject', b'getBytes:bytesPerRow:bytesPerImage:fromRegion:mipmapLevel:slice:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^v'}, 3: {'type': b'Q'}, 4: {'type': b'Q'}, 5: {'type': b'{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}'}, 6: {'type': b'Q'}, 7: {'type': b'Q'}}})
    r(b'NSObject', b'getBytes:bytesPerRow:fromRegion:mipmapLevel:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^v'}, 3: {'type': b'Q'}, 4: {'type': b'{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}'}, 5: {'type': b'Q'}}})
    r(b'NSObject', b'getDefaultSamplePositions:count:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^{_MTLSamplePosition=ff}'}, 3: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'memoryBarrierWithResources:count:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'Q'}}})
    r(b'NSObject', b'memoryBarrierWithResources:count:afterStages:beforeStages:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'Q'}, 4: {'type': b'Q'}, 5: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'newBufferWithBytes:length:options:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'^v'}, 3: {'type': b'Q'}, 4: {'type': b'Q'}}})
    r(b'NSObject', b'newBufferWithBytesNoCopy:length:options:deallocator:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'^v'}, 3: {'type': b'Q'}, 4: {'type': b'Q'}, 5: {'type': b'@?'}}})
    ...
    r(b'NSObject', b'newComputePipelineStateWithDescriptor:options:completionHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}, 4: {'type': b'@?'}}})
    r(b'NSObject', b'newComputePipelineStateWithDescriptor:options:reflection:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}, 4: {'type': b'^@'}, 5: {'type': b'^@'}}})
    r(b'NSObject', b'newComputePipelineStateWithFunction:completionHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@?'}}})
    r(b'NSObject', b'newComputePipelineStateWithFunction:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@'}}})
    r(b'NSObject', b'newComputePipelineStateWithFunction:options:completionHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}, 4: {'type': b'@?'}}})
    r(b'NSObject', b'newComputePipelineStateWithFunction:options:reflection:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}, 4: {'type': b'^@'}, 5: {'type': b'^@'}}})
    r(b'NSObject', b'newCounterSampleBufferWithDescriptor:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@'}}})
    r(b'NSObject', b'newDefaultLibrary', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'newDefaultLibraryWithBundle:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@'}}})
    ...
    r(b'NSObject', b'newFunctionWithName:constantValues:completionHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@?'}}})
    r(b'NSObject', b'newFunctionWithName:constantValues:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'^@'}}})
    ...
    r(b'NSObject', b'newLibraryWithData:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@'}}})
    r(b'NSObject', b'newLibraryWithFile:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@'}}})
    r(b'NSObject', b'newLibraryWithSource:options:completionHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@?'}}})
    r(b'NSObject', b'newLibraryWithSource:options:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'^@'}}})
    r(b'NSObject', b'newLibraryWithURL:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@'}}})
    ...
    r(b'NSObject', b'newRenderPipelineStateWithDescriptor:completionHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@?'}}})
    r(b'NSObject', b'newRenderPipelineStateWithDescriptor:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@'}}})
    r(b'NSObject', b'newRenderPipelineStateWithDescriptor:options:completionHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}, 4: {'type': b'@?'}}})
    r(b'NSObject', b'newRenderPipelineStateWithDescriptor:options:reflection:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}, 4: {'type': b'^@'}, 5: {'type': b'^@'}}})
    ...
    r(b'NSObject', b'notifyListener:atValue:block:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}, 4: {'type': b'@?'}}})
    ...
    r(b'NSObject', b'replaceRegion:mipmapLevel:slice:withBytes:bytesPerRow:bytesPerImage:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}'}, 3: {'type': b'Q'}, 4: {'type': b'Q'}, 5: {'type': b'^v'}, 6: {'type': b'Q'}, 7: {'type': b'Q'}}})
    r(b'NSObject', b'replaceRegion:mipmapLevel:withBytes:bytesPerRow:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}'}, 3: {'type': b'Q'}, 4: {'type': b'^v'}, 5: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'sampleTimestamps:gpuTimestamp:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^Q'}, 3: {'type': b'^Q'}}})
    ...
    r(b'NSObject', b'setBuffers:offsets:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'^Q'}, 4: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'setBytes:length:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^v'}, 3: {'type': b'Q'}, 4: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'setFragmentBuffers:offsets:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'^Q'}, 4: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'setFragmentBytes:length:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^v'}, 3: {'type': b'Q'}, 4: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'setFragmentSamplerStates:lodMinClamps:lodMaxClamps:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'^f'}, 4: {'type': b'^f'}, 5: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'setFragmentSamplerStates:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'setFragmentTexture:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}}})
    r(b'NSObject', b'setFragmentTextures:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'{_NSRange=QQ}'}}})
    ...
    r(b'NSObject', b'setIndirectCommandBuffers:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'{_NSRange=QQ}'}}})
    ...
    r(b'NSObject', b'setRenderPipelineStates:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'{_NSRange=QQ}'}}})
    ...
    r(b'NSObject', b'setSamplerStates:lodMinClamps:lodMaxClamps:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'^f'}, 4: {'type': b'^f'}, 5: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'setSamplerStates:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'setScissorRect:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'{_MTLScissorRect=QQQQ}'}}})
    r(b'NSObject', b'setScissorRects:count:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^{_MTLScissorRect=QQQQ}'}, 3: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'setTextures:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'{_NSRange=QQ}'}}})
    ...
    r(b'NSObject', b'setVertexBuffers:offsets:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'^Q'}, 4: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'setVertexBytes:length:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^v'}, 3: {'type': b'Q'}, 4: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'setVertexSamplerStates:lodMinClamps:lodMaxClamps:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'^f'}, 4: {'type': b'^f'}, 5: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'setVertexSamplerStates:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'setVertexTexture:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}}})
    r(b'NSObject', b'setVertexTextures:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'setViewport:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'{_MTLViewport=dddddd}'}}})
    r(b'NSObject', b'setViewports:count:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^{_MTLViewport=dddddd}'}, 3: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'useHeaps:count:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'Q'}}})
    r(b'NSObject', b'useHeaps:count:stages:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'Q'}, 4: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'useResources:count:usage:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'Q'}, 4: {'type': b'Q'}}})
