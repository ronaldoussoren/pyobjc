...
misc.update(
    {
        ...
        "MTLForwardProgressUsage": NewType("MTLForwardProgressUsage", int),
        ...
        "MTLTensorPlaneType": NewType("MTLTensorPlaneType", int),
        ...
        "MTLContentionRelief": NewType("MTLContentionRelief", int),
        "MTLDeviceError": NewType("MTLDeviceError", int),
        ...
        "MTLFloatingPointConversionRoundingMode": NewType(
            "MTLFloatingPointConversionRoundingMode", int
        ),
...
functions = {
    ...
    "MTLCopyAllDevices": (
        b"@",
        "",
        {"retval": {"already_retained": True, "already_cfretained": False}},
    ),
...
try:
    ...
    r(
        b"MTL4ComputePipelineDescriptor",
        b"setOptimizeForPersistentKernel:",
        {"arguments": {2: {"type": b"Z"}}},
    )
    r(
        b"MTL4ComputePipelineDescriptor",
    ...
    r(b"NSObject", b"auxiliaryPlanes", {"required": True, "retval": {"type": b"@"}})
    r(
        b"NSObject",
    ...
    r(b"NSObject", b"blockFactors", {"required": True, "retval": {"type": b"@"}})
    ...
    r(
        ...
        b"convertSparsePixelRegions:toTileRegions:withTileSize:alignmentMode:numRegions:",
        {
            ...
            "arguments": {
                2: {
                    "type": b"^{MTLRegion={MTLOrigin=QQQ}{MTLSize=QQQ}}",
                    "type_modifier": b"n",
    ...
    r(
        b"NSObject",
        b"copyFromTensor:sourceOrigin:sourceDimensions:sourcePlane:toTensor:destinationOrigin:destinationDimensions:destinationPlane:",
        {
            "required": True,
            "retval": {"type": b"v"},
            "arguments": {
    ...
    r(b"NSObject", b"drawableID", {"required": True, "retval": {"type": b"Q"}})
    r(
        b"NSObject",
    ...
    r(b"NSObject", b"firstMipmapInTail", {"required": False, "retval": {"type": b"Q"}})
    r(
        b"NSObject",
        b"forwardProgressUsage",
        {"required": True, "retval": {"type": b"q"}},
    )
    ...
    r(
        b"NSObject",
        b"getBytes:strides:fromSliceOrigin:sliceDimensions:plane:",
        {
            "required": True,
            "retval": {"type": b"v"},
            "arguments": {
    ...
    r(
        ...
        b"getTextureAccessCounters:region:mipLevel:slice:resetCounters:countersBuffer:countersBufferOffset:",
        {
            ...
            "arguments": {
                2: {"type": b"@"},
                3: {"type": b"{MTLRegion={MTLOrigin=QQQ}{MTLSize=QQQ}}"},
                4: {"type": b"Q"},
                5: {"type": b"Q"},
                6: {"type": b"Z"},
                7: {"type": b"@"},
    ...
    r(b"NSObject", b"isSparse", {"required": False, "retval": {"type": b"Z"}})
    ...
    r(b"NSObject", b"minLOD", {"required": True, "retval": {"type": b"f"}})
    r(
        b"NSObject",
    ...
    r(b"NSObject", b"planeType", {"required": True, "retval": {"type": b"q"}})
    ...
    r(b"NSObject", b"presentedTime", {"required": True, "retval": {"type": b"d"}})
    r(
        b"NSObject",
        b"pushDebugGroup:",
        {"required": True, "retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    ...
    r(
        b"NSObject",
        b"recommendedPersistentThreadgroupsPerGridForThreadsPerThreadgroup:",
        {
            "required": True,
            "retval": {"type": b"Q"},
            "arguments": {2: {"type": b"{MTLSize=QQQ}"}},
    ...
    r(
        b"NSObject",
        b"replaceSliceOrigin:sliceDimensions:plane:withBytes:strides:",
        {
            "required": True,
            "retval": {"type": b"v"},
            "arguments": {
    ...
    r(b"NSObject", b"supports32BitMSAA", {"required": True, "retval": {"type": b"Z"}})
    r(
        b"NSObject",
    ...
    r(b"NSObject", b"tailSizeInBytes", {"required": False, "retval": {"type": b"Q"}})
    ...
    r(b"NSObject", b"tileHeight", {"required": True, "retval": {"type": b"Q"}})
    r(b"NSObject", b"tileWidth", {"required": True, "retval": {"type": b"Q"}})
    ...
    r(
        ...
        b"updateTextureMappings:mode:regions:mipLevels:slices:numRegions:",
        {
            ...
            "arguments": {
                ...
                5: {"type": b"^Q", "type_modifier": b"n", "c_array_length_in_arg": 7},
                6: {"type": b"^Q", "type_modifier": b"n", "c_array_length_in_arg": 7},
                7: {"type": b"Q"},
            },
        },
    )
...
objc.registerNewKeywordsFromSelector("MTLCaptureManager", b"init")
...
objc.registerNewKeywordsFromSelector("MTLRasterizationRateLayerDescriptor", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("MTLSharedEventListener", b"init")
objc.registerNewKeywordsFromSelector(
...
formal_protocols = {
    "MTL4Archive": "MTL4Archive",
    "MTL4ArgumentTable": "MTL4ArgumentTable",
    "MTL4BinaryFunction": "MTL4BinaryFunction",
    "MTL4CommandAllocator": "MTL4CommandAllocator",
    "MTL4CommandBuffer": "MTL4CommandBuffer",
    "MTL4CommandEncoder": "MTL4CommandEncoder",
    "MTL4CommandQueue": "MTL4CommandQueue",
    "MTL4CommitFeedback": "MTL4CommitFeedback",
    "MTL4Compiler": "MTL4Compiler",
    "MTL4CompilerTask": "MTL4CompilerTask",
    "MTL4ComputeCommandEncoder": "MTL4ComputeCommandEncoder",
    "MTL4CounterHeap": "MTL4CounterHeap",
    "MTL4MachineLearningCommandEncoder": "MTL4MachineLearningCommandEncoder",
    "MTL4MachineLearningPipelineState": "MTL4MachineLearningPipelineState",
    "MTL4PipelineDataSetSerializer": "MTL4PipelineDataSetSerializer",
    "MTL4RenderCommandEncoder": "MTL4RenderCommandEncoder",
    "MTLAccelerationStructure": "MTLAccelerationStructure",
    "MTLAccelerationStructureCommandEncoder": "MTLAccelerationStructureCommandEncoder",
    "MTLAllocation": "MTLAllocation",
    "MTLArgumentEncoder": "MTLArgumentEncoder",
    "MTLBinaryArchive": "MTLBinaryArchive",
    "MTLBinding": "MTLBinding",
    "MTLBlitCommandEncoder": "MTLBlitCommandEncoder",
    "MTLBuffer": "MTLBuffer",
    "MTLBufferBinding": "MTLBufferBinding",
    "MTLCaptureScopeProtocol": "MTLCaptureScope",
    "MTLCommandBuffer": "MTLCommandBuffer",
    "MTLCommandBufferEncoderInfo": "MTLCommandBufferEncoderInfo",
    "MTLCommandEncoder": "MTLCommandEncoder",
    "MTLCommandQueue": "MTLCommandQueue",
    "MTLComputeCommandEncoder": "MTLComputeCommandEncoder",
    "MTLComputePipelineState": "MTLComputePipelineState",
    "MTLCounter": "MTLCounter",
    "MTLCounterSampleBuffer": "MTLCounterSampleBuffer",
    "MTLCounterSet": "MTLCounterSet",
    "MTLDepthStencilState": "MTLDepthStencilState",
    "MTLDevice": "MTLDevice",
    "MTLDrawable": "MTLDrawable",
    "MTLDynamicLibrary": "MTLDynamicLibrary",
    "MTLEvent": "MTLEvent",
    "MTLFence": "MTLFence",
    "MTLFunction": "MTLFunction",
    "MTLFunctionHandle": "MTLFunctionHandle",
    "MTLFunctionLog": "MTLFunctionLog",
    "MTLFunctionLogDebugLocation": "MTLFunctionLogDebugLocation",
    "MTLFunctionStitchingAttribute": "MTLFunctionStitchingAttribute",
    "MTLFunctionStitchingNode": "MTLFunctionStitchingNode",
    "MTLHeap": "MTLHeap",
    "MTLIOCommandBuffer": "MTLIOCommandBuffer",
    "MTLIOCommandQueue": "MTLIOCommandQueue",
    "MTLIOFileHandle": "MTLIOFileHandle",
    "MTLIOScratchBuffer": "MTLIOScratchBuffer",
    "MTLIOScratchBufferAllocator": "MTLIOScratchBufferAllocator",
    "MTLIndirectCommandBuffer": "MTLIndirectCommandBuffer",
    "MTLIndirectComputeCommand": "MTLIndirectComputeCommand",
    "MTLIndirectRenderCommand": "MTLIndirectRenderCommand",
    "MTLIntersectionFunctionTable": "MTLIntersectionFunctionTable",
    "MTLLibrary": "MTLLibrary",
    "MTLLogContainer": "MTLLogContainer",
    "MTLLogState": "MTLLogState",
    "MTLObjectPayloadBinding": "MTLObjectPayloadBinding",
    "MTLParallelRenderCommandEncoder": "MTLParallelRenderCommandEncoder",
    "MTLRasterizationRateMap": "MTLRasterizationRateMap",
    "MTLRenderCommandEncoder": "MTLRenderCommandEncoder",
    "MTLRenderPipelineState": "MTLRenderPipelineState",
    "MTLResidencySet": "MTLResidencySet",
    "MTLResource": "MTLResource",
    "MTLResourceStateCommandEncoder": "MTLResourceStateCommandEncoder",
    "MTLResourceViewPool": "MTLResourceViewPool",
    "MTLSamplerState": "MTLSamplerState",
    "MTLSharedEvent": "MTLSharedEvent",
    "MTLTensor": "MTLTensor",
    "MTLTensorAuxiliaryPlane": "MTLTensorAuxiliaryPlane",
    "MTLTensorBinding": "MTLTensorBinding",
    "MTLTexture": "MTLTexture",
    "MTLTextureBinding": "MTLTextureBinding",
    "MTLTextureViewPool": "MTLTextureViewPool",
    "MTLThreadgroupBinding": "MTLThreadgroupBinding",
    "MTLVisibleFunctionTable": "MTLVisibleFunctionTable",
}
