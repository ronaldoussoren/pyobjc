...
#
# Last update: Sun Nov 15 13:01:13 2020
#
# flake8: noqa
...
try:
    r(b'MTLAccelerationStructureGeometryDescriptor', b'allowDuplicateIntersectionFunctionInvocation', {'retval': {'type': b'Z'}})
    r(b'MTLAccelerationStructureGeometryDescriptor', b'opaque', {'retval': {'type': b'Z'}})
    r(b'MTLAccelerationStructureGeometryDescriptor', b'setAllowDuplicateIntersectionFunctionInvocation:', {'arguments': {2: {'type': b'Z'}}})
    r(b'MTLAccelerationStructureGeometryDescriptor', b'setOpaque:', {'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'MTLCommandBufferDescriptor', b'setRetainedReferences:', {'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'MTLCompileOptions', b'setPreserveInvariance:', {'arguments': {2: {'type': b'Z'}}})
    r(b'MTLComputePipelineDescriptor', b'setSupportAddingBinaryFunctions:', {'arguments': {2: {'type': b'Z'}}})
    r(b'MTLComputePipelineDescriptor', b'setSupportIndirectCommandBuffers:', {'arguments': {2: {'type': b'Z'}}})
    r(b'MTLComputePipelineDescriptor', b'setThreadGroupSizeIsMultipleOfThreadExecutionWidth:', {'arguments': {2: {'type': b'Z'}}})
    r(b'MTLComputePipelineDescriptor', b'supportAddingBinaryFunctions', {'retval': {'type': b'Z'}})
    r(b'MTLComputePipelineDescriptor', b'supportIndirectCommandBuffers', {'retval': {'type': b'Z'}})
    ...
    r(b'MTLTileRenderPipelineDescriptor', b'setThreadgroupSizeMatchesTileSize:', {'arguments': {2: {'type': b'Z'}}})
    r(b'MTLTileRenderPipelineDescriptor', b'threadgroupSizeMatchesTileSize', {'retval': {'type': b'Z'}})
    ...
    r(b'NSObject', b'accelerationStructureCommandEncoder', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'accelerationStructureSizesWithDescriptor:', {'required': True, 'retval': {'type': b'{_MTLAccelerationStructureSizes=QQQ}'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'addComputePipelineFunctionsWithDescriptor:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@', 'type_modifier': b'o'}}})
    ...
    r(b'NSObject', b'addRenderPipelineFunctionsWithDescriptor:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@', 'type_modifier': b'o'}}})
    ...
    r(b'NSObject', b'addTileRenderPipelineFunctionsWithDescriptor:error:', {'required': True, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': '^@', 'type_modifier': b'o'}}})
    ...
    r(b'NSObject', b'blitCommandEncoderWithDescriptor:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'buildAccelerationStructure:descriptor:scratchBuffer:scratchBufferOffset:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'commandBufferWithDescriptor:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'computeCommandEncoderWithDescriptor:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'computeCommandEncoderWithDispatchType:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'Q'}}})
    r(b'NSObject', b'concurrentDispatchThreadgroups:threadsPerThreadgroup:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': 'q'}, 3: {'type': 'q'}}})
    r(b'NSObject', b'concurrentDispatchThreads:threadsPerThreadgroup:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': 'q'}, 3: {'type': 'q'}}})
    ...
    r(b'NSObject', b'convertSparsePixelRegions:toTileRegions:withTileSize:alignmentMode:numRegions:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': '^{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}', 'type_modifier': b'n', 'c_array_length_in_arg': 6}, 3: {'type': '^{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}', 'type_modifier': b'n', 'c_array_length_in_arg': 6}, 4: {'type': '{_MTLSize=QQQ}'}, 5: {'type': 'Q'}, 6: {'type': 'Q'}}})
    r(b'NSObject', b'convertSparseTileRegions:toPixelRegions:withTileSize:numRegions:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': '^{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}', 'type_modifier': b'n', 'c_array_length_in_arg': 5}, 3: {'type': '^{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}', 'type_modifier': b'n', 'c_array_length_in_arg': 5}, 4: {'type': '{_MTLSize=QQQ}'}, 5: {'type': 'Q'}}})
    r(b'NSObject', b'copyAccelerationStructure:toAccelerationStructure:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'copyAndCompactAccelerationStructure:toAccelerationStructure:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    ...
    r(b'NSObject', b'dispatchThreadsPerTile:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': '{_MTLSize=QQQ}'}}})
    ...
    r(b'NSObject', b'executeCommandsInBuffer:inDirectBuffer:indirectBufferOffset:', {'arguments': {4: {'type': 'Q'}}})
    ...
    r(b'NSObject', b'functionHandleWithFunction:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'getTextureAccessCounters:region:mipLevel:slice:resetCounters:countersBuffer:countersBufferOffset:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': '{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}'}, 4: {'type': 'Q'}, 5: {'type': 'Q'}, 6: {'type': 'Z'}, 7: {'type': b'@'}, 8: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'imageblockMemoryLengthForDimensions:', {'required': True, 'retval': {'type': 'q'}, 'arguments': {2: {'type': '{_MTLSize=QQQ}'}}})
    r(b'NSObject', b'imageblockSampleLength', {'required': True, 'retval': {'type': 'q'}})
    r(b'NSObject', b'indirectComputeCommandAtIndex:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'newAccelerationStructureWithDescriptor:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'newAccelerationStructureWithSize:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'newBinaryArchiveWithDescriptor:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@', 'type_modifier': b'o'}}})
    ...
    r(b'NSObject', b'newComputePipelineStateWithAdditionalBinaryFunctions:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@', 'type_modifier': b'o'}}})
    ...
    r(b'NSObject', b'newDynamicLibrary:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'newDynamicLibraryWithURL:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'newEvent', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'newFence', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'newFunctionWithDescriptor:completionHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}, 'type': b'@?'}}})
    r(b'NSObject', b'newFunctionWithDescriptor:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@', 'type_modifier': b'o'}}})
    ...
    r(b'NSObject', b'newIntersectionFunctionTableWithDescriptor:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'newIntersectionFunctionWithDescriptor:completionHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}, 'type': b'@?'}}})
    r(b'NSObject', b'newIntersectionFunctionWithDescriptor:error:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@', 'type_modifier': b'o'}}})
    ...
    r(b'NSObject', b'newRenderPipelineStateWithTileDescriptor:options:completionHandler:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'Q'}, 4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}, 'type': '@?'}}})
    r(b'NSObject', b'newRenderPipelineStateWithTileDescriptor:options:reflection:error:', {'required': True, 'retval': {'type': 'q'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'Q'}, 4: {'type': b'^@'}, 5: {'type': '^@', 'type_modifier': b'o'}}})
    ...
    r(b'NSObject', b'newVisibleFunctionTableWithDescriptor:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'refitAccelerationStructure:descriptor:destination:scratchBuffer:scratchBufferOffset:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}, 6: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'resetTextureAccessCounters:region:mipLevel:slice:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': '{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}'}, 4: {'type': 'Q'}, 5: {'type': 'Q'}}})
    ...
    r(b'NSObject', b'resourceStateCommandEncoder', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'resourceStateCommandEncoderWithDescriptor:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'serializeToURL:error:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'setAccelerationStructure:atBufferIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}}})
    r(b'NSObject', b'setAccelerationStructure:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}}})
    ...
    r(b'NSObject', b'setComputePipelineState:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}}})
    r(b'NSObject', b'setComputePipelineStates:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@'}, 3: {'type': b'{_NSRange=QQ}'}}})
    ...
    r(b'NSObject', b'setFunction:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}}})
    r(b'NSObject', b'setFunctions:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 3: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'setImageblockWidth:height:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': 'q'}, 3: {'type': 'q'}}})
    ...
    r(b'NSObject', b'setIntersectionFunctionTable:atBufferIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}}})
    r(b'NSObject', b'setIntersectionFunctionTable:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}}})
    r(b'NSObject', b'setIntersectionFunctionTables:withBufferRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 3: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'setIntersectionFunctionTables:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 3: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'setKernelBuffer:offset:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'q'}, 4: {'type': 'Q'}}})
    r(b'NSObject', b'setLabel:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'setOpaqueTriangleIntersectionFunctionWithSignature:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'Q'}, 3: {'type': b'Q'}}})
    r(b'NSObject', b'setOpaqueTriangleIntersectionFunctionWithSignature:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'Q'}, 3: {'type': b'{_NSRange=QQ}'}}})
    ...
    r(b'NSObject', b'setThreadgroupMemoryLength:offset:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': 'Q'}, 3: {'type': 'Q'}, 4: {'type': 'Q'}}})
    r(b'NSObject', b'setTileBuffer:offset:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'Q'}, 4: {'type': 'Q'}}})
    r(b'NSObject', b'setTileBufferOffset:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': 'Q'}, 3: {'type': 'Q'}}})
    r(b'NSObject', b'setTileBuffers:offsets:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': '^@', 'type_modifier': b'n', 'c_array_length_in_arg': 4}, 3: {'type': '^Q', 'type_modifier': b'n', 'c_array_length_in_arg': 4}, 4: {'type': '{_NSRange=QQ}'}}})
    r(b'NSObject', b'setTileBytes:length:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 3: {'type': 'Q'}, 4: {'type': 'Q'}}})
    r(b'NSObject', b'setTileSamplerState:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'Q'}, 4: {'type': 'Q'}}})
    r(b'NSObject', b'setTileSamplerState:lodMinClamp:lodMaxClamp:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'Q'}, 4: {'type': 'Q'}, 5: {'type': 'Q'}}})
    r(b'NSObject', b'setTileSamplerStates:lodMinClamps:lodMaxClamps:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': '^@', 'type_modifier': b'n', 'c_array_length_in_arg': 5}, 3: {'type': '^Q', 'type_modifier': b'n', 'c_array_length_in_arg': 5}, 4: {'type': '^Q', 'type_modifier': b'n', 'c_array_length_in_arg': 5}, 5: {'type': '{_NSRange=QQ}'}}})
    r(b'NSObject', b'setTileSamplerStates:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': '^@', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 3: {'type': '{_NSRange=QQ}'}}})
    r(b'NSObject', b'setTileTexture:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'Q'}}})
    r(b'NSObject', b'setTileTextures:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': '^@', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 3: {'type': '{_NSRange=QQ}'}}})
    ...
    r(b'NSObject', b'setVisibleFunctionTable:atBufferIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}}})
    r(b'NSObject', b'setVisibleFunctionTable:atIndex:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}}})
    r(b'NSObject', b'setVisibleFunctionTables:withBufferRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 3: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'setVisibleFunctionTables:withRange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^@', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 3: {'type': b'{_NSRange=QQ}'}}})
    r(b'NSObject', b'signaledValue', {'required': True, 'retval': {'type': b'Q'}})
    r(b'NSObject', b'size', {'required': True, 'retval': {'type': b'Q'}})
    r(b'NSObject', b'sparseTileSizeInBytes', {'required': True, 'retval': {'type': 'Q'}})
    r(b'NSObject', b'sparseTileSizeWithTextureType:pixelFormat:sampleCount:', {'required': True, 'retval': {'type': b'{_MTLSize=QQQ}'}, 'arguments': {2: {'type': 'Q'}, 3: {'type': 'Q'}, 4: {'type': 'Q'}}})
    r(b'NSObject', b'sparseTileSizeWithTextureType_pixelFormat:sampleCount:', {'arguments': {2: {'type': 'Q'}, 3: {'type': 'Q'}, 4: {'type': 'Q'}}})
    ...
    r(b'NSObject', b'supports32BitFloatFiltering', {'required': True, 'retval': {'type': 'Z'}})
    r(b'NSObject', b'supports32BitMSAA', {'required': True, 'retval': {'type': 'Z'}})
    r(b'NSObject', b'supportsBCTextureCompression', {'required': True, 'retval': {'type': 'Z'}})
    r(b'NSObject', b'supportsCounterSampling:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'Q'}}})
    r(b'NSObject', b'supportsDynamicLibraries', {'required': True, 'retval': {'type': b'Z'}})
    ...
    r(b'NSObject', b'supportsFunctionPointers', {'required': True, 'retval': {'type': b'Z'}})
    r(b'NSObject', b'supportsPullModelInterpolation', {'required': True, 'retval': {'type': b'Z'}})
    r(b'NSObject', b'supportsQueryTextureLOD', {'required': True, 'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'threadgroupSizeMatchesTileSize', {'required': True, 'retval': {'type': 'Z'}})
    ...
    r(b'NSObject', b'updateFence:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'updateFence:afterStages:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Q'}}})
    r(b'NSObject', b'updateTextureMapping:mode:indirectBuffer:indirectBufferOffset:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'Q'}, 4: {'type': b'@'}, 5: {'type': 'Q'}}})
    r(b'NSObject', b'updateTextureMapping:mode:region:mipLevel:slice:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'Q'}, 4: {'type': '{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}'}, 5: {'type': 'Q'}, 6: {'type': 'Q'}}})
    r(b'NSObject', b'updateTextureMappings:mode:regions:mipLevels:slices:numRegions:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'Q'}, 4: {'type': '^{_MTLRegion={_MTLOrigin=QQQ}{_MTLSize=QQQ}}', 'type_modifier': b'n', 'c_array_length_in_arg': 7}, 5: {'type': '^Q', 'type_modifier': b'n', 'c_array_length_in_arg': 7}, 6: {'type': '^Q', 'type_modifier': b'n', 'c_array_length_in_arg': 7}, 7: {'type': 'Q'}}})
    ...
    r(b'NSObject', b'writeCompactedAccelerationStructureSize:toBuffer:offset:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'Q'}}})
finally:
