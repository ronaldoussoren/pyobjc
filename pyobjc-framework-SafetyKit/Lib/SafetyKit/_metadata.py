...
objc.registerNewKeywordsFromSelector("SACrashDetectionEvent", b"init")
expressions = {}
formal_protocols = {
    "SACrashDetectionDelegate": "SACrashDetectionDelegate",
    "SAEmergencyResponseDelegate": "SAEmergencyResponseDelegate",
}
