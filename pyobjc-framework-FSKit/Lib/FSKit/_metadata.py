...
#
# Last update: Sun Mar  2 20:23:07 2025
#
# flake8: noqa
...
try:
    ...
    r(
        b"NSObject",
        b"activateWithParameters:replyHandler:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {
    ...
    r(
        b"NSObject",
        b"mountWithParameters:replyHandler:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {
