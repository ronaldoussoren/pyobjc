...
class TestCVPixelBuffer(TestCase):
    def testConstants(self):
        ...
        self.assertEqual(
            kCVPixelFormatType_420YpCbCr10BiPlanarVideoRange, fourcc(b"x420")
        )
        self.assertEqual(
            kCVPixelFormatType_422YpCbCr10BiPlanarVideoRange, fourcc(b"x422")
        )
        self.assertEqual(
    ...
    def testConstants10_6(self):
        ...
        self.assertIsInstance(
            kCVPixelBufferIOSurfaceOpenGLTextureCompatibilityKey, unicode
        )
        self.assertIsInstance(kCVPixelBufferIOSurfaceOpenGLFBOCompatibilityKey, unicode)
        self.assertIsInstance(
            kCVPixelBufferIOSurfaceCoreAnimationCompatibilityKey, unicode
        )
