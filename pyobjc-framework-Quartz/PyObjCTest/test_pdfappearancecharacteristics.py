...
class TestPDFAppearanceCharacteristic(TestCase):
    ...
    def testConstants(self):
        self.assertIsInstance(Quartz.PDFAppearanceCharacteristicsKeyBackgroundColor, str)
        ...
        self.assertIsInstance(Quartz.PDFAppearanceCharacteristicsKeyRolloverCaption, str)
