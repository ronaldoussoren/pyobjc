...
class TestIKPictureTaker(TestCase):
    ...
    def testMethods(self):
        self.assertArgIsSEL(
            IKPictureTaker.beginPictureTakerWithDelegate_didEndSelector_contextInfo_,
            1,
            b"v@:@" + objc._C_NSInteger + b"^v",
        )
        self.assertArgIsSEL(
            IKPictureTaker.beginPictureTakerSheetForWindow_withDelegate_didEndSelector_contextInfo_,
            2,
            b"v@:@" + objc._C_NSInteger + b"^v",
        )
        self.assertArgIsSEL(
            IKPictureTaker.popUpRecentsMenuForView_withDelegate_didEndSelector_contextInfo_,
            2,
            b"v@:@" + objc._C_NSInteger + b"^v",
        )
