...
from Quartz import CGAffineTransform, CGPoint, CGRect
...
class TestCIFilterBuiltins(TestCase):
    ...
    def test_methods(self):
        ...
        with self.subTest("CIFourCoordinateGeometryFilter"):
            ...
            self.assert_rw_prop(
                TestCIBuiltinFilterHelper, "bottomRight", CGPoint.__typestr__
            )
            self.assert_rw_prop(
                TestCIBuiltinFilterHelper, "bottomLeft", CGPoint.__typestr__
            )
        ...
        with self.subTest("CIDisintegrateWithMaskTransition"):
            ...
            self.assert_rw_prop(
                TestCIBuiltinFilterHelper, "shadowOffset", CGPoint.__typestr__
            )
        ...
        with self.subTest("CIPageCurlWithShadowTransition"):
            ...
            self.assert_rw_prop(
                TestCIBuiltinFilterHelper, "shadowExtent", CGRect.__typestr__
            )
        ...
        with self.subTest("CIAffineClamp"):
            self.assert_rw_prop(
                TestCIBuiltinFilterHelper, "transform", CGAffineTransform.__typestr__
            )
