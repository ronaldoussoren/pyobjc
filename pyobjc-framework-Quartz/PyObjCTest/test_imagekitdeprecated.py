...
class TestImageKitDeprecated(TestCase):
    ...
    def testMethods(self):
        self.assertArgIsSEL(
            IKImagePicker.beginImagePickerWithDelegate_didEndSelector_contextInfo_,
            1,
            b"v@:@" + objc._C_NSUInteger + b"^v",
        )
        self.assertArgIsSEL(
            IKImagePicker.beginImagePickerSheetForWindow_withDelegate_didEndSelector_contextInfo_,
            2,
            b"v@:@" + objc._C_NSUInteger + b"^v",
        )
