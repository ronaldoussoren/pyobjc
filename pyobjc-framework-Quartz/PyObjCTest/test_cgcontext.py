...
class TestCGContext(TestCase):
    ...
    def testFunctions10_5(self):
        ...
        try:
            ...
            gradient = CGGradientCreateWithColorComponents(
                CGColorSpaceCreateDeviceGray(), (0.25, 0.8), (0.95, 0.99), 2
            )
            ...
            shading = CGShadingCreateAxial(
                CGColorSpaceCreateDeviceGray(), (0, 0), (30, 90), func, False, False
            )
            self.assertIsInstance(shading, CGShadingRef)

            self.assertArgHasType(
                CGContextSetShouldSubpixelPositionFonts, 1, objc._C_BOOL
            )
            self.assertArgHasType(
                CGContextSetAllowsFontSubpixelPositioning, 1, objc._C_BOOL
            )
            self.assertArgHasType(
                CGContextSetShouldSubpixelQuantizeFonts, 1, objc._C_BOOL
            )
            ...
            CGContextDrawLinearGradient(
                context, gradient, (0, 10), (50, 60), kCGGradientDrawsAfterEndLocation
            )
    ...
    def testFunctions(self):
        ...
        try:
            ...
            self.assertRaises(
                ValueError, CGContextSetLineDash, context, 0.5, [0.4, 0.2, 0.8, 0.1], 8
            )
            ...
            CGContextAddLines(context, [(0, 10), (50, 7), (50, 90), (90.5, 8)], 4)
            self.assertRaises(
                ValueError,
                CGContextAddLines,
                context,
            ...
            self.assertIsInstance(
                CGContextPathContainsPoint(context, pt, kCGPathStroke), bool
            )
            ...
            self.assertArgHasType(
                CGContextSetAllowsFontSubpixelQuantization, 1, objc._C_BOOL
            )
    ...
    def testGlyphFunctions(self):
        ...
        self.assertArgHasType(
            CGContextShowGlyphsAtPositions, 2, b"n^" + CGPoint.__typestr__
        )
        ...
        self.assertArgHasType(
            CGContextShowGlyphsWithAdvances, 2, b"n^" + CGSize.__typestr__
        )
