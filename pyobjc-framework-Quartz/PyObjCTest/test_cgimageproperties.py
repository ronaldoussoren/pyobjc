...
class TestCGImageProperties (TestCase):
    ...
    def testConstants10_13_4(self):
        self.assertIsInstane(kCGImagePropertyIPTCExtAboutCvTerm, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtAboutCvTermCvId, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtAboutCvTermId, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtAboutCvTermName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtAboutCvTermRefinedAbout, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtAddlModelInfo, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkOrObject, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkCircaDateCreated, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkContentDescription, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkContributionDescription, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkCopyrightNotice, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkCreator, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkCreatorID, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkCopyrightOwnerID, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkCopyrightOwnerName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkLicensorID, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkLicensorName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkDateCreated, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkPhysicalDescription, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkSource, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkSourceInventoryNo, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkSourceInvURL, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkStylePeriod, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtArtworkTitle, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtAudioBitrate, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtAudioBitrateMode, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtAudioChannelCount, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtCircaDateCreated, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtContainerFormat, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtContainerFormatIdentifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtContainerFormatName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtContributor, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtContributorIdentifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtContributorName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtContributorRole, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtCopyrightYear, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtCreator, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtCreatorIdentifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtCreatorName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtCreatorRole, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtControlledVocabularyTerm, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDataOnScreen, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDataOnScreenRegion, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDataOnScreenRegionD, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDataOnScreenRegionH, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDataOnScreenRegionText, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDataOnScreenRegionUnit, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDataOnScreenRegionW, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDataOnScreenRegionX, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDataOnScreenRegionY, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDigitalImageGUID, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDigitalSourceFileType, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDigitalSourceType, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDopesheet, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDopesheetLink, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDopesheetLinkLink, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtDopesheetLinkLinkQualifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtEmbdEncRightsExpr, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtEmbeddedEncodedRightsExpr, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtEmbeddedEncodedRightsExprType, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtEmbeddedEncodedRightsExprLangID, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtEpisode, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtEpisodeIdentifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtEpisodeName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtEpisodeNumber, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtEvent, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtShownEvent, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtShownEventIdentifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtShownEventName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtExternalMetadataLink, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtFeedIdentifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtGenre, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtGenreCvId, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtGenreCvTermId, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtGenreCvTermName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtGenreCvTermRefinedAbout, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtHeadline, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtIPTCLastEdited, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLinkedEncRightsExpr, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLinkedEncodedRightsExpr, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLinkedEncodedRightsExprType, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLinkedEncodedRightsExprLangID, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLocationCreated, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLocationCity, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLocationCountryCode, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLocationCountryName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLocationGPSAltitude, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLocationGPSLatitude, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLocationGPSLongitude, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLocationIdentifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLocationLocationId, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLocationLocationName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLocationProvinceState, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLocationSublocation, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLocationWorldRegion, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtLocationShown, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtMaxAvailHeight, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtMaxAvailWidth, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtModelAge, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtOrganisationInImageCode, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtOrganisationInImageName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPersonHeard, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPersonHeardIdentifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPersonHeardName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPersonInImage, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPersonInImageWDetails, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPersonInImageCharacteristic, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPersonInImageCvTermCvId, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPersonInImageCvTermId, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPersonInImageCvTermName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPersonInImageCvTermRefinedAbout, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPersonInImageDescription, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPersonInImageId, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPersonInImageName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtProductInImage, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtProductInImageDescription, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtProductInImageGTIN, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtProductInImageName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPublicationEvent, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPublicationEventDate, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPublicationEventIdentifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtPublicationEventName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRating, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingRatingRegion, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingRegionCity, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingRegionCountryCode, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingRegionCountryName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingRegionGPSAltitude, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingRegionGPSLatitude, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingRegionGPSLongitude, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingRegionIdentifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingRegionLocationId, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingRegionLocationName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingRegionProvinceState, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingRegionSublocation, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingRegionWorldRegion, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingScaleMaxValue, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingScaleMinValue, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingSourceLink, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingValue, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRatingValueLogoLink, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRegistryID, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRegistryEntryRole, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRegistryItemID, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtRegistryOrganisationID, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtReleaseReady, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtSeason, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtSeasonIdentifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtSeasonName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtSeasonNumber, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtSeries, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtSeriesIdentifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtSeriesName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtStorylineIdentifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtStreamReady, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtStylePeriod, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtSupplyChainSource, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtSupplyChainSourceIdentifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtSupplyChainSourceName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtTemporalCoverage, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtTemporalCoverageFrom, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtTemporalCoverageTo, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtTranscript, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtTranscriptLink, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtTranscriptLinkLink, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtTranscriptLinkLinkQualifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtVideoBitrate, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtVideoBitrateMode, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtVideoDisplayAspectRatio, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtVideoEncodingProfile, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtVideoShotType, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtVideoShotTypeIdentifier, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtVideoShotTypeName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtVideoStreamsCount, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtVisualColor, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtWorkflowTag, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtWorkflowTagCvId, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtWorkflowTagCvTermId, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtWorkflowTagCvTermName, unicode)
        self.assertIsInstane(kCGImagePropertyIPTCExtWorkflowTagCvTermRefinedAbout, unicode)
