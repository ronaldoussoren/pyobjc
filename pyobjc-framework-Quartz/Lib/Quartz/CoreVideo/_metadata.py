...
#
# Last update: Tue Jun 11 10:17:45 2024
#
# flake8: noqa
...
functions = {
    ...
    "CVMetalBufferCacheGetTypeID": (b"Q",),
...
cftypes = [
    ...
    ("CVMetalBufferCacheRef", b"^{__CVMetalBufferCache=}", None, None),
