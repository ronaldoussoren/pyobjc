...
#
# Last update: Thu Jun  9 22:17:43 2022
#
# flake8: noqa
...
misc.update(
    {
        ...
        "CGAffineTransform": objc.createStructType(
            "Quartz.CoreGraphics.CGAffineTransform",
        ...
        "CGVector": objc.createStructType(
            "Quartz.CoreGraphics.CGVector", b"{CGVector=dd}", ["dx", "dy"]
        ),
...
functions = {
    ...
    "CGPathIntersectsPathUsingEvenOdd": (b"B^{CGPath=}^{CGPath=}B",),
