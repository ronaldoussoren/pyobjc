...
#
# Last update: Fri Aug 14 15:04:32 2026
#
# flake8: noqa
...
functions = {
    "CGPDFStructureElementRelease": (b"v^{CGPDFStructureElement=}",),
    ...
    "CGPatternCreate": (
        b"^{CGPattern=}^v{CGRect={CGPoint=dd}{CGSize=dd}}{CGAffineTransform=dddddd}ddiB@",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CGPDFStructureElementSetTitle": (b"v^{CGPDFStructureElement=}^{__CFString=}",),
    ...
    "CGPDFStructureElementAddMarkedContentItem": (
        b"i^{CGPDFStructureElement=}^{CGPDFMarkedContentItem=}",
    ),
    ...
    "CGPDFMarkedContentItemRelease": (b"v^{CGPDFMarkedContentItem=}",),
    ...
    "CGPDFStructureElementSetAlternativeText": (
        b"v^{CGPDFStructureElement=}^{__CFString=}",
    ),
    ...
    "CGPDFStructureElementAddStructureElement": (
        b"i^{CGPDFStructureElement=}^{CGPDFStructureElement=}",
    ),
    ...
    "CGPSConverterCreate": (
        b"^{CGPSConverter=}^v@^{__CFDictionary=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CGSetDisplayTransferByByteTable": (
        ...
        "",
        {
            "arguments": {
                ...
                3: {"type_modifier": "n", "c_array_length_in_arg": 1},
                4: {"type_modifier": "n", "c_array_length_in_arg": 1},
            }
        },
    ),
    ...
    "CGPDFContextEndObjectReference": (b"v^{CGContext=}",),
    ...
    "CGPDFContextBeginNonStructuralMarkedContentSequence": (b"v^{CGContext=}i",),
    ...
    "CGPDFContextBeginMarkedContentSequence": (
        b"^{CGPDFMarkedContentItem=}^{CGContext=}i",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CGPDFStructureElementRetain": (
        b"^{CGPDFStructureElement=}^{CGPDFStructureElement=}",
    ),
    ...
    "CGWaitForScreenUpdateRects": (
        ...
        "",
        {
            ...
            "suggestion": "function is not functional since macOS 10.8",
        },
    ),
    ...
    "CGPDFMarkedContentItemRetain": (
        b"^{CGPDFMarkedContentItem=}^{CGPDFMarkedContentItem=}",
    ),
    ...
    "CGContextShowTextAtPoint": (
        b"v^{CGContext=}dd^tQ",
        "",
        {"arguments": {3: {"type_modifier": "n", "c_array_length_in_arg": 4}}},
    ),
    ...
    "CGPDFContextBeginObjectReference": (
        b"^{CGPDFMarkedContentItem=}^{CGContext=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
            ...
            "arguments": {
                1: {
                    "callable": {
                        ...
                        "arguments": {
                            0: {"type": b"^v"},
                            1: {"c_array_delimited_by_null": True, "type": b"n^t"},
                            2: {"type": b"^{CGPDFObject=}"},
                            3: {"type": b"^v"},
                        },
                    }
    ...
    "CGPDFContextAddStructureTreeRootChild": (
        b"i^{CGContext=}^{CGPDFStructureElement=}",
    ),
    ...
    "CGPDFContextEndMarkedContentSequence": (b"v^{CGContext=}",),
    ...
    "CGColorCreateWithPattern": (
        ...
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
                2: {"type_modifier": "n", "c_array_of_variable_length": True}
            },
        },
    ),
...
cftypes = [
    ...
    ("CGPDFStructureElementRef", b"^{^{CGPDFStructureElement=}", None, None),
    ...
    ("CGPDFMarkedContentItemRef", b"^{CGPDFMarkedContentItem=}", None, None),
