...
#
# Last update: Wed Aug  7 07:45:14 2019
...
misc.update(
    {
        ...
        "CGPoint": objc.createStructAlias(
            "CGPoint",
            sel32or64(b"{CGPoint=ff}", b"{CGPoint=dd}"),
            objc._resolve_name("Foundation.NSPoint"),
        ),
        ...
        "CGSize": objc.createStructAlias(
            "CGSize",
            sel32or64(b"{CGSize=ff}", b"{CGSize=dd}"),
            objc._resolve_name("Foundation.NSSize"),
        ),
        ...
        "CGAffineTransform": objc.createStructType(
            "CGAffineTransform",
            sel32or64(b"{CGAffineTransform=ffffff}", b"{CGAffineTransform=dddddd}"),
            ["a", "b", "c", "d", "tx", "ty"],
        ),
        ...
        "CGVector": objc.createStructType(
            "CGVector", sel32or64(b"{CGVector=ff}", b"{CGVector=dd}"), ["dx", "dy"]
        ),
        "CGPathElement": objc.createStructType(
            "CGPathElement",
            sel32or64(
                b"{CGPathElement=I^{CGPoint=ff}}", b"{CGPathElement=i^{CGPoint=dd}}"
            ),
            ["type", "points"],
        ),
...
functions = {
    ...
    "CGContextAddArcToPoint": (
        sel32or64(b"v^{CGContext=}fffff", b"v^{CGContext=}ddddd"),
    ),
    "CGRectIntersection": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}{CGRect={CGPoint=ff}{CGSize=ff}}{CGRect={CGPoint=ff}{CGSize=ff}}",
    ...
    "CGGradientGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "CGPDFPageGetDrawingTransform": (
        sel32or64(
            b"{CGAffineTransform=ffffff}^{CGPDFPage=}I{CGRect={CGPoint=ff}{CGSize=ff}}iB",
            b"{CGAffineTransform=dddddd}^{CGPDFPage=}i{CGRect={CGPoint=dd}{CGSize=dd}}iB",
        ),
    ),
    "CGFontCanCreatePostScriptSubset": (
        sel32or64(b"B^{CGFont=}I", b"B^{CGFont=}i"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CGContextSetStrokeColorSpace": (b"v^{CGContext=}^{CGColorSpace=}",),
    "CGContextPathContainsPoint": (
        sel32or64(b"B^{CGContext=}{CGPoint=ff}I", b"B^{CGContext=}{CGPoint=dd}i"),
    ),
    "CGAffineTransformRotate": (
        sel32or64(
            b"{CGAffineTransform=ffffff}{CGAffineTransform=ffffff}f",
    ...
    "CGPDFArrayGetStream": (
        sel32or64(
            b"B^{CGPDFArray=}L^^{CGPDFStream=}", b"B^{CGPDFArray=}Q^^{CGPDFStream=}"
        ),
        "",
        {"arguments": {2: {"type_modifier": "o"}}},
    ),
    "CGEventKeyboardSetUnicodeString": (
        sel32or64(b"v^{__CGEvent=}L^T", b"v^{__CGEvent=}Q^T"),
        "",
    ...
    "CGAffineTransformMake": (
        sel32or64(
            b"{CGAffineTransform=ffffff}ffffff", b"{CGAffineTransform=dddddd}dddddd"
        ),
    ),
    ...
    "CGContextAddLines": (
        sel32or64(b"v^{CGContext=}^{CGPoint=ff}L", b"v^{CGContext=}^{CGPoint=dd}Q"),
        "",
        {"arguments": {1: {"c_array_length_in_arg": 2, "type_modifier": "n"}}},
    ),
    "CGContextSetTextPosition": (sel32or64(b"v^{CGContext=}ff", b"v^{CGContext=}dd"),),
    "CGColorCreateSRGB": (
        b"^{CGColor=}dddd",
        "",
        {"retval": {"already_cfretained": True}},
    ...
    "CGContextGetTextPosition": (
        sel32or64(b"{CGPoint=ff}^{CGContext=}", b"{CGPoint=dd}^{CGContext=}"),
    ),
    "CGPDFPageGetRotationAngle": (b"i^{CGPDFPage=}",),
    "CGContextGetPathBoundingBox": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}^{CGContext=}",
            b"{CGRect={CGPoint=dd}{CGSize=dd}}^{CGContext=}",
        ),
    ),
    "CGRectContainsPoint": (
        sel32or64(
            b"B{CGRect={CGPoint=ff}{CGSize=ff}}{CGPoint=ff}",
            b"B{CGRect={CGPoint=dd}{CGSize=dd}}{CGPoint=dd}",
        ),
    ),
    "CGPDFDictionaryGetCount": (
        sel32or64(b"L^{CGPDFDictionary=}", b"Q^{CGPDFDictionary=}"),
    ),
    "CGRectMake": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}ffff",
    ...
    "CGPathCreateCopyByStrokingPath": (
        sel32or64(
            b"^{CGPath=}^{CGPath=}^{CGAffineTransform=ffffff}fIIf",
    ...
    "CGContextAddEllipseInRect": (
        sel32or64(
            b"v^{CGContext=}{CGRect={CGPoint=ff}{CGSize=ff}}",
            b"v^{CGContext=}{CGRect={CGPoint=dd}{CGSize=dd}}",
        ),
    ),
    "CGContextEndTransparencyLayer": (b"v^{CGContext=}",),
    "CGContextSelectFont": (
        sel32or64(b"v^{CGContext=}^cfI", b"v^{CGContext=}^cdi"),
        "",
        {"arguments": {1: {"c_array_delimited_by_null": True, "type_modifier": "n"}}},
    ),
    "CGLayerGetSize": (sel32or64(b"{CGSize=ff}^{CGLayer=}", b"{CGSize=dd}^{CGLayer=}"),),
    "CGWindowListCreate": (
        b"^{__CFArray=}II",
        "",
        {"retval": {"already_cfretained": True}},
    ...
    "CGSizeEqualToSize": (
        sel32or64(b"B{CGSize=ff}{CGSize=ff}", b"B{CGSize=dd}{CGSize=dd}"),
    ),
    ...
    "CGPathCreateMutable": (b"^{CGPath=}", "", {"retval": {"already_cfretained": True}}),
    "CGPatternCreate": (
        sel32or64(
            b"^{CGPattern=}^v{CGRect={CGPoint=ff}{CGSize=ff}}{CGAffineTransform=ffffff}ffIB^{CGPatternCallbacks=I^?^?}",
            b"^{CGPattern=}^v{CGRect={CGPoint=dd}{CGSize=dd}}{CGAffineTransform=dddddd}ddiB^{CGPatternCallbacks=I^?^?}",
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CGBitmapContextGetHeight": (sel32or64(b"L^{CGContext=}", b"Q^{CGContext=}"),),
    "CGPDFPageGetBoxRect": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}^{CGPDFPage=}I",
            b"{CGRect={CGPoint=dd}{CGSize=dd}}^{CGPDFPage=}i",
        ),
    ),
    "CGPDFStringCopyDate": (
    ...
    "CGDisplayStreamUpdateGetDropCount": (
        sel32or64(b"L^{CGDisplayStreamUpdate=}", b"Q^{CGDisplayStreamUpdate=}"),
    ),
    "CGDisplayBestModeForParametersAndRefreshRate": (
        sel32or64(b"^{__CFDictionary=}ILLLd^i", b"^{__CFDictionary=}IQQQd^I"),
        "",
    ...
    "CGPDFPageGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGContextAddRect": (
        sel32or64(
            b"v^{CGContext=}{CGRect={CGPoint=ff}{CGSize=ff}}",
            b"v^{CGContext=}{CGRect={CGPoint=dd}{CGSize=dd}}",
    ...
    "CGDisplayFade": (sel32or64(b"iIffffffi", b"iIffffffI"),),
    "CGPDFArrayGetObject": (
        sel32or64(b"B^{CGPDFArray=}L^{CGPDFObject=}", b"B^{CGPDFArray=}Q^{CGPDFObject=}"),
        "",
        {"arguments": {2: {"type_modifier": "o"}}},
    ),
    ...
    "CGColorGetComponents": (
        sel32or64(b"^f^{CGColor=}", b"^d^{CGColor=}"),
        "",
        {"retval": {"c_array_of_variable_length": True}},
    ),
    "CGPDFContextSetOutline": (b"v^{CGContext=}^{__CFDictionary=}",),
    "CGAffineTransformMakeTranslation": (
        sel32or64(b"{CGAffineTransform=ffffff}ff", b"{CGAffineTransform=dddddd}dd"),
    ),
    "CGSizeMake": (sel32or64(b"{CGSize=ff}ff", b"{CGSize=dd}dd"),),
    ...
    "CGDataProviderCreateWithData": (
        sel32or64(b"^{CGDataProvider=}^v^vL^?", b"^{CGDataProvider=}^v^vQ^?"),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "CGFontGetGlyphBBoxes": (
        sel32or64(
            b"B^{CGFont=}^SL^{CGRect={CGPoint=ff}{CGSize=ff}}",
    ...
    "CGAffineTransformMakeRotation": (
        sel32or64(b"{CGAffineTransform=ffffff}f", b"{CGAffineTransform=dddddd}d"),
    ),
    ...
    "CGDisplayCreateImageForRect": (
        sel32or64(
            b"^{CGImage=}I{CGRect={CGPoint=ff}{CGSize=ff}}",
            b"^{CGImage=}I{CGRect={CGPoint=dd}{CGSize=dd}}",
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CGImageGetWidth": (sel32or64(b"L^{CGImage=}", b"Q^{CGImage=}"),),
    "CGPDFDocumentIsUnlocked": (b"B^{CGPDFDocument=}",),
    "CGPathCreateWithRect": (
        sel32or64(
            b"^{CGPath=}{CGRect={CGPoint=ff}{CGSize=ff}}^{CGAffineTransform=ffffff}",
    ...
    "CGDisplayUsesOpenGLAcceleration": (sel32or64(b"iI", b"II"),),
    "CGPointMakeWithDictionaryRepresentation": (
        sel32or64(
            b"B^{__CFDictionary=}^{CGPoint=ff}", b"B^{__CFDictionary=}^{CGPoint=dd}"
        ),
        "",
        {"arguments": {1: {"type_modifier": "o"}}},
    ),
    ...
    "CGPathAddEllipseInRect": (
        sel32or64(
            b"v^{CGPath=}^{CGAffineTransform=ffffff}{CGRect={CGPoint=ff}{CGSize=ff}}",
    ...
    "CGColorSpaceGetColorTableCount": (
        sel32or64(b"L^{CGColorSpace=}", b"Q^{CGColorSpace=}"),
    ),
    "CGWindowListCreateImage": (
        sel32or64(
            b"^{CGImage=}{CGRect={CGPoint=ff}{CGSize=ff}}III",
    ...
    "CGPathAddQuadCurveToPoint": (
        sel32or64(
            b"v^{CGPath=}^{CGAffineTransform=ffffff}ffff",
    ...
    "CGRectIntersectsRect": (
        sel32or64(
            b"B{CGRect={CGPoint=ff}{CGSize=ff}}{CGRect={CGPoint=ff}{CGSize=ff}}",
    ...
    "CGImageGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGFontCreatePostScriptEncoding": (
        b"^{__CFData=}^{CGFont=}[256S]",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CGFontGetStemV": (sel32or64(b"f^{CGFont=}", b"d^{CGFont=}"),),
    "CGPointApplyAffineTransform": (
        sel32or64(
            b"{CGPoint=ff}{CGPoint=ff}{CGAffineTransform=ffffff}",
            b"{CGPoint=dd}{CGPoint=dd}{CGAffineTransform=dddddd}",
        ),
    ),
    "CGEventSourceGetSourceStateID": (
        sel32or64(b"I^{__CGEventSource=}", b"i^{__CGEventSource=}"),
    ),
    "CGRectStandardize": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}{CGRect={CGPoint=ff}{CGSize=ff}}",
            b"{CGRect={CGPoint=dd}{CGSize=dd}}{CGRect={CGPoint=dd}{CGSize=dd}}",
        ),
    ),
    "CGPathAddLineToPoint": (
        sel32or64(
            b"v^{CGPath=}^{CGAffineTransform=ffffff}ff",
    ...
    "CGColorCreateGenericGray": (
        sel32or64(b"^{CGColor=}ff", b"^{CGColor=}dd"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CGColorSpaceIsWideGamutRGB": (b"B^{CGColorSpace=}",),
    "CGPSConverterGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGColorRetain": (b"^{CGColor=}^{CGColor=}",),
    "CGColorCreateGenericCMYK": (
        sel32or64(b"^{CGColor=}fffff", b"^{CGColor=}ddddd"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CGGLContextCreate": (
        sel32or64(
            b"^{CGContext=}^v{CGSize=ff}^{CGColorSpace=}",
    ...
    "CGDisplayStreamGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGBitmapContextGetBitsPerPixel": (sel32or64(b"L^{CGContext=}", b"Q^{CGContext=}"),),
    ...
    "CGContextGetCTM": (
        sel32or64(
            b"{CGAffineTransform=ffffff}^{CGContext=}",
            b"{CGAffineTransform=dddddd}^{CGContext=}",
        ),
    ),
    "CGDisplayStreamUpdateGetRects": (
        sel32or64(
            b"^{CGRect={CGPoint=ff}{CGSize=ff}}^{CGDisplayStreamUpdate=}i^L",
    ...
    "CGPDFArrayGetName": (
        sel32or64(b"B^{CGPDFArray=}L^^c", b"B^{CGPDFArray=}Q^^c"),
        "",
        {"arguments": {2: {"type_modifier": "o"}}},
    ),
    "CGEventSourceGetPixelsPerLine": (b"d^{__CGEventSource=}",),
    "CGDisplayStreamUpdateGetMovedRectsDelta": (
        sel32or64(b"v^{CGDisplayStreamUpdate=}^f^f", b"v^{CGDisplayStreamUpdate=}^d^d"),
        "",
        {"arguments": {1: {"type_modifier": "o"}, 2: {"type_modifier": "o"}}},
    ),
    "CGRectGetHeight": (
        sel32or64(
            b"f{CGRect={CGPoint=ff}{CGSize=ff}}", b"d{CGRect={CGPoint=dd}{CGSize=dd}}"
        ),
    ),
    "CGEventSourceGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "CGDisplayIsOnline": (sel32or64(b"iI", b"II"),),
    "CGDisplayStreamCreate": (
        sel32or64(
            b"^{CGDisplayStream=}ILLi^{__CFDictionary=}@?",
    ...
    "CGContextShowGlyphsWithAdvances": (
        sel32or64(b"v^{CGContext=}^S^{CGSize=ff}L", b"v^{CGContext=}^S^{CGSize=dd}Q"),
        "",
        {
            "arguments": {
    ...
    "CGPDFArrayGetInteger": (
        sel32or64(b"B^{CGPDFArray=}L^l", b"B^{CGPDFArray=}Q^q"),
        "",
        {"arguments": {2: {"type_modifier": "o"}}},
    ),
    ...
    "CGBitmapContextCreate": (
        sel32or64(
            b"^{CGContext=}^vLLLL^{CGColorSpace=}I",
    ...
    "CGPathAddRelativeArc": (
        sel32or64(
            b"v^{CGPath=}^{CGAffineTransform=ffffff}fffff",
            b"v^{CGPath=}^{CGAffineTransform=dddddd}ddddd",
        ),
        "",
        {"arguments": {1: {"type_modifier": "n"}}},
    ),
    "CGDisplaySetStereoOperation": (sel32or64(b"iIiiI", b"iIIII"),),
    "CGPaletteIsEqualToPalette": (b"B^{_CGDirectPaletteRef=}^{_CGDirectPaletteRef=}",),
    "CGContextSetShouldAntialias": (b"v^{CGContext=}B",),
    "CGDisplayModeGetHeight": (sel32or64(b"L^{CGDisplayMode=}", b"Q^{CGDisplayMode=}"),),
    "CGContextSetFillColor": (
        sel32or64(b"v^{CGContext=}^f", b"v^{CGContext=}^d"),
        "",
        {"arguments": {1: {"c_array_of_variable_length": True, "type_modifier": "n"}}},
    ),
    "CGImageRelease": (b"v^{CGImage=}",),
    "CGInhibitLocalEvents": (sel32or64(b"ii", b"iI"),),
    "CGContextSetGrayFillColor": (sel32or64(b"v^{CGContext=}ff", b"v^{CGContext=}dd"),),
    ...
    "CGContextClipToMask": (
        sel32or64(
            b"v^{CGContext=}{CGRect={CGPoint=ff}{CGSize=ff}}^{CGImage=}",
    ...
    "CGContextAddLineToPoint": (sel32or64(b"v^{CGContext=}ff", b"v^{CGContext=}dd"),),
    "CGEventSourceGetLocalEventsSuppressionInterval": (b"d^{__CGEventSource=}",),
    "CGColorSpaceGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGPathAddPath": (
        sel32or64(
            b"v^{CGPath=}^{CGAffineTransform=ffffff}^{CGPath=}",
    ...
    "CGDisplayPixelsHigh": (sel32or64(b"LI", b"QI"),),
    "CGConfigureDisplayStereoOperation": (
        sel32or64(b"i^{_CGDisplayConfigRef=}Iii", b"i^{_CGDisplayConfigRef=}III"),
    ),
    "CGFontGetNumberOfGlyphs": (sel32or64(b"L^{CGFont=}", b"Q^{CGFont=}"),),
    ...
    "CGPDFContextAddDestinationAtPoint": (
        sel32or64(
            b"v^{CGContext=}^{__CFString=}{CGPoint=ff}",
            b"v^{CGContext=}^{__CFString=}{CGPoint=dd}",
        ),
    ),
    ...
    "CGColorCreateWithPattern": (
        sel32or64(
            b"^{CGColor=}^{CGColorSpace=}^{CGPattern=}^f",
    ...
    "CGPathContainsPoint": (
        sel32or64(
            b"B^{CGPath=}^{CGAffineTransform=ffffff}{CGPoint=ff}B",
    ...
    "CGSizeApplyAffineTransform": (
        sel32or64(
            b"{CGSize=ff}{CGSize=ff}{CGAffineTransform=ffffff}",
    ...
    "CGContextConcatCTM": (
        sel32or64(
            b"v^{CGContext=}{CGAffineTransform=ffffff}",
            b"v^{CGContext=}{CGAffineTransform=dddddd}",
        ),
    ),
    ...
    "CGWindowListCreateImageFromArray": (
        sel32or64(
            b"^{CGImage=}{CGRect={CGPoint=ff}{CGSize=ff}}^{__CFArray=}I",
    ...
    "CGDataProviderGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGPaletteCreateWithCapacity": (
        b"^{_CGDirectPaletteRef=}I",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CGDisplayBytesPerRow": (sel32or64(b"LI", b"QI"),),
    "CGSetLocalEventsSuppressionInterval": (b"id",),
    "CGPDFArrayGetCount": (sel32or64(b"L^{CGPDFArray=}", b"Q^{CGPDFArray=}"),),
    "CGPDFContextClose": (b"v^{CGContext=}",),
    "CGDisplayIsBuiltin": (sel32or64(b"iI", b"II"),),
    "CGContextIsPathEmpty": (b"B^{CGContext=}",),
    "CGContextSetShadow": (
        sel32or64(b"v^{CGContext=}{CGSize=ff}f", b"v^{CGContext=}{CGSize=dd}d"),
    ),
    "CGPathGetBoundingBox": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}^{CGPath=}",
            b"{CGRect={CGPoint=dd}{CGSize=dd}}^{CGPath=}",
        ),
    ),
    "CGColorGetNumberOfComponents": (sel32or64(b"L^{CGColor=}", b"Q^{CGColor=}"),),
    ...
    "CGContextShowGlyphsAtPoint": (
        sel32or64(b"v^{CGContext=}ff^SL", b"v^{CGContext=}dd^SQ"),
        "",
        {"arguments": {3: {"c_array_length_in_arg": 4, "type_modifier": "n"}}},
    ),
    "CGPathAddLines": (
        sel32or64(
            b"v^{CGPath=}^{CGAffineTransform=ffffff}^{CGPoint=ff}L",
    ...
    "CGColorCreateGenericRGB": (
        sel32or64(b"^{CGColor=}ffff", b"^{CGColor=}dddd"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CGContextScaleCTM": (sel32or64(b"v^{CGContext=}ff", b"v^{CGContext=}dd"),),
    "CGRectDivide": (
        sel32or64(
            b"v{CGRect={CGPoint=ff}{CGSize=ff}}^{CGRect={CGPoint=ff}{CGSize=ff}}^{CGRect={CGPoint=ff}{CGSize=ff}}fI",
            b"v{CGRect={CGPoint=dd}{CGSize=dd}}^{CGRect={CGPoint=dd}{CGSize=dd}}^{CGRect={CGPoint=dd}{CGSize=dd}}dI",
        ),
        "",
        {"arguments": {1: {"type_modifier": "o"}, 2: {"type_modifier": "o"}}},
    ),
    "CGContextSetLineCap": (sel32or64(b"v^{CGContext=}I", b"v^{CGContext=}i"),),
    "CGImageMaskCreate": (
        sel32or64(
            b"^{CGImage=}LLLLL^{CGDataProvider=}^fB",
    ...
    "CGContextDrawRadialGradient": (
        sel32or64(
            b"v^{CGContext=}^{CGGradient=}{CGPoint=ff}f{CGPoint=ff}fI",
    ...
    "CGEventSourceCreate": (
        sel32or64(b"^{__CGEventSource=}I", b"^{__CGEventSource=}i"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CGRectGetMidY": (
    ...
    "CGContextSetAlpha": (sel32or64(b"v^{CGContext=}f", b"v^{CGContext=}d"),),
    "CGContextAddQuadCurveToPoint": (
        sel32or64(b"v^{CGContext=}ffff", b"v^{CGContext=}dddd"),
    ),
    ...
    "CGPDFDocumentGetMediaBox": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}^{CGPDFDocument=}i",
    ...
    "CGAffineTransformIsIdentity": (
        sel32or64(b"B{CGAffineTransform=ffffff}", b"B{CGAffineTransform=dddddd}"),
    ),
    "CGContextGetInterpolationQuality": (
        sel32or64(b"I^{CGContext=}", b"i^{CGContext=}"),
    ),
    ...
    "CGContextRotateCTM": (sel32or64(b"v^{CGContext=}f", b"v^{CGContext=}d"),),
    "CGImageCreateCopy": (
        b"^{CGImage=}^{CGImage=}",
        "",
        {"retval": {"already_cfretained": True}},
    ...
    "CGImageGetDecode": (
        sel32or64(b"^f^{CGImage=}", b"^d^{CGImage=}"),
        "",
        {"retval": {"c_array_of_variable_length": True}},
    ),
    ...
    "CGColorGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "CGFontCreatePostScriptSubset": (
        sel32or64(
            b"^{__CFData=}^{CGFont=}^{__CFString=}I^SL[256S]",
            b"^{__CFData=}^{CGFont=}^{__CFString=}i^SQ[256S]",
        ),
        "",
        {
            "retval": {"already_cfretained": True},
    ...
    "CGPDFArrayGetString": (
        sel32or64(
            b"B^{CGPDFArray=}L^^{CGPDFString=}", b"B^{CGPDFArray=}Q^^{CGPDFString=}"
        ),
        "",
        {"arguments": {2: {"type_modifier": "o"}}},
    ),
    "CGPointMake": (sel32or64(b"{CGPoint=ff}ff", b"{CGPoint=dd}dd"),),
    ...
    "CGLayerCreateWithContext": (
        sel32or64(
            b"^{CGLayer=}^{CGContext=}{CGSize=ff}^{__CFDictionary=}",
    ...
    "CGPDFObjectGetType": (sel32or64(b"I^{CGPDFObject=}", b"i^{CGPDFObject=}"),),
    ...
    "CGWarpMouseCursorPosition": (sel32or64(b"i{CGPoint=ff}", b"i{CGPoint=dd}"),),
    "CGPathCreateWithRoundedRect": (
        sel32or64(
            b"^{CGPath=}{CGRect={CGPoint=ff}{CGSize=ff}}ff^{CGAffineTransform=ffffff}",
    ...
    "CGContextSetStrokePattern": (
        sel32or64(b"v^{CGContext=}^{CGPattern=}^f", b"v^{CGContext=}^{CGPattern=}^d"),
        "",
        {"arguments": {2: {"c_array_of_variable_length": True, "type_modifier": "n"}}},
    ),
    "CGDisplayCanSetPalette": (sel32or64(b"iI", b"II"),),
    "CGRectApplyAffineTransform": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}{CGRect={CGPoint=ff}{CGSize=ff}}{CGAffineTransform=ffffff}",
    ...
    "CGPDFContextCreate": (
        sel32or64(
            b"^{CGContext=}^{CGDataConsumer=}^{CGRect={CGPoint=ff}{CGSize=ff}}^{__CFDictionary=}",
    ...
    "CGImageCreateWithJPEGDataProvider": (
        sel32or64(
            b"^{CGImage=}^{CGDataProvider=}^fBI", b"^{CGImage=}^{CGDataProvider=}^dBi"
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CGVectorMake": (sel32or64(b"{CGVector=ff}ff", b"{CGVector=dd}dd"),),
    "CGDisplayIsActive": (sel32or64(b"iI", b"II"),),
    "CGPDFScannerScan": (b"B^{CGPDFScanner=}",),
    "CGPathCreateMutableCopyByTransformingPath": (
        sel32or64(
            b"^{CGPath=}^{CGPath=}^{CGAffineTransform=ffffff}",
    ...
    "CGImageGetRenderingIntent": (sel32or64(b"I^{CGImage=}", b"i^{CGImage=}"),),
    "CGGLContextUpdateViewportSize": (
        sel32or64(b"v^{CGContext=}{CGSize=ff}", b"v^{CGContext=}{CGSize=dd}"),
    ),
    "CGGetEventTapList": (
    ...
    "CGEnableEventStateCombining": (sel32or64(b"ii", b"iI"),),
    ...
    "CGDisplayIsCaptured": (sel32or64(b"iI", b"II"),),
    ...
    "CGRectIsEmpty": (
        sel32or64(
            b"B{CGRect={CGPoint=ff}{CGSize=ff}}", b"B{CGRect={CGPoint=dd}{CGSize=dd}}"
        ),
    ),
    "CGDisplayMoveCursorToPoint": (sel32or64(b"iI{CGPoint=ff}", b"iI{CGPoint=dd}"),),
    "CGPDFScannerPopInteger": (
        sel32or64(b"B^{CGPDFScanner=}^l", b"B^{CGPDFScanner=}^q"),
        "",
        {"arguments": {1: {"type_modifier": "o"}}},
    ),
    ...
    "CGEventSetLocation": (
        sel32or64(b"v^{__CGEvent=}{CGPoint=ff}", b"v^{__CGEvent=}{CGPoint=dd}"),
    ),
    "CGEventPostToPSN": (
    ...
    "CGAffineTransformScale": (
        sel32or64(
            b"{CGAffineTransform=ffffff}{CGAffineTransform=ffffff}ff",
    ...
    "CGPDFArrayGetArray": (
        sel32or64(b"B^{CGPDFArray=}L^^{CGPDFArray=}", b"B^{CGPDFArray=}Q^^{CGPDFArray=}"),
        "",
        {"arguments": {2: {"type_modifier": "o"}}},
    ),
    "CGContextDrawLayerInRect": (
        sel32or64(
            b"v^{CGContext=}{CGRect={CGPoint=ff}{CGSize=ff}}^{CGLayer=}",
    ...
    "CGMainDisplayID": (b"I",),
    "CGFontGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGPathAddRoundedRect": (
        sel32or64(
            b"v^{CGPath=}^{CGAffineTransform=ffffff}{CGRect={CGPoint=ff}{CGSize=ff}}ff",
    ...
    "CGBitmapContextGetWidth": (sel32or64(b"L^{CGContext=}", b"Q^{CGContext=}"),),
    "CGShadingCreateRadial": (
        sel32or64(
            b"^{CGShading=}^{CGColorSpace=}{CGPoint=ff}f{CGPoint=ff}f^{CGFunction=}BB",
    ...
    "CGContextAddRects": (
        sel32or64(
            b"v^{CGContext=}^{CGRect={CGPoint=ff}{CGSize=ff}}L",
    ...
    "CGContextConvertRectToUserSpace": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}^{CGContext=}{CGRect={CGPoint=ff}{CGSize=ff}}",
            b"{CGRect={CGPoint=dd}{CGSize=dd}}^{CGContext=}{CGRect={CGPoint=dd}{CGSize=dd}}",
        ),
    ),
    "CGGradientCreateWithColors": (
        sel32or64(
            b"^{CGGradient=}^{CGColorSpace=}^{__CFArray=}^f",
    ...
    "CGContextAddArc": (sel32or64(b"v^{CGContext=}fffffi", b"v^{CGContext=}dddddi"),),
    ...
    "CGPDFContextSetURLForRect": (
        sel32or64(
            b"v^{CGContext=}^{__CFURL=}{CGRect={CGPoint=ff}{CGSize=ff}}",
    ...
    "CGContextAddCurveToPoint": (
        sel32or64(b"v^{CGContext=}ffffff", b"v^{CGContext=}dddddd"),
    ),
    ...
    "CGEventKeyboardGetUnicodeString": (
        sel32or64(b"v^{__CGEvent=}L^L^T", b"v^{__CGEvent=}Q^Q^T"),
        "",
        {
            "arguments": {
                2: {"type_modifier": "o"},
    ...
    "CGContextConvertPointToUserSpace": (
        sel32or64(
            b"{CGPoint=ff}^{CGContext=}{CGPoint=ff}",
            b"{CGPoint=dd}^{CGContext=}{CGPoint=dd}",
        ),
    ),
    ...
    "CGPointEqualToPoint": (
        sel32or64(b"B{CGPoint=ff}{CGPoint=ff}", b"B{CGPoint=dd}{CGPoint=dd}"),
    ),
    "CGCursorIsDrawnInFramebuffer": (sel32or64(b"i", b"I"),),
    "CGEventSourceCounterForEventType": (sel32or64(b"III", b"IiI"),),
    "CGDisplayCaptureWithOptions": (b"iII",),
    "CGDisplayIsStereo": (sel32or64(b"iI", b"II"),),
    "CGPDFTagTypeGetName": (b"^ci",),
    "CGBitmapContextGetBytesPerRow": (sel32or64(b"L^{CGContext=}", b"Q^{CGContext=}"),),
    "CGContextBeginTransparencyLayer": (b"v^{CGContext=}^{__CFDictionary=}",),
    "CGFontRetain": (b"^{CGFont=}^{CGFont=}",),
    "CGContextSetLineDash": (
        sel32or64(b"v^{CGContext=}f^fL", b"v^{CGContext=}d^dQ"),
        "",
        {"arguments": {2: {"c_array_length_in_arg": 3, "type_modifier": "n"}}},
    ),
    "CGColorSpaceCreateICCBased": (
        sel32or64(
            b"^{CGColorSpace=}L^f^{CGDataProvider=}^{CGColorSpace=}",
    ...
    "CGContextSetGrayStrokeColor": (sel32or64(b"v^{CGContext=}ff", b"v^{CGContext=}dd"),),
    "CGPDFOperatorTableRelease": (b"v^{CGPDFOperatorTable=}",),
    "CGContextGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGRectOffset": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}{CGRect={CGPoint=ff}{CGSize=ff}}ff",
            b"{CGRect={CGPoint=dd}{CGSize=dd}}{CGRect={CGPoint=dd}{CGSize=dd}}dd",
        ),
    ),
    "CGLayerGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGColorSpaceCreateCalibratedGray": (
        sel32or64(b"^{CGColorSpace=}[3f][3f]f", b"^{CGColorSpace=}[3d][3d]d"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CGEventTapCreate": (
    ...
    "CGContextSetRenderingIntent": (sel32or64(b"v^{CGContext=}I", b"v^{CGContext=}i"),),
    "CGDisplayCurrentMode": (b"^{__CFDictionary=}I",),
    "CGConfigureDisplayWithDisplayMode": (
        b"i^{_CGDisplayConfigRef=}I^{CGDisplayMode=}^{__CFDictionary=}",
    ),
    "CGCursorIsVisible": (sel32or64(b"i", b"I"),),
    "CGDisplayIsMain": (sel32or64(b"iI", b"II"),),
    ...
    "CGAssociateMouseAndMouseCursorPosition": (sel32or64(b"ii", b"iI"),),
    "CGEventGetDoubleValueField": (b"d^{__CGEvent=}I",),
    "CGPDFDocumentAllowsPrinting": (b"B^{CGPDFDocument=}",),
    "CGContextSetBlendMode": (sel32or64(b"v^{CGContext=}I", b"v^{CGContext=}i"),),
    "CGFontGetGlyphAdvances": (
        sel32or64(b"B^{CGFont=}^SL^i", b"B^{CGFont=}^SQ^i"),
        "",
        {
            "arguments": {
                1: {"c_array_length_in_arg": 2, "type_modifier": "n"},
    ...
    "CGDisplayIsInHWMirrorSet": (sel32or64(b"iI", b"II"),),
    ...
    "CGSizeCreateDictionaryRepresentation": (
        sel32or64(b"^{__CFDictionary=}{CGSize=ff}", b"^{__CFDictionary=}{CGSize=dd}"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CGPDFStringGetLength": (sel32or64(b"L^{CGPDFString=}", b"Q^{CGPDFString=}"),),
    ...
    "CGWaitForScreenUpdateRects": (
        sel32or64(
            b"iI^I^^{CGRect={CGPoint=ff}{CGSize=ff}}^L^{CGScreenUpdateMoveDelta=ii}",
            b"iI^I^^{CGRect={CGPoint=dd}{CGSize=dd}}^Q^{CGScreenUpdateMoveDelta=ii}",
        ),
    ),
    "CGDisplayBitsPerSample": (sel32or64(b"LI", b"QI"),),
    "CGDisplayModeGetPixelHeight": (
        sel32or64(b"L^{CGDisplayMode=}", b"Q^{CGDisplayMode=}"),
    ),
    ...
    "CGBitmapContextGetBitsPerComponent": (
        sel32or64(b"L^{CGContext=}", b"Q^{CGContext=}"),
    ),
    "CGContextAddPath": (b"v^{CGContext=}^{CGPath=}",),
    "CGConfigureDisplayOrigin": (b"i^{_CGDisplayConfigRef=}Iii",),
    "CGContextSetCharacterSpacing": (sel32or64(b"v^{CGContext=}f", b"v^{CGContext=}d"),),
    "CGDisplaySamplesPerPixel": (sel32or64(b"LI", b"QI"),),
    "CGOpenGLDisplayMaskToDisplayID": (b"II",),
    "CGPDFArrayGetNumber": (
        sel32or64(b"B^{CGPDFArray=}L^f", b"B^{CGPDFArray=}Q^d"),
        "",
        {"arguments": {2: {"type_modifier": "o"}}},
    ),
    ...
    "CGDisplayModeGetWidth": (sel32or64(b"L^{CGDisplayMode=}", b"Q^{CGDisplayMode=}"),),
    ...
    "CGPDFDocumentGetPage": (
        sel32or64(b"^{CGPDFPage=}^{CGPDFDocument=}L", b"^{CGPDFPage=}^{CGPDFDocument=}Q"),
    ),
    ...
    "CGFontGetFontBBox": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}^{CGFont=}",
            b"{CGRect={CGPoint=dd}{CGSize=dd}}^{CGFont=}",
        ),
    ),
    "CGImageGetBitsPerComponent": (sel32or64(b"L^{CGImage=}", b"Q^{CGImage=}"),),
    "CGFontCopyTableTags": (
        b"^{__CFArray=}^{CGFont=}",
        "",
        {"retval": {"already_cfretained": True}},
    ...
    "CGWaitForScreenRefreshRects": (
        sel32or64(
            b"i^^{CGRect={CGPoint=ff}{CGSize=ff}}^I",
            b"i^^{CGRect={CGPoint=dd}{CGSize=dd}}^I",
        ),
    ),
    ...
    "CGContextShowTextAtPoint": (
        sel32or64(b"v^{CGContext=}ff^cL", b"v^{CGContext=}dd^cQ"),
        "",
        {"arguments": {3: {"c_array_length_in_arg": 4, "type_modifier": "n"}}},
    ),
    ...
    "CGContextTranslateCTM": (sel32or64(b"v^{CGContext=}ff", b"v^{CGContext=}dd"),),
    "CGDisplayModelNumber": (b"II",),
    "CGPDFContextCreateWithURL": (
        sel32or64(
            b"^{CGContext=}^{__CFURL=}^{CGRect={CGPoint=ff}{CGSize=ff}}^{__CFDictionary=}",
    ...
    "CGBitmapContextCreateWithData": (
        sel32or64(
            b"^{CGContext=}^vLLLL^{CGColorSpace=}I^?^v",
    ...
    "CGAffineTransformConcat": (
        sel32or64(
            b"{CGAffineTransform=ffffff}{CGAffineTransform=ffffff}{CGAffineTransform=ffffff}",
    ...
    "CGImageCreateWithMaskingColors": (
        sel32or64(b"^{CGImage=}^{CGImage=}^f", b"^{CGImage=}^{CGImage=}^d"),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {1: {"c_array_of_variable_length": True, "type_modifier": "n"}},
    ...
    "CGPDFDictionaryGetInteger": (
        sel32or64(b"B^{CGPDFDictionary=}^t^l", b"B^{CGPDFDictionary=}^t^q"),
        "",
        {
            "arguments": {
                1: {"c_array_delimited_by_null": True, "type_modifier": "n"},
    ...
    "CGColorGetAlpha": (sel32or64(b"f^{CGColor=}", b"d^{CGColor=}"),),
    ...
    "CGDisplayBestModeForParameters": (
        sel32or64(b"^{__CFDictionary=}ILLL^i", b"^{__CFDictionary=}IQQQ^I"),
        "",
    ...
    "CGShadingCreateAxial": (
        sel32or64(
            b"^{CGShading=}^{CGColorSpace=}{CGPoint=ff}{CGPoint=ff}^{CGFunction=}BB",
    ...
    "CGRectMakeWithDictionaryRepresentation": (
        sel32or64(
            b"B^{__CFDictionary=}^{CGRect={CGPoint=ff}{CGSize=ff}}",
    ...
    "CGFunctionCreate": (
        sel32or64(
            b"^{CGFunction=}^vL^fL^f^{CGFunctionCallbacks=I^?^?}",
    ...
    "CGDataProviderCreateDirectAccess": (
        sel32or64(
            b"^{CGDataProvider=}^vL^{CGDataProviderDirectAccessCallbacks=^?^?^?^?}",
    ...
    "CGGetDisplaysWithRect": (
        sel32or64(
            b"i{CGRect={CGPoint=ff}{CGSize=ff}}I^I^I",
    ...
    "CGGetDisplaysWithPoint": (
        sel32or64(b"i{CGPoint=ff}I^I^I", b"i{CGPoint=dd}I^I^I"),
        "",
        {
            "arguments": {
                2: {"c_array_length_in_arg": (1, 3), "type_modifier": "o"},
    ...
    "CGPDFStreamCopyData": (
        sel32or64(b"^{__CFData=}^{CGPDFStream=}^I", b"^{__CFData=}^{CGPDFStream=}^i"),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {1: {"type_modifier": "o"}},
    ...
    "CGImageGetHeight": (sel32or64(b"L^{CGImage=}", b"Q^{CGImage=}"),),
    "CGDisplayBitsPerPixel": (sel32or64(b"LI", b"QI"),),
    ...
    "CGPathGetCurrentPoint": (
        sel32or64(b"{CGPoint=ff}^{CGPath=}", b"{CGPoint=dd}^{CGPath=}"),
    ),
    "CGContextShowGlyphsAtPositions": (
        sel32or64(b"v^{CGContext=}^S^{CGPoint=ff}L", b"v^{CGContext=}^S^{CGPoint=dd}Q"),
        "",
        {
            "arguments": {
                1: {"c_array_length_in_arg": 3, "type_modifier": "n"},
    ...
    "CGEventCreateMouseEvent": (
        sel32or64(
            b"^{__CGEvent=}^{__CGEventSource=}I{CGPoint=ff}I",
    ...
    "CGImageCreateWithImageInRect": (
        sel32or64(
            b"^{CGImage=}^{CGImage=}{CGRect={CGPoint=ff}{CGSize=ff}}",
    ...
    "CGContextDrawPDFDocument": (
        sel32or64(
            b"v^{CGContext=}{CGRect={CGPoint=ff}{CGSize=ff}}^{CGPDFDocument=}i",
            b"v^{CGContext=}{CGRect={CGPoint=dd}{CGSize=dd}}^{CGPDFDocument=}i",
        ),
    ),
    "CGEventGetUnflippedLocation": (
        sel32or64(b"{CGPoint=ff}^{__CGEvent=}", b"{CGPoint=dd}^{__CGEvent=}"),
    ),
    "CGFunctionGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGCaptureAllDisplaysWithOptions": (b"iI",),
    "CGContextSetShadowWithColor": (
        sel32or64(
            b"v^{CGContext=}{CGSize=ff}f^{CGColor=}",
            b"v^{CGContext=}{CGSize=dd}d^{CGColor=}",
        ),
    ),
    "CGContextSetInterpolationQuality": (
        sel32or64(b"v^{CGContext=}I", b"v^{CGContext=}i"),
    ),
    "CGPDFPageGetDictionary": (b"^{CGPDFDictionary=}^{CGPDFPage=}",),
    "CGContextMoveToPoint": (sel32or64(b"v^{CGContext=}ff", b"v^{CGContext=}dd"),),
    "CGContextDrawLayerAtPoint": (
        sel32or64(
            b"v^{CGContext=}{CGPoint=ff}^{CGLayer=}",
            b"v^{CGContext=}{CGPoint=dd}^{CGLayer=}",
        ),
    ),
    ...
    "CGPDFPageGetPageNumber": (sel32or64(b"L^{CGPDFPage=}", b"Q^{CGPDFPage=}"),),
    ...
    "CGDisplayIsAlwaysInMirrorSet": (sel32or64(b"iI", b"II"),),
    ...
    "CGRectCreateDictionaryRepresentation": (
        sel32or64(
            b"^{__CFDictionary=}{CGRect={CGPoint=ff}{CGSize=ff}}",
    ...
    "CGContextStrokeRectWithWidth": (
        sel32or64(
            b"v^{CGContext=}{CGRect={CGPoint=ff}{CGSize=ff}}f",
            b"v^{CGContext=}{CGRect={CGPoint=dd}{CGSize=dd}}d",
        ),
    ),
    "CGEventGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGFontGetItalicAngle": (sel32or64(b"f^{CGFont=}", b"d^{CGFont=}"),),
    ...
    "CGPathAddRects": (
        sel32or64(
            b"v^{CGPath=}^{CGAffineTransform=ffffff}^{CGRect={CGPoint=ff}{CGSize=ff}}L",
    ...
    "CGPDFContextSetDestinationForRect": (
        sel32or64(
            b"v^{CGContext=}^{__CFString=}{CGRect={CGPoint=ff}{CGSize=ff}}",
    ...
    "CGImageGetBitsPerPixel": (sel32or64(b"L^{CGImage=}", b"Q^{CGImage=}"),),
    "CGPathAddArc": (
        sel32or64(
            b"v^{CGPath=}^{CGAffineTransform=ffffff}fffffB",
    ...
    "CGContextDrawLinearGradient": (
        sel32or64(
            b"v^{CGContext=}^{CGGradient=}{CGPoint=ff}{CGPoint=ff}I",
            b"v^{CGContext=}^{CGGradient=}{CGPoint=dd}{CGPoint=dd}I",
        ),
    ),
    "CGDataConsumerGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "CGDisplayScreenSize": (sel32or64(b"{CGSize=ff}I", b"{CGSize=dd}I"),),
    "CGDisplayIsInMirrorSet": (sel32or64(b"iI", b"II"),),
    ...
    "CGDisplayFadeOperationInProgress": (sel32or64(b"i", b"I"),),
    "CGPostMouseEvent": (
        sel32or64(b"i{CGPoint=ff}iIi", b"i{CGPoint=dd}III"),
        "",
        {"c_array_length_in_arg": 2, "variadic": True},
    ),
    "CGPDFContentStreamGetStreams": (b"^{__CFArray=}^{CGPDFContentStream=}",),
    "CGContextSetMiterLimit": (sel32or64(b"v^{CGContext=}f", b"v^{CGContext=}d"),),
    ...
    "CGContextDrawPath": (sel32or64(b"v^{CGContext=}I", b"v^{CGContext=}i"),),
    "CGWindowServerCFMachPort": (b"^{__CFMachPort=}",),
    "CGColorEqualToColor": (b"B^{CGColor=}^{CGColor=}",),
    "CGContextSetFontSize": (sel32or64(b"v^{CGContext=}f", b"v^{CGContext=}d"),),
    "CGEventGetIntegerValueField": (b"q^{__CGEvent=}I",),
    "CGContextShowText": (
        sel32or64(b"v^{CGContext=}^cL", b"v^{CGContext=}^cQ"),
        "",
        {"arguments": {1: {"c_array_length_in_arg": 2, "type_modifier": "n"}}},
    ),
    ...
    "CGContextSetTextDrawingMode": (sel32or64(b"v^{CGContext=}I", b"v^{CGContext=}i"),),
    ...
    "CGColorSpaceCreateCalibratedRGB": (
        sel32or64(
            b"^{CGColorSpace=}[3f][3f][3f][9f]", b"^{CGColorSpace=}[3d][3d][3d][9d]"
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CGContextSetLineJoin": (sel32or64(b"v^{CGContext=}I", b"v^{CGContext=}i"),),
    "CGDataProviderCreateSequential": (
        b"^{CGDataProvider=}^v^{CGDataProviderSequentialCallbacks=I^?^?^?^?}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CGPDFArrayGetNull": (sel32or64(b"B^{CGPDFArray=}L", b"B^{CGPDFArray=}Q"),),
    "CGEventSourceSecondsSinceLastEventType": (sel32or64(b"dII", b"diI"),),
    ...
    "CGPDFArrayGetDictionary": (
        sel32or64(
            b"B^{CGPDFArray=}L^^{CGPDFDictionary=}",
    ...
    "CGContextConvertSizeToUserSpace": (
        sel32or64(
            b"{CGSize=ff}^{CGContext=}{CGSize=ff}", b"{CGSize=dd}^{CGContext=}{CGSize=dd}"
        ),
    ),
    "CGColorCreateCopyWithAlpha": (
        sel32or64(b"^{CGColor=}^{CGColor=}f", b"^{CGColor=}^{CGColor=}d"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CGPDFScannerPopNumber": (
        sel32or64(b"B^{CGPDFScanner=}^f", b"B^{CGPDFScanner=}^d"),
        "",
        {"arguments": {1: {"type_modifier": "o"}}},
    ),
    ...
    "CGEventSourceButtonState": (sel32or64(b"BII", b"BiI"),),
    ...
    "CGReleaseScreenRefreshRects": (
        sel32or64(
            b"v^{CGRect={CGPoint=ff}{CGSize=ff}}", b"v^{CGRect={CGPoint=dd}{CGSize=dd}}"
        ),
    ),
    "CGContextSetFlatness": (sel32or64(b"v^{CGContext=}f", b"v^{CGContext=}d"),),
    ...
    "CGPathIsRect": (
        sel32or64(
            b"B^{CGPath=}^{CGRect={CGPoint=ff}{CGSize=ff}}",
    ...
    "CGPathCreateCopyByDashingPath": (
        sel32or64(
            b"^{CGPath=}^{CGPath=}^{CGAffineTransform=ffffff}f^fL",
    ...
    "CGDisplayIsAsleep": (sel32or64(b"iI", b"II"),),
    ...
    "CGDisplayBounds": (
        sel32or64(
            b"{CGRect={CGPoint=ff}{CGSize=ff}}I", b"{CGRect={CGPoint=dd}{CGSize=dd}}I"
        ),
    ),
    ...
    "CGDisplayBestModeForParametersAndRefreshRateWithProperty": (
        sel32or64(
            b"^{__CFDictionary=}ILLLd^{__CFString=}^i",
    ...
    "CGColorCreate": (
        sel32or64(b"^{CGColor=}^{CGColorSpace=}^f", b"^{CGColor=}^{CGColorSpace=}^d"),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {1: {"c_array_of_variable_length": True, "type_modifier": "n"}},
    ...
    "CGPDFDocumentGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGShadingGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGEventSourceKeyState": (sel32or64(b"BIS", b"BiS"),),
    "CGContextBeginTransparencyLayerWithRect": (
        sel32or64(
            b"v^{CGContext=}{CGRect={CGPoint=ff}{CGSize=ff}}^{__CFDictionary=}",
            b"v^{CGContext=}{CGRect={CGPoint=dd}{CGSize=dd}}^{__CFDictionary=}",
        ),
    ),
    "CGPointCreateDictionaryRepresentation": (
        sel32or64(b"^{__CFDictionary=}{CGPoint=ff}", b"^{__CFDictionary=}{CGPoint=dd}"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CGAffineTransformEqualToTransform": (
        sel32or64(
            b"B{CGAffineTransform=ffffff}{CGAffineTransform=ffffff}",
            b"B{CGAffineTransform=dddddd}{CGAffineTransform=dddddd}",
        ),
    ),
    "CGDisplayPixelsWide": (sel32or64(b"LI", b"QI"),),
    "CGEventSourceFlagsState": (sel32or64(b"QI", b"Qi"),),
    ...
    "CGAffineTransformInvert": (
        sel32or64(
            b"{CGAffineTransform=ffffff}{CGAffineTransform=ffffff}",
    ...
    "CGPatternGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGImageGetBytesPerRow": (sel32or64(b"L^{CGImage=}", b"Q^{CGImage=}"),),
    "CGPathRelease": (b"v^{CGPath=}",),
    "CGDisplayModeGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "CGContextSetLineWidth": (sel32or64(b"v^{CGContext=}f", b"v^{CGContext=}d"),),
    "CGDisplayStreamCreateWithDispatchQueue": (
        sel32or64(
            b"^{CGDisplayStream=}ILLi^{__CFDictionary=}^{dispatch_queue_s=}@?",
            b"^{CGDisplayStream=}IQQi^{__CFDictionary=}@@?",
        ),
        "",
        {
    ...
    "CGContextShowGlyphs": (
        sel32or64(b"v^{CGContext=}^SL", b"v^{CGContext=}^SQ"),
        "",
        {"arguments": {1: {"c_array_length_in_arg": 2, "type_modifier": "n"}}},
    ),
    ...
    "CGGradientCreateWithColorComponents": (
        sel32or64(
            b"^{CGGradient=}^{CGColorSpace=}^f^fL", b"^{CGGradient=}^{CGColorSpace=}^d^dQ"
        ),
        "",
        {
            "retval": {"already_cfretained": True},
    ...
    "CGDisplayStreamUpdateGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGRectGetMinY": (
        sel32or64(
            b"f{CGRect={CGPoint=ff}{CGSize=ff}}", b"d{CGRect={CGPoint=dd}{CGSize=dd}}"
        ),
    ...
    "CGPDFDocumentGetNumberOfPages": (
        sel32or64(b"L^{CGPDFDocument=}", b"Q^{CGPDFDocument=}"),
    ),
    ...
    "CGPathAddCurveToPoint": (
        sel32or64(
            b"v^{CGPath=}^{CGAffineTransform=ffffff}ffffff",
    ...
    "CGImageCreate": (
        sel32or64(
            b"^{CGImage=}LLLLL^{CGColorSpace=}I^{CGDataProvider=}^fBI",
            b"^{CGImage=}QQQQQ^{CGColorSpace=}I^{CGDataProvider=}^dBi",
        ),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {8: {"c_array_of_variable_length": True, "type_modifier": "n"}},
        },
    ),
    ...
    "CGPostKeyboardEvent": (sel32or64(b"iSSi", b"iSSI"),),
    ...
    "CGPathGetTypeID": (sel32or64(b"L", b"Q"),),
    "CGColorSpaceCreateIndexed": (
        sel32or64(
            b"^{CGColorSpace=}^{CGColorSpace=}L^C", b"^{CGColorSpace=}^{CGColorSpace=}Q^C"
        ),
        "",
        {
            "retval": {"already_cfretained": True},
    ...
    "CGColorSpaceCreateLab": (
        sel32or64(b"^{CGColorSpace=}[3f][3f][4f]", b"^{CGColorSpace=}[3d][3d][4d]"),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CGSizeMakeWithDictionaryRepresentation": (
        sel32or64(b"B^{__CFDictionary=}^{CGSize=ff}", b"B^{__CFDictionary=}^{CGSize=dd}"),
        "",
        {"arguments": {1: {"type_modifier": "o"}}},
    ),
...
aliases = {
    ...
    "CG_EXTERN_64": sel32or64("CG_LOCAL", "CG_EXTERN"),
    "CG_NONNULL_ARRAY": "__nonnull",
    "kCGWindowBackingCFNumberType": "kCFNumberSInt32Type",
    "CGFLOAT_MIN": sel32or64("FLT_MIN", "DBL_MIN"),
    ...
    "CGFLOAT_MAX": sel32or64("FLT_MAX", "DBL_MAX"),
