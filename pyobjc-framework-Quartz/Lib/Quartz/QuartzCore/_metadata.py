...
misc.update(
    {
        "CATransform3D": objc.createStructType(
            "CATransform3D",
            sel32or64(
                b"{CATransform3D=ffffffffffffffff}", b"{CATransform3D=dddddddddddddddd}"
            ),
            [
                "m11",
                "m12",
...
constants = constants + "$CATransform3DIdentity@%s$" % (
...
functions = {
    ...
    "CATransform3DGetAffineTransform": (
        sel32or64(
            b"{CGAffineTransform=ffffff}{CATransform3D=ffffffffffffffff}",
            b"{CGAffineTransform=dddddd}{CATransform3D=dddddddddddddddd}",
        ),
    ),
    "CATransform3DMakeAffineTransform": (
        sel32or64(
            b"{CATransform3D=ffffffffffffffff}{CGAffineTransform=ffffff}",
...
try:
    ...
    r(
        ...
        b"setROISelector:",
        {
            "arguments": {
                2: {
                    "sel_of_type": sel32or64(
                        b"{CGRect={CGPoint=ff}{CGSize=ff}}@:i{CGRect={CGPoint=ff}{CGSize=ff}}@",
                        b"{CGRect={CGPoint=dd}{CGSize=dd}}@:i{CGRect={CGPoint=dd}{CGSize=dd}}@",
                    )
                }
            }
        },
    ...
    r(
        b"NSObject",
        b"bottomLeft",
        {"retval": {"type": sel32or64(b"{CGPoint=ff}", b"{CGPoint=dd}")}},
    )
    r(
        b"NSObject",
        b"bottomRight",
    ...
    r(
        ...
        b"provideImageData:bytesPerRow:origin::size::userInfo:",
        {
            ...
            "arguments": {
                ...
                3: {"type": sel32or64(b"L", b"Q")},
                4: {"type": sel32or64(b"L", b"Q")},
                5: {"type": sel32or64(b"L", b"Q")},
                6: {"type": sel32or64(b"L", b"Q")},
                7: {"type": sel32or64(b"L", b"Q")},
                8: {"type": b"@"},
            },
        },
    )
    ...
    r(
        ...
        b"setTransform:",
        {
            "arguments": {
                2: {
                    "type": sel32or64(
                        b"{CGAffineTransform=ffffff}", b"{CGAffineTransform=dddddd}"
                    )
                }
            }
        },
    ...
    "CIImageProvider": objc.informal_protocol(
        ...
        [
            objc.selector(
                None,
                b"provideImageData:bytesPerRow:origin::size::userInfo:",
                sel32or64(b"v@:^vLLLLL@", b"v@:^vQQQQQ@"),
                isRequired=False,
            )
        ],
    ),
