...
#
# Last update: Sat Jul 30 15:44:47 2016
...
try:
    ...
    r(b'CIContext', b'createCGImage:fromRect:format:colorSpace:deferred:', {'retval': {'alread_cfretained': True}, 'arguments': {6: {'type': 'Z'}}})
