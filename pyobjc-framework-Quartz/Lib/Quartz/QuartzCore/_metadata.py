...
#
# Last update: Sat Nov 21 11:38:58 2020
#
# flake8: noqa
...
misc.update({})
functions={'CATransform3DIsAffine': (b'B{CATransform3D=dddddddddddddddd}',), 'CATransform3DInvert': (b'{CATransform3D=dddddddddddddddd}{CATransform3D=dddddddddddddddd}',), 'CATransform3DIsIdentity': (b'B{CATransform3D=dddddddddddddddd}',), 'CATransform3DMakeScale': (b'{CATransform3D=dddddddddddddddd}ddd',), 'CATransform3DTranslate': (b'{CATransform3D=dddddddddddddddd}{CATransform3D=dddddddddddddddd}ddd',), 'CATransform3DEqualToTransform': (b'B{CATransform3D=dddddddddddddddd}{CATransform3D=dddddddddddddddd}',), 'CATransform3DRotate': (b'{CATransform3D=dddddddddddddddd}{CATransform3D=dddddddddddddddd}dddd',), 'CACurrentMediaTime': (b'd',), 'CATransform3DMakeRotation': (b'{CATransform3D=dddddddddddddddd}dddd',), 'CATransform3DConcat': (b'{CATransform3D=dddddddddddddddd}{CATransform3D=dddddddddddddddd}{CATransform3D=dddddddddddddddd}',), 'CATransform3DScale': (b'{CATransform3D=dddddddddddddddd}{CATransform3D=dddddddddddddddd}ddd',), 'CATransform3DMakeTranslation': (b'{CATransform3D=dddddddddddddddd}ddd',), 'CATransform3DGetAffineTransform': (b'{CGAffineTransform=dddddd}{CATransform3D=dddddddddddddddd}',), 'CATransform3DMakeAffineTransform': (b'{CATransform3D=dddddddddddddddd}{CGAffineTransform=dddddd}',)}
...
try:
    ...
    r(b'CAOpenGLLayer', b'canDrawInCGLContext:pixelFormat:forLayerTime:displayTime:', {'retval': {'type': b'Z'}, 'arguments': {5: {'type': b'^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssIIIssss}QQ}', 'type_modifier': b'n'}}})
    r(b'CAOpenGLLayer', b'drawInCGLContext:pixelFormat:forLayerTime:displayTime:', {'arguments': {5: {'type': b'^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssIIIssss}QQ}', 'type_modifier': b'n'}}})
    ...
    r(b'CARenderer', b'beginFrameAtTime:timeStamp:', {'arguments': {3: {'type': b'^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssIIIssss}QQ}', 'type_modifier': b'n'}}})
    ...
    r(b'NSObject', b'provideImageData:bytesPerRow:origin::size::userInfo:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^v', 'type_modifier': b'o', 'c_array_of_variable_length': True}, 3: {'type': b'Q'}, 4: {'type': b'Q'}, 5: {'type': b'Q'}, 6: {'type': b'Q'}, 7: {'type': b'Q'}, 8: {'type': b'@'}}})
    ...
    r(b'NSObject', b'setExtent:', {'arguments': {2: {'type': '{CGRect={CGPoint=dd}{CGSize=dd}}'}}})
    ...
    r(b'NSObject', b'setShadowExtent:', {'arguments': {2: {'type': '{CGRect={CGPoint=dd}{CGSize=dd}}'}}})
    ...
    r(b'NSObject', b'setTransform:', {'arguments': {2: {'type': '{CGAffineTransform=dddddd}'}}})
    ...
    r(b'NSObject', b'shadowExtent', {'retval': {'type': '{CGRect={CGPoint=dd}{CGSize=dd}}'}})
