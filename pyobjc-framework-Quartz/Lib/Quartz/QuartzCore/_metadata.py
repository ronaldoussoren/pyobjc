...
#
# Last update: Fri Jul 14 13:39:05 2017
...
try:
    ...
    r(b'CIImage', b'writeJPEGRepresentationOfImage:toURL:format:colorSpace:options:error:', {'retval': {'type': 'Z'}, 'arguments': {7: {'type_modifier': b'o'}}})
