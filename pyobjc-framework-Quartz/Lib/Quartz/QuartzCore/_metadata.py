...
misc.update(
    {
        ...
        "CADynamicRange": NewType("CADynamicRange", str),
...
try:
    ...
    r(b"CAEmitterBehavior", b"isEnabled", {"retval": {"type": "Z"}})
    r(b"CAEmitterBehavior", b"setEnabled:", {"arguments": {2: {"type": "Z"}}})
    ...
    r(
        b"CIContext",
        b"createCGImage:fromRect:format:colorSpace:deferred:calculateHDRStats:",
    ...
    r(
        b"CIContext",
        b"estimateRender:fromRect:toDestination:atPoint:error:",
    ...
    r(b"CIFaceFeature", b"hasFaceAngle", {"retval": {"type": "Z"}})
    r(b"CIFaceFeature", b"hasLeftEyePosition", {"retval": {"type": "Z"}})
    r(b"CIFaceFeature", b"hasMouthPosition", {"retval": {"type": "Z"}})
    r(b"CIFaceFeature", b"hasRightEyePosition", {"retval": {"type": "Z"}})
    r(b"CIFaceFeature", b"hasSmile", {"retval": {"type": "Z"}})
    r(b"CIFaceFeature", b"hasTrackingFrameCount", {"retval": {"type": "Z"}})
    r(b"CIFaceFeature", b"hasTrackingID", {"retval": {"type": "Z"}})
    r(b"CIFaceFeature", b"leftEyeClosed", {"retval": {"type": "Z"}})
    r(b"CIFaceFeature", b"rightEyeClosed", {"retval": {"type": "Z"}})
    ...
    r(b"CIFilter", b"isEnabled", {"retval": {"type": "Z"}})
    r(b"CIFilter", b"setEnabled:", {"arguments": {2: {"type": "Z"}}})
    r(
        b"CIFilterGenerator",
        b"writeToURL:atomically:",
        {"retval": {"type": "Z"}, "arguments": {3: {"type": "Z"}}},
    )
    r(b"CIFilterShape", b"transformBy:interior:", {"arguments": {3: {"type": "Z"}}})
    r(
        b"CIImage",
    ...
    r(
        b"CIImageProcessorKernel",
        b"applyWithExtents:inputs:arguments:error:",
        {"arguments": {5: {"type_modifier": b"o"}}},
    )
    r(
        b"CIImageProcessorKernel",
        b"applyWithTiledExtent:inputs:arguments:error:",
        {"arguments": {5: {"type_modifier": b"o"}}},
    )
    r(
        b"CIImageProcessorKernel",
    ...
    r(
        b"CIImageProcessorKernel",
        b"processWithInputs:arguments:outputs:error:",
        {"retval": {"type": "Z"}, "arguments": {5: {"type_modifier": b"o"}}},
    )
    r(
        b"CIKernel",
    ...
    r(b"CIPlugIn", b"loadPlugIn:allowNonExecutable:", {"arguments": {3: {"type": "Z"}}})
    r(
        b"CIRAWFilter",
    ...
    r(b"NSObject", b"autoreverses", {"required": True, "retval": {"type": "Z"}})
    ...
    r(b"NSObject", b"centerSpaceSize", {"retval": {"type": "f"}})
    ...
    r(b"NSObject", b"displayHeadroom", {"retval": {"type": "f"}})
    r(
        b"NSObject",
        b"displayLayer:",
        {"required": False, "retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    ...
    r(b"NSObject", b"load:", {"retval": {"type": "Z"}})
    ...
    r(b"NSObject", b"roundedData", {"retval": {"type": "Z"}})
    r(b"NSObject", b"roundedMarkers", {"retval": {"type": "q"}})
    ...
    r(b"NSObject", b"setCenterSpaceSize:", {"arguments": {2: {"type": "f"}}})
    ...
    r(b"NSObject", b"setDisplayHeadroom:", {"arguments": {2: {"type": "f"}}})
    ...
    r(b"NSObject", b"setRoundedData:", {"arguments": {2: {"type": "Z"}}})
    r(b"NSObject", b"setRoundedMarkers:", {"arguments": {2: {"type": "q"}}})
    ...
    r(b"NSObject", b"setSmoothness:", {"arguments": {2: {"type": "f"}}})
    ...
    r(b"NSObject", b"smoothness", {"retval": {"type": "f"}})
    ...
    r(
        b"NSObject",
        b"temporaryPixelBufferWithIdentifier:format:width:height:attributes:",
        {"arguments": {3: {"type": "i"}, 4: {"type": "Q"}, 5: {"type": "Q"}}},
    )
    r(
        b"NSObject",
        b"temporarySurfaceWithIdentifier:format:width:height:",
        {"arguments": {3: {"type": "i"}, 4: {"type": "Q"}, 5: {"type": "Q"}}},
    )
...
objc.registerNewKeywordsFromSelector("CAEDRMetadata", b"init")
objc.registerNewKeywordsFromSelector("CALayer", b"init")
...
objc.registerNewKeywords(
    "CAConstraint",
    ("attribute", "relativeTo", "attribute"),
    "constraintWithAttribute_relativeTo_attribute_",
)
objc.registerNewKeywords(
    "CAConstraint",
    ("attribute", "relativeTo", "attribute", "offset"),
    "constraintWithAttribute_relativeTo_attribute_offset_",
)
objc.registerNewKeywords("CAMediaTimingFunction", ("name",), "functionWithName_")
objc.registerNewKeywords("CAPropertyAnimation", ("keyPath",), "animationWithKeyPath_")
objc.registerNewKeywords("CAValueFunction", ("name",), "functionWithName_")
expressions = {}
formal_protocols = {
    "CAAction": "CAAction",
    "CAAnimationDelegate": "CAAnimationDelegate",
    "CALayerDelegate": "CALayerDelegate",
    "CALayoutManager": "CALayoutManager",
    "CAMediaTiming": "CAMediaTiming",
    "CAMetalDisplayLinkDelegate": "CAMetalDisplayLinkDelegate",
    "CAMetalDrawableProtocol": "CAMetalDrawable",
    "CIImageProcessorInputProtocol": "CIImageProcessorInput",
    "CIPlugInRegistration": "CIPlugInRegistration",
}
