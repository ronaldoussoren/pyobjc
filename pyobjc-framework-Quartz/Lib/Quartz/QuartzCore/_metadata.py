...
#
# Last update: Thu Mar  8 12:20:54 2012
...
misc.update({'CATransform3D': objc.createStructType('CATransform3D', sel32or64('{CATransform3D=ffffffffffffffff}', '{CATransform3D=dddddddddddddddd}'), [])})
...
contants = constants + '$CATransform3DIdentity@%s$'%(sel32or64('{CATransform3D=ffffffffffffffff}', '{CATransform3D=dddddddddddddddd}'),)
...
try:
    ...
    r('CALayer', b'setShouldRasterize:', {'arguments': {2: {'type': b'Z'}}})
    r('CALayer', b'shouldArchiveValueForKey:', {'retval': {'type': b'Z'}})
    r('CALayer', b'shouldRasterize', {'retval': {'type': b'Z'}})
    r('CAOpenGLLayer', b'canDrawInCGLContext:pixelFormat:forLayerTime:displayTime:', {'retval': {'type': b'Z'}, 'arguments': {5: {'type': sel32or64(b'^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssLLLssss}QQ}', b'^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssIIIssss}QQ}')}}})
    r('CAOpenGLLayer', b'drawInCGLContext:pixelFormat:forLayerTime:displayTime:', {'arguments': {5: {'type': sel32or64(b'^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssLLLssss}QQ}', b'^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssIIIssss}QQ}')}}})
    ...
    r('CARenderer', b'beginFrameAtTime:timeStamp:', {'arguments': {3: {'type': sel32or64(b'^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssLLLssss}QQ}', b'^{_CVTimeStamp=IiqQdq{CVSMPTETime=ssIIIssss}QQ}')}}})
    r('CAReplicatorLayer', b'preservesDepth', {'retval': {'type': b'Z'}})
    r('CAReplicatorLayer', b'setPreservesDepth:', {'arguments': {2: {'type': b'Z'}}})
    r('CATextLayer', b'font', {'retval': {'type': b'@'}})
    ...
    r('CIFaceFeature', b'hasLeftEyePosition', {'retval': {'type': b'Z'}})
    r('CIFaceFeature', b'hasMouthPosition', {'retval': {'type': b'Z'}})
    r('CIFaceFeature', b'hasRightEyePosition', {'retval': {'type': b'Z'}})
    r('CIFilter', b'apply:', {'variadic': True})
    r('CIFilter', b'filterWithName:keysAndValues:', {'variadic': True})
    ...
    r('CIImage', b'imageWithTexture:size:flipped:colorSpace:', {'arguments': {4: {'type': b'Z'}}})
    r('CIImage', b'initWithTexture:size:flipped:colorSpace:', {'arguments': {4: {'type': b'Z'}}})
    r('CIPlugIn', b'loadPlugIn:allowExecutableCode:', {'arguments': {3: {'type': b'Z'}}})
    r('CIPlugIn', b'loadPlugIn:allowNonExecutable:', {'arguments': {3: {'type': b'Z'}}})
    r('CISampler', b'initWithImage:keysAndValues:', {'variadic': True})
    r('CISampler', b'samplerWithImage:keysAndValues:', {'variadic': True})
...
try:
    ...
    r('NSObject', b'beginTime', {'retval': {'type': b'd'}})
    r('NSObject', b'duration', {'retval': {'type': b'd'}})
    r('NSObject', b'fillMode', {'retval': {'type': b'@'}})
    r('NSObject', b'filterWithName:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r('NSObject', b'load:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'^v'}}})
    r('NSObject', b'repeatCount', {'retval': {'type': b'f'}})
    r('NSObject', b'repeatDuration', {'retval': {'type': b'd'}})
    r('NSObject', b'runActionForKey:object:arguments:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r('NSObject', b'setAutoreverses:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'Z'}}})
    r('NSObject', b'setBeginTime:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'd'}}})
    r('NSObject', b'setDuration:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'd'}}})
    r('NSObject', b'setFillMode:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r('NSObject', b'setRepeatCount:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'f'}}})
    r('NSObject', b'setRepeatDuration:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'd'}}})
    r('NSObject', b'setSpeed:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'f'}}})
    r('NSObject', b'setTimeOffset:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'd'}}})
    r('NSObject', b'speed', {'retval': {'type': b'f'}})
    r('NSObject', b'timeOffset', {'retval': {'type': b'd'}})
finally:
    objc._updatingMetadata(False)
r = objc.registerMetaDataForSelector
objc._updatingMetadata(True)
try:
    r('NSObject', b'actionForLayer:forKey:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r('NSObject', b'animationDidStart:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r('NSObject', b'animationDidStop:finished:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'Z'}}})
    r('NSObject', b'displayLayer:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r('NSObject', b'drawLayer:inContext:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^{CGContext=}'}}})
    r('NSObject', b'invalidateLayoutOfLayer:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r('NSObject', b'layoutSublayersOfLayer:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r('NSObject', b'layoutSublayersOfLayer:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r('NSObject', b'preferredSizeOfLayer:', {'retval': {'type': sel32or64(b'{CGSize=ff}', b'{CGSize=dd}')}, 'arguments': {2: {'type': b'@'}}})
    r('NSObject', b'provideImageData:bytesPerRow:origin::size::userInfo:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'^v'}, 3: {'type': b'L'}, 4: {'type': b'L'}, 5: {'type': b'L'}, 6: {'type': b'L'}, 7: {'type': b'L'}, 8: {'type': b'@'}}})
finally:
    objc._updatingMetadata(False)
protocols={'CAAnimationDelegate': objc.informal_protocol('CAAnimationDelegate', [objc.selector(None, 'animationDidStart:', b'v@:@', isRequired=False), objc.selector(None, 'animationDidStop:finished:', b'v@:@Z', isRequired=False)]), 'CALayerDelegate': objc.informal_protocol('CALayerDelegate', [objc.selector(None, 'drawLayer:inContext:', b'v@:@^{CGContext=}', isRequired=False), objc.selector(None, 'actionForLayer:forKey:', b'@@:@@', isRequired=False), objc.selector(None, 'displayLayer:', b'v@:@', isRequired=False), objc.selector(None, 'layoutSublayersOfLayer:', b'v@:@', isRequired=False)]), 'CIImageProvider': objc.informal_protocol('CIImageProvider', [objc.selector(None, 'provideImageData:bytesPerRow:origin::size::userInfo:', b'v@:^vLLLLL@', isRequired=False)]), 'CALayoutManager': objc.informal_protocol('CALayoutManager', [objc.selector(None, 'preferredSizeOfLayer:', sel32or64(b'{CGSize=ff}@:@', b'{CGSize=dd}@:@'), isRequired=False), objc.selector(None, 'layoutSublayersOfLayer:', b'v@:@', isRequired=False), objc.selector(None, 'invalidateLayoutOfLayer:', b'v@:@', isRequired=False)])}
expressions = {}
