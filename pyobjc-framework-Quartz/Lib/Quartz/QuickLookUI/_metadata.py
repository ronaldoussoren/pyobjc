...
#
# Last update: Thu Jul 11 22:27:13 2019
...
try:
    ...
    r(b'NSObject', b'preparePreviewOfFileAtURL:completionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@?'}}})
