...
#
# Last update: Fri Jul 14 08:50:00 2017
...
misc.update({})
aliases = {'kPDFDestinationUnspecifiedValue': 'FLT_MAX', 'kPDFImageArea': 'FLT_MX'}
...
try:
    ...
    r(b'NSObject', b'classForAnnotationClass:', {'retval': {'type': '#'}, 'arguments': {2: {'type': b'#'}}})
    r(b'NSObject', b'classForAnnotationType:', {'retval': {'type': '#'}})
    r(b'NSObject', b'classForPage', {'retval': {'type': '#'}})
    ...
    r(b'PDFAnnotation', b'isHighlighted', {'retval': {'type': 'Z'}})
    r(b'PDFAnnotation', b'isListChoice', {'retval': {'type': 'Z'}})
    r(b'PDFAnnotation', b'isMultiline', {'retval': {'type': 'Z'}})
    r(b'PDFAnnotation', b'isOpen', {'retval': {'type': 'Z'}})
    ...
    r(b'PDFAnnotation', b'setAllowsToggleToOff:', {'arguments': {2: {'type': 'Z'}}})
    r(b'PDFAnnotation', b'setBoolean:forAnnotationKey:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': 'Z'}}})
    r(b'PDFAnnotation', b'setComb:', {'arguments': {2: {'type': 'Z'}}})
    r(b'PDFAnnotation', b'setHighlighted:', {'arguments': {2: {'type': 'Z'}}})
    r(b'PDFAnnotation', b'setListChoice:', {'arguments': {2: {'type': 'Z'}}})
    r(b'PDFAnnotation', b'setMultiline:', {'arguments': {2: {'type': 'Z'}}})
    r(b'PDFAnnotation', b'setOpen:', {'arguments': {2: {'type': 'Z'}}})
    r(b'PDFAnnotation', b'setRadiosInUnison:', {'arguments': {2: {'type': 'Z'}}})
    r(b'PDFAnnotation', b'setReadOnly:', {'arguments': {2: {'type': 'Z'}}})
