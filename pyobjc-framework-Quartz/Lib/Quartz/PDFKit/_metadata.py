...
#
# Last update: Thu Jul 11 13:59:50 2019
...
try:
    ...
    r(b'NSObject', b'PDFViewWillChangeScaleFactor:toScale:', {'required': False, 'retval': {'type': b'd'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'd'}}})
