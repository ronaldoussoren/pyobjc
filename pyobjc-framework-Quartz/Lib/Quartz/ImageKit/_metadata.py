...
#
# Last update: Sun Aug  4 21:30:28 2019
...
try:
    ...
    r(
        ...
        {
            "retval": {"type": b"@"},
            "arguments": {2: {"type": b"@"}, 3: {"type": sel32or64(b"I", b"L")}},
        },
    )
    r(
        b"NSObject",
    ...
    r(
        ...
        {"retval": {"type": sel32or64(b"I", b"L")}, "arguments": {2: {"type": b"@"}}},
    )
    r(
        b"NSObject",
...
protocols = {
    "IKImageBrowserItem": objc.informal_protocol(
        ...
        [
            ...
            objc.selector(
                None, b"imageVersion", sel32or64(b"I@:", b"Q@:"), isRequired=False
            ),
