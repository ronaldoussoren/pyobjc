...
#
# Last update: Wed Jan 11 16:41:13 2023
#
# flake8: noqa
...
misc.update(
    {
        ...
        "BluetoothHCILEUsedFeatures": objc.createStructType(
        ...
        "BluetoothHCILESupportedFeatures": objc.createStructType(
        ...
        "BluetoothHCIEventReturnLinkKeysResults": objc.createStructType(
            "IOBluetooth.BluetoothHCIEventReturnLinkKeysResults",
            b"{BluetoothHCIEventReturnLinkKeysResults=C{_struct BluetoothHCIEventReturnLinkKeysResults::(unnamed at /Users/ronald/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.1.sdk/System/Library/Frameworks/IOBluetooth.framework/Headers/Bluetooth.h:2521:2)={BluetoothDeviceAddress=[6C]}{BluetoothKey=[16C]}}[1{={BluetoothDeviceAddress=[6C]}{BluetoothKey=[16C]}}]}",
            ["numLinkKeys", "linkKeys"],
        ),
...
functions = {
    "OBEXAddApplicationParameterHeader": (b"i^vI^{__CFDictionary=}",),
    "OBEXSessionAbort": (
        b"i^{OpaqueOBEXSessionRef=}^vQ^?^v",
        "",
        {
            "arguments": {
                3: {
                    "callable": {
                        ...
                        "arguments": {
                            0: {
                                "type": b"^{OBEXSessionEvent=I^{OpaqueOBEXSessionRef=}^vZ^v^v(_union OBEXSessionEvent::(unnamed at /Users/ronald/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.1.sdk/System/Library/Frameworks/IOBluetooth.framework/Headers/OBEX.h:792:2)={OBEXConnectCommandResponseData=C^vQSCC}{OBEXDisconnectCommandResponseData=C^vQ}{OBEXPutCommandResponseData=C^vQ}{OBEXGetCommandResponseData=C^vQ}{OBEXSetPathCommandResponseData=C^vQCC}{OBEXAbortCommandResponseData=C^vQ}{OBEXConnectCommandData=^vQSCC}{OBEXDisconnectCommandData=^vQ}{OBEXPutCommandData=^vQQ}{OBEXGetCommandData=^vQ}{OBEXSetPathCommandData=^vQCC}{OBEXAbortCommandData=^vQ}{OBEXErrorData=i^vQ})(={OBEXConnectCommandResponseData=C^vQSCC}{OBEXDisconnectCommandResponseData=C^vQ}{OBEXPutCommandResponseData=C^vQ}{OBEXGetCommandResponseData=C^vQ}{OBEXSetPathCommandResponseData=C^vQCC}{OBEXAbortCommandResponseData=C^vQ}{OBEXConnectCommandData=^vQSCC}{OBEXDisconnectCommandData=^vQ}{OBEXPutCommandData=^vQQ}{OBEXGetCommandData=^vQ}{OBEXSetPathCommandData=^vQCC}{OBEXAbortCommandData=^vQ}{OBEXErrorData=i^vQ})}"
                            }
                        },
                    }
                }
    ...
    "OBEXSessionGetResponse": (
        b"i^{OpaqueOBEXSessionRef=}C^vQ^?^v",
        "",
        {
            "arguments": {
                4: {
    ...
    "OBEXCreateVEvent": (
        b"^{__CFData=}^cI^cI^cI^cI^cI^cI^cI^cI^cI",
        "",
    ...
    "OBEXSessionConnectResponse": (
        b"i^{OpaqueOBEXSessionRef=}CCS^vQ^?^v",
        "",
        {
            "arguments": {
                6: {
    ...
    "OBEXCreateVCard": (
        b"^{__CFData=}^vI^vI^vI^vI^vI^vI^vI^vI^vI^vI^vI^vI^vI^vI",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "OBEXSessionHasOpenOBEXConnection": (b"i^{OpaqueOBEXSessionRef=}^Z",),
    "OBEXAddObjectClassHeader": (b"i^vI^{__CFDictionary=}",),
    "IOBluetoothOBEXSessionCreateWithIncomingIOBluetoothRFCOMMChannel": (
        b"i^{OpaqueIOBluetoothObjectRef=}^?^v^^{OpaqueOBEXSessionRef=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "IOBluetoothFindNumberOfRegistryEntriesOfClassName": (b"q^c",),
    "IOBluetoothRemoveSCOAudioDevice": (b"i^{OpaqueIOBluetoothObjectRef=}",),
    "OBEXSessionGet": (
        b"i^{OpaqueOBEXSessionRef=}Z^vQ^?^v",
        "",
        {
            "arguments": {
                4: {
    ...
    "IOBluetoothNSStringFromDeviceAddress": (b"@^{BluetoothDeviceAddress=[6C]}",),
    "OBEXAddLengthHeader": (b"iI^{__CFDictionary=}",),
    "IOBluetoothUnpackDataList": (
        selAorI(b"qQ^v^c^c", b"qQ^v^c[1{__va_list_tag=II^v^v}]"),
    ),
    ...
    "OBEXGetHeaders": (b"^{__CFDictionary=}^vQ",),
    "IOBluetoothUnpackData": (b"qQ^v^c", "", {"variadic": True}),
    "IOBluetoothPackData": (b"q^v^c", "", {"variadic": True}),
    "OBEXAddTimeISOHeader": (b"i^vI^{__CFDictionary=}",),
    ...
    "OBEXAddTargetHeader": (b"i^vI^{__CFDictionary=}",),
    "OBEXAddUserDefinedHeader": (b"i^vI^{__CFDictionary=}",),
    "IOBluetoothNSStringToDeviceAddress": (b"i@^{BluetoothDeviceAddress=[6C]}",),
    ...
    "OBEXAddAuthorizationResponseHeader": (b"i^vI^{__CFDictionary=}",),
    "OBEXSessionGetAvailableCommandPayloadLength": (b"i^{OpaqueOBEXSessionRef=}C^S",),
    "OBEXSessionPut": (
        b"i^{OpaqueOBEXSessionRef=}Z^vQ^vQ^?^v",
        "",
        {
            "arguments": {
                6: {
    ...
    "OBEXSessionConnect": (
        b"i^{OpaqueOBEXSessionRef=}CS^vQ^?^v",
        "",
        {
            "arguments": {
                5: {
    ...
    "OBEXSessionSetPath": (
        b"i^{OpaqueOBEXSessionRef=}CC^vQ^?^v",
        "",
        {
            "arguments": {
                5: {
    ...
    "OBEXAddWhoHeader": (b"i^vI^{__CFDictionary=}",),
    ...
    "OBEXAddByteSequenceHeader": (b"i^vI^{__CFDictionary=}",),
    "OBEXAddBodyHeader": (b"i^vIZ^{__CFDictionary=}",),
    ...
    "OBEXAddAuthorizationChallengeHeader": (b"i^vI^{__CFDictionary=}",),
    "OBEXAddHTTPHeader": (b"i^vI^{__CFDictionary=}",),
    ...
    "OBEXAddConnectionIDHeader": (b"i^vI^{__CFDictionary=}",),
    "IOBluetoothNSStringFromDeviceAddressColon": (b"@^{BluetoothDeviceAddress=[6C]}",),
    "OBEXAddTypeHeader": (b"i^{__CFString=}^{__CFDictionary=}",),
    "OBEXSessionGetMaxPacketLength": (b"i^{OpaqueOBEXSessionRef=}^S",),
    ...
    "IOBluetoothPackDataList": (
        selAorI(b"q^v^c^c", b"q^v^c[1{__va_list_tag=II^v^v}]"),
    ),
...
try:
    ...
    r(
        ...
        b"l2capChannelData:data:length:",
        {
            "required": False,
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"^v"}, 4: {"type": b"Q"}},
        },
    )
    r(
        b"NSObject",
