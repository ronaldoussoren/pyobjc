...
#
# Last update: Tue Jun 30 22:19:44 2026
#
# flake8: noqa
...
misc.update({"ISyncChangeType": NewType("ISyncChangeType", int)})
misc.update({})
...
try:
    ...
    r(
        ...
        b"startAsynchronousSync:",
        {
            "retval": {"type": "Z"},
            "arguments": {
                2: {"null_accepted": True, "name": "outError", "type_modifier": b"o"}
            },
        },
    )
...
expressions = {}
formal_protocols = {
    "ISyncConflictPropertyType": "ISyncConflictPropertyType",
    "ISyncFiltering": "ISyncFiltering",
    "ISyncSessionDriverDataSource": "ISyncSessionDriverDataSource",
