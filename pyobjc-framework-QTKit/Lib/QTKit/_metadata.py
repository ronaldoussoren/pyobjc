...
#
# Last update: Sat Mar 21 15:29:39 2020
#
# flake8: noqa
...
misc.update(
    {
        "QTTimeRange": objc.createStructType(
            "QTTimeRange",
            sel32or64(
                b"{_QTTimeRange={_QTTime=qll}{_QTTime=qll}}",
                b"{_QTTimeRange={_QTTime=qqq}{_QTTime=qqq}}",
            ),
            ["time", "duration"],
        ),
        "QTTime": objc.createStructType(
            "QTTime",
            sel32or64(b"{_QTTime=qll}", b"{_QTTime=qqq}"),
...
constants = constants + "$QTIndefiniteTime@%s$" % (
    sel32or64("{_QTTime=qll}", "{_QTTime=qqq}"),
)
constants = constants + "$QTZeroTime@%s$" % (
    sel32or64("{_QTTime=qll}", "{_QTTime=qqq}"),
)
...
misc.update({})
functions = {
    "QTStringForOSType": (sel32or64(b"@L", b"@I"),),
    "QTMakeTimeWithTimeRecord": (
        sel32or64(
            b"{_QTTime=qll}{TimeRecord={wide=Ll}l^{TimeBaseRecord=}}",
            b"{_QTTime=qqq}{TimeRecord={wide=Ii}i^{TimeBaseRecord=}}",
        ),
    ),
    "QTMakeTimeRange": (
        sel32or64(
            b"{_QTTimeRange={_QTTime=qll}{_QTTime=qll}}{_QTTime=qll}{_QTTime=qll}",
            b"{_QTTimeRange={_QTTime=qqq}{_QTTime=qqq}}{_QTTime=qqq}{_QTTime=qqq}",
        ),
    ),
    "QTStringFromTime": (sel32or64(b"@{_QTTime=qll}", b"@{_QTTime=qqq}"),),
    "QTTimeCompare": (
        sel32or64(b"i{_QTTime=qll}{_QTTime=qll}", b"q{_QTTime=qqq}{_QTTime=qqq}"),
    ),
    "QTTimeDecrement": (
        sel32or64(
            b"{_QTTime=qll}{_QTTime=qll}{_QTTime=qll}",
            b"{_QTTime=qqq}{_QTTime=qqq}{_QTTime=qqq}",
        ),
    ),
    "QTMakeTimeWithTimeInterval": (sel32or64(b"{_QTTime=qll}d", b"{_QTTime=qqq}d"),),
    ...
    "QTOSTypeForString": (sel32or64(b"L@", b"I@"),),
    "QTTimeRangeEnd": (
        sel32or64(
            b"{_QTTime=qll}{_QTTimeRange={_QTTime=qll}{_QTTime=qll}}",
            b"{_QTTime=qqq}{_QTTimeRange={_QTTime=qqq}{_QTTime=qqq}}",
        ),
    ),
    "QTTimeFromString": (sel32or64(b"{_QTTime=qll}@", b"{_QTTime=qqq}@"),),
    "QTGetTimeInterval": (
        sel32or64(b"Z{_QTTime=qll}^d", b"Z{_QTTime=qqq}^d"),
        "",
        {"arguments": {1: {"type_modifier": "o"}}},
    ),
    "QTTimeInTimeRange": (
        sel32or64(
            b"Z{_QTTime=qll}{_QTTimeRange={_QTTime=qll}{_QTTime=qll}}",
            b"Z{_QTTime=qqq}{_QTTimeRange={_QTTime=qqq}{_QTTime=qqq}}",
        ),
    ),
    "QTUnionTimeRange": (
        sel32or64(
            b"{_QTTimeRange={_QTTime=qll}{_QTTime=qll}}{_QTTimeRange={_QTTime=qll}{_QTTime=qll}}{_QTTimeRange={_QTTime=qll}{_QTTime=qll}}",
            b"{_QTTimeRange={_QTTime=qqq}{_QTTime=qqq}}{_QTTimeRange={_QTTime=qqq}{_QTTime=qqq}}{_QTTimeRange={_QTTime=qqq}{_QTTime=qqq}}",
        ),
    ),
    "QTMakeTimeScaled": (
        sel32or64(b"{_QTTime=qll}{_QTTime=qll}l", b"{_QTTime=qqq}{_QTTime=qqq}q"),
    ),
    "QTTimeIncrement": (
        sel32or64(
            b"{_QTTime=qll}{_QTTime=qll}{_QTTime=qll}",
    ...
    "QTTimeIsIndefinite": (sel32or64(b"Z{_QTTime=qll}", b"Z{_QTTime=qqq}"),),
    "QTStringFromSMPTETime": (
        sel32or64(b"@{SMPTETime=ssLLLssss}", b"@{SMPTETime=ssIIIssss}"),
    ),
    "QTMakeTime": (sel32or64(b"{_QTTime=qll}ql", b"{_QTTime=qqq}qq"),),
    ...
    "QTEqualTimeRanges": (
        sel32or64(
            b"Z{_QTTimeRange={_QTTime=qll}{_QTTime=qll}}{_QTTimeRange={_QTTime=qll}{_QTTime=qll}}",
            b"Z{_QTTimeRange={_QTTime=qqq}{_QTTime=qqq}}{_QTTimeRange={_QTTime=qqq}{_QTTime=qqq}}",
        ),
    ),
    ...
    "QTGetTimeRecord": (
        sel32or64(
            b"Z{_QTTime=qll}^{TimeRecord={wide=Ii}i^{TimeBaseRecord}}",
            b"Z{_QTTime=qqq}^{TimeRecord={wide=Ii}i^{TimeBaseRecord}}",
        ),
        "",
        {"arguments": {1: {"type_modifier": "o"}}},
    ),
...
aliases = {
    "AVAILABLE_QTKIT_VERSION_7_0_AND_LATER_BUT_DEPRECATED_IN_QTKIT_VERSION_7_2": "AVAILABLE_QTKIT_VERSION_7_0_AND_LATER",
    "AVAILABLE_QTKIT_VERSION_7_0_AND_LATER_BUT_DEPRECATED_IN_QTKIT_VERSION_7_6_3": "AVAILABLE_QTKIT_VERSION_7_0_AND_LATER",
    "AVAILABLE_QTKIT_VERSION_7_0_AND_LATER_BUT_DEPRECATED_IN_QTKIT_VERSION_7_7_3": "AVAILABLE_QTKIT_VERSION_7_0_AND_LATER",
    "QTMovieOperationEndPhase": "movieProgressClose",
    "AVAILABLE_QTKIT_VERSION_7_2_AND_LATER": "WEAK_IMPORT_ATTRIBUTE",
    "AVAILABLE_QTKIT_VERSION_7_6_3_AND_LATER_BUT_DEPRECATED_IN_QTKIT_VERSION_7_7_3": "AVAILABLE_QTKIT_VERSION_7_6_3_AND_LATER",
    "AVAILABLE_QTKIT_VERSION_7_7_AND_LATER": "WEAK_IMPORT_ATTRIBUTE",
    "NSIntegerMax": "LONG_MAX",
    "AVAILABLE_QTKIT_VERSION_7_2_AND_LATER_BUT_DEPRECATED_IN_QTKIT_VERSION_7_7": "AVAILABLE_QTKIT_VERSION_7_2_AND_LATER",
    "AVAILABLE_QTKIT_VERSION_7_6_6_AND_LATER_BUT_DEPRECATED_IN_QTKIT_VERSION_7_7_3": "AVAILABLE_QTKIT_VERSION_7_6_6_AND_LATER",
    "QTMovieOperationBeginPhase": "movieProgressOpen",
    "AVAILABLE_QTKIT_VERSION_7_2_AND_LATER_BUT_DEPRECATED_IN_QTKIT_VERSION_7_6_3": "AVAILABLE_QTKIT_VERSION_7_2_AND_LATER",
    "AVAILABLE_QTKIT_VERSION_7_7_2_AND_LATER": "WEAK_IMPORT_ATTRIBUTE",
    "AVAILABLE_QTKIT_VERSION_7_2_AND_LATER_BUT_DEPRECATED_IN_QTKIT_VERSION_7_7_3": "AVAILABLE_QTKIT_VERSION_7_2_AND_LATER",
    "AVAILABLE_QTKIT_VERSION_7_6_6_AND_LATER": "WEAK_IMPORT_ATTRIBUTE",
    ...
    "AVAILABLE_QTKIT_VERSION_7_7_3_AND_LATER": "WEAK_IMPORT_ATTRIBUTE",
    "NSIntegerMin": "LONG_MIN",
    "AVAILABLE_QTKIT_VERSION_7_6_3_AND_LATER": "WEAK_IMPORT_ATTRIBUTE",
    "AVAILABLE_QTKIT_VERSION_7_0_AND_LATER": "WEAK_IMPORT_ATTRIBUTE",
    "AVAILABLE_QTKIT_VERSION_7_7_AND_LATER_BUT_DEPRECATED_IN_QTKIT_VERSION_7_7_3": "AVAILABLE_QTKIT_VERSION_7_7_AND_LATER",
}
...
try:
    r(
        b"NSCoder",
        b"decodeQTTimeForKey:",
        {"retval": {"type": sel32or64(b"{_QTTime=qll}", b"{_QTTime=qqq}")}},
    )
    r(
        b"NSCoder",
        b"decodeQTTimeRangeForKey:",
        {
            "retval": {
                "type": sel32or64(
                    b"{_QTTimeRange={_QTTime=qll}{_QTTime=qll}}",
    ...
    r(
        b"NSCoder",
        b"encodeQTTime:forKey:",
        {"arguments": {2: {"type": sel32or64(b"{_QTTime=qll}", b"{_QTTime=qqq}")}}},
    )
    r(
        b"NSCoder",
        b"encodeQTTimeRange:forKey:",
        {
            "arguments": {
                2: {
                    "type": sel32or64(
    ...
    r(
        b"NSObject",
        b"captureOutput:didDropVideoFrameWithSampleBuffer:fromConnection:",
        {
            "retval": {"type": b"v"},
    ...
    r(
        b"NSObject",
        b"captureOutput:didFinishRecordingToOutputFileAtURL:forConnections:dueToError:",
        {
            "retval": {"type": b"v"},
            "arguments": {
                2: {"type": b"@"},
    ...
    r(
        b"NSObject",
        b"captureOutput:didOutputAudioSampleBuffer:fromConnection:",
        {
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}, 4: {"type": b"@"}},
        },
    ...
    r(
        b"NSObject",
        b"captureOutput:didOutputVideoFrame:withSampleBuffer:fromConnection:",
        {
            "retval": {"type": b"v"},
            "arguments": {
                2: {"type": b"@"},
    ...
    r(
        b"NSObject",
        b"captureOutput:didPauseRecordingToOutputFileAtURL:forConnections:",
        {
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}, 4: {"type": b"@"}},
        },
    ...
    r(
        b"NSObject",
        b"captureOutput:didResumeRecordingToOutputFileAtURL:forConnections:",
        {
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}, 4: {"type": b"@"}},
        },
    ...
    r(
        b"NSObject",
        b"captureOutput:didStartRecordingToOutputFileAtURL:forConnections:",
        {
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}, 4: {"type": b"@"}},
        },
    ...
    r(
        b"NSObject",
        b"captureOutput:mustChangeOutputFileAtURL:forConnections:dueToError:",
        {
            "retval": {"type": b"v"},
            "arguments": {
                2: {"type": b"@"},
    ...
    r(
        b"NSObject",
        b"captureOutput:shouldChangeOutputFileAtURL:forConnections:dueToError:",
        {
            "retval": {"type": "Z"},
            "arguments": {
                2: {"type": b"@"},
    ...
    r(
        b"NSObject",
        b"captureOutput:willFinishRecordingToOutputFileAtURL:forConnections:dueToError:",
        {
            "retval": {"type": b"v"},
            "arguments": {
                2: {"type": b"@"},
    ...
    r(
        b"NSObject",
        b"captureOutput:willStartRecordingToOutputFileAtURL:forConnections:",
        {
            "retval": {"type": b"v"},
            "arguments": {2: {"type": b"@"}, 3: {"type": b"@"}, 4: {"type": b"@"}},
        },
    ...
    r(
        b"NSObject",
        b"menuForEventDelegate:",
        {"retval": {"type": b"@"}, "arguments": {2: {"type": b"@"}}},
    )
    r(b"NSObject", b"movie:linkToURL:", {"retval": {"type": "Z"}})
    r(
        b"NSObject",
        b"movie:shouldContinueOperation:withPhase:atPercent:withAttributes:",
        {"retval": {"type": "Z"}, "arguments": {4: {"type": "i"}}},
    )
    ...
    r(
        b"QTCaptureDecompressedVideoOutput",
        b"automaticallyDropsLateVideoFrames",
        {"retval": {"type": b"Z"}},
    )
    r(
        b"QTCaptureDecompressedVideoOutput",
        b"setAutomaticallyDropsLateVideoFrames:",
    ...
    r(
        b"QTCaptureFileOutput",
        b"maximumRecordedDuration",
        {"retval": {"type": sel32or64(b"{_QTTime=qll}", b"{_QTTime=qqq}")}},
    )
    r(
        b"QTCaptureFileOutput",
    ...
    r(
        b"QTCompressionOptions",
        b"isEqualToCompressionOptions:",
        {"retval": {"type": "Z"}},
    )
    r(b"QTDataReference", b"dataRef", {"retval": {"type": "^*"}})
    r(
        b"QTDataReference",
        b"dataReferenceWithDataRef:type:",
        {"arguments": {2: {"type": "^*"}}},
    )
    ...
    r(
        b"QTExportSession",
        b"initWithMovie:exportOptions:outputURL:error:",
    ...
    r(
        b"QTMedia",
        b"initWithQuickTimeMedia:error:",
        {"arguments": {2: {"type": "^^{MediaType}"}, 3: {"type_modifier": b"o"}}},
    )
    r(
        b"QTMedia",
        b"mediaWithQuickTimeMedia:error:",
        {"arguments": {2: {"type": "^^{MediaType}"}, 3: {"type_modifier": b"o"}}},
    )
    r(b"QTMedia", b"quickTimeMedia", {"retval": {"type": "^^{MediaType}"}})
    r(
        b"QTMovie",
        b"addChapters:withAttributes:error:",
        {"arguments": {4: {"type_modifier": b"o"}}},
    )
    r(
        b"QTMovie",
        b"addImage:forDuration:withAttributes:",
        {"arguments": {3: {"type": sel32or64(b"{_QTTime=qll}", b"{_QTTime=qqq}")}}},
    )
    ...
    r(
        b"QTMovie",
        b"frameImageAtTime:withAttributes:error:",
        {
            "retval": {"type": "^v"},
            "arguments": {
                2: {"type": sel32or64(b"{_QTTime=qll}", b"{_QTTime=qqq}")},
                4: {"type_modifier": b"o"},
            },
        },
    )
    ...
    r(
        b"QTMovie",
        b"initToWritableData:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"QTMovie",
        b"initToWritableDataReference:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"QTMovie",
        b"initToWritableFile:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"QTMovie",
        b"initWithAttributes:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(b"QTMovie", b"initWithData:error:", {"arguments": {3: {"type_modifier": b"o"}}})
    r(
        b"QTMovie",
        b"initWithDataReference:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(b"QTMovie", b"initWithFile:error:", {"arguments": {3: {"type_modifier": b"o"}}})
    r(
        b"QTMovie",
        b"initWithMovie:timeRange:error:",
        {
            "arguments": {
                3: {
                    "type": sel32or64(
    ...
    r(
        b"QTMovie",
        b"initWithPasteboard:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"QTMovie",
        b"initWithQuickTimeMovie:disposeWhenDone:error:",
        {
            "arguments": {
                2: {"type": "^^{MovieType}"},
                3: {"type": "Z"},
    ...
    r(
        b"QTMovie",
        b"insertSegmentOfMovie:fromRange:scaledToRange:",
        {
            "arguments": {
                3: {
                    "type": sel32or64(
    ...
    r(
        b"QTMovie",
        b"insertSegmentOfMovie:timeRange:atTime:",
        {
            "arguments": {
                3: {
                    "type": sel32or64(
                ...
                4: {"type": sel32or64(b"{_QTTime=qll}", b"{_QTTime=qqq}")},
            }
        },
    )
    r(
        b"QTMovie",
        b"insertSegmentOfTrack:fromRange:scaledToRange:",
        {
            "arguments": {
                3: {
                    "type": sel32or64(
    ...
    r(
        b"QTMovie",
        b"insertSegmentOfTrack:timeRange:atTime:",
        {
            "arguments": {
                3: {
                    "type": sel32or64(
    ...
    r(
        b"QTMovie",
        b"movieWithAttributes:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(b"QTMovie", b"movieWithData:error:", {"arguments": {3: {"type_modifier": b"o"}}})
    r(
        b"QTMovie",
        b"movieWithDataReference:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(b"QTMovie", b"movieWithFile:error:", {"arguments": {3: {"type_modifier": b"o"}}})
    r(
        b"QTMovie",
        b"movieWithPasteboard:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"QTMovie",
        b"movieWithQuickTimeMovie:disposeWhenDone:error:",
        {
            "arguments": {
                2: {"type": "^^{MovieType}"},
                3: {"type": "Z"},
    ...
    r(
        ...
        b"scaleSegment:newDuration:",
        {
            "arguments": {
                ...
                3: {"type": sel32or64(b"{_QTTime=qll}", b"{_QTTime=qqq}")},
            }
        },
    )
    r(
    ...
    r(
        b"QTMovie",
        b"setVisualContext:",
        {"arguments": {2: {"type": "^{OpaqueQTVisualContext=}"}}},
    )
    r(
        b"QTMovie",
        b"startTimeOfChapter:",
        {"retval": {"type": sel32or64(b"{_QTTime=qll}", b"{_QTTime=qqq}")}},
    )
    r(
        b"QTMovie",
        b"trackByInsertingSegmentOfTrack:fromRange:scaledToRange:",
        {
            "arguments": {
                3: {
                    "type": sel32or64(
    ...
    r(
        b"QTMovie",
        b"trackByInsertingSegmentOfTrack:timeRange:atTime:",
        {
            "arguments": {
                3: {
                    "type": sel32or64(
    ...
    r(
        b"QTMovie",
        b"writeToFile:withAttributes:error:",
        {"retval": {"type": "Z"}, "arguments": {4: {"type_modifier": b"o"}}},
    )
    r(
        b"QTMovieModernizer",
        b"modernizeWithCompletionHandler:",
        {
            "arguments": {
                2: {
                    "callable": {
    ...
    r(
        b"QTSampleBuffer",
        b"getAudioStreamPacketDescriptions:inRange:",
        {"retval": {"type": "Z"}},
    )
    r(
        b"QTSampleBuffer",
    ...
    r(
        b"QTTrack",
        b"initWithQuickTimeTrack:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
    r(
        b"QTTrack",
    ...
    r(
        b"QTTrack",
        b"trackWithQuickTimeTrack:error:",
        {"arguments": {3: {"type_modifier": b"o"}}},
    )
finally:
    objc._updatingMetadata(False)
protocols = {
    "QTCaptureDecompressedVideoOutput_Delegate": objc.informal_protocol(
        "QTCaptureDecompressedVideoOutput_Delegate",
        [
            objc.selector(
                None,
                b"captureOutput:didOutputVideoFrame:withSampleBuffer:fromConnection:",
    ...
    "QTMovieView_Delegate": objc.informal_protocol(
        "QTMovieView_Delegate",
        [
            objc.selector(None, b"view:willDisplayImage:", b"@@:@@", isRequired=False),
            objc.selector(None, b"menuForEventDelegate:", b"@@:@", isRequired=False),
        ],
    ),
    "QTCaptureVideoPreviewOutput_Delegate": objc.informal_protocol(
        "QTCaptureVideoPreviewOutput_Delegate",
        [
            objc.selector(
                None,
                b"captureOutput:didOutputVideoFrame:withSampleBuffer:fromConnection:",
    ...
    "QTCaptureView_Delegate": objc.informal_protocol(
        "QTCaptureView_Delegate",
        [objc.selector(None, b"view:willDisplayImage:", b"@@:@@", isRequired=False)],
    ),
    "QTCaptureDecompressedAudioOutput_Delegate": objc.informal_protocol(
        "QTCaptureDecompressedAudioOutput_Delegate",
        [
            objc.selector(
                None,
                b"captureOutput:didOutputAudioSampleBuffer:fromConnection:",
    ...
    "QTCaptureFileOutput_Delegate": objc.informal_protocol(
        "QTCaptureFileOutput_Delegate",
        [
            objc.selector(
                None,
                b"captureOutput:didOutputSampleBuffer:fromConnection:",
    ...
    "QTMovie_Delegate": objc.informal_protocol(
        "QTMovie_Delegate",
        [
            objc.selector(None, b"setDelegate:", b"v@:@", isRequired=False),
            objc.selector(None, b"delegate", b"@@:", isRequired=False),
        ],
    ),
}
expressions = {}
