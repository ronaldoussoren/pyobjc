...
project = u'PyObjC'
copyright = u'2017, Ronald Oussoren'
...
pygments_style = 'pygments.styles.friendly.FriendlyStyle'

# A list of ignored prefixes for module index sorting.
modindex_common_prefix = [ 'objc.' ]
...
# of the sidebar.
#html_logo = "_static/pyobjc-logo.jpg"
...
html_sidebars = {
    '**': [ 'localtoc.html', 'links.html', 'donate.html', 'searchbox.html' ],
}
...
#html_use_opensearch = 'http://packages.python.org/pyobjc/'
