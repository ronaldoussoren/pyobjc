...
#
# Last update: Sun Jun 21 12:24:56 2026
#
# flake8: noqa
...
misc.update(
    {
        ...
        "MPSFunctions_AABB": objc.createStructType(
...
misc.update(
    {
        ...
        "MPSFColorConversionOptions": NewType("MPSFColorConversionOptions", int),
...
try:
    ...
    r(
        b"MPSFColorConversion",
        b"effectiveRange:",
        {
            "full_signature": b"{MPSFunctions_AABB=<4f><4f>}@:{MPSFunctions_AABB=<4f><4f>}",
            "retval": {"type": b"{MPSFunctions_AABB=<4f><4f>}"},
            "arguments": {2: {"type": b"{MPSFunctions_AABB=<4f><4f>}"}},
        },
    )
    r(
        b"MPSFColorConversion",
        b"initWithDevice:conversion:functionName:sourceRange:options:error:",
        {
            "full_signature": b"@@:@^{CGColorConversionInfo=}@^{MPSFunctions_AABB=<4f><4f>}Q^@",
            "arguments": {
                5: {"type": b"^{MPSFunctions_AABB=<4f><4f>}"},
                7: {"type_modifier": b"o"},
            },
        },
    )
    r(
        b"MPSFColorConversion",
        b"initWithDevice:startColorSpace:endColorSpace:functionName:sourceRange:options:error:",
        {
            "full_signature": b"@@:@^{CGColorSpace=}^{CGColorSpace=}@^{MPSFunctions_AABB=<4f><4f>}Q^@",
            "arguments": {
                6: {"type": b"^{MPSFunctions_AABB=<4f><4f>}"},
                8: {"type_modifier": b"o"},
            },
        },
    )
...
objc.registerNewKeywordsFromSelector("MPSAccelerationStructure", b"init")
...
objc.registerNewKeywordsFromSelector("MPSAccelerationStructureGroup", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("MPSCNNArithmeticGradientState", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("MPSCNNDropoutGradientState", b"init")
...
objc.registerNewKeywordsFromSelector("MPSCNNLossDataDescriptor", b"init")
objc.registerNewKeywordsFromSelector("MPSCNNLossDescriptor", b"init")
objc.registerNewKeywordsFromSelector("MPSCNNLossLabels", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("MPSCNNNeuronGradientNode", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("MPSCNNNeuronNode", b"init")
...
objc.registerNewKeywordsFromSelector("MPSCNNYOLOLossDescriptor", b"init")
objc.registerNewKeywordsFromSelector(
    "MPSCNNYOLOLossNode", b"initWithSource:lossDescriptor:"
)
objc.registerNewKeywordsFromSelector("MPSCommandBuffer", b"init")
...
objc.registerNewKeywordsFromSelector("MPSFunction", b"init")
objc.registerNewKeywordsFromSelector("MPSFunction", b"initWithCoder:")
objc.registerNewKeywordsFromSelector("MPSImage", b"init")
...
objc.registerNewKeywordsFromSelector("MPSKeyedUnarchiver", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("MPSMatrix", b"init")
...
objc.registerNewKeywordsFromSelector("MPSMatrixCopyDescriptor", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("MPSNDArray", b"init")
...
objc.registerNewKeywordsFromSelector("MPSNDArrayAffineQuantizationDescriptor", b"init")
objc.registerNewKeywordsFromSelector(
...
objc.registerNewKeywordsFromSelector("MPSNDArrayDescriptor", b"init")
...
objc.registerNewKeywordsFromSelector("MPSNNFilterNode", b"init")
...
objc.registerNewKeywordsFromSelector("MPSNNImageNode", b"init")
...
objc.registerNewKeywordsFromSelector("MPSNNNeuronDescriptor", b"init")
...
objc.registerNewKeywordsFromSelector("MPSNNStateNode", b"init")
objc.registerNewKeywordsFromSelector("MPSNNUnaryReductionNode", b"initWithSource:")
objc.registerNewKeywordsFromSelector("MPSPolygonBuffer", b"init")
...
objc.registerNewKeywordsFromSelector("MPSRayIntersector", b"init")
...
objc.registerNewKeywordsFromSelector("MPSState", b"init")
...
objc.registerNewKeywordsFromSelector("MPSStateResourceList", b"init")
...
objc.registerNewKeywordsFromSelector("MPSVector", b"init")
...
objc.registerNewKeywords(
    ...
    ("commandBuffer", "bufferSize"),
    "temporaryStateWithCommandBuffer_bufferSize_",
)
objc.registerNewKeywords(
    "MPSCNNBatchNormalizationState",
    ("commandBuffer", "textureDescriptor"),
    "temporaryStateWithCommandBuffer_textureDescriptor_",
)
objc.registerNewKeywords(
    "MPSCNNConvolutionDescriptor",
    ("kernelWidth", "kernelHeight", "inputFeatureChannels", "outputFeatureChannels"),
    "cnnConvolutionDescriptorWithKernelWidth_kernelHeight_inputFeatureChannels_outputFeatureChannels_",
)
objc.registerNewKeywords(
    "MPSCNNConvolutionDescriptor",
    (
    ...
    "cnnConvolutionDescriptorWithKernelWidth_kernelHeight_inputFeatureChannels_outputFeatureChannels_neuronFilter_",
)
objc.registerNewKeywords(
    "MPSCNNConvolutionWeightsAndBiasesState",
    ("commandBuffer", "cnnConvolutionDescriptor"),
    "temporaryCNNConvolutionWeightsAndBiasesStateWithCommandBuffer_cnnConvolutionDescriptor_",
)
objc.registerNewKeywords(
    "MPSCNNGroupNormalizationGradientState",
    ("commandBuffer",),
    "temporaryStateWithCommandBuffer_",
)
objc.registerNewKeywords(
    "MPSCNNGroupNormalizationGradientState",
    ("commandBuffer", "bufferSize"),
...
objc.registerNewKeywords(
    "MPSCNNNeuronNode", ("source", "descriptor"), "nodeWithSource_descriptor_"
)
objc.registerNewKeywords(
    "MPSCNNNormalizationGammaAndBetaState",
    ("commandBuffer", "numberOfFeatureChannels"),
    "temporaryStateWithCommandBuffer_numberOfFeatureChannels_",
)
objc.registerNewKeywords(
...
objc.registerNewKeywords(
    ...
    "createGRUDescriptorWithInputFeatureChannels_outputFeatureChannels_",
)
objc.registerNewKeywords(
    "MPSImageDescriptor",
    ("channelFormat", "width", "height", "featureChannels"),
    "imageDescriptorWithChannelFormat_width_height_featureChannels_",
)
objc.registerNewKeywords(
    "MPSImageDescriptor",
    ("channelFormat", "width", "height", "featureChannels", "numberOfImages", "usage"),
    "imageDescriptorWithChannelFormat_width_height_featureChannels_numberOfImages_usage_",
)
objc.registerNewKeywords(
    "MPSLSTMDescriptor",
    ("inputFeatureChannels", "outputFeatureChannels"),
    "createLSTMDescriptorWithInputFeatureChannels_outputFeatureChannels_",
)
objc.registerNewKeywords(
    "MPSMatrixCopyDescriptor",
    ("sourceMatrix", "destinationMatrix", "offsets"),
    "descriptorWithSourceMatrix_destinationMatrix_offsets_",
)
objc.registerNewKeywords(
    "MPSMatrixDescriptor",
    ("dimensions", "columns", "rowBytes", "dataType"),
    "matrixDescriptorWithDimensions_columns_rowBytes_dataType_",
)
objc.registerNewKeywords(
    "MPSMatrixDescriptor",
    ("rows", "columns", "matrices", "rowBytes", "matrixBytes", "dataType"),
    "matrixDescriptorWithRows_columns_matrices_rowBytes_matrixBytes_dataType_",
)
objc.registerNewKeywords(
    "MPSMatrixDescriptor",
    ("rows", "columns", "rowBytes", "dataType"),
    "matrixDescriptorWithRows_columns_rowBytes_dataType_",
)
objc.registerNewKeywords(
    "MPSNDArrayDescriptor",
    ("dataType", "dimensionCount", "dimensionSizes"),
    "descriptorWithDataType_dimensionCount_dimensionSizes_",
)
objc.registerNewKeywords(
    "MPSNDArrayDescriptor",
    ("dataType", "dimensionSizes"),
    "descriptorWithDataType_dimensionSizes_",
)
objc.registerNewKeywords(
    "MPSNDArrayDescriptor", ("dataType", "shape"), "descriptorWithDataType_shape_"
)
objc.registerNewKeywords("MPSNNDefaultPadding", ("method",), "paddingWithMethod_")
objc.registerNewKeywords(
    "MPSRNNSingleGateDescriptor",
    ("inputFeatureChannels", "outputFeatureChannels"),
    "createRNNSingleGateDescriptorWithInputFeatureChannels_outputFeatureChannels_",
)
objc.registerNewKeywords(
    "MPSState", ("commandBuffer",), "temporaryStateWithCommandBuffer_"
)
objc.registerNewKeywords(
    "MPSState",
    ("commandBuffer", "bufferSize"),
...
objc.registerNewKeywords(
    "MPSState",
    ("commandBuffer", "resourceList"),
    "temporaryStateWithCommandBuffer_resourceList_",
)
objc.registerNewKeywords(
    "MPSState",
    ("commandBuffer", "textureDescriptor"),
...
objc.registerNewKeywords(
    "MPSStateResourceList", ("bufferSizes",), "resourceListWithBufferSizes_"
)
objc.registerNewKeywords(
    "MPSStateResourceList",
    ("textureDescriptors",),
    "resourceListWithTextureDescriptors_",
)
objc.registerNewKeywords(
    "MPSTemporaryImage",
    ("commandBuffer", "imageDescriptor"),
    "temporaryImageWithCommandBuffer_imageDescriptor_",
)
objc.registerNewKeywords(
    "MPSTemporaryImage",
    ("commandBuffer", "textureDescriptor"),
    "temporaryImageWithCommandBuffer_textureDescriptor_",
)
objc.registerNewKeywords(
    "MPSTemporaryImage",
    ("commandBuffer", "textureDescriptor", "featureChannels"),
    "temporaryImageWithCommandBuffer_textureDescriptor_featureChannels_",
)
objc.registerNewKeywords(
    "MPSTemporaryMatrix",
    ("commandBuffer", "matrixDescriptor"),
    "temporaryMatrixWithCommandBuffer_matrixDescriptor_",
)
objc.registerNewKeywords(
    "MPSTemporaryNDArray",
    ("commandBuffer", "descriptor"),
    "temporaryNDArrayWithCommandBuffer_descriptor_",
)
objc.registerNewKeywords(
    "MPSTemporaryVector",
    ("commandBuffer", "descriptor"),
    "temporaryVectorWithCommandBuffer_descriptor_",
)
objc.registerNewKeywords(
    "MPSVectorDescriptor",
    ("length", "dataType"),
    "vectorDescriptorWithLength_dataType_",
)
objc.registerNewKeywords(
    "MPSVectorDescriptor",
    ("length", "vectors", "vectorBytes", "dataType"),
    "vectorDescriptorWithLength_vectors_vectorBytes_dataType_",
)
expressions = {
    "MPSUserAvailableFunctionConstantStartIndex": "MPSDeviceCapsIndex-12",
    "MPSFunctions_AABB_SDR": "MPSFunctions_AABB(_simd.vector_float4(1), _simd.vector_float4(0))",
    ...
    "MPSFunctions_AABB_Unbounded": "MPSFunctions_AABB(_simd.vector_float4(_math.inf), _simd.vector_float4(-_math.inf))",
...
formal_protocols = {
    "MPSCNNBatchNormalizationDataSource": "MPSCNNBatchNormalizationDataSource",
    "MPSCNNConvolutionDataSource": "MPSCNNConvolutionDataSource",
    "MPSCNNGroupNormalizationDataSource": "MPSCNNGroupNormalizationDataSource",
    "MPSCNNInstanceNormalizationDataSource": "MPSCNNInstanceNormalizationDataSource",
    "MPSDeviceProvider": "MPSDeviceProvider",
    "MPSHandle": "MPSHandle",
    "MPSHeapProvider": "MPSHeapProvider",
    "MPSImageAllocator": "MPSImageAllocator",
    "MPSImageSizeEncodingState": "MPSImageSizeEncodingState",
    "MPSImageTransformProvider": "MPSImageTransformProvider",
    "MPSNDArrayAllocator": "MPSNDArrayAllocator",
    "MPSNNGramMatrixCallback": "MPSNNGramMatrixCallback",
    "MPSNNLossCallback": "MPSNNLossCallback",
    "MPSNNPadding": "MPSNNPadding",
    "MPSNNTrainableNode": "MPSNNTrainableNode",
    "MPSSVGFTextureAllocator": "MPSSVGFTextureAllocator",
}
