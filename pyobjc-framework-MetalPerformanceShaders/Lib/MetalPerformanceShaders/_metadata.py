...
#
# Last update: Wed Jul 22 13:18:25 2020
#
# flake8: noqa
...
try:
    ...
    r(
        ...
        {
            "arguments": {
                3: {"type": b"^{_MPSImageHistogramInfo=QZ}", "type_modifier": b"n"}
            }
        },
    )
    r(
...
expressions = {
    ...
    "MPSUserAvailableFunctionConstantStartIndex": "MPSDeviceCapsIndex-8",
