...
#
# Last update: Sun Jul 19 22:08:47 2020
#
# flake8: noqa
...
misc.update(
    {
        "MPSNDArrayOffsets": objc.createStructType(
            "MPSNDArrayOffsets", b"{_MPSNDArrayOffsets=[16q]}", ["dimensions"]
        ),
        "MPSRayOriginMinDistanceDirectionMaxDistance": objc.createStructType(
            "MPSRayOriginMinDistanceDirectionMaxDistance",
            b"{_MPSRayOriginMinDistanceDirectionMaxDistance={_MPSPackedFloat3=(_union _MPSPackedFloat3::(anonymous at /Users/ronald/Downloads/Xcode-beta.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.16.sdk/System/Library/Frameworks/MetalPerformanceShaders.framework/Frameworks/MPSRayIntersector.framework/Headers/MPSRayIntersectorTypes.h:27:5)={=fff}[3f])}f{_MPSPackedFloat3=(_union _MPSPackedFloat3::(anonymous at /Users/ronald/Downloads/Xcode-beta.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.16.sdk/System/Library/Frameworks/MetalPerformanceShaders.framework/Frameworks/MPSRayIntersector.framework/Headers/MPSRayIntersectorTypes.h:27:5)={=fff}[3f])}f}",
            ["origin", "minDistance", "direction", "maxDistance"],
        ),
        "MPSImageHistogramInfo": objc.createStructType(
            "MPSImageHistogramInfo",
            b"{_MPSImageHistogramInfo=QZ}",
            [
        ...
        "MPSIntersectionDistance": objc.createStructType(
            "MPSIntersectionDistance", b"{_MPSIntersectionDistance=f}", ["distance"]
        ),
        "MPSRayOriginDirection": objc.createStructType(
            "MPSRayOriginDirection",
            b"{_MPSRayOriginDirection=}",
            ["origin", "direction"],
        ),
        ...
        "MPSNDArraySizes": objc.createStructType(
            "MPSNDArraySizes", b"{_MPSNDArraySizes=[16Q]}", ["dimensions"]
        ),
        ...
        "MPSRayPackedOriginDirection": objc.createStructType(
            ...
            b"{_MPSRayPackedOriginDirection={_MPSPackedFloat3=(_union _MPSPackedFloat3::(anonymous at /Users/ronald/Downloads/Xcode-beta.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.16.sdk/System/Library/Frameworks/MetalPerformanceShaders.framework/Frameworks/MPSRayIntersector.framework/Headers/MPSRayIntersectorTypes.h:27:5)={=fff}[3f])}{_MPSPackedFloat3=(_union _MPSPackedFloat3::(anonymous at /Users/ronald/Downloads/Xcode-beta.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.16.sdk/System/Library/Frameworks/MetalPerformanceShaders.framework/Frameworks/MPSRayIntersector.framework/Headers/MPSRayIntersectorTypes.h:27:5)={=fff}[3f])}}",
            ["origin", "direction"],
        ),
        "MPSDimensionSlice": objc.createStructType(
            "MPSDimensionSlice", b"{MPSDimensionSlice=QQ}", ["start", "length"]
        ),
        "MPSMatrixOffset": objc.createStructType(
            "MPSMatrixOffset", b"{_MPSMatrixOffset=II}", ["rowOffset", "columnOffset"]
        ),
        "MPSSize": objc.createStructType(
            "MPSSize", b"{MPSSize=ddd}", ["width", "height", "depth"]
        ),
        ...
        "MPSCustomKernelSourceInfo": objc.createStructType(
            ...
            b"{_MPSCustomKernelSourceInfo=SSSS}",
            [
                "kernelOrigin",
                "kernelPhase",
                "kernelSize",
        ...
        "MPSRayOriginMaskDirectionMaxDistance": objc.createStructType(
            ...
            b"{_MPSRayOriginMaskDirectionMaxDistance={_MPSPackedFloat3=(_union _MPSPackedFloat3::(anonymous at /Users/ronald/Downloads/Xcode-beta.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.16.sdk/System/Library/Frameworks/MetalPerformanceShaders.framework/Frameworks/MPSRayIntersector.framework/Headers/MPSRayIntersectorTypes.h:27:5)={=fff}[3f])}I{_MPSPackedFloat3=(_union _MPSPackedFloat3::(anonymous at /Users/ronald/Downloads/Xcode-beta.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.16.sdk/System/Library/Frameworks/MetalPerformanceShaders.framework/Frameworks/MPSRayIntersector.framework/Headers/MPSRayIntersectorTypes.h:27:5)={=fff}[3f])}f}",
        ...
        "MPSOffset": objc.createStructType(
            "MPSOffset", b"{_MPSOffset=qqq}", ["x", "y", "z"]
        ),
        ...
        "MPSIntersectionDistancePrimitiveIndexInstanceIndexCoordinates": objc.createStructType(
            ...
            b"{_MPSIntersectionDistancePrimitiveIndexInstanceIndexCoordinates=fII}",
            ["distance", "primitiveIndex", "instanceIndex", "coordinates"],
        ),
        "MPSImageCoordinate": objc.createStructType(
            "MPSImageCoordinate", b"{MPSImageCoordinate=QQQ}", ["x", "y", "channel"]
        ),
        "MPSCustomKernelInfo": objc.createStructType(
            "MPSCustomKernelInfo",
            b"{_MPSCustomKernelInfo=SSSSSS{_MPSIntegerDivisionParams=SSSS}}",
            [
                "clipOrigin",
                "clipSize",
...
try:
    ...
    r(
        ...
        {"arguments": {3: {"type": b"^{_MPSImageKeypointRangeInfo=Qf}"}}},
    )
    r(
        b"MPSImageFindKeypoints",
        b"keypointRangeInfo",
    ...
    r(
        b"MPSImageHistogram",
        b"histogramInfo",
        {"retval": {"type": b"{_MPSImageHistogramInfo=QZ}"}},
    )
    r(
        b"MPSImageHistogram",
        b"initWithDevice:histogramInfo:",
        {"arguments": {3: {"type": b"^{_MPSImageHistogramInfo=QZ}"}}},
    )
    r(
        b"MPSImageHistogram",
        b"setClipRectSource:",
    ...
    r(b"NSObject", b"beta", {"required": True, "retval": {"type": b"^f"}})
    r(b"NSObject", b"biasTerms", {"required": True, "retval": {"type": b"^f"}})
    r(
        b"NSObject",
    ...
    r(b"NSObject", b"gamma", {"required": True, "retval": {"type": b"^f"}})
    r(
        b"NSObject",
    ...
    r(b"NSObject", b"mean", {"required": True, "retval": {"type": b"^f"}})
    ...
    r(b"NSObject", b"variance", {"required": True, "retval": {"type": b"^f"}})
    r(b"NSObject", b"weights", {"required": True, "retval": {"type": b"^v"}})
