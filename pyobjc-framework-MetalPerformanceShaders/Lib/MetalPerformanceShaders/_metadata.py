...
#
# Last update: Tue Oct 11 20:01:08 2022
#
# flake8: noqa
...
misc.update(
    {
        ...
        "MPSRayOriginMinDistanceDirectionMaxDistance": objc.createStructType(
            ...
            b"{_MPSRayOriginMinDistanceDirectionMaxDistance={_MPSPackedFloat3=[3f]}f{_MPSPackedFloat3=[3f]}f}",
        ...
        "MPSRayPackedOriginDirection": objc.createStructType(
            ...
            b"{_MPSRayPackedOriginDirection={_MPSPackedFloat3=[3f]}{_MPSPackedFloat3=[3f]}}",
            ["origin", "direction"],
        ),
        ...
        "MPSRayOriginMaskDirectionMaxDistance": objc.createStructType(
            ...
            b"{_MPSRayOriginMaskDirectionMaxDistance={_MPSPackedFloat3=[3f]}I{_MPSPackedFloat3=[3f]}f}",
        ...
        "MPSPackedFloat3": objc.createStructType(
            ...
            b"{_MPSPackedFloat3=(_union _MPSPackedFloat3::(anonymous at /Users/ronald/Applications/Xcode-beta.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX13.0.sdk/System/Library/Frameworks/MetalPerformanceShaders.framework/Frameworks/MPSRayIntersector.framework/Headers/MPSRayIntersectorTypes.h:27:5)={=fff}[3f])}",
            [],
        ),
...
try:
    ...
    r(
        ...
        {"full_signature": b"^<2f>@:", "required": False, "retval": {"type": b"^<2f>"}},
    )
    r(
        b"NSObject",
