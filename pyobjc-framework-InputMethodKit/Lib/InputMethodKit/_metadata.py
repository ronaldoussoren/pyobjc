...
#
# Last update: Tue Jun 30 22:43:28 2026
#
# flake8: noqa
...
misc.update(
    {
        "IMKStyleType": NewType("IMKStyleType", int),
        "IMKCandidatesLocationHint": NewType("IMKCandidatesLocationHint", int),
        "IMKCandidatePanelType": NewType("IMKCandidatePanelType", int),
    }
)
misc.update({})
...
expressions = {}
formal_protocols = {
    "IMKMouseHandling": "IMKMouseHandling",
    "IMKStateSetting": "IMKStateSetting",
}
