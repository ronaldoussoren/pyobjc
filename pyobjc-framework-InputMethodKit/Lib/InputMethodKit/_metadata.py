...
try:
    ...
    r(b'IMKInputController', b'doCommandBySelector:commandDictionary:', {'arguments': {2: {'type': ':'}}})
    ...
    r(b'NSObject', b'mouseDownOnCharacterIndex:coordinate:withModifier:continueTracking:client:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': sel32or64(u'I', u'Q')}, 3: {'type': sel32or64(u'{_NSPoint=ff}', u'{CGPoint=dd}')}, 4: {'type': sel32or64(u'I', u'Q')}, 5: {'type': '^Z', 'type_modifier': b'o'}}})
    r(b'NSObject', b'mouseMovedOnCharacterIndex:coordinate:withModifier:client:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': sel32or64(u'I', u'Q')}, 3: {'type': sel32or64(u'{_NSPoint=ff}', u'{CGPoint=dd}')}, 4: {'type': sel32or64(u'I', u'Q')}}})
    r(b'NSObject', b'mouseUpOnCharacterIndex:coordinate:withModifier:client:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': sel32or64(u'I', u'Q')}, 3: {'type': sel32or64(u'{_NSPoint=ff}', u'{CGPoint=dd}')}, 4: {'type': sel32or64(u'I', u'Q')}}})
finally:
...
try:
    ...
    r(b'NSObject', b'mouseDownOnCharacterIndex:coordinate:withModifier:continueTracking:client:', {'required': True, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': sel32or64(u'I', u'Q')}, 3: {'type': sel32or64(u'{_NSPoint=ff}', u'{CGPoint=dd}')}, 4: {'type': sel32or64(u'I', u'Q')}, 5: {'type': '^Z', 'type_modifier': b'o'}, 6: {'type': b'@'}}})
    r(b'NSObject', b'mouseMovedOnCharacterIndex:coordinate:withModifier:client:', {'required': True, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': sel32or64(u'I', u'Q')}, 3: {'type': sel32or64(u'{_NSPoint=ff}', u'{CGPoint=dd}')}, 4: {'type': sel32or64(u'I', u'Q')}, 5: {'type': b'@'}}})
    r(b'NSObject', b'mouseUpOnCharacterIndex:coordinate:withModifier:client:', {'required': True, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': sel32or64(u'I', u'Q')}, 3: {'type': sel32or64(u'{_NSPoint=ff}', u'{CGPoint=dd}')}, 4: {'type': sel32or64(u'I', u'Q')}, 5: {'type': b'@'}}})
