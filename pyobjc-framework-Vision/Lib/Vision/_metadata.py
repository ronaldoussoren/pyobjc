...
#
# Last update: Tue Aug  8 22:36:41 2017
...
constants = '''$VNBarcodeSymbologyAztec$VNBarcodeSymbologyCODE128$VNBarcodeSymbologyCODE39$VNBarcodeSymbologyCODE39Checksum$VNBarcodeSymbologyCODE39FullASCII$VNBarcodeSymbologyCODE39FullASCIIChecksum$VNBarcodeSymbologyCODE93$VNBarcodeSymbologyCODE93i$VNBarcodeSymbologyCode128$VNBarcodeSymbologyCode39$VNBarcodeSymbologyCode39Checksum$VNBarcodeSymbologyCode39FullASCII$VNBarcodeSymbologyCode39FullASCIIChecksum$VNBarcodeSymbologyCode93$VNBarcodeSymbologyCode93i$VNBarcodeSymbologyDataMatrix$VNBarcodeSymbologyEAN13$VNBarcodeSymbologyEAN8$VNBarcodeSymbologyI2OF5$VNBarcodeSymbologyI2OF5Checksum$VNBarcodeSymbologyI2of5$VNBarcodeSymbologyI2of5Checksum$VNBarcodeSymbologyITF14$VNBarcodeSymbologyPDF417$VNBarcodeSymbologyQR$VNBarcodeSymbologyUPCE$VNImageOptionCameraIntrinsics$VNImageOptionProperties$VNNormalizedIdentityRect@{CGRect={CGPoint=dd}{CGSize=dd}}$VNVisionVersionNumber@d$'''
...
try:
    ...
    r(b'VNRequest', b'completionHandler', {'retval': {'retval': {'typestr': 'v'}, 'arguments': {0: {'typestr': '@'}}}})
    ...
    r(b'VNTargetedImageRequest', b'initWithTargetedCGImage:orientation:options:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
