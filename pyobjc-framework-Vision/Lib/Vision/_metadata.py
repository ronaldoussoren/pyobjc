...
try:
    r(b"NSObject", b"indeterminate", {"required": True, "retval": {"type": b"Z"}})
    r(
        b"NSObject",
    ...
    r(b"NSObject", b"requestRevision", {"required": True, "retval": {"type": b"Q"}})
    r(
        b"NSObject",
    ...
    r(b"VNRecognizeTextRequest", b"usesLanguageCorrection", {"retval": {"type": b"Z"}})
    r(
    ...
    r(b"VNRequest", b"preferBackgroundProcessing", {"retval": {"type": b"Z"}})
    r(
        b"VNRequest",
        b"setPreferBackgroundProcessing:",
        {"arguments": {2: {"type": b"Z"}}},
    )
    r(b"VNRequest", b"setUsesCPUOnly:", {"arguments": {2: {"type": b"Z"}}})
    r(
        b"VNRequest",
        b"supportedComputeStageDevicesAndReturnError:",
        {"arguments": {2: {"type_modifier": b"o"}}},
    )
    r(b"VNRequest", b"usesCPUOnly", {"retval": {"type": b"Z"}})
    r(
    ...
    r(b"VNTrackingRequest", b"isLastFrame", {"retval": {"type": b"Z"}})
    r(b"VNTrackingRequest", b"setLastFrame:", {"arguments": {2: {"type": b"Z"}}})
    r(
        b"VNTrackingRequest",
...
expressions = {}
formal_protocols = {
    "VNFaceObservationAccepting": "VNFaceObservationAccepting",
    "VNRequestProgressProviding": "VNRequestProgressProviding",
    "VNRequestRevisionProviding": "VNRequestRevisionProviding",
}
