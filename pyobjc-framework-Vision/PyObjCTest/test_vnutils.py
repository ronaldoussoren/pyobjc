...
if sys.maxsize >= 2**32:
    ...
    class TestVNUtils (TestCase):
        ...
        def testConstants10_13(self):
            self.assertIsInstance(Vision.VNNormalizedIdentityRect, Quartz.CGRect.__typestr__)
        ...
        def testFunctions(self):
            ...
            self.assertArgHasType(Vision.VNImagePointForNormalizedPoint, 1, objc._C_ULONG)
            self.assertArgHasType(Vision.VNImagePointForNormalizedPoint, 2, objc._C_ULONG)
            ...
            self.assertArgHasType(Vision.VNImageRectForNormalizedRect, 1, objc._C_ULONG)
            self.assertArgHasType(Vision.VNImageRectForNormalizedRect, 2, objc._C_ULONG)
            ...
            self.assertArgHasType(Vision.VNNormalizedRectForImageRect, 1, objc._C_ULONG)
            self.assertArgHasType(Vision.VNNormalizedRectForImageRect, 2, objc._C_ULONG)
            ...
            #self.assertArgHasType(Vision.VNNormalizedRectForImageRect, 2, objc._C_ULONG)
            #self.assertArgHasType(Vision.VNNormalizedRectForImageRect, 3, objc._C_ULONG)
            ...
            #self.assertArgHasType(Vision.VNImagePointForFaceLandmarkPoint, 2, objc._C_ULONG)
            #self.assertArgHasType(Vision.VNImagePointForFaceLandmarkPoint, 3, objc._C_ULONG)
