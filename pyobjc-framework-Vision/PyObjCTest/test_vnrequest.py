...
if sys.maxsize >= 2**32:
    ...
    class TestVNRequest (TestCase):
        ...
        def testMethods10_13(self):
            ...
            self.assertResultIsBlock(TestVNRequestHelper.progressHandler, VNRequestProgressHandler)
            self.assertArgIsBlock(TestVNRequestHelper.setProgressHandler_, 0, VNRequestProgressHandler)
