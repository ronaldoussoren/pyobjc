...
if sys.maxsize >= 2**32:
    ...
    class TestVNTargetedImageRequest (TestCase):
        ...
        def testMethods10_13(self):
            ...
            self.assertArgIsBlock(Vision.VNTargetedImageRequest.initWithTargetedImageData_options_completionHandler_, 2, b'v@@')
            self.assertArgIsBlock(Vision.VNTargetedImageRequest.initWithTargetedImageData_orientation_options_completionHandler_, 3, b'v@@')
            self.assertArgIsBlock(Vision.VNTargetedImageRequest.initWithCompletionHandler_, 0, b'v@@')
            self.assertArgIsBlock(Vision.VNTargetedImageRequest.initWithTargetedCVPixelBuffer_options_completionHandler_, 2, b'v@@')
            self.assertArgIsBlock(Vision.VNTargetedImageRequest.initWithTargetedCVPixelBuffer_orientation_options_completionHandler_, 3, b'v@@')
            self.assertArgIsBlock(Vision.VNTargetedImageRequest.initWithTargetedCGImage_options_completionHandler_, 2, b'v@@')
            self.assertArgIsBlock(Vision.VNTargetedImageRequest.initWithTargetedCGImage_orientation_options_completionHandler_, 3, b'v@@')
