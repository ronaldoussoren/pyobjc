...
misc.update(
    {
        "kFSEventStreamEventExtendedDataPathKey": b"path".decode("utf-8"),
        "kFSEventStreamEventExtendedFileIDKey": b"fileID".decode("utf-8"),
    }
)
functions = {
    ...
    "FSEventStreamSetDispatchQueue": (b"v^{__FSEventStream=}^{dispatch_queue_s=}",),
