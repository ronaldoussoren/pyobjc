...
misc.update(
    {
        "kSCNetworkConnectionSelectionOptionOnDemandHostName": b"OnDemandHostName".decode(
            "utf-8"
        ),
        "kSCNetworkConnectionPacketsOut": b"PacketsOut".decode("utf-8"),
        "kSCNetworkConnectionBytesIn": b"BytesIn".decode("utf-8"),
        "kSCNetworkConnectionPacketsIn": b"PacketsIn".decode("utf-8"),
        "kSCNetworkConnectionErrorsIn": b"ErrorsIn".decode("utf-8"),
        "kSCNetworkConnectionBytesOut": b"BytesOut".decode("utf-8"),
        "kSCNetworkConnectionSelectionOptionOnDemandRetry": b"OnDemandRetry".decode(
            "utf-8"
        ),
        "kSCNetworkConnectionErrorsOut": b"ErrorsOut".decode("utf-8"),
    }
)
functions = {
    ...
    "SCPreferencesGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "SCDynamicStoreCreate": (
        sel32or64(
            b"^{__SCDynamicStore=}^{__CFAllocator=}^{__CFString=}^?^{?=i^v^?^?^?}",
    ...
    "SCNetworkReachabilitySetDispatchQueue": (
        b"Z^{__SCNetworkReachability=}^{dispatch_queue_s=}",
    ),
    ...
    "SCBondStatusGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "SCDynamicStoreGetTypeID": (sel32or64(b"L", b"Q"),),
    "SCNetworkSetCopy": (
    ...
    "SCNetworkConnectionCreateWithServiceID": (
        sel32or64(
            b"^{__SCNetworkConnection=}^{__CFAllocator=}^{__CFString=}^?^{?=i^v^?^?^?}",
    ...
    "SCNetworkServiceGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "SCNetworkSetGetTypeID": (sel32or64(b"L", b"Q"),),
    "SCNetworkReachabilityUnscheduleFromRunLoop": (
        b"Z^{__SCNetworkReachability=}^{__CFRunLoop=}^{__CFString=}",
    ),
    "SCNetworkServiceSetEnabled": (b"Z^{__SCNetworkService=}Z",),
    "SCPreferencesSetDispatchQueue": (b"Z^{__SCPreferences=}^{dispatch_queue_s=}",),
    "SCNetworkReachabilityGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "SCNetworkConnectionGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "SCNetworkInterfaceGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "DHCPClientPreferencesSetApplicationOptions": (
        sel32or64(b"Z^{__CFString=}^Cl", b"Z^{__CFString=}^Cq"),
        "",
    ...
    "SCDynamicStoreCreateRunLoopSource": (
        sel32or64(
            b"^{__CFRunLoopSource=}^{__CFAllocator=}^{__SCDynamicStore=}l",
    ...
    "SCNetworkConnectionSetDispatchQueue": (
        b"Z^{__SCNetworkConnection=}^{dispatch_queue_s=}",
    ),
    ...
    "SCDynamicStoreSetDispatchQueue": (b"Z^{__SCDynamicStore=}^{dispatch_queue_s=}",),
    "SCNetworkReachabilitySetCallback": (
        sel32or64(
            b"Z^{__SCNetworkReachability=}^?^{?=i^v^?^?^?}",
