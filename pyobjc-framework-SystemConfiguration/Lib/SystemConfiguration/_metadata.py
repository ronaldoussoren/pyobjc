...
#
# Last update: Tue Aug 11 09:36:56 2026
#
# flake8: noqa
...
functions = {
    ...
    "SCDynamicStoreCreateWithOptions": (
        b"^{__SCDynamicStore=}^{__CFAllocator=}^{__CFString=}^{__CFDictionary=}^?@",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "SCDynamicStoreCreate": (
        b"^{__SCDynamicStore=}^{__CFAllocator=}^{__CFString=}^?@",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "SCNetworkConnectionCreateWithServiceID": (
        b"^{__SCNetworkConnection=}^{__CFAllocator=}^{__CFString=}^?@",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
