...
#
# Last update: Sun Aug 16 11:48:15 2026
#
# flake8: noqa
...
misc.update(
    {
        ...
        "PHAssetAdjustmentsState": NewType("PHAssetAdjustmentsState", int),
        ...
        "PHAssetRating": NewType("PHAssetRating", int),
        ...
        "PHAssetPlaybackVariation": NewType("PHAssetPlaybackVariation", int),
        "PHAssetCollectionSubtype": NewType("PHAssetCollectionSubtype", int),
        "PHOriginalResourceChoice": NewType("PHOriginalResourceChoice", int),
        "PHAssetResourceUploadJobType": NewType("PHAssetResourceUploadJobType", int),
        "PHAssetResourceUploadJobAction": NewType(
            "PHAssetResourceUploadJobAction", int
        ),
        ...
        "PHAssetResourceUploadJobState": NewType("PHAssetResourceUploadJobState", int),
    }
)
...
try:
    ...
    r(
        b"NSObject",
        b"photoLibraryPersistentChangesDidUpdate:",
        {"required": True, "retval": {"type": b"v"}, "arguments": {2: {"type": b"@"}}},
    )
    ...
    r(
        b"PHAssetChangeRequest",
        b"setLivePhotoVideoPlaybackEnabled:",
    ...
    r(
        b"PHAssetResourceUploadJobOptions",
        b"preventsExpensiveNetworkAccess",
        {"retval": {"type": b"Z"}},
    )
    r(
        b"PHAssetResourceUploadJobOptions",
        b"setPreventsExpensiveNetworkAccess:",
        {"arguments": {2: {"type": b"Z"}}},
    )
    r(
    ...
    r(
        b"PHContentEditingInputRequestOptions",
        b"setSkipsDisplaySizeImage:",
        {"arguments": {2: {"type": b"Z"}}},
    )
    r(
        b"PHContentEditingInputRequestOptions",
        b"skipsDisplaySizeImage",
        {"retval": {"type": b"Z"}},
    )
    r(
    ...
    r(b"PHFetchOptions", b"prefetchAssetExtendedMetadata", {"retval": {"type": b"Z"}})
    r(
        b"PHFetchOptions",
    ...
    r(
        b"PHFetchOptions",
        b"setPrefetchAssetExtendedMetadata:",
        {"arguments": {2: {"type": b"Z"}}},
    )
    r(
        b"PHFetchOptions",
    ...
    r(b"PHImageRequestOptions", b"preferHDR", {"retval": {"type": b"Z"}})
    r(
        b"PHImageRequestOptions",
        b"progressHandler",
        {
    ...
    r(b"PHImageRequestOptions", b"setPreferHDR:", {"arguments": {2: {"type": b"Z"}}})
    r(
        b"PHImageRequestOptions",
        b"setProgressHandler:",
        {
    ...
    r(b"PHLivePhotoEditingContext", b"duration", {"retval": {"type": "{CMTime=qiIq}"}})
    r(
    ...
    r(b"PHLivePhotoEditingContext", b"photoTime", {"retval": {"type": "{CMTime=qiIq}"}})
    r(
        b"PHLivePhotoEditingContext",
    ...
    r(b"PHLivePhotoRequestOptions", b"preferHDR", {"retval": {"type": b"Z"}})
    r(
        b"PHLivePhotoRequestOptions",
        b"progressHandler",
        {
    ...
    r(
        b"PHPhotoLibrary",
        b"disableUploadJobExtensionWithError:",
        {"retval": {"type": b"Z"}, "arguments": {2: {"type_modifier": b"o"}}},
    )
    r(
        b"PHPhotoLibrary",
        b"enableUploadJobExtensionWithOptions:error:",
    ...
    r(b"PHPhotoLibrary", b"isUploadJobExtensionEnabled", {"retval": {"type": b"Z"}})
    r(
        b"PHPhotoLibrary",
    ...
    r(
        b"PHPhotoLibrary",
        b"setUploadJobExtensionEnabled:error:",
        {
            "retval": {"type": b"Z"},
    ...
    r(
        b"PHPhotoLibrary",
        b"setUploadJobExtensionOptions:error:",
        {"retval": {"type": b"Z"}, "arguments": {3: {"type_modifier": b"o"}}},
    )
...
objc.registerNewKeywordsFromSelector(
    "PHCloudIdentifier", b"initWithArchivalStringValue:"
)
...
objc.registerNewKeywordsFromSelector("PHLivePhoto", b"init")
objc.registerNewKeywordsFromSelector("PHLivePhotoEditingContext", b"init")
objc.registerNewKeywordsFromSelector(
    "PHLivePhotoEditingContext", b"initWithLivePhotoEditingInput:"
)
objc.registerNewKeywordsFromSelector("PHPersistentChange", b"init")
objc.registerNewKeywordsFromSelector("PHPersistentChangeFetchResult", b"init")
objc.registerNewKeywordsFromSelector("PHPersistentChangeToken", b"init")
objc.registerNewKeywordsFromSelector("PHPersistentObjectChangeDetails", b"init")
...
objc.registerNewKeywords(
    ...
    ("resource",),
    "creationRequestForDownloadJobWithResource_",
)
objc.registerNewKeywords(
    "PHAssetResourceUploadJobChangeRequest",
    ("destination", "resource"),
    "creationRequestForJobWithDestination_resource_",
)
objc.registerNewKeywords(
...
expressions = {}
formal_protocols = {
    "PHLivePhotoFrame": "PHLivePhotoFrame",
    "PHPhotoLibraryAvailabilityObserver": "PHPhotoLibraryAvailabilityObserver",
    "PHPhotoLibraryChangeObserver": "PHPhotoLibraryChangeObserver",
    "PHPhotoLibraryPersistentChangesObserver": "PHPhotoLibraryPersistentChangesObserver",
}
