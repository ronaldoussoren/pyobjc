...
#
# Last update: Sun Jul  9 17:48:23 2017
...
try:
    ...
    r(b'PHPhotoLibrary', b'performChanges_completionHandler_:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'Z'}, 2: {'type': b'@'}}}}}})
