...
#
# Last update: Sat Jun 27 16:54:08 2020
#
# flake8: noqa
...
try:
    ...
    r(b'NSObject', b'photoLibraryDidBecomeUnavailable:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'photoLibraryDidChange:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'renderScale', {'required': True, 'retval': {'type': sel32or64(b'f', b'd')}})
    ...
    r(b'PHAsset', b'requestContentEditingInputWithOptions:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    ...
    r(b'PHAssetCreationRequest', b'supportsAssetResourceTypes:', {'retval': {'type': b'Z'}})
    r(b'PHAssetResourceCreationOptions', b'setShouldMoveFile:', {'arguments': {2: {'type': b'Z'}}})
    r(b'PHAssetResourceCreationOptions', b'shouldMoveFile', {'retval': {'type': b'Z'}})
    r(b'PHAssetResourceManager', b'requestDataForAssetResource:options:dataReceivedHandler:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}, 5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'PHAssetResourceManager', b'writeDataForAssetResource:toFile:options:completionHandler:', {'arguments': {5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'PHAssetResourceRequestOptions', b'isNetworkAccessAllowed', {'retval': {'type': b'Z'}})
    r(b'PHAssetResourceRequestOptions', b'setNetworkAccessAllowed:', {'arguments': {2: {'type': b'Z'}}})
    r(b'PHCachingImageManager', b'allowsCachingHighQualityImages', {'retval': {'type': b'Z'}})
    r(b'PHCachingImageManager', b'setAllowsCachingHighQualityImages:', {'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'PHContentEditingInputRequestOptions', b'isNetworkAccessAllowed', {'retval': {'type': b'Z'}})
    r(b'PHContentEditingInputRequestOptions', b'progressHandler', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'd'}, 2: {'type': b'o^Z'}}}}})
    r(b'PHContentEditingInputRequestOptions', b'setNetworkAccessAllowed:', {'arguments': {2: {'type': b'Z'}}})
    r(b'PHContentEditingInputRequestOptions', b'setProgressHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'd'}, 2: {'type': b'o^Z'}}}}}})
    ...
    r(b'PHImageManager', b'requestAVAssetForVideo:options:resultHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}}}})
    r(b'PHImageManager', b'requestExportSessionForVideo:options:exportPreset:resultHandler:', {'arguments': {5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'PHImageManager', b'requestImageDataAndOrientationForAsset:options:resultHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'I'}, 4: {'type': b'@'}}}}}})
    ...
    r(b'PHImageManager', b'requestLivePhotoForAsset:targetSize:contentMode:options:resultHandler:', {'arguments': {6: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'PHImageManager', b'requestPlayerItemForVideo:options:resultHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    ...
    r(b'PHLivePhoto', b'requestLivePhotoWithResourceFileURLs:placeholderImage:targetSize:contentMode:resultHandler:', {'arguments': {6: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    ...
    r(b'PHLivePhotoRequestOptions', b'progressHandler', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'd'}, 2: {'type': b'@'}, 3: {'type': b'o^Z'}, 4: {'type': b'@'}}}}})
    r(b'PHLivePhotoRequestOptions', b'setNetworkAccessAllowed:', {'arguments': {2: {'type': b'Z'}}})
    r(b'PHLivePhotoRequestOptions', b'setProgressHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'd'}, 2: {'type': b'@'}, 3: {'type': b'o^Z'}, 4: {'type': b'@'}}}}}})
    ...
    r(b'PHPhotoLibrary', b'requestAuthorizationForAccessLevel:handler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'q'}}}}}})
    r(b'PHProject', b'hasProjectPreview', {'retval': {'type': 'Z'}})
    r(b'PHVideoRequestOptions', b'isNetworkAccessAllowed', {'retval': {'type': b'Z'}})
    r(b'PHVideoRequestOptions', b'progressHandler', {'comment': 'XXX', 'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'd'}, 2: {'type': b'@'}, 3: {'type': b'o^Z'}, 4: {'type': b'@'}}}}})
    r(b'PHVideoRequestOptions', b'setNetworkAccessAllowed:', {'arguments': {2: {'type': b'Z'}}})
    r(b'PHVideoRequestOptions', b'setProgressHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'd'}, 2: {'type': b'@'}, 3: {'type': b'o^Z'}, 4: {'type': b'@'}}}}}})
finally:
