...
if sys.maxsize > 2 ** 32:
    ...
    class TestPHAssetChangeRequest (TestCase):
        ...
        def testMethods(self):
            ...
            self.assertResultIsBlock(Photos.PHContentEditingInputRequestOptions.progressHandler, b'vdo^Z')
            self.assertArgIsBlock(Photos.PHContentEditingInputRequestOptions.setProgressHandler_, 0, b'vdo^Z')

            self.assertArgIsBlock(Photos.PHAsset.requestContentEditingInputWithOptions_completionHandler_, 1, b'v@@')
