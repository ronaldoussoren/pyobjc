...
#
# Last update: Sat Jun  8 16:15:48 2019
...
try:
    r(b'NSObject', b'userNotificationCenter:didReceiveNotificationResponse:withCompletionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}, 'type': '@?'}}})
    r(b'NSObject', b'userNotificationCenter:willPresentNotification:withCompletionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'Q'}}}, 'type': '@?'}}})
