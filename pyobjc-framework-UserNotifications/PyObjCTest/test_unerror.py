...
if sys.maxsize > 2 ** 32:
    ...
    class TestUNError(TestCase):
        def test_constants(self):
            ...
            self.assertEqual(
                UserNotifications.UNErrorCodeAttachmentUnrecognizedType, 101
            )
            self.assertEqual(
                UserNotifications.UNErrorCodeAttachmentInvalidFileSize, 102
            )
            ...
            self.assertEqual(
                UserNotifications.UNErrorCodeNotificationInvalidNoDate, 1400
            )
            self.assertEqual(
