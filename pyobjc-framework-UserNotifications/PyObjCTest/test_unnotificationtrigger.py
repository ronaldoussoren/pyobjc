    ...
    class TestUNNotificationTrigger(TestCase):
        def test_methods(self):
            ...
            self.assertArgIsBOOL(
                UserNotifications.UNTimeIntervalNotificationTrigger.triggerWithTimeInterval_repeats_,
                1,
            )
            self.assertArgIsBOOL(
                UserNotifications.UNCalendarNotificationTrigger.triggerWithDateMatchingComponents_repeats_,
                1,
            )
            self.assertArgIsBOOL(
