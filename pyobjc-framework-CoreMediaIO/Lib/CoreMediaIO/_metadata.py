...
functions = {
    ...
    "CMIODeviceProcessRS422Command": (
        b"iI^{CMIODeviceRS422Command=^CI^CII}",
        "",
        {"arguments": {1: {"type_modifier": "n"}}},
    ),
    ...
    "CMIODeviceProcessAVCCommand": (
        b"iI^{CMIODeviceAVCCommand=^CI^CII}",
        "",
        {"arguments": {1: {"type_modifier": "n"}}},
    ),
...
expressions = {}
formal_protocols = {
    "CMIOExtensionDeviceSource": "CMIOExtensionDeviceSource",
    "CMIOExtensionProviderSource": "CMIOExtensionProviderSource",
    "CMIOExtensionStreamSource": "CMIOExtensionStreamSource",
}
