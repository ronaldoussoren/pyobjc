...
#
# Last update: Tue Jun 11 16:27:17 2019
...
misc.update(
    {
        "CMIODeviceRS422Command": objc.createStructType(
            ...
            sel32or64(
                b"{CMIODeviceRS422Command=^CL^CLL}", b"{CMIODeviceRS422Command=^CI^CII}"
            ),
            [
                "mCommand",
                "mCommandLength",
        ...
        "CMIODeviceAVCCommand": objc.createStructType(
            ...
            sel32or64(
                b"{CMIODeviceAVCCommand=^CL^CLL}", b"{CMIODeviceAVCCommand=^CI^CII}"
            ),
            [
                "mCommand",
                "mCommandLength",
        ...
        "CMIOObjectPropertyAddress": objc.createStructType(
            ...
            sel32or64(
                b"{CMIOObjectPropertyAddress=LLL}", b"{CMIOObjectPropertyAddress=III}"
            ),
...
functions = {
    ...
    "CMIOStreamDeckCueTo": (sel32or64(b"lLQZ", b"iIQZ"),),
    "CMIOObjectGetPropertyData": (
        sel32or64(
            b"lL^{CMIOObjectPropertyAddress=LLL}L^vL^L^v",
    ...
    "CMIOSampleBufferCreateForImageBuffer": (
        sel32or64(
            b"l^{__CFAllocator=}^{__CVBuffer=}^{opaqueCMFormatDescription=}^{_CMSampleTimingInfo={_CMTime=qiIq}{_CMTime=qiIq}{_CMTime=qiIq}}QL^^{opaqueCMSampleBuffer=}",
            b"i^{__CFAllocator=}^{__CVBuffer=}^{opaqueCMFormatDescription=}^{_CMSampleTimingInfo={_CMTime=qiIq}{_CMTime=qiIq}{_CMTime=qiIq}}QI^^{opaqueCMSampleBuffer=}",
        ),
        "",
        {
    ...
    "CMIOObjectRemovePropertyListener": (
        sel32or64(
            b"lL^{CMIOObjectPropertyAddress=LLL}^?^v",
    ...
    "CMIOSampleBufferCreateNoDataMarker": (
        sel32or64(
            b"l^{__CFAllocator=}L^{opaqueCMFormatDescription=}QL^^{opaqueCMSampleBuffer=}",
    ...
    "CMIOObjectGetPropertyDataSize": (
        sel32or64(
            b"lL^{CMIOObjectPropertyAddress=LLL}L^v^L",
    ...
    "CMIOStreamClockPostTimingEvent": (
        sel32or64(b"l{_CMTime=qiIq}QZ@", b"i{_CMTime=qiIq}QZ@"),
    ),
    "CMIODeviceStopStream": (sel32or64(b"lLL", b"iII"),),
    "CMIODeviceStartStream": (sel32or64(b"lLL", b"iII"),),
    "CMIOSampleBufferCreate": (
        sel32or64(
            b"l^{__CFAllocator=}^{OpaqueCMBlockBuffer=}^{opaqueCMFormatDescription=}LL^{_CMSampleTimingInfo={_CMTime=qiIq}{_CMTime=qiIq}{_CMTime=qiIq}}L^LQL^^{opaqueCMSampleBuffer=}",
            b"i^{__CFAllocator=}^{OpaqueCMBlockBuffer=}^{opaqueCMFormatDescription=}II^{_CMSampleTimingInfo={_CMTime=qiIq}{_CMTime=qiIq}{_CMTime=qiIq}}I^QQI^^{opaqueCMSampleBuffer=}",
        ),
        "",
        {
            "retval": {"already_cfretained": True},
    ...
    "CMIOStreamCopyBufferQueue": (
        sel32or64(b"lL^?^v^^{opaqueCMSimpleQueue=}", b"iI^?^v^^{opaqueCMSimpleQueue=}"),
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "CMIOObjectHasProperty": (
        sel32or64(
            b"ZL^{CMIOObjectPropertyAddress=LLL}", b"ZI^{CMIOObjectPropertyAddress=III}"
        ),
        "",
    ...
    "CMIOObjectIsPropertySettable": (
        sel32or64(
            b"lL^{CMIOObjectPropertyAddress=LLL}^Z",
    ...
    "CMIOStreamClockCreate": (
        sel32or64(
            b"l^{__CFAllocator=}^{__CFString=}^v{_CMTime=qiIq}LL^@",
            b"i^{__CFAllocator=}^{__CFString=}^v{_CMTime=qiIq}II^@",
        ),
        "",
        {
            "retval": {"already_cfretained": True},
    ...
    "CMIOStreamClockInvalidate": (sel32or64(b"l@", b"i@"),),
    "CMIOObjectsPublishedAndDied": (
        sel32or64(
            b"l^^{CMIOHardwarePlugInInterface=^v^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?}LL^LL^L",
            b"i^^{CMIOHardwarePlugInInterface=^v^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?}II^II^I",
        ),
    ),
    "CMIOObjectSetPropertyData": (
        sel32or64(
            b"lL^{CMIOObjectPropertyAddress=LLL}L^vL^v",
    ...
    "CMIOStreamDeckPlay": (sel32or64(b"lL", b"iI"),),
    "CMIOSampleBufferSetDiscontinuityFlags": (
        sel32or64(
            b"v^{__CFAllocator=}^{opaqueCMSampleBuffer=}L",
            b"v^{__CFAllocator=}^{opaqueCMSampleBuffer=}I",
        ),
    ),
    "CMIOStreamDeckStop": (sel32or64(b"lL", b"iI"),),
    "CMIOObjectPropertiesChanged": (
        sel32or64(
            b"l^^{CMIOHardwarePlugInInterface=^v^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?}LL^{CMIOObjectPropertyAddress=LLL}",
    ...
    "CMIOObjectCreate": (
        sel32or64(
            b"l^^{CMIOHardwarePlugInInterface=^v^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?^?}LL^L",
    ...
    "CMIOSampleBufferCopyNonRequiredAttachments": (
        sel32or64(
            b"l^{opaqueCMSampleBuffer=}^{opaqueCMSampleBuffer=}I",
