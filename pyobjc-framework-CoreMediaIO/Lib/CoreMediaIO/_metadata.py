...
#
# Last update: Sun Jul 11 21:34:06 2021
#
# flake8: noqa
...
misc.update(
    {
        ...
        "CMIOStreamDeck": objc.createStructType(
            "CMIOStreamDeck", b"{CMIOStreamDeck=III}", ["mStatus", "mState", "mState2"]
        ),
...
functions = {
    ...
    "CMIOStreamClockPostTimingEvent": (b"i{_CMTime=qiIq}QZ@",),
