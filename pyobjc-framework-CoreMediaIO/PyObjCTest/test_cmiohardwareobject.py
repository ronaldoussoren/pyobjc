...
class TestCMIOHardwareObject (TestCase):
    ...
    def testConstants(self):
        ...
        self.assertEqual(CoreMediaIO.kCMIOObjectPropertyElementCategoryName, fourcc(b'lccn'))
        self.assertEqual(CoreMediaIO.kCMIOObjectPropertyElementNumberName, fourcc(b'lcnn'))
    ...
    def testFunctions(self):
        ...
        self.assertArgIsFunction(CoreMediaIO.CMIOObjectAddPropertyListener, 2, CMIOObjectPropertyListenerProc, True)

        self.assertArgIsIn(CoreMediaIO.CMIOObjectRemovePropertyListener, 1)
        self.assertArgIsFunction(CoreMediaIO.CMIOObjectRemovePropertyListener, 2, CMIOObjectPropertyListenerProc, True)

        self.assertArgIsIn(CoreMediaIO.CMIOObjectAddPropertyListenerBlock, 1)
        self.assertArgIsBlock(CoreMediaIO.CMIOObjectAddPropertyListenerBlock, 3, CMIOObjectPropertyListenerBlock)

        self.assertArgIsIn(CoreMediaIO.CMIOObjectRemovePropertyListenerBlock, 1)
        self.assertArgIsBlock(CoreMediaIO.CMIOObjectRemovePropertyListenerBlock, 3, CMIOObjectPropertyListenerBlock)
