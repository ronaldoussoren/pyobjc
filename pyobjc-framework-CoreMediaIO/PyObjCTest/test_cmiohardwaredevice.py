...
class TestCMIOHardwareDevice (TestCase):
    ...
    def testConstants(self):
        ...
        self.assertEqual(CoreMediaIO.kCMIODevicePropertyDeviceIsRunningSomewhere, fourcc(b'gone'))
        self.assertEqual(CoreMediaIO.kCMIODevicePropertyDeviceCanBeDefaultDevice, fourcc(b'dflt'))
        ...
        self.assertEqual(CoreMediaIO.kCMIODevicePropertyStreamConfiguration, fourcc(b'slay'))
        self.assertEqual(CoreMediaIO.kCMIODevicePropertyDeviceMaster, fourcc(b'pmnh'))
        self.assertEqual(CoreMediaIO.kCMIODevicePropertyExcludeNonDALAccess, fourcc(b'ixna'))
        self.assertEqual(CoreMediaIO.kCMIODevicePropertyClientSyncDiscontinuity, fourcc(b'pmcs'))
        self.assertEqual(CoreMediaIO.kCMIODevicePropertySMPTETimeCallback, fourcc(b'pmsc'))
        self.assertEqual(CoreMediaIO.kCMIODevicePropertyCanProcessAVCCommand, fourcc(b'pmac'))
        self.assertEqual(CoreMediaIO.kCMIODevicePropertyAVCDeviceType, fourcc(b'pmat'))
        self.assertEqual(CoreMediaIO.kCMIODevicePropertyAVCDeviceSignalMode, fourcc(b'pmsm'))
        self.assertEqual(CoreMediaIO.kCMIODevicePropertyCanProcessRS422Command, fourcc(b'r422'))
        self.assertEqual(CoreMediaIO.kCMIODevicePropertyLinkedCoreAudioDeviceUID, fourcc(b'plud'))
        self.assertEqual(CoreMediaIO.kCMIODevicePropertyVideoDigitizerComponents, fourcc(b'vdig'))
        self.assertEqual(CoreMediaIO.kCMIODevicePropertySuspendedByUser, fourcc(b'sbyu'))
        self.assertEqual(CoreMediaIO.kCMIODevicePropertyLinkedAndSyncedCoreAudioDeviceUID, fourcc(b'plsd'))
        self.assertEqual(CoreMediaIO.kCMIODevicePropertyIIDCInitialUnitSpace, fourcc(b'iuns'))
