...
class TestCMIOSampleBuffer(TestCase):
    ...
    def testConstants10_7(self):
        self.assertIsInstance(
            CoreMediaIO.kCMIOSampleBufferAttachmentKey_DiscontinuityFlags, unicode
        )
        self.assertIsInstance(
            CoreMediaIO.kCMIOSampleBufferAttachmentKey_SequenceNumber, unicode
        )
        self.assertIsInstance(
            CoreMediaIO.kCMIOSampleBufferAttachmentKey_HDV1_PackData, unicode
        )
        self.assertIsInstance(
            CoreMediaIO.kCMIOSampleBufferAttachmentKey_HDV2_VAUX, unicode
        )
        self.assertIsInstance(
            CoreMediaIO.kCMIOSampleBufferAttachmentKey_CAAudioTimeStamp, unicode
        )
        self.assertIsInstance(
            CoreMediaIO.kCMIOSampleBufferAttachmentKey_SMPTETime, unicode
        )
        self.assertIsInstance(
            CoreMediaIO.kCMIOSampleBufferAttachmentKey_NativeSMPTEFrameCount, unicode
        )
        self.assertIsInstance(
            CoreMediaIO.kCMIOSampleBufferAttachmentKey_NumberOfVideoFramesInBuffer,
            unicode,
        )
        self.assertIsInstance(
            CoreMediaIO.kCMIOSampleBufferAttachmentKey_NumberOfVideoFramesInGOP, unicode
        )
        self.assertIsInstance(
        ...
        self.assertIsInstance(
            CoreMediaIO.kCMIOSampleBufferAttachmentKey_HostTime, unicode
        )
        self.assertIsInstance(
            CoreMediaIO.kCMIOSampleBufferAttachmentKey_RepeatedBufferContents, unicode
        )
        self.assertIsInstance(
            CoreMediaIO.kCMIOSampleBufferAttachmentKey_SourceAudioFormatDescription,
            unicode,
        )
        self.assertIsInstance(
        ...
        self.assertIsInstance(
            CoreMediaIO.kCMIOBlockBufferAttachmentKey_CVPixelBufferReference, unicode
        )
