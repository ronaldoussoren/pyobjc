...
#
# Last update: Sat Jun  8 16:44:24 2019
...
constants = constants + "$kCFStreamErrorDomainSystemConfiguration@%s$" % (
    sel32or64("l", "i"),
)
...
functions = {
    "CFNetworkExecuteProxyAutoConfigurationURL": (
        sel32or64(
            b"^{__CFRunLoopSource=}^{__CFURL=}^{__CFURL=}^?^{_CFStreamClientContext=l^v^?^?^?}",
    ...
    "CFNetServiceBrowserGetTypeID": (sel32or64(b"L", b"Q"),),
    "CFHostCreateWithName": (
        b"^{__CFHost=}^{__CFAllocator=}@",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CFSocketStreamPairSetSecurityProtocol": (
        b"Z^{__CFReadStream=}^{__CFWriteStream=}i",
    ),
    "CFHostGetAddressing": (b"^{__CFArray=}^{__CFHost=}o^Z",),
    "CFHTTPMessageSetBody": (b"v^{__CFHTTPMessage=}^{__CFData=}",),
    "CFHTTPAuthenticationGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "CFSocketStreamSOCKSGetError": (
        sel32or64(b"l^{_CFStreamError=ll}", b"i^{_CFStreamError=qi}"),
        "",
    ...
    "CFNetServiceBrowserSearchForDomains": (
        sel32or64(
            b"Z^{__CFNetServiceBrowser=}Z^{_CFStreamError=ll}",
            b"Z^{__CFNetServiceBrowser=}Z^{_CFStreamError=qi}",
        ),
        "",
        {"arguments": {2: {"type_modifier": "o"}}},
    ),
    "CFNetServiceUnscheduleFromRunLoop": (b"v^{__CFNetService=}^{__CFRunLoop=}@",),
    "CFNetServiceMonitorStop": (
        sel32or64(
            b"v^{__CFNetServiceMonitor=}^{_CFStreamError=ll}",
    ...
    "CFHostGetReachability": (b"^{__CFData=}^{__CFHost=}o^Z",),
    "CFHTTPMessageIsHeaderComplete": (b"Z^{__CFHTTPMessage=}",),
    "CFHTTPMessageGetTypeID": (sel32or64(b"L", b"Q"),),
    "CFNetServiceMonitorGetTypeID": (sel32or64(b"L", b"Q"),),
    "CFNetServiceGetPortNumber": (
        sel32or64(b"l^{__CFNetService=}", b"i^{__CFNetService=}"),
    ),
    "CFHTTPMessageCreateRequest": (
        b"^{__CFHTTPMessage=}^{__CFAllocator=}@^{__CFURL=}@",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "CFNetServiceGetName": (b"@^{__CFNetService=}",),
    ...
    "CFNetServiceMonitorCreate": (
        b"^{__CFNetServiceMonitor=}^{__CFAllocator=}^{__CFNetService=}^?^{CFNetServiceClientContext=l^v^?^?^?}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "CFNetServiceBrowserUnscheduleFromRunLoop": (
        b"v^{__CFNetServiceBrowser=}^{__CFRunLoop=}@",
    ),
    ...
    "CFNetServiceCreate": (
        sel32or64(
            b"^{__CFNetService=}^{__CFAllocator=}@@@l",
            b"^{__CFNetService=}^{__CFAllocator=}@@@i",
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CFNetServiceMonitorUnscheduleFromRunLoop": (
        b"v^{__CFNetServiceMonitor=}^{__CFRunLoop=}@",
    ),
    "CFHostScheduleWithRunLoop": (b"v^{__CFHost=}^{__CFRunLoop=}@",),
    "CFNetServiceMonitorStart": (
        sel32or64(
            b"Z^{__CFNetServiceMonitor=}i^{_CFStreamError=ll}",
            b"Z^{__CFNetServiceMonitor=}i^{_CFStreamError=qi}",
        ),
        "",
        {"arguments": {2: {"type_modifier": "o"}}},
    ),
    "CFHostGetNames": (b"^{__CFArray=}^{__CFHost=}o^Z",),
    "CFNetDiagnosticCopyNetworkStatusPassively": (
        sel32or64(
            b"l^{__CFNetDiagnostic=}^^{__CFString}",
    ...
    "CFNetDiagnosticDiagnoseProblemInteractively": (
        sel32or64(b"l^{__CFNetDiagnostic=}", b"q^{__CFNetDiagnostic=}"),
    ),
    "CFHTTPMessageAddAuthentication": (b"Z^{__CFHTTPMessage=}^{__CFHTTPMessage=}@@@Z",),
    "CFNetDiagnosticCreateWithURL": (
        b"^{__CFNetDiagnostic=}^{__CFAllocator=}^{__CFURL=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CFNetServiceGetDomain": (b"@^{__CFNetService=}",),
    "CFFTPCreateParsedResourceListing": (
        sel32or64(
            b"l^{__CFAllocator=}^vl^^{__CFDictionary}",
    ...
    "CFNetServiceGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "CFHTTPMessageAppendBytes": (
        sel32or64(b"Z^{__CFHTTPMessage=}^vl", b"Z^{__CFHTTPMessage=}^vq"),
        "",
    ...
    "CFNetServiceBrowserSearchForServices": (
        sel32or64(
            b"Z^{__CFNetServiceBrowser=}@@^{_CFStreamError=ll}",
            b"Z^{__CFNetServiceBrowser=}@@^{_CFStreamError=qi}",
        ),
        "",
    ...
    "CFHTTPAuthenticationIsValid": (
        sel32or64(
            b"Z^{_CFHTTPAuthentication=}^{_CFStreamError=ll}",
    ...
    "CFHTTPReadStreamSetProxy": (
        sel32or64(b"v^{__CFReadStream=}@l", b"v^{__CFReadStream=}@q"),
    ),
    ...
    "CFHTTPMessageSetHeaderFieldValue": (b"v^{__CFHTTPMessage=}@@",),
    "CFNetServiceBrowserStopSearch": (
        sel32or64(
            b"v^{__CFNetServiceBrowser=}^{_CFStreamError=ll}",
    ...
    "CFHTTPMessageApplyCredentials": (
        sel32or64(
            b"Z^{__CFHTTPMessage=}^{_CFHTTPAuthentication=}@@^{_CFStreamError=ll}",
            b"Z^{__CFHTTPMessage=}^{_CFHTTPAuthentication=}@@^{_CFStreamError=qi}",
        ),
        "",
    ...
    "CFNetServiceRegisterWithOptions": (
        sel32or64(
            b"Z^{__CFNetService=}L^{_CFStreamError=ll}",
    ...
    "CFNetServiceBrowserCreate": (
        b"^{__CFNetServiceBrowser=}^{__CFAllocator=}^?^{CFNetServiceClientContext=l^v^?^?^?}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "CFNetServiceGetTargetHost": (b"@^{__CFNetService=}",),
    "CFNetworkCopyProxiesForAutoConfigurationScript": (
        b"^{__CFArray=}@^{__CFURL=}^^{__CFError}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "CFNetServiceRegister": (
        sel32or64(
            b"Z^{__CFNetService=}^{_CFStreamError=ll}",
    ...
    "CFNetServiceGetType": (b"@^{__CFNetService=}",),
    "CFNetServiceScheduleWithRunLoop": (b"v^{__CFNetService=}^{__CFRunLoop=}@",),
    ...
    "CFHostStartInfoResolution": (
        sel32or64(
            b"Z^{__CFHost=}i^{_CFStreamError=ll}", b"Z^{__CFHost=}i^{_CFStreamError=qi}"
        ),
        "",
        {"arguments": {2: {"type_modifier": "o"}}},
    ),
    "CFHTTPAuthenticationRequiresUserNameAndPassword": (b"Z^{_CFHTTPAuthentication=}",),
    "CFNetDiagnosticSetName": (b"v^{__CFNetDiagnostic=}@",),
    ...
    "CFNetServiceSetClient": (
        b"Z^{__CFNetService=}^?^{CFNetServiceClientContext=l^v^?^?^?}",
        "",
        {
            "arguments": {
                1: {
    ...
    "CFHostUnscheduleFromRunLoop": (b"v^{__CFHost=}^{__CFRunLoop=}@",),
    "CFHTTPMessageApplyCredentialDictionary": (
        sel32or64(
            b"Z^{__CFHTTPMessage=}^{_CFHTTPAuthentication=}^{__CFDictionary=}^{_CFStreamError=ll}",
    ...
    "CFHTTPMessageCreateResponse": (
        sel32or64(
            b"^{__CFHTTPMessage=}^{__CFAllocator=}l@@",
            b"^{__CFHTTPMessage=}^{__CFAllocator=}q@@",
        ),
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "CFHostGetTypeID": (sel32or64(b"L", b"Q"),),
    ...
    "CFHTTPMessageGetResponseStatusCode": (
        sel32or64(b"l^{__CFHTTPMessage=}", b"q^{__CFHTTPMessage=}"),
    ),
    ...
    "CFStreamCreatePairWithSocketToCFHost": (
        sel32or64(
            b"v^{__CFAllocator=}^{__CFHost=}l^^{__CFReadStream}^^{__CFWriteStream}",
    ...
    "CFNetServiceResolveWithTimeout": (
        sel32or64(
            b"Z^{__CFNetService=}d^{_CFStreamError=ll}",
    ...
    "CFHostSetClient": (
        b"Z^{__CFHost=}^?^{CFHostClientContext=l^v^?^?^?}",
        "",
        {
            "arguments": {
                1: {
