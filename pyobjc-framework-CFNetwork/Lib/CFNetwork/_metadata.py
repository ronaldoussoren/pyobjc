...
functions = {
    "CFNetworkExecuteProxyAutoConfigurationURL": (
        b"^{__CFRunLoopSource=}^{__CFURL=}^{__CFURL=}^?@",
        "",
        {
            "arguments": {
                2: {
    ...
    "CFNetServiceMonitorCreate": (
        b"^{__CFNetServiceMonitor=}^{__CFAllocator=}^{__CFNetService=}^?@",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "CFNetworkExecuteProxyAutoConfigurationScript": (
        b"^{__CFRunLoopSource=}^{__CFString=}^{__CFURL=}^?@",
        "",
        {
            "arguments": {
                2: {
    ...
    "CFHTTPReadStreamSetProxy": (b"^{__CFReadStream=}^{__CFAllocator=}@",),
    ...
    "CFNetServiceBrowserCreate": (
        b"^{__CFNetServiceBrowser=}^{__CFAllocator=}^?@",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
