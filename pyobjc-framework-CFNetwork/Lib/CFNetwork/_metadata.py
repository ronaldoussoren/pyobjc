...
#
# Last update: Sun Jun 28 21:13:27 2020
#
# flake8: noqa
...
functions = {
    ...
    "CFNetDiagnosticCopyNetworkStatusPassively": (
        b"q^{__CFNetDiagnostic=}o^^{__CFString=}",
        "",
    ...
    "CFFTPCreateParsedResourceListing": (
        b"q^{__CFAllocator=}n^vqo^^{__CFDictionary=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
                1: {"c_array_length_in_arg": 2},
    ...
    "CFHTTPAuthenticationIsValid": (
        b"Z^{_CFHTTPAuthentication=}o^{_CFStreamError=qi}",
    ),
    ...
    "CFNetServiceRegisterWithOptions": (b"Z^{__CFNetService=}Qo^{_CFStreamError=qi}",),
    ...
    "CFHostStartInfoResolution": (b"Z^{__CFHost=}io^{_CFStreamError=qi}",),
    ...
    "CFStreamCreatePairWithSocketToCFHost": (
        b"v^{__CFAllocator=}^{__CFHost=}io^^{__CFReadStream=}o^^{__CFWriteStream=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
                3: {"already_cfretained": True},
                4: {"already_cfretained": True},
            },
        },
    ),
    "CFStreamCreatePairWithSocketToNetService": (
        b"v^{__CFAllocator=}^{__CFNetService=}o^^{__CFReadStream=}o^^{__CFWriteStream=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "CFNetServiceResolveWithTimeout": (b"Z^{__CFNetService=}do^{_CFStreamError=qi}",),
    "CFHostSetClient": (
