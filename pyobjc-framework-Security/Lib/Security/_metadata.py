...
#
# Last update: Fri Aug  9 18:56:58 2019
...
misc.update(
    {
        "AuthorizationExternalForm": objc.createStructType(
            "AuthorizationExternalForm", b"{_AuthorizationExternalForm=[32C]}", ["bytes"]
        ),
...
functions = {
    ...
    "SecKeyGeneratePair": (
        b"i@o^@o^@",
        "",
        {"arguments": {1: {"already_cfretained": True}, 2: {"already_cfretained": True}}},
    ),
    "SecCodeCopyPath": (b"i@Io^@", "", {"arguments": {2: {"already_cfretained": True}}}),
    ...
    "SecPKCS12Import": (b"i@@o^@", "", {"arguments": {2: {"already_cfretained": True}}}),
    ...
    "SecAccessCreate": (b"i@@o^@", "", {"arguments": {2: {"already_cfretained": True}}}),
    ...
    "SSLCopyPeerTrust": (b"i@o^@", "", {"arguments": {1: {"already_cfretained": True}}}),
    ...
    "SecDecryptTransformCreate": (b"@@o^@", "", {"retval": {"already_cfretained": True}}),
    ...
    "SecCertificateCopyValues": (b"@@@o^@", "", {"retval": {"already_cfretained": True}}),
    ...
    "SecDecodeTransformCreate": (b"@@o^@", "", {"retval": {"already_cfretained": True}}),
    ...
    "SecCertificateCopyPreferred": (b"@@@", "", {"retval": {"already_cfretained": True}}),
    ...
    "SecVerifyTransformCreate": (b"@@@o^@", "", {"retval": {"already_cfretained": True}}),
    ...
    "SecCopyErrorMessageString": (b"@i^v", "", {"retval": {"already_cfretained": True}}),
    ...
    "SecCodeCopyHost": (b"i@Io^@", "", {"arguments": {2: {"already_cfretained": True}}}),
    ...
    "SSLRead": (b"i@o^vLo^L", "", {"arguments": {1: {"c_array_length_in_arg": (2, 3)}}}),
    ...
    "SecEncodeTransformCreate": (b"@@o^@", "", {"retval": {"already_cfretained": True}}),
    ...
    "SecKeyUnwrapSymmetric": (b"@n^@@@o^@", "", {"retval": {"already_cfretained": True}}),
    ...
    "SSLClose": (b"i@",),
    "SecKeyDeriveFromPassword": (b"@@@o^@", "", {"retval": {"already_cfretained": True}}),
    ...
    "SecEncryptTransformCreate": (b"@@o^@", "", {"retval": {"already_cfretained": True}}),
    "CMSEncoderCreate": (b"io^@", "", {"arguments": {0: {"already_cfretained": True}}}),
    "CMSEncodeContent": (
        b"i@@@ZIn^vLo^@",
        "",
        {"arguments": {5: {"c_array_length_in_arg": 6}, 7: {"already_cfretained": True}}},
    ),
}
aliases = {
...
misc.update(
    {
        ...
        "SecRandomRef": objc.createOpaquePointerType("SecRandomRef", b"^{__SecRandom=}"),
