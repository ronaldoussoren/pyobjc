...
misc.update(
    {
        "AuthorizationRights": objc.createStructType(
            "Security.AuthorizationRights",
            b"{AuthorizationItemSet=I^{AuthorizationItem=^cQ^vI}}",
            [],
        ),
        ...
        "SecItemImportExportKeyParameters": objc.createStructType(
            ...
            b"{SecItemImportExportKeyParameters=II@^{__CFString=}^{__CFString=}^{__SecAccess=}^{__CFArray=}^{__CFArray=}}",
            [
                "version",
                "flags",
                "passphrase",
        ...
        "AuthorizationEnvironment": objc.createStructType(
            "Security.AuthorizationEnvironment",
            b"{AuthorizationItemSet=I^{AuthorizationItem=^cQ^vI}}",
            [],
        ),
        ...
        "SecAsn1AlgId": objc.createStructType(
            ...
            b"{SecAsn1AlgId={cssm_data=Q^C}{cssm_data=Q^C}}",
        ...
        "SecKeyImportExportParameters": objc.createStructType(
            "Security.SecKeyImportExportParameters",
            b"{SecKeyImportExportParameters=II@^{__CFString=}^{__CFString=}^{__SecAccess=}II}",
            [
                "version",
                "flags",
                "passphrase",
        ...
        "AuthorizationExternalForm": objc.createStructType(
            ...
            b"{AuthorizationExternalForm=[32c]}",
            ["bytes"],
        ),
        "SecAsn1PubKeyInfo": objc.createStructType(
            "Security.SecAsn1PubKeyInfo",
            b"{SecAsn1PubKeyInfo={SecAsn1AlgId={cssm_data=Q^C}{cssm_data=Q^C}}{cssm_data=Q^C}}",
...
misc.update(
    {
        ...
        "SecExternalItemType": NewType("SecExternalItemType", int),
        ...
        "SecKeyOperationType": NewType("SecKeyOperationType", int),
        "CMSCertificateChainMode": NewType("CMSCertificateChainMode", int),
        "SecItemImportExportFlags": NewType("SecItemImportExportFlags", int),
        ...
        "SecPadding": NewType("SecPadding", int),
        "CMSSignerStatus": NewType("CMSSignerStatus", int),
        "SSLConnectionType": NewType("SSLConnectionType", int),
        "SSLSessionState": NewType("SSLSessionState", int),
        "SecKeyImportExportFlags": NewType("SecKeyImportExportFlags", int),
        ...
        "SecKeychainPromptSelector": NewType("SecKeychainPromptSelector", int),
        "SecPreferencesDomain": NewType("SecPreferencesDomain", int),
        "SSLClientCertificateState": NewType("SSLClientCertificateState", int),
        "SecCredentialType": NewType("SecCredentialType", int),
        "AuthorizationFlags": NewType("AuthorizationFlags", int),
        ...
        "SSLProtocolSide": NewType("SSLProtocolSide", int),
        "SSLProtocol": NewType("SSLProtocol", int),
        "SSLSessionOption": NewType("SSLSessionOption", int),
        "SSLAuthenticate": NewType("SSLAuthenticate", int),
        "SecKeyUsage": NewType("SecKeyUsage", int),
        "SecKeySizes": NewType("SecKeySizes", int),
...
misc.update(
    {
        ...
        "SecCredentialType": NewType("SecCredentialType", int),
        "SSLConnectionType": NewType("SSLConnectionType", int),
        "SecAccessOwnerType": NewType("SecAccessOwnerType", int),
        "SSLSessionState": NewType("SSLSessionState", int),
        "SecKeyOperationType": NewType("SecKeyOperationType", int),
    }
)
...
functions = {
    ...
    "SecKeyGeneratePair": (
        b"i^{__CFDictionary=}^^{__SecKey=}^^{__SecKey=}",
        "",
        {
            "arguments": {
    ...
    "SecKeychainItemExport": (
        b"i@II^{SecKeyImportExportParameters=II@^{__CFString=}^{__CFString=}^{__SecAccess=}II}^^{__CFData=}",
        "",
        {
            "arguments": {
                3: {"type_modifier": "n"},
    ...
    "SecKeyIsAlgorithmSupported": (b"Z^{__SecKey=}q^{__CFString=}",),
    "SecTrustSetPolicies": (b"i^{__SecTrust=}@",),
    "SecTrustCopyKey": (
        b"^{__SecKey=}^{__SecTrust=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "SSLSetError": (b"i^{SSLContext=}i",),
    ...
    "SecTransformSetTransformAction": (
        b"^{__CFError=}^{OpaqueSecTransformImplementation=}^{__CFString=}@?",
        "",
        {
            "arguments": {
                2: {
    ...
    "sec_protocol_options_set_tls_tickets_enabled": (b"v@B",),
    "SSLGetSessionState": (
        b"i^{SSLContext=}^i",
        "",
        {"arguments": {1: {"type_modifier": "o"}}},
    ),
    "CMSEncoderSetEncapsulatedContentTypeOID": (b"i^{_CMSEncoder=}@",),
    "SecItemImport": (
        b"i^{__CFData=}^{__CFString=}^I^II^{SecItemImportExportKeyParameters=II@^{__CFString=}^{__CFString=}^{__SecAccess=}^{__CFArray=}^{__CFArray=}}^{__SecKeychain=}^^{__CFArray=}",
        "",
        {
            "arguments": {
                2: {"type_modifier": "N"},
    ...
    "sec_protocol_options_set_tls_ocsp_enabled": (b"v@B",),
    "SecTrustEvaluate": (
        b"i^{__SecTrust=}^I",
        "",
        {"arguments": {1: {"type_modifier": "o"}}},
    ...
    "SecKeyCreateEncryptedData": (
        b"^{__CFData=}^{__SecKey=}^{__CFString=}^{__CFData=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "SSLSetEncryptionCertificate": (b"i^{SSLContext=}^{__CFArray=}",),
    "SecHostCreateGuest": (
    ...
    "SSLSetSessionTicketsEnabled": (b"i^{SSLContext=}Z",),
    ...
    "SecStaticCodeCheckValidityWithErrors": (
        b"i^{__SecCode=}I^{__SecRequirement=}^^{__CFError=}",
        "",
        {
            "arguments": {
                3: {
    ...
    "SecAccessCreateWithOwnerAndACL": (
        b"^{__SecAccess=}III^{__CFArray=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "SecACLSetContents": (b"i^{__SecACL=}^{__CFArray=}^{__CFString=}S",),
    "sec_protocol_options_append_tls_ciphersuite": (b"v@S",),
    "SecTrustGetCertificateCount": (b"q^{__SecTrust=}",),
    "SecPKCS12Import": (
        b"i^{__CFData=}^{__CFDictionary=}^^{__CFArray=}",
        "",
        {"arguments": {2: {"already_cfretained": True, "type_modifier": "o"}}},
    ),
    ...
    "SecCodeValidateFileResource": (b"i^{__SecCode=}^{__CFString=}^{__CFData=}I",),
    ...
    "SecACLGetTypeID": (b"Q",),
    "SecTrustSettingsSetTrustSettings": (b"i^{__SecCertificate=}I@",),
    "SecKeyCopyExternalRepresentation": (
        b"^{__CFData=}^{__SecKey=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "AuthorizationExecuteWithPrivileges": (
        b"i^{AuthorizationOpaqueRef=}^tI^^t^^{__sFILE=^Ciiss{__sbuf=^Ci}i^v^?^?^?^?{__sbuf=^Ci}^{__sFILEX=}i[3C][1C]{__sbuf=^Ci}iq}",
        "",
        {
            "arguments": {
                1: {"c_array_delimited_by_null": True, "type_modifier": "n"},
                3: {"c_array_delimited_by_null": True, "type_modifier": "n"},
                4: {"null_accepted": True, "type_modifier": "o"},
            }
        },
    ),
    ...
    "SSLSetSessionOption": (b"i^{SSLContext=}iZ",),
    "sec_protocol_options_set_peer_authentication_required": (b"v@B",),
    ...
    "SecTrustSetVerifyDate": (b"i^{__SecTrust=}^{__CFDate=}",),
    "sec_trust_copy_ref": (
        b"^{__SecTrust=}@",
        "",
        {"retval": {"already_cfretained": True}},
    ...
    "SecKeychainItemImport": (
        b"i^{__CFData=}^{__CFString=}^I^II^{SecKeyImportExportParameters=II@^{__CFString=}^{__CFString=}^{__SecAccess=}II}^{__SecKeychain=}^^{__CFArray=}",
        "",
        {
            "arguments": {
                2: {"type_modifier": "N"},
    ...
    "SecKeychainItemDelete": (b"i^{__SecKeychainItem=}",),
    ...
    "sec_protocol_options_set_tls_false_start_enabled": (b"v@B",),
    "SecKeychainLock": (b"i^{__SecKeychain=}",),
    ...
    "CMSEncoderAddRecipients": (b"i^{_CMSEncoder=}@",),
    "sec_protocol_options_set_tls_is_fallback_attempt": (b"v@B",),
    ...
    "SecKeyCreateWithData": (
        b"^{__SecKey=}^{__CFData=}^{__CFDictionary=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "AuthorizationRightSet": (
        b"i^{AuthorizationOpaqueRef=}^t@^{__CFString=}^{__CFBundle=}^{__CFString=}",
        "",
        {"arguments": {1: {"c_array_delimited_by_null": True, "type_modifier": "n"}}},
    ),
    "SecACLRemove": (b"i^{__SecACL=}",),
    ...
    "SSLSetSessionConfig": (b"i^{SSLContext=}^{__CFString=}",),
    "SecCertificateCreateWithData": (
        b"^{__SecCertificate=}^{__CFAllocator=}^{__CFData=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "sec_protocol_metadata_get_negotiated_ciphersuite": (selAorI(b"S@", b"I@"),),
    ...
    "SecHostSetGuestStatus": (b"iII^{__CFDictionary=}I",),
    ...
    "SSLGetNegotiatedCipher": (
        selAorI(b"i^{SSLContext=}^S", b"i^{SSLContext=}^I"),
        "",
        {"arguments": {1: {"type_modifier": "o"}}},
    ),
    ...
    "SecKeyCopyKeyExchangeResult": (
        b"^{__CFData=}^{__SecKey=}^{__CFString=}^{__SecKey=}^{__CFDictionary=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
        ...
        "",
        {
            "arguments": {
                1: {
                    "callable": {
                        "retval": {"type": b"v"},
                        "arguments": {0: {"type": b"^v"}, 1: {"type": b"S"}},
                    }
                }
            }
        },
    ),
    "SecTransformFindByName": (b"@@^{__CFString=}",),
    ...
    "SecCertificateCopyValues": (
        b"^{__CFDictionary=}^{__SecCertificate=}^{__CFArray=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "SecTrustSetAnchorCertificatesOnly": (b"i^{__SecTrust=}Z",),
    "SSLGetPeerID": (
        b"i^{SSLContext=}^v^Q",
        "",
        {
    ...
    "SSLSetConnection": (b"i^{SSLContext=}@",),
    ...
    "SSLSetALPNProtocols": (b"i^{SSLContext=}^{__CFArray=}",),
    ...
    "SecKeychainGetPath": (
        b"i^{__SecKeychain=}^I^t",
        "",
        {
            "arguments": {
                1: {"type_modifier": "N"},
                2: {"type_modifier": "o", "c_array_length_in_arg": 1},
            }
        },
    ),
    ...
    "SSLGetSupportedCiphers": (
        ...
        {
            "arguments": {
                1: {"c_array_length_in_arg": 2, "type_modifier": "o"},
                2: {"type_modifier": "N"},
            }
        },
    ),
    ...
    "CMSEncoderSetSignerAlgorithm": (b"i^{_CMSEncoder=}^{__CFString=}",),
    "SecCertificateAddToKeychain": (b"i^{__SecCertificate=}^{__SecKeychain=}",),
    ...
    "SSLSetMaxDatagramRecordSize": (b"i^{SSLContext=}Q",),
            ...
            "arguments": {
                1: {
                    "callable": {
                        ...
                        "arguments": {
                            0: {"type": b"@"},
                            1: {"type": b"o^v", "c_array_length_in_arg": 2},
                            2: {"type": b"N^L"},
                        },
                    },
                    "callable_retained": True,
    ...
    "SSLSetProtocolVersionMax": (b"i^{SSLContext=}i",),
    ...
    "SecAccessControlCreateWithFlags": (
        b"^{__SecAccessControl=}^{__CFAllocator=}@Q^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "SecKeychainFindGenericPassword": (
        b"i@I^tI^t^I^t^^{__SecKeychainItem=}",
        "",
        {
            "arguments": {
                2: {"c_array_lenght_in_arg": 1, "type_modifier": "n"},
                4: {"c_array_lenght_in_arg": 3, "type_modifier": "n"},
                5: {"type_modifier": "o"},
                6: {"c_array_lenght_in_arg": 5, "type_modifier": "o"},
                7: {"type_modifier": "o"},
            }
        },
    ),
    ...
    "SecTransformGetAttribute": (b"@@^{__CFString=}",),
    ...
    "SecCertificateCopyPreferred": (
        b"^{__SecCertificate=}^{__CFString=}^{__CFArray=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    ...
    "SecCodeCheckValidity": (b"i^{__SecCode=}I^{__SecRequirement=}",),
    ...
    "SecKeychainAddGenericPassword": (
        b"i^{__SecKeychain=}In^tIn^tI^v^^{__SecKeychainItem=}",
        "",
        {
            "arguments": {
    ...
    "SecTaskCopyValueForEntitlement": (
        b"@^{__SecTask=}^{__CFString=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "sec_protocol_metadata_get_negotiated_tls_ciphersuite": (b"S@",),
    "SSLGetDatagramWriteSize": (
        b"i^{SSLContext=}^Q",
        "",
        {"arguments": {1: {"type_modifier": "o"}}},
    ),
    "SecIdentitySetPreferred": (b"i^{__SecIdentity=}^{__CFString=}^{__CFArray=}",),
    ...
    "SecCertificateCopyShortDescription": (
        b"^{__CFString=}^{__CFAllocator=}^{__SecCertificate=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "SecIdentityCopyPreferred": (
        b"^{__SecIdentity=}^{__CFString=}^{__CFArray=}^{__CFArray=}",
        "",
        {"retval": {"already_cfretained": True}},
    ),
    "SecACLUpdateAuthorizations": (b"i^{__SecACL=}^{__CFArray=}",),
    "SecAccessGetTypeID": (b"Q",),
    "SecKeychainItemGetTypeID": (b"Q",),
    "SecTrustSetKeychains": (b"i^{__SecTrust=}@",),
    ...
    "SecTrustSettingsRemoveTrustSettings": (b"i^{__SecCertificate=}I",),
    ...
    "SecKeychainFindInternetPassword": (
        ...
        "",
        {
            "arguments": {
                2: {"c_array_lenght_in_arg": 1, "type_modifier": "n"},
                4: {"c_array_lenght_in_arg": 3, "type_modifier": "n"},
                6: {"c_array_lenght_in_arg": 5, "type_modifier": "n"},
                8: {"c_array_lenght_in_arg": 7, "type_modifier": "n"},
                12: {"type_modifier": "o"},
                13: {"c_array_lenght_in_arg": 12, "type_modifier": "o"},
                14: {"type_modifier": "o"},
            }
        },
    ),
    ...
    "SecTaskCopyValuesForEntitlements": (
        b"^{__CFDictionary=}^{__SecTask=}^{__CFArray=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "SecItemExport": (
        b"i@II^{SecItemImportExportKeyParameters=II@^{__CFString=}^{__CFString=}^{__SecAccess=}^{__CFArray=}^{__CFArray=}}^^{__CFData=}",
        "",
        {
            "arguments": {
                3: {"type_modifier": "n"},
    ...
    "SSLSetProtocolVersionMin": (b"i^{SSLContext=}i",),
    ...
    "SecKeychainSetAccess": (b"i^{__SecKeychain=}^{__SecAccess=}",),
    ...
    "SecKeychainSetSearchList": (b"i^{__CFArray=}",),
    ...
    "SecKeychainGetVersion": (b"i^I", "", {"arguments": {0: {"type_modifier": "o"}}}),
    "SecKeyCreateRandomKey": (
        b"^{__SecKey=}^{__CFDictionary=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "sec_protocol_options_set_tls_renegotiation_enabled": (b"v@B",),
    ...
    "SSLSetCertificateAuthorities": (b"i^{SSLContext=}@Z",),
    ...
    "SecTrustGetVerifyTime": (b"d^{__SecTrust=}",),
    ...
    "SecKeychainAddInternetPassword": (
        b"i^{__SecKeychain=}In^tIn^tIn^tIn^tSIII^v^^{__SecKeychainItem=}",
        "",
        {
            "arguments": {
                2: {"c_array_length_in_arg": 1},
                ...
                13: {"c_array_length_in_arg": 12, "type_modifier": "n"},
                14: {"already_cfretained": True, "type_modifier": "o"},
            }
        },
    ),
    ...
    "SecIdentitySetSystemIdentity": (b"i^{__CFString=}^{__SecIdentity=}",),
    "CMSEncoderSetHasDetachedContent": (b"i^{_CMSEncoder=}Z",),
    ...
    "SecCertificateSetPreferred": (
        b"i^{__SecCertificate=}^{__CFString=}^{__CFArray=}",
    ),
    ...
    "SecTaskCopySigningIdentifier": (
        b"^{__CFString=}^{__SecTask=}^^{__CFError=}",
        "",
        {
            "retval": {"already_cfretained": True},
            "arguments": {
    ...
    "CMSEncodeContent": (
        ...
        {
            "arguments": {
                5: {"c_array_length_in_arg": 6, "type_modifier": "n"},
                7: {"already_cfretained": True, "type_modifier": "o"},
            }
        },
    ),
...
aliases = {
    ...
    "kSecCSUseSignature1": "kSecCSUseClassicalSignature",
    "kSecCSUseSignature2": "kSecCSUsePostQuantumSignature",
...
formal_protocols = {
    "OS_sec_certificate": "OS_sec_certificate",
    "OS_sec_identity": "OS_sec_identity",
    "OS_sec_protocol_metadata": "OS_sec_protocol_metadata",
    "OS_sec_protocol_options": "OS_sec_protocol_options",
    "OS_sec_trust": "OS_sec_trust",
}
