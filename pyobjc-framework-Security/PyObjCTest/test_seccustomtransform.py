...
class TestSecCustomTransform (TestCase):
    ...
    def test_constants(self):
        ...
        self.assertIsInstance(Security.kSecTransformActionCanExecute, unicode)
        self.assertIsInstance(Security.kSecTransformActionStartingExecution, unicode)
        self.assertIsInstance(Security.kSecTransformActionFinalize, unicode)
    ...
    def test_functions(self):
        ...
        self.assertArgHasType(Security.SecTransformSetAttributeAction, 0, Security.SecTransformImplementationRef.__typestr__)
        ...
        self.assertArgIsBlock(Security.SecTransformSetAttributeAction, 3, SecTransformAttributeActionBlock)

        self.assertResultHasType(Security.SecTransformSetDataAction, objc._C_ID)
        self.assertArgHasType(Security.SecTransformSetDataAction, 0, Security.SecTransformImplementationRef.__typestr__)
        self.assertArgHasType(Security.SecTransformSetDataAction, 1, objc._C_ID)
        self.assertArgIsBlock(Security.SecTransformSetDataAction, 2, SecTransformDataBlock)

        self.assertResultHasType(Security.SecTransformSetTransformAction, objc._C_ID)
        self.assertArgHasType(Security.SecTransformSetTransformAction, 0, Security.SecTransformImplementationRef.__typestr__)
        self.assertArgHasType(Security.SecTransformSetTransformAction, 1, objc._C_ID)
        self.assertArgIsBlock(Security.SecTransformSetTransformAction, 2, SecTransformActionBlock)

        self.assertResultHasType(Security.SecTranformCustomGetAttribute, objc._C_ID)
        self.assertArgHasType(Security.SecTranformCustomGetAttribute, 0, Security.SecTransformImplementationRef.__typestr__)
        self.assertArgHasType(Security.SecTranformCustomGetAttribute, 1, objc._C_ID)
        self.assertArgHasType(Security.SecTranformCustomGetAttribute, 2, objc._C_NSInteger)

        self.assertResultHasType(Security.SecTransformCustomGetAttribute, objc._C_ID)
        self.assertArgHasType(Security.SecTransformCustomGetAttribute, 0, Security.SecTransformImplementationRef.__typestr__)
        self.assertArgHasType(Security.SecTransformCustomGetAttribute, 1, objc._C_ID)
        self.assertArgHasType(Security.SecTransformCustomGetAttribute, 2, objc._C_NSInteger)

        self.assertResultHasType(Security.SecTransformCustomSetAttribute, objc._C_ID)
        self.assertArgHasType(Security.SecTransformCustomSetAttribute, 0, Security.SecTransformImplementationRef.__typestr__)
        self.assertArgHasType(Security.SecTransformCustomSetAttribute, 1, objc._C_ID)
        self.assertArgHasType(Security.SecTransformCustomSetAttribute, 2, objc._C_NSInteger)
        ...
        self.assertArgHasType(Security.SecTransformPushbackAttribute, 0, Security.SecTransformImplementationRef.__typestr__)
    ...
    def test_functions_10_7(self):
        ...
        self.assertArgIsFunction(Security.SecTransformRegister, 1, SecTransformCreateFP, 1)
        self.assertArgHasType(Security.SecTransformRegister, 2, objc._C_OUT + objc._C_PTR + objc._C_ID)
        ...
        self.assertArgHasType(Security.SecTransformCreate, 1, objc._C_OUT + objc._C_PTR + objc._C_ID)
