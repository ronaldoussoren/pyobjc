...
class Testoidscrl (TestCase):
    ...
    def test_unsuppported(self):
        ...
        self.assertFalse(hasattr(Security,'CSSMOID_X509V2CRLRevokedEntryAllExtensionsStruct'))
        self.assertFalse(hasattr(Security,'CSSMOID_X509V2CRLRevokedEntryAllExtensionsCStruct'))
        self.assertFalse(hasattr(Security,'CSSMOID_X509V2CRLRevokedEntryNumberOfExtensions'))
        self.assertFalse(hasattr(Security,'CSSMOID_X509V2CRLRevokedEntrySingleExtensionStruct'))
        self.assertFalse(hasattr(Security,'CSSMOID_X509V2CRLRevokedEntrySingleExtensionCStruct'))
        self.assertFalse(hasattr(Security,'CSSMOID_X509V2CRLRevokedEntryExtensionId'))
        self.assertFalse(hasattr(Security,'CSSMOID_X509V2CRLRevokedEntryExtensionCritical'))
