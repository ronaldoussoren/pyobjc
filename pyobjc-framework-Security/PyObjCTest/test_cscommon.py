...
class TestCSCommon(TestCase):
    ...
    def test_constants(self):
        ...
        self.assertIsInstance(Security.kSecCFErrorResourceSeal, str)
        self.assertIsInstance(Security.kSecCFErrorResourceAdded, str)
        self.assertIsInstance(Security.kSecCFErrorResourceAltered, str)
        self.assertIsInstance(Security.kSecCFErrorResourceMissing, str)
        self.assertIsInstance(Security.kSecCFErrorInfoPlist, str)
        self.assertIsInstance(Security.kSecCFErrorGuestAttributes, str)
        self.assertIsInstance(Security.kSecCFErrorRequirementSyntax, str)
        self.assertIsInstance(Security.kSecCFErrorPath, str)
