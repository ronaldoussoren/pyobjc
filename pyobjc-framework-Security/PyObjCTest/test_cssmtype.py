...
class Testcssmtype (TestCase):
    ...
    def test_unsuppported(self):
        ...
        self.assertFalse(hasattr(Security, 'CSSM_ACL_AUTHORIZATION_TAG_VENDOR_DEFINED_START'))
        ...
        self.assertFalse(hasattr(Security, 'CSSM_TP_CERTCHANGE_REASON_SUSPECTEDCOMPROMISE'))
        ...
        self.assertFalse(hasattr(Security, 'CSSM_TP_CERTVERIFY_INVALID_BASIC_CONSTRAINTS'))
        ...
        self.assertFalse(hasattr(Security, 'CSSM_CERT_BUNDLE_PKCS7_SIGNED_ENVELOPED_DATA'))
