...
class TestSecProtocolOptions (TestCase):
    ...
    def test_functions(self):
        ...
        self.assertArgHasType(Security.sec_protocol_options_set_tls_server_name, 1, b'n^t')
        self.assertArgIsNullTerminated(Security.sec_protocol_options_set_tls_server_name, 1)
