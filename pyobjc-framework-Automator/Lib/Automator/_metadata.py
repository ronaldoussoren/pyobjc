...
#
# Last update: Thu Feb  9 16:58:04 2012
...
protocols={'AMWorkflowControllerDelegate': objc.informal_protocol('AMWorkflowControllerDelegate', [objc.selector(None, 'workflowControllerWillRun:', b'v@:@', isRequired=False), objc.selector(None, 'workflowControllerWillStop:', b'v@:@', isRequired=False), objc.selector(None, 'workflowControllerDidRun:', b'v@:@', isRequired=False), objc.selector(None, 'workflowControllerDidStop:', b'v@:@', isRequired=False), objc.selector(None, 'workflowController:willRunAction:', b'v@:@@', isRequired=False), objc.selector(None, 'workflowController:didRunAction:', b'v@:@@', isRequired=False), objc.selector(None, 'workflowController:didError:', b'v@:@@', isRequired=False)])}
