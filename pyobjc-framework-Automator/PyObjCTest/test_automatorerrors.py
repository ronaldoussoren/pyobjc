...
class TestAutomatorErrors (TestCase):
    def testConstants(self):
        ...
        self.assertEqual(AMWorkflowActionsNotLoadedError, -113)
        self.assertEqual(AMWorkflowNoEnabledActionsError, -114)
        ...
        self.assertEqual(AMActionThirdPartyActionsNotAllowedError, -222)
