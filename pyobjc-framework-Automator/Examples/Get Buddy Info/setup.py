...
infoPlist = dict(
    AMAccepts=dict(
        Container="List", Optional=False, Types=["com.apple.addressbook.person-object"]
    ),
    ...
    AMProvides=dict(Container="List", Types=["com.apple.cocoa.string"]),
)
...
setup(
    ...
    data_files=[],
    options=dict(py2app=dict(extension=".action", plist=infoPlist)),
    setup_requires=[
        "py2app",
