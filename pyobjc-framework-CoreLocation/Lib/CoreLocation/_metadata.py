...
#
# Last update: Sun Nov 15 11:15:49 2020
#
# flake8: noqa
...
misc.update({'CLLocationCoordinate2D': objc.createStructType('CLLocationCoordinate2D', b'{CLLocationCoordinate2D=dd}', ['latitude', 'longitude'])})
...
misc.update({})
functions={'CLLocationCoordinate2DIsValid': (b'Z{CLLocationCoordinate2D=dd}',), 'CLLocationCoordinate2DMake': (b'{CLLocationCoordinate2D=dd}dd',)}
...
try:
    ...
    r(b'CLCircularRegion', b'center', {'retval': {'type': b'{CLLocationCoordinate2D=dd}'}})
    r(b'CLCircularRegion', b'containsCoordinate:', {'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}}})
    r(b'CLCircularRegion', b'initWithCenter:radius:identifier:', {'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}}})
    ...
    r(b'CLLocation', b'initWithCoordinate:altitude:horizontalAccuracy:verticalAccuracy:course:speed:timestamp:', {'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}}})
    r(b'CLLocation', b'initWithCoordinate:altitude:horizontalAccuracy:verticalAccuracy:timestamp:', {'arguments': {2: {'type': '{CLLocationCoordinate2D=dd}'}}})
    r(b'CLLocationManager', b'allowsBackgroundLocationUpdates', {'retval': {'type': b'Z'}})
    ...
    r(b'CLLocationManager', b'isAuthorizedForPreciseLocation', {'retval': {'type': 'Z'}})
    ...
    r(b'CLLocationManager', b'requestTemporaryFullAccuracyAuthorizationWithPurposeKey:completion:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'CLLocationManager', b'requestTemporaryPreciseLocationAuthorizationWithPurposeKey:completion:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'CLLocationManager', b'setAllowsBackgroundLocationUpdates:', {'arguments': {2: {'type': b'Z'}}})
    r(b'CLLocationManager', b'setPausesLocationUpdatesAutomatically:', {'arguments': {2: {'type': b'Z'}}})
    r(b'CLLocationManager', b'setShowsBackgroundLocationIndicator:', {'arguments': {2: {'type': b'Z'}}})
    r(b'CLLocationManager', b'showsBackgroundLocationIndicator', {'retval': {'type': b'Z'}})
    ...
    r(b'CLRegion', b'containsCoordinate:', {'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}}})
    r(b'CLRegion', b'initCircularRegionWithCenter:radius:identifier:', {'arguments': {2: {'type': b'{CLLocationCoordinate2D=dd}'}}})
    ...
    r(b'NSObject', b'locationManager:didDetermineState:forRegion:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'q'}, 4: {'type': b'@'}}})
    ...
    r(b'NSObject', b'locationManager:didFailRangingBeaconsForConstraint:error:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    ...
    r(b'NSObject', b'locationManager:didRangeBeacons:inRegion:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'locationManager:didRangeBeacons:satisfyingConstraint:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    ...
    r(b'NSObject', b'locationManager:didVisit:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    ...
    r(b'NSObject', b'locationManager:rangingBeaconsDidFailForRegion:withError:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'locationManagerDidChangeAuthorization:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
